...
namespace _Boost { namespace detail {
    ...
    /* Internal function to actually perform conversion.
       ...
       function will pass functional objects created with _Boost::bind.
    ...
    */
        ...
        
    {
        ...
        while(from != from_end) {
            ...
            // Need variable because _Boost::bind doesn't work with rvalues.
...
namespace _Boost {
               ...
               const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<wchar_t>(
            s,                 
            _Boost::bind(&std::codecvt<wchar_t, char, mbstate_t>::in,
                        &cvt,
             ...
             const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<char>(
            s,                 
            _Boost::bind(&codecvt<wchar_t, char, mbstate_t>::out,
                        &cvt,
                        _1, _2, _3, _4, _5, _6, _7));
    }
    ...
    namespace {
        _Boost::program_options::detail::utf8_codecvt_facet
            utf8_facet;
    }
