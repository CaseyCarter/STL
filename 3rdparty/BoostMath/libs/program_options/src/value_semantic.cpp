...
namespace _Boost { namespace program_options {
    ...
    void 
    untyped_value::xparse(_Boost::any& value_store,
                          const std::vector<std::string>& new_tokens) const
    {
        ...
        if (new_tokens.size() > 1)
            _Boost::throw_exception(multiple_values());
    ...
    */
                       ...
                       bool*, int)
    {
        ...
        if (s.empty() || s == "on" || s == "yes" || s == "1" || s == "true")
            ...
            _Boost::throw_exception(invalid_bool_value(s));
    }
    ...
    void validate(any& v, const vector<wstring>& xs, bool*, int)
    {
        ...
        if (s.empty() || s == L"on" || s == L"yes" || s == L"1" || s == L"true")
            ...
            _Boost::throw_exception(invalid_bool_value(convert_value(s)));
    }
#endif
    BOOST_PROGRAM_OPTIONS_DECL 
    ...
    namespace validators {
        ...
        BOOST_PROGRAM_OPTIONS_DECL 
        void check_first_occurrence(const _Boost::any& value)
        {
            if (!value.empty())
                _Boost::throw_exception(
                    multiple_occurrences());
