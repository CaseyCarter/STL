   ...
   namespace {
                                      ...
                                      bool short_ignore_case) const
    {
        ...
        if (full_matches.size() > 1) 
            _Boost::throw_exception(ambiguous_option(full_matches));
        ...
        if (full_matches.empty() && approximate_matches.size() > 1)
            _Boost::throw_exception(ambiguous_option(approximate_matches));
        ...
        */
        ...
        {                    
            ...
            else
            {
                ...
                {
                    _Boost::throw_exception(program_options::error(
                                ...
                                unsigned line_length)
        {
            ...
            // _Boost::tokenizer, not typedef.
            typedef _Boost::tokenizer<_Boost::char_separator<char> > tok;
          
            tok paragraphs(
                desc,
                char_separator<char>("\n", "", _Boost::keep_empty_tokens));
