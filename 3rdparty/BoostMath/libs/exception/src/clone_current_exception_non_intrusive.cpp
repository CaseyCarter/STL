...
namespace
    ...
    clone_msvc_exception( void * src, cpp_exception_type const & et, size_t image_base )
        ...
        if( void * dst = malloc(ti.size) )
            ...
            return _Boost::shared_ptr<void>(dst,exception_object_deleter(et,image_base));
            }
        else
            throw std::bad_alloc();
        }
    ...
    class
    cloned_exception:
        public _Boost::exception_detail::clone_base
        {
        ...
        _Boost::exception_detail::clone_base const *
        clone() const
            {
    ...
    unsigned long
    exception_cloning_filter( int & result, _Boost::exception_detail::clone_base const * & ptr, void * info_ )
        {
        ...
        if( is_cpp_exception(record) )
            ...
            if( is_cpp_exception(record) && record->ExceptionInformation[2] )
                try
                    ...
                    result = _Boost::exception_detail::clone_current_exception_result::success;
                    }
                catch(
                std::bad_alloc & )
                    {
                    result = _Boost::exception_detail::clone_current_exception_result::bad_alloc;
                    }
                catch(
                ... )
                    {
                    result = _Boost::exception_detail::clone_current_exception_result::bad_exception;
                    }
            }
