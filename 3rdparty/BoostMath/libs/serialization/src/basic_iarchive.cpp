...
using namespace _Boost::serialization;
...
//public:
    ...
    const basic_pointer_iserializer * load_pointer(
        ...
        const basic_pointer_iserializer * (*finder)(
            const _Boost::serialization::extended_type_info & type
        )
    );
};
...
basic_iarchive_impl::load_object(
    ...
    _Boost::serialization::state_saver<object_id_type> ss_start(m_moveable_objects.start);
...
basic_iarchive_impl::load_pointer(
    ...
    const basic_pointer_iserializer * bpis_ptr,
    const basic_pointer_iserializer * (*finder)(
        const _Boost::serialization::extended_type_info & type_
    )
){
...
BOOST_ARCHIVE_DECL _Boost::archive::library_version_type
