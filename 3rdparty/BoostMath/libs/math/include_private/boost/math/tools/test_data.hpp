...
namespace random_ns = _Boost::random;
#endif
...
inline void unpack_and_append_tuple(Seq&,
                                    const Item&,
                                    const _Boost::integral_constant<int, N>&,
                                    const _Boost::false_type&)
{
...
inline void unpack_and_append_tuple(Seq& s,
                                    const Item& data,
                                    const _Boost::integral_constant<int, N>&,
                                    const _Boost::true_type&)
{
   // extract the N'th element, append, and recurse:
   typedef typename Seq::value_type value_type;
   value_type val = _Boost::math::get<N>(data);
   s.push_back(val);

   typedef _Boost::integral_constant<int, N+1> next_value;
   typedef _Boost::integral_constant<bool, (_Boost::math::tuple_size<Item>::value > N+1)> terminate;

   unpack_and_append_tuple(s, data, next_value(), terminate());
}

template <class Seq, class Item>
inline void unpack_and_append(Seq& s, const Item& data, const _Boost::true_type&)
{
   s.push_back(data);
}

template <class Seq, class Item>
inline void unpack_and_append(Seq& s, const Item& data, const _Boost::false_type&)
{
   // Item had better be a tuple-like type or we've had it!!!!
   typedef _Boost::integral_constant<int, 0> next_value;
   typedef _Boost::integral_constant<bool, (_Boost::math::tuple_size<Item>::value > 0)> terminate;
...
{
   typedef typename Seq::value_type value_type;
   unpack_and_append(s, data, ::_Boost::is_convertible<Item, value_type>());
}
   ...
   test_data& insert(F func, const parameter_info<T>& arg1)
   {
      ...
      while(a != b)
      {
         ...
         try{
            ...
            _Boost::math::tools::detail::unpack_and_append(row, func(*a));
            m_data.insert(row);
#ifndef BOOST_NO_EXCEPTIONS
         }
...
#  pragma warning(disable: 4127)
   ...
   case periodic_in_range:
      ...
      do{
         ...
         try{
#endif
            info.z1 = _Boost::lexical_cast<T>(line);
            break;
#ifndef BOOST_NO_EXCEPTIONS
         }
      ...
      do{
         ...
         else
         {
            ...
            {
#endif
               info.z2 = _Boost::lexical_cast<T>(line);
#ifndef BOOST_NO_EXCEPTIONS
            }
            catch(const _Boost::bad_lexical_cast&)
            {
      ...
      do{
         ...
         try{
#endif
            info.n1 = _Boost::lexical_cast<int>(line);
            info.n2 = 0;
            if(info.n1 <= 0)
            {
   ...
   case power_series:
      ...
      do{
         ...
         try{
#endif
            info.n2 = _Boost::lexical_cast<int>(line);
            break;
#ifndef BOOST_NO_EXCEPTIONS
         }
         catch(const _Boost::bad_lexical_cast&)
                         ...
                         const char* name)
{
   ...
   "   static const _Boost::array<_Boost::array<T, "
