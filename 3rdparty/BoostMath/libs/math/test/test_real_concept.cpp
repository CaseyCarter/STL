...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   typedef _Boost::math::concepts::real_concept rc_t;
...

   {
...
#ifdef __MINGW32__
      BOOST_CHECK_CLOSE_FRACTION(modf(r2, &rc_result), _Boost::math::modf(l2, &ld_result), tol);
#else
      ...
      BOOST_CHECK_EQUAL(iround(r2), _Boost::math::iround(l2));
      BOOST_CHECK_EQUAL(lround(r2), _Boost::math::lround(l2));
#ifdef BOOST_HAS_LONG_LONG
      BOOST_CHECK_EQUAL(llround(r2), _Boost::math::llround(l2));
#endif
      BOOST_CHECK_EQUAL(itrunc(r2), _Boost::math::itrunc(l2));
      BOOST_CHECK_EQUAL(ltrunc(r2), _Boost::math::ltrunc(l2));
#ifdef BOOST_HAS_LONG_LONG
      BOOST_CHECK_EQUAL(lltrunc(r2), _Boost::math::lltrunc(l2));
#endif
   }
