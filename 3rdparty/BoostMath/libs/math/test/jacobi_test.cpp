...
using std::abs;
using _Boost::math::jacobi;
using _Boost::math::jacobi_derivative;
...
#ifdef BOOST_HAS_FLOAT128
    test_to_quadratic<_Boost::multiprecision::float128>();
    test_symmetry<_Boost::multiprecision::float128>();
    test_derivative<_Boost::multiprecision::float128>();
#endif
