...
using namespace _Boost::archive;
...
void archive_basic_test_impl()
{
    ...
    std::locale default_locale(std::locale::classic(),
        new _Boost::archive::codecvt_null<CharType>);
