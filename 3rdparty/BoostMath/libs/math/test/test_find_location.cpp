...
#include <boost/math/distributions/find_location.hpp>
  using _Boost::math::find_location;
...
{ // Parameter only provides the type, float, double... value ignored.
  ...
  l = find_location<normal_distribution<RealType> >(z, p, sd, policy<>()); // Default policy, needs using _Boost::math::policies::policy;
  l = find_location<normal_distribution<RealType> >(z, p, sd, _Boost::math::policies::policy<>()); // Default policy, fully specified.
