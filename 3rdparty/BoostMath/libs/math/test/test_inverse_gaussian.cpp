...
using _Boost::math::inverse_gaussian_distribution;
using _Boost::math::inverse_gaussian;
...
void test_spots(RealType)
{
  ...
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gaussian_distribution<RealType> nbad1(0, 0), std::domain_error); // zero scale
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gaussian_distribution<RealType> nbad1(0, -1), std::domain_error); // negative scale
#else
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gaussian_distribution<RealType>(0, 0), std::domain_error); // zero scale
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gaussian_distribution<RealType>(0, -1), std::domain_error); // negative scale
#endif
  ...
  RealType tolfeweps = _Boost::math::tools::epsilon<RealType>() * 5;
...
BOOST_AUTO_TEST_CASE( test_main )
{
  ...
  _Boost::math::inverse_gaussian w12(1., 2); // Using typedef
  inverse_gaussian_distribution<> w23(2., 3); // Using default RealType double.
  _Boost::math::inverse_gaussian w11; // Use default unity values for mean and scale.
