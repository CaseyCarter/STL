...
DEFINE_TYPE_NAME(_Boost::multiprecision::cpp_bin_float_quad);
DEFINE_TYPE_NAME(_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<25> >);

#if BOOST_WORKAROUND(BOOST_MSVC, < 1900)
#  define CPP_DEC_FLOAT_TEST
#else
#  define CPP_DEC_FLOAT_TEST , _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<25> >
#endif
...
typedef _Boost::mpl::list<float,double LD_TEST, _Boost::multiprecision::cpp_bin_float_quad CPP_DEC_FLOAT_TEST >  test_types;
...
typedef _Boost::mpl::list<float,double>  near_eps_test_types;
#else
typedef _Boost::mpl::list<float,double,long double>  near_eps_test_types;
#endif
...
using   ::_Boost::math::real;
using   ::_Boost::math::unreal;
using   ::_Boost::math::sup;
using   ::_Boost::math::l1;
using   ::_Boost::math::abs;
using   ::_Boost::math::norm;
using   ::_Boost::math::conj;
using   ::_Boost::math::exp;
using   ::_Boost::math::pow;
using   ::_Boost::math::cos;
using   ::_Boost::math::sin;
using   ::_Boost::math::tan;
using   ::_Boost::math::cosh;
using   ::_Boost::math::sinh;
using   ::_Boost::math::tanh;
using   ::_Boost::math::sinc_pi;
using   ::_Boost::math::sinhc_pi;
...
#if !BOOST_WORKAROUND(__GNUC__, < 3)
template    class ::_Boost::math::quaternion<int>;
#else
...
void check_exact_quaternion_result(const _Boost::math::quaternion<T>& q, R1 a, R2 b, R3 c, R4 d)
{
...
template <class T, class R1, class R2, class R3, class R4>
void check_approx_quaternion_result(const _Boost::math::quaternion<T>& q, R1 a, R2 b, R3 c, R4 d, int eps = 10)
{
...
void check_complex_ops_imp()
{
   ...
   ::_Boost::math::quaternion<T>        q2(c0), q1;
   ...
   q2 = ::_Boost::math::quaternion<T>(5, 6, 7, 8);
   q2 += c0;
   ...
   q2 = ::_Boost::math::quaternion<T>(4, 5, 7, 8);
   // operator +
   q1 = c0 + q2;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(arithmetic_test, T, test_types)
{
   ...
   BOOST_CHECK_EQUAL(_Boost::lexical_cast<std::string>(q4), "(34,56,20,2)");
   q1 = _Boost::lexical_cast<_Boost::math::quaternion<T> >("(34,56,20,2)");
   check_exact_quaternion_result(q1, 34, 56, 20, 2);
   ...
   BOOST_CHECK_EQUAL(l1(-q4), 34 + 56 + 20 + 2);
   BOOST_CHECK_CLOSE(abs(q4), _Boost::lexical_cast<T>("68.52736679604725626189080285032080446623"), tol);
   BOOST_CHECK_EQUAL(norm(q4), 4696);
   check_exact_quaternion_result(conj(q4), 34, -56, -20, -2);
   check_approx_quaternion_result(exp(q4), _Boost::lexical_cast<T>("-572700109350177.2871954597833265926769952"), _Boost::lexical_cast<T>("104986825963321.656891930274999993423955"), _Boost::lexical_cast<T>("37495294986900.59174711795535714050855537"), _Boost::lexical_cast<T>("3749529498690.059174711795535714050855537"), 300);
   check_approx_quaternion_result(pow(q4, 3), -321776, -4032, -1440, -144);
   check_approx_quaternion_result(sin(q4), _Boost::lexical_cast<T>("18285331065398556228976865.03309127394107"), _Boost::lexical_cast<T>("-27602822237164214909853379.68314411086089"), _Boost::lexical_cast<T>("-9858150798987219610661921.315408611021748"), _Boost::lexical_cast<T>("-985815079898721961066192.1315408611021748"), 40);
   check_approx_quaternion_result(cos(q4), _Boost::lexical_cast<T>("-29326963088663226843378365.81173441507358"), _Boost::lexical_cast<T>("-17210331032912252411431342.73890926302336"), _Boost::lexical_cast<T>("-6146546797468661575511193.835324736794056"), _Boost::lexical_cast<T>("-614654679746866157551119.3835324736794056"), 40);
   if(std::numeric_limits<T>::max_exponent >= std::numeric_limits<double>::max_exponent)
      check_approx_quaternion_result(tan(q4), _Boost::lexical_cast<T>("-3.758831069989140832054627039712718213887e-52"), _Boost::lexical_cast<T>("0.941209703633940052004990419391011076385"), _Boost::lexical_cast<T>("0.3361463227264071614303537212110753844232"), _Boost::lexical_cast<T>("0.03361463227264071614303537212110753844232"), 40);

   check_approx_quaternion_result(sinh(q4), _Boost::lexical_cast<T>("-286350054675088.6435977298916624551903343"), _Boost::lexical_cast<T>("52493412981660.82844596513750015091043914"), _Boost::lexical_cast<T>("18747647493450.29587355897767862532515683"), _Boost::lexical_cast<T>("1874764749345.029587355897767862532515683"), 200);
   check_approx_quaternion_result(cosh(q4), _Boost::lexical_cast<T>("-286350054675088.6435977298916641374866609"), _Boost::lexical_cast<T>("52493412981660.82844596513749984251351591"), _Boost::lexical_cast<T>("18747647493450.29587355897767851518339854"), _Boost::lexical_cast<T>("1874764749345.029587355897767851518339854"), 200);
   if(std::numeric_limits<T>::max_exponent >= std::numeric_limits<double>::max_exponent)
      check_approx_quaternion_result(tanh(q4), _Boost::lexical_cast<T>("0.9999999999999999999999999999945544805016"), _Boost::lexical_cast<T>("-2.075260044344318549117301019071435084233e-30"), _Boost::lexical_cast<T>("-7.411643015515423389704646496683696729404e-31"), _Boost::lexical_cast<T>("-7.411643015515423389704646496683696729404e-32"), 200);

#ifndef    BOOST_NO_TEMPLATE_TEMPLATES
   check_approx_quaternion_result(sinc_pi(q4), _Boost::lexical_cast<T>("-239180458943182912968898.352151239530846"), _Boost::lexical_cast<T>("-417903427539587405399855.0577257263862799"), _Boost::lexical_cast<T>("-149251224121281216214233.9491877594236714"), _Boost::lexical_cast<T>("-14925122412128121621423.39491877594236714"), 200);
   check_approx_quaternion_result(sinhc_pi(q4), _Boost::lexical_cast<T>("-1366603120232.604666248483234115586439226"), _Boost::lexical_cast<T>("3794799638667.255581055299959135992677524"), _Boost::lexical_cast<T>("1355285585238.305564662607128262854527687"), _Boost::lexical_cast<T>("135528558523.8305564662607128262854527687"), 200);
#endif
   //
   // Construction variations:
   //
   T rho = _Boost::math::constants::root_two<T>() * 2;
   T theta = _Boost::math::constants::pi<T>() / 4;
   T phi1 = theta;
   T phi2 = theta;
   q1 = ::_Boost::math::spherical(rho, theta, phi1, phi2);
   check_approx_quaternion_result(q1, 1, 1, _Boost::math::constants::root_two<T>(), 2, 10);
   T alpha = theta;
   q1 = ::_Boost::math::semipolar(rho, alpha, phi1, phi2);
   check_approx_quaternion_result(q1, _Boost::math::constants::root_two<T>(), _Boost::math::constants::root_two<T>(), _Boost::math::constants::root_two<T>(), _Boost::math::constants::root_two<T>(), 10);
   T rho1 = 1;
   T rho2 = 2;
   T theta1 = 0;
   T theta2 = _Boost::math::constants::half_pi<T>();
   q1 = ::_Boost::math::multipolar(rho1, theta1, rho2, theta2);
   check_approx_quaternion_result(q1, 1, 0, 0, 2, 10);
   T t = 5;
   T radius = _Boost::math::constants::root_two<T>();
   T longitude = _Boost::math::constants::pi<T>() / 4;
   T latitude = _Boost::math::constants::pi<T>() / 3;
   q1 = ::_Boost::math::cylindrospherical(t, radius, longitude, latitude);
   check_approx_quaternion_result(q1, 5, 0.5, 0.5, _Boost::lexical_cast<T>("1.224744871391589049098642037352945695983"), 10);
   T r = _Boost::math::constants::root_two<T>();
   T angle = _Boost::math::constants::pi<T>() / 4;
   T h1 = 3;
   T h2 = 4;
   q1 = ::_Boost::math::cylindrical(r, angle, h1, h2);
   check_approx_quaternion_result(q1, 1, 1, 3, 4, 10);

   ::_Boost::math::quaternion<T>        quaternion_1(1);
   ::_Boost::math::quaternion<T>        quaternion_i(0, 1);
   ::_Boost::math::quaternion<T>        quaternion_j(0, 0, 1);
   ::_Boost::math::quaternion<T>        quaternion_k(0, 0, 0, 1);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(multiplication_test, T, test_types)
{
    ...
    BOOST_REQUIRE_PREDICATE(::std::less_equal<T>(),
        (abs(::_Boost::math::quaternion<T>(1,0,0,0)*
             ::_Boost::math::quaternion<T>(1,0,0,0)-static_cast<T>(1)))
        (numeric_limits<T>::epsilon()));
    
    BOOST_REQUIRE_PREDICATE(::std::less_equal<T>(),
        (abs(::_Boost::math::quaternion<T>(0,1,0,0)*
             ::_Boost::math::quaternion<T>(0,1,0,0)+static_cast<T>(1)))
        (numeric_limits<T>::epsilon()));
    
    BOOST_REQUIRE_PREDICATE(::std::less_equal<T>(),
        (abs(::_Boost::math::quaternion<T>(0,0,1,0)*
             ::_Boost::math::quaternion<T>(0,0,1,0)+static_cast<T>(1)))
        (numeric_limits<T>::epsilon()));
    
    BOOST_REQUIRE_PREDICATE(::std::less_equal<T>(),
        (abs(::_Boost::math::quaternion<T>(0,0,0,1)*
             ::_Boost::math::quaternion<T>(0,0,0,1)+static_cast<T>(1)))
        (numeric_limits<T>::epsilon()));
    
    BOOST_REQUIRE_PREDICATE(::std::less_equal<T>(),
        (abs(::_Boost::math::quaternion<T>(0,1,0,0)*
             ::_Boost::math::quaternion<T>(0,0,1,0)-
             ::_Boost::math::quaternion<T>(0,0,0,1)))
        (numeric_limits<T>::epsilon()));
    
    BOOST_REQUIRE_PREDICATE(::std::less_equal<T>(),
        (abs(::_Boost::math::quaternion<T>(0,0,1,0)*
             ::_Boost::math::quaternion<T>(0,1,0,0)+
             ::_Boost::math::quaternion<T>(0,0,0,1)))
        (numeric_limits<T>::epsilon()));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(exp_test, T, test_types)
{
    ...
    BOOST_CHECK_PREDICATE(::std::less_equal<T>(),
        (abs(exp(::_Boost::math::quaternion<T>
...
BOOST_AUTO_TEST_CASE_TEMPLATE(cos_test, T, test_types)
{
    ...
    BOOST_CHECK_PREDICATE(::std::less_equal<T>(),
        (abs(static_cast<T>(4)*cos(::_Boost::math::quaternion<T>
...
BOOST_AUTO_TEST_CASE_TEMPLATE(sin_test, T, test_types)
{
    ...
    BOOST_CHECK_PREDICATE(::std::less_equal<T>(),
        (abs(static_cast<T>(4)*sin(::_Boost::math::quaternion<T>
             (0,log(static_cast<T>(2)),0,0))
             -::_Boost::math::quaternion<T>(0,3,0,0)))
        (4*numeric_limits<T>::epsilon()));
    
    BOOST_CHECK_PREDICATE(::std::less_equal<T>(),
        (abs(static_cast<T>(4)*sin(::_Boost::math::quaternion<T>
             (0,0,log(static_cast<T>(2)),0))
             -::_Boost::math::quaternion<T>(0,0,3,0)))
        (4*numeric_limits<T>::epsilon()));
    
    BOOST_CHECK_PREDICATE(::std::less_equal<T>(),
        (abs(static_cast<T>(4)*sin(::_Boost::math::quaternion<T>
             (0,0,0,log(static_cast<T>(2))))
             -::_Boost::math::quaternion<T>(0,0,0,3)))
        (4*numeric_limits<T>::epsilon()));
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(cosh_test, T, test_types)
{
    ...
    BOOST_CHECK_PREDICATE(::std::less_equal<T>(),
        (abs(cosh(::_Boost::math::quaternion<T>
...
BOOST_AUTO_TEST_CASE_TEMPLATE(sinh_test, T, test_types)
{
    ...
    BOOST_CHECK_PREDICATE(::std::less_equal<T>(),
        (abs(sinh(::_Boost::math::quaternion<T>
