...
#ifdef TEST_OTHER
namespace other{
   _Boost::math::concepts::real_concept erf(_Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept erfc(_Boost::math::concepts::real_concept){ return 0; }
}
#endif
