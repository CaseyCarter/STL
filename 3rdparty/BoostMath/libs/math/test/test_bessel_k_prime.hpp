...
T cyl_bessel_k_prime_int_wrapper(T v, T x)
{
   ...
   return static_cast<T>(
      ...
      _Boost::math::itrunc(v), x));
#else
   return static_cast<T>(
      _Boost::math::cyl_bessel_k_prime(
      _Boost::math::itrunc(v), x));
#endif
}
...
void do_test_cyl_bessel_k_prime(const T& data, const char* type_name, const char* test_name)
{
   ...
   pg funcp = _Boost::math::cyl_bessel_k_prime<value_type, value_type>;
#else
   pg funcp = _Boost::math::cyl_bessel_k_prime;
#endif
...
void test_bessel(T, const char* name)
{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 9> k0_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 9> k1_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 9> kn_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 11> kv_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 5> kv_prime_large_data = {{
...
#else
        { { SC_(-1.125), static_cast<T>(ldexp(0.5, -512)), std::numeric_limits<T>::has_infinity ? -std::numeric_limits<T>::infinity() : -_Boost::math::tools::max_value<T>() } },
        { { SC_(1.125), static_cast<T>(ldexp(0.5, -512)), std::numeric_limits<T>::has_infinity ? -std::numeric_limits<T>::infinity() : -_Boost::math::tools::max_value<T>() } },
        { { SC_(0.5), static_cast<T>(ldexp(0.5, -683)), std::numeric_limits<T>::has_infinity ? -std::numeric_limits<T>::infinity() : -_Boost::math::tools::max_value<T>() } },
#endif
    }};
