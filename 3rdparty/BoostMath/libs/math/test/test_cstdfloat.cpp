...
// The tests:
//
// Perform sanity checks on _Boost::float16_t, _Boost::float32_t,
// _Boost::float64_t, _Boost::float80_t, and _Boost::float128_t when
...
//
// An extended check is included for _Boost::float128_t. This checks
// the functionality of <cmath>, I/O stream operations, and <complex>
// functions for _Boost::float128_t.
...
{                                                                                                    \
  typedef _Boost::float##the_digits##_t float_type;                                                   \
                                                                                                     \
  ...
  {                                                                                                  \
    const bool the_lim_test =                                                                        \
      (std::numeric_limits<_Boost::floatmax_t>::digits >= std::numeric_limits<float_type>::digits);   \
...
BOOST_AUTO_TEST_CASE(test_main)
{
   ...
   // Perform an extended check of _Boost::float128_t including
