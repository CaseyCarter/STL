...
{
   check_result<std::complex<float> >(_Boost::math::atan(std::complex<float>()));
   check_result<std::complex<double> >(_Boost::math::atan(std::complex<double>()));
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
   check_result<std::complex<long double> >(_Boost::math::atan(std::complex<long double>()));
#endif
}
