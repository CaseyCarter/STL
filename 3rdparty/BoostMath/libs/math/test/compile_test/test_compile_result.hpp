...
inline void check_result_imp(_Boost::long_long_type, _Boost::long_long_type){}
#endif
...
#define TEST_DIST_FUNC(dist)\
   DistributionConcept< _Boost::math::dist##_distribution<float> >::constraints();\
   DistributionConcept< _Boost::math::dist##_distribution<double> >::constraints();\
   DistributionConcept< _Boost::math::dist##_distribution<long double> >::constraints();
#else
#define TEST_DIST_FUNC(dist)\
   DistributionConcept< _Boost::math::dist##_distribution<float> >::constraints();\
   DistributionConcept< _Boost::math::dist##_distribution<double> >::constraints();
