...
{
   check_result<float >(_Boost::math::fabs(std::complex<float>()));
   check_result<double >(_Boost::math::fabs(std::complex<double>()));
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
   check_result<long double>(_Boost::math::fabs(std::complex<long double>()));
#endif
}
