...
namespace std{
template<>
struct numeric_limits<_Boost::math::concepts::std_real_concept>
{
   static const bool is_specialized = true;
   static _Boost::math::concepts::std_real_concept min NULL_MACRO() throw();
   static _Boost::math::concepts::std_real_concept max NULL_MACRO() throw();
   ...
   static _Boost::math::concepts::std_real_concept epsilon() throw();
   static _Boost::math::concepts::std_real_concept round_error() throw();
   ...
   static _Boost::math::concepts::std_real_concept infinity() throw();
   static _Boost::math::concepts::std_real_concept quiet_NaN() throw();
   static _Boost::math::concepts::std_real_concept signaling_NaN() throw();
   static _Boost::math::concepts::std_real_concept denorm_min() throw();
...
int main(int argc, char*[])
{
   ...
   if(argc > 1000)
      instantiate(_Boost::math::concepts::std_real_concept(0));
#endif
}
