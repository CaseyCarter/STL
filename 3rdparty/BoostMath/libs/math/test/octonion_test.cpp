...
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
typedef _Boost::mpl::list<float,double,long double>  test_types;
#else
...
#if !BOOST_WORKAROUND(__GNUC__, < 3)
template    class ::_Boost::math::octonion<int>;
#else
...
{
    template<typename T>
    ::_Boost::math::octonion<T>    index_i_element(int idx)
    {
        return(
            ::_Boost::math::octonion<T>(
                        (idx == 0) ?
                            static_cast<T>(1) :
                            static_cast<T>(0),
                        (idx == 1) ?
...
void    octonion_manual_test()
{
    ...
    ::_Boost::math::octonion<float>            o0;
    
    ::_Boost::math::octonion<float>            oa[2];
    
    // using constructor "O seen as R^8"
    ::_Boost::math::octonion<float>            o1(1,2,3,4,5,6,7,8);
    
    ::std::complex<double>                    c0(9,10);
    
    // using constructor "O seen as C^4"
    ::_Boost::math::octonion<double>            o2(c0);
    
    ::_Boost::math::quaternion<long double>    q0(11,12,13,14);
    
    // using constructor "O seen as H^2"
    ::_Boost::math::octonion<long double>      o3(q0);
    
    // using UNtemplated copy constructor
    ::_Boost::math::octonion<float>            o4(o1);
    
    // using templated copy constructor
    ::_Boost::math::octonion<long double>      o5(o2);
    ...
    // using += (const ::_Boost::math::quaternion<T> &)
    o3 += q0;
    ...
    ::_Boost::math::quaternion<double>         q1(19,20,21,22);
    ...
    ::_Boost::math::octonion<float>            o6 = f0+o0;
    
    // using + (const octonion<T> &, const T &)
    ::_Boost::math::octonion<float>            o7 = o0+f0;
    
    // using + (const ::std::complex<T> &, const quaternion<T> &)
    ::_Boost::math::octonion<double>           o8 = c0+o2;
    
    // using + (const octonion<T> &, const ::std::complex<T> &)
    ::_Boost::math::octonion<double>           o9 = o2+c0;
    
    // using + (const ::_Boost::math::quaternion<T>, const octonion<T> &)
    ::_Boost::math::octonion<long double>      o10 = q0+o3;
    
    // using + (const octonion<T> &, const ::_Boost::math::quaternion<T> &)
    ::_Boost::math::octonion<long double>      o11 = o3+q0;
    
    // using + (const quaternion<T> &,const quaternion<T> &)
    ::_Boost::math::octonion<float>            o12 = o0+o4;
    ...
    BOOST_TEST_MESSAGE( "The value of the octonion represented "
                ...
                << " , phi5 = " << phi5 << " , phi6 = " << phi6
                << " is "
                << ::_Boost::math::spherical(rho, theta,
    ...
    BOOST_TEST_MESSAGE( "The value of the octonion represented "
                ...
                << " is "
                << ::_Boost::math::multipolar(rho1, theta1, rho2, theta2,
    ...
    BOOST_TEST_MESSAGE( "The value of the octonion represented "
                ...
                << " , h3 = " << h3 << " , h4 = " << h4
                << " , h5 = " << h5 << " , h6 = " << h6
                << " is " << ::_Boost::math::cylindrical(r, angle,
                        h1, h2, h3, h4, h5, h6));
    
    double                               real_1(1);
    ::std::complex<double>               complex_1(1);
    ::std::complex<double>               complex_i(0,1);
    ::_Boost::math::quaternion<double>    quaternion_1(1);
    ::_Boost::math::quaternion<double>    quaternion_i(0,1);
    ::_Boost::math::quaternion<double>    quaternion_j(0,0,1);
    ::_Boost::math::quaternion<double>    quaternion_k(0,0,0,1);
    ::_Boost::math::octonion<double>      octonion_1(1);
    ::_Boost::math::octonion<double>      octonion_i(0,1);
    ::_Boost::math::octonion<double>      octonion_j(0,0,1);
    ::_Boost::math::octonion<double>      octonion_k(0,0,0,1);
    ::_Boost::math::octonion<double>      octonion_e_prime(0,0,0,0,1);
    ::_Boost::math::octonion<double>      octonion_i_prime(0,0,0,0,0,1);
    ::_Boost::math::octonion<double>      octonion_j_prime(0,0,0,0,0,0,1);
    ::_Boost::math::octonion<double>      octonion_k_prime(0,0,0,0,0,0,0,1);
...
BOOST_TEST_CASE_TEMPLATE_FUNCTION(multiplication_test, T)
{
    ...
    BOOST_REQUIRE_PREDICATE(::std::less_equal<T>(),
        (abs(::_Boost::math::octonion<T>(1,0,0,0,0,0,0,0)*
             ::_Boost::math::octonion<T>(1,0,0,0,0,0,0,0)-
             static_cast<T>(1)))
        (numeric_limits<T>::epsilon()));
    
    for    (int idx = 1; idx < 8; ++idx)
    {
        ::_Boost::math::octonion<T>    toto = index_i_element<T>(idx);
...
_Boost::unit_test::test_suite *    init_unit_test_suite(int, char *[])
{
    ::_Boost::unit_test::unit_test_log.
        set_threshold_level(::_Boost::unit_test::log_messages);
    
    _Boost::unit_test::test_suite *    test =
