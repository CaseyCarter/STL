...
#ifdef TEST_OTHER
namespace other{
   _Boost::math::concepts::real_concept legendre_p(int, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept legendre_q(int, _Boost::math::concepts::real_concept){ return 0; }
}
#endif
