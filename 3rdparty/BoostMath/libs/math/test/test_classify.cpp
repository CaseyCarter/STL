...
const char* method_name(const _Boost::math::detail::native_tag&)
{
   return "Native";
}

const char* method_name(const _Boost::math::detail::generic_tag<true>&)
{
   return "Generic (with numeric limits)";
}

const char* method_name(const _Boost::math::detail::generic_tag<false>&)
{
   return "Generic (without numeric limits)";
}

const char* method_name(const _Boost::math::detail::ieee_tag&)
{
   return "IEEE std";
}

const char* method_name(const _Boost::math::detail::ieee_copy_all_bits_tag&)
{
   return "IEEE std, copy all bits";
}

const char* method_name(const _Boost::math::detail::ieee_copy_leading_bits_tag&)
{
...
void test_classify(T t, const char* type)
{
   ...
   typedef typename _Boost::math::detail::fp_traits<T>::type traits;
   ...
   t = 2;
   T u = 2;
   BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(t), (int)FP_NORMAL);
   BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(-t), (int)FP_NORMAL);
   BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(t), true);
   BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(-t), true);
   BOOST_CHECK_EQUAL((::_Boost::math::isinf)(t), false);
   BOOST_CHECK_EQUAL((::_Boost::math::isinf)(-t), false);
   BOOST_CHECK_EQUAL((::_Boost::math::isnan)(t), false);
   BOOST_CHECK_EQUAL((::_Boost::math::isnan)(-t), false);
   BOOST_CHECK_EQUAL((::_Boost::math::isnormal)(t), true);
   BOOST_CHECK_EQUAL((::_Boost::math::isnormal)(-t), true);
   ...
   if(std::numeric_limits<T>::has_denorm)
   {
      ...
      if(t != 0)
      {
         BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(t), (int)FP_SUBNORMAL);
         BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(-t), (int)FP_SUBNORMAL);
         BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(t), true);
         BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(-t), true);
         BOOST_CHECK_EQUAL((::_Boost::math::isinf)(t), false);
         ...
         BOOST_CHECK_EQUAL((::_Boost::math::isnan)(t), false);
         BOOST_CHECK_EQUAL((::_Boost::math::isnan)(-t), false);
         BOOST_CHECK_EQUAL((::_Boost::math::isnormal)(t), false);
         BOOST_CHECK_EQUAL((::_Boost::math::isnormal)(-t), false);
      }
   ...
   t = 0;
   BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(t), (int)FP_ZERO);
   BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(-t), (int)FP_ZERO);
   BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(t), true);
   BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(-t), true);
   BOOST_CHECK_EQUAL((::_Boost::math::isinf)(t), false);
   ...
   if(std::numeric_limits<T>::has_infinity) 
   {
      ...
      BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(t), (int)FP_INFINITE);
      BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(-t), (int)FP_INFINITE);
      BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(-t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isinf)(t), true);
      BOOST_CHECK_EQUAL((::_Boost::math::isinf)(-t), true);
      BOOST_CHECK_EQUAL((::_Boost::math::isnan)(t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isnan)(-t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isnormal)(t), false);
   ...
   if(std::numeric_limits<T>::has_quiet_NaN)
   {
      ...
      BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(t), (int)FP_NAN);
      BOOST_CHECK_EQUAL((::_Boost::math::fpclassify)(-t), (int)FP_NAN);
      BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isfinite)(-t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isinf)(t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isinf)(-t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isnan)(t), true);
      BOOST_CHECK_EQUAL((::_Boost::math::isnan)(-t), true);
      BOOST_CHECK_EQUAL((::_Boost::math::isnormal)(t), false);
      BOOST_CHECK_EQUAL((::_Boost::math::isnormal)(-t), false);
   }
...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   test_classify((_Boost::math::concepts::real_concept)(0), "real_concept");
