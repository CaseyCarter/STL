...
#ifdef TEST_OTHER
namespace other{
   _Boost::math::concepts::real_concept nccs_cdf(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
}
#endif
