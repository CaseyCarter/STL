...
void test_exact_mean()
{
    ...
    Real mu = _Boost::math::statistics::mean(v);

    auto [computed_statistic, computed_pvalue] = _Boost::math::statistics::one_sample_t_test(v, mu);
...
void test_agreement_with_mathematica()
{
    ...
    auto [computed_statistic, computed_pvalue] = _Boost::math::statistics::one_sample_t_test(v, 0.0);
