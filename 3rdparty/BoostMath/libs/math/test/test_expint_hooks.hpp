...
#ifdef TEST_OTHER
namespace other{
   _Boost::math::concepts::real_concept expint(unsigned, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept expint(_Boost::math::concepts::real_concept){ return 0; }
}
#endif
