...
#include <boost/math/distributions/normal.hpp> // for normal_distribution
  using _Boost::math::normal; // Default type double.
  using _Boost::math::normal_distribution; // All floating-point types.
#include <boost/math/distributions/cauchy.hpp> // for cauchy_distribution
  using _Boost::math::cauchy;
#include <boost/math/distributions/pareto.hpp> // for cauchy_distribution
  using _Boost::math::pareto;
#include <boost/math/distributions/find_scale.hpp>
  using _Boost::math::find_scale;
  using _Boost::math::complement;// will be needed by users who want complement,
...
{ // Parameter only provides the type, float, double... value ignored.
  ...
  // BOOST_STATIC_ASSERT(::_Boost::math::tools::is_scaled_distribution<Dist>::value); 
  ...
  s = find_scale<normal_distribution<RealType> >(z, p, l, policy<>()); // Default policy, needs using _Boost::math::policies::policy;
  s = find_scale<normal_distribution<RealType> >(z, p, l, _Boost::math::policies::policy<>()); // Default policy, fully specified.
...
Tolerance for type class _Boost::math::concepts::real_concept is 2.22e-014 (or 2.22e-012%).
*** No errors detected
