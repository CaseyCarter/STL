...
BOOST_AUTO_TEST_CASE_TEMPLATE(lround_llround_lltrunc_truncl, T,
  ...
  using _Boost::math::lround;
  using _Boost::multiprecision::llround;
  using _Boost::multiprecision::lltrunc;
  using _Boost::multiprecision::lround;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(equality, T, all_float_types) {
  ...
  using _Boost::math::epsilon_difference;
  using _Boost::math::fpclassify;
  using _Boost::math::ulp;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(multiprecision, T, multiprecision_float_types) {
  ...
  const T answer = _Boost::lexical_cast<T>(
...
BOOST_AUTO_TEST_CASE_TEMPLATE(atan_hpp, T, all_float_types) {
  ...
  using _Boost::math::differentiation::detail::atan;
  using _Boost::multiprecision::atan;
  using _Boost::multiprecision::fabs;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(bernoulli_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    {
      auto autodiff_v = _Boost::math::bernoulli_b2n<autodiff_fvar<T, m>>(i);
      auto anchor_v = _Boost::math::bernoulli_b2n<T>(i);
      BOOST_CHECK_CLOSE(autodiff_v.derivative(0u), anchor_v,
                        50 * test_constants::pct_epsilon());
    }
    {
      auto i_ = (min)(19, i);
      auto autodiff_v = _Boost::math::tangent_t2n<autodiff_fvar<T, m>>(i_);
      auto anchor_v = _Boost::math::tangent_t2n<T>(i_);
      BOOST_CHECK_CLOSE(autodiff_v.derivative(0u), anchor_v,
                        50 * test_constants::pct_epsilon());
    }
  }
