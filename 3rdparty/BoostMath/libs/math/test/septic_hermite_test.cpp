...
using _Boost::math::interpolators::septic_hermite;
using _Boost::math::interpolators::cardinal_septic_hermite;
using _Boost::math::interpolators::cardinal_septic_hermite_aos;
