...
#else
   return static_cast<T>(
      _Boost::math::cyl_bessel_i_prime(
      _Boost::math::itrunc(v), x));
#endif
}
...
void do_test_cyl_bessel_i_prime(const T& data, const char* type_name, const char* test_name)
{
   ...
   pg funcp = _Boost::math::cyl_bessel_i_prime<value_type, value_type>;
#else
   pg funcp = _Boost::math::cyl_bessel_i_prime;
#endif
...
void test_bessel(T, const char* name)
{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 10> i0_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 10> i1_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 11> in_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 10> iv_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 5> iv_prime_large_data = {{
