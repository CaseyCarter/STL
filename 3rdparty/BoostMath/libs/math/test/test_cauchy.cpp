...
#include <boost/math/distributions/cauchy.hpp>
    using _Boost::math::cauchy_distribution;
...
void test_spots(RealType T)
{
  ...
  BOOST_MATH_CHECK_THROW(_Boost::math::cauchy_distribution<RealType> nbad1(0, 0), std::domain_error); // zero scale.
  BOOST_MATH_CHECK_THROW(_Boost::math::cauchy_distribution<RealType> nbad1(0, -1), std::domain_error); // negative scale (shape).
#else
  BOOST_MATH_CHECK_THROW(_Boost::math::cauchy_distribution<RealType>(0, 0), std::domain_error); // zero scale.
  BOOST_MATH_CHECK_THROW(_Boost::math::cauchy_distribution<RealType>(0, -1), std::domain_error); // negative scale (shape).
#endif
  ...
  RealType tolerance = (std::max)(
     static_cast<RealType>(_Boost::math::tools::epsilon<double>()),
  ...
  cout << "Tolerance for type " << typeid(T).name()  << " is " << tolerance << " %" << endl;
   ...
   BOOST_CHECK_EQUAL(
       median(dist),
       static_cast<RealType>(0));
   RealType expected_entropy = log(2*_Boost::math::constants::two_pi<RealType>());
   BOOST_CHECK_CLOSE(
       entropy(dist),
   ...
   check_out_of_range<_Boost::math::cauchy_distribution<RealType> >(0, 1); // (All) valid constructor parameter values.
...
BOOST_AUTO_TEST_CASE( test_main )
{
  ...
  _Boost::math::cauchy mycd1(1.); // Using typedef
...
Tolerance for type class _Boost::math::concepts::real_concept is 1.11022e-012 %
*** No errors detected
