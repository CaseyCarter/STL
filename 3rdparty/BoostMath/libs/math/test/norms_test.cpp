...
using _Boost::math::tools::lp_norm;
using _Boost::math::tools::l1_norm;
using _Boost::math::tools::l2_norm;
using _Boost::math::tools::sup_norm;
using _Boost::math::tools::lp_distance;
using _Boost::math::tools::l1_distance;
using _Boost::math::tools::l2_distance;
using _Boost::math::tools::sup_distance;
using _Boost::math::tools::total_variation;
...
void test_lp()
{
    ...
    _Boost::numeric::ublas::vector<Real> w(4);
...
void test_complex_lp_distance()
{
    ...
    Real dist = _Boost::math::tools::lp_distance(u,u, 3);
    BOOST_TEST(abs(dist) < tol);

    dist = _Boost::math::tools::lp_distance(u,v, 3);
    BOOST_TEST(abs(dist - 1) < tol);
...
void test_integer_total_variation()
{
    ...
    std::vector<Z> v{1,1};
    double tv = _Boost::math::tools::total_variation(v);
    BOOST_TEST_EQ(tv, 0);

    v[1] = 2;
    tv = _Boost::math::tools::total_variation(v.begin(), v.end());
    BOOST_TEST_EQ(tv, 1);
    ...
    tv = _Boost::math::tools::total_variation(v);
    ...
    // Work with std::array?
    std::array<Z, 2> w{1,1};
    tv = _Boost::math::tools::total_variation(w);
    BOOST_TEST_EQ(tv,0);

    std::array<Z, 4> u{1, 2, 1, 2};
    tv = _Boost::math::tools::total_variation(u);
    BOOST_TEST_EQ(tv, 3);
...
void test_sup_norm()
{
    ...
    Real s = _Boost::math::tools::sup_norm(v.begin(), v.end());
    BOOST_TEST(abs(s - 2) < tol);

    s = _Boost::math::tools::sup_norm(v);
    BOOST_TEST(abs(s - 2) < tol);

    // Work with std::array?
    std::array<Real, 3> w{-2,1,0};
    s = _Boost::math::tools::sup_norm(w);
    BOOST_TEST(abs(s - 2) < tol);
...
void test_l0_pseudo_norm()
{
    ...
    size_t count = _Boost::math::tools::l0_pseudo_norm(v.begin(), v.end());
    BOOST_TEST_EQ(count, 1);

    // Compiles with cbegin()/cend()?
    count = _Boost::math::tools::l0_pseudo_norm(v.cbegin(), v.cend());
    BOOST_TEST_EQ(count, 1);

    count = _Boost::math::tools::l0_pseudo_norm(v);
    BOOST_TEST_EQ(count, 1);

    std::array<Real, 3> w{0,0,1};
    count = _Boost::math::tools::l0_pseudo_norm(w);
    BOOST_TEST_EQ(count, 1);
}
...
void test_hamming_distance()
{
    ...
    size_t count = _Boost::math::tools::hamming_distance(v, w);
    BOOST_TEST_EQ(count, 1);

    count = _Boost::math::tools::hamming_distance(v, v);
...
void test_integer_l1_norm()
{
    ...
    Z l1 = _Boost::math::tools::l1_norm(v.begin(), v.end());
    BOOST_TEST_EQ(l1, 3);
...
void test_l1_distance()
{
    ...
    Real l1 = _Boost::math::tools::l1_distance(v, v);
    BOOST_TEST(abs(l1) < tol);

    l1 = _Boost::math::tools::l1_distance(w, v);
    BOOST_TEST(abs(l1 - 3) < tol);

    l1 = _Boost::math::tools::l1_distance(v, w);
    BOOST_TEST(abs(l1 - 3) < tol);
...
void test_integer_l1_distance()
{
    ...
    double l1 = _Boost::math::tools::l1_distance(v, v);
    BOOST_TEST(abs(l1) < tol);
...
void test_complex_l1_distance()
{
    ...
    l1 = _Boost::math::tools::l1_distance(v.cbegin(), v.cend(), w.cbegin());
...
void test_l2_norm()
{
    ...
    Real l2 = _Boost::math::tools::l2_norm(v.begin(), v.end());
    BOOST_TEST(abs(l2 - 2) < tol);

    l2 = _Boost::math::tools::l2_norm(v);
    BOOST_TEST(abs(l2 - 2) < tol);

    std::array<Real, 4> w{1,1,1,1};
    l2 = _Boost::math::tools::l2_norm(w);
    BOOST_TEST(abs(l2 - 2) < tol);
    ...
    v[2] = 0;
    v[3] = 0;
    l2 = _Boost::math::tools::l2_norm(v.begin(), v.end());
...
void test_integer_l2_norm()
{
    ...
    double l2 = _Boost::math::tools::l2_norm(v.begin(), v.end());
    BOOST_TEST(abs(l2 - 2) < tol);
...
void test_l2_distance()
{
    Real tol = std::numeric_limits<Real>::epsilon();
    std::vector<Real> v{1,1,1,1};
    Real l2 = _Boost::math::tools::l2_distance(v, v);
...
void test_integer_l2_distance()
{
    double tol = std::numeric_limits<double>::epsilon();
    std::vector<Z> v{1,1,1,1};
    double l2 = _Boost::math::tools::l2_distance(v, v);
    BOOST_TEST(abs(l2) < tol);
...
void test_sup_distance()
{
    ...
    Real sup = _Boost::math::tools::sup_distance(v, v);
    BOOST_TEST(abs(sup) < tol);
    sup = _Boost::math::tools::sup_distance(v, w);
...
void test_integer_sup_distance()
{
    ...
    double sup = _Boost::math::tools::sup_distance(v, v);
    BOOST_TEST(abs(sup) < tol);
