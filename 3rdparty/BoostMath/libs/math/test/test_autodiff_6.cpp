...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_1_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(_Boost::math::ellint_1(make_fvar<T, m>(k)).derivative(0u),
                      _Boost::math::ellint_1(k),
                      2.5e3 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_1(make_fvar<T, m>(k), make_fvar<T, m>(phi))
            .derivative(0u),
        _Boost::math::ellint_1(k, phi), 1e4 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_2_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    auto k = k_sampler.next();
    auto phi = phi_sampler.next();
    BOOST_CHECK_CLOSE(_Boost::math::ellint_2(make_fvar<T, m>(k)).derivative(0u),
                      _Boost::math::ellint_2(k),
                      2.5e3 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_2(make_fvar<T, m>(k), make_fvar<T, m>(phi))
            .derivative(0u),
        _Boost::math::ellint_2(k, phi), 2.5e3 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_3_hpp, T, all_float_types) {
  ...
  using _Boost::math::differentiation::detail::sin;
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    auto n = (min)((min)(n_sampler.next(), T(1) / (sin(phi) * sin(phi))),
                   nextafter(T(1), T(0)));
    BOOST_CHECK_CLOSE(_Boost::math::ellint_3(make_fvar<T, m>(k),
                                            make_fvar<T, m>(n),
                                            make_fvar<T, m>(phi))
                          .derivative(0u),
                      _Boost::math::ellint_3(k, n, phi),
                      2.5e3 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_d_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    auto k = k_sampler.next();
    auto phi = phi_sampler.next();
    BOOST_CHECK_CLOSE(_Boost::math::ellint_d(make_fvar<T, m>(k)).derivative(0u),
                      _Boost::math::ellint_d(k),
                      2.5e3 * test_constants::pct_epsilon());
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_d(make_fvar<T, m>(k), make_fvar<T, m>(phi))
            .derivative(0u),
        _Boost::math::ellint_d(k, phi), 2.5e3 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rf_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_rf(make_fvar<T, m>(x), make_fvar<T, m>(y),
                               make_fvar<T, m>(z))
            .derivative(0u),
        _Boost::math::ellint_rf(x, y, z), 2.5e3 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rc_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_rc(make_fvar<T, m>(x), make_fvar<T, m>(y))
            .derivative(0u),
        _Boost::math::ellint_rc(x, y), 2.5e3 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rj_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_rj(make_fvar<T, m>(x), make_fvar<T, m>(y),
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rd_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_rd(make_fvar<T, m>(x), make_fvar<T, m>(y),
                               make_fvar<T, m>(z))
            .derivative(0u),
        _Boost::math::ellint_rd(x, y, z), 2.5e3 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(ellint_rg_hpp, T, all_float_types) {
  ...
  for (auto i : _Boost::irange(test_constants::n_samples)) {
    ...
    auto z = z_sampler.next();
    BOOST_CHECK_CLOSE(
        _Boost::math::ellint_rg(make_fvar<T, m>(x), make_fvar<T, m>(y),
                               make_fvar<T, m>(z))
            .derivative(0u),
        _Boost::math::ellint_rg(x, y, z), 50 * test_constants::pct_epsilon());
  }
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(expint_hpp, T, all_float_types) {
  ...
  for (auto n :
       _Boost::irange(1u, static_cast<unsigned>(test_constants::n_samples))) {
    auto x = x_sampler.next();
    BOOST_CHECK_CLOSE(_Boost::math::expint(n, make_fvar<T, m>(x)).derivative(0u),
                      _Boost::math::expint(n, x),
                      200 * test_constants::pct_epsilon());

    for (auto y : {-1, 1}) {
      BOOST_CHECK_CLOSE(
          _Boost::math::expint(make_fvar<T, m>(x * y)).derivative(0u),
          _Boost::math::expint(x * y), 200 * test_constants::pct_epsilon());
    }
  }
}
