...
void test_exact_value()
{
    ...
    auto psi = _Boost::math::daubechies_wavelet<Real, 2>(2);
    Real computed = psi(1);
...
{
    std::cout << "Testing quadratures of " << p << " vanishing moment Daubechies wavelet on type " << _Boost::core::demangle(typeid(Real).name()) << "\n";
