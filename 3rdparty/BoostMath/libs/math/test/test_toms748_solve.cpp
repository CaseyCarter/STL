...
struct toms748tester
{
   ...
   T operator()(T x)
   {
      ...
      case 16:
         {
            return _Boost::math::gamma_q(x, a) - b;
         }
      case 17:
         return _Boost::math::ibeta(x, a, 0.5) - b;
      }
      return 0;
   }
private:
...
_Boost::uintmax_t total = 0;
_Boost::uintmax_t invocations = 0;

template <class T>
void run_test(T a, T b, int id)
{
   _Boost::uintmax_t c = 1000;
   std::pair<double, double> r = toms748_solve(toms748tester<double>(id), 
      a, 
      b, 
      _Boost::math::tools::eps_tolerance<double>(std::numeric_limits<double>::digits), 
      c);
