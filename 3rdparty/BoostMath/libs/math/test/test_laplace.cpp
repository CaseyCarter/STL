...
using _Boost::math::laplace_distribution;
...
{
   RealType tolerance(_Boost::math::tools::epsilon<RealType>() * 500); // 5 eps as a percentage.
      ...
      for (int li=0; li<7; ++li)
         for (int si=0; si<3; ++si)
         {
            ...
            BOOST_CHECK_CLOSE( 
               ...
               static_cast<RealType>( s * _Boost::math::constants::root_two<RealType>() ),
               tolerance);
            ...
            RealType expected_entropy = log(2*s*_Boost::math::constants::e<RealType>());
            BOOST_CHECK_CLOSE(
...
void test_bad_dist_parameters()
{
   ...
   _Boost::math::laplace lp2(0.5); // Using typedef. 
#ifndef BOOST_NO_EXCEPTIONS
   BOOST_MATH_CHECK_THROW(_Boost::math::laplace_distribution<RealType> lbad1(0, 0), std::domain_error);
   BOOST_MATH_CHECK_THROW(_Boost::math::laplace_distribution<RealType> lbad2(0, -1), std::domain_error);
#else
   BOOST_MATH_CHECK_THROW(_Boost::math::laplace_distribution<RealType>(0, 0), std::domain_error);
   BOOST_MATH_CHECK_THROW(_Boost::math::laplace_distribution<RealType>(0, -1), std::domain_error);
#endif
}
...
void test_extreme_function_arguments()
{
   ...
   using _Boost::math::tools::max_value;  // In case std::numeric_limits<RealType>::max() is not defined.
