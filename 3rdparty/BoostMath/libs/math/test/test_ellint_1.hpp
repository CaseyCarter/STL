...
void do_test_ellint_f(T& data, const char* type_name, const char* test)
{
   ...
   value_type(*fp2)(value_type, value_type) = ELLINT_1_FUNCTION_TO_TEST;
    ...
    value_type (*fp2)(value_type, value_type) = _Boost::math::ellint_1<value_type, value_type>;
#else
    value_type (*fp2)(value_type, value_type) = _Boost::math::ellint_1;
#endif
...
#elif defined(BOOST_MATH_NO_DEDUCED_FUNCTION_POINTERS)
   value_type (*fp1)(value_type) = _Boost::math::ellint_1<value_type>;
#else
   value_type (*fp1)(value_type) = _Boost::math::ellint_1;
#endif
   result = _Boost::math::tools::test_hetero<Real>(
      data,
...
void test_spots(T, const char* type_name)
{
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 22> data1 = {{
...
#include "ellint_f_data.ipp"
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 2>, 9> data2 = {{
...
#include "ellint_k_data.ipp"
    ...
    // Test error handling:
    //
    BOOST_CHECK_GE(_Boost::math::ellint_1(T(1)), _Boost::math::tools::max_value<T>());
    BOOST_CHECK_GE(_Boost::math::ellint_1(T(-1)), _Boost::math::tools::max_value<T>());
    BOOST_CHECK_THROW(_Boost::math::ellint_1(T(1.0001)), std::domain_error);
    BOOST_CHECK_THROW(_Boost::math::ellint_1(T(-1.0001)), std::domain_error);
    BOOST_CHECK_THROW(_Boost::math::ellint_1(T(2.2), T(0.5)), std::domain_error);
    BOOST_CHECK_THROW(_Boost::math::ellint_1(T(-2.2), T(0.5)), std::domain_error);
}
