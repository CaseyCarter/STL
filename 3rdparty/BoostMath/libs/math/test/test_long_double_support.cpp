...
void test_spots()
{
   ...
   // COS:
   //
   _Boost::array<_Boost::array<long double, 2>, 4> cos_test_data = {{
      {{ 0, 1, }},
   ...
   // SIN:
   //
   _Boost::array<_Boost::array<long double, 2>, 6> sin_test_data = {{
      {{ 0, 0, }},
   ...
   // TAN:
   //
   _Boost::array<_Boost::array<long double, 2>, 6> tan_test_data = {{
      {{ 0, 0, }},
   ...
   // EXP:
   //
   _Boost::array<_Boost::array<long double, 2>, 16> exp_test_data = {{
      {{ 0, 1, }},
   ...
   // SQRT:
   //
   _Boost::array<_Boost::array<long double, 2>, 8> sqrt_test_data = {{
      {{ 1, 1, }},
   ...
   // POW:
   //
   _Boost::array<_Boost::array<long double, 3>, 40> pow_test_data = { {
   ...
   // LDEXP:
   //
   _Boost::array<_Boost::array<long double, 2>, 20> ld_data = { {
   ...
   // Sinh:
   //
   _Boost::array<_Boost::array<long double, 2>, 20> sinh_data = { {
   ...
   // Cosh:
   //
   _Boost::array<_Boost::array<long double, 2L>, 20L> cosh_data = { {
   ...
   // Tanh:
   //
   _Boost::array<_Boost::array<long double, 2L>, 20L> tanh_data = { {
   ...
   // ABS, FABS:
   //
   _Boost::array<_Boost::array<long double, 2L>, 20L> abs_data = { {
