...
void do_test_ellint_rf(T& data, const char* type_name, const char* test)
{
   ...
   value_type(*fp)(value_type, value_type, value_type) = ELLINT_RF_FUNCTION_TO_TEST;
    ...
    value_type (*fp)(value_type, value_type, value_type) = _Boost::math::ellint_rf<value_type, value_type, value_type>;
#else
    value_type (*fp)(value_type, value_type, value_type) = _Boost::math::ellint_rf;
#endif
...
#elif defined(BOOST_MATH_NO_DEDUCED_FUNCTION_POINTERS)
    value_type (*fp)(value_type, value_type) = _Boost::math::ellint_rc<value_type, value_type>;
#else
    value_type (*fp)(value_type, value_type) = _Boost::math::ellint_rc;
#endif
    _Boost::math::tools::test_result<value_type> result;
...
#elif defined(BOOST_MATH_NO_DEDUCED_FUNCTION_POINTERS)
    value_type (*fp)(value_type, value_type, value_type, value_type) = _Boost::math::ellint_rj<value_type, value_type, value_type, value_type>;
#else
    value_type (*fp)(value_type, value_type, value_type, value_type) = _Boost::math::ellint_rj;
#endif
    _Boost::math::tools::test_result<value_type> result;
...
#elif defined(BOOST_MATH_NO_DEDUCED_FUNCTION_POINTERS)
    value_type (*fp)(value_type, value_type, value_type) = _Boost::math::ellint_rd<value_type, value_type, value_type>;
#else
    value_type (*fp)(value_type, value_type, value_type) = _Boost::math::ellint_rd;
#endif
    _Boost::math::tools::test_result<value_type> result;
...
#elif defined(BOOST_MATH_NO_DEDUCED_FUNCTION_POINTERS)
   value_type(*fp)(value_type, value_type, value_type) = _Boost::math::ellint_rg<value_type, value_type, value_type>;
#else
   value_type(*fp)(value_type, value_type, value_type) = _Boost::math::ellint_rg;
#endif
   _Boost::math::tools::test_result<value_type> result;
...
void test_spots(T val, const char* type_name)
{
   ...
   // RC:
   BOOST_CHECK_CLOSE_FRACTION(ellint_rc(T(0), T(1)/4), _Boost::math::constants::pi<T>(), eps2);
   BOOST_CHECK_CLOSE_FRACTION(ellint_rc(T(9)/4, T(2)), _Boost::math::constants::ln_two<T>(), eps2);
   BOOST_CHECK_CLOSE_FRACTION(ellint_rc(T(1) / 4, T(-2)), _Boost::math::constants::ln_two<T>() / 3, eps2);
   // RJ:
   ...
   // Elliptic Integrals, B. C. Carlson: http://arxiv.org/abs/math.CA/9409227
   _Boost::mt19937 ran;
   _Boost::uniform_real<float> ur(0, 1000);
