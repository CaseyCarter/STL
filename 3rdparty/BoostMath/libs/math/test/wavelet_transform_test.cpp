...
using _Boost::math::quadrature::daubechies_wavelet_transform;
using _Boost::math::quadrature::trapezoidal;

template<typename Real, int p>
void test_wavelet_transform()
{
    std::cout << "Testing wavelet transform of " << p << " vanishing moment Daubechies wavelet on type " << _Boost::core::demangle(typeid(Real).name()) << "\n";
...
int main()
{
    _Boost::hana::for_each(std::make_index_sequence<17>(), [&](auto i) {
