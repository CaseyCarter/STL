...
void test_spots(T)
{
   ...
   {
      BOOST_CHECK_CLOSE(
         ::_Boost::math::falling_factorial(static_cast<T>(-30.75Q), 30),
         static_cast<T>(naive_falling_factorial(-30.75Q, 30)),
         tolerance * 3);
      BOOST_CHECK_CLOSE(
         ::_Boost::math::falling_factorial(static_cast<T>(-30.75Q), 27),
...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   test_spots(0.0Q);
   cout << "max factorial for __float128"  << _Boost::math::max_factorial<_Boost::floatmax_t>::value  << endl;
}
