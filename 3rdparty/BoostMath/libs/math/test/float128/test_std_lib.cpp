...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   //
   _Boost::float128_t tol = std::numeric_limits<_Boost::float128_t>::epsilon() * 4;
   _Boost::float128_t pi = BOOST_FLOAT128_C(3.14159265358979323846264338327950288419716939937510582097494459230781640628620899862803482534211);
   ...
   //
   std::complex<_Boost::floatmax_t> cm(2.5, 3.5);
   ...
   BOOST_CHECK_EQUAL(conj(cm), std::complex<_Boost::floatmax_t>(2.5, -3.5));
   BOOST_CHECK_EQUAL(proj(cm), cm);
   if (std::numeric_limits<_Boost::floatmax_t>::has_infinity)
   {
      _Boost::floatmax_t m = (std::numeric_limits<_Boost::floatmax_t>::max)();
      _Boost::floatmax_t n = (std::numeric_limits<_Boost::floatmax_t>::quiet_NaN)();
      _Boost::floatmax_t i = std::numeric_limits<_Boost::floatmax_t>::infinity();
      std::complex<_Boost::floatmax_t> ci(i, 0);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(i, 2.5)), ci);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(i, -2.5)), std::conj(ci));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-i, 2.5)), ci);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-i, -2.5)), std::conj(ci));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(2.5, i)), ci);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-2.5, i)), ci);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(2.5, -i)), std::conj(ci));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-2.5, -i)), std::conj(ci));
      // If there's a NaN and an infinity, then we treat it as an infinity:
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(i, n)), ci);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-i, n)), ci);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(n, i)), ci);
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(n, -i)), std::conj(ci));
      // Maximum values should not be detected as infinities:
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(m, 2.5)), std::complex<_Boost::floatmax_t>(m, 2.5));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(m, -2.5)), std::complex<_Boost::floatmax_t>(m, -2.5));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-m, 2.5)), std::complex<_Boost::floatmax_t>(-m, 2.5));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-m, -2.5)), std::complex<_Boost::floatmax_t>(-m, -2.5));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(2.5, m)), std::complex<_Boost::floatmax_t>(2.5, m));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-2.5, m)), std::complex<_Boost::floatmax_t>(-2.5, m));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(2.5, -m)), std::complex<_Boost::floatmax_t>(2.5, -m));
      BOOST_CHECK_EQUAL(proj(std::complex<_Boost::floatmax_t>(-2.5, -m)), std::complex<_Boost::floatmax_t>(-2.5, -m));
   }
