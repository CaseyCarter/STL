...
#ifdef TEST_OTHER
namespace other{
   _Boost::math::concepts::real_concept tgamma(_Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept lgamma(_Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept gamma_q(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept gamma_p(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept gamma_p_inv(_Boost::math::concepts::real_concept x, _Boost::math::concepts::real_concept y){ return 0; }
   _Boost::math::concepts::real_concept gamma_q_inv(_Boost::math::concepts::real_concept x, _Boost::math::concepts::real_concept y){ return 0; }
}
#endif
