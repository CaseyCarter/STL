...
void do_test_cyl_bessel_k(const T& data, const char* type_name, const char* test_name)
{
   ...
   pg funcp = _Boost::math::cyl_bessel_k<value_type, value_type>;
#else
   pg funcp = _Boost::math::cyl_bessel_k;
#endif
...
void test_bessel(T, const char* name)
{
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 9> k0_data = {{
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 9> k1_data = {{
