...
T get_random()
{
   ...
   //
   int bits = _Boost::math::tools::digits<T>();
   int shift = 0;
...
void check_within_half(T a, U u)
{
   ...
   {
      BOOST_ERROR("Rounded result was towards zero with _Boost::round");
      std::cerr << "Values were: " << std::setprecision(35) << std::setw(40)
         << std::left << a << u << std::endl;
   }
}
...
void check_trunc_result(T a, U u)
{
   ...
   {
      BOOST_ERROR("Rounded result was away from zero with _Boost::trunc");
      std::cerr << "Values were: " << std::setprecision(35) << std::setw(40)
         << std::left << a << u << std::endl;
   }
}
...
void check_modf_result(T a, T fract, U ipart)
{
   ...
   if((_Boost::math::sign(a) != _Boost::math::sign(fract)) && _Boost::math::sign(fract))
   {
      BOOST_ERROR("Original and fractional parts have differing signs");
      std::cerr << "Values were: " << std::setprecision(35) << " "
         << std::left << a << ipart << " " << fract << std::endl;
   }
   if((_Boost::math::sign(a) != _Boost::math::sign(ipart)) && _Boost::math::sign(ipart))
   {
...
void test_round_number(T arg)
{
   ...
   using _Boost::math::llround;  using _Boost::math::lltrunc;
#endif
...
#ifdef BOOST_HAS_LONG_LONG
   if(abs(r) < (std::numeric_limits<_Boost::long_long_type>::max)())
   {
      _Boost::long_long_type ll = llround(arg);
      check_within_half(arg, ll);
      ll = lltrunc(arg);
      check_trunc_result(arg, T(ll));
      r = _Boost::math::modf(arg, &ll);
      check_modf_result(arg, r, ll);
   }
   if(std::numeric_limits<T>::digits >= std::numeric_limits<_Boost::long_long_type>::digits)
   {
      _Boost::long_long_type j = llround(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::max)()));
      check_within_half(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::max)()), j);
      j = llround(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::min)()));
      check_within_half(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::min)()), j);
      j = lltrunc(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::max)()));
      check_trunc_result(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::max)()), T(j));
      j = lltrunc(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::min)()));
      check_trunc_result(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::min)()), T(j));
   }
#endif
}
...
void test_round(T, const char* name )
{
   ...
   //
   BOOST_MATH_CHECK_THROW(iround(static_cast<T>(1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(iround(static_cast<T>(-1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(lround(static_cast<T>(1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(lround(static_cast<T>(-1e20)), _Boost::math::rounding_error);
#ifdef BOOST_HAS_LONG_LONG
   BOOST_MATH_CHECK_THROW(llround(static_cast<T>(1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(llround(static_cast<T>(-1e20)), _Boost::math::rounding_error);
#endif
   if(std::numeric_limits<T>::has_infinity)
   {
      BOOST_MATH_CHECK_THROW(round(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(iround(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(iround(-std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(lround(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(lround(-std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
   #ifdef BOOST_HAS_LONG_LONG
      BOOST_MATH_CHECK_THROW(llround(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(llround(-std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
   #endif
   }
   if(std::numeric_limits<T>::has_quiet_NaN)
   {
      BOOST_MATH_CHECK_THROW(round(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(iround(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(lround(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
   #ifdef BOOST_HAS_LONG_LONG
      BOOST_MATH_CHECK_THROW(llround(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
   #endif
   }
   BOOST_MATH_CHECK_THROW(itrunc(static_cast<T>(1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(itrunc(static_cast<T>(-1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(ltrunc(static_cast<T>(1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(ltrunc(static_cast<T>(-1e20)), _Boost::math::rounding_error);
#ifdef BOOST_HAS_LONG_LONG
   BOOST_MATH_CHECK_THROW(lltrunc(static_cast<T>(1e20)), _Boost::math::rounding_error);
   BOOST_MATH_CHECK_THROW(lltrunc(static_cast<T>(-1e20)), _Boost::math::rounding_error);
#endif
   if(std::numeric_limits<T>::has_infinity)
   {
      BOOST_MATH_CHECK_THROW(trunc(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(itrunc(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(itrunc(-std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(ltrunc(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(ltrunc(-std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
   #ifdef BOOST_HAS_LONG_LONG
      BOOST_MATH_CHECK_THROW(lltrunc(std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(lltrunc(-std::numeric_limits<T>::infinity()), _Boost::math::rounding_error);
   #endif
   }
   if(std::numeric_limits<T>::has_quiet_NaN)
   {
      BOOST_MATH_CHECK_THROW(trunc(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(itrunc(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(ltrunc(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
   #ifdef BOOST_HAS_LONG_LONG
      BOOST_MATH_CHECK_THROW(lltrunc(std::numeric_limits<T>::quiet_NaN()), _Boost::math::rounding_error);
   #endif
   }
   if(std::numeric_limits<T>::digits >= std::numeric_limits<int>::digits)
   {
      BOOST_MATH_CHECK_THROW(itrunc(static_cast<T>((std::numeric_limits<int>::max)()) + 1), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(itrunc(static_cast<T>((std::numeric_limits<int>::min)()) - 1), _Boost::math::rounding_error);
   }
   if(std::numeric_limits<T>::digits >= std::numeric_limits<long>::digits)
   {
      BOOST_MATH_CHECK_THROW(ltrunc(static_cast<T>((std::numeric_limits<long>::max)()) + 1), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(ltrunc(static_cast<T>((std::numeric_limits<long>::min)()) - 1), _Boost::math::rounding_error);
   }
#ifndef BOOST_NO_LONG_LONG
   if(std::numeric_limits<T>::digits >= std::numeric_limits<_Boost::long_long_type>::digits)
   {
      BOOST_MATH_CHECK_THROW(lltrunc(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::max)()) + 1), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(lltrunc(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::min)()) - 1), _Boost::math::rounding_error);
   }
#endif
   if(std::numeric_limits<T>::digits >= std::numeric_limits<int>::digits)
   {
      BOOST_MATH_CHECK_THROW(iround(static_cast<T>((std::numeric_limits<int>::max)()) + 1), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(iround(static_cast<T>((std::numeric_limits<int>::min)()) - 1), _Boost::math::rounding_error);
   }
   if(std::numeric_limits<T>::digits >= std::numeric_limits<long>::digits)
   {
      BOOST_MATH_CHECK_THROW(lround(static_cast<T>((std::numeric_limits<long>::max)()) + 1), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(lround(static_cast<T>((std::numeric_limits<long>::min)()) - 1), _Boost::math::rounding_error);
   }
#ifndef BOOST_NO_LONG_LONG
   if(std::numeric_limits<T>::digits >= std::numeric_limits<_Boost::long_long_type>::digits)
   {
      BOOST_MATH_CHECK_THROW(llround(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::max)()) + 1), _Boost::math::rounding_error);
      BOOST_MATH_CHECK_THROW(llround(static_cast<T>((std::numeric_limits<_Boost::long_long_type>::min)()) - 1), _Boost::math::rounding_error);
   }
#endif
   //
   // try non-throwing error handlers:
   //
   _Boost::math::policies::policy<_Boost::math::policies::rounding_error<_Boost::math::policies::ignore_error> > pol;
   ...
   //
   T half = 0.5f;
   half = _Boost::math::float_prior(half);
   test_round_number(half);
   half = -0.5f;
   half = _Boost::math::float_next(half);
   test_round_number(half);
...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   test_round(_Boost::math::concepts::real_concept(0.1), "real_concept");
#else
   ...
   BOOST_CHECK_EQUAL(_Boost::math::round(-0.4999999701976776123046875f), 0.0f);

   test_round_number(0.4999999701976776123046875f);
   BOOST_CHECK_EQUAL(_Boost::math::round(0.4999999701976776123046875f), 0.0f);

   BOOST_CHECK_EQUAL(_Boost::math::round(-0.499999999999999944488848768742172978818416595458984375), 0.0);
   ...
   BOOST_CHECK_EQUAL(_Boost::math::round(-16777215.0f), -16777215.0f);
   test_round_number(-16777215.0f);

   BOOST_CHECK_EQUAL(_Boost::math::round(-16777213.0f), -16777213.0f);
   test_round_number(-16777213.0f);

   BOOST_CHECK_EQUAL(_Boost::math::round(-8388611.0f), -8388611.0f);
   test_round_number(-8388611.0f);

   BOOST_CHECK_EQUAL(_Boost::math::round(-8388609.0f), -8388609.0f);
   ...
   BOOST_CHECK_EQUAL(_Boost::math::round(-9007199254740993.0), -9007199254740993.0);
   test_round_number(-9007199254740993.0);

   BOOST_CHECK_EQUAL(_Boost::math::round(-9007199254740991.0), -9007199254740991.0);
   test_round_number(-9007199254740991.0);

   BOOST_CHECK_EQUAL(_Boost::math::round(-4503599627370499.0), -4503599627370499.0);
   test_round_number(-4503599627370499.0);

   BOOST_CHECK_EQUAL(_Boost::math::round(-4503599627370497.0), -4503599627370497.0);
