...
void do_test_digamma(const T& data, const char* type_name, const char* test_name)
{
   ...
   pg funcp = _Boost::math::digamma<value_type>;
#else
   pg funcp = _Boost::math::digamma;
#endif
...
#  include "digamma_neg_data.ipp"
   ...
   do_test_digamma<T>(digamma_neg_data, name, "Digamma Function: Negative Values");
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 2>, 5> digamma_bugs = {{
   ...
   static const _Boost::array<_Boost::array<typename table_type<T>::type, 2>, 40> digamma_integers = { {
   ...
   static const _Boost::array<_Boost::array<typename table_type<T>::type, 2>, 41> digamma_half_integers = { {
   ...
   BOOST_MATH_CHECK_THROW(_Boost::math::digamma(T(0)), std::domain_error);
   BOOST_MATH_CHECK_THROW(_Boost::math::digamma(T(-1)), std::domain_error);
   BOOST_MATH_CHECK_THROW(_Boost::math::digamma(T(-2)), std::domain_error);
}
