...
//BOOST_STATIC_ASSERT((_Boost::is_same<mpfr::mpreal, _Boost::math::tools::promote_args<mpfr::mpreal>::type >::value));
...
int main()
{
   BOOST_CONCEPT_ASSERT((_Boost::math::concepts::RealTypeConcept<mpfr::mpreal>));
   return 0;
}
