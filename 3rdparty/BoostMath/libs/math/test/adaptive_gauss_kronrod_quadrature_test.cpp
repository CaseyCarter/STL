...
{
   return _Boost::math::tools::epsilon<Real>() * 1000;
}
...
void test_integration_over_real_line()
{
    ...
    Q = gauss_kronrod<Real, Points>::integrate(f1, -_Boost::math::tools::max_value<Real>(), _Boost::math::tools::max_value<Real>(), 15, get_termination_condition<Real>(), &error, &L1);
    Q_expected = pi<Real>();
    BOOST_CHECK_CLOSE_FRACTION(Q, Q_expected, tol);
    BOOST_CHECK_CLOSE_FRACTION(L1, Q_expected, tol);
    BOOST_CHECK_LE(fabs(error / Q), get_termination_condition<Real>());
    ...
    Q = gauss_kronrod<Real, Points>::integrate(f4, -_Boost::math::tools::max_value<Real>(), _Boost::math::tools::max_value<Real>(), 15, get_termination_condition<Real>(), &error, &L1);
    Q_expected = pi<Real>();
    BOOST_CHECK_CLOSE_FRACTION(Q, Q_expected, tol);
    BOOST_CHECK_CLOSE_FRACTION(L1, Q_expected, tol);
    BOOST_CHECK_LE(fabs(error / Q), get_termination_condition<Real>());
...
void test_right_limit_infinite()
{
    ...
    // Example 11:
    auto f1 = [](const Real& t) { return 1/(1+t*t);};
    Q = gauss_kronrod<Real, Points>::integrate(f1, 0, _Boost::math::tools::max_value<Real>(), 15, get_termination_condition<Real>(), &error, &L1);
    Q_expected = half_pi<Real>();
    BOOST_CHECK_CLOSE(Q, Q_expected, 100*tol);
    BOOST_CHECK_LE(fabs(error / Q), get_termination_condition<Real>());

    auto f4 = [](const Real& t) { return 1/(1+t*t); };
    Q = gauss_kronrod<Real, Points>::integrate(f4, 1, _Boost::math::tools::max_value<Real>(), 15, get_termination_condition<Real>(), &error, &L1);
...
void test_left_limit_infinite()
{
    ...
    // Example 11:
    auto f1 = [](const Real& t) { return 1/(1+t*t);};
    Q = gauss_kronrod<Real, Points>::integrate(f1, -_Boost::math::tools::max_value<Real>(), 0);
    Q_expected = half_pi<Real>();
