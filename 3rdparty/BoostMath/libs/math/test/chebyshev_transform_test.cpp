...
using _Boost::math::chebyshev_transform;
...
void test_sinc_chebyshev_transform()
{
    ...
    auto f = [](Real x) { return _Boost::math::sinc_pi(x); };
    Real a = 0;
    Real b = 1;
    ...
    Real Q_exp = _Boost::lexical_cast<Real>("0.94608307036718301494135331382317965781233795473811179047145477356668");
