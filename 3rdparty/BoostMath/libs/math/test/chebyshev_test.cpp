...
using _Boost::math::chebyshev_t;
using _Boost::math::chebyshev_t_prime;
using _Boost::math::chebyshev_u;

template<class Real>
void test_polynomials()
{
    std::cout << "Testing explicit polynomial representations of the Chebyshev polynomials on type " << _Boost::typeindex::type_id<Real>().pretty_name()  << "\n";
...
{
    std::cout << "Testing explicit polynomial representations of the Chebyshev polynomial derivatives on type " << _Boost::typeindex::type_id<Real>().pretty_name()  << "\n";
...
void test_clenshaw_recurrence()
{
    ...
    _Boost::array<Real, 5> c0 = { {2, 0, 0, 0, 0} };
    // Check the size = 1 case:
    _Boost::array<Real, 1> c01 = { {2} };
    // Check the size = 2 case:
    _Boost::array<Real, 2> c02 = { {2, 0} };
    _Boost::array<Real, 4> c1 = { {0, 1, 0, 0} };
    _Boost::array<Real, 4> c2 = { {0, 0, 1, 0} };
    _Boost::array<Real, 5> c3 = { {0, 0, 0, 1, 0} };
    _Boost::array<Real, 5> c4 = { {0, 0, 0, 0, 1} };
    _Boost::array<Real, 6> c5 = { {0, 0, 0, 0, 0, 1} };
    _Boost::array<Real, 7> c6 = { {0, 0, 0, 0, 0, 0, 1} };
