...
#include <boost/math/distributions/lognormal.hpp>
    using _Boost::math::lognormal_distribution;
...
void test_spots(RealType)
{
   ...
   for(RealType x = -15; x < 5; x += 0.125)
   {
      BOOST_CHECK_CLOSE(
         ...
         pdf(_Boost::math::normal_distribution<RealType>(-5, 6), x) / exp(x),
         tolerance);
   }
   ...
   RealType expected_entropy = 8 + log(_Boost::math::constants::two_pi<RealType>()*_Boost::math::constants::e<RealType>()*9)/2;
   BOOST_CHECK_CLOSE(
    entropy(dist)
...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   _Boost::math::lognormal myf1(1., 2); // Using typedef
...
Tolerance for type long double is 1.11022e-013 %
Tolerance for type class _Boost::math::concepts::real_concept is 0.5 %
