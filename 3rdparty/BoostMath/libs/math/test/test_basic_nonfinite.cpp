...
template<class CharType, class ValType> void basic_test_inf_impl()
{
    ...
    BOOST_CHECK((_Boost::math::isinf)(a1));
    BOOST_CHECK((_Boost::math::isinf)(a2));
...
template<class CharType, class ValType> void basic_test_nan_impl()
{
    ...
    ValType a2 = (_Boost::math::changesign)(std::numeric_limits<ValType>::quiet_NaN());
    ValType a3 = std::numeric_limits<ValType>::signaling_NaN();
    ValType a4 = (_Boost::math::changesign)(std::numeric_limits<ValType>::signaling_NaN());
    ss << a1 << ' ' << a2 << ' ' << a3 << ' ' << a4;

    BOOST_CHECK((_Boost::math::isnan)(a1) && (_Boost::math::isnan)(a2) && (_Boost::math::isnan)(a3) && (_Boost::math::isnan)(a4));
...
template<class CharType, class ValType> void basic_test_format_impl()
{
    ...
    BOOST_CHECK((_Boost::math::isinf)(a));
