...
BOOST_STATIC_ASSERT((_Boost::is_same<_Boost::math::constants::construction_traits<float, _Boost::math::policies::policy<> >::type, _Boost::integral_constant<int, _Boost::math::constants::construct_from_float> >::value));
BOOST_STATIC_ASSERT((_Boost::is_same<_Boost::math::constants::construction_traits<double, _Boost::math::policies::policy<> >::type, _Boost::integral_constant<int, _Boost::math::constants::construct_from_double> >::value));
BOOST_STATIC_ASSERT((_Boost::is_same<_Boost::math::constants::construction_traits<long double, _Boost::math::policies::policy<> >::type, _Boost::integral_constant<int, (sizeof(double) == sizeof(long double) ? _Boost::math::constants::construct_from_double : _Boost::math::constants::construct_from_long_double)> >::value));
BOOST_STATIC_ASSERT((_Boost::is_same<_Boost::math::constants::construction_traits<_Boost::math::concepts::real_concept, _Boost::math::policies::policy<> >::type, _Boost::integral_constant<int, 0> >::value));

// Policy to set precision at maximum possible using long double.
typedef _Boost::math::policies::policy<_Boost::math::policies::digits2<std::numeric_limits<long double>::digits> > real_concept_policy_1;
...
typedef _Boost::math::policies::policy<_Boost::math::policies::digits2<115> > real_concept_policy_2;
#else
typedef _Boost::math::policies::policy<_Boost::math::policies::digits2<std::numeric_limits<long double>::digits + 2> > real_concept_policy_2;
#endif
// Policy with precision greater than the string representations, forces computation of values (i.e. different code path):
typedef _Boost::math::policies::policy<_Boost::math::policies::digits2<400> > real_concept_policy_3;

BOOST_STATIC_ASSERT((_Boost::is_same<_Boost::math::constants::construction_traits<_Boost::math::concepts::real_concept, real_concept_policy_1 >::type, _Boost::integral_constant<int, (sizeof(double) == sizeof(long double) ? _Boost::math::constants::construct_from_double : _Boost::math::constants::construct_from_long_double) > >::value));
BOOST_STATIC_ASSERT((_Boost::is_same<_Boost::math::constants::construction_traits<_Boost::math::concepts::real_concept, real_concept_policy_2 >::type, _Boost::integral_constant<int, _Boost::math::constants::construct_from_string> >::value));
BOOST_STATIC_ASSERT((_Boost::math::constants::construction_traits<_Boost::math::concepts::real_concept, real_concept_policy_3>::type::value >= 5));
...
{
   return 2 * _Boost::math::constants::max_string_digits;
}
...
void test_spots(RealType)
{
  ...
  typedef typename _Boost::math::constants::construction_traits<RealType, _Boost::math::policies::policy<> >::type construction_type;
   RealType tolerance = (std::max)(static_cast<RealType>(_Boost::math::tools::epsilon<long double>()), _Boost::math::tools::epsilon<RealType>()) * 2;  // double
   if((construction_type::value == 0) && (_Boost::math::tools::digits<RealType>() > _Boost::math::constants::max_string_digits))
   ...
   //typedef typename _Boost::math::policies::precision<RealType, _Boost::math::policies::policy<> >::type t1;
   ...
   //
   if(_Boost::math::tools::digits<RealType>() > _Boost::math::constants::max_string_digits)
   {
...
{
   // Basic sanity checks for constants in _Boost::math::float_constants::
   // for example: _Boost::math::float_constants::pi
   // (rather than _Boost::math::constants::pi<float>() ).

   float tolerance = _Boost::math::tools::epsilon<float>() * 2;

   using namespace _Boost::math::float_constants;
   BOOST_MATH_STD_USING
...
{
   // Basic sanity checks for constants in _Boost::math::double_constants::
   // for example: _Boost::math::double_constants::pi
   // (rather than _Boost::math::constants::pi<double>() ).

   double tolerance = _Boost::math::tools::epsilon<double>() * 2;

   using namespace _Boost::math::double_constants;
   BOOST_MATH_STD_USING
...
{
   // Basic sanity checks for constants in _Boost::math::long double_constants::
   // for example: _Boost::math::long_double_constants::pi
   // (rather than _Boost::math::constants::pi<long double>() ).
  ...
  // or calculations using long double (sometime a little less accurate).
   ...
   long double tolerance = _Boost::math::tools::epsilon<long double>() * 2;

   using namespace _Boost::math::long_double_constants;
   BOOST_MATH_STD_USING
...
void test_real_concept_policy(const Policy&)
{
   ...
   _Boost::math::concepts::real_concept tolerance = _Boost::math::tools::epsilon<real_concept>() * 2;  // double
   if(Policy::precision_type::value > 200)
      tolerance *= 50;
   std::cout << "Tolerance for type " << typeid(real_concept).name()  << " is " << tolerance << "." << std::endl;

   //typedef typename _Boost::math::policies::precision<_Boost::math::concepts::real_concept, _Boost::math::policies::policy<> >::type t1;
   // A precision of zero means we don't know what the precision of this type is until runtime.
   //std::cout << "Precision for type " << typeid(_Boost::math::concepts::real_concept).name()  << " is " << t1::value << "." << std::endl;
   ...
   // Last of all come the test cases that behave differently if we're calculating the constants on the fly:
   //
   if(_Boost::math::tools::digits<real_concept>() > _Boost::math::constants::max_string_digits)
   {
      // This suffers from cancellation error, so increased tolerance:
...
} // template <class _Boost::math::concepts::real_concept>void test_spots(_Boost::math::concepts::real_concept)
...
void test_float128()
{
   ...
   __float128 p = _Boost::math::constants::pi<__float128>();
...
void test_constexpr()
{
   ...
   constexpr float f1 = _Boost::math::constants::pi<float>();
   constexpr double f2 = _Boost::math::constants::pi<double>();
   constexpr long double f3 = _Boost::math::constants::pi<long double>();
   constexpr float fval2 = _Boost::math::float_constants::pi;
   constexpr double dval2 = _Boost::math::double_constants::pi;
   constexpr long double ldval2 = _Boost::math::long_double_constants::pi;
   (void)f1;
   (void)f2;
   (void)f3;
   (void) fval2;
   ...
   (void) ldval2;
#ifdef BOOST_MATH_USE_FLOAT128
   constexpr __float128 f4 = _Boost::math::constants::pi<__float128>();
   (void)f4;
#endif
#endif
}
...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   test_float_spots(); // Test float_constants, like _Boost::math::float_constants::pi;
   ...
   test_real_concept_policy(_Boost::math::policies::policy<>()); // Default.
#endif
   ...
   test_spots(_Boost::math::concepts::big_real_concept(0.)); // Test real concept.
#endif
#else
...
test_constants.cpp
  ...
  Running 1 test case...
  Tolerance for type class _Boost::math::concepts::real_concept is 4.44089e-016.
  Tolerance for type class _Boost::math::concepts::real_concept is 4.44089e-016.
  Tolerance for type class _Boost::math::concepts::real_concept is 4.44089e-016.
  ...
  Tolerance for type class _Boost::math::concepts::real_concept is 4.44089e-016.
  Tolerance for type class _Boost::math::concepts::big_real_concept is 1.33227e-014.
