...
using _Boost::math::differentiation::discrete_lanczos_derivative;
using _Boost::math::differentiation::detail::discrete_legendre;
using _Boost::math::differentiation::detail::interior_velocity_filter;
using _Boost::math::differentiation::detail::boundary_velocity_filter;
...
void test_acceleration_filters()
{
    ...
    for (size_t n = 1; n < 5; ++n)
    {
        for(size_t p = 3; p <= 2*n; ++p)
        {
            ...
            {
                auto g = _Boost::math::differentiation::detail::acceleration_filter<long double>(n,p,s);
...
void test_data_representations()
{
    ...
    _Boost::numeric::ublas::vector<Real> w(500);
    _Boost::numeric::ublas::vector<Real> dwdt(500);
    ...
    auto v1 = _Boost::make_iterator_range(v.begin(), v.end());
    auto v2 = _Boost::make_iterator_range(dvdt.begin(), dvdt.end());
    lanczos(v1, v2);
