...
using _Boost::math::inverse_chi_squared_distribution;
...
using _Boost::math::inverse_gamma_distribution;
using _Boost::math::inverse_gamma;
//  using  ::_Boost::math::cdf;
//  using  ::_Boost::math::pdf;

#include <boost/math/special_functions/gamma.hpp> 
using _Boost::math::tgamma; // for naive pdf.
...
{
   _Boost::math::inverse_chi_squared_distribution<RealType> dist(degrees_of_freedom, scale);
...
// Tests from Mark Coleman & Georgi Boshnakov using Wolfram Mathematica.
  ...
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType> ichsqbad1(-1), std::domain_error); // negative degrees_of_freedom.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType> ichsqbad2(1, -1), std::domain_error); // negative scale.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType> ichsqbad3(-1, -1), std::domain_error); // negative scale and degrees_of_freedom.
#else
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType>(-1), std::domain_error); // negative degrees_of_freedom.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType>(1, -1), std::domain_error); // negative scale.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType>(-1, -1), std::domain_error); // negative scale and degrees_of_freedom.
#endif
  check_out_of_range<_Boost::math::inverse_chi_squared_distribution<RealType> >(1, 1);
...
#ifndef BOOST_NO_EXCEPTIONS
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType> nbad1(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType> nbad1(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType> nbad1(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#else
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType>(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType>(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_chi_squared_distribution<RealType>(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#endif
  }
  ...
  RealType tol_2eps = _Boost::math::tools::epsilon<RealType>() * 2; // 2 eps as a fraction.
  ...
  tol_2eps = _Boost::math::tools::epsilon<RealType>() * 2; // 2 eps as a percentage.
...
BOOST_AUTO_TEST_CASE( test_main )
{
  ...
  using _Boost::math::inverse_chi_squared;
   
  // Some constructor tests using default double.
  double tol4eps = _Boost::math::tools::epsilon<double>() * 4; // 4 eps as a fraction.
  ...
  */
  ...
  // and "using _Boost::math::inverse_chi_squared_distribution;".
