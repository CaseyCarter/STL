...
using namespace std;
using _Boost::integer::gcd_detail::Euclid_gcd;
using _Boost::math::tools::subresultant_gcd;
...
_Boost::array<double, 4> const d3a = {{10, -6, -4, 3}};
_Boost::array<double, 4> const d3b = {{-7, 5, 6, 1}};

_Boost::array<double, 2> const d1a = {{-2, 1}};
_Boost::array<double, 1> const d0a = {{6}};
_Boost::array<double, 2> const d0a1 = {{0, 6}};
_Boost::array<double, 6> const d0a5 = {{0, 0, 0, 0, 0, 6}};


_Boost::array<int, 9> const d8 = {{-5, 2, 8, -3, -3, 0, 1, 0, 1}};
_Boost::array<int, 9> const d8b = {{0, 2, 8, -3, -3, 0, 1, 0, 1}};
...
_Boost::array<double, 4> const d3c = {{10.0/3.0, -2.0, -4.0/3.0, 1.0}};
_Boost::array<double, 3> const d2a = {{-2, 2, 3}};
_Boost::array<double, 3> const d2b = {{-7, 5, 6}};
_Boost::array<double, 3> const d2c = {{31, -21, -22}};
_Boost::array<double, 1> const d0b = {{3}};
_Boost::array<int, 7> const d6 = {{21, -9, -4, 0, 5, 0, 3}};
_Boost::array<int, 3> const d2 = {{-6, 0, 9}};
_Boost::array<int, 6> const d5 = {{-9, 0, 3, 0, -15}};
...
struct FM2GP_Ex_8_3__1
{
    ...
    FM2GP_Ex_8_3__1()
    {
        _Boost::array<T, 5> const x_data = {{105, 278, -88, -56, 16}};
        _Boost::array<T, 5> const y_data = {{70, 232, -44, -64, 16}};
        _Boost::array<T, 3> const z_data = {{35, -24, 4}};
...
struct FM2GP_Ex_8_3__2
{
    ...
    FM2GP_Ex_8_3__2()
    {
        _Boost::array<T, 5> const x_data = {{1, -6, -8, 6, 7}};
        _Boost::array<T, 5> const y_data = {{1, -5, -2, 15, 11}};
        _Boost::array<T, 3> const z_data = {{1, 2, 1}};
        x = polynomial<T>(x_data.begin(), x_data.end());
        y = polynomial<T>(y_data.begin(), y_data.end());
        z = polynomial<T>(z_data.begin(), z_data.end());
    }
...
struct FM2GP_mixed
{
    ...
    FM2GP_mixed()
    {
        _Boost::array<T, 4> const x_data = {{-2.2, -3.3, 0, 1}};
        _Boost::array<T, 3> const y_data = {{-4.4, 0, 1}};
        _Boost::array<T, 2> const z_data= {{-2, 1}};
        x = polynomial<T>(x_data.begin(), x_data.end());
        y = polynomial<T>(y_data.begin(), y_data.end());
        z = polynomial<T>(z_data.begin(), z_data.end());
    }
...
struct FM2GP_trivial
{
    ...
    FM2GP_trivial()
    {
        _Boost::array<T, 4> const x_data = {{-2, -3, 0, 1}};
        _Boost::array<T, 3> const y_data = {{-4, 0, 1}};
        _Boost::array<T, 2> const z_data= {{-2, 1}};
        x = polynomial<T>(x_data.begin(), x_data.end());
        y = polynomial<T>(y_data.begin(), y_data.end());
        z = polynomial<T>(z_data.begin(), z_data.end());
...
#ifdef TEST1
typedef _Boost::mpl::list<char, short, int, long> integral_test_types;
typedef _Boost::mpl::list<int, long> large_integral_test_types;
typedef _Boost::mpl::list<> mp_integral_test_types;
#elif defined(TEST2)
typedef _Boost::mpl::list<
#if !BOOST_WORKAROUND(BOOST_MSVC, <= 1500)
   _Boost::multiprecision::cpp_int
#endif
> integral_test_types;
typedef integral_test_types large_integral_test_types;
typedef large_integral_test_types mp_integral_test_types;
#elif defined(TEST3)
typedef _Boost::mpl::list<> large_integral_test_types;
typedef _Boost::mpl::list<> integral_test_types;
typedef large_integral_test_types mp_integral_test_types;
#endif

#ifdef TEST1
typedef _Boost::mpl::list<double, long double> non_integral_test_types;
#elif defined(TEST2)
typedef _Boost::mpl::list<
#if !BOOST_WORKAROUND(BOOST_MSVC, <= 1500)
   _Boost::multiprecision::cpp_rational
#endif
> non_integral_test_types;
#elif defined(TEST3)
typedef _Boost::mpl::list<
#if !BOOST_WORKAROUND(BOOST_MSVC, <= 1500)
   _Boost::multiprecision::cpp_bin_float_single, _Boost::multiprecision::cpp_dec_float_50
#endif
> non_integral_test_types;
#endif

typedef _Boost::mpl::joint_view<integral_test_types, non_integral_test_types> all_test_types;
...
BOOST_AUTO_TEST_CASE_TEMPLATE( test_multiplication, T, all_test_types )
{
    ...
    polynomial<T> const b(d1a.begin(), d1a.end());
    polynomial<T> const zero;
    _Boost::array<T, 7> const d3a_sq = {{100, -120, -44, 108, -20, -24, 9}};
...
{
    _Boost::array<polynomial<T>, 4> const q={{
...
BOOST_AUTO_TEST_CASE_TEMPLATE( test_self_multiply_assign, T, all_test_types )
{
    ...
    _Boost::array<double, 7> const d3a_sq = {{100, -120, -44, 108, -20, -24, 9}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE( test_pow, T, all_test_types )
{
   if (std::numeric_limits<T>::digits < 32)
    ...
    _Boost::array<double, 7> const d3a_sqr = {{100, -120, -44, 108, -20, -24, 9}};
    _Boost::array<double, 10> const d3a_cub =
