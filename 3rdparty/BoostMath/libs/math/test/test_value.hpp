...
#define BOOST_MATH_TEST_LARGEST_FLOAT_DIGITS std::numeric_limits<_Boost::multiprecision::float128>::digits
#else
...
inline T create_test_value(largest_float val, const char*, const _Boost::true_type&, const T2&)
...
template <class T>
inline T create_test_value(largest_float, const char* str, const _Boost::false_type&, const _Boost::true_type&)
...
template <class T>
inline T create_test_value(largest_float, const char* str, const _Boost::false_type&, const _Boost::false_type&)
{ // Create test value using from lexical cast of decimal digit string const char* str.
  ...
  create_type = 3;
  #endif
  return _Boost::lexical_cast<T>(str);
}
  ...
  _Boost::integral_constant<bool, \
    std::numeric_limits<T>::is_specialized &&\
      (std::numeric_limits<T>::radix == 2)\
        ...
        && _Boost::is_convertible<largest_float, T>::value>(),\
  _Boost::integral_constant<bool, \
    _Boost::is_constructible<T, const char*>::value>()\
)
