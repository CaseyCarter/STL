...
void do_test_cyl_neumann_y_prime(const T& data, const char* type_name, const char* test_name)
{
   ...
   pg funcp = _Boost::math::cyl_neumann_prime<value_type, value_type>;
#else
   pg funcp = _Boost::math::cyl_neumann_prime;
#endif
...
T cyl_neumann_prime_int_wrapper(T v, T x)
{
   ...
   return static_cast<T>(BESSEL_YNP_FUNCTION_TO_TEST(_Boost::math::itrunc(v), x));
#else
   return static_cast<T>(_Boost::math::cyl_neumann_prime(_Boost::math::itrunc(v), x));
#endif
}
...
#elif defined(BOOST_MATH_NO_DEDUCED_FUNCTION_POINTERS)
   pg funcp = _Boost::math::sph_neumann_prime<value_type>;
#else
   pg funcp = _Boost::math::sph_neumann_prime;
#endif
...
void test_bessel_prime(T, const char* name)
{
   ...
   // 
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 9> y0_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 9> y1_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 10> yn_prime_data = {{
    ...
    static const _Boost::array<_Boost::array<T, 3>, 11> yv_prime_data = {{
        ...
        {{ SC_(8.5), _Boost::math::constants::pi<T>() * 4, SC_(0.014516314554743677558496402742690038592727861) }},
        {{ SC_(-8.5), _Boost::math::constants::pi<T>() * 4, SC_(-0.194590144622675911618596506265006877277073804) }},
    }};
    static const _Boost::array<_Boost::array<T, 3>, 7> yv_prime_large_data = {{
