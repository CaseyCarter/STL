...
{
   _Boost::math::inverse_gamma_distribution<RealType> dist(shape, scale);
...
// This test values from output from R provided by Thomas Mang.
  ...
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType> igbad1(-1, 0), std::domain_error); // negative shape.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType> igbad2(0, -1), std::domain_error); // negative scale.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType> igbad2(-1, -1), std::domain_error); // negative scale and shape.
#else
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType>(-1, 0), std::domain_error); // negative shape.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType>(0, -1), std::domain_error); // negative scale.
  BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType>(-1, -1), std::domain_error); // negative scale and shape.
#endif
...
#ifndef BOOST_NO_EXCEPTIONS
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType> nbad1(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType> nbad1(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType> nbad1(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#else
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType>(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType>(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::inverse_gamma_distribution<RealType>(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#endif
  }
  ...
  RealType tol_few_eps = _Boost::math::tools::epsilon<RealType>() * 5; // 5 eps as a fraction.
 ...
 //  cumulative hazard:
  ...
  tol_few_eps = _Boost::math::tools::epsilon<RealType>() * 3; // 3 eps as a percentage.
...
BOOST_AUTO_TEST_CASE( test_main )
{
 ...
 // }
  ...
  // and "using _Boost::math::inverse_gamma_distribution;".
  ...
  double tol5eps = _Boost::math::tools::epsilon<double>() * 5; // 5 eps as a fraction.
