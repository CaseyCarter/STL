...
using ::_Boost::math::concepts::real_concept;
#include <boost/math/tools/test.hpp> // for real_concept.

#include <boost/math/distributions/arcsine.hpp> // for arcsine_distribution.
using _Boost::math::arcsine_distribution;

#include <boost/math/constants/constants.hpp>
using _Boost::math::constants::one_div_root_two;
...
void test_ignore_policy(RealType)
{
  ...
  { // Ordinary floats only.
    ...
    if (std::numeric_limits<RealType>::has_quiet_NaN)
    {
      ...
      BOOST_CHECK((_Boost::math::isnan)(pdf(ignore_error_arcsine(0, 1), std::numeric_limits<RealType>::infinity()))); // x == infinity
      BOOST_CHECK((_Boost::math::isnan)(pdf(ignore_error_arcsine(-1, 1), std::numeric_limits<RealType>::infinity()))); // x == infinity
      BOOST_CHECK((_Boost::math::isnan)(pdf(ignore_error_arcsine(0, 1), static_cast <RealType>(-2))));  // x < xmin
      BOOST_CHECK((_Boost::math::isnan)(pdf(ignore_error_arcsine(-1, 1), static_cast <RealType>(-2))));  // x < xmin
      BOOST_CHECK((_Boost::math::isnan)(pdf(ignore_error_arcsine(0, 1), static_cast <RealType>(+2))));  // x > x_max
      BOOST_CHECK((_Boost::math::isnan)(pdf(ignore_error_arcsine(-1, 1), static_cast <RealType>(+2)))); // x > x_max

      // Mean
      BOOST_CHECK((_Boost::math::isnan)(mean(ignore_error_arcsine(-nan, 0))));
      BOOST_CHECK((_Boost::math::isnan)(mean(ignore_error_arcsine(+nan, 0))));

      if (std::numeric_limits<RealType>::has_infinity)
      {
        //BOOST_CHECK((_Boost::math::isnan)(mean(ignore_error_arcsine(-std::numeric_limits<RealType>::infinity(), 0))));
        // std::cout << "arcsine(-inf,+1) mean " << mean(ignore_error_arcsine(-std::numeric_limits<RealType>::infinity())) << std::endl;
        //BOOST_CHECK((_Boost::math::isnan)(mean(ignore_error_arcsine(std::numeric_limits<RealType>::infinity(), 0))));
      }

      // NaN constructors.
      BOOST_CHECK((_Boost::math::isnan)(mean(ignore_error_arcsine(2, nan))));
      BOOST_CHECK((_Boost::math::isnan)(mean(ignore_error_arcsine(nan, nan))));
      BOOST_CHECK((_Boost::math::isnan)(mean(ignore_error_arcsine(nan, 2))));

      // Variance
      BOOST_CHECK((_Boost::math::isnan)(variance(ignore_error_arcsine(nan, 0))));
      BOOST_CHECK((_Boost::math::isnan)(variance(ignore_error_arcsine(1, nan))));
      BOOST_CHECK((_Boost::math::isnan)(variance(ignore_error_arcsine(2, nan))));
      BOOST_CHECK((_Boost::math::isnan)(variance(ignore_error_arcsine(0, 0))));
      BOOST_CHECK((_Boost::math::isnan)(variance(ignore_error_arcsine(1, 0))));
      BOOST_CHECK((_Boost::math::isnan)(variance(ignore_error_arcsine(static_cast<RealType>(1.7L), 0))));
      BOOST_CHECK((_Boost::math::isnan)(variance(ignore_error_arcsine(2, 0))));

      // Skewness
      BOOST_CHECK((_Boost::math::isnan)(skewness(ignore_error_arcsine(nan, 0))));
      BOOST_CHECK((_Boost::math::isnan)(skewness(ignore_error_arcsine(-1, nan))));
      BOOST_CHECK((_Boost::math::isnan)(skewness(ignore_error_arcsine(0, 0))));
      BOOST_CHECK((_Boost::math::isnan)(skewness(ignore_error_arcsine(1, 0))));
      BOOST_CHECK((_Boost::math::isnan)(skewness(ignore_error_arcsine(2, 0))));
      BOOST_CHECK((_Boost::math::isnan)(skewness(ignore_error_arcsine(3, 0))));

      // Kurtosis
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(nan, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(-1, nan))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(0, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(1, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(2, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(static_cast<RealType>(2.0001L), 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(3, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis(ignore_error_arcsine(4, 0))));

      // Kurtosis excess
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(nan, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(-1, nan))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(0, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(1, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(2, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(static_cast<RealType>(2.0001L), 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(3, 0))));
      BOOST_CHECK((_Boost::math::isnan)(kurtosis_excess(ignore_error_arcsine(4, 0))));
    } // has_quiet_NaN

    //
    BOOST_CHECK(_Boost::math::isfinite(mean(ignore_error_arcsine(0, std::numeric_limits<RealType>::epsilon()))));
...
{ //! \return Infinity else max_value.
  return ((std::numeric_limits<RealType>::has_infinity) ?
     std::numeric_limits<RealType>::infinity() : _Boost::math::tools::max_value<RealType>());
}
...
{
  _Boost::math::arcsine_distribution<RealType> anarcsine(a, b);
  ...
  { // We can only check this if P is not too close to 1,
    ...
    {  // Just check quantile is very small:
      if ((std::numeric_limits<RealType>::max_exponent <= std::numeric_limits<double>::max_exponent) && (_Boost::is_floating_point<RealType>::value))
      { // Limit where this is checked: if exponent range is very large we may
        // run out of iterations in our root finding algorithm.
        BOOST_CHECK(quantile(complement(anarcsine, Q)) < _Boost::math::tools::epsilon<RealType>() * 10);
      }
    } // if x
  }
...
void test_spots(RealType)
{
    ...
    using _Boost::math::arcsine_distribution;
    using  ::_Boost::math::cdf;
    using  ::_Boost::math::pdf;
    using  ::_Boost::math::complement;
    using  ::_Boost::math::quantile;
    ...
    BOOST_CHECK_CLOSE_FRACTION(pdf(arcsine_01, tolerance),
      1 /(sqrt(tolerance) * _Boost::math::constants::pi<RealType>()), 2 * tolerance); //
    ...
    BOOST_MATH_CHECK_THROW(pdf(_Boost::math::arcsine_distribution<RealType>(0, 1), -1), std::domain_error);
    BOOST_MATH_CHECK_THROW(pdf(_Boost::math::arcsine_distribution<RealType>(-1, 1), +2), std::domain_error);
    BOOST_MATH_CHECK_THROW(quantile(_Boost::math::arcsine_distribution<RealType>(1, 1), -1), std::domain_error);
    BOOST_MATH_CHECK_THROW(quantile(_Boost::math::arcsine_distribution<RealType>(1, 1), 2), std::domain_error);
    ...
    check_out_of_range<_Boost::math::arcsine_distribution<RealType> >(-1, +1); // (All) valid constructor parameter values.
  ...
  BOOST_AUTO_TEST_CASE(test_main)
  {
    ...
    test_spots(0.0); // Test double.
      ...
      test_spots(0.0L); // Test long double.
        ...
        test_spots(_Boost::math::concepts::real_concept(0.)); // Test real concept.
      #endif
    #endif
  /*    */
  } // BOOST_AUTO_TEST_CASE( test_main )
