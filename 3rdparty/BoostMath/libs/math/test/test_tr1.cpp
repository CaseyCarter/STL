...
void test_values(float, const char* name)
{
   ...
   //
   float eps = _Boost::math::tools::epsilon<float>();
...
#ifndef TEST_LD
   double eps = _Boost::math::tools::epsilon<double>();
...
void test_values(long double, const char* name)
{
   ...
   long double eps = _Boost::math::tools::epsilon<long double>();
