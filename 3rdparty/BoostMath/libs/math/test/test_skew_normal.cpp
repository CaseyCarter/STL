...
using _Boost::math::skew_normal_distribution;
using _Boost::math::skew_normal;
...
void check_skew_normal(RealType mean, RealType scale, RealType shape, RealType x, RealType p, RealType q, RealType tol)
{
 using _Boost::math::skew_normal_distribution;
  ...
  BOOST_CHECK_CLOSE_FRACTION(
    ...
    tol);    // %tolerance.
  BOOST_CHECK_CLOSE_FRACTION(
    ::_Boost::math::quantile( // Check quantile
    skew_normal_distribution<RealType>(mean, scale, shape),    // distribution.
    p),   // probability.
    x,   // random variable.
    tol);   // tolerance.
  BOOST_CHECK_CLOSE_FRACTION(
    ::_Boost::math::quantile( // Check quantile complement
    complement(
    skew_normal_distribution<RealType>(mean, scale, shape),   // distribution.
    q)),   // probability complement.
    x,     // random variable.
...
void test_spots(RealType)
{
  ...
  // Check some bad parameters to the distribution,
   ...
   BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType> nbad1(0, 0), std::domain_error); // zero sd
   BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType> nbad1(0, -1), std::domain_error); // negative sd
#else
   BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType>(0, 0), std::domain_error); // zero sd
   BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType>(0, -1), std::domain_error); // negative sd
#endif
...
#ifndef BOOST_NO_EXCEPTIONS
    BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType> nbad1(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType> nbad1(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType> nbad1(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#else
    BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType>(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType>(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
    BOOST_MATH_CHECK_THROW(_Boost::math::skew_normal_distribution<RealType>(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#endif
  }
  ...
  BOOST_CHECK_EQUAL(kurtosis_excess(N01), 0);
   ...
   //
   tolerance = _Boost::math::tools::epsilon<RealType>() * 5; // 5 eps as a fraction
   BOOST_CHECK_CLOSE_FRACTION(
   ...
   // Checks on shape ==0
    ...
    RealType tol5 = _Boost::math::tools::epsilon<RealType>() * 5;
    ...
    // Skew_normal tests with shape != 0.
    {
      ...
      RealType tol10 = _Boost::math::tools::epsilon<RealType>() * 10 * 100;
      RealType tol100 = _Boost::math::tools::epsilon<RealType>() * 100 * 100;
      ...
      { // mode tests
       ...
       // BOOST_CHECK_CLOSE(mode(dist), _Boost::math::constants::root_two<RealType>() / 2, tol5);
...
BOOST_AUTO_TEST_CASE( test_main )
{
  ...
  _Boost::math::skew_normal w12(1., 2); // Using typedef.
  _Boost::math::skew_normal_distribution<> w01; // Use default unity values for mean and scale.
