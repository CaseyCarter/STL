...
void test_inverse_trig(T)
{
   ...
   for(x = -3; x <= 3; x += interval2)
   {
      for(y = -3; y <= 3; y += interval2)
      {
         ...
         {
            // atanh:
            val = _Boost::math::atanh(val);
            inter = tanh(val);
            result = _Boost::math::atanh(inter);
            ...
            if(!((x == 0) && (std::fabs(y) == 1))) // we can't test infinities here
            {
               ...
               val = _Boost::math::atan(val);
               inter = tan(val);
               result = _Boost::math::atan(inter);
               if(!check_complex(val, result, tanh_error))
               {
...
void check_spots(const T&)
{
   ...
   static const T pi = _Boost::math::constants::pi<T>();
   static const T half_pi = _Boost::math::constants::half_pi<T>();
   static const T quarter_pi = half_pi / 2;
   static const T three_quarter_pi = _Boost::math::constants::three_quarters_pi<T>();
   ...
   //
   result = _Boost::math::acos(ct(zero));
   check_complex(ct(half_pi), result, 2);
   
   result = _Boost::math::acos(ct(mzero));
   check_complex(ct(half_pi), result, 2);
   
   result = _Boost::math::acos(ct(zero, mzero));
   check_complex(ct(half_pi), result, 2);
   
   result = _Boost::math::acos(ct(mzero, mzero));
   check_complex(ct(half_pi), result, 2);
   
   if(test_nan)
   {
      result = _Boost::math::acos(ct(zero,nan));
      BOOST_CHECK_CLOSE(result.real(), half_pi, eps*200);
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   
      result = _Boost::math::acos(ct(mzero,nan));
      BOOST_CHECK_CLOSE(result.real(), half_pi, eps*200);
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   }
   if(test_infinity)
   {
      result = _Boost::math::acos(ct(zero, infinity));
      BOOST_CHECK_CLOSE(result.real(), half_pi, eps*200);
   ...
   if(test_nan)
   {
      result = _Boost::math::acos(ct(one, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   }
   if(test_infinity)
   {
      result = _Boost::math::acos(ct(-infinity, one));
      ...
      result = _Boost::math::acos(ct(-infinity, infinity));
   ...
   if(test_nan)
   {
      result = _Boost::math::acos(ct(infinity, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      ...
      result = _Boost::math::acos(ct(nan, zero));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::acos(ct(nan, one));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::acos(ct(nan, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));

      result = _Boost::math::acos(ct(nan, infinity));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK(result.imag() == -infinity);
   ...
   if(_Boost::math::signbit(mzero))
   {
      result = _Boost::math::acos(ct(-1.25f, zero));
      BOOST_CHECK(result.real() > 0);
      BOOST_CHECK(result.imag() < 0);
      result = _Boost::math::asin(ct(-1.75f, mzero));
      BOOST_CHECK(result.real() < 0);
      BOOST_CHECK(result.imag() < 0);
      result = _Boost::math::atan(ct(mzero, -1.75f));
      BOOST_CHECK(result.real() < 0);
      BOOST_CHECK(result.imag() < 0);

      result = _Boost::math::acos(ct(zero, zero));
      BOOST_CHECK(result.real() > 0);
      BOOST_CHECK(result.imag() == 0);
      BOOST_CHECK((_Boost::math::signbit)(result.imag()));
      result = _Boost::math::acos(ct(zero, mzero));
      BOOST_CHECK(result.real() > 0);
      BOOST_CHECK(result.imag() == 0);
      BOOST_CHECK(0 == (_Boost::math::signbit)(result.imag()));
      result = _Boost::math::acos(ct(mzero, zero));
      BOOST_CHECK(result.real() > 0);
      BOOST_CHECK(result.imag() == 0);
      BOOST_CHECK((_Boost::math::signbit)(result.imag()));
      result = _Boost::math::acos(ct(mzero, mzero));
   ...
   //
   result = _Boost::math::acosh(ct(zero, zero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK_CLOSE(result.imag(), half_pi, eps*200);

   result = _Boost::math::acosh(ct(zero, mzero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK_CLOSE(result.imag(), -half_pi, eps*200);

   result = _Boost::math::acosh(ct(mzero, zero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK_CLOSE(result.imag(), half_pi, eps*200);
   
   result = _Boost::math::acosh(ct(mzero, mzero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK_CLOSE(result.imag(), -half_pi, eps*200);
   
   if(test_infinity)
   {
      result = _Boost::math::acosh(ct(one, infinity));
   ...
   if(test_nan)
   {
      result = _Boost::math::acosh(ct(one, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   }
   if(test_infinity)
   {
      result = _Boost::math::acosh(ct(-infinity, one));
      BOOST_CHECK(result.real() == infinity);
      ...
      result = _Boost::math::acosh(ct(-infinity, infinity));
      BOOST_CHECK(result.real() == infinity);
   ...
   if(test_nan)
   {
      result = _Boost::math::acosh(ct(infinity, nan));
      BOOST_CHECK(result.real() == infinity);
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::acosh(ct(nan, one));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      
      result = _Boost::math::acosh(ct(nan, infinity));
      BOOST_CHECK(result.real() == infinity);
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::acosh(ct(nan, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   }
   if(_Boost::math::signbit(mzero))
   {
      result = _Boost::math::acosh(ct(-2.5f, zero));
      BOOST_CHECK(result.real() > 0);
      BOOST_CHECK(result.imag() > 0);
   }
   //
   ...
   //
   result = _Boost::math::asinh(ct(zero, zero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK(result.imag() == 0);

   result = _Boost::math::asinh(ct(mzero, zero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK(result.imag() == 0);

   result = _Boost::math::asinh(ct(zero, mzero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK(result.imag() == 0);

   result = _Boost::math::asinh(ct(mzero, mzero));
   BOOST_CHECK(result.real() == 0);
   BOOST_CHECK(result.imag() == 0);

   if(test_infinity)
   {
      result = _Boost::math::asinh(ct(one, infinity));
      BOOST_CHECK(result.real() == infinity);
      BOOST_CHECK_CLOSE(result.imag(), half_pi, eps*200);
   ...
   if(test_nan)
   {
      result = _Boost::math::asinh(ct(one, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::asinh(ct(zero, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   }
   ...
   if(test_infinity)
   {
      result = _Boost::math::asinh(ct(infinity, one));
      BOOST_CHECK(result.real() == infinity);
      BOOST_CHECK(result.imag() == 0);
      ...
      result = _Boost::math::asinh(ct(infinity, infinity));
      BOOST_CHECK(result.real() == infinity);
      BOOST_CHECK_CLOSE(result.imag(), quarter_pi, eps*200);
   ...
   if(test_nan)
   {
      result = _Boost::math::asinh(ct(infinity, nan));
      BOOST_CHECK(result.real() == infinity);
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::asinh(ct(nan, zero));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK(result.imag() == 0);

      result = _Boost::math::asinh(ct(nan,  mzero));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK(result.imag() == 0);

      result = _Boost::math::asinh(ct(nan, one));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::asinh(ct(nan,  nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));

      result = _Boost::math::asinh(ct(nan, infinity));
   ...
   if(_Boost::math::signbit(mzero))
   {
      result = _Boost::math::asinh(ct(zero, 1.5f));
      BOOST_CHECK(result.real() > 0);
      BOOST_CHECK(result.imag() > 0);
   }
   ...
   //
   result = _Boost::math::atanh(ct(zero, zero));
   BOOST_CHECK(result.real() == zero);
   BOOST_CHECK(result.imag() == zero);

   result = _Boost::math::atanh(ct(mzero, zero));
   BOOST_CHECK(result.real() == zero);
   BOOST_CHECK(result.imag() == zero);

   result = _Boost::math::atanh(ct(zero, mzero));
   BOOST_CHECK(result.real() == zero);
   BOOST_CHECK(result.imag() == zero);

   result = _Boost::math::atanh(ct(mzero, mzero));
   BOOST_CHECK(result.real() == zero);
   BOOST_CHECK(result.imag() == zero);

   if(test_nan)
   {
      result = _Boost::math::atanh(ct(zero, nan));
      BOOST_CHECK(result.real() == zero);
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   ...
   if(test_infinity)
   {
      result = _Boost::math::atanh(ct(one, zero));
      ...
      result = _Boost::math::atanh(ct(pi, infinity));
   ...
   if(test_nan)
   {
      result = _Boost::math::atanh(ct(pi, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   ...
   if(test_infinity)
   {
      result = _Boost::math::atanh(ct(infinity, pi));
      BOOST_CHECK(result.real() == zero);
      BOOST_CHECK_CLOSE(result.imag(), half_pi, eps*200);
      ...
      result = _Boost::math::atanh(ct(infinity, infinity));
      BOOST_CHECK_EQUAL(result.real(), zero);
      BOOST_CHECK_CLOSE(result.imag(), half_pi, eps*200);
   ...
   if(test_nan)
   {
      result = _Boost::math::atanh(ct(infinity, nan));
      BOOST_CHECK(result.real() == 0);
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::atanh(ct(nan, pi));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
      ...
      result = _Boost::math::atanh(ct(nan, infinity));
      BOOST_CHECK(result.real() == 0);
      BOOST_CHECK_CLOSE(result.imag(), half_pi, eps*200);
      ...
      result = _Boost::math::atanh(ct(nan, nan));
      BOOST_CHECK((_Boost::math::isnan)(result.real()));
      BOOST_CHECK((_Boost::math::isnan)(result.imag()));
   ...
   if(_Boost::math::signbit(mzero))
   {
      result = _Boost::math::atanh(ct(-2.0f, mzero));
      BOOST_CHECK(result.real() < 0);
      BOOST_CHECK(result.imag() < 0);
   }
}
...
{
   std::complex<float> r1 = _Boost::math::asin(std::complex<float>(x, y));
   std::complex<double> dr = _Boost::math::asin(std::complex<double>(x, y));
   std::complex<float> r2(static_cast<float>(dr.real()), static_cast<float>(dr.imag()));
   check_complex(r2, r1, 5);
   r1 = _Boost::math::acos(std::complex<float>(x, y));
   dr = _Boost::math::acos(std::complex<double>(x, y));
   r2 = std::complex<float>(std::complex<double>(dr.real(), dr.imag()));
   check_complex(r2, r1, 5);
   r1 = _Boost::math::atanh(std::complex<float>(x, y));
   dr = _Boost::math::atanh(std::complex<double>(x, y));
   r2 = std::complex<float>(std::complex<double>(dr.real(), dr.imag()));
   check_complex(r2, r1, 5);
}
