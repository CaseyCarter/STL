...
using  _Boost::math::statistics::means_and_covariance;
using  _Boost::math::statistics::covariance;
...
void test_covariance()
{
    ...
    Real mu_u = _Boost::math::statistics::mean(u);
    Real mu_v = _Boost::math::statistics::mean(v);
    Real sigma_u_sq = _Boost::math::statistics::variance(u);
    Real sigma_v_sq = _Boost::math::statistics::variance(v);
...
{
    using _Boost::math::statistics::correlation_coefficient;
