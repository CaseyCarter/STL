...
{
    std::cout << "Testing interpolation condition for barycentric interpolation on type " << _Boost::typeindex::type_id<Real>().pretty_name()  << "\n";
    std::mt19937 gen(4);
    _Boost::random::uniform_real_distribution<Real> dis(0.1f, 1);
    ...
    _Boost::math::barycentric_rational<Real> interpolator(x.data(), y.data(), y.size());
    ...
    _Boost::math::barycentric_rational<Real> move_interpolator(std::move(x), std::move(y));
...
{
    std::cout << "Testing interpolation condition in high order for barycentric interpolation on type " << _Boost::typeindex::type_id<Real>().pretty_name()  << "\n";
    std::mt19937 gen(5);
    _Boost::random::uniform_real_distribution<Real> dis(0.1f, 1);
    std::vector<Real> x(100);
    std::vector<Real> y(100);
    ...
    _Boost::math::barycentric_rational<Real> interpolator(x.data(), y.data(), y.size(), 5);
...
void test_constant()
{
    std::cout << "Testing that constants are interpolated correctly using barycentric interpolation on type " << _Boost::typeindex::type_id<Real>().pretty_name() << "\n";
...
{
    std::cout << "Testing that constants are interpolated correctly in high order using barycentric interpolation on type " << _Boost::typeindex::type_id<Real>().pretty_name() << "\n";
    ...
    _Boost::math::barycentric_rational<Real> interpolator(x.data(), y.data(), y.size(), 7);
...
void test_runge()
{
    std::cout << "Testing interpolation of Runge's 1/(1+25x^2) function using barycentric interpolation on type " << _Boost::typeindex::type_id<Real>().pretty_name() << "\n";

    std::mt19937 gen(8);
    _Boost::random::uniform_real_distribution<Real> dis(0.005f, 0.01f);
    std::vector<Real> x(100);
    std::vector<Real> y(100);
    x[0] = -2;
    y[0] = 1/(1+25*x[0]*x[0]);
...
void test_weights()
{
    std::cout << "Testing weights are calculated correctly using barycentric interpolation on type " << _Boost::typeindex::type_id<Real>().pretty_name() << "\n";

    std::mt19937 gen(9);
    _Boost::random::uniform_real_distribution<Real> dis(0.005, 0.01);
    std::vector<Real> x(100);
    std::vector<Real> y(100);
    x[0] = -2;
    y[0] = 1/(1+25*x[0]*x[0]);
    ...
    _Boost::math::detail::barycentric_rational_imp<Real> interpolator(x.data(), x.data() + x.size(), y.data(), 0);
    ...
    // d = 1:
    interpolator = _Boost::math::detail::barycentric_rational_imp<Real>(x.data(), x.data() + x.size(), y.data(), 1);
...
#ifdef BOOST_HAS_FLOAT128
    //test_interpolation_condition<_Boost::multiprecision::float128>();
    //test_constant<_Boost::multiprecision::float128>();
    //test_constant_high_order<_Boost::multiprecision::float128>();
    //test_interpolation_condition_high_order<_Boost::multiprecision::float128>();
    //test_runge<_Boost::multiprecision::float128>();
#endif
