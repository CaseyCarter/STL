...
BOOST_AUTO_TEST_CASE( Derivatives_of_lambert_w )
{
  ...
  using _Boost::math::lambert_w0_prime;
  using _Boost::math::lambert_wm1_prime;
  ...
  int epsilons = 1;
  RealType tolerance = _Boost::math::tools::epsilon<RealType>() * epsilons; // 2 eps as a fraction.
