...
#ifdef TEST_OTHER
namespace other{
   _Boost::math::concepts::real_concept beta(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept ibeta(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
}
#endif
