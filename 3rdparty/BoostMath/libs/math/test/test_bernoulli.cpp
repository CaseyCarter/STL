...
using _Boost::math::bernoulli_distribution;
...
{ // Parameter only provides the type, float, double... value ignored.
  ...
  using _Boost::math::bernoulli_distribution; // of type RealType.
...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   _Boost::math::bernoulli bn2(0.5); // Using typedef. 
  ...
  //using namespace _Boost::math; or 
  using _Boost::math::bernoulli;
