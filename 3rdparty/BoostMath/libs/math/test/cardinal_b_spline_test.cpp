...
using std::abs;
using _Boost::math::cardinal_b_spline;
using _Boost::math::cardinal_b_spline_prime;
using _Boost::math::forward_cardinal_b_spline;
using _Boost::math::cardinal_b_spline_double_prime;
...
void test_cubic()
{
    ...
    for (Real t = -4; t <= 4; t += h) {
        expected = _Boost::math::detail::b3_spline_prime<Real>(t);
        computed = cardinal_b_spline_prime<3>(t);
        CHECK_ULP_CLOSE(expected, computed, 0);
        expected = _Boost::math::detail::b3_spline_double_prime<Real>(t);
