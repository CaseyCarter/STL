...
#ifdef TEST_OTHER
namespace other{
   _Boost::math::concepts::real_concept cyl_bessel_j(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept cyl_bessel_i(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept cyl_bessel_k(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
   _Boost::math::concepts::real_concept cyl_neumann(_Boost::math::concepts::real_concept, _Boost::math::concepts::real_concept){ return 0; }
}
#endif
