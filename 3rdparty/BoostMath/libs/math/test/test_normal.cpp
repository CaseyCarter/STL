...
RealType NaivePDF(RealType mean, RealType sd, RealType x)
{
   ...
   using namespace std;
   return exp(-(x-mean)*(x-mean)/(2*sd*sd))/(sd * sqrt(2*_Boost::math::constants::pi<RealType>()));
}
...
void test_spots(RealType)
{
  ...
  // Check some bad parameters to the distribution,
   ...
   BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType> nbad1(0, 0), std::domain_error); // zero sd
   BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType> nbad1(0, -1), std::domain_error); // negative sd
#else
   BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType>(0, 0), std::domain_error); // zero sd
   BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType>(0, -1), std::domain_error); // negative sd
#endif
...
#ifndef BOOST_NO_EXCEPTIONS
    BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType> nbad1(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
     BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType> nbad1(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
     BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType> nbad1(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#else
    BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType>(std::numeric_limits<RealType>::infinity(), static_cast<RealType>(1)), std::domain_error); // +infinite mean
     BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType>(-std::numeric_limits<RealType>::infinity(),  static_cast<RealType>(1)), std::domain_error); // -infinite mean
     BOOST_MATH_CHECK_THROW(_Boost::math::normal_distribution<RealType>(static_cast<RealType>(0), std::numeric_limits<RealType>::infinity()), std::domain_error); // infinite sd
#endif
  }
  ...
  if (std::numeric_limits<RealType>::has_quiet_NaN)
  {
   ...
   //
   tolerance = _Boost::math::tools::epsilon<RealType>() * 5 * 100; // 5 eps as a percentage
   BOOST_CHECK_CLOSE(
   ...
   for(RealType x = -15; x < 5; x += 0.125)
   {
    ...
    RealType expected_entropy = log(_Boost::math::constants::two_pi<RealType>()*_Boost::math::constants::e<RealType>()*9)/2;
    BOOST_CHECK_CLOSE(
       entropy(dist)
    ...
    // Error tests:
    check_out_of_range<_Boost::math::normal_distribution<RealType> >(0, 1); // (All) valid constructor parameter values.
...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   _Boost::math::normal myf1(1., 2); // Using typedef
   normal_distribution<> myf2(1., 2); // Using default RealType double.
  _Boost::math::normal myn01; // Use default values.
...
Tolerance for type class _Boost::math::concepts::real_concept is 0.01 %
*** No errors detected
...
------ Build started: Project: test_normal, Configuration: Release Win32 ------
  ...
  *** No errors detected
  ...
  {2413} normal block at 0x00321190, 42 bytes long.
   Data: <class _Boost::mat> 63 6C 61 73 73 20 62 6F 6F 73 74 3A 3A 6D 61 74 
