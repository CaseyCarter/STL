...
{
   T tol = _Boost::math::tools::epsilon<T>() * 3000;
...
void test_hankel(T, const char* name)
{
   ...
   static const _Boost::array<_Boost::array<std::complex<T>, 4>, 16> data = 
   {{
   ...
   for(unsigned i = 0; i < data.size(); ++i)
   {
      ...
      {
         check_close(_Boost::math::cyl_hankel_1(data[i][0].real(), data[i][1].real()), data[i][2] + im * data[i][3]);
         check_close(_Boost::math::cyl_hankel_2(data[i][0].real(), data[i][1].real()), data[i][2] - im * data[i][3]);

         check_close(
            _Boost::math::cyl_hankel_1(data[i][0].real() + 0.5f, data[i][1].real()) * _Boost::math::constants::root_half_pi<T>() / sqrt(data[i][1]),
            _Boost::math::sph_hankel_1(data[i][0].real(), data[i][1].real()));
         check_close(
            _Boost::math::cyl_hankel_2(data[i][0].real() + 0.5f, data[i][1].real()) * _Boost::math::constants::root_half_pi<T>() / sqrt(data[i][1]),
            _Boost::math::sph_hankel_2(data[i][0].real(), data[i][1].real()));
      }
   }
}
...
typedef _Boost::math::policies::policy<
   _Boost::math::policies::overflow_error<_Boost::math::policies::throw_on_error>,
   _Boost::math::policies::denorm_error<_Boost::math::policies::throw_on_error>,
   _Boost::math::policies::underflow_error<_Boost::math::policies::throw_on_error>,
   _Boost::math::policies::domain_error<_Boost::math::policies::throw_on_error>,
   _Boost::math::policies::pole_error<_Boost::math::policies::throw_on_error>,
   _Boost::math::policies::rounding_error<_Boost::math::policies::throw_on_error>,
   _Boost::math::policies::evaluation_error<_Boost::math::policies::throw_on_error>,
   _Boost::math::policies::indeterminate_result_error<_Boost::math::policies::throw_on_error> > pol1;

template std::complex<double> _Boost::math::cyl_hankel_1<double, double, pol1>(double, double, const pol1&);

typedef _Boost::math::policies::policy<
   _Boost::math::policies::overflow_error<_Boost::math::policies::errno_on_error>,
   _Boost::math::policies::denorm_error<_Boost::math::policies::errno_on_error>,
   _Boost::math::policies::underflow_error<_Boost::math::policies::errno_on_error>,
   ...
   _Boost::math::policies::indeterminate_result_error<_Boost::math::policies::errno_on_error> > pol2;

template std::complex<double> _Boost::math::cyl_hankel_1<double, double, pol2>(double, double, const pol2&);
...
typedef _Boost::math::policies::policy<
   ...
   _Boost::math::policies::rounding_error<_Boost::math::policies::ignore_error>,
   _Boost::math::policies::evaluation_error<_Boost::math::policies::ignore_error>,
   _Boost::math::policies::indeterminate_result_error<_Boost::math::policies::ignore_error> > pol3;

template std::complex<double> _Boost::math::cyl_hankel_1<double, double, pol3>(double, double, const pol3&);
