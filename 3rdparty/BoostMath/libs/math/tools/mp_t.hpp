...
typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<BOOST_MATH_PRECISION *301L / 1000L> > mp_t;

#else

#include <boost/multiprecision/cpp_bin_float.hpp>

typedef _Boost::multiprecision::number<_Boost::multiprecision::cpp_bin_float<BOOST_MATH_PRECISION, _Boost::multiprecision::digit_base_2> > mp_t;
...
{
   mp_t min_val = _Boost::math::tools::min_value<mp_t>();
   mp_t max_val = _Boost::math::tools::max_value<mp_t>();
