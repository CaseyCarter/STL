...
struct hypergeometric_2f0_gen
{
   mp_t operator()(mp_t a1, mp_t a2, mp_t z)
   {
      ...
      mp_t result = _Boost::math::detail::hypergeometric_2f0_generic_series(a1, a2, z, _Boost::math::policies::policy<>());
...
{
   _Boost::math::tuple<mp_t, mp_t, mp_t, mp_t> operator()(mp_t a1, mp_t z)
   {
      mp_t result = _Boost::math::detail::hypergeometric_2f0_generic_series(a1, a1 + 0.5, z, _Boost::math::policies::policy<>());
      std::cout << a1 << " " << a1 + 0.5 << " " << z << " " << result << std::endl;
      return _Boost::math::make_tuple(a1, a1 + 0.5, z, result);
   }
};
