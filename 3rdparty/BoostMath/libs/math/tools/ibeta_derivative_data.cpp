...
int main(int, char* [])
{
   ...
   ofs <<
      ...
      "//  LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)\n"
      "\n\n"
      "static const _Boost::array<_Boost::array<typename table_type<T>::type, 4>, " << ibeta_int_data.size() << "> ibeta_derivative_small_data = { {\n";
   ...
   for(unsigned i = 0; i < ibeta_int_data.size(); ++i)
   {
      ...
      mp_t bet = exp(_Boost::math::lgamma(a) + _Boost::math::lgamma(b) - _Boost::math::lgamma(a + b));
