...
void print_polynomials(int max_order)
{
   for(int i = 2; i <= max_order; ++i)
   {
      ...
      ofs << copyright_string <<
         ...
         "inline V evaluate_polynomial_c_imp(const T*, const V&, const _Boost::integral_constant<int, 0>*)\n"
         "{\n"
         "   return static_cast<V>(0);\n"
         "}\n"
         "\n"
         "template <class T, class V>\n"
         "inline V evaluate_polynomial_c_imp(const T* a, const V&, const _Boost::integral_constant<int, 1>*)\n"
         "{\n"
      ...
      for(int order = 2; order <= i; ++order)
      {
         ofs << 
         "template <class T, class V>\n"
         "inline V evaluate_polynomial_c_imp(const T* a, const V& x, const _Boost::integral_constant<int, " << order << ">*)\n"
         "{\n"
      ...
      ofs << copyright_string <<
         ...
         "}\n\n"
         "template <class T, class V>\n"
         "inline V evaluate_polynomial_c_imp(const T* a, const V& x, const _Boost::integral_constant<int, 2>*)\n"
         "{\n"
         "   return static_cast<V>(a[1] * x + a[0]);\n"
         "}\n\n"
         "template <class T, class V>\n"
         "inline V evaluate_polynomial_c_imp(const T* a, const V& x, const _Boost::integral_constant<int, 3>*)\n"
         "{\n"
         "   return static_cast<V>((a[2] * x + a[1]) * x + a[0]);\n"
         "}\n\n"
         "template <class T, class V>\n"
         "inline V evaluate_polynomial_c_imp(const T* a, const V& x, const _Boost::integral_constant<int, 4>*)\n"
         "{\n"
...
void print_rationals(int max_order)
{
   for(int i = 2; i <= max_order; ++i)
   {
      ...
      ofs << copyright_string <<
         ...
         "inline V evaluate_rational_c_imp(const T*, const U*, const V&, const _Boost::integral_constant<int, 0>*)\n"
         "{\n"
         "   return static_cast<V>(0);\n"
         "}\n"
         "\n"
         "template <class T, class U, class V>\n"
         "inline V evaluate_rational_c_imp(const T* a, const U* b, const V&, const _Boost::integral_constant<int, 1>*)\n"
         "{\n"
      ...
      for(int order = 2; order <= i; ++order)
      {
         ofs << 
         "template <class T, class U, class V>\n"
         "inline V evaluate_rational_c_imp(const T* a, const U* b, const V& x, const _Boost::integral_constant<int, " << order << ">*)\n"
         "{\n"
         "   if(x <= 1)\n"
         "     return static_cast<V>((";
      ...
      ofs << copyright_string <<
         ...
         "}\n\n"
         "template <class T, class U, class V>\n"
         "inline V evaluate_rational_c_imp(const T* a, const U* b, const V& x, const _Boost::integral_constant<int, 2>*)\n"
         "{\n"
         "   return static_cast<V>((a[1] * x + a[0]) / (b[1] * x + b[0]));\n"
         "}\n\n"
         "template <class T, class U, class V>\n"
         "inline V evaluate_rational_c_imp(const T* a, const U* b, const V& x, const _Boost::integral_constant<int, 3>*)\n"
         "{\n"
         "   return static_cast<V>(((a[2] * x + a[1]) * x + a[0]) / ((b[2] * x + b[1]) * x + b[0]));\n"
         "}\n\n"
         "template <class T, class U, class V>\n"
         "inline V evaluate_rational_c_imp(const T* a, const U* b, const V& x, const _Boost::integral_constant<int, 4>*)\n"
         "{\n"
