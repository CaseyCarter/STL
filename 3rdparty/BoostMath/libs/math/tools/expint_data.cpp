...
struct expint_data_generator
{
   ...
   {
      unsigned n = _Boost::math::tools::real_cast<unsigned>(a);
      std::cout << n << "  " << b << "  ";
      mp_t result = _Boost::math::expint(n, b);
...
int main()
{
   _Boost::math::expint(1, 0.06227754056453704833984375);
   std::cout << _Boost::math::expint(1, mp_t(0.5)) << std::endl;
