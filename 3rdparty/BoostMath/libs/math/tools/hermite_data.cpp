...
template<class T>
_Boost::math::tuple<T, T, T> hermite_data(T n, T x)
{
   n = floor(n);
   T r1 = hermite(_Boost::math::tools::real_cast<unsigned>(n), x);
...
int main(int argc, char*argv [])
{
   ...
   std::cout << _Boost::math::hermite(10, static_cast<mp_t>(1e300)) << std::endl;
