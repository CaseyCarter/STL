...
"   static const U n" << i << "c[" << i << "] = { ";
      ...
      mp_t r5 = _Boost::math::tools::evaluate_polynomial(&coef[0], mp_t(6.5), i);
      mp_t r6 = _Boost::math::tools::evaluate_polynomial(&coef[0], mp_t(10247.25), i);
      ...
      if(fabs(r5) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_polynomial(n" << i << "c, static_cast<T>(6.5), " << i << "),\n"
            "      static_cast<T>(" << r5 << "L),\n"
            "      tolerance);\n";
      if(fabs(r6) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_polynomial(n" << i << "c, static_cast<T>(10247.25), " << i << "),\n"
            "      static_cast<T>(" << r6 << "L),\n"
            "      tolerance);\n\n";
      ...
      if(fabs(r5) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_polynomial(n" << i << "c, static_cast<T>(6.5)),\n"
            "      static_cast<T>(" << r5 << "L),\n"
            "      tolerance);\n";
      if(fabs(r6) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_polynomial(n" << i << "c, static_cast<T>(10247.25)),\n"
            "      static_cast<T>(" << r6 << "L),\n"
            "      tolerance);\n\n";
      ...
      if(fabs(r5) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_polynomial(n" << i << "a, static_cast<T>(6.5)),\n"
            "      static_cast<T>(" << r5 << "L),\n"
            "      tolerance);\n";
      if(fabs(r6) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_polynomial(n" << i << "a, static_cast<T>(10247.25)),\n"
            "      static_cast<T>(" << r6 << "L),\n"
            "      tolerance);\n\n";
      ...
      r5 = _Boost::math::tools::evaluate_even_polynomial(&coef[0], mp_t(6.5), i);
      r6 = _Boost::math::tools::evaluate_even_polynomial(&coef[0], mp_t(10247.25), i);
      ...
      if(fabs(r5) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_even_polynomial(n" << i << "c, static_cast<T>(6.5f), " << i << "),\n"
            "      static_cast<T>(" << r5 << "L),\n"
            "      tolerance);\n";
      if(fabs(r6) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_even_polynomial(n" << i << "c, static_cast<T>(10247.25f), " << i << "),\n"
            "      static_cast<T>(" << r6 << "L),\n"
            "      tolerance);\n\n";
      ...
      if(fabs(r5) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_even_polynomial(n" << i << "c, static_cast<T>(6.5f)),\n"
            "      static_cast<T>(" << r5 << "L),\n"
            "      tolerance);\n";
      if(fabs(r6) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_even_polynomial(n" << i << "c, static_cast<T>(10247.25f)),\n"
            "      static_cast<T>(" << r6 << "L),\n"
            "      tolerance);\n\n";
      ...
      if(fabs(r5) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_even_polynomial(n" << i << "a, static_cast<T>(6.5f)),\n"
            "      static_cast<T>(" << r5 << "L),\n"
            "      tolerance);\n";
      if(fabs(r6) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_even_polynomial(n" << i << "a, static_cast<T>(10247.25f)),\n"
            "      static_cast<T>(" << r6 << "L),\n"
            "      tolerance);\n\n";
      ...
      if(i > 1)
      {
         ...
         r5 = _Boost::math::tools::evaluate_odd_polynomial(&coef[0], mp_t(6.5), i);
         r6 = _Boost::math::tools::evaluate_odd_polynomial(&coef[0], mp_t(10247.25), i);
         ...
         if(fabs(r5) < tools::max_value<float>())
            std::cout <<
               "   BOOST_CHECK_CLOSE(\n"
               "      _Boost::math::tools::evaluate_odd_polynomial(n" << i << "c, static_cast<T>(6.5f), " << i << "),\n"
               "      static_cast<T>(" << r5 << "L),\n"
               "      tolerance);\n";
         if(fabs(r6) < tools::max_value<float>())
            std::cout <<
               "   BOOST_CHECK_CLOSE(\n"
               "      _Boost::math::tools::evaluate_odd_polynomial(n" << i << "c, static_cast<T>(10247.25f), " << i << "),\n"
               "      static_cast<T>(" << r6 << "L),\n"
               "      tolerance);\n\n";
         ...
         if(fabs(r5) < tools::max_value<float>())
            std::cout <<
               "   BOOST_CHECK_CLOSE(\n"
               "      _Boost::math::tools::evaluate_odd_polynomial(n" << i << "c, static_cast<T>(6.5f)),\n"
               "      static_cast<T>(" << r5 << "L),\n"
               "      tolerance);\n";
         if(fabs(r6) < tools::max_value<float>())
            std::cout <<
               "   BOOST_CHECK_CLOSE(\n"
               "      _Boost::math::tools::evaluate_odd_polynomial(n" << i << "c, static_cast<T>(10247.25f)),\n"
               "      static_cast<T>(" << r6 << "L),\n"
               "      tolerance);\n\n";
         ...
         if(fabs(r5) < tools::max_value<float>())
            std::cout <<
               "   BOOST_CHECK_CLOSE(\n"
               "      _Boost::math::tools::evaluate_odd_polynomial(n" << i << "a, static_cast<T>(6.5f)),\n"
               "      static_cast<T>(" << r5 << "L),\n"
               "      tolerance);\n";
         if(fabs(r6) < tools::max_value<float>())
            std::cout <<
               "   BOOST_CHECK_CLOSE(\n"
               "      _Boost::math::tools::evaluate_odd_polynomial(n" << i << "a, static_cast<T>(10247.25f)),\n"
               "      static_cast<T>(" << r6 << "L),\n"
               "      tolerance);\n\n";
      }
      ...
      r5 = _Boost::math::tools::evaluate_polynomial(&coef[0], mp_t(6.5), i);
      r6 = _Boost::math::tools::evaluate_polynomial(&coef[0], mp_t(10247.25), i);
...
"   static const U d" << i << "c[" << i << "] = { ";
      ...
      mp_t r5d = _Boost::math::tools::evaluate_polynomial(&coef[0], mp_t(6.5), i);
      mp_t r6d = _Boost::math::tools::evaluate_polynomial(&coef[0], mp_t(10247.25), i);
      ...
      if(fabs(r5/r5d) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_rational(n" << i << "c, d" << i << "c, static_cast<T>(6.5f), " << i << "),\n"
            "      static_cast<T>(" << r5/r5d << "L),\n"
            "      tolerance);\n";
      if(fabs(r6/r6d) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_rational(n" << i << "c, d" << i << "c, static_cast<T>(10247.25f), " << i << "),\n"
      ...
      if(fabs(r5/r5d) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_rational(n" << i << "c, d" << i << "c, static_cast<T>(6.5f)),\n"
            "      static_cast<T>(" << r5/r5d << "L),\n"
            "      tolerance);\n";
      if(fabs(r6/r6d) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_rational(n" << i << "c, d" << i << "c, static_cast<T>(10247.25f)),\n"
            "      static_cast<T>(" << r6/r6d << "L),\n"
            "      tolerance);\n\n";
      ...
      if(fabs(r5/r5d) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_rational(n" << i << "a, d" << i << "a, static_cast<T>(6.5f)),\n"
            "      static_cast<T>(" << r5/r5d << "L),\n"
            "      tolerance);\n";
      if(fabs(r6/r6d) < tools::max_value<float>())
         std::cout <<
            "   BOOST_CHECK_CLOSE(\n"
            "      _Boost::math::tools::evaluate_rational(n" << i << "a, d" << i << "a, static_cast<T>(10247.25f)),\n"
            "      static_cast<T>(" << r6/r6d << "L),\n"
            "      tolerance);\n\n";
   }
