...
//
template <class T>
inline BOOST_MATH_CONSTEXPR T log_max_value(const _Boost::integral_constant<int, 128>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
   return 88.0f;
}

template <class T>
inline BOOST_MATH_CONSTEXPR T log_min_value(const _Boost::integral_constant<int, 128>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
   return -87.0f;
}
//
...
//
template <class T>
inline BOOST_MATH_CONSTEXPR T log_max_value(const _Boost::integral_constant<int, 1024>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
   return 709.0;
}

template <class T>
inline BOOST_MATH_CONSTEXPR T log_min_value(const _Boost::integral_constant<int, 1024>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
   return -708.0;
}
//
...
//
template <class T>
inline BOOST_MATH_CONSTEXPR T log_max_value(const _Boost::integral_constant<int, 16384>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
   return 11356.0L;
}

template <class T>
inline BOOST_MATH_CONSTEXPR T log_min_value(const _Boost::integral_constant<int, 16384>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
   return -11355.0L;
}

template <class T>
inline T log_max_value(const _Boost::integral_constant<int, 0>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   BOOST_MATH_STD_USING
#ifdef __SUNPRO_CC
   static const T m = _Boost::math::tools::max_value<T>();
   static const T val = log(m);
#else
   static const T val = log(_Boost::math::tools::max_value<T>());
#endif
   return val;
}

template <class T>
inline T log_min_value(const _Boost::integral_constant<int, 0>& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   BOOST_MATH_STD_USING
#ifdef __SUNPRO_CC
   static const T m = _Boost::math::tools::min_value<T>();
   static const T val = log(m);
#else
   static const T val = log(_Boost::math::tools::min_value<T>());
#endif
   return val;
}

template <class T>
inline BOOST_MATH_CONSTEXPR T epsilon(const _Boost::true_type& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_MATH_NOEXCEPT(T)
{
...
template <>
inline BOOST_MATH_CONSTEXPR long double epsilon<long double>(const _Boost::true_type& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(long double)) BOOST_MATH_NOEXCEPT(long double)
{
...
template <class T>
inline T epsilon(const _Boost::false_type& BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
...
struct log_limit_traits
{
   typedef typename mpl::if_c<
      ...
      _Boost::integral_constant<int, (std::numeric_limits<T>::max_exponent > INT_MAX ? INT_MAX : static_cast<int>(std::numeric_limits<T>::max_exponent))>,
      _Boost::integral_constant<int, 0>
   >::type tag_type;
...
template <class T> struct log_limit_noexcept_traits_imp<T, false> : public _Boost::integral_constant<bool, false> {};
...
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   return detail::epsilon<T>(_Boost::integral_constant<bool, ::std::numeric_limits<T>::is_specialized>());
#else
   return ::std::numeric_limits<T>::is_specialized ?
      detail::epsilon<T>(_Boost::true_type()) :
      detail::epsilon<T>(_Boost::false_type());
#endif
}
...
template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const _Boost::integral_constant<int, 24>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(0.00034526698300124390839884978618400831996329879769945L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const T*, const _Boost::integral_constant<int, 53>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(0.1490116119384765625e-7L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const T*, const _Boost::integral_constant<int, 64>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(0.32927225399135962333569506281281311031656150598474e-9L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T root_epsilon_imp(const T*, const _Boost::integral_constant<int, 113>&) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline T root_epsilon_imp(const T*, const _Boost::integral_constant<int, 0>&)
{
   BOOST_MATH_STD_USING
...
template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const _Boost::integral_constant<int, 24>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(0.0049215666011518482998719164346805794944150447839903L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const T*, const _Boost::integral_constant<int, 53>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(6.05545445239333906078989272793696693569753008995e-6L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const T*, const _Boost::integral_constant<int, 64>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(4.76837158203125e-7L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T cbrt_epsilon_imp(const T*, const _Boost::integral_constant<int, 113>&) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline T cbrt_epsilon_imp(const T*, const _Boost::integral_constant<int, 0>&)
{
   BOOST_MATH_STD_USING;
...
template <class T>
inline BOOST_MATH_CONSTEXPR T forth_root_epsilon_imp(const T*, const _Boost::integral_constant<int, 24>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(0.018581361171917516667460937040007436176452688944747L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T forth_root_epsilon_imp(const T*, const _Boost::integral_constant<int, 53>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(0.0001220703125L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T forth_root_epsilon_imp(const T*, const _Boost::integral_constant<int, 64>&) BOOST_MATH_NOEXCEPT(T)
{
   return static_cast<T>(0.18145860519450699870567321328132261891067079047605e-4L);
}

template <class T>
inline BOOST_MATH_CONSTEXPR T forth_root_epsilon_imp(const T*, const _Boost::integral_constant<int, 113>&) BOOST_MATH_NOEXCEPT(T)
{
...
template <class T>
inline T forth_root_epsilon_imp(const T*, const _Boost::integral_constant<int, 0>&)
{
   BOOST_MATH_STD_USING
...
{
   typedef _Boost::integral_constant<int, (::std::numeric_limits<T>::radix == 2) && (::std::numeric_limits<T>::digits != INT_MAX) ? std::numeric_limits<T>::digits : 0> tag_type;
