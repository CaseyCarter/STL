   ...
   namespace math {
      namespace tools {
         namespace detail{
            ...
            {
               typedef typename _Boost::remove_reference<decltype(_Boost::math::get<0>(std::declval<Recurrence&>()(0)))>::type value_type;
            ...
            struct recurrence_reverser
            {
               ...
               _Boost::math::tuple<T, T, T> operator()(int i)
               {
                  using std::swap;
                  _Boost::math::tuple<T, T, T> t = r(-i);
                  swap(_Boost::math::get<0>(t), _Boost::math::get<2>(t));
                  return t;
               }
               R r;
            };
         ...
         T function_ratio_from_backwards_recurrence(const Recurrence& r, const T& factor, _Boost::uintmax_t& max_iter)
         {
            detail::function_ratio_from_backwards_recurrence_fraction<Recurrence> f(r);
            return _Boost::math::tools::continued_fraction_a(f, factor, max_iter);
         }
         ...
         //
         template <class Recurrence, class T>
         T function_ratio_from_forwards_recurrence(const Recurrence& r, const T& factor, _Boost::uintmax_t& max_iter)
         {
            _Boost::math::tools::detail::function_ratio_from_backwards_recurrence_fraction<_Boost::math::tools::detail::recurrence_reverser<Recurrence, T> > f(r);
            return _Boost::math::tools::continued_fraction_a(f, factor, max_iter);
         }
         ...
         inline T apply_recurrence_relation_forward(const NextCoefs& get_coefs, unsigned number_of_steps, T first, T second, int* log_scaling = 0, T* previous = 0)
         {
            ...
            using _Boost::math::tuple;
            using _Boost::math::get;
            ...
            for (unsigned k = 0; k < number_of_steps; ++k)
            {
               ...
               BOOST_ASSERT((_Boost::math::isfinite)(third));
         ...
         inline T apply_recurrence_relation_backward(const NextCoefs& get_coefs, unsigned number_of_steps, T first, T second, int* log_scaling = 0, T* previous = 0)
         {
            ...
            for (unsigned k = 0; k < number_of_steps; ++k)
            {
               ...
               BOOST_ASSERT((_Boost::math::isfinite)(next));
         ...
         {
            typedef typename _Boost::remove_reference<decltype(std::get<0>(std::declval<Recurrence&>()(0)))>::type value_type;
            ...
            forward_recurrence_iterator(const Recurrence& r, value_type f_n)
               : f_n(f_n), coef(r), k(0)
            {
               _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<_Boost::math::policies::policy<> >();
               f_n_minus_1 = f_n * _Boost::math::tools::function_ratio_from_forwards_recurrence(detail::recurrence_offsetter<Recurrence>(r, -1), value_type(_Boost::math::tools::epsilon<value_type>() * 2), max_iter);
               _Boost::math::policies::check_series_iterations<value_type>("forward_recurrence_iterator<>::forward_recurrence_iterator", max_iter, _Boost::math::policies::policy<>());
            }
         ...
         struct backward_recurrence_iterator
         {
            ...
            {
               _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<_Boost::math::policies::policy<> >();
               f_n_plus_1 = f_n * _Boost::math::tools::function_ratio_from_backwards_recurrence(detail::recurrence_offsetter<Recurrence>(r, 1), value_type(_Boost::math::tools::epsilon<value_type>() * 2), max_iter);
               _Boost::math::policies::check_series_iterations<value_type>("backward_recurrence_iterator<>::backward_recurrence_iterator", max_iter, _Boost::math::policies::policy<>());
            }
