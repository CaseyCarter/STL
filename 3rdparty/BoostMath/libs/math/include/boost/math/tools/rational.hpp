...
{
   typedef _Boost::integral_constant<int, N> tag_type;
   return detail::evaluate_polynomial_c_imp(static_cast<const T*>(a), val, static_cast<tag_type const*>(0));
}

template <std::size_t N, class T, class V>
inline V evaluate_polynomial(const _Boost::array<T,N>& a, const V& val) BOOST_MATH_NOEXCEPT(V)
{
   typedef _Boost::integral_constant<int, N> tag_type;
...
template <std::size_t N, class T, class V>
inline V evaluate_even_polynomial(const _Boost::array<T,N>& a, const V& z) BOOST_MATH_NOEXCEPT(V)
{
   return evaluate_polynomial(a, V(z*z));
}
//
...
{
   typedef _Boost::integral_constant<int, N-1> tag_type;
   return a[0] + z * detail::evaluate_polynomial_c_imp(static_cast<const T*>(a) + 1, V(z*z), static_cast<tag_type const*>(0));
}

template <std::size_t N, class T, class V>
inline V evaluate_odd_polynomial(const _Boost::array<T,N>& a, const V& z) BOOST_MATH_NOEXCEPT(V)
{
   typedef _Boost::integral_constant<int, N-1> tag_type;
...
{
   return _Boost::math::tools::evaluate_rational(num, denom, z, Tag::value);
}
...
{
   return detail::evaluate_rational_c_imp(a, b, z, static_cast<const _Boost::integral_constant<int, N>*>(0));
}

template <std::size_t N, class T, class U, class V>
inline V evaluate_rational(const _Boost::array<T,N>& a, const _Boost::array<U,N>& b, const V& z) BOOST_MATH_NOEXCEPT(V)
{
   return detail::evaluate_rational_c_imp(a.data(), b.data(), z, static_cast<_Boost::integral_constant<int, N>*>(0));
}
