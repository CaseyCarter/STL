...
{
   typedef typename _Boost::math::policies::precision<T, _Boost::math::policies::policy<> >::type prec_type;
   std::stringstream ss;
   if(prec_type::value)
   {
...
#ifndef BOOST_NO_RTTI
  replace_all_in_string(function, "%1%", _Boost::math::policies::detail::name_of<T>());
#else
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const ::_Boost::math::policies::domain_error< ::_Boost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::_Boost::math::policies::domain_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::_Boost::math::policies::domain_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::domain_error< ::_Boost::math::policies::user_error>&)
{
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::pole_error< ::_Boost::math::policies::throw_on_error>&)
{
   return _Boost::math::policies::detail::raise_domain_error(function, message, val,  ::_Boost::math::policies::domain_error< ::_Boost::math::policies::throw_on_error>());
}
...
inline BOOST_MATH_CONSTEXPR T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::pole_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::_Boost::math::policies::detail::raise_domain_error(function, message, val,  ::_Boost::math::policies::domain_error< ::_Boost::math::policies::ignore_error>());
}
...
inline BOOST_MATH_CONSTEXPR T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::pole_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::_Boost::math::policies::detail::raise_domain_error(function, message, val,  ::_Boost::math::policies::domain_error< ::_Boost::math::policies::errno_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::pole_error< ::_Boost::math::policies::user_error>&)
{
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::_Boost::math::policies::overflow_error< ::_Boost::math::policies::throw_on_error>&)
{
   raise_error<std::overflow_error, T>(function, message ? message : "numeric overflow");
   // We should never get here:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : _Boost::math::tools::max_value<T>();
}
...
inline BOOST_MATH_CONSTEXPR T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::_Boost::math::policies::overflow_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : _Boost::math::tools::max_value<T>();
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::_Boost::math::policies::overflow_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::_Boost::math::policies::overflow_error< ::_Boost::math::policies::user_error>&)
{
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::_Boost::math::policies::underflow_error< ::_Boost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_underflow_error(
           const char* ,
           const char* ,
           const  ::_Boost::math::policies::underflow_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return T(0);
...
inline T raise_underflow_error(
           const char* /* function */,
           const char* /* message */,
           const  ::_Boost::math::policies::underflow_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::_Boost::math::policies::underflow_error< ::_Boost::math::policies::user_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& /* val */,
           const  ::_Boost::math::policies::denorm_error< ::_Boost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_denorm_error(
           ...
           const char* ,
           const T&  val,
           const  ::_Boost::math::policies::denorm_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T& val,
           const  ::_Boost::math::policies::denorm_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::denorm_error< ::_Boost::math::policies::user_error>&)
{
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::evaluation_error< ::_Boost::math::policies::throw_on_error>&)
{
   raise_error<_Boost::math::evaluation_error, T>(function, message, val);
   // we never get here:
   return T(0);
}
...
inline BOOST_MATH_CONSTEXPR T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::_Boost::math::policies::evaluation_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::_Boost::math::policies::evaluation_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::_Boost::math::policies::evaluation_error< ::_Boost::math::policies::user_error>&)
{
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::_Boost::math::policies::rounding_error< ::_Boost::math::policies::throw_on_error>&)
{
   raise_error<_Boost::math::rounding_error, T>(function, message, val);
   // we never get here:
   return TargetType(0);
}
...
inline BOOST_MATH_CONSTEXPR TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::_Boost::math::policies::rounding_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::_Boost::math::policies::rounding_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
           ...
           const  ::_Boost::math::policies::rounding_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   ...
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
   return  val > 0 ? _Boost::math::tools::max_value<T>() : -_Boost::math::tools::max_value<T>();
}
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType& t,
           const  ::_Boost::math::policies::rounding_error< ::_Boost::math::policies::user_error>&)
{
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::_Boost::math::policies::indeterminate_result_error< ::_Boost::math::policies::throw_on_error>&)
{
   raise_error<std::domain_error, T>(function, message, val);
   // we never get here:
   return std::numeric_limits<T>::quiet_NaN();
...
inline BOOST_MATH_CONSTEXPR T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::_Boost::math::policies::indeterminate_result_error< ::_Boost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return result;
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::_Boost::math::policies::indeterminate_result_error< ::_Boost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::_Boost::math::policies::indeterminate_result_error< ::_Boost::math::policies::user_error>&)
{
...
inline bool check_overflow(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      _Boost::math::policies::detail::raise_overflow_error<R>(function, 0, pol);
...
inline bool check_underflow(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(_Boost::math::policies::detail::raise_underflow_error<R>(function, 0, pol));
      return true;
   }
   return false;
}
...
inline bool check_denorm(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(_Boost::math::policies::detail::raise_denorm_error<R>(function, 0, static_cast<R>(val), pol));
      return true;
   }
   return false;
}
...
template <class T, class Policy>
inline void check_series_iterations(const char* function, _Boost::uintmax_t max_iter, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && is_noexcept_error_policy<Policy>::value)
{
...
template <class T, class Policy>
inline void check_root_iterations(const char* function, _Boost::uintmax_t max_iter, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && is_noexcept_error_policy<Policy>::value)
{
