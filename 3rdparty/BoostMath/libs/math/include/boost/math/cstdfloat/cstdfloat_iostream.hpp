...
//  #if (0)
  ...
  extern "C" _Boost::math::cstdfloat::detail::float_internal128_t strtoflt128(const char*, char **) throw();

  namespace std
  {
    template<typename char_type, class traits_type>
    inline std::basic_ostream<char_type, traits_type>& operator<<(std::basic_ostream<char_type, traits_type>& os, const _Boost::math::cstdfloat::detail::float_internal128_t& x)
    {
      ...
      if(v < 0) { BOOST_THROW_EXCEPTION(std::runtime_error("Formatting of _Boost::float128_t failed internally in quadmath_snprintf().")); }
      ...
      if(v >= static_cast<int>(sizeof(my_buffer) - 1U))
      {
        ...
        {
          BOOST_THROW_EXCEPTION(std::runtime_error("Formatting of _Boost::float128_t failed while allocating memory."));
        }
#endif
        ...
        if(v2 >= v + 3)
        {
          BOOST_THROW_EXCEPTION(std::runtime_error("Formatting of _Boost::float128_t failed."));
        }
    ...
    template<typename char_type, class traits_type>
    inline std::basic_istream<char_type, traits_type>& operator>>(std::basic_istream<char_type, traits_type>& is, _Boost::math::cstdfloat::detail::float_internal128_t& x)
    {
      std::string str;
      ...
      if(static_cast<std::ptrdiff_t>(p_end - str.c_str()) != static_cast<std::ptrdiff_t>(str.length()))
      {
        ...
        BOOST_THROW_EXCEPTION(std::runtime_error("Unable to interpret input string as a _Boost::float128_t"));
      }
...
//  #elif defined(__GNUC__)
  ...
  // This methodology has been slightly modified here for _Boost::float128_t.
                            ...
                            const bool iszero)
  {
    ...
    else
    {
      ...
      str.append(1U, 'e');
      string_type e = _Boost::lexical_cast<string_type>(std::abs(my_exp));
                                ...
                                const std::ios_base::fmtflags f)
  {
    ...
    else
    {
      ...
      if(-expon > std::numeric_limits<float_type>::max_exponent10 - 3)
      {
        ...
        const float_type t2 = _Boost::math::cstdfloat::detail::pown(ten, e);
      ...
      {
        t = _Boost::math::cstdfloat::detail::pown(ten, -expon);
        eval_multiply(t, x);
      }
  ...
  bool convert_from_string(float_type& value, const char* p)
  {
    ...
    if(expon)
    {
      ...
      {
        t = _Boost::math::cstdfloat::detail::pown(t, expon);
        eval_multiply(value, t);
      }
      else
      {
        t = _Boost::math::cstdfloat::detail::pown(t, (expon + digits_seen + 1));
        eval_multiply(value, t);
        t = ten;
        t = _Boost::math::cstdfloat::detail::pown(t, (-digits_seen - 1));
        eval_multiply(value, t);
      }
    }
  ...
  namespace std
  {
    ...
    inline std::basic_ostream<char_type, traits_type>& operator<<(std::basic_ostream<char_type, traits_type>& os, const _Boost::math::cstdfloat::detail::float_internal128_t& x)
    {
      _Boost::math::cstdfloat::detail::float_internal128_t non_const_x = x;

      const std::string str = _Boost::math::cstdfloat::detail::convert_to_string(non_const_x,
                                                                                os.precision(),
                                                                                os.flags());
    ...
    inline std::basic_istream<char_type, traits_type>& operator>>(std::basic_istream<char_type, traits_type>& is, _Boost::math::cstdfloat::detail::float_internal128_t& x)
    {
      ...
      const bool conversion_is_ok = _Boost::math::cstdfloat::detail::convert_from_string(x, str.c_str());
