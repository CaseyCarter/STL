...
template <class T>
inline T expint_1_rational(const T& z, const _Boost::integral_constant<int, 0>&)
{
...
template <class T>
T expint_1_rational(const T& z, const _Boost::integral_constant<int, 53>&)
{
   ...
   else if(z < -_Boost::math::tools::log_min_value<T>())
   {
...
template <class T>
T expint_1_rational(const T& z, const _Boost::integral_constant<int, 64>&)
{
   BOOST_MATH_STD_USING
   T result;
   if(z <= 1)
...
template <class T>
T expint_1_rational(const T& z, const _Boost::integral_constant<int, 113>&)
{
   BOOST_MATH_STD_USING
   T result;
   if(z <= 1)
...
inline T expint_as_fraction(unsigned n, T z, const Policy& pol)
{
   ...
   T result = tools::continued_fraction_b(
      f, 
      _Boost::math::policies::get_epsilon<T, Policy>(),
      max_iter);
   policies::check_series_iterations<T>("_Boost::math::expint_continued_fraction<%1%>(unsigned,%1%)", max_iter, pol);
...
inline T expint_as_series(unsigned n, T z, const Policy& pol)
{
   ...
   result += pow(-z, static_cast<T>(n - 1)) 
      * (_Boost::math::digamma(static_cast<T>(n)) - log(z)) / fact;
   BOOST_MATH_INSTRUMENT_VARIABLE(result)

   expint_series<T> s(k, z, x_k, denom, fact);
   result = tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter, result);
   policies::check_series_iterations<T>("_Boost::math::expint_series<%1%>(unsigned,%1%)", max_iter, pol);
   BOOST_MATH_INSTRUMENT_VARIABLE(result)
   BOOST_MATH_INSTRUMENT_VARIABLE(max_iter)
   return result;
}
...
{
   BOOST_MATH_STD_USING
   static const char* function = "_Boost::math::expint<%1%>(unsigned, %1%)";
   if(z < 0)
...
T expint_i_as_series(T z, const Policy& pol)
{
   ...
   _Boost::uintmax_t max_iter = policies::get_max_series_iterations<Policy>();
   result = tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter, result);
   policies::check_series_iterations<T>("_Boost::math::expint_i_series<%1%>(%1%)", max_iter, pol);
   return result;
}
...
{
   static const char* function = "_Boost::math::expint<%1%>(%1%)";
   if(z < 0)
...
template <class T, class Policy>
T expint_i_imp(T z, const Policy& pol, const _Boost::integral_constant<int, 53>& tag)
{
   BOOST_MATH_STD_USING
   static const char* function = "_Boost::math::expint<%1%>(%1%)";
   if(z < 0)
   ...
   if(z <= 6)
   {
      ...
      if(fabs(t) < 0.1)
      {
         result += _Boost::math::log1p(t / r, pol);
      }
      else
      {
         result += log(z / r);
...
template <class T, class Policy>
T expint_i_imp(T z, const Policy& pol, const _Boost::integral_constant<int, 64>& tag)
{
   BOOST_MATH_STD_USING
   static const char* function = "_Boost::math::expint<%1%>(%1%)";
   if(z < 0)
...
template <class T, class Policy>
T expint_i_imp(T z, const Policy& pol, const _Boost::integral_constant<int, 113>& tag)
{
   BOOST_MATH_STD_USING
   static const char* function = "_Boost::math::expint<%1%>(%1%)";
   if(z < 0)
...
struct expint_i_initializer
{
   struct init
   {
      ...
      {
         _Boost::math::expint(T(5));
         _Boost::math::expint(T(7));
         _Boost::math::expint(T(18));
         _Boost::math::expint(T(38));
         _Boost::math::expint(T(45));
      }
      ...
      static void do_init(const _Boost::integral_constant<int, 113>&)
      {
         _Boost::math::expint(T(5));
         _Boost::math::expint(T(7));
         _Boost::math::expint(T(17));
         _Boost::math::expint(T(25));
         _Boost::math::expint(T(40));
         _Boost::math::expint(T(50));
         _Boost::math::expint(T(80));
         _Boost::math::expint(T(200));
         _Boost::math::expint(T(220));
      }
...
struct expint_1_initializer
{
   struct init
   {
      ...
      static void do_init(const _Boost::integral_constant<int, 53>&)
      {
         _Boost::math::expint(1, T(0.5));
         _Boost::math::expint(1, T(2));
      }
      static void do_init(const _Boost::integral_constant<int, 64>&)
      {
         _Boost::math::expint(1, T(0.5));
...
template <class T, class Policy>
inline typename tools::promote_args<T>::type
   expint_forwarder(T z, const Policy& /*pol*/, _Boost::true_type const&)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::expint_i_imp(
      ...
      forwarding_policy(),
      tag_type()), "_Boost::math::expint<%1%>(%1%)");
}

template <class T>
inline typename tools::promote_args<T>::type
expint_forwarder(unsigned n, T z, const _Boost::false_type&)
{
   return _Boost::math::expint(n, z, policies::policy<>());
}
   ...
   expint(unsigned n, T z, const Policy& /*pol*/)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::expint_imp(
      ...
      static_cast<value_type>(z),
      forwarding_policy(),
      tag_type()), "_Boost::math::expint<%1%>(unsigned, %1%)");
}
