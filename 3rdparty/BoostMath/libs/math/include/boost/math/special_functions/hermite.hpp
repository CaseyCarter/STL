   ...
   hermite(unsigned n, T x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::hermite_imp(n, static_cast<value_type>(x)), "_Boost::math::hermite<%1%>(unsigned, %1%)");
}
...
{
   return _Boost::math::hermite(n, x, policies::policy<>());
}
