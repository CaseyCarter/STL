   ...
   namespace math {
      namespace detail {
         ...
         struct bessel_jy_recurrence
         {
            ...
            _Boost::math::tuple<T, T, T> operator()(int k)
            {
               return _Boost::math::tuple<T, T, T>(1, -2 * (v + k) / z, 1);
            }
      ...
      struct bessel_j_backwards_iterator
      {
         ...
         bessel_j_backwards_iterator(const T& v, const T& x)
            : it(detail::bessel_jy_recurrence<T>(v, x), _Boost::math::cyl_bessel_j(v, x)) 
         {
            if(v < 0)
               _Boost::math::policies::raise_domain_error("bessel_j_backwards_iterator<%1%>", "Order must be > 0 stable backwards recurrence but got %1%", v, _Boost::math::policies::policy<>());
         }
      ...
      private:
         _Boost::math::tools::backward_recurrence_iterator< detail::bessel_jy_recurrence<T> > it;
      };
      ...
      struct bessel_i_backwards_iterator
      {
         ...
         bessel_i_backwards_iterator(const T& v, const T& x)
            : it(detail::bessel_ik_recurrence<T>(v, x), _Boost::math::cyl_bessel_i(v, x)) 
         {
            if(v < -1)
               _Boost::math::policies::raise_domain_error("bessel_i_backwards_iterator<%1%>", "Order must be > 0 stable backwards recurrence but got %1%", v, _Boost::math::policies::policy<>());
         }
      ...
      private:
         _Boost::math::tools::backward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
      ...
      struct bessel_i_forwards_iterator
      {
         ...
         {
            if(v > 1)
               _Boost::math::policies::raise_domain_error("bessel_i_forwards_iterator<%1%>", "Order must be < 0 stable forwards recurrence but got %1%", v, _Boost::math::policies::policy<>());
         }
      ...
      private:
         _Boost::math::tools::forward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
