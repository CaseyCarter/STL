...
inline Real chebyshev_imp(unsigned n, Real const & x)
{
   ...
   using _Boost::math::acosh;
    ...
    {
       std::swap(T0, T1);
       T1 = _Boost::math::chebyshev_next(x, T0, T1);
       ++l;
    }
    return T1;
}
...
chebyshev_t(unsigned n, Real const & x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::chebyshev_imp<value_type, false>(n, static_cast<value_type>(x)), "_Boost::math::chebyshev_t<%1%>(unsigned, %1%)");
}
...
chebyshev_u(unsigned n, Real const & x, const Policy&)
{
   typedef typename tools::promote_args<Real>::type result_type;
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::chebyshev_imp<value_type, true>(n, static_cast<value_type>(x)), "_Boost::math::chebyshev_u<%1%>(unsigned, %1%)");
}
...
chebyshev_t_prime(unsigned n, Real const & x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(n * detail::chebyshev_imp<value_type, true>(n - 1, static_cast<value_type>(x)), "_Boost::math::chebyshev_t_prime<%1%>(unsigned, %1%)");
}
