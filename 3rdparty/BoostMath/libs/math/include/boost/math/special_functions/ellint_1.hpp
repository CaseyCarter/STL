...
T ellint_f_imp(T phi, T k, const Policy& pol)
{
    ...
    static const char* function = "_Boost::math::ellint_f<%1%>(%1%,%1%)";
...
T ellint_k_imp(T k, const Policy& pol)
{
    ...
    static const char* function = "_Boost::math::ellint_k<%1%>(%1%)";
...
template <typename T, typename Policy>
inline typename tools::promote_args<T>::type ellint_1(T k, const Policy& pol, const _Boost::true_type&)
{
   typedef typename tools::promote_args<T>::type result_type;
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::ellint_k_imp(static_cast<value_type>(k), pol), "_Boost::math::ellint_1<%1%>(%1%)");
}

template <class T1, class T2>
inline typename tools::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi, const _Boost::false_type&)
{
   return _Boost::math::ellint_1(k, phi, policies::policy<>());
}
...
inline typename tools::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi, const Policy& pol)
{
   ...
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::ellint_f_imp(static_cast<value_type>(phi), static_cast<value_type>(k), pol), "_Boost::math::ellint_1<%1%>(%1%,%1%)");
}
