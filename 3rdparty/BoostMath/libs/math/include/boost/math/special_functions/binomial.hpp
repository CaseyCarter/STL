...
T binomial_coefficient(unsigned n, unsigned k, const Policy& pol)
{
   ...
   static const char* function = "_Boost::math::binomial_coefficient<%1%>(unsigned, unsigned)";
   if(k > n)
...
{
   return policies::checked_narrowing_cast<float, policies::policy<> >(binomial_coefficient<double>(n, k, pol), "_Boost::math::binomial_coefficient<%1%>(unsigned,unsigned)");
}
