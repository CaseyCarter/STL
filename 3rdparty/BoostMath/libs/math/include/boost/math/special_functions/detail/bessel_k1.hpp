...
namespace _Boost { namespace math { namespace detail{
   ...
   inline T bessel_k1_imp(const T& x, const _Boost::integral_constant<int, N>&)
   {
      BOOST_ASSERT(0);
      return 0;
   }
   ...
   template <typename T>
   T bessel_k1_imp(const T& x, const _Boost::integral_constant<int, 24>&)
   {
   ...
   template <typename T>
   T bessel_k1_imp(const T& x, const _Boost::integral_constant<int, 53>&)
   {
      BOOST_MATH_STD_USING
      if(x <= 1)
      {
   ...
   template <typename T>
   T bessel_k1_imp(const T& x, const _Boost::integral_constant<int, 64>&)
   {
      BOOST_MATH_STD_USING
      if(x <= 1)
      {
   ...
   template <typename T>
   T bessel_k1_imp(const T& x, const _Boost::integral_constant<int, 113>&)
   {
      BOOST_MATH_STD_USING
      if(x <= 1)
      {
    ...
    template <typename T>
    T bessel_k1_imp(const T& x, const _Boost::integral_constant<int, 0>&)
    {
       if(_Boost::math::tools::digits<T>() <= 24)
          return bessel_k1_imp(x, _Boost::integral_constant<int, 24>());
       else if(_Boost::math::tools::digits<T>() <= 53)
          return bessel_k1_imp(x, _Boost::integral_constant<int, 53>());
       else if(_Boost::math::tools::digits<T>() <= 64)
          return bessel_k1_imp(x, _Boost::integral_constant<int, 64>());
       else if(_Boost::math::tools::digits<T>() <= 113)
          return bessel_k1_imp(x, _Boost::integral_constant<int, 113>());
       BOOST_ASSERT(0);
       return 0;
    }
