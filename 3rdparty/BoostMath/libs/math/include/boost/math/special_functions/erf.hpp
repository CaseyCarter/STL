...
struct erf_asympt_series_t
{
   erf_asympt_series_t(T z) : xx(2 * -z * z), tk(1)
   {
      ...
      result = -exp(-z * z) / sqrt(_Boost::math::constants::pi<T>());
      result /= z;
   }
...
inline float erf_asymptotic_limit_N(const _Boost::integral_constant<int, 24>&)
{
   return 2.8F;
}
inline float erf_asymptotic_limit_N(const _Boost::integral_constant<int, 53>&)
{
   return 4.3F;
}
inline float erf_asymptotic_limit_N(const _Boost::integral_constant<int, 64>&)
{
   return 4.8F;
}
inline float erf_asymptotic_limit_N(const _Boost::integral_constant<int, 106>&)
{
   return 6.5F;
}
inline float erf_asymptotic_limit_N(const _Boost::integral_constant<int, 113>&)
{
   return 6.8F;
}
...
T erf_imp(T z, bool invert, const Policy& pol, const Tag& t)
{
   ...
   if(!invert && (z > detail::erf_asymptotic_limit<T, Policy>()))
   {
      ...
      result = _Boost::math::tools::sum_series(s, policies::get_epsilon<T, Policy>(), max_iter, 1);
      policies::check_series_iterations<T>("_Boost::math::erf<%1%>(%1%, %1%)", max_iter, pol);
   }
   else
   {
      T x = z * z;
      if(x < 0.6)
      {
         // Compute P:
         result = z * exp(-x);
         result /= sqrt(_Boost::math::constants::pi<T>());
         if(result != 0)
      ...
      else
      {
         ...
         invert = !invert;
         result = z * exp(-x);
         result /= _Boost::math::constants::root_pi<T>();
...
template <class T, class Policy>
T erf_imp(T z, bool invert, const Policy& pol, const _Boost::integral_constant<int, 53>& t)
{
   BOOST_MATH_STD_USING
   ...
   if ((_Boost::math::isnan)(z))
      return policies::raise_denorm_error("_Boost::math::erf<%1%>(%1%)", "Expected a finite argument but got %1%", z, pol);
   ...
   return result;
} // template <class T, class Lanczos>T erf_imp(T z, bool invert, const Lanczos& l, const _Boost::integral_constant<int, 53>& t)


template <class T, class Policy>
T erf_imp(T z, bool invert, const Policy& pol, const _Boost::integral_constant<int, 64>& t)
{
   BOOST_MATH_STD_USING
   ...
   return result;
} // template <class T, class Lanczos>T erf_imp(T z, bool invert, const Lanczos& l, const _Boost::integral_constant<int, 64>& t)


template <class T, class Policy>
T erf_imp(T z, bool invert, const Policy& pol, const _Boost::integral_constant<int, 113>& t)
{
   BOOST_MATH_STD_USING
   ...
   return result;
} // template <class T, class Lanczos>T erf_imp(T z, bool invert, const Lanczos& l, const _Boost::integral_constant<int, 113>& t)
...
struct erf_initializer
{
   struct init
   {
      ...
      {
         _Boost::math::erf(static_cast<T>(1e-12), Policy());
         _Boost::math::erf(static_cast<T>(0.25), Policy());
         _Boost::math::erf(static_cast<T>(1.25), Policy());
         _Boost::math::erf(static_cast<T>(2.25), Policy());
         _Boost::math::erf(static_cast<T>(4.25), Policy());
         _Boost::math::erf(static_cast<T>(5.25), Policy());
      }
      ...
      {
         _Boost::math::erf(static_cast<T>(1e-22), Policy());
         _Boost::math::erf(static_cast<T>(0.25), Policy());
         _Boost::math::erf(static_cast<T>(1.25), Policy());
         _Boost::math::erf(static_cast<T>(2.125), Policy());
         _Boost::math::erf(static_cast<T>(2.75), Policy());
         _Boost::math::erf(static_cast<T>(3.25), Policy());
         _Boost::math::erf(static_cast<T>(5.25), Policy());
         _Boost::math::erf(static_cast<T>(7.25), Policy());
         _Boost::math::erf(static_cast<T>(11.25), Policy());
         _Boost::math::erf(static_cast<T>(12.5), Policy());
      }
...
inline typename tools::promote_args<T>::type erf(T z, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::erf_imp(
      ...
      false,
      forwarding_policy(),
      tag_type()), "_Boost::math::erf<%1%>(%1%, %1%)");
}
...
inline typename tools::promote_args<T>::type erfc(T z, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(detail::erf_imp(
      ...
      true,
      forwarding_policy(),
      tag_type()), "_Boost::math::erfc<%1%>(%1%, %1%)");
}

template <class T>
inline typename tools::promote_args<T>::type erf(T z)
{
   return _Boost::math::erf(z, policies::policy<>());
}

template <class T>
inline typename tools::promote_args<T>::type erfc(T z)
{
   return _Boost::math::erfc(z, policies::policy<>());
}
