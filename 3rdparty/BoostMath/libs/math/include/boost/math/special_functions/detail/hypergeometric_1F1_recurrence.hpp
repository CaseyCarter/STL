...
#include <boost/math/special_functions/detail/hypergeometric_pFq_checked_series.hpp>
  ...
  {
    typedef _Boost::math::tuple<T, T, T> result_type;
    ...
    result_type operator()(_Boost::intmax_t i) const
    {
      const T ai = a + i;
      ...
      return _Boost::math::make_tuple(an, bn, cn);
    }
  ...
  inline T hypergeometric_1F1_backward_recurrence_for_negative_a(const T& a, const T& b, const T& z, const Policy& pol, const char* function, int& log_scaling)
  {
    ...
    _Boost::intmax_t integer_part = 0;
    ...
    if (-integer_part > static_cast<_Boost::intmax_t>(policies::get_max_series_iterations<Policy>()))
  ...
  T hypergeometric_1F1_backwards_recursion_on_b_for_negative_a(const T& a, const T& b, const T& z, const Policy& pol, const char*, int& log_scaling)
  {
     ...
     //
     if (b_shift > static_cast<_Boost::intmax_t>(_Boost::math::policies::get_max_series_iterations<Policy>()))
        return hypergeometric_1F1_checked_series_impl(a, b, z, pol, log_scaling);

     if (a_shift > static_cast<_Boost::intmax_t>(_Boost::math::policies::get_max_series_iterations<Policy>()))
        return hypergeometric_1F1_checked_series_impl(a, b, z, pol, log_scaling);
     ...
     first = _Boost::math::detail::hypergeometric_1F1_imp(T(a + a_shift), T(b + b_shift), z, pol, scale1);
     //
     ...
     //
     second = _Boost::math::detail::hypergeometric_1F1_imp(T(a + a_shift - 1), T(b + b_shift), z, pol, scale2);
     if (scale1 != scale2)
     ...
     //
     second = _Boost::math::tools::apply_recurrence_relation_backward(
