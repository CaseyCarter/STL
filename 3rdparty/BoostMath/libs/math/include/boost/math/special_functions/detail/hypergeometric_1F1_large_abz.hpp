  ...
  namespace _Boost { namespace math { namespace detail {
     ...
     struct hypergeometric_1F1_igamma_series
     {
           ...
           : delta_poch(-delta), alpha_poch(alpha), x(x), k(0), cache_offset(0), pol(pol)
        {
           ...
           log_scaling = itrunc(log_term - 3 - _Boost::math::tools::log_min_value<T>() / 50);
        ...
        void refill_cache()
        {
           ...
           gamma_cache[cache_size - 1] = _Boost::math::gamma_p(alpha_poch + ((int)cache_size - 1), x, pol);
     ...
     T hypergeometric_1F1_igamma(const T& a, const T& b, const T& x, const T& b_minus_a, const Policy& pol, int& log_scaling)
     {
        ...
        T log_prefix = x + _Boost::math::lgamma(b, pol) - _Boost::math::lgamma(a, pol);
     ...
     T hypergeometric_1F1_shift_on_a(T h, const T& a_local, const T& b_local, const T& x, int a_shift, const Policy& pol, int& log_scaling)
     {
        ...
        else if (a_shift > 0)
        {
           ...
           if (crossover_shift > 1)
           {
              ...
              _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> b_coef(crossover_a, b_local, x);
              _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();
              T b_ratio = _Boost::math::tools::function_ratio_from_backwards_recurrence(b_coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
              _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_large_abz<%1%>(%1%,%1%,%1%)", max_iter, pol);
              //
              // Convert to a ratio:
              ...
              //
              _Boost::math::detail::hypergeometric_1F1_recurrence_a_coefficients<T> a_coef(crossover_a, b_local, x);
              int backwards_scale = 0;
              T comparitor = _Boost::math::tools::apply_recurrence_relation_backward(a_coef, crossover_shift, second, first, &backwards_scale);
              ...
              if (crossover_shift < a_shift)
              {
                 _Boost::math::detail::hypergeometric_1F1_recurrence_a_coefficients<T> a_coef_2(crossover_a + 1, b_local, x);
                 h = _Boost::math::tools::apply_recurrence_relation_forward(a_coef_2, a_shift - crossover_shift - 1, first, second, &log_scaling);
              }
              else
                 h = first;
           }
           else
           {
              ...
              //
              _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> b_coef(a_local, b_local, x);
              _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();
              T b_ratio = _Boost::math::tools::function_ratio_from_backwards_recurrence(b_coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
              _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_large_abz<%1%>(%1%,%1%,%1%)", max_iter, pol);
              //
              ...
              _Boost::math::detail::hypergeometric_1F1_recurrence_a_coefficients<T> a_coef(a_local + 1, b_local, x);
              h = _Boost::math::tools::apply_recurrence_relation_forward(a_coef, --a_shift, h, second, &log_scaling);
           }
        }
        else
        {
           ...
           _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> b_coef(a, b_local, x);
           _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();
           T b_ratio = _Boost::math::tools::function_ratio_from_backwards_recurrence(b_coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
           _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_large_abz<%1%>(%1%,%1%,%1%)", max_iter, pol);
           //
           ...
           {
              _Boost::math::detail::hypergeometric_1F1_recurrence_a_coefficients<T> a_coef(a + 1, b_local, x);
              T comparitor = _Boost::math::tools::apply_recurrence_relation_forward(a_coef, -(a_shift + 1), first, second);
              if (_Boost::math::tools::min_value<T>() * comparitor > h)
              {
     ...
     T hypergeometric_1F1_shift_on_b(T h, const T& a, const T& b_local, const T& x, int b_shift, const Policy& pol, int& log_scaling)
     {
        ...
        else if (b_shift > 0)
        {
           ...
           //
           _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> b_coef(a, b, x);
           _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();

           T first = 1;  // arbitrary value;
           T second = 1 / _Boost::math::tools::function_ratio_from_backwards_recurrence(b_coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
           _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_large_abz<%1%>(%1%,%1%,%1%)", max_iter, pol);
           if (b_shift == 1)
              h = h / second;
           else
           {
              ...
              //
              _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> b_coef_2(a, b - 1, x);
              int local_scale = 0;
              T comparitor = _Boost::math::tools::apply_recurrence_relation_backward(b_coef_2, --b_shift, first, second, &local_scale);
        ...
        else
        {
           ...
           else
           {
              ...
              _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> b_coef(a, b_local, x);
              _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();
              second = h / _Boost::math::tools::function_ratio_from_backwards_recurrence(b_coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
              _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_large_abz<%1%>(%1%,%1%,%1%)", max_iter, pol);
           }
           if (b_shift == -1)
              h = second;
           ...
           {
              _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> b_coef_2(a, b_local - 1, x);
              h = _Boost::math::tools::apply_recurrence_relation_backward(b_coef_2, -(++b_shift), h, second, &log_scaling);
           }
        }
        return h;
     }
     ...
     T hypergeometric_1F1_large_series(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling)
     {
        ...
        T a_local = a - a_shift;
        T b_local = b - b_shift;
        T h = _Boost::math::detail::hypergeometric_1F1_generic_series(a_local, b_local, z, pol, log_scaling, "hypergeometric_1F1_large_series<%1%>(a,b,z)");
        //
        // Apply shifts on a and b as required:
        //
        if (a_shift && (a_local == 0))
        {
           ...
           //
           int scale = 0;
           T h2 = _Boost::math::detail::hypergeometric_1F1_generic_series(T(a_local + 1), b_local, z, pol, scale, "hypergeometric_1F1_large_series<%1%>(a,b,z)");
           if (scale != log_scaling)
           {
              h2 *= exp(T(scale - log_scaling));
           }
           _Boost::math::detail::hypergeometric_1F1_recurrence_a_coefficients<T> coef(a_local + 1, b_local, z);
           h = _Boost::math::tools::apply_recurrence_relation_forward(coef, a_shift - 1, h, h2, &log_scaling);
     ...
     T hypergeometric_1F1_large_13_3_6_series(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling)
     {
        ...
        T b_local = b - b_shift;
        T h = _Boost::math::detail::hypergeometric_1F1_AS_13_3_6(a, b_local, z, T(b_local - a), pol, log_scaling);
