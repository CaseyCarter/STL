    ...
    namespace math
    {
       namespace detail
       {
        ...
        inline T    atanh_imp(const T x, const Policy& pol)
        {
            ...
            static const char* function = "_Boost::math::atanh<%1%>(%1%)";
            ...
            else if(abs(x) >= tools::forth_root_epsilon<T>())
            {
                ...
                if(abs(x) < 0.5f)
                   return (_Boost::math::log1p(x, pol) - _Boost::math::log1p(-x, pol)) / 2;
        ...
        inline typename tools::promote_args<T>::type atanh(T x, const Policy&)
        {
           ...
           return policies::checked_narrowing_cast<result_type, forwarding_policy>(
              ...
              "_Boost::math::atanh<%1%>(%1%)");
        }
        template<typename T>
        inline typename tools::promote_args<T>::type atanh(T x)
        {
           return _Boost::math::atanh(x, policies::policy<>());
        }
