...
template <>
struct has_hidden_guard_digits<float> : public _Boost::false_type {};
template <>
struct has_hidden_guard_digits<double> : public _Boost::false_type {};
template <>
struct has_hidden_guard_digits<long double> : public _Boost::false_type {};
#ifdef BOOST_HAS_FLOAT128
template <>
struct has_hidden_guard_digits<__float128> : public _Boost::false_type {};
#endif
template <>
struct has_hidden_guard_digits<_Boost::math::concepts::real_concept> : public _Boost::false_type {};
template <>
struct has_hidden_guard_digits<_Boost::math::concepts::std_real_concept> : public _Boost::false_type {};

template <class T, bool b>
struct has_hidden_guard_digits_10 : public _Boost::false_type {};
template <class T>
struct has_hidden_guard_digits_10<T, true> : public _Boost::integral_constant<bool, (std::numeric_limits<T>::digits10 != std::numeric_limits<T>::max_digits10)> {};
...
template <class T>
inline const T& normalize_value(const T& val, const _Boost::false_type&) { return val; }
template <class T>
inline T normalize_value(const T& val, const _Boost::true_type&) 
{
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::is_specialized);
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::radix != 2);

   _Boost::intmax_t shift = (_Boost::intmax_t)std::numeric_limits<T>::digits - (_Boost::intmax_t)ilogb(val) - 1;
...
template <class T>
inline T get_smallest_value(_Boost::true_type const&)
{
   //
...
template <class T>
inline T get_smallest_value(_Boost::false_type const&)
{
...
inline T get_smallest_value()
{
   ...
   return get_smallest_value<T>(_Boost::integral_constant<bool, std::numeric_limits<T>::is_specialized && (std::numeric_limits<T>::has_denorm == 1)>());
#else
   return get_smallest_value<T>(_Boost::integral_constant<bool, std::numeric_limits<T>::is_specialized && (std::numeric_limits<T>::has_denorm == std::denorm_present)>());
#endif
}
...
template <class T>
inline T calc_min_shifted(const _Boost::true_type&)
{
   BOOST_MATH_STD_USING
   return ldexp(tools::min_value<T>(), tools::digits<T>() + 1);
}
template <class T>
inline T calc_min_shifted(const _Boost::false_type&)
{
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::is_specialized);
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::radix != 2);
...
{
   static const T val = calc_min_shifted<T>(_Boost::integral_constant<bool, !std::numeric_limits<T>::is_specialized || std::numeric_limits<T>::radix == 2>());
...
T float_next_imp(const T& val, const _Boost::true_type&, const Policy& pol)
{
   BOOST_MATH_STD_USING
   int expon;
   static const char* function = "float_next<%1%>(%1%)";

   int fpclass = (_Boost::math::fpclassify)(val);
...
//
template <class T, class Policy>
T float_next_imp(const T& val, const _Boost::false_type&, const Policy& pol)
{
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::is_specialized);
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::radix != 2);

   BOOST_MATH_STD_USING
   _Boost::intmax_t expon;
   static const char* function = "float_next<%1%>(%1%)";
...
inline typename tools::promote_args<T>::type float_next(const T& val, const Policy& pol)
{
   ...
   return detail::float_next_imp(detail::normalize_value(static_cast<result_type>(val), typename detail::has_hidden_guard_digits<result_type>::type()), _Boost::integral_constant<bool, !std::numeric_limits<result_type>::is_specialized || (std::numeric_limits<result_type>::radix == 2)>(), pol);
}
...
inline double float_next(const double& val, const Policy& pol)
{
   ...
   if(!(_Boost::math::isfinite)(val) && (val > 0))
...
template <class T, class Policy>
T float_prior_imp(const T& val, const _Boost::true_type&, const Policy& pol)
{
   BOOST_MATH_STD_USING
   int expon;
...
//
template <class T, class Policy>
T float_prior_imp(const T& val, const _Boost::false_type&, const Policy& pol)
{
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::is_specialized);
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::radix != 2);
...
{
   typedef typename tools::promote_args<T>::type result_type;
   return detail::float_prior_imp(detail::normalize_value(static_cast<result_type>(val), typename detail::has_hidden_guard_digits<result_type>::type()), _Boost::integral_constant<bool, !std::numeric_limits<result_type>::is_specialized || (std::numeric_limits<result_type>::radix == 2)>(), pol);
}
...
inline typename tools::promote_args<T, U>::type nextafter(const T& val, const U& direction, const Policy& pol)
{
   ...
   return val < direction ? _Boost::math::float_next<result_type>(val, pol) : val == direction ? val : _Boost::math::float_prior<result_type>(val, pol);
}
...
template <class T, class Policy>
T float_distance_imp(const T& a, const T& b, const _Boost::true_type&, const Policy& pol)
{
   BOOST_MATH_STD_USING
   //
   // Error handling:
   ...
   if(!(_Boost::math::isfinite)(a))
      return policies::raise_domain_error<T>(
         function,
         "Argument a must be finite, but got %1%", a, pol);
   if(!(_Boost::math::isfinite)(b))
      return policies::raise_domain_error<T>(
         function,
   ...
   if(_Boost::math::sign(a) != _Boost::math::sign(b))
   ...
   //
   (void)frexp(((_Boost::math::fpclassify)(a) == (int)FP_SUBNORMAL) ? tools::min_value<T>() : a, &expon);
   ...
   T mb, x, y, z;
   if(((_Boost::math::fpclassify)(a) == (int)FP_SUBNORMAL) || (b - a < tools::min_value<T>()))
   {
      //
...
//
template <class T, class Policy>
T float_distance_imp(const T& a, const T& b, const _Boost::false_type&, const Policy& pol)
{
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::is_specialized);
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::radix != 2);
   ...
   // significant bits in the representation:
   //
   expon = 1 + ilogb(((_Boost::math::fpclassify)(a) == (int)FP_SUBNORMAL) ? tools::min_value<T>() : a);
   ...
   if(b > upper)
   {
      _Boost::intmax_t expon2 = 1 + ilogb(b);
...
//
template <class T, class Policy>
T float_advance_imp(T val, int distance, const _Boost::false_type&, const Policy& pol)
{
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::is_specialized);
   BOOST_STATIC_ASSERT(std::numeric_limits<T>::radix != 2);
   ...
   _Boost::intmax_t expon = 1 + ilogb(val);
...
{
   typedef typename tools::promote_args<T>::type result_type;
   return detail::float_advance_imp(detail::normalize_value(static_cast<result_type>(val), typename detail::has_hidden_guard_digits<result_type>::type()), distance, _Boost::integral_constant<bool, !std::numeric_limits<result_type>::is_specialized || (std::numeric_limits<result_type>::radix == 2)>(), pol);
}

template <class T>
inline typename tools::promote_args<T>::type float_advance(const T& val, int distance)
{
   return _Boost::math::float_advance(val, distance, policies::policy<>());
}
