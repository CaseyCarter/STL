...
struct sph_bessel_j_small_z_series_term
{
      ...
      : N(0), v(v_)
   {
      ...
      {
         term = v * log(mult) - _Boost::math::lgamma(v+1+T(0.5f), Policy());
         term = exp(term);
      }
      else
         term = pow(mult, T(v)) / _Boost::math::tgamma(v+1+T(0.5f), Policy());
      mult *= -mult;
   }
   T operator()()
   {
...
inline T sph_bessel_j_small_z_series(unsigned v, T x, const Policy& pol)
{
   ...
   T zero = 0;
   T result = _Boost::math::tools::sum_series(s, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter, zero);
#else
   T result = _Boost::math::tools::sum_series(s, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
#endif
   policies::check_series_iterations<T>("_Boost::math::sph_bessel_j_small_z_series<%1%>(%1%,%1%)", max_iter, pol);
...
{
   BOOST_MATH_STD_USING
   static const char* function = "_Boost::math::bessel_j<%1%>(%1%,%1%)";
   if(x < 0)
   {
...
T cyl_bessel_i_imp(T v, T x, const Policy& pol)
{
   ...
   if(x < 0)
   {
      ...
      if(floor(v) == v)
      {
         ...
         return policies::raise_domain_error<T>(
         "_Boost::math::cyl_bessel_i<%1%>(%1%,%1%)",
            "Got x = %1%, but we need x >= 0", x, pol);
   }
   if(x == 0)
   {
...
{
   static const char* function = "_Boost::math::cyl_bessel_k<%1%>(%1%,%1%)";
   BOOST_MATH_STD_USING
   if(x < 0)
   {
      return policies::raise_domain_error<T>(
...
{
   static const char* function = "_Boost::math::cyl_neumann<%1%>(%1%,%1%)";
...
{
   BOOST_MATH_STD_USING // ADL of std names
   static const char* function = "_Boost::math::sph_neumann<%1%>(%1%,%1%)";
   //
...
inline T cyl_bessel_j_zero_imp(T v, int m, const Policy& pol)
{
   ...
   static const char* function = "_Boost::math::cyl_bessel_j_zero<%1%>(%1%, int)";

   const T half_epsilon(_Boost::math::tools::epsilon<T>() / 2U);

   // Handle non-finite order.
   if (!(_Boost::math::isfinite)(v) )
   {
   ...
   const T guess_root = _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess<T, Policy>((order_is_integer ? vv : v), m, pol);

   // Select the maximum allowed iterations from the policy.
   _Boost::uintmax_t number_of_iterations = policies::get_max_root_iterations<Policy>();

   const T delta_lo = ((guess_root > 0.2F) ? T(0.2) : T(guess_root / 2U));

   // Perform the root-finding using Newton-Raphson iteration from Boost.Math.
   const T jvm =
      _Boost::math::tools::newton_raphson_iterate(
         _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::function_object_jv_and_jv_prime<T, Policy>((order_is_integer ? vv : v), order_is_zero, pol),
         guess_root,
...
inline T cyl_neumann_zero_imp(T v, int m, const Policy& pol)
{
   ...
   static const char* function = "_Boost::math::cyl_neumann_zero<%1%>(%1%, int)";
   ...
   if(order_is_negative && order_is_integer)
      return _Boost::math::detail::cyl_neumann_zero_imp(vv, m, pol);
   ...
   if(order_is_negative_half_integer)
      return _Boost::math::detail::cyl_bessel_j_zero_imp(vv, m, pol);

   // Set up the initial guess for the upcoming root-finding.
   // If the order is a negative integer, then use the corresponding
   // positive integer for the order.
   const T guess_root = _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::initial_guess<T, Policy>(v, m, pol);
   ...
   const T yvm =
      _Boost::math::tools::newton_raphson_iterate(
         _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::function_object_yv_and_yv_prime<T, Policy>(v, pol),
         guess_root,
         T(guess_root - delta_lo),
         T(guess_root + 0.2F),
         policies::digits<T, Policy>(),
...
inline typename detail::bessel_traits<T1, T2, Policy>::result_type cyl_bessel_j(T1 v, T2 x, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::cyl_bessel_j_imp<value_type>(v, static_cast<value_type>(x), tag_type(), forwarding_policy()), "_Boost::math::cyl_bessel_j<%1%>(%1%,%1%)");
}
...
inline typename detail::bessel_traits<T, T, Policy>::result_type sph_bessel(unsigned v, T x, const Policy& /* pol */)
{
   ...
   typedef typename policies::normalise<
      ...
      policies::discrete_quantile<>,
      policies::assert_undefined<> >::type forwarding_policy;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::sph_bessel_j_imp<value_type>(v, static_cast<value_type>(x), forwarding_policy()), "_Boost::math::sph_bessel<%1%>(%1%,%1%)");
}
...
inline typename detail::bessel_traits<T1, T2, Policy>::result_type cyl_bessel_i(T1 v, T2 x, const Policy& /* pol */)
{
   ...
   typedef typename policies::normalise<
      ...
      policies::discrete_quantile<>,
      policies::assert_undefined<> >::type forwarding_policy;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::cyl_bessel_i_imp<value_type>(static_cast<value_type>(v), static_cast<value_type>(x), forwarding_policy()), "_Boost::math::cyl_bessel_i<%1%>(%1%,%1%)");
}
...
inline typename detail::bessel_traits<T1, T2, Policy>::result_type cyl_bessel_k(T1 v, T2 x, const Policy& /* pol */)
{
   ...
   typedef typename policies::normalise<
      ...
      policies::discrete_quantile<>,
      policies::assert_undefined<> >::type forwarding_policy;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::cyl_bessel_k_imp<value_type>(v, static_cast<value_type>(x), tag_type(), forwarding_policy()), "_Boost::math::cyl_bessel_k<%1%>(%1%,%1%)");
}
...
inline typename detail::bessel_traits<T1, T2, Policy>::result_type cyl_neumann(T1 v, T2 x, const Policy& /* pol */)
{
   ...
   typedef typename policies::normalise<
      ...
      policies::discrete_quantile<>,
      policies::assert_undefined<> >::type forwarding_policy;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::cyl_neumann_imp<value_type>(v, static_cast<value_type>(x), tag_type(), forwarding_policy()), "_Boost::math::cyl_neumann<%1%>(%1%,%1%)");
}
...
inline typename detail::bessel_traits<T, T, Policy>::result_type sph_neumann(unsigned v, T x, const Policy& /* pol */)
{
   ...
   typedef typename policies::normalise<
      ...
      policies::discrete_quantile<>,
      policies::assert_undefined<> >::type forwarding_policy;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::sph_neumann_imp<value_type>(v, static_cast<value_type>(x), forwarding_policy()), "_Boost::math::sph_neumann<%1%>(%1%,%1%)");
}
...
inline typename detail::bessel_traits<T, T, Policy>::result_type cyl_bessel_j_zero(T v, int m, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::cyl_bessel_j_zero_imp<value_type>(v, m, forwarding_policy()), "_Boost::math::cyl_bessel_j_zero<%1%>(%1%,%1%)");
}
                              ...
                              const Policy& pol)
{
   ...
   {
      *out_it = _Boost::math::cyl_bessel_j_zero(v, start_index + i, pol);
      ++out_it;
   }
   return out_it;
}
...
inline typename detail::bessel_traits<T, T, Policy>::result_type cyl_neumann_zero(T v, int m, const Policy& /* pol */)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::cyl_neumann_zero_imp<value_type>(v, m, forwarding_policy()), "_Boost::math::cyl_neumann_zero<%1%>(%1%,%1%)");
}
                             ...
                             const Policy& pol)
{
   ...
   for(int i = 0; i < static_cast<int>(number_of_zeros); ++i)
   {
      *out_it = _Boost::math::cyl_neumann_zero(v, start_index + i, pol);
      ++out_it;
   }
   return out_it;
}
