  ...
  namespace _Boost { namespace math { namespace detail {
     ...
     struct hypergeometric_1f1_recurrence_on_z_minus_zero_series
     {
           ...
           : term(1), b_minus_a_plus_n(b - a), a_(a), b_(b), z_(z), n(0), k(k_)
        {
           ...
           M = _Boost::math::detail::hypergeometric_1F1_imp(a, b, z, pol, scale1);
           M_next = _Boost::math::detail::hypergeometric_1F1_imp(T(a - 1), b, z, pol, scale2);
           if (scale1 != scale2)
     ...
     T hypergeometric_1f1_recurrence_on_z_minus_zero(const T& a, const T& b, const T& z, int k, const Policy& pol, int& log_scaling)
     {
        ...
        log_scaling += s.scale();
        _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1f1_recurrence_on_z_plus_plus<%1%>(%1%,%1%,%1%)", max_iter, pol);
     ...
     struct hypergeometric_1f1_recurrence_on_z_plus_plus_series
     {
        ...
        {
           M = _Boost::math::detail::hypergeometric_1F1_imp(a, b, z, pol);
           M_next = _Boost::math::detail::hypergeometric_1F1_imp(a + 1, b + 1, z, pol);
        }
        T operator()()
        {
           T result = term * M;
     ...
     struct hypergeometric_1f1_recurrence_on_z_zero_minus_series
     {
        ...
        {
           M = _Boost::math::detail::hypergeometric_1F1_imp(a, b, z, pol);
           M_next = _Boost::math::detail::hypergeometric_1F1_imp(a, b - 1, z, pol);
        }
        T operator()()
        {
           BOOST_MATH_STD_USING
     ...
     struct hypergeometric_1f1_recurrence_on_z_plus_zero_series
     {
        ...
        {
           M = _Boost::math::detail::hypergeometric_1F1_imp(a, b, z, pol);
           M_next = _Boost::math::detail::hypergeometric_1F1_imp(a + 1, b, z, pol);
        }
        T operator()()
        {
           T result = term * M;
