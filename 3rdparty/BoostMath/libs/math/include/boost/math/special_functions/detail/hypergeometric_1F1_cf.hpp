...
//
  ...
  namespace _Boost { namespace math { namespace detail {
     ...
     T hypergeometric_1F1_cf(const T& a, const T& b, const T& z, const Policy& pol, const char* function)
     {
        ...
        T result = _Boost::math::tools::continued_fraction_a(func, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
        _Boost::math::policies::check_series_iterations<T>(function, max_iter, pol);
