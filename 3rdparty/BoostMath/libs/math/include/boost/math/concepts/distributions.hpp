...
struct DistributionConcept
{
   ...
   static void test_extra_members(const _Boost::math::bernoulli_distribution<R, P>& d)
   {
      value_type r = d.success_fraction();
      (void)r; // warning suppression
   }
   template <class R, class P>
   static void test_extra_members(const _Boost::math::beta_distribution<R, P>& d)
   {
      value_type r1 = d.alpha();
      value_type r2 = d.beta();
      r1 = _Boost::math::beta_distribution<R, P>::find_alpha(r1, r2);
      suppress_unused_variable_warning(r1);
      r1 = _Boost::math::beta_distribution<R, P>::find_beta(r1, r2);
      suppress_unused_variable_warning(r1);
      r1 = _Boost::math::beta_distribution<R, P>::find_alpha(r1, r2, r1);
      suppress_unused_variable_warning(r1);
      r1 = _Boost::math::beta_distribution<R, P>::find_beta(r1, r2, r1);
      suppress_unused_variable_warning(r1);
   }
   template <class R, class P>
   static void test_extra_members(const _Boost::math::binomial_distribution<R, P>& d)
   {
      value_type r = d.success_fraction();
      r = d.trials();
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::cauchy_distribution<R, P>& d)
   {
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::chi_squared_distribution<R, P>& d)
   {
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::exponential_distribution<R, P>& d)
   {
      value_type r = d.lambda();
      suppress_unused_variable_warning(r);
   }
   template <class R, class P>
   static void test_extra_members(const _Boost::math::extreme_value_distribution<R, P>& d)
   {
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::fisher_f_distribution<R, P>& d)
   {
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::gamma_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.shape();
      suppress_unused_variable_warning(r);
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::inverse_chi_squared_distribution<R, P>& d)
   {
      value_type r = d.scale();
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::inverse_gamma_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.shape();
      suppress_unused_variable_warning(r);
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::hypergeometric_distribution<R, P>& d)
   {
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::laplace_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.location();
      suppress_unused_variable_warning(r);
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::logistic_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.location();
      suppress_unused_variable_warning(r);
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::lognormal_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.location();
      suppress_unused_variable_warning(r);
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::negative_binomial_distribution<R, P>& d)
   {
      value_type r = d.success_fraction();
      r = d.successes();
      r = Distribution::find_lower_bound_on_p(r, r, r);
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::non_central_beta_distribution<R, P>& d)
   {
      value_type r1 = d.alpha();
      value_type r2 = d.beta();
      r1 = d.non_centrality();
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::non_central_chi_squared_distribution<R, P>& d)
   {
      value_type r = d.degrees_of_freedom();
      r = d.non_centrality();
      r = Distribution::find_degrees_of_freedom(r, r, r);
      r = Distribution::find_degrees_of_freedom(_Boost::math::complement(r, r, r));
      r = Distribution::find_non_centrality(r, r, r);
      r = Distribution::find_non_centrality(_Boost::math::complement(r, r, r));
      (void)r; // warning suppression
   }
   template <class R, class P>
   static void test_extra_members(const _Boost::math::non_central_f_distribution<R, P>& d)
   {
      value_type r = d.degrees_of_freedom1();
      r = d.degrees_of_freedom2();
      r = d.non_centrality();
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::non_central_t_distribution<R, P>& d)
   {
      value_type r = d.degrees_of_freedom();
      r = d.non_centrality();
      (void)r; // warning suppression
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::normal_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.location();
      r = d.mean();
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::pareto_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.shape();
      (void)r; // warning suppression
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::poisson_distribution<R, P>& d)
   {
      value_type r = d.mean();
      (void)r; // warning suppression
   }
   template <class R, class P>
   static void test_extra_members(const _Boost::math::rayleigh_distribution<R, P>& d)
   {
      value_type r = d.sigma();
      (void)r; // warning suppression
   }
   template <class R, class P>
   static void test_extra_members(const _Boost::math::students_t_distribution<R, P>& d)
   {
      value_type r = d.degrees_of_freedom();
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::triangular_distribution<R, P>& d)
   {
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::weibull_distribution<R, P>& d)
   {
      value_type r = d.scale();
      r = d.shape();
      (void)r; // warning suppression
   ...
   template <class R, class P>
   static void test_extra_members(const _Boost::math::uniform_distribution<R, P>& d)
   {
      value_type r = d.lower();
      r = d.upper();
      (void)r; // warning suppression
