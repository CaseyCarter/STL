...
public:
   ...
   real_concept(_Boost::ulong_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   real_concept(_Boost::long_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   ...
   real_concept& operator=(_Boost::long_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
   real_concept& operator=(_Boost::ulong_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
#endif
...
inline real_concept modf(real_concept a, real_concept* ipart)
{
   ...
   real_concept_base_type result = _Boost::math::modf(a.value(), &ip);
   *ipart = ip;
   return result;
#else
   real_concept_base_type ip;
...
//
inline _Boost::math::concepts::real_concept asinh(_Boost::math::concepts::real_concept a)
{
...
inline _Boost::math::concepts::real_concept acosh(_Boost::math::concepts::real_concept a)
{
...
inline _Boost::math::concepts::real_concept atanh(_Boost::math::concepts::real_concept a)
{
...
#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline _Boost::long_long_type llround(const concepts::real_concept& v, const Policy& pol)
{ return _Boost::math::llround(v.value(), pol); }
inline _Boost::long_long_type llround(const concepts::real_concept& v)
...
#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline _Boost::long_long_type lltrunc(const concepts::real_concept& v, const Policy& pol)
{ return _Boost::math::lltrunc(v.value(), pol); }
inline _Boost::long_long_type lltrunc(const concepts::real_concept& v)
...
template <>
inline concepts::real_concept make_big_value<concepts::real_concept>(_Boost::math::tools::largest_float val, const char* , _Boost::false_type const&, _Boost::false_type const&)
{
...
namespace policies {
   namespace detail {
         ...
         const  ::_Boost::math::policies::rounding_error< ::_Boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
      {
         ...
         return  val > 0 ? _Boost::math::tools::max_value<concepts::real_concept>() : -_Boost::math::tools::max_value<concepts::real_concept>();
      }
