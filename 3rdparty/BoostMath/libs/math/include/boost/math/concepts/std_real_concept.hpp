...
public:
   ...
   std_real_concept(_Boost::ulong_long_type c) : m_value(static_cast<std_real_concept_base_type>(c)){}
   std_real_concept(_Boost::long_long_type c) : m_value(static_cast<std_real_concept_base_type>(c)){}
#endif
...
#elif defined(BOOST_HAS_LONG_LONG)
   std_real_concept& operator=(_Boost::long_long_type c) { m_value = static_cast<std_real_concept_base_type>(c); return *this; }
   std_real_concept& operator=(_Boost::ulong_long_type c) { m_value = static_cast<std_real_concept_base_type>(c); return *this; }
#endif
...
inline _Boost::math::concepts::std_real_concept acos(_Boost::math::concepts::std_real_concept a)
{ return std::acos(a.value()); }
inline _Boost::math::concepts::std_real_concept cos(_Boost::math::concepts::std_real_concept a)
{ return std::cos(a.value()); }
inline _Boost::math::concepts::std_real_concept asin(_Boost::math::concepts::std_real_concept a)
{ return std::asin(a.value()); }
inline _Boost::math::concepts::std_real_concept atan(_Boost::math::concepts::std_real_concept a)
{ return std::atan(a.value()); }
inline _Boost::math::concepts::std_real_concept atan2(_Boost::math::concepts::std_real_concept a, _Boost::math::concepts::std_real_concept b)
{ return std::atan2(a.value(), b.value()); }
inline _Boost::math::concepts::std_real_concept ceil(_Boost::math::concepts::std_real_concept a)
{ return std::ceil(a.value()); }
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
inline _Boost::math::concepts::std_real_concept fmod(_Boost::math::concepts::std_real_concept a, _Boost::math::concepts::std_real_concept b)
{ return fmodl(a.value(), b.value()); }
#else
inline _Boost::math::concepts::std_real_concept fmod(_Boost::math::concepts::std_real_concept a, _Boost::math::concepts::std_real_concept b)
{ return std::fmod(a.value(), b.value()); }
#endif
inline _Boost::math::concepts::std_real_concept cosh(_Boost::math::concepts::std_real_concept a)
{ return std::cosh(a.value()); }
inline _Boost::math::concepts::std_real_concept exp(_Boost::math::concepts::std_real_concept a)
{ return std::exp(a.value()); }
inline _Boost::math::concepts::std_real_concept fabs(_Boost::math::concepts::std_real_concept a)
{ return std::fabs(a.value()); }
inline _Boost::math::concepts::std_real_concept abs(_Boost::math::concepts::std_real_concept a)
{ return std::abs(a.value()); }
inline _Boost::math::concepts::std_real_concept floor(_Boost::math::concepts::std_real_concept a)
{ return std::floor(a.value()); }
inline _Boost::math::concepts::std_real_concept modf(_Boost::math::concepts::std_real_concept a, _Boost::math::concepts::std_real_concept* ipart)
{
   _Boost::math::concepts::std_real_concept_base_type ip;
   _Boost::math::concepts::std_real_concept_base_type result = std::modf(a.value(), &ip);
   *ipart = ip;
   return result;
}
inline _Boost::math::concepts::std_real_concept frexp(_Boost::math::concepts::std_real_concept a, int* expon)
{ return std::frexp(a.value(), expon); }
inline _Boost::math::concepts::std_real_concept ldexp(_Boost::math::concepts::std_real_concept a, int expon)
{ return std::ldexp(a.value(), expon); }
inline _Boost::math::concepts::std_real_concept log(_Boost::math::concepts::std_real_concept a)
{ return std::log(a.value()); }
inline _Boost::math::concepts::std_real_concept log10(_Boost::math::concepts::std_real_concept a)
{ return std::log10(a.value()); }
inline _Boost::math::concepts::std_real_concept tan(_Boost::math::concepts::std_real_concept a)
{ return std::tan(a.value()); }
inline _Boost::math::concepts::std_real_concept pow(_Boost::math::concepts::std_real_concept a, _Boost::math::concepts::std_real_concept b)
{ return std::pow(a.value(), b.value()); }
#if !defined(__SUNPRO_CC)
inline _Boost::math::concepts::std_real_concept pow(_Boost::math::concepts::std_real_concept a, int b)
{ return std::pow(a.value(), b); }
#else
inline _Boost::math::concepts::std_real_concept pow(_Boost::math::concepts::std_real_concept a, int b)
{ return std::pow(a.value(), static_cast<long double>(b)); }
#endif
inline _Boost::math::concepts::std_real_concept sin(_Boost::math::concepts::std_real_concept a)
{ return std::sin(a.value()); }
inline _Boost::math::concepts::std_real_concept sinh(_Boost::math::concepts::std_real_concept a)
{ return std::sinh(a.value()); }
inline _Boost::math::concepts::std_real_concept sqrt(_Boost::math::concepts::std_real_concept a)
{ return std::sqrt(a.value()); }
inline _Boost::math::concepts::std_real_concept tanh(_Boost::math::concepts::std_real_concept a)
{ return std::tanh(a.value()); }
inline _Boost::math::concepts::std_real_concept (nextafter)(_Boost::math::concepts::std_real_concept a, _Boost::math::concepts::std_real_concept b)
{ return (_Boost::math::nextafter)(a, b); }
//
// C++11 ism's
...
//
inline _Boost::math::concepts::std_real_concept asinh(_Boost::math::concepts::std_real_concept a)
{ return _Boost::math::asinh(a.value(), _Boost::math::policies::make_policy(_Boost::math::policies::overflow_error<_Boost::math::policies::ignore_error>())); }
inline _Boost::math::concepts::std_real_concept acosh(_Boost::math::concepts::std_real_concept a)
{ return _Boost::math::acosh(a.value(), _Boost::math::policies::make_policy(_Boost::math::policies::overflow_error<_Boost::math::policies::ignore_error>())); }
inline _Boost::math::concepts::std_real_concept atanh(_Boost::math::concepts::std_real_concept a)
{ return _Boost::math::atanh(a.value(), _Boost::math::policies::make_policy(_Boost::math::policies::overflow_error<_Boost::math::policies::ignore_error>())); }
inline bool (isfinite)(_Boost::math::concepts::std_real_concept a)
{
   return (_Boost::math::isfinite)(a.value());
}
...
namespace _Boost{ namespace math{ namespace concepts{
...
{
   return _Boost::math::iround(v.value(), pol);
}
inline int iround(const concepts::std_real_concept& v)
{
   return _Boost::math::iround(v.value(), policies::policy<>());
}

template <class Policy>
inline long lround(const concepts::std_real_concept& v, const Policy& pol)
{
   return _Boost::math::lround(v.value(), pol);
}
inline long lround(const concepts::std_real_concept& v)
{
   return _Boost::math::lround(v.value(), policies::policy<>());
}

#ifdef BOOST_HAS_LONG_LONG

template <class Policy>
inline _Boost::long_long_type llround(const concepts::std_real_concept& v, const Policy& pol)
{
   return _Boost::math::llround(v.value(), pol);
}
inline _Boost::long_long_type llround(const concepts::std_real_concept& v)
{
   return _Boost::math::llround(v.value(), policies::policy<>());
}
...
{
   return _Boost::math::itrunc(v.value(), pol);
}
inline int itrunc(const concepts::std_real_concept& v)
{
   return _Boost::math::itrunc(v.value(), policies::policy<>());
}

template <class Policy>
inline long ltrunc(const concepts::std_real_concept& v, const Policy& pol)
{
   return _Boost::math::ltrunc(v.value(), pol);
}
inline long ltrunc(const concepts::std_real_concept& v)
{
   return _Boost::math::ltrunc(v.value(), policies::policy<>());
}

#ifdef BOOST_HAS_LONG_LONG

template <class Policy>
inline _Boost::long_long_type lltrunc(const concepts::std_real_concept& v, const Policy& pol)
{
   return _Boost::math::lltrunc(v.value(), pol);
}
inline _Boost::long_long_type lltrunc(const concepts::std_real_concept& v)
{
   return _Boost::math::lltrunc(v.value(), policies::policy<>());
}
...
template <>
inline concepts::std_real_concept make_big_value<concepts::std_real_concept>(_Boost::math::tools::largest_float val, const char*, _Boost::false_type const&, _Boost::false_type const&)
{
