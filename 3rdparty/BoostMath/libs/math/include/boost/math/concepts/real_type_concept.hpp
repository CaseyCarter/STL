...
struct RealTypeConcept
{
   ...
   void constraints()
   {
      ...
      r2 = ldexp(r, i);
      r2 = frexp(r, &i);
      i = _Boost::math::tools::digits<RealType>();
      r2 = _Boost::math::tools::max_value<RealType>();
      r2 = _Boost::math::tools::min_value<RealType>();
      r2 = _Boost::math::tools::log_max_value<RealType>();
      r2 = _Boost::math::tools::log_min_value<RealType>();
      r2 = _Boost::math::tools::epsilon<RealType>();
   }
