...
namespace _Boost { namespace math { 
    ...
    public:
      ...
      {
        static const char* function = "_Boost::math::logistic_distribution<%1%>::logistic_distribution";
    ...
    {
       static const char* function = "_Boost::math::pdf(const logistic_distribution<%1%>&, %1%)";
    ...
    inline RealType cdf(const logistic_distribution<RealType, Policy>& dist, const RealType& x)
    {
       ...
       static const char* function = "_Boost::math::cdf(const logistic_distribution<%1%>&, %1%)";
       if(false == detail::check_scale(function, scale, &result, Policy()))
       {
          return result;
       }
    ...
    inline RealType quantile(const logistic_distribution<RealType, Policy>& dist, const RealType& p)
    {
       ...
       static const char* function = "_Boost::math::quantile(const logistic_distribution<%1%>&, %1%)";
    ...
    inline RealType cdf(const complemented2_type<logistic_distribution<RealType, Policy>, RealType>& c)
    {
       ...
       RealType x = c.param;
       static const char* function = "_Boost::math::cdf(const complement(logistic_distribution<%1%>&), %1%)";
    ...
    inline RealType quantile(const complemented2_type<logistic_distribution<RealType, Policy>, RealType>& c)
    {
       ...
       RealType scale = c.dist.scale();
       RealType location = c.dist.location();
       static const char* function = "_Boost::math::quantile(const complement(logistic_distribution<%1%>&), %1%)";
       RealType result = 0;
       if(false == detail::check_scale(function, scale, &result, Policy()))
          return result;
       if(false == detail::check_location(function, location, &result, Policy()))
    ...
    inline RealType variance(const logistic_distribution<RealType, Policy>& dist)
    {
      BOOST_MATH_STD_USING
      RealType scale = dist.scale();
      return _Boost::math::constants::pi<RealType>()*_Boost::math::constants::pi<RealType>()*scale*scale/3;
