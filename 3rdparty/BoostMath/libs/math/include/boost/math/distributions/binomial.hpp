...
namespace _Boost
{
  namespace math
  {
     ...
     namespace binomial_detail{
      ...
      { // Quantile or Percent Point Binomial function.
        ...
        if(false == binomial_detail::check_dist_and_prob(
           "_Boost::math::quantile(binomial_distribution<%1%> const&, %1%)",
           trials,
           success_fraction,
           p,
           &result, Policy()))
    ...
    public:
      ...
      { // Default n = 1 is the Bernoulli distribution
        // with equal probability of 'heads' or 'tails.
         ...
         binomial_detail::check_dist(
            "_Boost::math::binomial_distribution<%1%>::binomial_distribution",
            m_n,
            m_p,
            &r, Policy());
      ...
      {
        static const char* function = "_Boost::math::binomial_distribution<%1%>::find_lower_bound_on_p";
        // Error checks:
        RealType result = 0;
      ...
      static RealType find_upper_bound_on_p(
         ...
         interval_type t = clopper_pearson_exact_interval)
      {
        static const char* function = "_Boost::math::binomial_distribution<%1%>::find_upper_bound_on_p";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           function, trials, RealType(0), successes, &result, Policy())
      ...
      {
        static const char* function = "_Boost::math::binomial_distribution<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
         ...
         RealType alpha) // risk level
      {
        static const char* function = "_Boost::math::binomial_distribution<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           function, k, p, k, &result, Policy())
    ...
    private:
      ...
      { // Probability Density/Mass Function.
        ...
        if(false == binomial_detail::check_dist_and_k(
           "_Boost::math::pdf(binomial_distribution<%1%> const&, %1%)",
           n,
        ...
        //
        using _Boost::math::ibeta_derivative; // a, b, x
      ...
      { // Cumulative Distribution Function Binomial.
        ...
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           "_Boost::math::cdf(binomial_distribution<%1%> const&, %1%)",
           n,
           p,
           k,
           &result, Policy()))
