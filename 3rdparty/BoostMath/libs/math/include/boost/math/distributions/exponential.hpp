...
public:
   ...
   {
      RealType err;
      detail::verify_lambda("_Boost::math::exponential_distribution<%1%>::exponential_distribution", l_lambda, &err, Policy());
...
inline RealType pdf(const exponential_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::pdf(const exponential_distribution<%1%>&, %1%)";
...
inline RealType cdf(const exponential_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::cdf(const exponential_distribution<%1%>&, %1%)";
   ...
   if(0 == detail::verify_exp_x(function, x, &result, Policy()))
      return result;
   result = -_Boost::math::expm1(-x * lambda, Policy());
...
inline RealType quantile(const exponential_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "_Boost::math::quantile(const exponential_distribution<%1%>&, %1%)";
   ...
   result = -_Boost::math::log1p(-p, Policy()) / lambda;
   return result;
} // quantile
...
inline RealType mean(const exponential_distribution<RealType, Policy>& dist)
{
   RealType result = 0;
   RealType lambda = dist.lambda();
   if(0 == detail::verify_lambda("_Boost::math::mean(const exponential_distribution<%1%>&)", lambda, &result, Policy()))
      return result;
   return 1 / lambda;
}
...
inline RealType standard_deviation(const exponential_distribution<RealType, Policy>& dist)
{
   RealType result = 0;
   RealType lambda = dist.lambda();
   if(0 == detail::verify_lambda("_Boost::math::standard_deviation(const exponential_distribution<%1%>&)", lambda, &result, Policy()))
      return result;
   return 1 / lambda;
}
