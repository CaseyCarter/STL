...
namespace _Boost{ namespace math
{
  ...
  public:
    ...
    { // Evans says 'standard triangular' is lower 0, mode 1/2, upper 1,
      ...
      RealType result;
      detail::check_triangular("_Boost::math::triangular_distribution<%1%>::triangular_distribution",l_lower, l_mode, l_upper, &result, Policy());
    }
    // Accessor functions.
  ...
  {
    static const char* function = "_Boost::math::pdf(const triangular_distribution<%1%>&, %1%)";
  ...
  {
    static const char* function = "_Boost::math::cdf(const triangular_distribution<%1%>&, %1%)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
  ...
  RealType quantile(const triangular_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    static const char* function = "_Boost::math::quantile(const triangular_distribution<%1%>&, %1%)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0; // of checks
  ...
  {
    static const char* function = "_Boost::math::mean(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0;  // of checks.
  ...
  {
    static const char* function = "_Boost::math::mode(const triangular_distribution<%1%>&)";
    RealType mode = dist.mode();
    RealType result = 0; // of checks.
  ...
  inline RealType median(const triangular_distribution<RealType, Policy>& dist)
  {
    ...
    static const char* function = "_Boost::math::median(const triangular_distribution<%1%>&)";
    RealType mode = dist.mode();
    RealType result = 0; // of checks.
    if(false == detail::check_triangular_mode(function, mode, &result, Policy()))
    { // This should never happen!
  ...
  inline RealType skewness(const triangular_distribution<RealType, Policy>& dist)
  {
    ...
    using namespace _Boost::math::constants; // for root_two
    static const char* function = "_Boost::math::skewness(const triangular_distribution<%1%>&)";

    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == _Boost::math::detail::check_triangular(function,lower, mode, upper, &result, Policy()))
    {
      return result;
    }
  ...
  { // These checks may be belt and braces as should have been checked on construction?
    static const char* function = "_Boost::math::kurtosis(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType upper = dist.upper();
    RealType mode = dist.mode();
    RealType result = 0;  // of checks.
  ...
  { // These checks may be belt and braces as should have been checked on construction?
    static const char* function = "_Boost::math::kurtosis_excess(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType upper = dist.upper();
    RealType mode = dist.mode();
    RealType result = 0;  // of checks.
