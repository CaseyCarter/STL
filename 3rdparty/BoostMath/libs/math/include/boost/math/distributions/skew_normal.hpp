...
namespace _Boost{ namespace math{
  ...
  public:
    ...
    { // Default is a 'standard' normal distribution N01. (shape=0 results in the normal distribution with no skew)
      static const char* function = "_Boost::math::skew_normal_distribution<%1%>::skew_normal_distribution";
  ...
  inline RealType pdf(const skew_normal_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    static const char* function = "_Boost::math::pdf(const skew_normal_distribution<%1%>&, %1%)";
  ...
  inline RealType cdf(const skew_normal_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    static const char* function = "_Boost::math::cdf(const skew_normal_distribution<%1%>&, %1%)";
    RealType result = 0;
    if(false == detail::check_scale(function, scale, &result, Policy()))
    {
      return result;
  ...
  inline RealType cdf(const complemented2_type<skew_normal_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    static const char* function = "_Boost::math::cdf(const complement(skew_normal_distribution<%1%>&), %1%)";
  ...
  namespace detail
  {
    ...
    */
    ...
    { 
      skew_normal_mode_functor(const _Boost::math::skew_normal_distribution<RealType, Policy> dist)
        : distribution(dist)
      {
      }
    ...
    private:
      const _Boost::math::skew_normal_distribution<RealType, Policy> distribution;
    };
  ...
  inline RealType mode(const skew_normal_distribution<RealType, Policy>& dist)
  {
    ...
    static const char* function = "_Boost::math::mode(const skew_normal_distribution<%1%>&, %1%)";
  ...
  namespace detail
  {
    ...
    { 
      skew_normal_quantile_functor(const _Boost::math::skew_normal_distribution<RealType, Policy> dist, RealType const& p)
  ...
  inline RealType quantile(const skew_normal_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    static const char* function = "_Boost::math::quantile(const skew_normal_distribution<%1%>&, %1%)";
    ...
    RealType x = -_Boost::math::erfc_inv(2 * p, Policy()) * constants::root_two<RealType>();
  ...
  inline RealType quantile(const complemented2_type<skew_normal_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    static const char* function = "_Boost::math::quantile(const complement(skew_normal_distribution<%1%>&), %1%)";
    RealType result = 0;
    if(false == detail::check_scale(function, scale, &result, Policy()))
      return result;
    if(false == detail::check_location(function, location, &result, Policy()))
