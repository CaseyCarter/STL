...
T hypergeometric_pdf_lanczos_imp(T /*dummy*/, unsigned x, unsigned r, unsigned n, unsigned N, const _Boost::math::lanczos::undefined_lanczos&, const Policy& pol)
{
   BOOST_MATH_STD_USING
   return exp(
      _Boost::math::lgamma(T(n + 1), pol)
      + _Boost::math::lgamma(T(r + 1), pol)
      + _Boost::math::lgamma(T(N - n + 1), pol)
      + _Boost::math::lgamma(T(N - r + 1), pol)
      - _Boost::math::lgamma(T(N + 1), pol)
      - _Boost::math::lgamma(T(x + 1), pol)
      - _Boost::math::lgamma(T(n - x + 1), pol)
      - _Boost::math::lgamma(T(r - x + 1), pol)
      - _Boost::math::lgamma(T(N - n - r + x + 1), pol));
}
...
inline T integer_power(const T& x, int ex)
{
   ...
   case 3:
      return x * x * x;
   case 4:
      return _Boost::math::pow<4>(x);
   case 5:
      return _Boost::math::pow<5>(x);
   case 6:
      return _Boost::math::pow<6>(x);
   case 7:
      return _Boost::math::pow<7>(x);
   case 8:
      return _Boost::math::pow<8>(x);
   }
   BOOST_MATH_STD_USING
#ifdef __SUNPRO_CC
   return pow(x, T(ex));
...
{
   BOOST_MATH_STD_USING
   BOOST_ASSERT(N <= _Boost::math::max_factorial<T>::value);
   T result = _Boost::math::unchecked_factorial<T>(n);
   T num[3] = {
      _Boost::math::unchecked_factorial<T>(r),
      _Boost::math::unchecked_factorial<T>(N - n),
      _Boost::math::unchecked_factorial<T>(N - r)
   };
   T denom[5] = {
      _Boost::math::unchecked_factorial<T>(N),
      _Boost::math::unchecked_factorial<T>(x),
      _Boost::math::unchecked_factorial<T>(n - x),
      _Boost::math::unchecked_factorial<T>(r - x),
      _Boost::math::unchecked_factorial<T>(N - n - r + x)
   };
   int i = 0;
   int j = 0;
   while((i < 3) || (j < 5))
   ...
   hypergeometric_pdf(unsigned x, unsigned r, unsigned n, unsigned N, const Policy&)
{
   ...
   value_type result;
   if(N <= _Boost::math::max_factorial<value_type>::value)
   {
      //
   ...
   else if(N <= _Boost::math::prime(_Boost::math::max_prime - 1))
   {
      //
   ...
   return policies::checked_narrowing_cast<result_type, forwarding_policy>(result, "_Boost::math::hypergeometric_pdf<%1%>(%1%,%1%,%1%,%1%)");
}
