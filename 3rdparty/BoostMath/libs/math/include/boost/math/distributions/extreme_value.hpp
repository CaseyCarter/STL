...
public:
   ...
   {
      RealType err;
      detail::verify_scale_b("_Boost::math::extreme_value_distribution<%1%>::extreme_value_distribution", b, &err, Policy());
      detail::check_finite("_Boost::math::extreme_value_distribution<%1%>::extreme_value_distribution", a, &err, Policy());
...
inline RealType pdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::pdf(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType cdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::cdf(const extreme_value_distribution<%1%>&, %1%)";
   ...
   if(0 == detail::check_finite(function, a, &result, Policy()))
      return result;
   if(0 == detail::check_x("_Boost::math::cdf(const extreme_value_distribution<%1%>&, %1%)", x, &result, Policy()))
      return result;
...
RealType quantile(const extreme_value_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "_Boost::math::quantile(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType cdf(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   result = -_Boost::math::expm1(-exp((a-c.param)/b), Policy());
...
RealType quantile(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   result = a - log(-_Boost::math::log1p(-q, Policy())) * b;
...
inline RealType mean(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result = 0;
   if(0 == detail::verify_scale_b("_Boost::math::mean(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
   if (0 == detail::check_finite("_Boost::math::mean(const extreme_value_distribution<%1%>&)", a, &result, Policy()))
      return result;
...
inline RealType standard_deviation(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result = 0;
   if(0 == detail::verify_scale_b("_Boost::math::standard_deviation(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
   if(0 == detail::check_finite("_Boost::math::standard_deviation(const extreme_value_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
