...
public:
   ...
   {
      RealType result;
      check_parameters("_Boost::math::laplace_distribution<%1%>::laplace_distribution()", &result);
   }
...
inline RealType pdf(const laplace_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType result = 0;
   const char* function = "_Boost::math::pdf(const laplace_distribution<%1%>&, %1%))";
...
inline RealType cdf(const laplace_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType result = 0;
   // Checking function argument.
   const char* function = "_Boost::math::cdf(const laplace_distribution<%1%>&, %1%)";
   // Check scale and location.
   if (false == dist.check_parameters(function, &result)) return result;
...
inline RealType quantile(const laplace_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   // Checking function argument
   RealType result = 0;
   const char* function = "_Boost::math::quantile(const laplace_distribution<%1%>&, %1%)";
   if (false == dist.check_parameters(function, &result)) return result;
...
inline RealType cdf(const complemented2_type<laplace_distribution<RealType, Policy>, RealType>& c)
{
   ...
   // Checking function argument.
   const char* function = "_Boost::math::cdf(const complemented2_type<laplace_distribution<%1%>, %1%>&)";
