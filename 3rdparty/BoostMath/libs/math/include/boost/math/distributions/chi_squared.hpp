...
public:
   ...
   chi_squared_distribution(RealType i) : m_df(i)
   {
      RealType result;
      detail::check_df(
         "_Boost::math::chi_squared_distribution<%1%>::chi_squared_distribution", m_df, &result, Policy());
...
RealType pdf(const chi_squared_distribution<RealType, Policy>& dist, const RealType& chi_square)
{
   ...
   static const char* function = "_Boost::math::pdf(const chi_squared_distribution<%1%>&, %1%)";

   if(false == detail::check_df(
         function, degrees_of_freedom, &error_result, Policy()))
      return error_result;

   if((chi_square < 0) || !(_Boost::math::isfinite)(chi_square))
   {
...
inline RealType cdf(const chi_squared_distribution<RealType, Policy>& dist, const RealType& chi_square)
{
   ...
   // Error check:
   RealType error_result;
   static const char* function = "_Boost::math::cdf(const chi_squared_distribution<%1%>&, %1%)";
   ...
   return _Boost::math::gamma_p(degrees_of_freedom / 2, chi_square / 2, Policy());
} // cdf
...
{
   RealType degrees_of_freedom = dist.degrees_of_freedom();
   static const char* function = "_Boost::math::quantile(const chi_squared_distribution<%1%>&, %1%)";
   // Error check:
   RealType error_result;
   if(false ==
     (
   ...
   return 2 * _Boost::math::gamma_p_inv(degrees_of_freedom / 2, p, Policy());
} // quantile
...
inline RealType cdf(const complemented2_type<chi_squared_distribution<RealType, Policy>, RealType>& c)
{
   ...
   return _Boost::math::gamma_q(degrees_of_freedom / 2, chi_square / 2, Policy());
}
...
inline RealType quantile(const complemented2_type<chi_squared_distribution<RealType, Policy>, RealType>& c)
{
   ...
   return 2 * _Boost::math::gamma_q_inv(degrees_of_freedom / 2, q, Policy());
}
...
inline RealType mode(const chi_squared_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::mode(const chi_squared_distribution<%1%>&)";
...
RealType chi_squared_distribution<RealType, Policy>::find_degrees_of_freedom(
   ...
   RealType hint)
{
   static const char* function = "_Boost::math::chi_squared_distribution<%1%>::find_degrees_of_freedom(%1%,%1%,%1%,%1%,%1%)";
