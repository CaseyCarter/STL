...
#  pragma warning(disable:4267)
   ...
   T result;
   T fudge_factor = 1 + tools::epsilon<T>() * ((N <= _Boost::math::prime(_Boost::math::max_prime - 1)) ? 50 : 2 * N);
   ...
   if(p <= 0.5)
   {
      ...
      if (diff == 0)
      {
         ...
         T log_pdf = _Boost::math::lgamma(static_cast<T>(n + 1), pol)
            + _Boost::math::lgamma(static_cast<T>(r + 1), pol)
            + _Boost::math::lgamma(static_cast<T>(N - n + 1), pol)
            + _Boost::math::lgamma(static_cast<T>(N - r + 1), pol)
            - _Boost::math::lgamma(static_cast<T>(N + 1), pol)
            - _Boost::math::lgamma(static_cast<T>(x + 1), pol)
            - _Boost::math::lgamma(static_cast<T>(n - x + 1), pol)
            - _Boost::math::lgamma(static_cast<T>(r - x + 1), pol)
            - _Boost::math::lgamma(static_cast<T>(N - n - r + x + 1), pol);
