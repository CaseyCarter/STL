...
namespace _Boost
{
  namespace math
  {
    namespace negative_binomial_detail
    {
      ...
      {
        if( !(_Boost::math::isfinite)(p) || (p < 0) || (p > 1) )
        {
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      {
        static const char* function = "_Boost::math::negative_binomial<%1%>::find_lower_bound_on_p";
      ...
      static RealType find_upper_bound_on_p(
        ...
        RealType alpha) // alpha 0.05 equivalent to 95% for one-sided test.
      {
        static const char* function = "_Boost::math::negative_binomial<%1%>::find_upper_bound_on_p";
        RealType result = 0;  // of error checks.
        RealType failures = trials - successes;
      ...
      {
        static const char* function = "_Boost::math::negative_binomial<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == negative_binomial_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
        ...
        RealType alpha) // risk level threshold 0 <= alpha <= 1.
      {
        static const char* function = "_Boost::math::negative_binomial<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == negative_binomial_detail::check_dist_and_k(
          function, RealType(1), p, k, &result, Policy())
    ...
    { // Probability Density/Mass Function.
      ...
      static const char* function = "_Boost::math::pdf(const negative_binomial_distribution<%1%>&, %1%)";
    ...
    { // Cumulative Distribution Function of Negative Binomial.
      static const char* function = "_Boost::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using _Boost::math::ibeta; // Regularized incomplete beta function.
      ...
      static const char* function = "_Boost::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using _Boost::math::ibetac; // Regularized incomplete beta function complement.
      // k argument may be integral, signed, or unsigned, or floating point.
      // If necessary, it has already been promoted from an integral type.
    ...
    { // Quantile, percentile/100 or Percent Point Negative Binomial function.
      ...
      static const char* function = "_Boost::math::quantile(const negative_binomial_distribution<%1%>&, %1%)";
      BOOST_MATH_STD_USING // ADL of std functions.
    ...
    {  // Quantile or Percent Point Binomial function.
       ...
       if (-Q <= _Boost::math::powm1(dist.success_fraction(), dist.successes(), Policy()))
