...
#define    BOOST_OCTONION_ACCESSOR_GENERATOR(type)                      \
            ...
            {                                                           \
                return(::std::complex<type>(g,h));                      \
                                                                        ...
                                                                        \
            ::_Boost::math::quaternion<type>    H_component_1() const    \
            {                                                           \
                return(::_Boost::math::quaternion<type>(a,b,c,d));       \
            }                                                           \
                                                                        \
            ::_Boost::math::quaternion<type>    H_component_2() const    \
            {                                                           \
                return(::_Boost::math::quaternion<type>(e,f,g,h));       \
            }
...
#define    BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(type)                                         \
            ...
            {                                                                                       \
                ...
                return(*this);                                                                      \
                                                                                                    ...
                                                                                                    \
            octonion<type> &        operator = (::_Boost::math::quaternion<type> const & a_affecter) \
            {                                                                                       \
...
#define    BOOST_OCTONION_MEMBER_DATA_GENERATOR(type) \
        ...
        public:
            ...
            explicit                octonion(   ::_Boost::math::quaternion<T> const & q0,
                                                ::_Boost::math::quaternion<T> const & q1 = ::_Boost::math::quaternion<T>())
            :   a(q0.R_component_1()),
                b(q0.R_component_2()),
                c(q0.R_component_3()),
                d(q0.R_component_4()),
            ...
            octonion<T> &            operator += (::_Boost::math::quaternion<T> const & rhs)
            {
...
#define    BOOST_OCTONION_CONSTRUCTOR_GENERATOR(type)                                                                               \
            ...
            {                                                                                                                       \
                                                                                                                                    ...
                                                                                                                                    \
            explicit                    octonion(   ::_Boost::math::quaternion<type> const & q0,                                     \
                                                    ::_Boost::math::quaternion<type> const & q1 = ::_Boost::math::quaternion<type>()) \
            :   a(q0.R_component_1()),                                                                                              \
                b(q0.R_component_2()),                                                                                              \
                c(q0.R_component_3()),                                                                                              \
                d(q0.R_component_4()),                                                                                              \
...
#define    BOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)                                              \
            octonion<type> &            operator += (::_Boost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
                a += rhs.R_component_1();                                                           \
                b += rhs.R_component_2();                                                           \
                c += rhs.R_component_3();                                                           \
...
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (::_Boost::math::quaternion<T> const & lhs, octonion<T> const & rhs) \
        BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, ::_Boost::math::quaternion<T> const & rhs) \
        BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
...
#undef    BOOST_OCTONION_OPERATOR_GENERATOR_BODY
        ...
        template<typename T>
        inline bool                                operator == (::_Boost::math::quaternion<T> const & lhs, octonion<T> const & rhs)
        {
            return(
        ...
        template<typename T>
        inline bool                                operator == (octonion<T> const & lhs, ::_Boost::math::quaternion<T> const & rhs)
        {
            return(
...
#define    BOOST_OCTONION_NOT_EQUAL_GENERATOR \
    ...
    #undef    BOOST_OCTONION_NOT_EQUAL_GENERATOR
                                                                ...
                                                                octonion<T> & o)
        {
            ...
            ::_Boost::math::quaternion<T>    p = ::_Boost::math::quaternion<T>();
            ::_Boost::math::quaternion<T>    q = ::_Boost::math::quaternion<T>();
                ...
                if    (cc == '(')                                // read "(("
                {
                    ...
                    if    (cc == '(')                                // read "((("
                    {
                        ...
                        else if    (cc ==',')                        // read "((u,"
                        {
                            ...
                            if        (cc == ')')                        // read "((u,v)"
                            {
                                p = ::_Boost::math::quaternion<T>(u,v);
                                    ...
                                    else                                        // read "((a),(c" or "((a),(e"
                                    {
                                        ...
                                        else if    (cc == ',')                            // read "((a),(c," or "((a),(e,"
                                        {
                                            ...
                                            if        (cc == '(')                        // read "((a),(e,(" (ambiguity resolution)
                                            {
                                                ...
                                                if        (cc == ')')                        // read "((a),(e,y)"
                                                {
                                                    q = ::_Boost::math::quaternion<T>(x,y);
                                            ...
                                            else                                    // read "((a),(c,d" or "((a),(e,f"
                                            {
                                                ...
                                                else if    (cc == ',')                        // read "((a),(e,f," (ambiguity resolution)
                                                {
                                                    ...
                                                    if        (cc == ')')                        // read "((a),(e,f,g)"
                                                    {
                                                        q = ::_Boost::math::quaternion<T>(c,d,g);        // "c" was actually "e", and "d" was actually "f"
                                                    ...
                                                    else if    (cc == ',')                        // read "((a),(e,f,g,"
                                                    {
                                                        ...
                                                        {
                                                            q = ::_Boost::math::quaternion<T>(c,d,g,h);    // "c" was actually "e", and "d" was actually "f"
                            ...
                            else
                            {
                                ...
                                if        (cc == ')')                            // read "((a,b)"
                                {
                                    ...
                                    else if    (cc == ',')                            // read "((a,b),"
                                    {
                                        ...
                                        if        (cc == '(')                            // read "((a,b),("
                                        {
                                            ...
                                            if        (cc == '(')                            // read "((a,b),(("
                                            {
                                                p = ::_Boost::math::quaternion<T>(a,b);
                                            ...
                                            else                                        // read "((a,b),(c" or "((a,b),(e"
                                            {
                                                ...
                                                else if    (cc == ',')                            // read "((a,b),(c," or "((a,b),(e,"
                                                {
                                                    ...
                                                    else                                        // read "((a,b),(c,d" or "((a,b),(e,f"
                                                    {
                                                        ...
                                                        {
                                                            p = ::_Boost::math::quaternion<T>(a,b);                // too late to backtrack
                                                            ...
                                                            if        (cc == ')')                            // read "((a,b),(e,f,g)"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g))"
                                                                {
                                                                    q = ::_Boost::math::quaternion<T>(c,d,g);            // "c" is actually "e" and "d" is actually "f"
                                                            ...
                                                            else if    (cc == ',')                            // read "((a,b),(e,f,g,"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g,h)"
                                                                {
                                                                    ...
                                                                    if        (cc == ')')                            // read ((a,b),(e,f,g,h))"
                                                                    {
                                                                        q = ::_Boost::math::quaternion<T>(c,d,g,h);            // "c" is actually "e" and "d" is actually "f"
                                ...
                                else if    (cc == ',')                            // read "((a,b,"
                                {
                                    ...
                                    if        (cc == ')')                            // read "((a,b,c)"
                                    {
                                        ...
                                        {
                                            p = ::_Boost::math::quaternion<T>(a,b,c);
                                    ...
                                    else if    (cc == ',')                            // read "((a,b,c,"
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a,b,c,d)"
                                        {
                                            ...
                                            {
                                                p = ::_Boost::math::quaternion<T>(a,b,c,d);
