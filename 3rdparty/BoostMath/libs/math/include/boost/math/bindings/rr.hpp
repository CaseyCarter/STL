...
public:
   ...
   RR(_Boost::ulong_long_type c)
   {
      assign_large_int(c);
   }
   RR(_Boost::long_long_type c)
   {
      assign_large_int(c);
   }
#endif
...
#ifdef BOOST_HAS_LONG_LONG
   RR& operator=(_Boost::long_long_type c) { assign_large_int(c); return *this; }
   RR& operator=(_Boost::ulong_long_type c) { assign_large_int(c); return *this; }
#endif
...
template<>
inline int digits<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
   return ::NTL::RR::precision();
}

template <>
inline float real_cast<float, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
   double r;
   conv(r, t.value());
...
template <>
inline double real_cast<double, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
   double r;
   conv(r, t.value());
   return r;
...
template <>
inline long double real_cast<long double, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
...
template <>
inline _Boost::math::ntl::RR real_cast<_Boost::math::ntl::RR, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
   return t;
}
template <>
inline unsigned real_cast<unsigned, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
   unsigned result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline int real_cast<int, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
   int result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline long real_cast<long, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
   long result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline long long real_cast<long long, _Boost::math::ntl::RR>(_Boost::math::ntl::RR t)
{
   long long result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline _Boost::math::ntl::RR max_value<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
...
template <>
inline _Boost::math::ntl::RR min_value<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline _Boost::math::ntl::RR log_max_value<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline _Boost::math::ntl::RR log_min_value<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline _Boost::math::ntl::RR epsilon<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
   return ldexp(_Boost::math::ntl::RR(1), 1-_Boost::math::policies::digits<_Boost::math::ntl::RR, _Boost::math::policies::policy<> >());
}
...
template<> inline _Boost::math::ntl::RR pi<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
    NTL::RR result;
    ComputePi(result);
    return result;
}
template<> inline _Boost::math::ntl::RR e<_Boost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(_Boost::math::ntl::RR))
{
    NTL::RR result;
    result = 1;
    return exp(result);
...
namespace ntl{
   ...
   struct asin_root
   {
      ...
      _Boost::math::tuple<RR, RR, RR> operator()(RR const& p)
      {
         RR f0 = sin(p);
         RR f1 = cos(p);
         RR f2 = -f0;
         f0 -= t;
         return _Boost::math::make_tuple(f0, f1, f2);
      }
   private:
      RR t;
   };
   ...
   inline RR asin(RR z)
   {
      double r;
      conv(r, z.value());
      return _Boost::math::tools::halley_iterate(
         asin_root(z), 
         RR(std::asin(r)), 
         RR(-_Boost::math::constants::pi<RR>()/2),
         RR(_Boost::math::constants::pi<RR>()/2),
         NTL::RR::precision());
   }
   ...
   inline RR atan2(RR y, RR x)
   {
      ...
      if(x < 0)
      {
         return y < 0 ? atan(y / x) - _Boost::math::constants::pi<RR>() : atan(y / x) + _Boost::math::constants::pi<RR>();
      }
      return y < 0 ? -_Boost::math::constants::half_pi<RR>() : _Boost::math::constants::half_pi<RR>() ;
   }
...
template <class Policy>
ntl::RR digamma_imp(ntl::RR x, const _Boost::integral_constant<int, 0>* , const Policy& pol)
{
   //
   ...
   if(x < 0)
   {
      ...
      if(remainder == 0)
      {
         return policies::raise_pole_error<ntl::RR>("_Boost::math::digamma<%1%>(%1%)", 0, (1-x), pol);
      }
