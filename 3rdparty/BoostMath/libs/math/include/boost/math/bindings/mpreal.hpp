...
{
   *ipart = lltrunc(v, pol);
   return v - _Boost::math::tools::real_cast<mpfr::mpreal>(*ipart);
}
template <class Policy>
inline int iround(mpfr::mpreal const& x, const Policy& pol)
{
   return _Boost::math::tools::real_cast<int>(_Boost::math::round(x, pol));
}

template <class Policy>
inline long lround(mpfr::mpreal const& x, const Policy& pol)
{
   return _Boost::math::tools::real_cast<long>(_Boost::math::round(x, pol));
}

template <class Policy>
inline long long llround(mpfr::mpreal const& x, const Policy& pol)
{
   return _Boost::math::tools::real_cast<long long>(_Boost::math::round(x, pol));
}

template <class Policy>
inline int itrunc(mpfr::mpreal const& x, const Policy& pol)
{
   return _Boost::math::tools::real_cast<int>(_Boost::math::trunc(x, pol));
}

template <class Policy>
inline long ltrunc(mpfr::mpreal const& x, const Policy& pol)
{
   return _Boost::math::tools::real_cast<long>(_Boost::math::trunc(x, pol));
}

template <class Policy>
inline long long lltrunc(mpfr::mpreal const& x, const Policy& pol)
{
   return _Boost::math::tools::real_cast<long long>(_Boost::math::trunc(x, pol));
}
...
{
   return ldexp(mpfr::mpreal(1), 1-_Boost::math::policies::digits<mpfr::mpreal, _Boost::math::policies::policy<> >());
}
...
inline mpfr::mpreal skewness(const extreme_value_distribution<mpfr::mpreal, Policy>& /*dist*/)
{
   ...
   //
   return _Boost::lexical_cast<mpfr::mpreal>("1.1395470994046486574927930193898461120875997958366");
}
...
inline mpfr::mpreal skewness(const rayleigh_distribution<mpfr::mpreal, Policy>& /*dist*/)
{
  ...
  return _Boost::lexical_cast<mpfr::mpreal>("0.63111065781893713819189935154422777984404221106391");
...
{
  // using namespace _Boost::math::constants;
  return _Boost::lexical_cast<mpfr::mpreal>("3.2450893006876380628486604106197544154170667057995");
  // Computed using NTL at 150 bit, about 50 decimal digits.
...
inline mpfr::mpreal kurtosis_excess(const rayleigh_distribution<mpfr::mpreal, Policy>& /*dist*/)
{
  //using namespace _Boost::math::constants;
  // Computed using NTL at 150 bit, about 50 decimal digits.
  return _Boost::lexical_cast<mpfr::mpreal>("0.2450893006876380628486604106197544154170667057995");
...
//
template <class Policy>
mpfr::mpreal digamma_imp(mpfr::mpreal x, const _Boost::integral_constant<int, 0>* , const Policy& pol)
{
   //
   ...
   if(x < 0)
   {
      ...
      if(remainder == 0)
      {
         return policies::raise_pole_error<mpfr::mpreal>("_Boost::math::digamma<%1%>(%1%)", 0, (1-x), pol);
      }
...
//
template <class Policy>
mpfr::mpreal erf_inv_imp(const mpfr::mpreal& p, const mpfr::mpreal& q, const Policy&, const _Boost::integral_constant<int, 64>*)
{
...
inline mpfr::mpreal bessel_i0(mpfr::mpreal x)
{
    static const mpfr::mpreal P1[] = {
        _Boost::lexical_cast<mpfr::mpreal>("-2.2335582639474375249e+15"),
        _Boost::lexical_cast<mpfr::mpreal>("-5.5050369673018427753e+14"),
        _Boost::lexical_cast<mpfr::mpreal>("-3.2940087627407749166e+13"),
        _Boost::lexical_cast<mpfr::mpreal>("-8.4925101247114157499e+11"),
        _Boost::lexical_cast<mpfr::mpreal>("-1.1912746104985237192e+10"),
        _Boost::lexical_cast<mpfr::mpreal>("-1.0313066708737980747e+08"),
        _Boost::lexical_cast<mpfr::mpreal>("-5.9545626019847898221e+05"),
        _Boost::lexical_cast<mpfr::mpreal>("-2.4125195876041896775e+03"),
        _Boost::lexical_cast<mpfr::mpreal>("-7.0935347449210549190e+00"),
        _Boost::lexical_cast<mpfr::mpreal>("-1.5453977791786851041e-02"),
        _Boost::lexical_cast<mpfr::mpreal>("-2.5172644670688975051e-05"),
        _Boost::lexical_cast<mpfr::mpreal>("-3.0517226450451067446e-08"),
        _Boost::lexical_cast<mpfr::mpreal>("-2.6843448573468483278e-11"),
        _Boost::lexical_cast<mpfr::mpreal>("-1.5982226675653184646e-14"),
        _Boost::lexical_cast<mpfr::mpreal>("-5.2487866627945699800e-18"),
    };
    static const mpfr::mpreal Q1[] = {
        _Boost::lexical_cast<mpfr::mpreal>("-2.2335582639474375245e+15"),
        _Boost::lexical_cast<mpfr::mpreal>("7.8858692566751002988e+12"),
        _Boost::lexical_cast<mpfr::mpreal>("-1.2207067397808979846e+10"),
        _Boost::lexical_cast<mpfr::mpreal>("1.0377081058062166144e+07"),
        _Boost::lexical_cast<mpfr::mpreal>("-4.8527560179962773045e+03"),
        _Boost::lexical_cast<mpfr::mpreal>("1.0"),
    };
    static const mpfr::mpreal P2[] = {
        _Boost::lexical_cast<mpfr::mpreal>("-2.2210262233306573296e-04"),
        _Boost::lexical_cast<mpfr::mpreal>("1.3067392038106924055e-02"),
        _Boost::lexical_cast<mpfr::mpreal>("-4.4700805721174453923e-01"),
        _Boost::lexical_cast<mpfr::mpreal>("5.5674518371240761397e+00"),
        _Boost::lexical_cast<mpfr::mpreal>("-2.3517945679239481621e+01"),
        _Boost::lexical_cast<mpfr::mpreal>("3.1611322818701131207e+01"),
        _Boost::lexical_cast<mpfr::mpreal>("-9.6090021968656180000e+00"),
    };
    static const mpfr::mpreal Q2[] = {
        _Boost::lexical_cast<mpfr::mpreal>("-5.5194330231005480228e-04"),
        _Boost::lexical_cast<mpfr::mpreal>("3.2547697594819615062e-02"),
        _Boost::lexical_cast<mpfr::mpreal>("-1.1151759188741312645e+00"),
        _Boost::lexical_cast<mpfr::mpreal>("1.3982595353892851542e+01"),
        _Boost::lexical_cast<mpfr::mpreal>("-6.0228002066743340583e+01"),
        _Boost::lexical_cast<mpfr::mpreal>("8.5539563258012929600e+01"),
        _Boost::lexical_cast<mpfr::mpreal>("-3.1446690275135491500e+01"),
        _Boost::lexical_cast<mpfr::mpreal>("1.0"),
    };
