...
namespace _Boost_math {
   ...
   public:
      ...
      {
         return _Boost::math::mean(m_dist);
      }
      virtual double median()const
      {
         return _Boost::math::median(m_dist);
      }
      virtual double mode()const
      {
         return _Boost::math::mode(m_dist);
      }
      virtual double variance()const
      {
         return _Boost::math::variance(m_dist);
      }
      virtual double skewness()const
      {
         return _Boost::math::skewness(m_dist);
      }
      virtual double standard_deviation()const
      {
         return _Boost::math::standard_deviation(m_dist);
      }
      virtual double coefficient_of_variation()const
      {
         return _Boost::math::coefficient_of_variation(m_dist);
      }
      virtual double kurtosis()const
      {
         return _Boost::math::kurtosis(m_dist);
      }
      virtual double kurtosis_excess()const
      {
         return _Boost::math::kurtosis_excess(m_dist);
      }
      // Range of x for the distribution.
      virtual double lowest()const
      {
         return _Boost::math::range(m_dist).first;
      }
      virtual double uppermost()const
      {
         return _Boost::math::range(m_dist).second;
      }
      // Support of x for the distribution.
      virtual double lower()const
      {
         return _Boost::math::support(m_dist).first;
      }
      virtual double upper()const
      {
         return _Boost::math::support(m_dist).second;
      }

      // Values computed from random variate x.
      virtual double hazard(double x)const
      {
         return _Boost::math::hazard(m_dist, x);
      }
      virtual double chf(double x)const
      {
         return _Boost::math::chf(m_dist, x);
      }
      virtual double cdf(double x)const
      {
         return _Boost::math::cdf(m_dist, x);
      }
      virtual double ccdf(double x)const
      {
         return _Boost::math::cdf(complement(m_dist, x));
      }
      virtual double pdf(double x)const
      {
         return _Boost::math::pdf(m_dist, x);
      }
      virtual double quantile(double x)const
      {
         return _Boost::math::quantile(m_dist, x);
      }
      virtual double quantile_c(double x)const
      {
         return _Boost::math::quantile(complement(m_dist, x));
      }
   private:
      Distribution m_dist;
   };
