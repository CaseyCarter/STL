...
#ifdef _MSC_VER
#  pragma warning(disable: 4400) // 'const _Boost_math::any_distribution ^' : const/volatile qualifiers on this type are not supported
...
any_distribution::any_distribution(int t, double arg1, double arg2, double arg3)
{
   ...
   case 0:
      this->reset(new concrete_distribution<_Boost::math::bernoulli>(_Boost::math::bernoulli(arg1)));
      break;
   case 1:
      this->reset(new concrete_distribution<_Boost::math::beta_distribution<> >(_Boost::math::beta_distribution<>(arg1, arg2)));
      break; // Note - no typedef, so need explicit type <> but rely on default = double.
   case 2:
      this->reset(new concrete_distribution<_Boost::math::binomial_distribution<> >(_Boost::math::binomial_distribution<>(arg1, arg2)));
      break; // Note - no typedef, so need explicit type <> but rely on default = double.
   case 3:
      this->reset(new concrete_distribution<_Boost::math::cauchy>(_Boost::math::cauchy(arg1, arg2)));
      break;
   case 4:
      this->reset(new concrete_distribution<_Boost::math::chi_squared>(_Boost::math::chi_squared(arg1)));
      break;
   case 5:
      this->reset(new concrete_distribution<_Boost::math::exponential>(_Boost::math::exponential(arg1)));
      break;
   case 6:
      this->reset(new concrete_distribution<_Boost::math::extreme_value>(_Boost::math::extreme_value(arg1)));
      break;
   case 7:
      this->reset(new concrete_distribution<_Boost::math::fisher_f >(_Boost::math::fisher_f(arg1, arg2)));
      break;
   case 8:
      this->reset(new concrete_distribution<_Boost::math::gamma_distribution<> >(_Boost::math::gamma_distribution<>(arg1, arg2)));
      break;
   case 9:
      this->reset(new concrete_distribution<_Boost::math::geometric_distribution<> >(_Boost::math::geometric_distribution<>(arg1)));
      break;
   case 10:
      this->reset(new concrete_distribution<_Boost::math::hypergeometric_distribution<> >(_Boost::math::hypergeometric_distribution<>(arg1, arg2, arg3)));
      break;
   case 11:
      this->reset(new concrete_distribution<_Boost::math::inverse_chi_squared_distribution<> >(_Boost::math::inverse_chi_squared_distribution<>(arg1, arg2)));
      break;
   case 12:
      this->reset(new concrete_distribution<_Boost::math::inverse_gamma_distribution<> >(_Boost::math::inverse_gamma_distribution<>(arg1, arg2)));
      break;
   case 13:
      this->reset(new concrete_distribution<_Boost::math::inverse_gaussian_distribution<> >(_Boost::math::inverse_gaussian_distribution<>(arg1, arg2)));
      break;
   case 14:
      this->reset(new concrete_distribution<_Boost::math::laplace_distribution<> >(_Boost::math::laplace_distribution<>(arg1, arg2)));
      break;
   case 15:
      this->reset(new concrete_distribution<_Boost::math::logistic_distribution<> >(_Boost::math::logistic_distribution<>(arg1, arg2)));
      break;
   case 16:
      this->reset(new concrete_distribution<_Boost::math::lognormal_distribution<> >(_Boost::math::lognormal_distribution<>(arg1, arg2)));
      break;
   case 17:
      this->reset(new concrete_distribution<_Boost::math::negative_binomial_distribution<> >(_Boost::math::negative_binomial_distribution<>(arg1, arg2)));
      break;
   case 18:
      this->reset(new concrete_distribution<_Boost::math::non_central_beta_distribution<> >(_Boost::math::non_central_beta_distribution<>(arg1, arg2, arg3)));
      break;
   case 19:
      this->reset(new concrete_distribution<_Boost::math::non_central_chi_squared_distribution<> >(_Boost::math::non_central_chi_squared_distribution<>(arg1, arg2)));
      break;
   case 20:
      this->reset(new concrete_distribution<_Boost::math::non_central_f_distribution<> >(_Boost::math::non_central_f_distribution<>(arg1, arg2, arg3)));
      break;
   case 21:
      this->reset(new concrete_distribution<_Boost::math::non_central_t_distribution<> >(_Boost::math::non_central_t_distribution<>(arg1, arg2)));
      break;
   case 22:
      this->reset(new concrete_distribution<_Boost::math::normal_distribution<> >(_Boost::math::normal_distribution<>(arg1, arg2)));
      break;
   case 23:
      this->reset(new concrete_distribution<_Boost::math::pareto>(_Boost::math::pareto(arg1, arg2)));
      break;
   case 24:
      this->reset(new concrete_distribution<_Boost::math::poisson>(_Boost::math::poisson(arg1)));
      break;
   case 25:
      this->reset(new concrete_distribution<_Boost::math::rayleigh>(_Boost::math::rayleigh(arg1)));
      break;
   case 26:
      this->reset(new concrete_distribution<_Boost::math::skew_normal>(_Boost::math::skew_normal(arg1, arg2, arg3)));
      break;
   case 27:
      this->reset(new concrete_distribution<_Boost::math::students_t>(_Boost::math::students_t(arg1)));
      break;
   case 28:
      this->reset(new concrete_distribution<_Boost::math::triangular>(_Boost::math::triangular(arg1, arg2, arg3)));
      break;
   case 29:
      this->reset(new concrete_distribution<_Boost::math::uniform>(_Boost::math::uniform(arg1, arg2)));
      break;
   case 30:
      this->reset(new concrete_distribution<_Boost::math::weibull>(_Boost::math::weibull(arg1, arg2)));
      break;
