...
class distribution_tester
{
   ...
   {
      if(x > _Boost::math::tools::max_value<float>() / 2)
         return _Boost::math::tools::max_value<float>() / 2;
      if(x < -_Boost::math::tools::max_value<float>() / 2)
         return -_Boost::math::tools::max_value<float>() / 2;
      return x;
   }
public:
   ...
   void run_timed_tests(F f, std::string sub_name, std::string column, bool p_value = false, int where = main_table)
   {
      ...
      try{
         ...
         do{
            data_size = 0;
            stopwatch<_Boost::chrono::high_resolution_clock> w;
            ...
            for(unsigned count = 0; count < repeats; ++count)
            {
               for(unsigned i = 0; i < tests.size(); ++i)
               {
                  ...
                  {
                     if((_Boost::math::isfinite)(tests[i].x_values[j]))
            ...
            t = _Boost::chrono::duration_cast<_Boost::chrono::duration<double>>(w.elapsed()).count();
            if(t < 0.5)
               repeats *= 2;
         } while(t < 0.5);
      ...
      catch(const std::exception& e)
      {
         ...
         report_execution_time(
            (std::numeric_limits<_Boost::uintmax_t>::max)(),
...
void test_boost_1_param(distribution_tester& tester)
{
   ...
   //
   typedef _Boost::math::policies::policy<> default_policy;
   typedef _Boost::math::policies::policy<_Boost::math::policies::promote_double<false> > no_promote_double_policy;
   typedef _Boost::math::policies::policy<_Boost::math::policies::promote_double<false>, _Boost::math::policies::digits10<10> > no_promote_double_10_digits_policy;
   typedef _Boost::math::policies::policy<_Boost::math::policies::promote_float<false> > no_promote_float_policy;
...
int main()
{
   try {
      ...
      n.add_test_case(0, 1, two_param_quantile<_Boost::math::normal_distribution<> >());
      n.add_test_case(20, 20, two_param_quantile<_Boost::math::normal_distribution<> >());
      n.add_test_case(-20, 0.0125, two_param_quantile<_Boost::math::normal_distribution<> >());

      test_boost_2_param<_Boost::math::normal_distribution>(n);

      distribution_tester arcsine("ArcSine");
      arcsine.add_test_case(0, 1, two_param_quantile<_Boost::math::arcsine_distribution<> >());
      arcsine.add_test_case(20, 500, two_param_quantile<_Boost::math::arcsine_distribution<> >());
      arcsine.add_test_case(-20, 100000, two_param_quantile<_Boost::math::arcsine_distribution<> >());

      test_boost_2_param<_Boost::math::arcsine_distribution>(arcsine);

      distribution_tester beta("Beta");
      beta.add_test_case(1, 4, two_param_quantile<_Boost::math::beta_distribution<> >());
      beta.add_test_case(20, 500, two_param_quantile<_Boost::math::beta_distribution<> >());
      beta.add_test_case(0.1, 0.01, two_param_quantile<_Boost::math::beta_distribution<> >());

      test_boost_2_param<_Boost::math::beta_distribution>(beta);

      distribution_tester binomial("Binomial");
      binomial.add_test_case(5, 0.125, two_param_quantile<_Boost::math::binomial_distribution<> >());
      binomial.add_test_case(200, 0.75, two_param_quantile<_Boost::math::binomial_distribution<> >());
      binomial.add_test_case(2000, 0.5, two_param_quantile<_Boost::math::binomial_distribution<> >());
      binomial.add_test_case(20000, 0.001, two_param_quantile<_Boost::math::binomial_distribution<> >());
      binomial.add_test_case(200000, 0.99, two_param_quantile<_Boost::math::binomial_distribution<> >());

      test_boost_2_param<_Boost::math::binomial_distribution>(binomial);

      distribution_tester cauchy("Cauchy");
      cauchy.add_test_case(0, 1, two_param_quantile<_Boost::math::cauchy_distribution<> >());
      cauchy.add_test_case(20, 20, two_param_quantile<_Boost::math::cauchy_distribution<> >());
      cauchy.add_test_case(-20, 0.0125, two_param_quantile<_Boost::math::cauchy_distribution<> >());

      test_boost_2_param<_Boost::math::cauchy_distribution>(cauchy);

      distribution_tester chi_squared("ChiSquared");
      chi_squared.add_test_case(3, one_param_quantile<_Boost::math::chi_squared_distribution<> >());
      chi_squared.add_test_case(20, one_param_quantile<_Boost::math::chi_squared_distribution<> >());
      chi_squared.add_test_case(200, one_param_quantile<_Boost::math::chi_squared_distribution<> >());
      chi_squared.add_test_case(2000, one_param_quantile<_Boost::math::chi_squared_distribution<> >());
      chi_squared.add_test_case(20000, one_param_quantile<_Boost::math::chi_squared_distribution<> >());
      chi_squared.add_test_case(200000, one_param_quantile<_Boost::math::chi_squared_distribution<> >());

      test_boost_1_param<_Boost::math::chi_squared_distribution>(chi_squared);

      distribution_tester exponential("Exponential");
      exponential.add_test_case(0.001, one_param_quantile<_Boost::math::exponential_distribution<> >());
      exponential.add_test_case(0.01, one_param_quantile<_Boost::math::exponential_distribution<> >());
      exponential.add_test_case(0.1, one_param_quantile<_Boost::math::exponential_distribution<> >());
      exponential.add_test_case(1, one_param_quantile<_Boost::math::exponential_distribution<> >());
      exponential.add_test_case(10, one_param_quantile<_Boost::math::exponential_distribution<> >());
      exponential.add_test_case(100, one_param_quantile<_Boost::math::exponential_distribution<> >());
      exponential.add_test_case(1000, one_param_quantile<_Boost::math::exponential_distribution<> >());

      test_boost_1_param<_Boost::math::exponential_distribution>(exponential);

      distribution_tester extreme_value("ExtremeValue");
      extreme_value.add_test_case(0, 1, two_param_quantile<_Boost::math::extreme_value_distribution<> >());
      extreme_value.add_test_case(20, 20, two_param_quantile<_Boost::math::extreme_value_distribution<> >());
      extreme_value.add_test_case(-20, 0.0125, two_param_quantile<_Boost::math::extreme_value_distribution<> >());

      test_boost_2_param<_Boost::math::extreme_value_distribution>(extreme_value);
      ...
      for (unsigned i = 2; i <= 200000; i *= 10)
      {
         ...
         {
            fisher.add_test_case(i, j, two_param_quantile<_Boost::math::fisher_f_distribution<> >());
         }
      }
      test_boost_2_param<_Boost::math::fisher_f_distribution>(fisher);

      distribution_tester gamma("Gamma");
      gamma.add_test_case(0.1, 1, two_param_quantile<_Boost::math::gamma_distribution<> >());
      gamma.add_test_case(20, 20, two_param_quantile<_Boost::math::gamma_distribution<> >());
      gamma.add_test_case(200, 0.0125, two_param_quantile<_Boost::math::gamma_distribution<> >());
      gamma.add_test_case(2000, 500, two_param_quantile<_Boost::math::gamma_distribution<> >());

      test_boost_2_param<_Boost::math::gamma_distribution>(gamma);

      distribution_tester geometric("Geometric");
      geometric.add_test_case(0.001, one_param_quantile<_Boost::math::geometric_distribution<> >());
      geometric.add_test_case(0.01, one_param_quantile<_Boost::math::geometric_distribution<> >());
      geometric.add_test_case(0.1, one_param_quantile<_Boost::math::geometric_distribution<> >());
      geometric.add_test_case(0.5, one_param_quantile<_Boost::math::geometric_distribution<> >());
      geometric.add_test_case(0.9, one_param_quantile<_Boost::math::geometric_distribution<> >());
      geometric.add_test_case(0.99, one_param_quantile<_Boost::math::geometric_distribution<> >());
      geometric.add_test_case(0.999, one_param_quantile<_Boost::math::geometric_distribution<> >());

      test_boost_1_param<_Boost::math::geometric_distribution>(geometric);

      distribution_tester hypergeometric("Hypergeometric");
      hypergeometric.add_test_case(10, 5, 100, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(50, 75, 100, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(30, 20, 100, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(100, 50, 1000000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(500000, 3000, 1000000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(20000, 800000, 1000000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(100, 5, 1000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(500, 50, 1000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(2, 25, 1000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(1, 5, 1000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());
      hypergeometric.add_test_case(100, 500, 1000, three_param_quantile<_Boost::math::hypergeometric_distribution<> >());

      test_boost_3_param<_Boost::math::hypergeometric_distribution>(hypergeometric);

      distribution_tester inverse_chi_squared("InverseChiSquared");
      inverse_chi_squared.add_test_case(5, 0.125, two_param_quantile<_Boost::math::inverse_chi_squared_distribution<> >());
      inverse_chi_squared.add_test_case(200, 0.75, two_param_quantile<_Boost::math::inverse_chi_squared_distribution<> >());
      inverse_chi_squared.add_test_case(2000, 1, two_param_quantile<_Boost::math::inverse_chi_squared_distribution<> >());
      inverse_chi_squared.add_test_case(20000, 10, two_param_quantile<_Boost::math::inverse_chi_squared_distribution<> >());
      inverse_chi_squared.add_test_case(200000, 100, two_param_quantile<_Boost::math::inverse_chi_squared_distribution<> >());

      test_boost_2_param<_Boost::math::inverse_chi_squared_distribution>(inverse_chi_squared);

      distribution_tester inverse_gamma("InverseGamma");
      inverse_gamma.add_test_case(0.1, 1, two_param_quantile<_Boost::math::inverse_gamma_distribution<> >());
      inverse_gamma.add_test_case(20, 20, two_param_quantile<_Boost::math::inverse_gamma_distribution<> >());
      inverse_gamma.add_test_case(200, 0.0125, two_param_quantile<_Boost::math::inverse_gamma_distribution<> >());
      inverse_gamma.add_test_case(2000, 500, two_param_quantile<_Boost::math::inverse_gamma_distribution<> >());

      test_boost_2_param<_Boost::math::inverse_gamma_distribution>(inverse_gamma);

      distribution_tester inverse_gaussian("InverseGaussian");
      inverse_gaussian.add_test_case(0.001, 1, two_param_quantile<_Boost::math::inverse_gaussian_distribution<> >());
      inverse_gaussian.add_test_case(20, 20, two_param_quantile<_Boost::math::inverse_gaussian_distribution<> >());

      test_boost_2_param<_Boost::math::inverse_gaussian_distribution>(inverse_gaussian);

      distribution_tester laplace("Laplace");
      laplace.add_test_case(0, 1, two_param_quantile<_Boost::math::laplace_distribution<> >());
      laplace.add_test_case(20, 20, two_param_quantile<_Boost::math::laplace_distribution<> >());
      laplace.add_test_case(-20, 0.0125, two_param_quantile<_Boost::math::laplace_distribution<> >());

      test_boost_2_param<_Boost::math::laplace_distribution>(laplace);

      distribution_tester logistic("Logistic");
      logistic.add_test_case(0, 1, two_param_quantile<_Boost::math::logistic_distribution<> >());
      logistic.add_test_case(20, 20, two_param_quantile<_Boost::math::logistic_distribution<> >());
      logistic.add_test_case(-20, 0.0125, two_param_quantile<_Boost::math::logistic_distribution<> >());

      test_boost_2_param<_Boost::math::logistic_distribution>(logistic);

      distribution_tester lognormal("LogNormal");
      lognormal.add_test_case(0, 1, two_param_quantile<_Boost::math::lognormal_distribution<> >());
      lognormal.add_test_case(20, 20, two_param_quantile<_Boost::math::lognormal_distribution<> >());
      lognormal.add_test_case(-20, 0.0125, two_param_quantile<_Boost::math::lognormal_distribution<> >());

      test_boost_2_param<_Boost::math::lognormal_distribution>(lognormal);

      distribution_tester negative_binomial("NegativeBinomial");
      negative_binomial.add_test_case(5, 0.125, two_param_quantile<_Boost::math::negative_binomial_distribution<> >());
      negative_binomial.add_test_case(200, 0.75, two_param_quantile<_Boost::math::negative_binomial_distribution<> >());
      negative_binomial.add_test_case(2000, 0.001, two_param_quantile<_Boost::math::negative_binomial_distribution<> >());
      negative_binomial.add_test_case(20000, 0.5, two_param_quantile<_Boost::math::negative_binomial_distribution<> >());
      negative_binomial.add_test_case(200000, 0.99, two_param_quantile<_Boost::math::negative_binomial_distribution<> >());

      test_boost_2_param<_Boost::math::negative_binomial_distribution>(negative_binomial);

      distribution_tester non_central_beta("NonCentralBeta");
      non_central_beta.add_test_case(2, 5, 2.1, three_param_quantile<_Boost::math::non_central_beta_distribution<> >());
      non_central_beta.add_test_case(0.25, 0.01, 20, three_param_quantile<_Boost::math::non_central_beta_distribution<> >());
      non_central_beta.add_test_case(20, 3, 30, three_param_quantile<_Boost::math::non_central_beta_distribution<> >());
      non_central_beta.add_test_case(100, 200, 400, three_param_quantile<_Boost::math::non_central_beta_distribution<> >());
      non_central_beta.add_test_case(100, 0.25, 20, three_param_quantile<_Boost::math::non_central_beta_distribution<> >());

      test_boost_3_param<_Boost::math::non_central_beta_distribution>(non_central_beta);

      distribution_tester non_central_chi_squared("NonCentralChiSquared");
      non_central_chi_squared.add_test_case(5, 0.5, two_param_quantile<_Boost::math::non_central_chi_squared_distribution<> >());
      non_central_chi_squared.add_test_case(200, 2, two_param_quantile<_Boost::math::non_central_chi_squared_distribution<> >());
      non_central_chi_squared.add_test_case(2000, 20, two_param_quantile<_Boost::math::non_central_chi_squared_distribution<> >());
      non_central_chi_squared.add_test_case(20000, 10, two_param_quantile<_Boost::math::non_central_chi_squared_distribution<> >());
      non_central_chi_squared.add_test_case(200000, 50, two_param_quantile<_Boost::math::non_central_chi_squared_distribution<> >());

      test_boost_2_param<_Boost::math::non_central_chi_squared_distribution>(non_central_chi_squared);

      distribution_tester non_central_f("NonCentralF");
      non_central_f.add_test_case(20, 20, 3, three_param_quantile<_Boost::math::non_central_f_distribution<> >());
      non_central_f.add_test_case(20, 50, 20, three_param_quantile<_Boost::math::non_central_f_distribution<> >());
      non_central_f.add_test_case(100, 20, 30, three_param_quantile<_Boost::math::non_central_f_distribution<> >());
      non_central_f.add_test_case(100, 200, 100, three_param_quantile<_Boost::math::non_central_f_distribution<> >());
      non_central_f.add_test_case(1000, 100000, 20, three_param_quantile<_Boost::math::non_central_f_distribution<> >());

      test_boost_3_param<_Boost::math::non_central_f_distribution>(non_central_f);

      distribution_tester non_central_t("NonCentralT");
      non_central_t.add_test_case(5, 0.5, two_param_quantile<_Boost::math::non_central_t_distribution<> >());
      non_central_t.add_test_case(200, 2, two_param_quantile<_Boost::math::non_central_t_distribution<> >());
      non_central_t.add_test_case(2000, 20, two_param_quantile<_Boost::math::non_central_t_distribution<> >());
      non_central_t.add_test_case(20000, 10, two_param_quantile<_Boost::math::non_central_t_distribution<> >());
      non_central_t.add_test_case(200000, 50, two_param_quantile<_Boost::math::non_central_t_distribution<> >());

      test_boost_2_param<_Boost::math::non_central_t_distribution>(non_central_t);

      distribution_tester pareto("Pareto");
      pareto.add_test_case(0.1, 1, two_param_quantile<_Boost::math::pareto_distribution<> >());
      pareto.add_test_case(20, 20, two_param_quantile<_Boost::math::pareto_distribution<> >());
      pareto.add_test_case(200, 0.0125, two_param_quantile<_Boost::math::pareto_distribution<> >());
      pareto.add_test_case(2000, 500, two_param_quantile<_Boost::math::pareto_distribution<> >());

      test_boost_2_param<_Boost::math::pareto_distribution>(pareto);

      distribution_tester poisson("Poisson");
      poisson.add_test_case(0.001, one_param_quantile<_Boost::math::poisson_distribution<> >());
      poisson.add_test_case(0.01, one_param_quantile<_Boost::math::poisson_distribution<> >());
      poisson.add_test_case(0.1, one_param_quantile<_Boost::math::poisson_distribution<> >());
      poisson.add_test_case(1, one_param_quantile<_Boost::math::poisson_distribution<> >());
      poisson.add_test_case(10, one_param_quantile<_Boost::math::poisson_distribution<> >());
      poisson.add_test_case(100, one_param_quantile<_Boost::math::poisson_distribution<> >());
      poisson.add_test_case(1000, one_param_quantile<_Boost::math::poisson_distribution<> >());

      test_boost_1_param<_Boost::math::poisson_distribution>(poisson);

      distribution_tester rayleigh("Rayleigh");
      rayleigh.add_test_case(0.001, one_param_quantile<_Boost::math::rayleigh_distribution<> >());
      rayleigh.add_test_case(0.01, one_param_quantile<_Boost::math::rayleigh_distribution<> >());
      rayleigh.add_test_case(0.1, one_param_quantile<_Boost::math::rayleigh_distribution<> >());
      rayleigh.add_test_case(1, one_param_quantile<_Boost::math::rayleigh_distribution<> >());
      rayleigh.add_test_case(10, one_param_quantile<_Boost::math::rayleigh_distribution<> >());
      rayleigh.add_test_case(100, one_param_quantile<_Boost::math::rayleigh_distribution<> >());
      rayleigh.add_test_case(1000, one_param_quantile<_Boost::math::rayleigh_distribution<> >());

      test_boost_1_param<_Boost::math::rayleigh_distribution>(rayleigh);

      distribution_tester skew_norm("SkewNormal");
      skew_norm.add_test_case(0, 1, 0.1, three_param_quantile<_Boost::math::skew_normal_distribution<> >());
      skew_norm.add_test_case(20, 20, 30, three_param_quantile<_Boost::math::skew_normal_distribution<> >());
      skew_norm.add_test_case(-20, 0.0125, 10, three_param_quantile<_Boost::math::skew_normal_distribution<> >());

      test_boost_3_param<_Boost::math::skew_normal_distribution>(skew_norm);

      distribution_tester students_t("StudentsT");
      students_t.add_test_case(3, one_param_quantile<_Boost::math::students_t_distribution<> >());
      students_t.add_test_case(20, one_param_quantile<_Boost::math::students_t_distribution<> >());
      students_t.add_test_case(200, one_param_quantile<_Boost::math::students_t_distribution<> >());
      students_t.add_test_case(2000, one_param_quantile<_Boost::math::students_t_distribution<> >());
      students_t.add_test_case(20000, one_param_quantile<_Boost::math::students_t_distribution<> >());
      students_t.add_test_case(200000, one_param_quantile<_Boost::math::students_t_distribution<> >());

      test_boost_1_param<_Boost::math::students_t_distribution>(students_t);

      distribution_tester weibull("Weibull");
      weibull.add_test_case(0.1, 1, two_param_quantile<_Boost::math::weibull_distribution<> >());
      weibull.add_test_case(20, 20, two_param_quantile<_Boost::math::weibull_distribution<> >());
      weibull.add_test_case(200, 0.0125, two_param_quantile<_Boost::math::weibull_distribution<> >());
      weibull.add_test_case(2000, 500, two_param_quantile<_Boost::math::weibull_distribution<> >());

      test_boost_2_param<_Boost::math::weibull_distribution>(weibull);
