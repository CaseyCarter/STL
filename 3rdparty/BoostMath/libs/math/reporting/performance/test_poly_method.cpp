...
static const _Boost::uint32_t denom_int[20] = {
   static_cast<_Boost::uint32_t>(0u),
   static_cast<_Boost::uint32_t>(39916800u),
   static_cast<_Boost::uint32_t>(120543840u),
   static_cast<_Boost::uint32_t>(150917976u),
   static_cast<_Boost::uint32_t>(105258076u),
   static_cast<_Boost::uint32_t>(45995730u),
   static_cast<_Boost::uint32_t>(13339535u),
   static_cast<_Boost::uint32_t>(2637558u),
   static_cast<_Boost::uint32_t>(357423u),
   static_cast<_Boost::uint32_t>(32670u),
   static_cast<_Boost::uint32_t>(1925u),
   static_cast<_Boost::uint32_t>(66u),
   static_cast<_Boost::uint32_t>(1u),
   0
};

std::string make_order_string(int n)
{
   std::string result = _Boost::lexical_cast<std::string>(n);
   if (result.size() < 2)
      result.insert(result.begin(), ' ');
   return result;
}

void test_poly_1(const _Boost::integral_constant<int, 1>&)
{
}

template <int N>
void test_poly_1(const _Boost::integral_constant<int, N>&)
{
   test_poly_1(_Boost::integral_constant<int, N - 1>());

   double time = exec_timed_test([](const std::vector<double>& v) 
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_polynomial_c_imp_1(denom, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
   ...
   time = exec_timed_test([](const std::vector<double>& v)
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_polynomial_c_imp_1(denom_int, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
...
void test_poly_2(const _Boost::integral_constant<int, 1>&)
{
}

template <int N>
void test_poly_2(const _Boost::integral_constant<int, N>&)
{
   test_poly_2(_Boost::integral_constant<int, N - 1>());

   double time = exec_timed_test([](const std::vector<double>& v) 
   {  
      double result = 0; 
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_polynomial_c_imp_2(denom, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
   ...
   {  
      double result = 0; 
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_polynomial_c_imp_2(denom_int, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
...
void test_poly_3(const _Boost::integral_constant<int, 1>&)
{
}

template <int N>
void test_poly_3(const _Boost::integral_constant<int, N>&)
{
   test_poly_3(_Boost::integral_constant<int, N - 1>());

   double time = exec_timed_test([](const std::vector<double>& v) {  double result = 0;
   for (unsigned i = 0; i < 10; ++i)
      result += _Boost::math::tools::detail::evaluate_polynomial_c_imp_3(denom, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
   return result;
   });
   ...
   for (unsigned i = 0; i < 10; ++i)
      result += _Boost::math::tools::detail::evaluate_polynomial_c_imp_3(denom_int, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
   return result;
   });
...
void test_rat_1(const _Boost::integral_constant<int, 1>&)
{
}

template <int N>
void test_rat_1(const _Boost::integral_constant<int, N>&)
{
   test_rat_1(_Boost::integral_constant<int, N - 1>());

   double time = exec_timed_test([](const std::vector<double>& v)
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_rational_c_imp_1(num, denom, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
   ...
   time = exec_timed_test([](const std::vector<double>& v)
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_rational_c_imp_1(num, denom_int, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
...
void test_rat_2(const _Boost::integral_constant<int, 1>&)
{
}

template <int N>
void test_rat_2(const _Boost::integral_constant<int, N>&)
{
   test_rat_2(_Boost::integral_constant<int, N - 1>());

   double time = exec_timed_test([](const std::vector<double>& v)
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_rational_c_imp_2(num, denom, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
   ...
   time = exec_timed_test([](const std::vector<double>& v)
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_rational_c_imp_2(num, denom_int, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
...
void test_rat_3(const _Boost::integral_constant<int, 1>&)
{
}

template <int N>
void test_rat_3(const _Boost::integral_constant<int, N>&)
{
   test_rat_3(_Boost::integral_constant<int, N - 1>());

   double time = exec_timed_test([](const std::vector<double>& v)
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_rational_c_imp_3(num, denom, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
   ...
   time = exec_timed_test([](const std::vector<double>& v)
   {
      double result = 0;
      for (unsigned i = 0; i < 10; ++i)
         result += _Boost::math::tools::detail::evaluate_rational_c_imp_3(num, denom_int, v[0] + i, static_cast<_Boost::integral_constant<int, N>*>(0));
      return result;
   });
...
int main()
{
   ...
   test_poly_1(_Boost::integral_constant<int, 20>());
   test_poly_2(_Boost::integral_constant<int, 20>());
   test_poly_3(_Boost::integral_constant<int, 20>());
   ...
   test_rat_1(_Boost::integral_constant<int, 20>());
   test_rat_2(_Boost::integral_constant<int, 20>());
   test_rat_3(_Boost::integral_constant<int, 20>());
