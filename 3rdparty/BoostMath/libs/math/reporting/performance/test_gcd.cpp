...
_Boost::multiprecision::cpp_int total_sum(0);
...
_Boost::random::mt19937 rng;
_Boost::random::uniform_int_distribution<> d_0_6(0, 6);
_Boost::random::uniform_int_distribution<> d_1_20(1, 20);
...
T get_prime_products()
{
   ...
   case 1:
      // prime number:
      return _Boost::math::prime(d_1_20(rng) + 3);
   }
   T result = 1;
   for(int i = 0; i < n_primes; ++i)
      result *= _Boost::math::prime(d_1_20(rng) + 3) * _Boost::math::prime(d_1_20(rng) + 3) * _Boost::math::prime(d_1_20(rng) + 3) * _Boost::math::prime(d_1_20(rng) + 3) * _Boost::math::prime(d_1_20(rng) + 3);
   return result;
}
...
{
   static _Boost::random::uniform_int_distribution<T> minimax((std::numeric_limits<T>::min)(), (std::numeric_limits<T>::max)());
   return minimax(rng);
}
...
inline bool even(_Boost::multiprecision::number<Backend, ExpressionTemplates> const& val)
{
...
T binary_textbook(T u, T v)
{
   if(u && v)
   {
      unsigned shifts = (std::min)(_Boost::multiprecision::lsb(u), _Boost::multiprecision::lsb(v));
      if(shifts)
      {
         u >>= shifts;
         v >>= shifts;
      ...
      while(u)
      {
         unsigned bit_index = _Boost::multiprecision::lsb(u);
         if(bit_index)
         {
            u >>= bit_index;
         }
         else if(bit_index = _Boost::multiprecision::lsb(v))
         {
            v >>= bit_index;
         }
         else
...
{
   using namespace _Boost::integer::gcd_detail;
   typedef T int_type;
...
{
   static _Boost::random::mt19937 gen;
   typedef _Boost::random::mt19937::result_type random_type;
...
_Boost::multiprecision::cpp_int big_gcd(const _Boost::multiprecision::cpp_int& a, const _Boost::multiprecision::cpp_int& b)
{
   return _Boost::multiprecision::gcd(a, b);
}

namespace _Boost { namespace multiprecision { namespace backends {
      ...
      const cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& b)
{
   ...
   do 
   {
      ...
      {
         if(vp->size() == 1)
            *up = _Boost::integer::gcd_detail::mixed_binary_gcd(*vp->limbs(), *up->limbs());
         else
         {
            ...
            u = _Boost::integer::gcd_detail::mixed_binary_gcd(i, j);
         }
         break;
      }
...
_Boost::multiprecision::cpp_int big_gcd_new(const _Boost::multiprecision::cpp_int& a, const _Boost::multiprecision::cpp_int& b)
{
   _Boost::multiprecision::cpp_int result;
   _Boost::multiprecision::backends::eval_gcd_new(result.backend(), a.backend(), b.backend());
   return result;
}

#if 0
void test_n_bits(unsigned n, std::string data_name, const std::vector<pair<_Boost::multiprecision::cpp_int, _Boost::multiprecision::cpp_int> >* p_data = 0)
{
   using namespace _Boost::math::detail;
   typedef _Boost::multiprecision::cpp_int int_type;
...
int main()
{
    ...
    test_type<_Boost::multiprecision::uint256_t>("_Boost::multiprecision::uint256_t");
    test_type<_Boost::multiprecision::uint512_t>("_Boost::multiprecision::uint512_t");
    test_type<_Boost::multiprecision::uint1024_t>("_Boost::multiprecision::uint1024_t");
