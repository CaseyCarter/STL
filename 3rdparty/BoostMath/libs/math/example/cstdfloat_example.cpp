...
about 15 decimal digits `std::numeric_limits<_Boost::float64_t>::digits10`,
(but never exceeding 17 decimal digits `std::numeric_limits<_Boost::float64_t>::max_digits10`).
...
// Since max_digits10 is not defined (or wrong) on older systems, define a local max_digits10.
  // Usage:   int m = max_digits10<_Boost::float64_t>();
  const int m =
...
//[cstdfloat_example_2
_Boost::float64_t jahnke_emden_lambda(_Boost::float64_t v, _Boost::float64_t x)
{
  const _Boost::float64_t gamma_v_plus_one = _Boost::math::tgamma(v + 1);
  const _Boost::float64_t x_half_pow_v     = std::pow(x /2, v);

  return gamma_v_plus_one * _Boost::math::cyl_bessel_j(x, v) / x_half_pow_v;
}
//] [/cstdfloat_example_2]
...
//`Ensure that all possibly significant digits (17) including trailing zeros are shown.
  ...
  std::cout.precision(std::numeric_limits<_Boost::float64_t>::max_digits10);
  ...
  _Boost::float64_t v = 1.;
  _Boost::float64_t x = 1.;
...
//] [/cstdfloat_example_3]
  ...
  { // float64_t
    for (int i = 0; i < 10; i++)
    {
      std::cout << std::setprecision(2) << _Boost::float64_t(i) << ' '
        << std::setprecision(std::numeric_limits<_Boost::float64_t>::max_digits10)
        << jahnke_emden_lambda(_Boost::float64_t(i), v) << std::endl; //
    }
  }
  { // floatmax_t = the maximum available on this platform.
    for (int i = 0; i < 10; i++)
    {
      std::cout << std::setprecision(2) << _Boost::floatmax_t(i) << ' '
        << std::setprecision(std::numeric_limits<_Boost::floatmax_t>::max_digits10)
        << jahnke_emden_lambda(_Boost::floatmax_t(i), v) << std::endl; //
    }
  }
  ...
  long double p = _Boost::math::constants::pi<double>();
  std::cout.precision(std::numeric_limits<long double>::digits10);
  std::cout << "pi = "  << p << std::endl;
...
//`These allow floating-point [*constants of at least the specified width] to be declared:
  ...
  static const _Boost::float32_t pi = BOOST_FLOAT32_C(3.1415926536);

  // Declare the Euler-gamma constant with approximately 15 decimal digits of precision.
  static const _Boost::float64_t euler =
  ...
  static const _Boost::floatmax_t golden_ratio =
...
// Display the constant pi to the maximum available precision.
  _Boost::floatmax_t pi_max = _Boost::math::constants::pi<_Boost::floatmax_t>();
  std::cout.precision(std::numeric_limits<_Boost::floatmax_t>::digits10);
...
// then display how many decimal digits of precision.
  ...
  std::cout << "Floating-point type _Boost::float16_t is available." << std::endl;
#else
  std::cout << "Floating-point type _Boost::float16_t is NOT available." << std::endl;
#endif

#ifdef BOOST_FLOAT32_C
  std::cout << "Floating-point type _Boost::float32_t is available." << std::endl;
  std::cout << "  std::numeric_limits<_Boost::float32_t>::digits10 == "
    << std::numeric_limits<_Boost::float32_t>::digits10 << std::endl;
  std::cout << "  std::numeric_limits<_Boost::float32_t>::max_digits10 == "
    << std::numeric_limits<_Boost::float32_t>::max_digits10 << std::endl;
#else
  std::cout << "Floating-point type _Boost::float32_t is NOT available." << std::endl;
#endif

#ifdef BOOST_FLOAT64_C
  std::cout << "Floating-point type _Boost::float64_t is available." << std::endl;
    std::cout << "  std::numeric_limits<_Boost::float64_t>::digits10 == "
    << std::numeric_limits<_Boost::float64_t>::digits10 << std::endl;
  std::cout << "  std::numeric_limits<_Boost::float64_t>::max_digits10 == "
    << std::numeric_limits<_Boost::float64_t>::max_digits10 << std::endl;
#else
  std::cout << "Floating-point type _Boost::float64_t is NOT available." << std::endl;
#endif

#ifdef BOOST_FLOAT80_C
  std::cout << "Floating-point type _Boost::float80_t is available." << std::endl;
  std::cout << "  std::numeric_limits<_Boost::float80_t>::digits10 == "
    << std::numeric_limits<_Boost::float80_t>::digits10 << std::endl;
  std::cout << "  std::numeric_limits<_Boost::float80_t>::max_digits10 == "
    << std::numeric_limits<_Boost::float80_t>::max_digits10 << std::endl;
#else
  std::cout << "Floating-point type _Boost::float80_t is NOT available." << std::endl;
#endif

#ifdef BOOST_FLOAT128_C
  std::cout << "Floating-point type _Boost::float128_t is available." << std::endl;
    std::cout << "  std::numeric_limits<_Boost::float128_t>::digits10 == "
    << std::numeric_limits<_Boost::float128_t>::digits10 << std::endl;
  std::cout << "  std::numeric_limits<_Boost::float128_t>::max_digits10 == "
    << std::numeric_limits<_Boost::float128_t>::max_digits10 << std::endl;
#else
  std::cout << "Floating-point type _Boost::float128_t is NOT available." << std::endl;
#endif

// Show some constants at a precision depending on the available type(s).
#ifdef BOOST_FLOAT16_C
  std::cout.precision(_Boost::max_digits10<_Boost::float16_t>()); // Show all significant decimal digits,
...
//[floatmax_widths_1
#ifdef BOOST_FLOAT32_C
  std::cout.precision(_Boost::max_digits10<_Boost::float32_t>()); // Show all significant decimal digits,
  std::cout.setf(std::ios::showpoint); // including all significant trailing zeros.
...
#ifdef BOOST_FLOAT64_C
  std::cout.precision(_Boost::max_digits10<_Boost::float64_t>()); // Show all significant decimal digits,
  std::cout.setf(std::ios::showpoint); // including all significant trailing zeros.
...
#ifdef BOOST_FLOAT80_C
  std::cout.precision(_Boost::max_digits10<_Boost::float80_t>()); // Show all significant decimal digits,
  std::cout.setf(std::ios::showpoint); // including all significant trailing zeros.
...
#ifdef BOOST_FLOAT128_C
  std::cout.precision(_Boost::max_digits10<_Boost::float128_t>()); // Show all significant decimal digits,
  std::cout.setf(std::ios::showpoint); // including all significant trailing zeros.
...
// Display the precisions available for floatmax_t
  ...
  BOOST_ASSERT(std::numeric_limits<_Boost::floatmax_t>::is_specialized == true);
  BOOST_ASSERT(std::numeric_limits<_Boost::floatmax_t>::is_iec559 == true);
  BOOST_ASSERT(BOOST_FLOATMAX_C(0.) == 0);

  std::cout << "floatmax_t " << std::numeric_limits<_Boost::floatmax_t>::digits << " bits\n" // 113
    << std::numeric_limits<_Boost::floatmax_t>::digits10 << " decimal digits\n" // 34
    << std::numeric_limits<_Boost::floatmax_t>::max_digits10 << " max_digits\n" // 36
    << std::numeric_limits<_Boost::floatmax_t>::radix << " radix\n"
    << std::endl;

  int significand_bits = std::numeric_limits<_Boost::floatmax_t>::digits;
  int exponent_max = std::numeric_limits<_Boost::floatmax_t>::max_exponent;
  int exponent_min = std::numeric_limits<_Boost::floatmax_t>::min_exponent;
  int exponent_bits = 1 + static_cast<int>(std::log2(std::numeric_limits<_Boost::floatmax_t>::max_exponent));
  int sign_bits = std::numeric_limits<_Boost::floatmax_t>::is_signed;
  ...
  bool b = _Boost::is_same<_Boost::floatmax_t, _Boost::float64_t>::value;
  std::cout << "_Boost::is_same<_Boost::floatmax_t, _Boost::float64_t>::value; " << b << std::endl;
  std::cout << "floatmax_t, float64_t: "
    << std::is_same<_Boost::floatmax_t, _Boost::float64_t>::value << std::endl;
...
//[floatmax_1
  const int fpbits =
    (std::numeric_limits<_Boost::floatmax_t>::digits == 113) ? 128 :
    (std::numeric_limits<_Boost::floatmax_t>::digits == 64) ? 80 :
    (std::numeric_limits<_Boost::floatmax_t>::digits == 53) ? 64 :
    (std::numeric_limits<_Boost::floatmax_t>::digits == 24) ? 32 :
    (std::numeric_limits<_Boost::floatmax_t>::digits == 11) ? 16 :
...
GCC 4.8.1 with quadmath
 ...
 Most precise pi = 3.141592653589793238462643383279503
 Floating-point type _Boost::float16_t is NOT available.
 Floating-point type _Boost::float32_t is available.
 std::numeric_limits<_Boost::float32_t>::digits10 == 6
 std::numeric_limits<_Boost::float32_t>::max_digits10 == 9
 Floating-point type _Boost::float64_t is available.
 std::numeric_limits<_Boost::float64_t>::digits10 == 15
 std::numeric_limits<_Boost::float64_t>::max_digits10 == 17
 Floating-point type _Boost::float80_t is available.
 std::numeric_limits<_Boost::float80_t>::digits10 == 18
 std::numeric_limits<_Boost::float80_t>::max_digits10 == 21
 Floating-point type _Boost::float128_t is available.
 std::numeric_limits<_Boost::float128_t>::digits10 == 34
 std::numeric_limits<_Boost::float128_t>::max_digits10 == 36
 BOOST_FLOAT32_C(123.4567890123456789012345678901234567890) = 123.456787
 BOOST_FLOAT64_C(123.4567890123456789012345678901234567890) = 123.45678901234568
 BOOST_FLOAT80_C(123.4567890123456789012345678901234567890) = 123.456789012345678903
 BOOST_FLOAT128_C(123.4567890123456789012345678901234567890) = 123.456789012345678901234567890123453
 ...
 bits = 128
 double, double: true
 _Boost::is_same<_Boost::floatmax_t, _Boost::float64_t>::value; false
...
Floating-point type _Boost::float80_t is available.
  ...
  std::numeric_limits<_Boost::float80_t>::max_digits10 == 21
Floating-point type _Boost::float128_t is available.
  std::numeric_limits<_Boost::float128_t>::digits10 == 33
  std::numeric_limits<_Boost::float128_t>::max_digits10 == 36
BOOST_FLOAT32_C(123.4567890123456789012345678901234567890) = 123.456787
BOOST_FLOAT64_C(123.4567890123456789012345678901234567890) = 123.45678901234568
BOOST_FLOAT80_C(123.4567890123456789012345678901234567890) = 123.456789012345678903
...
128 bits.
 ...
 1>  Floating-point type _Boost::float16_t is NOT available.
 1>  Floating-point type _Boost::float32_t is available.
 1>    std::numeric_limits<_Boost::float32_t>::digits10 == 6
 1>    std::numeric_limits<_Boost::float32_t>::max_digits10 == 9
 1>  Floating-point type _Boost::float64_t is available.
 1>    std::numeric_limits<_Boost::float64_t>::digits10 == 15
 1>    std::numeric_limits<_Boost::float64_t>::max_digits10 == 17
 1>  Floating-point type _Boost::float80_t is NOT available.
 1>  Floating-point type _Boost::float128_t is NOT available.
 ...
 1>  _Boost::is_same<_Boost::floatmax_t, _Boost::float64_t>::value; true
