...
*/
  typedef _Boost::multiprecision::cpp_dec_float_50 float_type;
...
*/
    double root = _Boost::math::cyl_bessel_j_zero(0.0, 1);
    // Displaying with default precision of 6 decimal digits:
    std::cout << "_Boost::math::cyl_bessel_j_zero(0.0, 1) " << root << std::endl; // 2.40483
    // And with all the guaranteed (15) digits:
    std::cout.precision(std::numeric_limits<double>::digits10);
    std::cout << "_Boost::math::cyl_bessel_j_zero(0.0, 1) " << root << std::endl; // 2.40482555769577
...
``
    root = _Boost::math::cyl_bessel_j_zero(0, 1);
``
...
*/
  ...
  typedef _Boost::math::policies::policy
    ...
    std::cout << "_Boost::math::cyl_bessel_j_zero(-1.0, 0) " << std::endl;
    double dodgy_root = _Boost::math::cyl_bessel_j_zero(-1.0, 0, ignore_all_policy());
    std::cout << "_Boost::math::cyl_bessel_j_zero(-1.0, 1) " << dodgy_root << std::endl; // 1.#QNAN
    double inf_root = _Boost::math::cyl_bessel_j_zero(inf, 1, ignore_all_policy());
    std::cout << "_Boost::math::cyl_bessel_j_zero(inf, 1) " << inf_root << std::endl; // 1.#QNAN
    double nan_root = _Boost::math::cyl_bessel_j_zero(nan, 1, ignore_all_policy());
    std::cout << "_Boost::math::cyl_bessel_j_zero(nan, 1) " << nan_root << std::endl; // 1.#QNAN
...
*/
    ...
    _Boost::math::cyl_bessel_j_zero(2.0, 1, n_roots, std::back_inserter(roots));
...
*/
    ...
    float_type r = _Boost::math::cyl_bessel_j_zero(x, 1); // 1st root.
    std::cout << "x = " << x << ", r = " << r << std::endl;

    r = _Boost::math::cyl_bessel_j_zero(x, 20U); // 20th root.
    std::cout << "x = " << x << ", r = " << r << std::endl;

    std::vector<float_type> zeros;
    _Boost::math::cyl_bessel_j_zero(x, 1, 3, std::back_inserter(zeros));
...
*/
    using _Boost::math::cyl_neumann_zero;
...
*/
    using _Boost::math::cyl_bessel_j_zero;
    double nu = 1.;
    double sum = 0;
...
*/
  ...
  { // Try a negative rank m.
    std::cout << "_Boost::math::cyl_bessel_j_zero(-1.F, -1) " << std::endl;
    float dodgy_root = _Boost::math::cyl_bessel_j_zero(-1.F, -1);
    std::cout << "_Boost::math::cyl_bessel_j_zero(-1.F, -1) " << dodgy_root << std::endl;
    // Throw exception Error in function _Boost::math::cyl_bessel_j_zero<double>(double, int):
...
//] [/bessel_zero_example_iterator_3]
    try
  { // order v = inf
     std::cout << "_Boost::math::cyl_bessel_j_zero(infF, 1) " << std::endl;
     float infF = std::numeric_limits<float>::infinity();
     float inf_root = _Boost::math::cyl_bessel_j_zero(infF, 1);
      std::cout << "_Boost::math::cyl_bessel_j_zero(infF, 1) " << inf_root << std::endl;
     //  _Boost::math::cyl_bessel_j_zero(-1.F, -1) 
     //Thrown exception Error in function _Boost::math::cyl_bessel_j_zero<double>(double, int):
  ...
  { // order v = inf
     double inf = std::numeric_limits<double>::infinity();
     double inf_root = _Boost::math::cyl_bessel_j_zero(inf, 1);
     std::cout << "_Boost::math::cyl_bessel_j_zero(inf, 1) " << inf_root << std::endl;
     // Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, unsigned):
  ...
  { // order v = NaN
     double nan = std::numeric_limits<double>::quiet_NaN();
     double nan_root = _Boost::math::cyl_bessel_j_zero(nan, 1);
     std::cout << "_Boost::math::cyl_bessel_j_zero(nan, 1) " << nan_root << std::endl;
     // Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, unsigned):
  ...
  try
  {   // Try a negative m.
    double dodgy_root = _Boost::math::cyl_bessel_j_zero(0.0, -1);
    //  warning C4146: unary minus operator applied to unsigned type, result still unsigned.
    std::cout << "_Boost::math::cyl_bessel_j_zero(0.0, -1) " << dodgy_root << std::endl;
    //  _Boost::math::cyl_bessel_j_zero(0.0, -1) 6.74652e+009
  ...
  { // m = inf
     double inf = std::numeric_limits<double>::infinity();
     double inf_root = _Boost::math::cyl_bessel_j_zero(0.0, inf);
     // warning C4244: 'argument' : conversion from 'double' to 'int', possible loss of data.
     std::cout << "_Boost::math::cyl_bessel_j_zero(0.0, inf) " << inf_root << std::endl;
     // Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, int):
  ...
  try
  { // m = NaN
     std::cout << "_Boost::math::cyl_bessel_j_zero(0.0, nan) " << std::endl ;
     double nan = std::numeric_limits<double>::quiet_NaN();
     double nan_root = _Boost::math::cyl_bessel_j_zero(0.0, nan);
     // warning C4244: 'argument' : conversion from 'double' to 'int', possible loss of data.
...
[bessel_zero_output]
  ...
  _Boost::math::cyl_bessel_j_zero(0.0, 1) 2.40483
  _Boost::math::cyl_bessel_j_zero(0.0, 1) 2.40482555769577
  _Boost::math::cyl_bessel_j_zero(-1.0, 1) 1.#QNAN
  _Boost::math::cyl_bessel_j_zero(inf, 1) 1.#QNAN
  _Boost::math::cyl_bessel_j_zero(nan, 1) 1.#QNAN
  5.13562230184068
  8.41724414039986
  11.6198411721491
  14.7959517823513
  ...
  3.6154383428745996706772556069431792744372398748422
  nu = 1.00000, sum = 0.124990, exact = 0.125000
  Throw exception Error in function _Boost::math::cyl_bessel_j_zero<double>(double, int): Order argument is -1, but must be >= 0 !
  Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, int): Order argument is 1.#INF, but must be finite >= 0 !
  Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, int): Order argument is 1.#QNAN, but must be finite >= 0 !
  Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, int): Requested the -1'th zero, but must be > 0 !
  Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, int): Requested the -2147483648'th zero, but must be > 0 !
  Throw exception Error in function _Boost::math::cyl_bessel_j_zero<long double>(long double, int): Requested the -2147483648'th zero, but must be > 0 !
