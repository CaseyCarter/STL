...
#include <boost/math/distributions/geometric.hpp>
  ...
  using ::_Boost::math::geometric; // typedef provides default type is double.
  using  ::_Boost::math::pdf; // Probability mass function.
  using  ::_Boost::math::cdf; // Cumulative density function.
...
#include <boost/math/distributions/normal.hpp>
  // for negative_binomial_distribution
  using _Boost::math::normal; // typedef provides default type is double.
...
*/
  ...
  int max_digits10 = 2 + (_Boost::math::policies::digits<double, _Boost::math::policies::policy<> >() * 30103UL) / 100000UL;
...
[pre
Message from thrown exception was:
 Error in function _Boost::math::pdf(const exponential_distribution<double>&, double):
