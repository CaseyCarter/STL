...
void gauss_examples()
{
   ...
   */
   using namespace _Boost::math::quadrature;
   ...
   */
   ...
   std::cout << _Boost::math::relative_difference(Q, (_Boost::math::constants::pi<double>() - 2 + 2 * _Boost::math::constants::ln_two<double>()) / 12) << std::endl;

   std::cout << std::setprecision(34) << Q2 << std::endl;
   std::cout << _Boost::math::relative_difference(Q2, (_Boost::math::constants::pi<cpp_bin_float_quad>() - 2 + 2 * _Boost::math::constants::ln_two<cpp_bin_float_quad>()) / 12) << std::endl;
}
...
void gauss_kronrod_examples()
{
   ...
   */
   ...
   //<-
   double Q_expected = sqrt(_Boost::math::constants::half_pi<double>());
   //->
   ...
   */
   ...
   std::cout << _Boost::math::relative_difference(Q, Q_expected) << std::endl;
