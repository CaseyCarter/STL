...
int main()
{
  try
  {
    ...
    using _Boost::math::jacobi_zeta; // jacobi_zeta(T1 k, T2 phi) |k| <=1, k = sqrt(m)
  ...
  catch (std::exception const& ex)
  {
    ...
    // Message from thrown exception was:
    // Error in function _Boost::math::ellint_k<long double>(long double) : Got k = 2, function requires |k| <= 1
