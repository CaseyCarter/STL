...
template<typename TYPE_FLOAT>
R3_matrix<TYPE_FLOAT>    quaternion_to_R3_rotation(::_Boost::math::quaternion<TYPE_FLOAT> const & q)
{
...
template<typename TYPE_FLOAT>
::_Boost::math::quaternion<TYPE_FLOAT>    R3_rotation_to_quaternion(    R3_matrix<TYPE_FLOAT> const & rot,
                                                                    ::_Boost::math::quaternion<TYPE_FLOAT> const * hint = 0)
{
    ...
    ::_Boost::math::quaternion<TYPE_FLOAT>    q;
    ...
    {
        q = ::_Boost::math::quaternion<TYPE_FLOAT>(1);
    }
    else
    {
        ...
        {
            q = ::_Boost::math::quaternion<TYPE_FLOAT>(cos_theta_sur_2, +x*sin_theta_sur_2, +y*sin_theta_sur_2, +z*sin_theta_sur_2);
        }
        ...
        else
        {
            ...
            {
                q = ::_Boost::math::quaternion<TYPE_FLOAT>(0, +x, +y, +z);
            }
            else
            {
                q = ::_Boost::math::quaternion<TYPE_FLOAT>(0, -x, -y, -z);
