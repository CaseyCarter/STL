...
struct ds_info
{
   ...
   _Boost::math::hyperexponential iat_he;
   double multi_lt_sample_mean;
   double multi_lt_sample_sd;
   _Boost::math::hyperexponential multi_lt_he;
   double single_lt_sample_mean;
   double single_lt_sample_sd;
   _Boost::math::hyperexponential single_lt_he;
};
...
ds_info make_ds1()
{
   ...
   ds.iat_he = _Boost::math::hyperexponential(iat_fit_probs, iat_fit_rates);
   ...
   ds.multi_lt_he = _Boost::math::hyperexponential(multi_lt_fit_probs, multi_lt_fit_rates);
   ...
   ds.single_lt_he = _Boost::math::hyperexponential(single_lt_fit_probs, single_lt_fit_rates);
...
void print_fitted(ds_info const& ds)
{
   ...
   std::cout << " - Mean (SD): " << _Boost::math::mean(ds.iat_he) << " (" << _Boost::math::standard_deviation(ds.iat_he) << ") seconds." << std::endl;
   std::cout << " - 99th Percentile: " << _Boost::math::quantile(ds.iat_he, 0.99) << " seconds." << std::endl;
   std::cout << " - Probability that a VM will arrive within 30 minutes: " << _Boost::math::cdf(ds.iat_he, secs_in_a_hour / 2.0) << std::endl;
   std::cout << " - Probability that a VM will arrive after 1 hour: " << _Boost::math::cdf(_Boost::math::complement(ds.iat_he, secs_in_a_hour)) << std::endl;
   std::cout << "* Fitted Multi-core VM Lifetime" << std::endl;
   std::cout << " - Mean (SD): " << _Boost::math::mean(ds.multi_lt_he) << " (" << _Boost::math::standard_deviation(ds.multi_lt_he) << ") seconds." << std::endl;
   std::cout << " - 99th Percentile: " << _Boost::math::quantile(ds.multi_lt_he, 0.99) << " seconds." << std::endl;
   std::cout << " - Probability that a VM will last for less than 1 month: " << _Boost::math::cdf(ds.multi_lt_he, secs_in_a_month) << std::endl;
   std::cout << " - Probability that a VM will last for more than 3 months: " << _Boost::math::cdf(_Boost::math::complement(ds.multi_lt_he, 3.0*secs_in_a_month)) << std::endl;
   std::cout << "* Fitted Single-core VM Lifetime" << std::endl;
   std::cout << " - Mean (SD): " << _Boost::math::mean(ds.single_lt_he) << " (" << _Boost::math::standard_deviation(ds.single_lt_he) << ") seconds." << std::endl;
   std::cout << " - 99th Percentile: " << _Boost::math::quantile(ds.single_lt_he, 0.99) << " seconds." << std::endl;
   std::cout << " - Probability that a VM will last for less than 1 month: " << _Boost::math::cdf(ds.single_lt_he, secs_in_a_month) << std::endl;
   std::cout << " - Probability that a VM will last for more than 3 months: " << _Boost::math::cdf(_Boost::math::complement(ds.single_lt_he, 3.0*secs_in_a_month)) << std::endl;
}
