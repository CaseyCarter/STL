...
int main()
{
    ...
    auto x_range = _Boost::adaptors::keys(r);
    auto y_range = _Boost::adaptors::values(r);
    _Boost::math::barycentric_rational<double> b(x_range.begin(), x_range.end(), y_range.begin());
    //
    ...
    _Boost::uintmax_t iterations = (std::numeric_limits<_Boost::uintmax_t>::max)();
    double abscissa_3 = _Boost::math::tools::bisect([=](double x) { return b(x) - 3; }, 0.44, 1.24, _Boost::math::tools::eps_tolerance<double>(), iterations).first;
    ...
    iterations = (std::numeric_limits<_Boost::uintmax_t>::max)();
    abscissa_3 = _Boost::math::tools::bracket_and_solve_root([=](double x) { return b(x) - 3; }, 0.6, 1.2, false, _Boost::math::tools::eps_tolerance<double>(), iterations).first;
    std::cout << "Abscissa value that yields a potential of 3 = " << abscissa_3 << std::endl;
    std::cout << "Root was found in " << iterations << " iterations." << std::endl;
}
//] [/barycentric_rational_example2]
