...
using _Boost::math::binomial_coefficient;
...
using _Boost::multiprecision::cpp_complex_100;
...
int main()
{
    typedef _Boost::multiprecision::cpp_complex<500> Complex;
    size_t p_max = 20;
    ...
    {
        fs << std::setprecision(std::numeric_limits<_Boost::multiprecision::cpp_bin_float_oct>::max_digits10);
