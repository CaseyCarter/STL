...
int main ()
{
...

  {
    ...
    std::locale C99_out_locale (the_default_locale, new _Boost::math::nonfinite_num_put<char>);
...

  {
    ...
    std::locale C99_in_locale (the_default_locale, new _Boost::math::nonfinite_num_get<char>);
