...
#include <boost/exception/exception.hpp>  // _Boost::exception
#include <boost/math/constants/constants.hpp> // For exp_minus_one == 3.67879441171442321595523770161460867e-01.
#include <boost/math/policies/policy.hpp>

#include <boost/multiprecision/cpp_dec_float.hpp> // _Boost::multiprecision::cpp_dec_float_50
using _Boost::multiprecision::cpp_dec_float_50; // 50 decimal digits type.
using _Boost::multiprecision::cpp_dec_float_100; // 100 decimal digits type.
...
using _Boost::multiprecision::cpp_bin_float_double; // == double
using _Boost::multiprecision::cpp_bin_float_double_extended; // 80-bit long double emulation.
using _Boost::multiprecision::cpp_bin_float_quad; // 128-bit quad precision.
...
int main()
{
  try
  {
    ...
    using _Boost::math::constants::exp_minus_one; //-1/e, the branch point, a singularity ~= -0.367879.
...
//[lambert_w_simple_examples_out_of_range
 ...
 //] [/lambert_w_simple_examples_out_of_range]
     // Error in function _Boost::math::lambert_wm1<RealType>(<RealType>):
