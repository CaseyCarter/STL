...
int main ()
{
  ...
  std::locale new_locale(std::locale(std::locale(),
    new _Boost::math::nonfinite_num_put<char>),
    new _Boost::math::nonfinite_num_get<char>);
...
Output:
  ...
  _Boost::lexical_cast<double>("inf") = inf
