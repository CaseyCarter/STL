...
//using namespace _Boost::math::policies; may also be convenient.
...
Output:
  ...
  Message from thrown exception was:
     Error in function _Boost::math::tgamma<long double>(long double): Evaluation of tgamma at a negative integer 0.
