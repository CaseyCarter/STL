...
{ // Functor also returning 1st derivative.
  BOOST_STATIC_ASSERT_MSG(_Boost::is_integral<T>::value == false, "Only floating-point type types can be used!");
  ...
  { // Return both f(x) and f'(x).
    using _Boost::math::pow; // // Compile-time integral power.
    T p = pow<N - 1>(x);
...
{ // return nth root of x using 1st derivative and Newton_Raphson.
  using namespace std;  // Help ADL of std functions.
  using namespace _Boost::math::tools; // For newton_raphson_iterate.
...
{ // Functor returning both 1st and 2nd derivatives.
  ...
  // using _Boost::math::tuple; // to return three values.
...
{ // return nth root of x using 1st and 2nd derivatives and Halley.
  ...
  using namespace std;  // Help ADL of std functions.
  using namespace _Boost::math::tools; // For halley_iterate.
...
{ // return nth root of x using 1st and 2nd derivatives and Schroder.
  ...
  using namespace std;  // Help ADL of std functions.
  using namespace _Boost::math::tools; // For schroder_iterate.
...
int test_root(cpp_bin_float_100 big_value, cpp_bin_float_100 answer, const char* type_name, std::size_t type_no)
{
  ...
  int eval_count = _Boost::is_floating_point<T>::value ? 10000000 : 100000; // To give a sufficiently stable timing for the fast built-in types,
