...
//using namespace _Boost::math::policies; or explicitly
using _Boost::math::policies::policy;

using _Boost::math::policies::promote_float;
...
typedef _Boost::math::binomial_distribution<float, mypolicy> mybinom;
