...
#include <boost/multiprecision/cpp_bin_float.hpp> // using _Boost::multiprecision::cpp_bin_float_50;
...
int main()
{
  ...
  using _Boost::multiprecision::cpp_dec_float_50; // decimal.
  using _Boost::multiprecision::cpp_bin_float_50; // binary.
#ifndef _MSC_VER  // Not supported by Microsoft compiler.
  using _Boost::multiprecision::float128; // Requires libquadmath
#endif
  try
...
Type class _Boost::multiprecision::number<class _Boost::multiprecision::backends::cpp_dec_float<50,int,void>,1> value = 2,
  5th root = 1.1486983549970350067986269467779275894438508890978
Type class _Boost::multiprecision::number<class _Boost::multiprecision::backends::cpp_bin_float<50,10,void,int,0,0>,0> value = 2,
  5th root = 1.1486983549970350067986269467779275894438508890978
