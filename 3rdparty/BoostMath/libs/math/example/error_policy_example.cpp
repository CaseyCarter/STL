...
using _Boost::math::students_t_distribution;  // Probability of students_t(df, t).
using _Boost::math::students_t;  // Probability of students_t(df, t) convenience typedef for double.
...
/*`
   ...
   Error in function _Boost::math::students_t_distribution<double>::students_t_distribution:
...
Output:
  ...
  Message from thrown exception was:
     Error in function _Boost::math::students_t_distribution<double>::students_t_distribution: Degrees of freedom argument is -1, but must be > 0 !
