...
/*! \brief Examples of using the enhanced math constants.
    ...
    and also via namespaces, @c using @c namespace _Boost::math::double_constants;
    called simply @c pi.
*/
...
int main()
{
  ...
  { // Boost.Math constants using function calls like pi().
   ...
   using _Boost::math::constants::one_div_two_pi;
  ...
  cout << "double pi =  _Boost::math::double_constants::pi = " << pi<double>() << endl;
  //   double pi =  _Boost::math::double_constants::pi = 3.1415926535897931
  ...
  float pif = _Boost::math::constants::pi<float>();
  cout << "pidf =  _Boost::math::constants::pi() = " << pif << endl;
  //   pidf =  _Boost::math::float_constants::pi = 3.1415927410125732
  ...
  { // Boost math new constants using namespace selected values, like pi.
    ...
    double my2pi = two_pi; // Uses _Boost::math::double_constants::two_pi;

    cout << "double my2pi = " << my2pi << endl;

    using _Boost::math::float_constants::e;
    float my_e = e;
    cout << "float my_e  " << my_e << endl;

    double my_pi = _Boost::math::double_constants::pi;
    cout << "double my_pi = _Boost::math::double_constants::pi =  " << my_pi << endl;
...
//] [/math_constants_ambiguity]
  ...
  { // You can, of course, use both methods of access if both are fully qualified, for examples:
    ...
    double my_pi1 = _Boost::math::constants::pi<double>();
    double my_pid = _Boost::math::double_constants::pi;
    cout << "_Boost::math::constants::pi<double>() = " << my_pi1 << endl
         << "_Boost::math::double_constants::pi = " << my_pid << endl;

    // cout.precision(std::numeric_limits<float>::max_digits10); // Ideally.
    cout.precision(2 + std::numeric_limits<double>::digits * 3010/10000); // If no max_digits10.
    float my_pif = _Boost::math::float_constants::pi;
    cout << "_Boost::math::float_constants::pi = " << my_pif << endl;
...
Output:
  ...
  pidf =  _Boost::math::constants::pi() = 3.1415927410125732
  ...
  double my_pi = _Boost::math::double_constants::pi =  3.1415926535897931
  _Boost::math::constants::pi<double>() = 3.1415926535897931
  _Boost::math::double_constants::pi = 3.1415926535897931
  _Boost::math::float_constants::pi = 3.1415927410125732
