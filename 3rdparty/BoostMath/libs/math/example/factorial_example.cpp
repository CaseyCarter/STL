...
int main()
{
  ...
  try
  {
     ...
     cout << "Unchecked factorial: " << _Boost::math::unchecked_factorial<float>(n) << endl;
     // Note:
     // unsigned int unfac = _Boost::math::unchecked_factorial<unsigned int>(n);
  ...
  try
  {
    //cout << "Double factorial: " << _Boost::math::double_factorial<unsigned>(n);
  }
  catch(exception& e)
  {
    cout << e.what() << endl;
  ...
  try
  {
    ...
    // cout << "Binomial coefficient: " << _Boost::math::binomial_coefficient<unsigned>(n,k) << endl;
  }
  catch(exception& e)
  {
    cout << e.what() << endl;
