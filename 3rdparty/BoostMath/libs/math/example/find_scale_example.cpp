...
#include <boost/math/distributions/find_scale.hpp>
  ...
  using _Boost::math::complement; // Needed if you want to use the complement version.
  using _Boost::math::policies::policy; // Needed to specify the error handling policy.
...
Unless we are using the _Boost::math namespace, we will need:
*/
...
*/
  ...
  // Default policy policy<>, needs using _Boost::math::policies::policy;

  l = find_scale<normal>(z, p, l, policy<>());
  // Default policy, fully specified.
  l = find_scale<normal>(z, p, l, _Boost::math::policies::policy<>());
...
Message from thrown exception was:
   Error in function _Boost::math::find_scale<Dist, Policy>(complement(double, double, double, Policy)):
