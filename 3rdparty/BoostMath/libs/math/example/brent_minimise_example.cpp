...
#include <boost/multiprecision/cpp_dec_float.hpp> // For decimal _Boost::multiprecision::cpp_dec_float_50.
#include <boost/multiprecision/cpp_bin_float.hpp> // For binary _Boost::multiprecision::cpp_bin_float_50;
//] [/brent_minimise_mp_include_0]
...
#include <typeinfo>
 ...
 //typedef _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<50>,
 //   _Boost::multiprecision::et_off>
 //   cpp_dec_float_50_et_off;
 //
 // typedef _Boost::multiprecision::number<_Boost::multiprecision::cpp_bin_float<50>,
 //   _Boost::multiprecision::et_off>
...
{
  return _Boost::math::fpc::close_at_tolerance<FPT>(tolerance) (left, right);
}
...
{
  using _Boost::math::fpc::close_at_tolerance;
  using _Boost::math::fpc::is_small;
  using _Boost::math::fpc::FPC_STRONG;
...
void show_minima()
{
  using _Boost::math::tools::brent_find_minima;
  using std::sqrt;
  try
...
//[brent_minimise_double_4
  ...
  double epsilon_2 = _Boost::math::pow<-(std::numeric_limits<double>::digits/2 - 1), double>(2);
...
//] [/brent_minimise_double_4]
  ...
  //[brent_minimise_double_5
    ...
    double epsilon_4 = _Boost::math::pow<-(std::numeric_limits<double>::digits / 4 - 1), double>(2);
...
//[brent_minimise_mp_typedefs
  using _Boost::multiprecision::cpp_bin_float_50; // binary multiprecision typedef.
  using _Boost::multiprecision::cpp_dec_float_50; // decimal multiprecision typedef.

  // One might also need typedefs like these to switch expression templates off and on (default is on).
  typedef _Boost::multiprecision::number<_Boost::multiprecision::cpp_bin_float<50>,
    _Boost::multiprecision::et_on>
  ...
  typedef _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<50>,
    _Boost::multiprecision::et_on> // et_on is default so is same as cpp_dec_float_50.
...
//[brent_minimise_mp_1
    ...
    const _Boost::uintmax_t maxit = 20;
    _Boost::uintmax_t it = maxit; // Will be updated with actual iteration count.
...
For type  class _Boost::multiprecision::number<class _Boost::multiprecision::backends::cpp_bin_float<50,10,void,int,0,0>,1>,
