...
// using _Boost::multiprecision::cpp_bin_float and
...
`_Boost::multiprecision::cpp_bin_float_50`
...
*/
  ...
  cpp_bin_float_50 p = _Boost::math::constants::pi<cpp_bin_float_50>();
...
std::cout << "Generating an `std::array` or `_Boost::array` for floating-point type: "
  << fp_type << ". " << std::endl;
