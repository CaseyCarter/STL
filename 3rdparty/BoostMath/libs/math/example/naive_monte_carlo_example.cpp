...
int main()
{
    ...
    double A = 1.0 / _Boost::math::pow<3>(_Boost::math::constants::pi<double>());
    auto g = [&](std::vector<double> const & x)
    {
      return A / (1.0 - cos(x[0])*cos(x[1])*cos(x[2]));
    };
    vector<pair<double, double>> bounds{{0, _Boost::math::constants::pi<double>() }, {0, _Boost::math::constants::pi<double>() }, {0, _Boost::math::constants::pi<double>() }};
