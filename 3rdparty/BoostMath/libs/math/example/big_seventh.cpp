...
void no_et()
{
  ...
  std::cout.setf(std::ios_base::boolalpha);
   ...
   typedef number<backends::cpp_bin_float<113, backends::digit_base_2, void, _Boost::int16_t, -16382, 16383>, et_on> cpp_bin_float_quad_et_on;
   typedef number<backends::cpp_bin_float<113, backends::digit_base_2, void, _Boost::int16_t, -16382, 16383>, et_off> cpp_bin_float_quad_et_off;

   typedef number<backends::cpp_bin_float<113, backends::digit_base_2, void, _Boost::int16_t, -16382, 16383>, et_off> cpp_bin_float_oct;
...
*/
   std::cout << "pi = " << _Boost::math::constants::pi<cpp_bin_float_50>() << std::endl;
   cpp_bin_float_50 circumference = _Boost::math::constants::pi<cpp_bin_float_50>() * 2 * seventh;
