...
using _Boost::math::gamma_p_inv; // Compute x given a
//using _Boost::math::gamma_q_inv;
//using _Boost::math::gamma_p_inva; // Compute a given x
//using _Boost::math::gamma_q_inva;
...
int main()
{
  ...
  double r = _Boost::math::gamma_q_inv(a ,x);
