...
#include <boost/math/distributions/cauchy.hpp> // for cauchy_distribution
  using _Boost::math::cauchy; // typedef provides default type is double.
#include <boost/math/distributions/find_location.hpp>
  using _Boost::math::find_location; // for mean
#include <boost/math/distributions/find_scale.hpp>
  using _Boost::math::find_scale; // for standard deviation
...
*/
  ...
  l = find_location<normal>(z, p, sd, _Boost::math::policies::policy<>());
