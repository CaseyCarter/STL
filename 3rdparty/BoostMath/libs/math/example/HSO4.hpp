...
template<typename TYPE_FLOAT>
R4_matrix<TYPE_FLOAT>    quaternions_to_R4_rotation(::std::pair< ::_Boost::math::quaternion<TYPE_FLOAT> , ::_Boost::math::quaternion<TYPE_FLOAT> > const & pq)
{
...
template<typename TYPE_FLOAT>
::std::pair< ::_Boost::math::quaternion<TYPE_FLOAT> , ::_Boost::math::quaternion<TYPE_FLOAT> >    R4_rotation_to_quaternions(    R4_matrix<TYPE_FLOAT> const & rot,
                                                                                                                            ::std::pair< ::_Boost::math::quaternion<TYPE_FLOAT> , ::_Boost::math::quaternion<TYPE_FLOAT> > const * hint = 0)
{
    ...
    ::_Boost::math::quaternion<TYPE_FLOAT>    q = R3_rotation_to_quaternion(mat);
    
    ::_Boost::math::quaternion<TYPE_FLOAT>    p =
        ::_Boost::math::quaternion<TYPE_FLOAT>(rot.a11,rot.a12,rot.a13,rot.a14)*q;
