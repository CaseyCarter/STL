...
using _Boost::multiprecision::cpp_bin_float_double_extended;
using _Boost::multiprecision::cpp_bin_float_double;
...
int main()
{
  try
  {
    ...
    using _Boost::math::constants::exp_minus_one;
...
//[lambert_w_precision_1
    using _Boost::math::lambert_w_detail::lambert_w_halley_step;
    using _Boost::math::epsilon_difference;
    using _Boost::math::relative_difference;
