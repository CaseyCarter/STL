...
using _Boost::math::inverse_gamma_distribution;  //  inverse_gamma_distribution.
using _Boost::math::inverse_gamma;

#include <boost/math/special_functions/gamma.hpp>
using _Boost::math::tgamma; // Used for naive pdf as a comparison.
...
Output is:
  ...
  Message from thrown exception was:
     Error in function _Boost::math::mean(const inverse_gamma_distribution<double>&): Shape parameter is 0.5, but for a defined mean it must be > 1
