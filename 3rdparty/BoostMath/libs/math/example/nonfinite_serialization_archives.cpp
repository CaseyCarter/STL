...
using _Boost::archive::text_oarchive;
#include <boost/archive/codecvt_null.hpp>
using _Boost::archive::codecvt_null;
using _Boost::archive::no_codecvt;

#include <boost/math/special_functions/nonfinite_num_facets.hpp>
using _Boost::math::nonfinite_num_get;
using _Boost::math::nonfinite_num_put;
...
`_Boost::archive::codecvt_null` facet added.
...
That is done by calling the archive constructor with the flag `_Boost::archive::no_codecvt`.
...
int main()
{
  ...
  locale default_locale(locale::classic(), new _Boost::archive::codecvt_null<char>);
  ...
  _Boost::archive::text_oarchive oa(ofs, no_codecvt);
