    ...
    for    (int idxphi2 = 0; idxphi2 <= number_of_intervals; idxphi2++)
    {
        ...
        for    (int idxphi1 = 0; idxphi1 <= number_of_intervals; idxphi1++)
        {
            ...
            for    (int idxtheta = 0; idxtheta <= number_of_intervals; idxtheta++)
            {
                ...
                ::_Boost::math::quaternion<float>    q = ::_Boost::math::spherical(rho, theta, phi1, phi2);
                ...
                ::_Boost::math::quaternion<float>    p = R3_rotation_to_quaternion(rot, &q);
                
                ::std::cout << "p = " << p << ::std::endl;
                
                ::std::cout << "round trip discrepancy: " << ::_Boost::math::abs(q-p) << ::std::endl;
    ...
    for    (int idxalpha = 0; idxalpha <= number_of_intervals; idxalpha++)
    {
        ...
        for    (int idxtheta1 = 0; idxtheta1 <= number_of_intervals; idxtheta1++)
        {
            ...
            for    (int idxtheta2 = 0; idxtheta2 <= number_of_intervals; idxtheta2++)
            {
                ...
                ::_Boost::math::quaternion<float>    q = ::_Boost::math::semipolar(rho, alpha, theta1, theta2);
    ...
    for    (int idxrho = 0; idxrho <= number_of_intervals; idxrho++)
    {
        ...
        for    (int idxtheta1 = 0; idxtheta1 <= number_of_intervals; idxtheta1++)
        {
            ...
            for    (int idxtheta2 = 0; idxtheta2 <= number_of_intervals; idxtheta2++)
            {
                ...
                ::_Boost::math::quaternion<float>    q = ::_Boost::math::multipolar(rho1, theta1, rho2, theta2);
    ...
    for    (int idxt = 0; idxt <= number_of_intervals; idxt++)
    {
        ...
        for    (int idxlatitude = 0; idxlatitude <= number_of_intervals; idxlatitude++)
        {
            ...
            for    (int idxlongitude = 0; idxlongitude <= number_of_intervals; idxlongitude++)
            {
                ...
                ::_Boost::math::quaternion<float>    q = ::_Boost::math::cylindrospherical(t, radius, longitude, latitude);
    ...
    for    (int idxh2 = 0; idxh2 <= number_of_intervals; idxh2++)
    {
        ...
        for    (int idxh1 = 0; idxh1 <= number_of_intervals; idxh1++)
        {
            ...
            for    (int idxangle = 0; idxangle <= number_of_intervals; idxangle++)
            {
                ...
                ::_Boost::math::quaternion<float>    q = ::_Boost::math::cylindrical(r, angle, h1, h2);
                ...
                for    (int idxphi12 = 0; idxphi12 <= number_of_intervals; idxphi12++)
                {
                    ...
                    for    (int idxtheta1 = 0; idxtheta1 <= number_of_intervals; idxtheta1++)
                    {
                        ...
                        for    (int idxtheta2 = 0; idxtheta2 <= number_of_intervals; idxtheta2++)
                        {
                            ...
                            ::_Boost::math::quaternion<float>    p1 = ::_Boost::math::spherical(rho1, theta1, phi11, phi21);
                            
                            ::std::cout << "p1 = " << p1 << ::std::endl;
                            
                            ::_Boost::math::quaternion<float>    q1 = ::_Boost::math::spherical(rho2, theta2, phi12, phi22);
                            
                            ::std::cout << "q1 = " << q1 << ::std::endl;
                            
                            ::std::pair< ::_Boost::math::quaternion<float> , ::_Boost::math::quaternion<float> >    pq1 =
                                ::std::make_pair(p1,q1);
                            ...
                            ::std::pair< ::_Boost::math::quaternion<float> , ::_Boost::math::quaternion<float> >    pq2 =
                                R4_rotation_to_quaternions(rot, &pq1);
                            
                            ::std::cout << "p1 = " << pq2.first << ::std::endl;
                            ::std::cout << "p2 = " << pq2.second << ::std::endl;
                            
                            ::std::cout << "round trip discrepancy: " << ::std::sqrt(::_Boost::math::norm(pq1.first-pq2.first)+::_Boost::math::norm(pq1.second-pq2.second)) << ::std::endl;
