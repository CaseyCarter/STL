...
*/
  ...
  using _Boost::math::policies::integer_round_outwards; // Default.
  typedef _Boost::math::policies::policy<discrete_quantile<real> > real_quantile_policy;
/*`
