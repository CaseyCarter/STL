...
int main (void)
{
  ...
  std::locale the_default_locale (std::locale::classic (),
          new _Boost::archive::codecvt_null<char>);
  ...
  // Demonstrate use of nonfinite facets with stringstreams.
  {
    ...
    std::locale the_out_locale (the_default_locale, new _Boost::math::nonfinite_num_put<char>);
...

  {
    ...
    std::locale the_in_locale (the_default_locale, new _Boost::math::nonfinite_num_get<char>);
  ...
  {  // Demonstrate use of nonfinite facets for Serialization with Boost text archives.
    ...
    _Boost::archive::text_oarchive toar (fout, _Boost::archive::no_codecvt);
    // Write to archive.
    toar & f0;
    toar & f1;
    toar & f2;
...

  {
    ...
    _Boost::archive::text_iarchive tiar (fin, _Boost::archive::no_codecvt);
    foo f0, f1, f2, f3;
    // Read from archive.
    tiar & f0;
    tiar & f1;
  ...
  {   // Demonstrate use of nonfinite facets for Serialization with Boost XML Archive.
    ...
    fout.imbue (the_out_locale);
    _Boost::archive::xml_oarchive xoar (fout, _Boost::archive::no_codecvt);
...

  {
    ...
    fin.imbue (the_in_locale);
    _Boost::archive::xml_iarchive xiar (fin, _Boost::archive::no_codecvt);
    foo f0, f1, f2, f3;
