...
namespace my_distributions
{
  ...
  // using _Boost::math::policies::errno_on_error; // etc.
...
``
typedef _Boost::math::normal_distribution<double, my_policy> normal;
typedef _Boost::math::cauchy_distribution<double, my_policy> cauchy;
typedef _Boost::math::gamma_distribution<double, my_policy> gamma;
// etc
``

So that when we use my_distributions::normal we really end up using
`_Boost::math::normal_distribution<double, my_policy>`:
