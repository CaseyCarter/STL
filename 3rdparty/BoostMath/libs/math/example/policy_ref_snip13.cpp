...
namespace myspace
{ // using namespace _Boost::math::policies; // May be convenient in myspace.
...
// make the policy assert_undefined.
  using _Boost::math::policies::assert_undefined;
...
policy_snip_13.vcxproj -> J:\Cpp\MathToolkit\test\Math_test\Release\policy_snip_13.exe
  Error in function _Boost::math::mean(cauchy<double>&): The Cauchy distribution does not have a mean: the only possible return value is 1.#QNAN.
