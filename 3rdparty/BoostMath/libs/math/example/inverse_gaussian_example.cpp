...
#include <boost/math/distributions/inverse_gaussian.hpp> // for inverse_gaussian_distribution
  using _Boost::math::inverse_gaussian; // typedef provides default type is double.
  using _Boost::math::inverse_gaussian_distribution; // for inverse gaussian distribution.
