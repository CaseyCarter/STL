...
template <class T>
_Boost::uintmax_t cbrt_noderiv(T x, T guess)
{
   ...
   const _Boost::uintmax_t maxit = 20;            // Limit to maximum iterations.
...
template <class T>
_Boost::uintmax_t cbrt_deriv(T x, T guess)
{
...
template <class T>
_Boost::uintmax_t cbrt_2deriv(T x, T guess)
{ 
...
template <class T>
_Boost::uintmax_t cbrt_2deriv_s(T x, T guess)
{ 
   // return cube root of x using 1st and 2nd derivatives and Halley.
   //using namespace std;  // Help ADL of std functions.
   using namespace _Boost::math::tools;
...
_Boost::uintmax_t elliptic_root_noderiv(T radius, T arc, T guess)
...
template <class T = double>
_Boost::uintmax_t elliptic_root_1deriv(T radius, T arc, T guess)
{
   using namespace std;  // Help ADL of std functions.
...
template <class T = double>
_Boost::uintmax_t elliptic_root_2deriv(T radius, T arc, T guess)
{
   using namespace std;                // Help ADL of std functions.
...
template <class T = double>
_Boost::uintmax_t elliptic_root_2deriv_s(T radius, T arc, T guess)
