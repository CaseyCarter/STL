...
#include <boost/math/distributions/negative_binomial.hpp> // for negative_binomial_distribution
  using _Boost::math::negative_binomial_distribution; // default type is double.
  using _Boost::math::negative_binomial; // typedef provides default type is double.
...
*/
  _Boost::math::negative_binomial_distribution<double> mydist0(8., 0.25);
  /*`
  ...
  */
  ...
  [*much] better is explicit `using _Boost::math::` statements, for example:
  */
  ...
  */
  ...
  for example, `_Boost::math::cpp_bin_float_50` (an arbitrary 50 decimal digits precision type),
  then we can write:
  */
