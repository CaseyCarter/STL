...
*/ 
  ...
  std::cout
    ...
    << _Boost::math::bernoulli_b2n<double>(2) << std::endl;
...
*/
  ...
  std::cout
    << std::setprecision(std::numeric_limits<_Boost::multiprecision::cpp_dec_float_50>::digits10)
    << _Boost::math::bernoulli_b2n<_Boost::multiprecision::cpp_dec_float_50>(100) << std::endl;
...
*/
  ...
  _Boost::math::bernoulli_b2n<float>(0, 32, std::back_inserter(bn)); // Fill vector with even Bernoulli numbers.
...
*/
  try
  {
    ...
    std::cout << _Boost::math::bernoulli_b2n<float>(33) << std::endl;
  }
...
/*For example:
*/
   std::cout << "_Boost::math::max_bernoulli_b2n<float>::value = "  << _Boost::math::max_bernoulli_b2n<float>::value << std::endl;
   std::cout << "Maximum Bernoulli number using float is " << _Boost::math::bernoulli_b2n<float>( _Boost::math::max_bernoulli_b2n<float>::value) << std::endl;
   std::cout << "_Boost::math::max_bernoulli_b2n<double>::value = "  << _Boost::math::max_bernoulli_b2n<double>::value << std::endl;
   std::cout << "Maximum Bernoulli number using double is " << _Boost::math::bernoulli_b2n<double>( _Boost::math::max_bernoulli_b2n<double>::value) << std::endl;
  //] //[/bernoulli_example_4]
...
*/
  ...
  // Start with Bernoulli number 0.
  _Boost::math::tangent_t2n<float>(1, 6, std::back_inserter(tn)); // Fill vector with even Tangent numbers.
...
//[bernoulli_output_3
 Bernoulli number 66
 Thrown Exception caught: Error in function _Boost::math::bernoulli_b2n<float>(n):
 Overflow evaluating function at 33
//] //[/bernoulli_output_3]
//[bernoulli_output_4
  _Boost::math::max_bernoulli_b2n<float>::value = 32
  Maximum Bernoulli number using float is -2.0938e+038
  _Boost::math::max_bernoulli_b2n<double>::value = 129
