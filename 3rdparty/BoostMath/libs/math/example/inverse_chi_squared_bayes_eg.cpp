...
For this task, we use calls to the `_Boost::math::` functions `cdf` and `complement`,
respectively, and find a probability of about 0.031 (3.1%) for each case.
*/
  
  cout << "  probability variance <= 15: " << _Boost::math::cdf(prior, 15.0) << endl;
  cout << "  probability variance <= 25: " << _Boost::math::cdf(prior, 25.0) << endl;
  cout << "  probability variance > 50: " 
    << _Boost::math::cdf(_Boost::math::complement(prior, 50.0))
  << endl << endl;
 //] [/inverse_chi_squared_bayes_eg_2]
...
*/
 ...
 inverse_chi_squared posterior(posteriorDF, posteriorScale);
  ...
  cout << "  2.5% quantile: " << _Boost::math::quantile(posterior, 0.025) << endl;
  cout << "  50% quantile: " << _Boost::math::quantile(posterior, 0.5) << endl;
  cout << "  97.5% quantile: " << _Boost::math::quantile(posterior, 0.975) << endl << endl;

  cout << "  probability variance <= 15: " << _Boost::math::cdf(posterior, 15.0) << endl;
  cout << "  probability variance <= 25: " << _Boost::math::cdf(posterior, 25.0) << endl;
  cout << "  probability variance > 50: " 
    << _Boost::math::cdf(_Boost::math::complement(posterior, 50.0)) << endl;
