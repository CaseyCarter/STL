...
// using namespace _Boost::math::policies; is small risk, but
// the necessary items are brought into scope thus:

using _Boost::math::binomial_distribution;
using _Boost::math::policies::policy;
using _Boost::math::policies::discrete_quantile;

using _Boost::math::policies::integer_round_outwards;
using _Boost::math::policies::integer_round_down;
using _Boost::math::policies::integer_round_up;
using _Boost::math::policies::integer_round_nearest;
using _Boost::math::policies::integer_round_inwards;
using _Boost::math::policies::real;

using _Boost::math::binomial_distribution; // Not std::binomial_distribution.
