...
using _Boost::math::legendre_p_prime;
using _Boost::math::legendre_stieltjes;
...
void gauss_kronrod_rule(size_t order)
{
    ...
    std::cout << std::fixed;
    auto gauss_nodes = _Boost::math::legendre_p_zeros<Real>(order);
    ...
    {
        std::cout << "    _Boost::lexical_cast<Real>(\"" << node << "\"),\n";
    }
    std::cout << "};\n\n";
    ...
    {
        std::cout << "    _Boost::lexical_cast<Real>(\"" << weight << "\"),\n";
    }
    std::cout << "};\n\n";
