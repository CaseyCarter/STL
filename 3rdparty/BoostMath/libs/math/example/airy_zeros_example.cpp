...
*/
    double aiz1 = _Boost::math::airy_ai_zero<double>(1);
    std::cout << "_Boost::math::airy_ai_zero<double>(1) = " << aiz1 << std::endl; 
    double aiz2 = _Boost::math::airy_ai_zero<double>(2);
    std::cout << "_Boost::math::airy_ai_zero<double>(2) = " << aiz2 << std::endl;
    double biz3 = _Boost::math::airy_bi_zero<double>(3);
    std::cout << "_Boost::math::airy_bi_zero<double>(3) = " << biz3 << std::endl;
...
*/
    ...
    _Boost::math::airy_ai_zero<double>(1U, n_roots, std::back_inserter(roots));
...
*/
    ...
    unsigned int m = 1U;
    float_type r = _Boost::math::airy_ai_zero<float_type>(1U); // 1st root.
    std::cout << "_Boost::math::airy_bi_zero<float_type>(" << m << ")  = " << r << std::endl;
    m = 2;
    r = _Boost::math::airy_ai_zero<float_type>(2U); // 2nd root.
    std::cout << "_Boost::math::airy_bi_zero<float_type>(" << m << ")  = " << r << std::endl;
    m = 7U;
    r = _Boost::math::airy_bi_zero<float_type>(7U); // 7th root.
    std::cout << "_Boost::math::airy_bi_zero<float_type>(" << m << ")  = " << r << std::endl;

    std::vector<float_type> zeros;
    _Boost::math::airy_ai_zero<float_type>(1U, 3, std::back_inserter(zeros));
    std::cout << "airy_ai_zeros:" << std::endl;
...
/*
 ...
 Output:
  ...
  _Boost::math::airy_ai_zero<double>(1) = -2.33811
  _Boost::math::airy_ai_zero<double>(2) = -4.08795
  _Boost::math::airy_bi_zero<double>(3) = -4.83074
  airy_ai_zeros:
  -2.33811
  -4.08795
  -5.52056
  ...
  _Boost::math::airy_bi_zero<float_type>(1)  = -2.3381074104597670384891972524467354406385401456711
  _Boost::math::airy_bi_zero<float_type>(2)  = -4.0879494441309706166369887014573910602247646991085
  _Boost::math::airy_bi_zero<float_type>(7)  = -9.5381943793462388866329885451560196208390720763825
  airy_ai_zeros:
