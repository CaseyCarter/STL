...
using _Boost::math::inverse_chi_squared_distribution;  // inverse_chi_squared_distribution.
using _Boost::math::inverse_chi_squared; //typedef for nverse_chi_squared_distribution double.
...
int main()
{
  ...
  try
  {
    ...
    using _Boost::math::detail::inverse_chi_square_df_estimator;
    using _Boost::math::policies::default_policy;
    ...
    // bracket_and_solve_root(F f, const T& guess, T factor, bool rising, Tol tol, _Boost::uintmax_t& max_iter, const Policy& pol)
...
Output is:
  ...
  Message from thrown exception was:
     Error in function _Boost::math::inverse_chi_squared_distribution<double>::inverse_chi_squared_distribution: Degrees of freedom argument is 1.#INF, but must be > 0 !
