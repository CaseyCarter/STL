...
#include <boost/math/distributions/students_t.hpp>
   using _Boost::math::students_t;  // Probability of students_t(df, t).
   using _Boost::math::students_t_distribution;

//  using namespace _Boost::math; causes:
//.\error_policy_normal.cpp(30) : error C2872: 'policy' : ambiguous symbol
//        could be '\boost/math/policies/policy.hpp(392) : _Boost::math::policies::policy'
//        or '_Boost::math::policies'

// So should not use this 'using namespace _Boost::math;' command.
...
typedef _Boost::math::normal_distribution<double, my_policy> my_normal;
