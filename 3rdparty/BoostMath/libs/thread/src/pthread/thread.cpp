...
//#endif
        ...
        {
            _Boost::detail::thread_exit_function_base* func;
            thread_exit_callback_node* next;

            thread_exit_callback_node(_Boost::detail::thread_exit_function_base* func_,
        ...
        namespace
        {
          ...
          _Boost::once_flag current_thread_tls_init_flag;
#else
            _Boost::once_flag current_thread_tls_init_flag=BOOST_ONCE_INIT;
#endif
            ...
            extern "C"
            {
                ...
                {
                    //_Boost::detail::thread_data_base* thread_info=static_cast<_Boost::detail::thread_data_base*>(data);
                    _Boost::detail::thread_data_ptr thread_info = static_cast<_Boost::detail::thread_data_base*>(data)->shared_from_this();
            ...
            struct  delete_current_thread_tls_key_on_dlclose_t
            {
                ...
                ~delete_current_thread_tls_key_on_dlclose_t()
                {
                    const _Boost::once_flag uninitialized = BOOST_ONCE_INIT;
                    if (memcmp(&current_thread_tls_init_flag, &uninitialized, sizeof(_Boost::once_flag)))
                    {
        ...
        _Boost::detail::thread_data_base* get_current_thread_data()
        {
            _Boost::call_once(current_thread_tls_init_flag,&create_current_thread_tls_key);
            return (_Boost::detail::thread_data_base*)pthread_getspecific(current_thread_tls_key);
        }
    ...
    namespace
    {
        extern "C"
        {
            ...
            {
                //_Boost::detail::thread_data_ptr thread_info = static_cast<_Boost::detail::thread_data_base*>(param)->self;
                _Boost::detail::thread_data_ptr thread_info = static_cast<_Boost::detail::thread_data_base*>(param)->shared_from_this();
                thread_info->self.reset();
...
//                 }
                ...
                _Boost::lock_guard<_Boost::mutex> lock(thread_info->data_mutex);
...
#   endif
    ...
    unsigned thread::physical_concurrency() BOOST_NOEXCEPT
    {
        ...
        try {
            ...
            while ( getline(proc_cpuinfo, line) ) {
                ...
                _Boost::split(key_val, line, _Boost::is_any_of(":"));
                ...
                if (key == physical_id) {
                    current_core_entry.first = _Boost::lexical_cast<unsigned>(value);
                    continue;
                }

                if (key == core_id) {
                    current_core_entry.second = _Boost::lexical_cast<unsigned>(value);
    ...
    void thread::interrupt()
    {
        ...
        if(local_thread_info)
        {
            ...
            {
                _Boost::pthread::pthread_mutex_scoped_lock internal_lock(local_thread_info->cond_mutex);
    ...
    namespace this_thread
    {
        ...
        {
#ifndef BOOST_NO_EXCEPTIONS
            _Boost::detail::thread_data_base* const thread_info=detail::get_current_thread_data();
