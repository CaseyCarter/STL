...
namespace _Boost
{
    void _Boosttss_cleanup_implemented() {}
}
...
extern "C" {
    ...
    void (* after_ctors )() __attribute__((section(".ctors")))     = _Boost::_Booston_process_enter;
    void (* before_dtors)() __attribute__((section(".dtors")))     = _Boost::_Booston_thread_exit;
    void (* after_dtors )() __attribute__((section(".dtors.zzz"))) = _Boost::_Booston_process_exit;
...
#pragma warning(pop)
        ...
        {
            //Schedule _Booston_thread_exit() to be called for the main
            ...
            atexit(_Boost::_Booston_thread_exit);

            //Call Boost process entry callback here

            _Boost::_Booston_process_enter();
...
namespace _Boost
{
    void _Boosttss_cleanup_implemented()
    {
        ...
        _Boosttss_cleanup_implemented() function to eliminate the linker's
