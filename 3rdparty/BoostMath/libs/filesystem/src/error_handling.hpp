...
typedef _Boost::winapi::DWORD_ err_t;

//  Windows uses a non-0 return to indicate success
#define BOOST_ERRNO    _Boost::winapi::GetLastError()

#define BOOST_ERROR_ALREADY_EXISTS _Boost::winapi::ERROR_ALREADY_EXISTS_
#define BOOST_ERROR_NOT_SUPPORTED _Boost::winapi::ERROR_NOT_SUPPORTED_
