...
{
   static char s_delim;
   static const int s_collate_type = ::_Boost::BOOST_REGEX_DETAIL_NS::find_sort_syntax(static_cast<c_regex_traits<char>*>(0), &s_delim);
   std::string result;
   //
   ...
   {
   case ::_Boost::BOOST_REGEX_DETAIL_NS::sort_C:
   case ::_Boost::BOOST_REGEX_DETAIL_NS::sort_unknown:
   ...
   case ::_Boost::BOOST_REGEX_DETAIL_NS::sort_fixed:
      {
   ...
   case ::_Boost::BOOST_REGEX_DETAIL_NS::sort_delim:
...
c_regex_traits<char>::char_class_type BOOST_REGEX_CALL c_regex_traits<char>::lookup_classname(const char* p1, const char* p2)
{
   ...
   int idx = ::_Boost::BOOST_REGEX_DETAIL_NS::get_default_class_id(p1, p2);
   if(idx < 0)
   {
      std::string s(p1, p2);
      for(std::string::size_type i = 0; i < s.size(); ++i)
         s[i] = static_cast<char>((std::tolower)(static_cast<unsigned char>(s[i])));
      idx = ::_Boost::BOOST_REGEX_DETAIL_NS::get_default_class_id(&*s.begin(), &*s.begin() + s.size());
   }
...
bool BOOST_REGEX_CALL c_regex_traits<char>::isctype(char c, char_class_type mask)
{
   return
      ...
      || ((mask & char_class_blank) && (std::isspace)(static_cast<unsigned char>(c)) && !::_Boost::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & char_class_word) && (c == '_'))
      || ((mask & char_class_vertical) && (::_Boost::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == '\v')))
      || ((mask & char_class_horizontal) && (std::isspace)(static_cast<unsigned char>(c)) && !::_Boost::BOOST_REGEX_DETAIL_NS::is_separator(c) && (c != '\v'));
}

c_regex_traits<char>::string_type BOOST_REGEX_CALL c_regex_traits<char>::lookup_collatename(const char* p1, const char* p2)
{
   std::string s(p1, p2);
   s = ::_Boost::BOOST_REGEX_DETAIL_NS::lookup_default_collate_name(s);
   if(s.empty() && (p2-p1 == 1))
      s.append(1, *p1);
   return s;
}
