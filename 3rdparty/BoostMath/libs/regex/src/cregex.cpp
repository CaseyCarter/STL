 ...
 */
  ...
  *   DESCRIPTION: Implements high level class _Boost::RexEx
  */
...
typedef _Boost::match_flag_type match_flag_type;
#include <cstdio>
...
{
   _Boost::uint_fast32_t f = icase ? regex::normal | regex::icase : regex::normal;
