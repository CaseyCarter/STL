...
namespace _Boost{ namespace BOOST_REGEX_DETAIL_NS{
...
void w32_regex_traits_char_layer<char>::init() 
{
   ...
   if(cat)
   {
      ...
      {
         string_type mss = ::_Boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, i, get_default_syntax(i));
   ...
   do
   {
      if(m_char_map[i] == 0)
      {
         if(::_Boost::BOOST_REGEX_DETAIL_NS::w32_is(this->m_locale, 0x0002u, (char)i)) 
            m_char_map[i] = regex_constants::escape_type_class;
         else if(::_Boost::BOOST_REGEX_DETAIL_NS::w32_is(this->m_locale, 0x0001u, (char)i)) 
...
#endif
#endif
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type idx, _Boost::uint32_t m, char c)
{
   WORD mask;
#ifndef BOOST_NO_ANSI_APIS
...
#ifndef BOOST_NO_WREGEX
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type idx, _Boost::uint32_t m, wchar_t c)
{
   WORD mask;
...
#ifdef BOOST_REGEX_HAS_OTHER_WCHAR_T
BOOST_REGEX_DECL bool BOOST_REGEX_CALL w32_is(lcid_type idx, _Boost::uint32_t m, unsigned short c)
{
   WORD mask;
