...
/*
This header defines two traits classes, both in namespace _Boost::math::tools.
...
{
   BOOST_STATIC_CONSTANT(bool, value = (::_Boost::math::tools::detail::is_scaled_distribution_helper<D, ::_Boost::math::tools::detail::is_distribution_imp<D>::value>::value));
};

} // namespace detail

template <class T> struct is_distribution : public _Boost::integral_constant<bool, ::_Boost::math::tools::detail::is_distribution_imp<T>::value> {};
template <class T> struct is_scaled_distribution : public _Boost::integral_constant<bool, ::_Boost::math::tools::detail::is_scaled_distribution_imp<T>::value> {};
