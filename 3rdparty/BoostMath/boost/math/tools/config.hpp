...
#include <boost/cstdint.hpp> // for _Boost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         _Boost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    _Boost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  _Boost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  _Boost::non_type<t, v>*
...
#  define BOOST_MATH_NOEXCEPT(T) noexcept(_Boost::is_floating_point<T>::value)
#  define BOOST_MATH_IS_FLOAT(T) (_Boost::is_floating_point<T>::value)
#endif
#else
...
{
   static const bool value = _Boost::is_integral<T>::value
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#    define BOOST_FPU_EXCEPTION_GUARD _Boost::math::detail::fpu_guard local_guard_object;
