      ...
      namespace quadrature {
         namespace detail {
            ...
            public:
               ...
               {
                  typedef _Boost::integral_constant<int, initializer_selector> tag_type;
                  init(tag_type());
               }

               void init(const _Boost::integral_constant<int, 0>&)
               {
                  using std::tanh;
                  using std::sinh;
                  using std::asinh;
               ...
               void init(const _Boost::integral_constant<int, 1>&)
               {
