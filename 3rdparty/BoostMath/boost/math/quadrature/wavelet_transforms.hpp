...
namespace _Boost::math::quadrature {
...
public:
    ...
    daubechies_wavelet_transform(F f, _Boost::math::daubechies_wavelet<Real, p> wavelet, Real tol = 100*std::numeric_limits<Real>::epsilon(),
...
private:
    F f_;
    _Boost::math::daubechies_wavelet<Real, p> psi_;
    Real tol_;
