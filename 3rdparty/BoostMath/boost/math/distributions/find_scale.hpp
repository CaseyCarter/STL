...
namespace _Boost
{
  namespace math
  {
      ...
      )
    {
      ...
      BOOST_STATIC_ASSERT(::_Boost::math::tools::is_distribution<Dist>::value); 
      BOOST_STATIC_ASSERT(::_Boost::math::tools::is_scaled_distribution<Dist>::value); 
#endif
      static const char* function = "_Boost::math::find_scale<Dist, Policy>(%1%, %1%, %1%, Policy)";
      ...
      complemented4_type<Real1, Real2, Real3, Policy> const& c)
    {
      ...
      BOOST_STATIC_ASSERT(::_Boost::math::tools::is_scaled_distribution<Dist>::value); 
#endif
      static const char* function = "_Boost::math::find_scale<Dist, Policy>(complement(%1%, %1%, %1%, Policy))";

      // Checks on arguments, as not complemented version,
      // Explicit policy.
      typename Dist::value_type q = c.param1;
      if(!(_Boost::math::isfinite)(q) || (q < 0) || (q > 1))
      {
        return policies::raise_domain_error<typename Dist::value_type>(
