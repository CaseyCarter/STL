...
namespace _Boost
{
  namespace math
  {
    namespace beta_detail
    {
      ...
      {
        if(!(_Boost::math::isfinite)(alpha) || (alpha <= 0))
        {
      ...
      {
        if(!(_Boost::math::isfinite)(beta) || (beta <= 0))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
      ...
      {
        if(!(_Boost::math::isfinite)(x) || (x < 0) || (x > 1))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
      ...
      {
        if(!(_Boost::math::isfinite)(variance) || (variance <= 0))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      beta_distribution(RealType l_alpha = 1, RealType l_beta = 1) : m_alpha(l_alpha), m_beta(l_beta)
      {
        ...
        beta_detail::check_dist(
           "_Boost::math::beta_distribution<%1%>::beta_distribution",
          m_alpha,
          m_beta,
          &result, Policy());
      ...
      {
        static const char* function = "_Boost::math::beta_distribution<%1%>::find_alpha";
      ...
      static RealType find_beta(
        ...
        RealType variance) // Expected value of variance.
      {
        static const char* function = "_Boost::math::beta_distribution<%1%>::find_beta";
        RealType result = 0; // of error checks.
        if(false ==
            (
              beta_detail::check_mean(function, mean, &result, Policy())
    ...
    {
      static const char* function = "_Boost::math::mode(beta_distribution<%1%> const&)";
    ...
    { // Probability Density/Mass Function.
      ...
      static const char* function = "_Boost::math::pdf(beta_distribution<%1%> const&, %1%)";
    ...
    { // Cumulative Distribution Function beta.
      ...
      static const char* function = "_Boost::math::cdf(beta_distribution<%1%> const&, %1%)";
    ...
    { // Quantile or Percent Point beta function or
      ...
      static const char* function = "_Boost::math::quantile(beta_distribution<%1%> const&, %1%)";
