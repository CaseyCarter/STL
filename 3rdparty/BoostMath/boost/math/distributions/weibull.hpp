...
{
   if((shape <= 0) || !(_Boost::math::isfinite)(shape))
   {
...
public:
   ...
   {
      RealType result;
      detail::check_weibull("_Boost::math::weibull_distribution<%1%>::weibull_distribution", l_scale, l_shape, &result, Policy());
   }
...
{ // Range of supported values for random variable x.
   ...
   using _Boost::math::tools::max_value;
   using _Boost::math::tools::min_value;
...
inline RealType pdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::pdf(const weibull_distribution<%1%>, %1%)";
...
inline RealType cdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::cdf(const weibull_distribution<%1%>, %1%)";
   ...
   result = -_Boost::math::expm1(-pow(x / scale, shape), Policy());
...
inline RealType quantile(const weibull_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "_Boost::math::quantile(const weibull_distribution<%1%>, %1%)";
   ...
   result = scale * pow(-_Boost::math::log1p(-p, Policy()), 1 / shape);
...
inline RealType mean(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::mean(const weibull_distribution<%1%>)";
   ...
   result = scale * _Boost::math::tgamma(1 + 1 / shape, Policy());
   return result;
}
...
inline RealType variance(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::variance(const weibull_distribution<%1%>)";
   ...
   result = _Boost::math::tgamma(1 + 1 / shape, Policy());
   result *= -result;
   result += _Boost::math::tgamma(1 + 2 / shape, Policy());
   result *= scale * scale;
   return result;
}
...
inline RealType mode(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::mode(const weibull_distribution<%1%>)";
...
inline RealType median(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::median(const weibull_distribution<%1%>)";
...
inline RealType skewness(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::skewness(const weibull_distribution<%1%>)";
   ...
   g1 = _Boost::math::tgamma(1 + 1 / shape, Policy());
   g2 = _Boost::math::tgamma(1 + 2 / shape, Policy());
   g3 = _Boost::math::tgamma(1 + 3 / shape, Policy());
...
inline RealType kurtosis_excess(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::kurtosis_excess(const weibull_distribution<%1%>)";
   ...
   g2 = _Boost::math::tgamma(1 + 2 / shape, Policy());
   g3 = _Boost::math::tgamma(1 + 3 / shape, Policy());
   g4 = _Boost::math::tgamma(1 + 4 / shape, Policy());
   g1_2 = g1 * g1;
   g1_4 = g1_2 * g1_2;
   d = g2 - g1_2;
   d *= d;
