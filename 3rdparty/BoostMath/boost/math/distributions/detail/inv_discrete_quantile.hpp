      ...
      _Boost::uintmax_t& max_iter)
{
   ...
   static const char* function = "_Boost::math::do_inverse_discrete_quantile<%1%>";
   ...
   _Boost::math::tie(min_bound, max_bound) = support(dist);
   ...
   //
   if((_Boost::math::sign)(fb) == (_Boost::math::sign)(fa))
   {
      if(fa < 0)
      {
         //
         ...
         // until we find it:
         //
         while(((_Boost::math::sign)(fb) == (_Boost::math::sign)(fa)) && (a != b))
         {
            if(count == 0)
