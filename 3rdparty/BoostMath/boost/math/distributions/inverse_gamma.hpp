...
public:
      ...
      : m_shape(l_shape), m_scale(l_scale)
   {
      ...
      detail::check_inverse_gamma(
        "_Boost::math::inverse_gamma_distribution<%1%>::inverse_gamma_distribution",
...
inline RealType pdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::pdf(const inverse_gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::cdf(const inverse_gamma_distribution<%1%>&, %1%)";
   ...
   result = _Boost::math::gamma_q(shape, scale / x, Policy());
...
{
   BOOST_MATH_STD_USING  // for ADL of std functions
   using _Boost::math::gamma_q_inv;

   static const char* function = "_Boost::math::quantile(const inverse_gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const complemented2_type<inverse_gamma_distribution<RealType, Policy>, RealType>& c)
{
   ...
   static const char* function = "_Boost::math::quantile(const gamma_distribution<%1%>&, %1%)";
...
inline RealType mean(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::mean(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 1) || !(_Boost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType variance(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::variance(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 2) || !(_Boost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType mode(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::mode(const inverse_gamma_distribution<%1%>&)";
...
inline RealType skewness(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::skewness(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 3) || !(_Boost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType kurtosis_excess(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::kurtosis_excess(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 4) || !(_Boost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
{
  static const char* function = "_Boost::math::kurtosis(const inverse_gamma_distribution<%1%>&)";
   RealType shape = dist.shape();
   RealType scale = dist.scale();
