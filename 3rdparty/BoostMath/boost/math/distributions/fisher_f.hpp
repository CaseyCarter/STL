...
RealType pdf(const fisher_f_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::pdf(fisher_f_distribution<%1%> const&, %1%)";
...
{
   static const char* function = "_Boost::math::cdf(fisher_f_distribution<%1%> const&, %1%)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
   ...
   //
   return v1x > df2
      ? _Boost::math::ibetac(df2 / 2, df1 / 2, df2 / (df2 + v1x), Policy())
      : _Boost::math::ibeta(df1 / 2, df2 / 2, v1x / (df2 + v1x), Policy());
} // cdf

template <class RealType, class Policy>
inline RealType quantile(const fisher_f_distribution<RealType, Policy>& dist, const RealType& p)
{
   static const char* function = "_Boost::math::quantile(fisher_f_distribution<%1%> const&, %1%)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
   ...
   x = _Boost::math::ibeta_inv(df1 / 2, df2 / 2, p, &y, Policy());
...
inline RealType cdf(const complemented2_type<fisher_f_distribution<RealType, Policy>, RealType>& c)
{
   ...
   //
   return v1x > df2
      ? _Boost::math::ibeta(df2 / 2, df1 / 2, df2 / (df2 + v1x), Policy())
      : _Boost::math::ibetac(df1 / 2, df2 / 2, v1x / (df2 + v1x), Policy());
}
...
inline RealType quantile(const complemented2_type<fisher_f_distribution<RealType, Policy>, RealType>& c)
{
   ...
   x = _Boost::math::ibetac_inv(df1 / 2, df2 / 2, p, &y, Policy());
...
{ // Mean of F distribution = v.
   static const char* function = "_Boost::math::mean(fisher_f_distribution<%1%> const&)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
...
{ // Variance of F distribution.
   static const char* function = "_Boost::math::variance(fisher_f_distribution<%1%> const&)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
...
{
   static const char* function = "_Boost::math::mode(fisher_f_distribution<%1%> const&)";
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
   RealType error_result = 0;
...
{
   static const char* function = "_Boost::math::skewness(fisher_f_distribution<%1%> const&)";
...
{
   static const char* function = "_Boost::math::kurtosis_excess(fisher_f_distribution<%1%> const&)";
   // See http://mathworld.wolfram.com/F-Distribution.html
   RealType df1 = dist.degrees_of_freedom1();
   RealType df2 = dist.degrees_of_freedom2();
   // Error check:
