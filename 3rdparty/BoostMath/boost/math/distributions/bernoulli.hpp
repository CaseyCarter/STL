...
namespace _Boost
{
  namespace math
  {
    namespace bernoulli_detail
    {
      ...
      template <class RealType, class Policy>
      inline bool check_dist(const char* function, const RealType& p, RealType* result, const Policy& /* pol */, const _Boost::true_type&)
      {
        return check_success_fraction(function, p, result, Policy());
      }
      template <class RealType, class Policy>
      inline bool check_dist(const char* , const RealType& , RealType* , const Policy& /* pol */, const _Boost::false_type&)
      {
         return true;
      }
      template <class RealType, class Policy>
      ...
      inline bool check_dist_and_k(const char* function, const RealType& p, RealType k, RealType* result, const Policy& pol)
      {
        ...
        if(!(_Boost::math::isfinite)(k) || !((k == 0) || (k == 1)))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      { // Default probability = half suits 'fair' coin tossing
        ...
        bernoulli_detail::check_dist(
           "_Boost::math::bernoulli_distribution<%1%>::bernoulli_distribution",
          m_p,
          &result, Policy());
    ...
    { // Probability Density/Mass Function.
      ...
      if(false == bernoulli_detail::check_dist_and_k(
        "_Boost::math::pdf(bernoulli_distribution<%1%>, %1%)",
    ...
    { // Cumulative Distribution Function Bernoulli.
      ...
      RealType result = 0;
      if(false == bernoulli_detail::check_dist_and_k(
        "_Boost::math::cdf(bernoulli_distribution<%1%>, %1%)",
        p,
        k,
        &result, Policy()))
      {
    ...
    { // Quantile or Percent Point Bernoulli function.
      ...
      if(false == bernoulli_detail::check_dist_and_prob(
        "_Boost::math::quantile(bernoulli_distribution<%1%>, %1%)",
