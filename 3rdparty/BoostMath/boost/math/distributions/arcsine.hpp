...
namespace _Boost
{
  namespace math
  {
    namespace arcsine_detail
    {
      ...
      {
        if ((p < 0) || (p > 1) || !(_Boost::math::isfinite)(p))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
      ...
      { // Check x finite and x_min < x < x_max.
        ...
        if ((x < x_min) || (x > x_max))
        {
          ...
          *result = policies::raise_domain_error<RealType>(
          ...
          // For example:
          // Error in function _Boost::math::pdf(arcsine_distribution<double> const&, double) : x argument is -1.01, but must be x_min < x < x_max !
    ...
    public:
      ...
      { // Default beta (alpha = beta = 0.5) is standard arcsine with x_min = 0, x_max = 1.
        ...
        arcsine_detail::check_dist(
          "_Boost::math::arcsine_distribution<%1%>::arcsine_distribution",
          m_x_min,
          m_x_max,
          &result, Policy());
    ...
    { // Mean of arcsine distribution .
      ...
      if (false == arcsine_detail::check_dist(
        "_Boost::math::mean(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    { // Variance of standard arcsine distribution = (1-0)/8 = 0.125.
      ...
      RealType x_max = dist.x_max();
      if (false == arcsine_detail::check_dist(
        "_Boost::math::variance(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    { //There are always [*two] values for the mode, at ['x_min] and at ['x_max], default 0 and 1,
      ...
      return policies::raise_domain_error<RealType>(
        "_Boost::math::mode(arcsine_distribution<%1%>&)",
    ...
    { // Median of arcsine distribution (a + b) / 2 == mean.
      ...
      RealType result;
      if (false == arcsine_detail::check_dist(
        "_Boost::math::median(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    inline RealType skewness(const arcsine_distribution<RealType, Policy>& dist)
    {
      ...
      if (false == arcsine_detail::check_dist(
        "_Boost::math::skewness(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    inline RealType kurtosis_excess(const arcsine_distribution<RealType, Policy>& dist)
    {
      ...
      if (false == arcsine_detail::check_dist(
        "_Boost::math::kurtosis_excess(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    inline RealType kurtosis(const arcsine_distribution<RealType, Policy>& dist)
    {
      ...
      if (false == arcsine_detail::check_dist(
        "_Boost::math::kurtosis(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    { // Probability Density/Mass Function arcsine.
      ...
      static const char* function = "_Boost::math::pdf(arcsine_distribution<%1%> const&, %1%)";
    ...
    { // Cumulative Distribution Function arcsine.
      ...
      static const char* function = "_Boost::math::cdf(arcsine_distribution<%1%> const&, %1%)";
    ...
    { 
      ...
      static const char* function = "_Boost::math::quantile(arcsine_distribution<%1%> const&, %1%)";
