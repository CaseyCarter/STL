...
namespace _Boost { namespace math {
   ...
   public:
      ...
      hypergeometric_distribution(unsigned r, unsigned n, unsigned N) // Constructor.
         : m_n(n), m_N(N), m_r(r)
      {
         static const char* function = "_Boost::math::hypergeometric_distribution<%1%>::hypergeometric_distribution";
         RealType ret;
      ...
      bool check_params(const char* function, RealType* result)const
      {
         if(m_r > m_N)
         {
            *result = _Boost::math::policies::raise_domain_error<RealType>(
...
#  pragma warning(pop)
   ...
   {
      static const char* function = "_Boost::math::pdf(const hypergeometric_distribution<%1%>&, const %1%&)";
      RealType result = 0;
      ...
      return _Boost::math::detail::hypergeometric_pdf<RealType>(
   ...
   inline RealType pdf(const hypergeometric_distribution<RealType, Policy>& dist, const U& x)
   {
      ...
      if(u != r)
      {
         return _Boost::math::policies::raise_domain_error<RealType>(
   ...
   {
      static const char* function = "_Boost::math::cdf(const hypergeometric_distribution<%1%>&, const %1%&)";
      RealType result = 0;
      if(!dist.check_params(function, &result))
         return result;
      if(!dist.check_x(x, function, &result))
      ...
      return _Boost::math::detail::hypergeometric_cdf<RealType>(
   ...
   inline RealType quantile(const hypergeometric_distribution<RealType, Policy>& dist, const RealType& p)
   {
      BOOST_MATH_STD_USING // for ADL of std functions
         ...
         RealType result = 0;
      const char* function = "_Boost::math::quantile(const hypergeometric_distribution<%1%>&, %1%)";
