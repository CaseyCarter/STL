...
namespace _Boost
{
  namespace math
  {
    ...
    public:
      ...
      {
        static const char* function = "_Boost::math::geometric<%1%>::find_lower_bound_on_p";
      ...
      static RealType find_upper_bound_on_p(
        ...
        RealType alpha) // alpha 0.05 equivalent to 95% for one-sided test.
      {
        static const char* function = "_Boost::math::geometric<%1%>::find_upper_bound_on_p";
        RealType result = 0;  // of error checks.
        RealType successes = 1;
        RealType failures = trials - successes;
      ...
      {
        static const char* function = "_Boost::math::geometric<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == geometric_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
        ...
        RealType alpha) // risk level threshold 0 <= alpha <= 1.
      {
        static const char* function = "_Boost::math::geometric<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == geometric_detail::check_dist_and_k(
          function, p, k, &result, Policy())
    ...
    { // Probability Density/Mass Function.
      ...
      static const char* function = "_Boost::math::pdf(const geometric_distribution<%1%>&, %1%)";
    ...
    { // Cumulative Distribution Function of geometric.
      static const char* function = "_Boost::math::cdf(const geometric_distribution<%1%>&, %1%)";
      ...
      RealType z = _Boost::math::log1p(-p, Policy()) * (k + 1);
      RealType probability = -_Boost::math::expm1(z, Policy());
    ...
    { // Quantile, percentile/100 or Percent Point geometric function.
      ...
      static const char* function = "_Boost::math::quantile(const geometric_distribution<%1%>&, %1%)";
      BOOST_MATH_STD_USING // ADL of std functions.
      ...
      result = _Boost::math::log1p(-x, Policy()) / _Boost::math::log1p(-success_fraction, Policy()) - 1;
    ...
    {  // Quantile or Percent Point Binomial function.
       ...
       if (-x <= _Boost::math::powm1(dist.success_fraction(), dist.successes(), Policy()))
       ...
       result = log(x) / _Boost::math::log1p(-success_fraction, Policy()) - 1;
      return result;
