...
public:
   ...
   {
      RealType result;
      detail::check_gamma("_Boost::math::gamma_distribution<%1%>::gamma_distribution", l_scale, l_shape, &result, Policy());
   }
...
inline RealType pdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::pdf(const gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::cdf(const gamma_distribution<%1%>&, %1%)";
   ...
   result = _Boost::math::gamma_p(shape, x / scale, Policy());
   return result;
} // cdf
...
inline RealType mean(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::mean(const gamma_distribution<%1%>&)";
...
inline RealType variance(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::variance(const gamma_distribution<%1%>&)";
...
inline RealType mode(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::mode(const gamma_distribution<%1%>&)";
...
inline RealType skewness(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::skewness(const gamma_distribution<%1%>&)";
...
inline RealType kurtosis_excess(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "_Boost::math::kurtosis_excess(const gamma_distribution<%1%>&)";
