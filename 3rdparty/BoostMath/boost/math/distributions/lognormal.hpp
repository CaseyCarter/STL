...
public:
   ...
   {
      RealType result;
      detail::check_scale("_Boost::math::lognormal_distribution<%1%>::lognormal_distribution", l_scale, &result, Policy());
      detail::check_location("_Boost::math::lognormal_distribution<%1%>::lognormal_distribution", l_location, &result, Policy());
   }
...
{ // Range of permissible values for random variable x is >0 to +infinity.
   using _Boost::math::tools::max_value;
...
RealType pdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::pdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType cdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "_Boost::math::cdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType quantile(const lognormal_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "_Boost::math::quantile(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType mean(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("_Boost::math::mean(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("_Boost::math::mean(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType variance(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("_Boost::math::variance(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("_Boost::math::variance(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;

   return _Boost::math::expm1(sigma * sigma, Policy()) * exp(2 * mu + sigma * sigma);
}
...
inline RealType mode(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("_Boost::math::mode(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("_Boost::math::mode(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType skewness(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("_Boost::math::skewness(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("_Boost::math::skewness(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;

   return (ess + 2) * sqrt(_Boost::math::expm1(ss, Policy()));
}
...
inline RealType kurtosis(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("_Boost::math::kurtosis(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("_Boost::math::kurtosis(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
...
inline RealType kurtosis_excess(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("_Boost::math::kurtosis_excess(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("_Boost::math::kurtosis_excess(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
