...
namespace _Boost{ namespace math
{
  ...
  public:
    ...
    {
      RealType result;
      detail::check_uniform("_Boost::math::uniform_distribution<%1%>::uniform_distribution", l_lower, l_upper, &result, Policy());
    }
    // Accessor functions.
  ...
  inline RealType pdf(const uniform_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    if(false == detail::check_uniform("_Boost::math::pdf(const uniform_distribution<%1%>&, %1%)", lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_uniform_x("_Boost::math::pdf(const uniform_distribution<%1%>&, %1%)", x, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType cdf(const uniform_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("_Boost::math::cdf(const uniform_distribution<%1%>&, %1%)",lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_uniform_x("_Boost::math::cdf(const uniform_distribution<%1%>&, %1%)", x, &result, Policy()))
    {
      return result;
    }
    if (x < lower)
  ...
  inline RealType quantile(const uniform_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks
    if(false == detail::check_uniform("_Boost::math::quantile(const uniform_distribution<%1%>&, %1%)",lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_probability("_Boost::math::quantile(const uniform_distribution<%1%>&, %1%)", p, &result, Policy()))
    {
      return result;
    }
    if(p == 0)
  ...
  inline RealType quantile(const complemented2_type<uniform_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    if(false == detail::check_probability("_Boost::math::quantile(const uniform_distribution<%1%>&, %1%)", q, &result, Policy()))
    {
       return result;
    }
    if(q == 0)
  ...
  inline RealType mean(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0;  // of checks.
    if(false == detail::check_uniform("_Boost::math::mean(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType variance(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("_Boost::math::variance(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType mode(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("_Boost::math::mode(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType median(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("_Boost::math::median(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
    return (lower + upper) / 2; //
  ...
  inline RealType skewness(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0; // of checks.
    if(false == detail::check_uniform("_Boost::math::skewness(const uniform_distribution<%1%>&)",lower, upper, &result, Policy()))
    {
      return result;
    }
    return 0;
  ...
  inline RealType kurtosis_excess(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result = 0;  // of checks.
    if(false == detail::check_uniform("_Boost::math::kurtosis_execess(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
