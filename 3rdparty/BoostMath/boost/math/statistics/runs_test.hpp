                          ...
                          typename RandomAccessContainer::value_type threshold)
{
    ...
    auto normal = _Boost::math::normal_distribution<Real, no_promote_policy>(0,1);
    Real pvalue = 2*_Boost::math::cdf(normal, -abs(statistic));
    return std::make_pair(statistic, pvalue);
}
...
auto runs_above_and_below_median(RandomAccessContainer const & v)
{
    ...
    auto w = v;
    Real median = _Boost::math::statistics::median(w);
