...
// Implement the types for floating-point typedefs having specified widths.
  ...
  // <boost/math/tools/config.hpp>.
    ...
    namespace _Boost { namespace math { namespace cstdfloat { namespace detail {
    #if defined(__GNUC__)
    ...
    #define BOOST_CSTDFLOAT_FLOAT128_NATIVE_TYPE _Boost::math::cstdfloat::detail::float_internal128_t
    #undef  BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH
    #define BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH 128
    #undef  BOOST_CSTDFLOAT_HAS_FLOAT128_NATIVE_TYPE
    #define BOOST_CSTDFLOAT_HAS_FLOAT128_NATIVE_TYPE  1
  ...
  // specified widths. The types are defined in the namespace _Boost.
  ...
  namespace _Boost
  {
      ...
      typedef _Boost::float16_t float_fast16_t;
      typedef _Boost::float16_t float_least16_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float16_t>::is_iec559    == true, "_Boost::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float16_t>::radix        ==    2, "_Boost::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float16_t>::digits       ==   11, "_Boost::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float16_t>::max_exponent ==   16, "_Boost::float16_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef _Boost::float32_t float_fast32_t;
      typedef _Boost::float32_t float_least32_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float32_t>::is_iec559    == true, "_Boost::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float32_t>::radix        ==    2, "_Boost::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float32_t>::digits       ==   24, "_Boost::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float32_t>::max_exponent ==  128, "_Boost::float32_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
...
#define BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH 64
      ...
      typedef _Boost::float64_t float_fast64_t;
      typedef _Boost::float64_t float_least64_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float64_t>::is_iec559    == true, "_Boost::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float64_t>::radix        ==    2, "_Boost::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float64_t>::digits       ==   53, "_Boost::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float64_t>::max_exponent == 1024, "_Boost::float64_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef _Boost::float80_t float_fast80_t;
      typedef _Boost::float80_t float_least80_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float80_t>::is_iec559    ==  true, "_Boost::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float80_t>::radix        ==     2, "_Boost::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float80_t>::digits       ==    64, "_Boost::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float80_t>::max_exponent == 16384, "_Boost::float80_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef _Boost::float128_t float_fast128_t;
      typedef _Boost::float128_t float_least128_t;

      #if defined(BOOST_CSTDFLOAT_HAS_INTERNAL_FLOAT128_T) && defined(BOOST_MATH_USE_FLOAT128) && !defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_SUPPORT)
      // This configuration does not *yet* support std::numeric_limits<_Boost::float128_t>.
      // Support for std::numeric_limits<_Boost::float128_t> is added in the detail
      // file <boost/math/cstdfloat/cstdfloat_limits.hpp>.
      #else
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float128_t>::is_iec559    ==  true, "_Boost::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float128_t>::radix        ==     2, "_Boost::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float128_t>::digits       ==   113, "_Boost::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<_Boost::float128_t>::max_exponent == 16384, "_Boost::float128_t has been detected in <boost/cstdfloat>, but verification with std::numeric_limits fails");
      #endif
    ...
    #if  (BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  16)
      typedef _Boost::float16_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  32)
      typedef _Boost::float32_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  64)
      typedef _Boost::float64_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  80)
      typedef _Boost::float80_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH == 128)
      typedef _Boost::float128_t floatmax_t;
    #else
      #error The maximum available floating-point width for <boost/cstdfloat.hpp> is undefined.
    #endif
