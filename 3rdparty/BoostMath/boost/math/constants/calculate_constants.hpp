...
namespace _Boost{ namespace math{ namespace constants{ namespace detail{

template <class T>
template<int N>
inline T constant_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   ...
   T lim;
   lim = _Boost::math::tools::epsilon<T>();
   ...
   do
   {
      ...
      B = ldexp(B, 1);
      result = A - B;
      bool neg = _Boost::math::sign(result) < 0;
      if(neg)
         result = -result;
      if(result <= lim)
         break;
...
template <class T>
template<int N>
inline T constant_two_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template<int N>
inline T constant_two_div_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   return 2 / pi<T, policies::policy<policies::digits2<N> > >();
}
...
template <int N>
inline T constant_root_two_div_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_two_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int N>
inline T constant_root_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_half_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_two_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_log_root_two_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_ln_four<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_e<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   //
...
template <class T>
template<int N>
inline T constant_half<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int M>
inline T constant_euler<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, M>)))
{
   BOOST_MATH_STD_USING
   //
...
template <class T>
template<int N>
inline T constant_euler_sqr<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
  BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_euler<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
  BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_two<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_three<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_half_root_two<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_ln_two<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   //
...
template <class T>
template<int N>
inline T constant_ln_ten<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_ln_ln_two<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_third<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_twothirds<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_two_thirds<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return static_cast<T>(2) / static_cast<T>(3);
}
...
template <class T>
template<int N>
inline T constant_three_quarters<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_sixth<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
  BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_minus_three<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int N>
inline T constant_four_minus_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
//template <class T>
//template<int N>
//inline T constant_pow23_four_minus_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
//{
//   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_exp_minus_half<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_exp_minus_one<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
  BOOST_MATH_STD_USING
  return exp(static_cast<T>(-1.));
}
...
template <class T>
template<int N>
inline T constant_one_div_root_two<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int N>
inline T constant_one_div_root_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int N>
inline T constant_one_div_root_two_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int N>
inline T constant_root_one_div_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_four_thirds_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_half_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_third_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()  / static_cast<T>(3);
}
...
template <class T>
template<int N>
inline T constant_sixth_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_two_thirds_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_three_quarters_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_pow_e<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_sqr<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_pi_sqr_div_six<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()
   *      pi<T, policies::policy<policies::digits2<N> > >()
...
template <class T>
template<int N>
inline T constant_pi_cubed<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()
   *      pi<T, policies::policy<policies::digits2<N> > >()
...
template <class T>
template<int N>
inline T constant_cbrt_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_cbrt_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return static_cast<T>(1)
...
template <class T>
template<int N>
inline T constant_e_pow_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_root_e<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_log10_e<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_log10_e<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return  static_cast<T>(1) /
...
template <class T>
template<int N>
inline T constant_degree<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return pi<T, policies::policy<policies::digits2<N> > >()
   / static_cast<T>(180)
...
template <class T>
template<int N>
inline T constant_radian<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_sin_one<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_cos_one<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_sinh_one<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_cosh_one<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_phi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_ln_phi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_one_div_ln_phi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
   return static_cast<T>(1) /
...
template <class T>
template<int N>
inline T constant_zeta_two<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   BOOST_MATH_STD_USING
...
template <class T>
template<int N>
inline T constant_zeta_three<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int N>
inline T constant_catalan<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{ // http://oeis.org/A006752/constant
 ...
 //"149374281672134266498119621763019776254769479356512926115106248574");
  ...
  // 9.159655941772190150546035149323841107, 74149374281672134266498119621763019776254769479356512926115106248574422619, -01);
   ...
   return _Boost::math::constants::pi<T, _Boost::math::policies::policy<> >()
      * log(2 + _Boost::math::constants::root_three<T, _Boost::math::policies::policy<> >())
       / 8
      + 3 * sum / 8;
}
...
T khinchin(int digits)
{
   ...
   return exp(sum / _Boost::math::constants::ln_two<T, _Boost::math::policies::policy<> >());
}
...
template <class T>
template<int N>
inline T constant_khinchin<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
...
template <class T>
template<int N>
inline T constant_extreme_value_skewness<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
...
T zeta_series_derivative_2(unsigned digits)
{
   ...
   _Boost::math::itrunc((std::numeric_limits<T>::digits10 + 1) * 1.3);
...
inline T zeta_series_derivative_lead_2()
{
   ...
   return -2 * _Boost::math::constants::ln_two<T>();
}
...
template <class T>
template<int N>
inline T constant_glaisher<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   ...
   v *= 6;
   v /= _Boost::math::constants::pi<T, forwarding_policy>() * _Boost::math::constants::pi<T, forwarding_policy>();
   v -= _Boost::math::constants::euler<T, forwarding_policy>();
   v -= log(2 * _Boost::math::constants::pi<T, forwarding_policy>());
   v /= -12;
   return exp(v);
...
template <class T>
template<int N>
inline T constant_rayleigh_skewness<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{  // From e_float
...
template <class T>
template<int N>
inline T constant_rayleigh_kurtosis_excess<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
...
template <class T>
template<int N>
inline T constant_rayleigh_kurtosis<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
...
template <class T>
template<int N>
inline T constant_log2_e<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   return 1 / _Boost::math::constants::ln_two<T>();
}

template <class T>
template<int N>
inline T constant_quarter_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   return _Boost::math::constants::pi<T>() / 4;
}

template <class T>
template<int N>
inline T constant_one_div_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   return 1 / _Boost::math::constants::pi<T>();
}

template <class T>
template<int N>
inline T constant_two_div_root_pi<T>::compute(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC((_Boost::integral_constant<int, N>)))
{
   return 2 * _Boost::math::constants::one_div_root_pi<T>();
}
