...
#define BOOST_MATH_META_INT(type, name, Default)\
   template <type N = Default> struct name : public _Boost::integral_constant<int, N>{};\
   namespace detail{\
   template <type N>\
   ...
   template <class T> struct is_##name : public _Boost::integral_constant<bool, ::_Boost::math::policies::detail::is_##name##_imp<T>::value>{};

#define BOOST_MATH_META_BOOL(name, Default)\
   template <bool N = Default> struct name : public _Boost::integral_constant<bool, N>{};\
   namespace detail{\
   template <bool N>\
   char test_is_valid_arg(const name<N>*);\
   char test_is_default_arg(const name<Default>*);\
...
#define BOOST_MATH_META_INT(Type, name, Default)\
   ...
   {\
      static T inst;\
      BOOST_STATIC_CONSTANT(bool, value = sizeof( ::_Boost::math::policies::detail::is_##name##_tester<T>::test(inst)) == 1);\
   };\
   }\
   template <class T> struct is_##name : public _Boost::integral_constant<bool, ::_Boost::math::policies::detail::is_##name##_imp<T>::value>\
   {\
...
#ifdef __BORLANDC__
   typedef typename mpl::if_c<
      (Digits2::value > ::_Boost::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
public:
   typedef typename select_result<
      DefaultType, iter,
      ::_Boost::is_same<iter, end_type>::value>::type type;
};
...
{
   BOOST_STATIC_CONSTANT(bool, value = sizeof(::_Boost::math::policies::detail::test_is_valid_arg(static_cast<T*>(0))) == 1);
};

template <class T>
struct is_default_policy_imp
{
   BOOST_STATIC_CONSTANT(bool, value = sizeof(::_Boost::math::policies::detail::test_is_default_arg(static_cast<T*>(0))) == 1);
};

template <class T> struct is_valid_policy 
: public _Boost::integral_constant<bool, ::_Boost::math::policies::detail::is_valid_policy_imp<T>::value>
{};

template <class T> struct is_default_policy 
: public _Boost::integral_constant<bool, ::_Boost::math::policies::detail::is_default_policy_imp<T>::value>
{
   template <class U>
   struct apply
   {
...
private:
   ...
   //
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A1>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A2>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A3>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A4>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A5>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A6>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A7>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A8>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A9>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A10>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A11>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A12>::value);
   BOOST_STATIC_ASSERT(::_Boost::math::policies::detail::is_valid_policy<A13>::value);
   //
...
private:
   ...
   //
   typedef typename detail::append_N<reduced_list, default_policy, (14 - ::_Boost::mpl::size<reduced_list>::value)>::type result_type;
public:
   typedef policy<
      typename mpl::at<result_type, _Boost::integral_constant<int, 0> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 1> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 2> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 3> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 4> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 5> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 6> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 7> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 8> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 9> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 10> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 11> >::type,
      typename mpl::at<result_type, _Boost::integral_constant<int, 12> >::type > type;
};
//
...
template <class Real>
struct basic_digits : public _Boost::integral_constant<int, 0>{ };
template <>
struct basic_digits<float> : public _Boost::integral_constant<int, FLT_MANT_DIG>{ };
template <>
struct basic_digits<double> : public _Boost::integral_constant<int, DBL_MANT_DIG>{ };
template <>
struct basic_digits<long double> : public _Boost::integral_constant<int, LDBL_MANT_DIG>{ };
...
struct precision
{
   ...
   typedef typename mpl::if_<
      mpl::equal_to<digits_t, _Boost::integral_constant<int, 0> >,
      // Possibly unknown precision:
      precision_type,
      typename mpl::if_<
         mpl::or_<mpl::less_equal<digits_t, precision_type>, mpl::less_equal<precision_type, _Boost::integral_constant<int, 0> > >,
...
#else
   typedef typename Policy::precision_type precision_type;
   typedef _Boost::integral_constant<int, ::std::numeric_limits<Real>::digits> digits_t;
   typedef _Boost::integral_constant<bool, ::std::numeric_limits<Real>::is_specialized> spec_t;
   typedef typename mpl::if_<
      mpl::or_<mpl::equal_to<spec_t, _Boost::true_type>, mpl::equal_to<digits_t, _Boost::integral_constant<int, 0> > >,
      // Possibly unknown precision:
      precision_type,
      typename mpl::if_<
         mpl::or_<mpl::less_equal<digits_t, precision_type>, mpl::less_equal<precision_type, _Boost::integral_constant<int, 0> > >,
...
{
   typedef _Boost::integral_constant<int, 113> type;
};
...
inline BOOST_MATH_CONSTEXPR int digits_imp(_Boost::true_type const&) BOOST_NOEXCEPT
{
...
#endif
   typedef typename _Boost::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}

template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR int digits_imp(_Boost::false_type const&) BOOST_NOEXCEPT
{
...
{
   typedef _Boost::integral_constant<bool, std::numeric_limits<T>::is_specialized > tag_type;
   return detail::digits_imp<T, Policy>(tag_type());
}
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR int digits_base10(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) BOOST_NOEXCEPT
{
   return _Boost::math::policies::digits<T, Policy>() * 301 / 1000L;
}
...
struct series_factor_calc<T, Digits, _Boost::true_type, _Boost::true_type>
{
   static BOOST_MATH_CONSTEXPR T get() BOOST_MATH_NOEXCEPT(T)
   {
      return _Boost::math::tools::epsilon<T>();
   }
};
template <class T, class Digits>
struct series_factor_calc<T, Digits, _Boost::true_type, _Boost::false_type>
{
   static BOOST_MATH_CONSTEXPR T get() BOOST_MATH_NOEXCEPT(T)
   {
      return 1 / static_cast<T>(static_cast<_Boost::uintmax_t>(1u) << (Digits::value - 1));
   }
};
template <class T, class Digits>
struct series_factor_calc<T, Digits, _Boost::false_type, _Boost::true_type>
{
   static BOOST_MATH_CONSTEXPR T get() BOOST_MATH_NOEXCEPT(T)
   {
      return _Boost::math::tools::epsilon<T>();
...
template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR T get_epsilon_imp(_Boost::true_type const&) BOOST_MATH_NOEXCEPT(T)
{
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
...
#endif
   typedef typename _Boost::math::policies::precision<T, Policy>::type p_t;
   typedef _Boost::integral_constant<bool, p_t::value <= std::numeric_limits<_Boost::uintmax_t>::digits> is_small_int;
   typedef _Boost::integral_constant<bool, p_t::value >= std::numeric_limits<T>::digits> is_default_value;
   return series_factor_calc<T, p_t, is_small_int, is_default_value>::get();
}

template <class T, class Policy>
inline BOOST_MATH_CONSTEXPR T get_epsilon_imp(_Boost::false_type const&) BOOST_MATH_NOEXCEPT(T)
{
...
{
   typedef _Boost::integral_constant<bool, (std::numeric_limits<T>::is_specialized && (std::numeric_limits<T>::radix == 2)) > tag_type;
...
{
   BOOST_STATIC_CONSTANT(bool, value = (sizeof(::_Boost::math::policies::detail::test_is_policy(static_cast<P*>(0))) == 1));
};

}

template <class P>
struct is_policy : public _Boost::integral_constant<bool, ::_Boost::math::policies::detail::is_policy_imp<P>::value> {};
