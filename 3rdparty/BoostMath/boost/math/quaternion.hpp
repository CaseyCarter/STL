...
namespace _Boost
{
   namespace math
   {
      ...
      namespace detail {
         ...
         template <class T>
         struct is_trivial_arithmetic_type : public _Boost::is_pod<T> {};
      ...
      namespace constexpr_detail
      {
       ...
       template<typename T>
        ...
        public:
         ...
         private:
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_add(T const & rhs, const _Boost::true_type&)
            {
               a += rhs;
               return *this;
            }
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_add(T const & rhs, const _Boost::false_type&)
            {
               quaternion<T> result(a + rhs, b, c, d); // exception guard
               swap(result);
               return *this;
            }
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_add(std::complex<T> const & rhs, const _Boost::true_type&)
            {
               a += std::real(rhs);
               b += std::imag(rhs);
               return *this;
            }
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_add(std::complex<T> const & rhs, const _Boost::false_type&)
            {
            ...
            template <class X>
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_add(quaternion<X> const & rhs, const _Boost::true_type&)
            {
               a += rhs.R_component_1();
               b += rhs.R_component_2();
               c += rhs.R_component_3();
            ...
            template <class X>
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_add(quaternion<X> const & rhs, const _Boost::false_type&)
            {
            ...
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_subtract(T const & rhs, const _Boost::true_type&)
            {
               a -= rhs;
               return *this;
            }
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_subtract(T const & rhs, const _Boost::false_type&)
            {
               quaternion<T> result(a - rhs, b, c, d); // exception guard
               swap(result);
               return *this;
            }
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_subtract(std::complex<T> const & rhs, const _Boost::true_type&)
            {
               a -= std::real(rhs);
               b -= std::imag(rhs);
               return *this;
            }
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_subtract(std::complex<T> const & rhs, const _Boost::false_type&)
            {
               quaternion<T> result(a - std::real(rhs), b - std::imag(rhs), c, d); // exception guard
               swap(result);
               return *this;
            ...
            template <class X>
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_subtract(quaternion<X> const & rhs, const _Boost::true_type&)
            {
               a -= rhs.R_component_1();
               b -= rhs.R_component_2();
               c -= rhs.R_component_3();
            ...
            template <class X>
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_subtract(quaternion<X> const & rhs, const _Boost::false_type&)
            {
               quaternion<T> result(a - rhs.R_component_1(), b - rhs.R_component_2(), c - rhs.R_component_3(), d - rhs.R_component_4()); // exception guard
               swap(result);
               return *this;
            ...
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_multiply(T const & rhs, const _Boost::true_type&)
            {
               a *= rhs;
               b *= rhs;
               c *= rhs;
            ...
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_multiply(T const & rhs, const _Boost::false_type&)
            {
            ...
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_divide(T const & rhs, const _Boost::true_type&)
            {
               a /= rhs;
               b /= rhs;
               c /= rhs;
            ...
            BOOST_CXX14_CONSTEXPR quaternion<T> &        do_divide(T const & rhs, const _Boost::false_type&)
            {
               quaternion<T> result(a / rhs, b / rhs, c / rhs, d / rhs); // exception guard
               swap(result);
               return *this;
...
inline BOOST_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<T2, T1>::value, quaternion<T1> >::type
...
template <class T1, class T2>
inline BOOST_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<T1, T2>::value, quaternion<T2> >::type
...
template <class T1, class T2>
inline BOOST_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<T2, T1>::value, quaternion<T1> >::type
operator * (const quaternion<T1>& a, const std::complex<T2>& b)
{
...
template <class T1, class T2>
inline BOOST_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<T1, T2>::value, quaternion<T2> >::type
operator * (const std::complex<T1>& a, const quaternion<T2>& b)
{
   quaternion<T1> result(a);
   result *= b;
...
inline BOOST_CXX14_CONSTEXPR quaternion<T> operator / (const quaternion<T>& a, const quaternion<T>& b)
{
   ...
   return result;
        ...
        inline BOOST_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<R, T>::value, bool>::type operator == (R const & lhs, quaternion<T> const & rhs)
        {
            return    (
        ...
        inline BOOST_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<R, T>::value, bool>::type operator == (quaternion<T> const & lhs, R const & rhs)
        {
           return rhs == lhs;
        }
