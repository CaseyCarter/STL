...
public:
    ...
    barycentric_rational(InputIterator1 start_x, InputIterator1 end_x, InputIterator2 start_y, size_t approximation_order = 3, typename _Boost::disable_if_c<_Boost::is_integral<InputIterator2>::value>::type* = 0);
...
template <class Real>
template <class InputIterator1, class InputIterator2>
barycentric_rational<Real>::barycentric_rational(InputIterator1 start_x, InputIterator1 end_x, InputIterator2 start_y, size_t approximation_order, typename _Boost::disable_if_c<_Boost::is_integral<InputIterator2>::value>::type*)
