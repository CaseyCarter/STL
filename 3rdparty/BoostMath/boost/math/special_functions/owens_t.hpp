   ...
   namespace math
   {
      namespace detail
      {
         ...
         inline RealType owens_t_znorm1(const RealType x)
         {
            ...
            return _Boost::math::erf(x*one_div_root_two<RealType>())*half<RealType>();
         ...
         {
            using namespace _Boost::math::constants;
            return _Boost::math::erfc(x*one_div_root_two<RealType>())*half<RealType>();
         ...
         template<typename RealType>
         inline unsigned short owens_t_get_order_imp(const unsigned short icode, RealType, const _Boost::integral_constant<int, 53>&)
         {
            ...
            return ord[icode];
         } // unsigned short owens_t_get_order(const unsigned short icode, RealType, _Boost::integral_constant<int, 53> const&)

         template<typename RealType>
         inline unsigned short owens_t_get_order_imp(const unsigned short icode, RealType, const _Boost::integral_constant<int, 64>&)
        {
          ...
          return ord[icode];
        } // unsigned short owens_t_get_order(const unsigned short icode, RealType, _Boost::integral_constant<int, 64> const&)
         ...
         inline RealType owens_t_T1(const RealType h, const RealType a, const unsigned short m, const Policy& pol)
         {
            ...
            RealType dj = _Boost::math::expm1( hs, pol);
            RealType gj = hs*dhs;
         ...
         inline RealType owens_t_T2(const RealType h, const RealType a, const unsigned short m, const RealType ah, const Policy&, const _Boost::false_type&)
         {
            BOOST_MATH_STD_USING
            using namespace _Boost::math::constants;
         ...
         template<typename RealType>
         inline RealType owens_t_T3_imp(const RealType h, const RealType a, const RealType ah, const _Boost::integral_constant<int, 53>&)
         {
            BOOST_MATH_STD_USING
            using namespace _Boost::math::constants;
      ...
      const unsigned short m = 20;
        ...
        inline RealType owens_t_T3_imp(const RealType h, const RealType a, const RealType ah, const _Boost::integral_constant<int, 64>&)
        {
          BOOST_MATH_STD_USING
          using namespace _Boost::math::constants;
        ...
        inline RealType owens_t_T3(const RealType h, const RealType a, const RealType ah, const Policy&)
        {
         ...
         template<typename RealType>
         inline RealType owens_t_T5_imp(const RealType h, const RealType a, const _Boost::integral_constant<int, 53>&)
         {
            BOOST_MATH_STD_USING
            /*
               NOTICE:
            ...
            const RealType as = a*a;
            const RealType hs = -h*h*_Boost::math::constants::half<RealType>();
        ...
        // compute the value of Owen's T function with method T5 from the reference paper
        template<typename RealType>
        inline RealType owens_t_T5_imp(const RealType h, const RealType a, const _Boost::integral_constant<int, 64>&)
        {
          BOOST_MATH_STD_USING
            /*
              NOTICE:
        ...
        inline RealType owens_t_T5(const RealType h, const RealType a, const Policy&)
        {
         ...
         std::pair<T, T> owens_t_T1_accelerated(T h, T a, const Policy& pol)
         {
            ...
            //
            BOOST_MATH_STD_USING
            static const char* function = "_Boost::math::owens_t<%1%>(%1%, %1%)";
            T half_h_h = h * h / 2;
            T a_pow = a;
            T aa = a * a;
            ...
            return std::pair<T, T>((sum / d) / _Boost::math::constants::two_pi<T>(), abs_err / sum);
         }

         template<typename RealType, class Policy>
         inline RealType owens_t_T2(const RealType h, const RealType a, const unsigned short m, const RealType ah, const Policy&, const _Boost::true_type&)
         {
            BOOST_MATH_STD_USING
            using namespace _Boost::math::constants;
         ...
         inline std::pair<RealType, RealType> owens_t_T2_accelerated(const RealType h, const RealType a, const RealType ah, const Policy&)
         {
            ...
            RealType val = 0;
            RealType vi = a * exp( -ah*ah*half<RealType>() ) / root_two_pi<RealType>();
            RealType z = _Boost::math::detail::owens_t_znorm1(ah)/h;
            RealType last_z = fabs(z);
         ...
         inline RealType T4_mp(const RealType h, const RealType a, const Policy& pol)
         {
            ...
            RealType lim = _Boost::math::policies::get_epsilon<RealType, Policy>();
            ...
            while( true )
            {
               ...
               if(ii > (std::min)(1500, (int)policies::get_max_series_iterations<Policy>()))
                  policies::raise_evaluation_error("_Boost::math::owens_t<%1%>", 0, val, pol);
            } // while( true )
         ...
         template<typename RealType, typename Policy>
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, _Boost::integral_constant<int, 64> const&)
         {
            ...
            case 2: // T2
               typedef typename policies::precision<RealType, Policy>::type precision_type;
               typedef _Boost::integral_constant<bool, (precision_type::value == 0) || (precision_type::value > 64)> tag_type;
         ...
         template<typename RealType, typename Policy>
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, const _Boost::integral_constant<int, 65>&)
         {
            ...
            typedef typename _Boost::math::policies::normalise<Policy, _Boost::math::policies::evaluation_error<> >::type forwarding_policy;
            ...
            if(ah < 3)
            {
               ...
               catch(const _Boost::math::evaluation_error&){}  // T1 may fail and throw, that's OK
#endif
            }
            if(ah > 1)
            {
               ...
               catch(const _Boost::math::evaluation_error&){}  // T2 may fail and throw, that's OK
#endif
            }
            //
            ...
            catch(const _Boost::math::evaluation_error&){}  // T4 may fail and throw, that's OK
#endif
            //
            ...
            //
            return owens_t_dispatch(h, a, ah, pol, _Boost::integral_constant<int, 64>());
         } // RealType owens_t_dispatch(RealType h, RealType a, RealType ah)
         template<typename RealType, typename Policy>
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, const _Boost::integral_constant<int, 0>&)
         {
            // We don't know what the precision is until runtime:
            if(tools::digits<RealType>() <= 64)
               return owens_t_dispatch(h, a, ah, pol, _Boost::integral_constant<int, 64>());
            return owens_t_dispatch(h, a, ah, pol, _Boost::integral_constant<int, 65>());
         }
         template<typename RealType, typename Policy>
         ...
         struct owens_t_initializer
         {
            struct init
            {
               ...
               {
                  _Boost::math::owens_t(static_cast<T>(7), static_cast<T>(0.96875), Policy());
                  _Boost::math::owens_t(static_cast<T>(2), static_cast<T>(0.5), Policy());
               }
      ...
      inline typename tools::promote_args<T1, T2>::type owens_t(T1 h, T2 a, const Policy& pol)
      {
         ...
         return policies::checked_narrowing_cast<result_type, Policy>(detail::owens_t(static_cast<value_type>(h), static_cast<value_type>(a), pol), "_Boost::math::owens_t<%1%>(%1%,%1%)");
      }
