...
T ellint_pi_imp(T v, T phi, T k, T vc, const Policy& pol)
{
   ...
   static const char* function = "_Boost::math::ellint_3<%1%>(%1%,%1%,%1%)";
   ...
   if((phi > constants::half_pi<T>()) || (phi < 0))
   {
      ...
      {
         T rphi = _Boost::math::tools::fmod_workaround(T(fabs(phi)), T(constants::half_pi<T>()));
         T m = _Boost::math::round((fabs(phi) - rphi) / constants::half_pi<T>());
         int sign = 1;
         if((m != 0) && (k >= 1))
         {
   ...
   if(k == 0)
   {
      ...
      else
      {
         ...
         T vcr = sqrt(-vc);
         T arg = vcr * tan(phi);
         return (_Boost::math::log1p(arg, pol) - _Boost::math::log1p(-arg, pol)) / (2 * vcr);
      }
   }
   if((v < 0) && fabs(k) <= 1)
   {
...
T ellint_pi_imp(T v, T k, T vc, const Policy& pol)
{
    ...
    static const char* function = "_Boost::math::ellint_pi<%1%>(%1%,%1%)";
    ...
    if(v == 0)
    {
       return (k == 0) ? _Boost::math::constants::pi<T>() / 2 : ellint_k_imp(k, pol);
    }
    ...
    if(v < 0)
    {
       ...
       T Nm1 = (1 - k2) / (1 - v);
       T result = 0;
       result = _Boost::math::detail::ellint_pi_imp(N, k, Nm1, pol);
...
inline typename tools::promote_args<T1, T2, T3>::type ellint_3(T1 k, T2 v, T3 phi, const _Boost::false_type&)
{
   return _Boost::math::ellint_3(k, v, phi, policies::policy<>());
}

template <class T1, class T2, class Policy>
inline typename tools::promote_args<T1, T2>::type ellint_3(T1 k, T2 v, const Policy& pol, const _Boost::true_type&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_pi_imp(
         ...
         pol), "_Boost::math::ellint_3<%1%>(%1%,%1%)");
}
...
inline typename tools::promote_args<T1, T2, T3>::type ellint_3(T1 k, T2 v, T3 phi, const Policy& pol)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_pi_imp(
         ...
         static_cast<value_type>(k),
         static_cast<value_type>(1-v),
         pol), "_Boost::math::ellint_3<%1%>(%1%,%1%,%1%)");
}
