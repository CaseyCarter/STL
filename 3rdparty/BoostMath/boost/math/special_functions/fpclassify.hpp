...
//
// This must not be located in any namespace under _Boost::math
...
template <class T>
inline bool is_nan_helper(T t, const _Boost::true_type&)
{
#ifdef isnan
   return isnan(t);
...
template <class T>
inline bool is_nan_helper(T, const _Boost::false_type&)
{
   return false;
}
#if defined(BOOST_MATH_USE_FLOAT128) 
#if defined(BOOST_MATH_HAS_QUADMATH_H)
inline bool is_nan_helper(__float128 f, const _Boost::true_type&) { return ::isnanq(f); }
inline bool is_nan_helper(__float128 f, const _Boost::false_type&) { return ::isnanq(f); }
#elif defined(BOOST_GNU_STDLIB) && BOOST_GNU_STDLIB && \
      _GLIBCXX_USE_C99_MATH && !_GLIBCXX_USE_C99_FP_MACROS_DYNAMIC
inline bool is_nan_helper(__float128 f, const _Boost::true_type&) { return std::isnan(static_cast<double>(f)); }
inline bool is_nan_helper(__float128 f, const _Boost::false_type&) { return std::isnan(static_cast<double>(f)); }
#else
inline bool is_nan_helper(__float128 f, const _Boost::true_type&) { return ::isnan(static_cast<double>(f)); }
inline bool is_nan_helper(__float128 f, const _Boost::false_type&) { return ::isnan(static_cast<double>(f)); }
#endif
#endif
}
...
inline int fpclassify_imp BOOST_NO_MACRO_EXPAND(T t, const generic_tag<true>&)
{
   ...
   if(::_Boost::math_detail::is_nan_helper(t, ::_Boost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(isnan)
   if(_Boost::math_detail::is_nan_helper(t, ::_Boost::is_floating_point<T>()))
      return FP_NAN;
#elif defined(_MSC_VER) || defined(__BORLANDC__)
   if(::_isnan(_Boost::math::tools::real_cast<double>(t)))
      return FP_NAN;
#endif
...
{
   return _Boost::math::detail::fpclassify_imp(t, generic_tag<true>());
}
#endif
...
{
   return _Boost::math::detail::isfinite_impl(t, generic_tag<true>());
}
#endif
...
{ //!< \brief return true if floating-point type t is finite.
   typedef typename detail::fp_traits<T>::type traits;
   typedef typename traits::method method;
   // typedef typename _Boost::is_floating_point<T>::type fp_tag;
   typedef typename tools::promote_args_permissive<T>::type value_type;
...
{ //!< \brief return true if floating-point type t is finite.
   typedef detail::fp_traits<long double>::type traits;
   typedef traits::method method;
   //typedef _Boost::is_floating_point<long double>::type fp_tag;
   typedef long double value_type;
   return detail::isfinite_impl(static_cast<value_type>(x), method());
}
#endif
...
{
   return _Boost::math::detail::isnormal_impl(t, generic_tag<true>());
}
#endif
...
{
   return _Boost::math::detail::isinf_impl(t, generic_tag<true>());
}
#endif
...
#ifdef isnan
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<float>(float t){ return ::_Boost::math_detail::is_nan_helper(t, _Boost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<double>(double t){ return ::_Boost::math_detail::is_nan_helper(t, _Boost::true_type()); }
template <> inline bool isnan BOOST_NO_MACRO_EXPAND<long double>(long double t){ return ::_Boost::math_detail::is_nan_helper(t, _Boost::true_type()); }
