  ...
  namespace detail
  {
    namespace bessel_zero
    {
      ...
      public:
        ...
        _Boost::math::tuple<T, T> operator()(const T& z) const
        {
          ...
          return _Boost::math::tuple<T, T>(the_function, its_derivative);
        }
      ...
      static T equation_as_9_5_26(const T& v, const T& ai_bi_root)
      {
        ...
        const T v_pow_third(_Boost::math::cbrt(v));
        ...
        const T b = -((((zeta * zeta_sqrt) * 2U) / 3U) + _Boost::math::constants::half_pi<T>());
        ...
        const int my_digits10 = static_cast<int>(static_cast<float>(_Boost::math::tools::digits<T>() * 0.301F));

        // Select the maximum allowed iterations based on the number
        // of decimal digits in the numeric type T, being at least 12.
        const _Boost::uintmax_t iterations_allowed = static_cast<_Boost::uintmax_t>((std::max)(12, my_digits10 * 2));

        _Boost::uintmax_t iterations_used = iterations_allowed;

        // Calculate the root of z as a function of zeta.
        const T z = _Boost::math::tools::newton_raphson_iterate(
          _Boost::math::detail::bessel_zero::equation_as_9_3_39_and_its_derivative<T>(zeta),
          z_estimate,
          range_zmin,
          range_zmax,
          (std::min)(_Boost::math::tools::digits<T>(), _Boost::math::tools::digits<float>()),
          iterations_used);
      ...
      namespace cyl_bessel_j_zero_detail
      {
        ...
        public:
          ...
          {
            return _Boost::math::cyl_bessel_j(my_v, x, my_pol);
          }
        ...
        public:
          ...
          _Boost::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            if(my_order_is_zero)
            {
              j_v       =  _Boost::math::cyl_bessel_j(0, x, my_pol);
              j_v_prime = -_Boost::math::cyl_bessel_j(1, x, my_pol);
            }
            else
            {
                      j_v       = _Boost::math::cyl_bessel_j(  my_v,      x, my_pol);
              const T j_v_m1     (_Boost::math::cyl_bessel_j(T(my_v - 1), x, my_pol));
                      j_v_prime = j_v_m1 - ((my_v * j_v) / x);
            }

            // Return a tuple containing both Jv(x) and Jv'(x).
            return _Boost::math::make_tuple(j_v, j_v_prime);
          }
        ...
        T initial_guess(const T& v, const int m, const Policy& pol)
        {
          ...
          if(v < 0)
          {
            ...
            T root_hi = _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(vv_floor, m, pol);
            T root_lo;
            ...
            if(m == 1)
            {
              ...
              const bool hi_end_of_bracket_is_negative = (_Boost::math::cyl_bessel_j(v, root_hi, pol) < 0);

              while((root_lo > _Boost::math::tools::epsilon<T>()))
              {
                const bool lo_end_of_bracket_is_negative = (_Boost::math::cyl_bessel_j(v, root_lo, pol) < 0);
            ...
            {
              root_lo = _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(vv_floor, m - 1, pol);
            }

            // Perform several steps of bisection iteration to refine the guess.
            _Boost::uintmax_t number_of_iterations(12U);

            // Do the bisection iteration.
            const _Boost::math::tuple<T, T> guess_pair =
               _Boost::math::tools::bisect(
                  _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::function_object_jv<T, Policy>(v, pol),
                  root_lo,
                  root_hi,
                  _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::my_bisection_unreachable_tolerance<T>,
                  number_of_iterations);

            return (_Boost::math::get<0>(guess_pair) + _Boost::math::get<1>(guess_pair)) / 2U;
          }
          ...
          if(m == 1U)
          {
            ...
            else
            {
              ...
              guess = _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::equation_nist_10_21_40_a(v);
            }
          }
          else
          {
            if(v < 2.2F)
            {
              ...
              const T a(((v + T(m * 2U)) - T(0.5)) * _Boost::math::constants::half_pi<T>());

              guess = _Boost::math::detail::bessel_zero::equation_nist_10_21_19(v, a);
            }
            else
            {
              // Get an estimate of the m'th root of airy_ai.
              const T airy_ai_root(_Boost::math::detail::airy_zero::airy_ai_zero_detail::initial_guess<T>(m));

              // Use Eq. 9.5.26 in the A&S Handbook.
              guess = _Boost::math::detail::bessel_zero::equation_as_9_5_26(v, airy_ai_root);
            }
          }
      ...
      namespace cyl_neumann_zero_detail
      {
        ...
        public:
          ...
          T operator()(const T& x) const
          {
            return _Boost::math::cyl_neumann(my_v, x, my_pol);
          }
        ...
        public:
          ...
          _Boost::math::tuple<T, T> operator()(const T& x) const
          {
            const T half_epsilon(_Boost::math::tools::epsilon<T>() / 2U);
            ...
            if(order_is_zero)
            {
              y_v       =  _Boost::math::cyl_neumann(0, x, my_pol);
              y_v_prime = -_Boost::math::cyl_neumann(1, x, my_pol);
            }
            else
            {
                      y_v       = _Boost::math::cyl_neumann(  my_v,      x, my_pol);
              const T y_v_m1     (_Boost::math::cyl_neumann(T(my_v - 1), x, my_pol));
                      y_v_prime = y_v_m1 - ((my_v * y_v) / x);
            }

            // Return a tuple containing both Yv(x) and Yv'(x).
            return _Boost::math::make_tuple(y_v, y_v_prime);
          }
        ...
        T initial_guess(const T& v, const int m, const Policy& pol)
        {
          ...
          if(v < 0)
          {
            ...
            if(m == 1)
            {
              ...
              {
                root_hi = _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::initial_guess(vv_floor, m, pol);
              }
              else
              {
                root_hi = _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(T(vv_floor + 0.5F), m, pol);
              }

              root_lo = T(root_hi - 0.1F);

              const bool hi_end_of_bracket_is_negative = (_Boost::math::cyl_neumann(v, root_hi, pol) < 0);

              while((root_lo > _Boost::math::tools::epsilon<T>()))
              {
                const bool lo_end_of_bracket_is_negative = (_Boost::math::cyl_neumann(v, root_lo, pol) < 0);
            ...
            else
            {
              if(T(vv - vv_floor) < 0.5F)
              {
                root_lo  = _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::initial_guess(vv_floor, m - 1, pol);
                root_hi = _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::initial_guess(vv_floor, m, pol);
                root_lo += 0.01F;
                root_hi += 0.01F;
              }
              ...
              {
                root_lo = _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(T(vv_floor + 0.5F), m - 1, pol);
                root_hi = _Boost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(T(vv_floor + 0.5F), m, pol);
                root_lo += 0.01F;
                root_hi += 0.01F;
              }
            ...
            const _Boost::math::tuple<T, T> guess_pair =
               _Boost::math::tools::bisect(
                  _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::function_object_yv<T, Policy>(v, pol),
                  root_lo,
                  root_hi,
                  _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::my_bisection_unreachable_tolerance<T>,
                  number_of_iterations);
          ...
          if(m == 1U)
          {
            ...
            else
            {
              ...
              guess = _Boost::math::detail::bessel_zero::cyl_neumann_zero_detail::equation_nist_10_21_40_b(v);
            }
          }
          else
          {
            ...
            {
              // Use Eq. 10.21.19 in the NIST Handbook.
              const T a(((v + T(m * 2U)) - T(1.5)) * _Boost::math::constants::half_pi<T>());
            ...
            else
            {
              ...
              const T airy_bi_root(_Boost::math::detail::airy_zero::airy_bi_zero_detail::initial_guess<T>(m));

              // Use Eq. 9.5.26 in the A&S Handbook.
              guess = _Boost::math::detail::bessel_zero::equation_as_9_5_26(v, airy_bi_root);
            }
          }
