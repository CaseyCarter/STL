...
inline T igamma_temme_large(T, T, const Policy& /* pol */, _Boost::integral_constant<int, 0> const *)
{
...
//
template <class T, class Policy>
T igamma_temme_large(T a, T x, const Policy& pol, _Boost::integral_constant<int, 64> const *)
{
   BOOST_MATH_STD_USING // ADL of std functions
   T sigma = (x - a) / a;
   T phi = -_Boost::math::log1pmx(sigma, pol);
   T y = a * phi;
   T z = sqrt(2 * phi);
   if(x < a)
      z = -z;
   ...
   result += _Boost::math::erfc(sqrt(y), pol) / 2;
...
//
template <class T, class Policy>
T igamma_temme_large(T a, T x, const Policy& pol, _Boost::integral_constant<int, 53> const *)
{
   BOOST_MATH_STD_USING // ADL of std functions
   T sigma = (x - a) / a;
   T phi = -_Boost::math::log1pmx(sigma, pol);
...
//
template <class T, class Policy>
T igamma_temme_large(T a, T x, const Policy& pol, _Boost::integral_constant<int, 24> const *)
{
   BOOST_MATH_STD_USING // ADL of std functions
   T sigma = (x - a) / a;
   T phi = -_Boost::math::log1pmx(sigma, pol);
...
//
template <class T, class Policy>
T igamma_temme_large(T a, T x, const Policy& pol, _Boost::integral_constant<int, 113> const *)
{
   BOOST_MATH_STD_USING // ADL of std functions
   T sigma = (x - a) / a;
   T phi = -_Boost::math::log1pmx(sigma, pol);
