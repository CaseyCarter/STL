  ...
  namespace detail
  {
    ...
    namespace airy_zero
    {
      ...
      T equation_as_10_4_105(const T& z)
      {
        ...
        const T z_pow_third     (_Boost::math::cbrt(z));
      ...
      namespace airy_ai_zero_detail
      {
        ...
        T initial_guess(const int m)
        {
          ...
          switch(m)
          {
            ...
            default:
            {
              const T t(((_Boost::math::constants::pi<T>() * 3) * ((T(m) * 4) - 1)) / 8);
              guess = -_Boost::math::detail::airy_zero::equation_as_10_4_105(t);
              break;
            }
          }
        ...
        public:
          ...
          _Boost::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            return _Boost::math::make_tuple(
              _Boost::math::detail::airy_ai_imp      (x, my_pol),
              _Boost::math::detail::airy_ai_prime_imp(x, my_pol));
          }
      ...
      namespace airy_bi_zero_detail
      {
        ...
        T initial_guess(const int m)
        {
          ...
          switch(m)
          {
            ...
            default:
            {
              const T t(((_Boost::math::constants::pi<T>() * 3) * ((T(m) * 4) - 3)) / 8);
              guess = -_Boost::math::detail::airy_zero::equation_as_10_4_105(t);
              break;
            }
          }
        ...
        public:
          ...
          _Boost::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            return _Boost::math::make_tuple(
              _Boost::math::detail::airy_bi_imp      (x, my_pol),
              _Boost::math::detail::airy_bi_prime_imp(x, my_pol));
          }
