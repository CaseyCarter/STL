...
T bessel_i0_imp(const T&, const _Boost::integral_constant<int, N>&)
{
   BOOST_ASSERT(0);
   return 0;
}
...
template <typename T>
T bessel_i0_imp(const T& x, const _Boost::integral_constant<int, 24>&)
{
   ...
   if(x < 7.75)
   {
      ...
      T a = x * x / 4;
      return a * _Boost::math::tools::evaluate_polynomial(P, a) + 1;
   }
   else if(x < 50)
   {
      ...
      return exp(x) * _Boost::math::tools::evaluate_polynomial(P, T(1 / x)) / sqrt(x);
   }
   else
   {
      ...
      T ex = exp(x / 2);
      T result = ex * _Boost::math::tools::evaluate_polynomial(P, T(1 / x)) / sqrt(x);
      result *= ex;
      return result;
   }
}
...
template <typename T>
T bessel_i0_imp(const T& x, const _Boost::integral_constant<int, 53>&)
{
   BOOST_MATH_STD_USING
   if(x < 7.75)
   {
...
template <typename T>
T bessel_i0_imp(const T& x, const _Boost::integral_constant<int, 64>&)
{
   BOOST_MATH_STD_USING
   if(x < 7.75)
   {
   ...
   else if(x < 10)
   {
      ...
      return exp(x) * (_Boost::math::tools::evaluate_polynomial(P, T(1 / x)) + Y) / sqrt(x);
   }
   else if(x < 15)
   {
...
template <typename T>
T bessel_i0_imp(const T& x, const _Boost::integral_constant<int, 113>&)
{
   BOOST_MATH_STD_USING
   if(x < 7.75)
   {
...
template <typename T>
T bessel_i0_imp(const T& x, const _Boost::integral_constant<int, 0>&)
{
   if(_Boost::math::tools::digits<T>() <= 24)
      return bessel_i0_imp(x, _Boost::integral_constant<int, 24>());
   else if(_Boost::math::tools::digits<T>() <= 53)
      return bessel_i0_imp(x, _Boost::integral_constant<int, 53>());
   else if(_Boost::math::tools::digits<T>() <= 64)
      return bessel_i0_imp(x, _Boost::integral_constant<int, 64>());
   else if(_Boost::math::tools::digits<T>() <= 113)
      return bessel_i0_imp(x, _Boost::integral_constant<int, 113>());
   BOOST_ASSERT(0);
   return 0;
}
