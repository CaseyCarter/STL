...
#include <boost/math/policies/error_handling.hpp>
  ...
  namespace _Boost { namespace math { namespace detail {
     ...
     T hypergeometric_1F1_from_function_ratio_negative_b(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling, const T& ratio)
     {
        ...
        //
        int local_scaling = 0;
        T M2 = _Boost::math::detail::hypergeometric_1F1_imp(T(1 + a - b), T(2 - b), z, pol, local_scaling);
        ...
        _Boost::math::detail::hypergeometric_1F1_recurrence_a_and_b_coefficients<T> coef2(1 + a - b + 1, 2 - b + 1, z);
        T M3 = _Boost::math::tools::function_ratio_from_backwards_recurrence(coef2, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter) * M2;
        _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_from_function_ratio_negative_b_positive_a<%1%>(%1%,%1%,%1%)", max_iter, pol);
        //
     ...
     T hypergeometric_1F1_from_function_ratio_negative_b(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling)
     {
        ...
        //
        _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();
        _Boost::math::detail::hypergeometric_1F1_recurrence_a_and_b_coefficients<T> coef(a + 1, b + 1, z);
        T ratio = _Boost::math::tools::function_ratio_from_backwards_recurrence(coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
        _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_from_function_ratio_negative_b_positive_a<%1%>(%1%,%1%,%1%)", max_iter, pol);
     ...
     T hypergeometric_1F1_from_function_ratio_negative_b_forwards(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling)
     {
        ...
        //
        _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();
        _Boost::math::detail::hypergeometric_1F1_recurrence_a_and_b_coefficients<T> coef(a, b, z);
        T ratio = 1 / _Boost::math::tools::function_ratio_from_forwards_recurrence(coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
        _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_from_function_ratio_negative_b_positive_a<%1%>(%1%,%1%,%1%)", max_iter, pol);
        //
        ...
        T found = _Boost::math::tools::apply_recurrence_relation_forward(_Boost::math::detail::hypergeometric_1F1_recurrence_a_and_b_coefficients<T>(a + 1, b + 1, z), steps - 1, T(1), ratio, &scale);
        log_scaling -= scale;
     ...
     T hypergeometric_1F1_from_function_ratio_negative_ab(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling)
     {
        ...
        //
        _Boost::uintmax_t max_iter = _Boost::math::policies::get_max_series_iterations<Policy>();
        _Boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T> coef(a, b + 1, z);
        T ratio = _Boost::math::tools::function_ratio_from_backwards_recurrence(coef, _Boost::math::policies::get_epsilon<T, Policy>(), max_iter);
        _Boost::math::policies::check_series_iterations<T>("_Boost::math::hypergeometric_1F1_from_function_ratio_negative_b_positive_a<%1%>(%1%,%1%,%1%)", max_iter, pol);
        //
        ...
        T M3 = _Boost::math::detail::hypergeometric_1F1_imp(T(2 + a - b), T(3 - b), z, pol, local_scaling2);
        //
