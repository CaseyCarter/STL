...
T bessel_i1_imp(const T&, const _Boost::integral_constant<int, N>&)
{
   BOOST_ASSERT(0);
   return 0;
}
...
template <typename T>
T bessel_i1_imp(const T& x, const _Boost::integral_constant<int, 24>&)
{
   BOOST_MATH_STD_USING
      if(x < 7.75)
      {
         ...
         T a = x * x / 4;
         T Q[3] = { 1, 0.5f, _Boost::math::tools::evaluate_polynomial(P, a) };
         return x * _Boost::math::tools::evaluate_polynomial(Q, a) / 2;
      }
      else
      {
...
template <typename T>
T bessel_i1_imp(const T& x, const _Boost::integral_constant<int, 53>&)
{
   BOOST_MATH_STD_USING
   if(x < 7.75)
   {
...
template <typename T>
T bessel_i1_imp(const T& x, const _Boost::integral_constant<int, 64>&)
{
   BOOST_MATH_STD_USING
      if(x < 7.75)
      {
...
template <typename T>
T bessel_i1_imp(const T& x, const _Boost::integral_constant<int, 113>&)
{
   BOOST_MATH_STD_USING
   if(x < 7.75)
   {
...
template <typename T>
T bessel_i1_imp(const T& x, const _Boost::integral_constant<int, 0>&)
{
   if(_Boost::math::tools::digits<T>() <= 24)
      return bessel_i1_imp(x, _Boost::integral_constant<int, 24>());
   else if(_Boost::math::tools::digits<T>() <= 53)
      return bessel_i1_imp(x, _Boost::integral_constant<int, 53>());
   else if(_Boost::math::tools::digits<T>() <= 64)
      return bessel_i1_imp(x, _Boost::integral_constant<int, 64>());
   else if(_Boost::math::tools::digits<T>() <= 113)
      return bessel_i1_imp(x, _Boost::integral_constant<int, 113>());
   BOOST_ASSERT(0);
   return 0;
}
