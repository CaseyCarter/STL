    ...
    */
    ...
    private:
        ...
        CharType fill, ValType val) const
      {
        ...
        switch((_Boost::math::fpclassify)(val))
        {
        ...
        case FP_INFINITE:
          ...
          else if((_Boost::math::signbit)(val))
          { // negative infinity.
        ...
        case FP_ZERO:
          if((flags_ & signed_zero) && ((_Boost::math::signbit)(val)))
    ...
    private:
      ...
      ) const
      {
        ...
        if(negative)
        {
          val = (_Boost::math::changesign)(val);
        }
      } // void get_signed
