...
namespace _Boost
{
  namespace chrono
  {
    ...
    process_real_cpu_clock::time_point process_real_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::_Boost::chrono::is_throws(ec))
        {
          _Boost::throw_exception(system::system_error(errno, ::_Boost::system::system_category(), "chrono::process_real_cpu_clock"));
        } else
        {
          ec.assign(errno, ::_Boost::system::system_category());
          return time_point();
        }
      } else
      {
    ...
    process_user_cpu_clock::time_point process_user_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::_Boost::chrono::is_throws(ec))
        {
          _Boost::throw_exception(system::system_error(errno, ::_Boost::system::system_category(), "chrono::process_user_cpu_clock"));
        } else
        {
          ec.assign(errno, ::_Boost::system::system_category());
          return time_point();
    ...
    process_system_cpu_clock::time_point process_system_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::_Boost::chrono::is_throws(ec))
        {
          _Boost::throw_exception(system::system_error(errno, ::_Boost::system::system_category(), "chrono::process_system_cpu_clock"));
        } else
        {
          ec.assign(errno, ::_Boost::system::system_category());
          return time_point();
    ...
    process_cpu_clock::time_point process_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::_Boost::chrono::is_throws(ec))
        {
          _Boost::throw_exception(system::system_error(errno, ::_Boost::system::system_category(), "chrono::process_clock"));
        } else
        {
          ec.assign(errno, ::_Boost::system::system_category());
          return time_point();
