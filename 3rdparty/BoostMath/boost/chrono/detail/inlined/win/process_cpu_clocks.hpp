...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    _Boost::winapi::FILETIME_ creation, exit, user_time, system_time;

    if ( _Boost::winapi::GetProcessTimes(
            _Boost::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        _Boost::winapi::DWORD_ cause = _Boost::winapi::GetLastError();
        if (::_Boost::chrono::is_throws(ec))
        {
            _Boost::throw_exception(
                    system::system_error(
