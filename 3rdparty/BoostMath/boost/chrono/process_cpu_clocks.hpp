...
namespace _Boost { namespace chrono {
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef _Boost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<_Boost::chrono::process_times<Rep> >
    {
        typedef _Boost::chrono::process_times<Rep> Res;
