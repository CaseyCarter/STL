...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "_Boost::bad_format_string: format-string is ill-formed";
            }
        };
