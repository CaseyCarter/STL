// ----------------------------------------------------------------------------
// free_funcs.hpp :  implementation of the free functions of _Boost::format
// ----------------------------------------------------------------------------
...
namespace _Boost {
    ...
    namespace io {
         using ::_Boost::str; // keep compatibility with when it was defined in this N.S.
    }   // - namespace io
    ...
    {
        typedef _Boost::basic_format<Ch, Tr, Alloc>   format_t;
        if(f.items_.size()==0) 
            os << f.prefix_;
        else {
            if(f.cur_arg_ < f.num_args_)
                if( f.exceptions() & io::too_few_args_bit )
                    ...
                    _Boost::throw_exception(io::too_few_args(f.cur_arg_, f.num_args_)); 
