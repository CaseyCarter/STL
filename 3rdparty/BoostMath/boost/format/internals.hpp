...
//        stream_format_state(const basic_ios& os)     { set_by_stream(os); }
        ...
        void apply_on(basic_ios & os,            //- applies format_state to the stream
                      _Boost::io::detail::locale_t * loc_default = 0) const;
        template<class T> 
        ...
        _Boost::optional<_Boost::io::detail::locale_t>  loc_;
    };  
...
// -   stream_format_state:: -------------------------------------------------
    ...
    void stream_format_state<Ch,Tr>:: apply_on (basic_ios & os,
                      _Boost::io::detail::locale_t * loc_default) const {
