...
public:
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        _Boost::sp_scalar_constructor_hook( px, sizeof(X), this );
#endif
    }
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        _Boost::sp_scalar_destructor_hook( px_, sizeof(X), this );
#endif
        _Boost::checked_delete( px_ );
    }
...
public:
    ...
    {
        return ti == BOOST_SP_TYPEID_(D)? _Boost::detail::get_local_deleter( _Boost::addressof( del ) ): 0;
    }
...
public:
    ...
    virtual void * get_local_deleter( sp_typeinfo_ const & ti ) BOOST_SP_NOEXCEPT
    {
        return ti == BOOST_SP_TYPEID_( D )? _Boost::detail::get_local_deleter( _Boost::addressof( d_ ) ): 0;
    }
