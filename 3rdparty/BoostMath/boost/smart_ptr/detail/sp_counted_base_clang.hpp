...
typedef _Atomic( _Boost::int_least32_t ) atomic_int_least32_t;
...
inline _Boost::int_least32_t atomic_decrement( atomic_int_least32_t * pw ) BOOST_SP_NOEXCEPT
{
    return __c11_atomic_fetch_sub( pw, 1, __ATOMIC_ACQ_REL );
}

inline _Boost::int_least32_t atomic_conditional_increment( atomic_int_least32_t * pw ) BOOST_SP_NOEXCEPT
{
    // long r = *pw;
    // if( r != 0 ) ++*pw;
    // return r;

    _Boost::int_least32_t r = __c11_atomic_load( pw, __ATOMIC_RELAXED );
