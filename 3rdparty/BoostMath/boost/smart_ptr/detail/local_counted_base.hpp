...
public:
    ...
    virtual _Boost::detail::shared_count local_cb_get_shared_count() const BOOST_SP_NOEXCEPT = 0;
...
public:
    ...
    virtual _Boost::detail::shared_count local_cb_get_shared_count() const BOOST_SP_NOEXCEPT
    {
        return pn_;
    }
};
