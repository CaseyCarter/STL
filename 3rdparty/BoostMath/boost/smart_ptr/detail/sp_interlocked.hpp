...
# define BOOST_SP_INTERLOCKED_INCREMENT ::_Boost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::_Boost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::_Boost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::_Boost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::_Boost::detail::InterlockedExchangeAdd
