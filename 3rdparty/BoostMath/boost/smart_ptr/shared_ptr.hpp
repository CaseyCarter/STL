...
template< class X, class Y, class T > inline void sp_enable_shared_from_this( _Boost::shared_ptr<X> const * ppx, Y const * py, _Boost::enable_shared_from_this< T > const * pe )
{
    if( pe != 0 )
    {
...
template< class X, class Y > inline void sp_enable_shared_from_this( _Boost::shared_ptr<X> * ppx, Y const * py, _Boost::enable_shared_from_raw const * pe );
...
template< class T, class Y > inline void sp_pointer_construct( _Boost::shared_ptr< T > * ppx, Y * p, _Boost::detail::shared_count & pn )
{
    _Boost::detail::shared_count( p ).swap( pn );
    _Boost::detail::sp_enable_shared_from_this( ppx, p, p );
}
...
template< class T, class Y > inline void sp_pointer_construct( _Boost::shared_ptr< T[] > * /*ppx*/, Y * p, _Boost::detail::shared_count & pn )
{
    ...
    _Boost::detail::shared_count( p, _Boost::checked_array_deleter< T >() ).swap( pn );
}

template< class T, std::size_t N, class Y > inline void sp_pointer_construct( _Boost::shared_ptr< T[N] > * /*ppx*/, Y * p, _Boost::detail::shared_count & pn )
{
...
template< class T, class Y > inline void sp_deleter_construct( _Boost::shared_ptr< T > * ppx, Y * p )
{
    _Boost::detail::sp_enable_shared_from_this( ppx, p, p );
}
...
template< class T, std::size_t N, class Y > inline void sp_deleter_construct( _Boost::shared_ptr< T[N] > * /*ppx*/, Y * /*p*/ )
{
    sp_assert_convertible< Y[N], T[N] >();
}
...
public:
    ...
    typedef typename _Boost::detail::sp_element< T >::type element_type;
    ...
    BOOST_CONSTEXPR shared_ptr( _Boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT : px( 0 ), pn()
    {
    }

#endif

    BOOST_CONSTEXPR shared_ptr( _Boost::detail::sp_internal_constructor_tag, element_type * px_, _Boost::detail::shared_count const & pn_ ) BOOST_SP_NOEXCEPT : px( px_ ), pn( pn_ )
    {
    }

#if !defined( BOOST_NO_CXX11_RVALUE_REFERENCES )

    BOOST_CONSTEXPR shared_ptr( _Boost::detail::sp_internal_constructor_tag, element_type * px_, _Boost::detail::shared_count && pn_ ) BOOST_SP_NOEXCEPT : px( px_ ), pn( std::move( pn_ ) )
    {
    }
    ...
    {
        _Boost::detail::sp_pointer_construct( this, p, pn );
    }
    ...
    {
        _Boost::detail::sp_deleter_construct( this, p );
    }

#if !defined( BOOST_NO_CXX11_NULLPTR )

    template<class D> shared_ptr( _Boost::detail::sp_nullptr_t p, D d ): px( p ), pn( p, d )
    {
    }
    ...
    template<class D, class A> shared_ptr( _Boost::detail::sp_nullptr_t p, D d, A a ): px( p ), pn( p, d, a )
    {
    }
...
// ... except in C++0x, move disables the implicit copy
    ...
    {
        _Boost::detail::sp_assert_convertible< Y, T >();
    ...
    template<class Y>
    shared_ptr( weak_ptr<Y> const & r, _Boost::detail::sp_nothrow_tag )
    BOOST_SP_NOEXCEPT : px( 0 ), pn( r.pn, _Boost::detail::sp_nothrow_tag() )
    {
        if( !pn.empty() )
        {
            px = r.px;
    ...
    shared_ptr( shared_ptr<Y> const & r, typename _Boost::detail::sp_enable_if_convertible<Y,T>::type = _Boost::detail::sp_empty() )
    ...
    explicit shared_ptr( std::auto_ptr<Y> & r ): px(r.get()), pn()
    {
        ...
        Y * tmp = r.get();
        pn = _Boost::detail::shared_count( r );

        _Boost::detail::sp_deleter_construct( this, tmp );
    }
    ...
    template<class Ap>
    explicit shared_ptr( Ap r, typename _Boost::detail::sp_enable_if_auto_ptr<Ap, int>::type = 0 ): px( r.get() ), pn()
    {
    ...
    template< class Y, class D >
    shared_ptr( _Boost::movelib::unique_ptr< Y, D > r ): px( r.get() ), pn()
    {
        _Boost::detail::sp_assert_convertible< Y, T >();

        typename _Boost::movelib::unique_ptr< Y, D >::pointer tmp = r.get();
    ...
    template<class Ap>
    typename _Boost::detail::sp_enable_if_auto_ptr< Ap, shared_ptr & >::type operator=( Ap r )
    {
        this_type( r ).swap( *this );
        return *this;
    }
    ...
    template<class Y, class D>
    shared_ptr & operator=( _Boost::movelib::unique_ptr<Y, D> r )
    {
        // this_type( static_cast< unique_ptr<Y, D> && >( r ) ).swap( *this );

        _Boost::detail::sp_assert_convertible< Y, T >();

        typename _Boost::movelib::unique_ptr< Y, D >::pointer p = r.get();
        ...
        {
            tmp.px = p;
            tmp.pn = _Boost::detail::shared_count( r );

            _Boost::detail::sp_deleter_construct( &tmp, p );
        }
...
// Move support
    ...
    shared_ptr( shared_ptr<Y> && r, typename _Boost::detail::sp_enable_if_convertible<Y,T>::type = _Boost::detail::sp_empty() )
    ...
    shared_ptr & operator=( _Boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT
    {
        this_type().swap(*this);
        return *this;
    }
    ...
    typename _Boost::detail::sp_dereference< T >::type operator* () const BOOST_SP_NOEXCEPT_WITH_ASSERT
    {
        BOOST_ASSERT( px != 0 );
        return *px;
    }
    
    typename _Boost::detail::sp_member_access< T >::type operator-> () const BOOST_SP_NOEXCEPT_WITH_ASSERT
    {
        BOOST_ASSERT( px != 0 );
        return px;
    }
    
    typename _Boost::detail::sp_array_access< T >::type operator[] ( std::ptrdiff_t i ) const BOOST_SP_NOEXCEPT_WITH_ASSERT
    {
        BOOST_ASSERT( px != 0 );
        BOOST_ASSERT( i >= 0 && ( i < _Boost::detail::sp_extent< T >::value || _Boost::detail::sp_extent< T >::value == 0 ) );

        return static_cast< typename _Boost::detail::sp_array_access< T >::type >( px[ i ] );
    }
...
#include <boost/smart_ptr/detail/operator_bool.hpp>
    ...
    void * _internal_get_deleter( _Boost::detail::sp_typeinfo_ const & ti ) const BOOST_SP_NOEXCEPT
    {
        return pn.get_deleter( ti );
    }

    void * _internal_get_local_deleter( _Boost::detail::sp_typeinfo_ const & ti ) const BOOST_SP_NOEXCEPT
    {
    ...
    _Boost::detail::shared_count _internal_count() const BOOST_SP_NOEXCEPT
    {
        return pn;
    }
...
private:
    ...
    _Boost::detail::shared_count pn;    // reference counter
...
template<class T> inline bool operator==( shared_ptr<T> const & p, _Boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( _Boost::detail::sp_nullptr_t, shared_ptr<T> const & p ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}
...
// get_pointer() enables _Boost::mem_fn to recognize shared_ptr
...
public:
    ...
    {
        return _Boost::detail::basic_get_deleter<D>( deleter_ );
    }
...
{
    D * d = _Boost::detail::basic_get_deleter<D>( p );

    if( d == 0 )
    {
        d = _Boost::detail::basic_get_local_deleter( d, p );
    }

    if( d == 0 )
    {
        _Boost::detail::esft2_deleter_wrapper *del_wrapper = _Boost::detail::basic_get_deleter<_Boost::detail::esft2_deleter_wrapper>(p);
// The following get_deleter method call is fully qualified because
// older versions of gcc (2.95, 3.2.3) fail to compile it when written del_wrapper->get_deleter<D>()
        if(del_wrapper) d = del_wrapper->::_Boost::detail::esft2_deleter_wrapper::get_deleter<D>();
    }
...
{
    _Boost::detail::spinlock_pool<2>::scoped_lock lock( p );
    return *p;
}
...
{
    _Boost::detail::spinlock & sp = _Boost::detail::spinlock_pool<2>::spinlock_for( p );
...
template< class T > std::size_t hash_value( _Boost::shared_ptr<T> const & p ) BOOST_SP_NOEXCEPT
{
    return _Boost::hash< typename _Boost::shared_ptr<T>::element_type* >()( p.get() );
}
