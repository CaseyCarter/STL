...
{
    typedef _Boost::detail::atomic_count type;

    static unsigned int load(_Boost::detail::atomic_count const& counter) BOOST_SP_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(_Boost::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(_Boost::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
