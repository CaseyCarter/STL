...
//
    ...
    weak_ptr( weak_ptr<Y> const & r, typename _Boost::detail::sp_enable_if_convertible<Y,T>::type = _Boost::detail::sp_empty() )
    ...
    weak_ptr( weak_ptr<Y> && r, typename _Boost::detail::sp_enable_if_convertible<Y,T>::type = _Boost::detail::sp_empty() )
...
#endif
    BOOST_SP_NOEXCEPT : px( r.lock().get() ), pn( static_cast< _Boost::detail::weak_count && >( r.pn ) )
    {
        _Boost::detail::sp_assert_convertible< Y, T >();
        r.px = 0;
    }
    ...
    weak_ptr( weak_ptr && r )
    BOOST_SP_NOEXCEPT : px( r.px ), pn( static_cast< _Boost::detail::weak_count && >( r.pn ) )
    {
        r.px = 0;
    }
    ...
    weak_ptr( shared_ptr<Y> const & r, typename _Boost::detail::sp_enable_if_convertible<Y,T>::type = _Boost::detail::sp_empty() )
    ...
    {
        return shared_ptr<T>( *this, _Boost::detail::sp_nothrow_tag() );
    }
...
private:
    ...
    _Boost::detail::weak_count pn; // reference counter
