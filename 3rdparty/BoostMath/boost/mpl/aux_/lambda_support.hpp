...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::_Boost::mpl::aux::yes_tag operator|( \
      ::_Boost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::_Boost::mpl::aux::no_tag operator|( \
      ::_Boost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::_Boost::mpl::na) >* \
    ); \
/**/
...
::_Boost::mpl::aux::yes_tag operator|( \
      ::_Boost::mpl::aux::has_rebind_tag<int> \
    , ::_Boost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
