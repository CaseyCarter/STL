...
#include <boost/operators.hpp>   // for _Boost::addable etc
#include <cstdlib>               // for std::abs
#include <boost/call_traits.hpp> // for _Boost::call_traits
#include <boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <boost/assert.hpp>      // for BOOST_ASSERT
#include <boost/integer/common_factor_rt.hpp> // for _Boost::integer::gcd, lcm
...
class rational
{
    ...
    // Helper types
    typedef typename _Boost::call_traits<IntType>::param_type param_type;
...
public:
    ...
    template <class T>
    BOOST_CXX14_CONSTEXPR typename _Boost::enable_if_c<rational_detail::is_compatible_integer<T, IntType>::value, rational&>::type operator+= (const T& i)
    {
       num += i * den;
       return *this;
    }
...
#pragma parse_mfunc_templ reset
    ...
    template <class T>
    BOOST_CXX14_CONSTEXPR typename _Boost::enable_if_c<rational_detail::is_compatible_integer<T, IntType>::value, bool>::type operator< (const T& i) const
    {
       // Avoid repeated construction
    ...
    template <class T>
    BOOST_CONSTEXPR typename _Boost::enable_if_c<rational_detail::is_compatible_integer<T, IntType>::value, bool>::type operator== (const T& i) const
    {
...
private:
    ...
    //
    template <class T>
    BOOST_CONSTEXPR static typename _Boost::enable_if_c<(std::numeric_limits<T>::digits > std::numeric_limits<IntType>::digits) && (std::numeric_limits<T>::is_signed == false), bool>::type is_safe_narrowing_conversion(const T& val)
    {
    ...
    //
    template <class T>
    BOOST_CONSTEXPR static typename _Boost::enable_if_c<(std::numeric_limits<T>::digits > std::numeric_limits<IntType>::digits) && (std::numeric_limits<T>::is_signed == true) && (std::numeric_limits<IntType>::is_signed == true), bool>::type is_safe_narrowing_conversion(const T& val)
    {
    ...
    //
    template <class T>
    BOOST_CONSTEXPR static typename _Boost::enable_if_c<(std::numeric_limits<T>::digits > std::numeric_limits<IntType>::digits) && (std::numeric_limits<T>::is_signed == true) && (std::numeric_limits<IntType>::is_signed == false), bool>::type is_safe_narrowing_conversion(const T& val)
    {
    ...
    //
    template <class T>
    BOOST_CONSTEXPR static typename _Boost::enable_if_c<(std::numeric_limits<T>::digits <= std::numeric_limits<IntType>::digits) && (std::numeric_limits<T>::is_signed == false) && (std::numeric_limits<IntType>::is_signed == true), bool>::type is_safe_narrowing_conversion(const T&)
    {
       return true;
    }
    //
    ...
    //
    template <class T>
    BOOST_CONSTEXPR static typename _Boost::enable_if_c<(std::numeric_limits<T>::digits <= std::numeric_limits<IntType>::digits) && (std::numeric_limits<T>::is_signed == false) && (std::numeric_limits<IntType>::is_signed == false), bool>::type is_safe_narrowing_conversion(const T&)
    {
       return true;
    }
    //
    ...
    //
    template <class T>
    BOOST_CONSTEXPR static typename _Boost::enable_if_c<(std::numeric_limits<T>::digits <= std::numeric_limits<IntType>::digits) && (std::numeric_limits<T>::is_signed == true) && (std::numeric_limits<IntType>::is_signed == true), bool>::type is_safe_narrowing_conversion(const T&)
    {
       return true;
    }
};
