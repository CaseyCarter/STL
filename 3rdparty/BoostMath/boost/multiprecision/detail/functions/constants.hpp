...
const T& get_constant_ln2()
{
   ...
   {
#endif
      calc_log2(result, _Boost::multiprecision::detail::digits2<number<T, et_on> >::value());
...
const T& get_constant_e()
{
   ...
   {
#endif
      calc_e(result, _Boost::multiprecision::detail::digits2<number<T, et_on> >::value());
      digits = _Boost::multiprecision::detail::digits2<number<T> >::value();
   }
...
const T& get_constant_pi()
{
   ...
   {
#endif
      calc_pi(result, _Boost::multiprecision::detail::digits2<number<T, et_on> >::value());
      digits = _Boost::multiprecision::detail::digits2<number<T> >::value();
   }
