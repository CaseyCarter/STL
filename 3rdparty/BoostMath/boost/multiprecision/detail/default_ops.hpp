...
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::disable_if_c<_Boost::is_same<T, U>::value, T>::type make_T(const U& u)
{
   T t;
   t = number<T>::canonical_value(u);
   return t;
...
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_integral<R>::value, bool>::type check_in_range(const T& t)
{
   // Can t fit in an R?
...
template <class R, class B>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_integral<R>::value>::type eval_convert_to(R* result, const B& backend)
{
   typedef typename calculate_next_larger_type<R, B>::type next_type;
   next_type                                               n = next_type();
   eval_convert_to(&n, backend);
   if (!_Boost::is_unsigned<R>::value && std::numeric_limits<R>::is_specialized && std::numeric_limits<R>::is_bounded && (n > (next_type)(std::numeric_limits<R>::max)()))
   {
...
template <class R, class B>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::disable_if_c<_Boost::is_integral<R>::value>::type eval_convert_to(R* result, const B& backend)
{
   typedef typename calculate_next_larger_type<R, B>::type next_type;
   next_type                                               n = next_type();
   eval_convert_to(&n, backend);
...
inline void last_chance_eval_convert_to(terminal<R>* result, const B& backend, const mpl::false_&)
{
   ...
   try
   {
      result->value = _Boost::lexical_cast<R>(backend.str(0, std::ios_base::fmtflags(0)));
   }
...
inline void last_chance_eval_convert_to(terminal<R>* result, const B& backend, const mpl::true_&)
{
   ...
   try
   {
      ...
      result->value = _Boost::lexical_cast<R>(t.str(0, std::ios_base::fmtflags(0)));
   }
   catch (const bad_lexical_cast&)
   {
      if (eval_get_sign(backend) < 0)
...
{
   typedef mpl::bool_<_Boost::is_unsigned<R>::value && number_category<B>::value == number_kind_integer> tag_type;
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_convert_to(terminal<number<B1, et> >* result, const B2& backend)
{
   ...
   //
   _Boost::multiprecision::detail::generic_interconvert(result->value.backend(), backend, number_category<B1>(), number_category<B2>());
}
...
{
   typedef typename _Boost::multiprecision::detail::canonical<A, T>::type          canonical_type;
...
{
   typedef typename _Boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_arithmetic<A>::value>::type eval_fdim(T& result, const T& a, const A& b)
{
   typedef typename _Boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
   typedef typename _Boost::multiprecision::detail::canonical<A, T>::type        arithmetic_type;
   const ui_type                                                                zero        = 0u;
   arithmetic_type                                                              canonical_b = b;
   switch ((::_Boost::math::fpclassify)(b))
   {
   case FP_NAN:
   case FP_INFINITE:
      result = zero;
...
template <class T, class A>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_arithmetic<A>::value>::type eval_fdim(T& result, const A& a, const T& b)
{
   typedef typename _Boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
   typedef typename _Boost::multiprecision::detail::canonical<A, T>::type        arithmetic_type;
   const ui_type                                                                zero        = 0u;
   ...
   switch ((::_Boost::math::fpclassify)(a))
   {
   case FP_NAN:
      result = zero;
      return;
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_round(T& result, const T& a)
{
   ...
   typedef typename _Boost::multiprecision::detail::canonical<float, T>::type fp_type;
...
{
   typedef typename _Boost::multiprecision::detail::canonical<Arithmetic, T>::type si_type;
...
void BOOST_MP_CXX14_CONSTEXPR eval_integer_sqrt(B& s, B& r, const B& x)
{
   ...
   // at some point.
   //
   typedef typename _Boost::multiprecision::detail::canonical<unsigned char, B>::type ui_type;
...
inline BOOST_MP_CXX14_CONSTEXPR void eval_logb(B& result, const B& val)
{
   ...
   typedef typename _Boost::mpl::if_c<_Boost::is_same<_Boost::intmax_t, long>::value, _Boost::long_long_type, _Boost::intmax_t>::type max_t;
...
{
   return is_arg_nan(val, mpl::bool_<_Boost::multiprecision::detail::is_backend<T>::value>(), is_floating_point<T>());
}
...
{
   return (_Boost::multiprecision::signbit)(a) != (_Boost::multiprecision::signbit)(b) ? (_Boost::multiprecision::changesign)(a) : a;
}
...
real(const multiprecision::number<Backend, ExpressionTemplates>& a)
{
   ...
   _Boost::multiprecision::detail::scoped_default_precision<result_type>                                              precision_guard(a);
   result_type                                                                                                       result;
...
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::lazy_enable_if_c<number_category<T>::value == number_kind_complex, component_type<number<T, ExpressionTemplates> > >::type
abs(const number<T, ExpressionTemplates>& v)
{
   return BOOST_MP_MOVE(_Boost::math::hypot(real(v), imag(v)));
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::lazy_enable_if_c<number_category<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_complex, component_type<typename detail::expression<tag, A1, A2, A3, A4>::result_type> >::type
...
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<number_category<T>::value != number_kind_complex, typename scalar_result_from_possible_complex<number<T, ExpressionTemplates> >::type>::type
norm(const number<T, ExpressionTemplates>& v)
{
   return v * v;
}
...
BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<_Boost::is_same<typename detail::expression<tag, A1, A2, A3, A4>::result_type, number<Backend, ExpressionTemplates> >::value,
...
template <class tag, class A1, class A2, class A3, class A4, class tagb, class A1b, class A2b, class A3b, class A4b>
BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<_Boost::is_same<typename detail::expression<tag, A1, A2, A3, A4>::result_type, typename detail::expression<tagb, A1b, A2b, A3b, A4b>::result_type>::value,
...
BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_arithmetic<Scalar>::value, typename complex_result_from_scalar<number<Backend, ExpressionTemplates> >::type>::type
...
BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<_Boost::is_arithmetic<Scalar>::value,
                     typename complex_result_from_scalar<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::type>::type
...
//
using _Boost::multiprecision::changesign;
...
using _Boost::multiprecision::sign;
...
typedef ::_Boost::math::policies::policy<
    ::_Boost::math::policies::domain_error< ::_Boost::math::policies::errno_on_error>,
    ::_Boost::math::policies::pole_error< ::_Boost::math::policies::errno_on_error>,
    ::_Boost::math::policies::overflow_error< ::_Boost::math::policies::errno_on_error>,
    ::_Boost::math::policies::evaluation_error< ::_Boost::math::policies::errno_on_error>,
    ::_Boost::math::policies::rounding_error< ::_Boost::math::policies::errno_on_error> >
    c99_error_policy;

template <class Backend, multiprecision::expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<number_category<Backend>::value != number_kind_complex, multiprecision::number<Backend, ExpressionTemplates> >::type
    asinh
    BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   ...
   return _Boost::math::asinh(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value != number_kind_complex, typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::type
    asinh
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return _Boost::math::acosh(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value != number_kind_complex, typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::type
    acosh
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return _Boost::math::atanh(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<number_category<typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::value != number_kind_complex, typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type>::type
    atanh
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return _Boost::math::cbrt(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return _Boost::math::erf(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return _Boost::math::erfc(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return _Boost::math::expm1(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR multiprecision::number<Backend, ExpressionTemplates> lgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   ...
   result = _Boost::math::lgamma(arg, c99_error_policy());
   if ((_Boost::multiprecision::isnan)(result) && !(_Boost::multiprecision::isnan)(arg))
   {
...
inline BOOST_MP_CXX14_CONSTEXPR multiprecision::number<Backend, ExpressionTemplates> tgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   ...
   return _Boost::math::tgamma(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
template <class Backend, multiprecision::expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type llrint BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   return llround(arg);
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type llrint BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::detail::expression<tag, A1, A2, A3, A4>& arg)
{
   return llround(arg);
}
#endif
...
{
   detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(arg);
   return _Boost::math::log1p(arg, c99_error_policy());
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR multiprecision::number<Backend, ExpressionTemplates> nextafter BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& a, const multiprecision::number<Backend, ExpressionTemplates>& b)
{
   ...
   return _Boost::math::nextafter(a, b, c99_error_policy());
}
template <class Backend, multiprecision::expression_template_option ExpressionTemplates, class tag, class A1, class A2, class A3, class A4>
...
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::itrunc<%1%>(%1%)", 0, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return itrunc(v, _Boost::math::policies::policy<>());
}
template <class Backend, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int itrunc(const number<Backend, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::itrunc<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
template <class Backend, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type                                                           r(trunc(v, pol));
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::ltrunc<%1%>(%1%)", 0, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return ltrunc(v, _Boost::math::policies::policy<>());
}
...
inline BOOST_MP_CXX14_CONSTEXPR long ltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::ltrunc<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
#ifndef BOOST_NO_LONG_LONG
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type                                                           r(trunc(v, pol));
   if ((r > (std::numeric_limits<_Boost::long_long_type>::max)()) || r < (std::numeric_limits<_Boost::long_long_type>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::lltrunc<%1%>(%1%)", 0, number_type(v), 0LL, pol);
   return r.template convert_to<_Boost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return lltrunc(v, _Boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type lltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(trunc(v, pol));
   if ((r > (std::numeric_limits<_Boost::long_long_type>::max)()) || r < (std::numeric_limits<_Boost::long_long_type>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::lltrunc<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<_Boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type lltrunc(const number<T, ExpressionTemplates>& v)
{
   return lltrunc(v, _Boost::math::policies::policy<>());
}
#endif
...
inline BOOST_MP_CXX14_CONSTEXPR int iround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR int iround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return iround(v, _Boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR int iround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if ((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::iround<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline BOOST_MP_CXX14_CONSTEXPR long lround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   number_type                                                           r(round(v, pol));
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::lround<%1%>(%1%)", 0, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR long lround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return lround(v, _Boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR long lround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(round(v, pol));
   if ((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::lround<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
#ifndef BOOST_NO_LONG_LONG
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type llround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type                                                           r(round(v, pol));
   if ((r > (std::numeric_limits<_Boost::long_long_type>::max)()) || r < (std::numeric_limits<_Boost::long_long_type>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0LL, pol);
   return r.template convert_to<_Boost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type llround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return llround(v, _Boost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type llround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r(round(v, pol));
   if ((r > (std::numeric_limits<_Boost::long_long_type>::max)()) || r < (std::numeric_limits<_Boost::long_long_type>::min)() || !(_Boost::math::isfinite)(v))
      return _Boost::math::policies::raise_rounding_error("_Boost::multiprecision::iround<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<_Boost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR _Boost::long_long_type llround(const number<T, ExpressionTemplates>& v)
{
   return llround(v, _Boost::math::policies::policy<>());
}
#endif
...
template <class T, expression_template_option ExpressionTemplates>
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<number_category<T>::value == number_kind_floating_point, number<T, ExpressionTemplates> >::type frexp(const number<T, ExpressionTemplates>& v, _Boost::long_long_type* pint)
{
   using default_ops::eval_frexp;
   detail::scoped_default_precision<multiprecision::number<T, ExpressionTemplates> > precision_guard(v);
   number<T, ExpressionTemplates>                                                    result;
...
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<number_category<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_floating_point, typename detail::expression<tag, A1, A2, A3, A4>::result_type>::type
frexp(const detail::expression<tag, A1, A2, A3, A4>& v, _Boost::long_long_type* pint)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   return BOOST_MP_MOVE(frexp(static_cast<number_type>(v), pint));
}
...
#define BINARY_OP_FUNCTOR_CXX11_RVALUE(func, category)\
   ...
   inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<(number_category<Backend>::value == category) && (_Boost::is_convertible<typename detail::expression<tag, A1, A2, A3, A4>::result_type, number<Backend, et_on> >::value),                           \
...
#define UNARY_OP_FUNCTOR(func, category)                                                                                                                                                                  \
   ...
   template <class Backend>                                                                                                                                                                               \
   inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<                                                                                                                                                                    \
       _Boost::multiprecision::number_category<Backend>::value == category,                                                                                                                                \
       number<Backend, et_off> >::type                                                                                                                                                                    \
...
template <class tag, class A1, class A2, class A3, class A4>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::disable_if_c<number_category<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_complex,
                                    detail::expression<
...
HETERO_BINARY_OP_FUNCTOR_B(ldexp, _Boost::long_long_type, number_kind_floating_point)
//HETERO_BINARY_OP_FUNCTOR_B(frexp, _Boost::long_long_type*, number_kind_floating_point)
...
HETERO_BINARY_OP_FUNCTOR_B(scalbn, _Boost::long_long_type, number_kind_floating_point)
HETERO_BINARY_OP_FUNCTOR_B(scalbln, _Boost::long_long_type, number_kind_floating_point)
...
{
   _Boost::multiprecision::detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
...
{
   _Boost::multiprecision::detail::scoped_default_precision<multiprecision::number<Backend, ExpressionTemplates> > precision_guard(x);
   return BOOST_MP_MOVE(_Boost::math::sinhc_pi(x));
}

using _Boost::multiprecision::gcd;
using _Boost::multiprecision::lcm;
