...
BOOST_FORCEINLINE unsigned find_lsb(_Boost::ulong_long_type mask, mpl::int_<3> const&)
{
...
BOOST_FORCEINLINE unsigned find_msb(_Boost::ulong_long_type mask, mpl::int_<3> const&)
{
   return sizeof(_Boost::ulong_long_type) * CHAR_BIT - 1 - __builtin_clzll(mask);
}
...
BOOST_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR unsigned find_lsb(Unsigned mask)
{
   ...
   typedef typename mpl::if_c<
       ...
       typename mpl::if_c<
           ...
           mpl::int_<2>,
           typename mpl::if_c<
               sizeof(Unsigned) <= sizeof(_Boost::ulong_long_type),
               mpl::int_<3>,
