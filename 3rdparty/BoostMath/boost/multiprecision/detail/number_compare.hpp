...
{
   typename _Boost::multiprecision::detail::number_from_backend<T, U>::type t(b);
   return eval_eq(a, t.backend());
}
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR bool eval_eq_imp(const T& a, const U& b, const mpl::false_&)
{
   typename _Boost::multiprecision::detail::number_from_backend<U, T>::type t(a);
   return eval_eq(t.backend(), b);
}
template <class T, class U>
inline BOOST_MP_CXX14_CONSTEXPR bool eval_eq(const T& a, const U& b)
{
   typedef mpl::bool_<_Boost::multiprecision::detail::is_first_backend<T, U>::value> tag_type;
...
inline BOOST_CONSTEXPR typename _Boost::enable_if_c<number_category<Backend>::value != number_kind_floating_point, bool>::type is_unordered_value(const number<Backend, ExpressionTemplates>&)
{
   return false;
}
template <class Backend, expression_template_option ExpressionTemplates>
inline
    ...
    BOOST_CONSTEXPR
#endif
    typename _Boost::enable_if_c<number_category<Backend>::value == number_kind_floating_point, bool>::type
...
inline BOOST_CONSTEXPR typename _Boost::enable_if_c<number_category<Arithmetic>::value != number_kind_floating_point, bool>::type is_unordered_value(const Arithmetic&)
{
   return false;
}
template <class Arithmetic>
...
#endif
   typename _Boost::enable_if_c < number_category < Arithmetic> ::value == number_kind_floating_point, bool> ::type
...
template <class Backend, expression_template_option ExpressionTemplates, class Backend2, expression_template_option ExpressionTemplates2>
inline BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<(number_category<Backend>::value != number_kind_complex) && (number_category<Backend2>::value != number_kind_complex), bool>::type
