...
namespace _Boost { namespace multiprecision { namespace detail {

template <class B, _Boost::multiprecision::expression_template_option ET>
inline BOOST_CONSTEXPR unsigned current_precision_of_last_chance_imp(const _Boost::multiprecision::number<B, ET>&, const mpl::false_&)
{
   return std::numeric_limits<_Boost::multiprecision::number<B, ET> >::digits10;
}
template <class B, _Boost::multiprecision::expression_template_option ET>
inline BOOST_MP_CXX14_CONSTEXPR unsigned current_precision_of_last_chance_imp(const _Boost::multiprecision::number<B, ET>& val, const mpl::true_&)
{
   //
...
template <class B, _Boost::multiprecision::expression_template_option ET>
inline BOOST_MP_CXX14_CONSTEXPR unsigned current_precision_of_imp(const _Boost::multiprecision::number<B, ET>& n, const mpl::true_&)
{
   return n.precision();
}
template <class B, _Boost::multiprecision::expression_template_option ET>
inline BOOST_CONSTEXPR unsigned current_precision_of_imp(const _Boost::multiprecision::number<B, ET>& val, const mpl::false_&)
{
   return current_precision_of_last_chance_imp(val,
                                               mpl::bool_ <
                                                       std::numeric_limits<_Boost::multiprecision::number<B, ET> >::is_specialized &&
                                                   std::numeric_limits<_Boost::multiprecision::number<B, ET> >::is_integer && std::numeric_limits<_Boost::multiprecision::number<B, ET> >::is_exact && !std::numeric_limits<_Boost::multiprecision::number<B, ET> >::is_modulo > ());
}
...
template <class B, _Boost::multiprecision::expression_template_option ET>
inline BOOST_CONSTEXPR unsigned current_precision_of(const _Boost::multiprecision::number<B, ET>& n)
{
   return current_precision_of_imp(n, _Boost::multiprecision::detail::is_variable_precision<_Boost::multiprecision::number<B, ET> >());
}
...
template <class R, bool = _Boost::multiprecision::detail::is_variable_precision<R>::value>
...
{
   maybe_promote_precision(obj, mpl::bool_<_Boost::multiprecision::detail::is_variable_precision<T>::value>());
}

#ifndef BOOST_NO_CXX17_IF_CONSTEXPR
#define BOOST_MP_CONSTEXPR_IF_VARIABLE_PRECISION(T) \
   if                                               \
   constexpr(_Boost::multiprecision::detail::is_variable_precision<T>::value)
#else
#define BOOST_MP_CONSTEXPR_IF_VARIABLE_PRECISION(T) if (_Boost::multiprecision::detail::is_variable_precision<T>::value)
#endif

}
}
} // namespace _Boost::multiprecision::detail
