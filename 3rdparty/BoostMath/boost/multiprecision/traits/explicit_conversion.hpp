       ...
       typename _Boost::conditional<
           ...
           typename _Boost::conditional<
               ...
               typename _Boost::conditional<
                   ...
                   _Boost::true_type,
                   _Boost::false_type>::type>::type>::type,
...
struct is_explicitly_convertible_imp
{
   ...
   static type_traits::yes_type selector(dummy_size<sizeof(new T1(_Boost::declval<
   ...
   typedef _Boost::integral_constant<bool, value> type;
#else
   typedef typename has_generic_interconversion<S, T>::type                                      gen_type;
   typedef _Boost::integral_constant<bool, _Boost::is_convertible<S, T>::value || gen_type::value> type;
#endif
};
