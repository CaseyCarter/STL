...
struct gmp_float_imp
{
   ...
   gmp_float_imp& operator=(_Boost::ulong_long_type i)
   {
...
#endif
   gmp_float_imp& operator=(_Boost::long_long_type i)
   {
      if (m_data[0]._mp_d == 0)
         mpf_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
      bool neg = i < 0;
      *this    = static_cast<_Boost::ulong_long_type>(_Boost::multiprecision::detail::unsigned_abs(i));
      if (neg)
   ...
   gmp_float_imp& operator=(long double a)
   {
      ...
      BOOST_ASSERT(!(_Boost::math::isinf)(a));
      BOOST_ASSERT(!(_Boost::math::isnan)(a));
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f) const
   {
      ...
      _Boost::multiprecision::detail::format_float_string(result, e, org_digits, f, mpf_sgn(m_data) == 0);
      return result;
   }
   ~gmp_float_imp() BOOST_NOEXCEPT
   {
 ...
 protected:
   ...
   {
      static _Boost::multiprecision::detail::precision_type val(50);
      return val;
   }
};
...
inline void eval_add(gmp_float<digits10>& result, long i)
{
   if (i > 0)
      ...
      mpf_sub_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
template <unsigned digits10>
inline void eval_subtract(gmp_float<digits10>& result, long i)
{
   if (i > 0)
      ...
      mpf_add_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
template <unsigned digits10>
inline void eval_multiply(gmp_float<digits10>& result, long i)
{
   mpf_mul_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
...
inline void eval_divide(gmp_float<digits10>& result, long i)
{
   if (i == 0)
      BOOST_THROW_EXCEPTION(std::overflow_error("Division by zero."));
   mpf_div_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpf_neg(result.data(), result.data());
}
//
...
{
   if (y < 0)
      mpf_sub_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
   else
      mpf_add_ui(a.data(), x.data(), y);
}
template <unsigned D1, unsigned D2>
...
inline void eval_add(gmp_float<D1>& a, long x, const gmp_float<D2>& y)
{
   if (x < 0)
   {
      mpf_ui_sub(a.data(), _Boost::multiprecision::detail::unsigned_abs(x), y.data());
...
{
   if (y < 0)
      mpf_add_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
   else
      mpf_sub_ui(a.data(), x.data(), y);
}
template <unsigned D1, unsigned D2>
...
inline void eval_subtract(gmp_float<D1>& a, long x, const gmp_float<D2>& y)
{
   if (x < 0)
   {
      mpf_add_ui(a.data(), y.data(), _Boost::multiprecision::detail::unsigned_abs(x));
      mpf_neg(a.data(), a.data());
   }
   else
      mpf_ui_sub(a.data(), x, y.data());
...
inline void eval_multiply(gmp_float<D1>& a, const gmp_float<D2>& x, long y)
{
   if (y < 0)
   {
      mpf_mul_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
      a.negate();
   }
   else
      mpf_mul_ui(a.data(), x.data(), y);
...
inline void eval_multiply(gmp_float<D1>& a, long x, const gmp_float<D2>& y)
{
   if (x < 0)
   {
      mpf_mul_ui(a.data(), y.data(), _Boost::multiprecision::detail::unsigned_abs(x));
      mpf_neg(a.data(), a.data());
   }
   else
      mpf_mul_ui(a.data(), y.data(), x);
...
inline void eval_divide(gmp_float<D1>& a, const gmp_float<D2>& x, long y)
{
   ...
   if (y < 0)
   {
      mpf_div_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
      a.negate();
   }
   else
      mpf_div_ui(a.data(), x.data(), y);
...
inline void eval_divide(gmp_float<D1>& a, long x, const gmp_float<D2>& y)
{
   ...
   if (x < 0)
   {
      mpf_ui_div(a.data(), _Boost::multiprecision::detail::unsigned_abs(x), y.data());
      mpf_neg(a.data(), a.data());
   }
   else
      mpf_ui_div(a.data(), x, y.data());
...
#ifdef BOOST_HAS_LONG_LONG
template <unsigned digits10>
inline void eval_convert_to(_Boost::long_long_type* result, const gmp_float<digits10>& val)
{
   gmp_float<digits10> t(val);
   if (eval_get_sign(t) < 0)
      t.negate();

   long digits = std::numeric_limits<_Boost::long_long_type>::digits - std::numeric_limits<long>::digits;
   ...
   if (!mpf_fits_slong_p(t.data()))
   {
      if (eval_get_sign(val) < 0)
         *result = (std::numeric_limits<_Boost::long_long_type>::min)();
      else
         *result = (std::numeric_limits<_Boost::long_long_type>::max)();
      return;
   };
...
template <unsigned digits10>
inline void eval_convert_to(_Boost::ulong_long_type* result, const gmp_float<digits10>& val)
{
   gmp_float<digits10> t(val);
...
inline std::size_t hash_value(const gmp_float<Digits10>& val)
{
   ...
   for (int i = 0; i < std::abs(val.data()[0]._mp_size); ++i)
      _Boost::hash_combine(result, val.data()[0]._mp_d[i]);
   _Boost::hash_combine(result, val.data()[0]._mp_exp);
   _Boost::hash_combine(result, val.data()[0]._mp_size);
   return result;
}
...
#ifdef BOOST_HAS_LONG_LONG
#if defined(ULLONG_MAX) && (ULLONG_MAX == ULONG_MAX)
   gmp_int& operator=(_Boost::ulong_long_type i)
   {
      *this = static_cast<unsigned long>(i);
      return *this;
   }
...
#endif
   gmp_int& operator=(_Boost::long_long_type i)
   {
      if (m_data[0]._mp_d == 0)
         mpz_init(this->m_data);
      bool neg = i < 0;
...
inline void eval_add(gmp_int& t, long i)
{
   if (i > 0)
      ...
      mpz_sub_ui(t.data(), t.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_multiply_add(gmp_int& t, const gmp_int& a, long i)
{
   if (i > 0)
      ...
      mpz_submul_ui(t.data(), a.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_multiply_subtract(gmp_int& t, const gmp_int& a, long i)
{
   if (i > 0)
      ...
      mpz_addmul_ui(t.data(), a.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_subtract(gmp_int& t, long i)
{
   if (i > 0)
      ...
      mpz_add_ui(t.data(), t.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_multiply(gmp_int& t, long i)
{
   mpz_mul_ui(t.data(), t.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpz_neg(t.data(), t.data());
}
inline void eval_modulus(gmp_int& t, long i)
{
   mpz_tdiv_r_ui(t.data(), t.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_divide(gmp_int& t, long i)
{
   if (i == 0)
      BOOST_THROW_EXCEPTION(std::overflow_error("Division by zero."));
   mpz_tdiv_q_ui(t.data(), t.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpz_neg(t.data(), t.data());
}
template <class UI>
...
inline void eval_add(gmp_int& t, const gmp_int& p, long i)
{
   if (i > 0)
      ...
      mpz_sub_ui(t.data(), p.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_subtract(gmp_int& t, const gmp_int& p, long i)
{
   if (i > 0)
      ...
      mpz_add_ui(t.data(), p.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_multiply(gmp_int& t, const gmp_int& p, long i)
{
   mpz_mul_ui(t.data(), p.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpz_neg(t.data(), t.data());
}
inline void eval_modulus(gmp_int& t, const gmp_int& p, long i)
{
   mpz_tdiv_r_ui(t.data(), p.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
inline void eval_divide(gmp_int& t, const gmp_int& p, long i)
{
   if (i == 0)
      BOOST_THROW_EXCEPTION(std::overflow_error("Division by zero."));
   mpz_tdiv_q_ui(t.data(), p.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpz_neg(t.data(), t.data());
}
...
{
   mpz_gcd_ui(result.data(), a.data(), _Boost::multiprecision::detail::unsigned_abs(b));
}
template <class I>
...
{
   mpz_lcm_ui(result.data(), a.data(), _Boost::multiprecision::detail::unsigned_abs(b));
}
...
{
   return eval_integer_modulus(x, _Boost::multiprecision::detail::unsigned_abs(val));
}
...
struct gmp_rational
{
...
#ifdef BOOST_HAS_LONG_LONG
#if defined(ULLONG_MAX) && (ULLONG_MAX == ULONG_MAX)
   gmp_rational& operator=(_Boost::ulong_long_type i)
   {
      *this = static_cast<unsigned long>(i);
      return *this;
   }
   ...
   gmp_rational& operator=(_Boost::long_long_type i)
   {
      if (m_data[0]._mp_den._mp_d == 0)
         mpq_init(m_data);
      bool neg = i < 0;
...
inline typename enable_if_c<number_category<R>::value == number_kind_floating_point>::type eval_convert_to(R* result, const gmp_rational& backend)
{
   ...
   // This does:
   //
   ::_Boost::multiprecision::detail::generic_convert_rational_to_float(*result, backend);
}
...
inline std::size_t hash_value(const gmp_rational& val)
{
   ...
   for (int i = 0; i < std::abs(val.data()[0]._mp_num._mp_size); ++i)
      _Boost::hash_combine(result, val.data()[0]._mp_num._mp_d[i]);
   for (int i = 0; i < std::abs(val.data()[0]._mp_den._mp_size); ++i)
      _Boost::hash_combine(result, val.data()[0]._mp_den._mp_d[i]);
   _Boost::hash_combine(result, val.data()[0]._mp_num._mp_size);
   return result;
}
...
using _Boost::multiprecision::backends::gmp_float;
using _Boost::multiprecision::backends::gmp_int;
using _Boost::multiprecision::backends::gmp_rational;
...
template <>
inline int digits<_Boost::multiprecision::mpf_float>()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
   return multiprecision::detail::digits10_2_2(_Boost::multiprecision::mpf_float::default_precision());
}
template <>
inline int digits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, _Boost::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
...
template <>
inline _Boost::multiprecision::mpf_float
max_value<_Boost::multiprecision::mpf_float>()
{
   _Boost::multiprecision::mpf_float result(0.5);
...
template <>
inline _Boost::multiprecision::mpf_float
min_value<_Boost::multiprecision::mpf_float>()
{
   _Boost::multiprecision::mpf_float result(0.5);
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, _Boost::multiprecision::et_off>
max_value<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, _Boost::multiprecision::et_off> >()
{
   _Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, _Boost::multiprecision::et_off> result(0.5);
   mpf_mul_2exp(result.backend().data(), result.backend().data(), (std::numeric_limits<mp_exp_t>::max)() / 64 + 1);
   return result;
}
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, _Boost::multiprecision::et_off>
min_value<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, _Boost::multiprecision::et_off> >()
{
   _Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, _Boost::multiprecision::et_off> result(0.5);
...
template <>
inline int digits<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpf_float::backend_type> > >()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
   return multiprecision::detail::digits10_2_2(_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpf_float::backend_type> >::default_precision());
}
template <>
inline int digits<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::gmp_float<0> >, _Boost::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpf_float::backend_type> >
max_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpf_float::backend_type> > >()
{
   return max_value<_Boost::multiprecision::mpf_float>().backend();
}

template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpf_float::backend_type> >
min_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpf_float::backend_type> > >()
{
   return min_value<_Boost::multiprecision::mpf_float>().backend();
}

template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::gmp_float<0> >, _Boost::multiprecision::et_off>
max_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::gmp_float<0> >, _Boost::multiprecision::et_off> >()
{
   return max_value<_Boost::multiprecision::mpf_float>().backend();
}
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::gmp_float<0> >, _Boost::multiprecision::et_off>
min_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::gmp_float<0> >, _Boost::multiprecision::et_off> >()
{
   return min_value<_Boost::multiprecision::mpf_float>().backend();
}
...
//
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> number_type;
 ...
 private:
   struct data_initializer
   {
      data_initializer()
      {
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<digits10> > >::epsilon();
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<digits10> > >::round_error();
         (std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<digits10> > >::min)();
         (std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<digits10> > >::max)();
      }
...
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
const typename numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::data_initializer numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::initializer;

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::digits;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::radix;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::traps;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<Digits10>, ExpressionTemplates> >::round_style;

#endif

template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> number_type;
...
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::digits;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_signed;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_integer;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_exact;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::radix;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::min_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::min_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::max_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_infinity;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_quiet_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_signaling_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_denorm;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::has_denorm_loss;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_iec559;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_bounded;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::is_modulo;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::traps;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::tinyness_before;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_float<0>, ExpressionTemplates> >::round_style;

#endif

template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> number_type;
...
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::digits;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::max_digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::is_signed;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::is_integer;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::is_exact;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::radix;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::min_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::min_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::max_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::max_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::has_infinity;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::has_quiet_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::has_signaling_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::has_denorm;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::has_denorm_loss;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::is_iec559;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::is_bounded;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::is_modulo;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::traps;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::tinyness_before;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_int, ExpressionTemplates> >::round_style;

#endif

template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> number_type;
...
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::digits;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::max_digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::is_signed;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::is_integer;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::is_exact;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::radix;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::min_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::min_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::max_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::max_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::has_infinity;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::has_quiet_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::has_signaling_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::has_denorm;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::has_denorm_loss;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::is_iec559;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::is_bounded;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::is_modulo;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::traps;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::tinyness_before;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::gmp_rational, ExpressionTemplates> >::round_style;
