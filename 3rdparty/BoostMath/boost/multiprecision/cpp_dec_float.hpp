...
template <unsigned Digits10, class ExponentType = _Boost::int32_t, class Allocator = void>
class cpp_dec_float;
...
{
 private:
   static const _Boost::int32_t cpp_dec_float_digits10_setting = Digits10;

   // We need at least 16-bits in the exponent type to do anything sensible:
   BOOST_STATIC_ASSERT_MSG(_Boost::is_signed<ExponentType>::value, "ExponentType must be a signed built in integer type.");
   BOOST_STATIC_ASSERT_MSG(sizeof(ExponentType) > 1, "ExponentType is too small.");

 public:
   typedef mpl::list<_Boost::long_long_type>  signed_types;
   typedef mpl::list<_Boost::ulong_long_type> unsigned_types;
   typedef mpl::list<double, long double>    float_types;
   typedef ExponentType                      exponent_type;

   static const _Boost::int32_t cpp_dec_float_radix             = 10L;
   static const _Boost::int32_t cpp_dec_float_digits10_limit_lo = 9L;
   static const _Boost::int32_t cpp_dec_float_digits10_limit_hi = _Boost::integer_traits<_Boost::int32_t>::const_max - 100;
   static const _Boost::int32_t cpp_dec_float_digits10          = ((cpp_dec_float_digits10_setting < cpp_dec_float_digits10_limit_lo) ? cpp_dec_float_digits10_limit_lo : ((cpp_dec_float_digits10_setting > cpp_dec_float_digits10_limit_hi) ? cpp_dec_float_digits10_limit_hi : cpp_dec_float_digits10_setting));
 ...
 private:
   static const _Boost::int32_t cpp_dec_float_elem_digits10 = 8L;
   static const _Boost::int32_t cpp_dec_float_elem_mask     = 100000000L;
   ...
   static const _Boost::int32_t cpp_dec_float_elem_number_request = static_cast<_Boost::int32_t>((cpp_dec_float_digits10 / cpp_dec_float_elem_digits10) + (((cpp_dec_float_digits10 % cpp_dec_float_elem_digits10) != 0) ? 1 : 0));

   // The number of elements needed (with a minimum of two) plus three added guard limbs.
   static const _Boost::int32_t cpp_dec_float_elem_number = static_cast<_Boost::int32_t>(((cpp_dec_float_elem_number_request < 2L) ? 2L : cpp_dec_float_elem_number_request) + 3L);

 public:
   static const _Boost::int32_t cpp_dec_float_total_digits10 = static_cast<_Boost::int32_t>(cpp_dec_float_elem_number * cpp_dec_float_elem_digits10);
 ...
 private:
   ...
   typedef typename mpl::if_<is_void<Allocator>,
                             std::array<_Boost::uint32_t, cpp_dec_float_elem_number>,
                             detail::dynamic_array<_Boost::uint32_t, cpp_dec_float_elem_number, Allocator> >::type array_type;
#else
   typedef typename mpl::if_<is_void<Allocator>,
                             _Boost::array<_Boost::uint32_t, cpp_dec_float_elem_number>,
                             detail::dynamic_array<_Boost::uint32_t, cpp_dec_float_elem_number, Allocator> >::type array_type;
#endif
 ...
 public:
                                                                      ...
                                                                      prec_elem(cpp_dec_float_elem_number)
   {
      if (i < 0)
      {
         from_unsigned_long_long(_Boost::multiprecision::detail::unsigned_abs(i));
         negate();
      }
      else
         from_unsigned_long_long(i);
   ...
   cpp_dec_float(const F val, typename enable_if_c<is_floating_point<F>::value
                                                   ...
                                                   && !_Boost::is_same<F, __float128>::value
#endif
                                                   >::type* = 0) : data(),
                                                                   exp(static_cast<ExponentType>(0)),
                                                                   neg(false),
   ...
   std::size_t hash() const
   {
      ...
      for (int i = 0; i < prec_elem; ++i)
         _Boost::hash_combine(result, data[i]);
      _Boost::hash_combine(result, exp);
      _Boost::hash_combine(result, neg);
      _Boost::hash_combine(result, fpclass);
      return result;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val_max = std::string("1.0e" + _Boost::multiprecision::detail::itos(cpp_dec_float_max_exp10)).c_str();
      return val_max;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val_min = std::string("1.0e" + _Boost::multiprecision::detail::itos(cpp_dec_float_min_exp10)).c_str();
      return val_min;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val(static_cast<_Boost::ulong_long_type>(0u));
      return val;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val(static_cast<_Boost::ulong_long_type>(1u));
      return val;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val(static_cast<_Boost::ulong_long_type>(2u));
      return val;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val((std::numeric_limits<_Boost::long_long_type>::max)());
      return val;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val((std::numeric_limits<_Boost::long_long_type>::min)());
      return val;
   }
   ...
   {
      init.do_nothing();
      static cpp_dec_float val((std::numeric_limits<_Boost::ulong_long_type>::max)());
      return val;
   }
   ...
   cpp_dec_float& operator=(_Boost::long_long_type v)
   {
      if (v < 0)
      {
         from_unsigned_long_long(1u - _Boost::ulong_long_type(v + 1)); // Avoid undefined behaviour in negation of minimum value for long long
         negate();
      }
      else
   ...
   cpp_dec_float& operator=(_Boost::ulong_long_type v)
   {
      from_unsigned_long_long(v);
      return *this;
   }
   ...
   typename _Boost::enable_if_c<_Boost::is_floating_point<Float>::value, cpp_dec_float&>::type operator=(Float v);
   ...
   cpp_dec_float& add_unsigned_long_long(const _Boost::ulong_long_type n)
   {
      cpp_dec_float t;
   ...
   cpp_dec_float& sub_unsigned_long_long(const _Boost::ulong_long_type n)
   {
      cpp_dec_float t;
      t.from_unsigned_long_long(n);
      return *this -= t;
   ...
   cpp_dec_float& mul_unsigned_long_long(const _Boost::ulong_long_type n);
   cpp_dec_float& div_unsigned_long_long(const _Boost::ulong_long_type n);
   ...
   std::string str(_Boost::intmax_t digits, std::ios_base::fmtflags f) const;
   ...
   _Boost::long_long_type  extract_signed_long_long() const;
   _Boost::ulong_long_type extract_unsigned_long_long() const;
   void                   extract_parts(double& mantissa, ExponentType& exponent) const;
   cpp_dec_float          extract_integer_part() const;

   void precision(const _Boost::int32_t prec_digits)
   {
      ...
      {
         const _Boost::int32_t elems = static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>((prec_digits + (cpp_dec_float_elem_digits10 / 2)) / cpp_dec_float_elem_digits10) + static_cast<_Boost::int32_t>(((prec_digits % cpp_dec_float_elem_digits10) != 0) ? 1 : 0));

         prec_elem = (std::min)(cpp_dec_float_elem_number, (std::max)(elems, static_cast<_Boost::int32_t>(2)));
      }
   }
   static cpp_dec_float pow2(_Boost::long_long_type i);
   ExponentType         order() const
   {
      const bool bo_order_is_zero = ((!(isfinite)()) || (data[0] == static_cast<_Boost::uint32_t>(0u)));
      //
   ...
   void serialize(Archive& ar, const unsigned int /*version*/)
   {
      for (unsigned i = 0; i < data.size(); ++i)
         ar& _Boost::make_nvp("digit", data[i]);
      ar& _Boost::make_nvp("exponent", exp);
      ar& _Boost::make_nvp("sign", neg);
      ar& _Boost::make_nvp("class-type", fpclass);
      ar& _Boost::make_nvp("precision", prec_elem);
   }

 private:
   static bool data_elem_is_non_zero_predicate(const _Boost::uint32_t& d) { return (d != static_cast<_Boost::uint32_t>(0u)); }
   static bool data_elem_is_non_nine_predicate(const _Boost::uint32_t& d) { return (d != static_cast<_Boost::uint32_t>(cpp_dec_float::cpp_dec_float_elem_mask - 1)); }
   static bool char_is_nonzero_predicate(const char& c) { return (c != static_cast<char>('0')); }

   void from_unsigned_long_long(const _Boost::ulong_long_type u);

   int cmp_data(const array_type& vd) const;

   static _Boost::uint32_t mul_loop_uv(_Boost::uint32_t* const u, const _Boost::uint32_t* const v, const _Boost::int32_t p);
   static _Boost::uint32_t mul_loop_n(_Boost::uint32_t* const u, _Boost::uint32_t n, const _Boost::int32_t p);
   static _Boost::uint32_t div_loop_n(_Boost::uint32_t* const u, _Boost::uint32_t n, const _Boost::int32_t p);
...
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_radix;
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10_setting;
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10_limit_lo;
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10_limit_hi;
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
template <unsigned Digits10, class ExponentType, class Allocator>
...
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_digits10;
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_number_request;
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_number;
template <unsigned Digits10, class ExponentType, class Allocator>
const _Boost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_mask;
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::operator+=(const cpp_dec_float<Digits10, ExponentType, Allocator>& v)
{
   ...
   bool                                b_copy = false;
   const _Boost::int32_t                ofs    = static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(ofs_exp) / cpp_dec_float_elem_digits10);
   array_type                          n_data;
   ...
   if (neg == v.neg)
   {
      ...
      if (ofs >= static_cast<_Boost::int32_t>(0))
      {
         std::copy(v.data.begin(), v.data.end() - static_cast<size_t>(ofs), n_data.begin() + static_cast<size_t>(ofs));
         std::fill(n_data.begin(), n_data.begin() + static_cast<size_t>(ofs), static_cast<_Boost::uint32_t>(0u));
         p_v = n_data.begin();
      }
      else
      {
      ...
      // Addition algorithm
      _Boost::uint32_t carry = static_cast<_Boost::uint32_t>(0u);

      for (_Boost::int32_t j = static_cast<_Boost::int32_t>(cpp_dec_float_elem_number - static_cast<_Boost::int32_t>(1)); j >= static_cast<_Boost::int32_t>(0); j--)
      {
         _Boost::uint32_t t = static_cast<_Boost::uint32_t>(static_cast<_Boost::uint32_t>(p_u[j] + p_v[j]) + carry);
         carry             = t / static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask);
         p_u[j]            = static_cast<_Boost::uint32_t>(t - static_cast<_Boost::uint32_t>(carry * static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask)));
      }
      ...
      if (carry != static_cast<_Boost::uint32_t>(0u))
      {
   ...
   else
   {
      ...
      // might have to be treated with a positive, negative or zero offset.
      if ((ofs > static_cast<_Boost::int32_t>(0)) || ((ofs == static_cast<_Boost::int32_t>(0)) && (cmp_data(v.data) > static_cast<_Boost::int32_t>(0))))
      {
      ...
      else
      {
         if (ofs != static_cast<_Boost::int32_t>(0))
         {
            ...
            std::fill(data.begin(), data.begin() + static_cast<size_t>(-ofs), static_cast<_Boost::uint32_t>(0u));
         }
      ...
      _Boost::int32_t borrow = static_cast<_Boost::int32_t>(0);

      for (j = static_cast<_Boost::int32_t>(cpp_dec_float_elem_number - static_cast<_Boost::int32_t>(1)); j >= static_cast<_Boost::int32_t>(0); j--)
      {
         _Boost::int32_t t = static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(p_u[j]) - static_cast<_Boost::int32_t>(p_v[j])) - borrow);

         // Underflow? Borrow?
         if (t < static_cast<_Boost::int32_t>(0))
         {
            // Yes, underflow and borrow
            t += static_cast<_Boost::int32_t>(cpp_dec_float_elem_mask);
            borrow = static_cast<_Boost::int32_t>(1);
         }
         else
         {
            borrow = static_cast<_Boost::int32_t>(0);
         }

         p_u[j] = static_cast<_Boost::uint32_t>(static_cast<_Boost::uint32_t>(t) % static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask));
      }
      ...
      if (first_nonzero_elem != data.begin())
      {
         ...
         else
         {
            ...
            std::fill(data.end() - sj, data.end(), static_cast<_Boost::uint32_t>(0u));
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::operator*=(const cpp_dec_float<Digits10, ExponentType, Allocator>& v)
{
   ...
   const _Boost::int32_t prec_mul = (std::min)(prec_elem, v.prec_elem);

   const _Boost::uint32_t carry = mul_loop_uv(data.data(), v.data.data(), prec_mul);
   ...
   if (carry != static_cast<_Boost::uint32_t>(0u))
   {
      ...
      std::copy_backward(data.begin(),
                         data.begin() + static_cast<std::size_t>(prec_elem - static_cast<_Boost::int32_t>(1)),
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::operator/=(const cpp_dec_float<Digits10, ExponentType, Allocator>& v)
{
   ...
   const bool u_and_v_are_finite_and_identical = ((isfinite)() && (fpclass == v.fpclass) && (exp == v.exp) && (cmp_data(v.data) == static_cast<_Boost::int32_t>(0)));
...
template <unsigned Digits10, class ExponentType, class Allocator>
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::mul_unsigned_long_long(const _Boost::ulong_long_type n)
{
   // Multiply *this with a constant _Boost::ulong_long_type.
   ...
   // Handle special cases like zero, inf and NaN.
   const bool b_u_is_inf  = (isinf)();
   const bool b_n_is_zero = (n == static_cast<_Boost::int32_t>(0));
   ...
   if (n >= static_cast<_Boost::ulong_long_type>(cpp_dec_float_elem_mask))
   {
      neg = b_neg;
      cpp_dec_float t;
      t = n;
   ...
   if (n == static_cast<_Boost::ulong_long_type>(1u))
   {
      neg = b_neg;
      return *this;
   }
   ...
   const _Boost::uint32_t nn    = static_cast<_Boost::uint32_t>(n);
   const _Boost::uint32_t carry = mul_loop_n(data.data(), nn, prec_elem);
   ...
   if (carry != static_cast<_Boost::uint32_t>(0u))
   {
      ...
      data.front() = static_cast<_Boost::uint32_t>(carry);
   }
...
template <unsigned Digits10, class ExponentType, class Allocator>
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::div_unsigned_long_long(const _Boost::ulong_long_type n)
{
   // Divide *this by a constant _Boost::ulong_long_type.
   ...
   if (n == static_cast<_Boost::ulong_long_type>(0u))
   {
      // Divide by 0.
      if (iszero())
      {
   ...
   if (nn > static_cast<_Boost::uint32_t>(1u))
   {
      // Do the division loop.
      const _Boost::uint32_t prev = div_loop_n(data.data(), nn, prec_elem);

      // Determine if one leading zero is in the result data.
      if (data[0] == static_cast<_Boost::uint32_t>(0u))
      {
         // Adjust the exponent
         exp -= static_cast<ExponentType>(cpp_dec_float_elem_digits10);
         ...
         data[prec_elem - static_cast<_Boost::int32_t>(1)] = static_cast<_Boost::uint32_t>(static_cast<_Boost::uint64_t>(prev * static_cast<_Boost::uint64_t>(cpp_dec_float_elem_mask)) / nn);
      }
   }
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::calculate_inv()
{
   ...
   static const _Boost::int32_t double_digits10_minus_a_few = std::numeric_limits<double>::digits10 - 3;

   for (_Boost::int32_t digits = double_digits10_minus_a_few; digits <= cpp_dec_float_total_digits10; digits *= static_cast<_Boost::int32_t>(2))
   {
      // Adjust precision of the terms.
      precision(static_cast<_Boost::int32_t>((digits + 10) * static_cast<_Boost::int32_t>(2)));
      x.precision(static_cast<_Boost::int32_t>((digits + 10) * static_cast<_Boost::int32_t>(2)));
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::calculate_sqrt()
{
   ...
   *this = cpp_dec_float<Digits10, ExponentType, Allocator>(sqd, static_cast<ExponentType>(ne / static_cast<ExponentType>(2)));
   ...
   static const _Boost::uint32_t double_digits10_minus_a_few = std::numeric_limits<double>::digits10 - 3;

   for (_Boost::int32_t digits = double_digits10_minus_a_few; digits <= cpp_dec_float_total_digits10; digits *= 2u)
   {
      // Adjust precision of the terms.
...
bool cpp_dec_float<Digits10, ExponentType, Allocator>::isone() const
{
   ...
   {
      if ((data[0u] == static_cast<_Boost::uint32_t>(1u)) && (exp == static_cast<ExponentType>(0)))
      {
      ...
      else if ((data[0u] == static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask - 1)) && (exp == static_cast<ExponentType>(-cpp_dec_float_elem_digits10)))
      {
...
void cpp_dec_float<Digits10, ExponentType, Allocator>::extract_parts(double& mantissa, ExponentType& exponent) const
{
   ...
   _Boost::uint32_t p10  = static_cast<_Boost::uint32_t>(1u);
   _Boost::uint32_t test = data[0u];

   for (;;)
   {
      test /= static_cast<_Boost::uint32_t>(10u);

      if (test == static_cast<_Boost::uint32_t>(0u))
      {
         break;
      }

      p10 *= static_cast<_Boost::uint32_t>(10u);
      ++exponent;
   }

   // Establish the upper bound of limbs for extracting the double.
   const int max_elem_in_double_count = static_cast<int>(static_cast<_Boost::int32_t>(std::numeric_limits<double>::digits10) / cpp_dec_float_elem_digits10) + (static_cast<int>(static_cast<_Boost::int32_t>(std::numeric_limits<double>::digits10) % cpp_dec_float_elem_digits10) != 0 ? 1 : 0) + 1;

   // And make sure this upper bound stays within bounds of the elems.
   const std::size_t max_elem_extract_count = static_cast<std::size_t>((std::min)(static_cast<_Boost::int32_t>(max_elem_in_double_count), cpp_dec_float_elem_number));
...
template <unsigned Digits10, class ExponentType, class Allocator>
_Boost::long_long_type cpp_dec_float<Digits10, ExponentType, Allocator>::extract_signed_long_long() const
{
   ...
   if (exp < static_cast<ExponentType>(0))
   {
      return static_cast<_Boost::long_long_type>(0);
   }

   const bool b_neg = isneg();

   _Boost::ulong_long_type val;

   if ((!b_neg) && (compare(long_long_max()) > 0))
   {
      return (std::numeric_limits<_Boost::long_long_type>::max)();
   }
   else if (b_neg && (compare(long_long_min()) < 0))
   {
      return (std::numeric_limits<_Boost::long_long_type>::min)();
   }
   else
   {
      // Extract the data into an _Boost::ulong_long_type value.
      cpp_dec_float<Digits10, ExponentType, Allocator> xn(extract_integer_part());
      if (xn.isneg())
         xn.negate();

      val = static_cast<_Boost::ulong_long_type>(xn.data[0]);

      const _Boost::int32_t imax = (std::min)(static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(xn.exp) / cpp_dec_float_elem_digits10), static_cast<_Boost::int32_t>(cpp_dec_float_elem_number - static_cast<_Boost::int32_t>(1)));

      for (_Boost::int32_t i = static_cast<_Boost::int32_t>(1); i <= imax; i++)
      {
         val *= static_cast<_Boost::ulong_long_type>(cpp_dec_float_elem_mask);
         val += static_cast<_Boost::ulong_long_type>(xn.data[i]);
      }
   }

   if (!b_neg)
   {
      return static_cast<_Boost::long_long_type>(val);
   }
   else
   {
      // This strange expression avoids a hardware trap in the corner case
      // that val is the most negative value permitted in _Boost::long_long_type.
      // See https://svn.boost.org/trac/boost/ticket/9740.
      //
      _Boost::long_long_type sval = static_cast<_Boost::long_long_type>(val - 1);
      sval                       = -sval;
      --sval;
      return sval;
   }
...
template <unsigned Digits10, class ExponentType, class Allocator>
_Boost::ulong_long_type cpp_dec_float<Digits10, ExponentType, Allocator>::extract_unsigned_long_long() const
{
   // Extracts an _Boost::ulong_long_type from *this.
   // If x exceeds the maximum of _Boost::ulong_long_type,
   // then the maximum of _Boost::ulong_long_type is returned.
   // If x is negative, then the _Boost::ulong_long_type cast of
   // the long long extracted value is returned.

   if (isneg())
   {
      return static_cast<_Boost::ulong_long_type>(extract_signed_long_long());
   }

   if (exp < static_cast<ExponentType>(0))
   {
      return static_cast<_Boost::ulong_long_type>(0u);
   }
   ...
   {
      return (std::numeric_limits<_Boost::ulong_long_type>::max)();
   }
   else
   {
      // Extract the data into an _Boost::ulong_long_type value.
...
cpp_dec_float<Digits10, ExponentType, Allocator> cpp_dec_float<Digits10, ExponentType, Allocator>::extract_integer_part() const
{
   ...
   if (first_clear < last_clear)
      std::fill(x.data.begin() + first_clear, x.data.begin() + last_clear, static_cast<_Boost::uint32_t>(0u));

   return x;
}

template <unsigned Digits10, class ExponentType, class Allocator>
std::string cpp_dec_float<Digits10, ExponentType, Allocator>::str(_Boost::intmax_t number_of_digits, std::ios_base::fmtflags f) const
{
   if ((this->isinf)())
   {
      if (this->isneg())
   ...
   std::string     str;
   _Boost::intmax_t org_digits(number_of_digits);
   ...
   if (number_of_digits < 0)
   {
      ...
      _Boost::multiprecision::detail::format_float_string(str, 0, number_of_digits - my_exp - 1, f, this->iszero());
      return str;
   }
   else
   {
      ...
      if (str.length() > static_cast<std::string::size_type>(number_of_digits))
      {
         ...
         const _Boost::uint32_t round = static_cast<_Boost::uint32_t>(static_cast<_Boost::uint32_t>(str[static_cast<std::string::size_type>(number_of_digits)]) - static_cast<_Boost::uint32_t>('0'));

         bool need_round_up = round >= 5u;

         if (round == 5u)
         {
            const _Boost::uint32_t ix = static_cast<_Boost::uint32_t>(static_cast<_Boost::uint32_t>(str[static_cast<std::string::size_type>(number_of_digits - 1)]) - static_cast<_Boost::uint32_t>('0'));
            if ((ix & 1u) == 0)
            {
         ...
         if (need_round_up)
         {
            ...
            while (ix && (static_cast<_Boost::int32_t>(str.at(ix)) - static_cast<_Boost::int32_t>('0') == static_cast<_Boost::int32_t>(9)))
            {
            ...
            if (!ix)
            {
               ...
               if (static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(str.at(ix)) - static_cast<_Boost::int32_t>(0x30)) == static_cast<_Boost::int32_t>(9))
               {
   ...
   _Boost::multiprecision::detail::format_float_string(str, my_exp, org_digits, f, this->iszero());
   return str;
}
...
bool cpp_dec_float<Digits10, ExponentType, Allocator>::rd_string(const char* const s)
{
   ...
   try
   {
      ...
      if (((pos = str.find('e')) != std::string::npos) || ((pos = str.find('E')) != std::string::npos))
      {
         ...
         exp = _Boost::lexical_cast<ExponentType>(static_cast<const char*>(str.c_str() + (pos + 1u)));
      ...
      {
         const _Boost::int32_t n_pos         = static_cast<_Boost::int32_t>(pos);
         const _Boost::int32_t n_rem_is_zero = ((static_cast<_Boost::int32_t>(n_pos % cpp_dec_float_elem_digits10) == static_cast<_Boost::int32_t>(0)) ? static_cast<_Boost::int32_t>(1) : static_cast<_Boost::int32_t>(0));
         const _Boost::int32_t n             = static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(n_pos / cpp_dec_float_elem_digits10) - n_rem_is_zero);

         str.insert(static_cast<std::size_t>(static_cast<_Boost::int32_t>(n_pos - static_cast<_Boost::int32_t>(n * cpp_dec_float_elem_digits10))), ".");
      ...
      const _Boost::int32_t n_dec = static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(str.length() - 1u) - static_cast<_Boost::int32_t>(pos));
      const _Boost::int32_t n_rem = static_cast<_Boost::int32_t>(n_dec % cpp_dec_float_elem_digits10);

      _Boost::int32_t n_cnt = ((n_rem != static_cast<_Boost::int32_t>(0))
                                  ? static_cast<_Boost::int32_t>(cpp_dec_float_elem_digits10 - n_rem)
                                  : static_cast<_Boost::int32_t>(0));

      if (n_cnt != static_cast<_Boost::int32_t>(0))
      {
      ...
      std::fill(data.begin(), data.end(), static_cast<_Boost::uint32_t>(0u));

      // Extract the data.

      // First get the digits to the left of the decimal point...
      data[0u] = _Boost::lexical_cast<_Boost::uint32_t>(str.substr(static_cast<std::size_t>(0u), pos));
      ...
      for (std::string::size_type i = static_cast<std::string::size_type>(0u); i < i_end; i++)
      {
         ...
         data[i + 1u] = _Boost::lexical_cast<_Boost::uint32_t>(std::string(it, it + static_cast<std::string::size_type>(cpp_dec_float_elem_digits10)));
      }
      ...
      prec_elem(cpp_dec_float_elem_number)
{
   ...
   _Boost::int32_t shift = static_cast<_Boost::int32_t>(e % static_cast<_Boost::int32_t>(cpp_dec_float_elem_digits10));

   while (static_cast<_Boost::int32_t>(shift-- % cpp_dec_float_elem_digits10) != static_cast<_Boost::int32_t>(0))
   {
      d *= 10.0;
      --e;
   }
   ...
   static const _Boost::int32_t digit_ratio = static_cast<_Boost::int32_t>(static_cast<_Boost::int32_t>(std::numeric_limits<double>::digits10) / static_cast<_Boost::int32_t>(cpp_dec_float_elem_digits10));
   static const _Boost::int32_t digit_loops = static_cast<_Boost::int32_t>(digit_ratio + static_cast<_Boost::int32_t>(2));

   for (_Boost::int32_t i = static_cast<_Boost::int32_t>(0); i < digit_loops; i++)
   {
      _Boost::uint32_t n = static_cast<_Boost::uint32_t>(static_cast<_Boost::uint64_t>(d));
      data[i]           = static_cast<_Boost::uint32_t>(n);
...
template <unsigned Digits10, class ExponentType, class Allocator>
template <class Float>
typename _Boost::enable_if_c<_Boost::is_floating_point<Float>::value, cpp_dec_float<Digits10, ExponentType, Allocator>&>::type cpp_dec_float<Digits10, ExponentType, Allocator>::operator=(Float a)
{
   // Christopher Kormanyos's original code used a cast to _Boost::long_long_type here, but that fails
   // when long double has more digits than a _Boost::long_long_type.
   using std::floor;
   using std::frexp;
   using std::ldexp;
   ...
   *this = zero();
   ...
   BOOST_ASSERT((_Boost::math::isfinite)(f));
...
template <unsigned Digits10, class ExponentType, class Allocator>
void cpp_dec_float<Digits10, ExponentType, Allocator>::from_unsigned_long_long(const _Boost::ulong_long_type u)
{
   std::fill(data.begin(), data.end(), static_cast<_Boost::uint32_t>(0u));
   ...
   _Boost::ulong_long_type uu = u;

   _Boost::uint32_t temp[(std::numeric_limits<_Boost::ulong_long_type>::digits10 / static_cast<int>(cpp_dec_float_elem_digits10)) + 3] = {static_cast<_Boost::uint32_t>(0u)};

   while (uu != static_cast<_Boost::ulong_long_type>(0u))
   {
      temp[i] = static_cast<_Boost::uint32_t>(uu % static_cast<_Boost::ulong_long_type>(cpp_dec_float_elem_mask));
      uu      = static_cast<_Boost::ulong_long_type>(uu / static_cast<_Boost::ulong_long_type>(cpp_dec_float_elem_mask));
      ++i;
   }
...
template <unsigned Digits10, class ExponentType, class Allocator>
_Boost::uint32_t cpp_dec_float<Digits10, ExponentType, Allocator>::mul_loop_uv(_Boost::uint32_t* const u, const _Boost::uint32_t* const v, const _Boost::int32_t p)
{
   //
   ...
   _Boost::uint64_t carry = static_cast<_Boost::uint64_t>(0u);

   for (_Boost::int32_t j = static_cast<_Boost::int32_t>(p - 1u); j >= static_cast<_Boost::int32_t>(0); j--)
   {
      _Boost::uint64_t sum = carry;

      for (_Boost::int32_t i = j; i >= static_cast<_Boost::int32_t>(0); i--)
      {
         sum += static_cast<_Boost::uint64_t>(u[j - i] * static_cast<_Boost::uint64_t>(v[i]));
      }

      u[j]  = static_cast<_Boost::uint32_t>(sum % static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask));
      carry = static_cast<_Boost::uint64_t>(sum / static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask));
   }

   return static_cast<_Boost::uint32_t>(carry);
}

template <unsigned Digits10, class ExponentType, class Allocator>
_Boost::uint32_t cpp_dec_float<Digits10, ExponentType, Allocator>::mul_loop_n(_Boost::uint32_t* const u, _Boost::uint32_t n, const _Boost::int32_t p)
{
   _Boost::uint64_t carry = static_cast<_Boost::uint64_t>(0u);

   // Multiplication loop.
   for (_Boost::int32_t j = p - 1; j >= static_cast<_Boost::int32_t>(0); j--)
   {
      const _Boost::uint64_t t = static_cast<_Boost::uint64_t>(carry + static_cast<_Boost::uint64_t>(u[j] * static_cast<_Boost::uint64_t>(n)));
      carry                   = static_cast<_Boost::uint64_t>(t / static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask));
      u[j]                    = static_cast<_Boost::uint32_t>(t - static_cast<_Boost::uint64_t>(static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask) * static_cast<_Boost::uint64_t>(carry)));
   }
...
template <unsigned Digits10, class ExponentType, class Allocator>
_Boost::uint32_t cpp_dec_float<Digits10, ExponentType, Allocator>::div_loop_n(_Boost::uint32_t* const u, _Boost::uint32_t n, const _Boost::int32_t p)
{
   _Boost::uint64_t prev = static_cast<_Boost::uint64_t>(0u);

   for (_Boost::int32_t j = static_cast<_Boost::int32_t>(0); j < p; j++)
   {
      const _Boost::uint64_t t = static_cast<_Boost::uint64_t>(u[j] + static_cast<_Boost::uint64_t>(prev * static_cast<_Boost::uint32_t>(cpp_dec_float_elem_mask)));
      u[j]                    = static_cast<_Boost::uint32_t>(t / n);
      prev                    = static_cast<_Boost::uint64_t>(t - static_cast<_Boost::uint64_t>(n * static_cast<_Boost::uint64_t>(u[j])));
   }

   return static_cast<_Boost::uint32_t>(prev);
}

template <unsigned Digits10, class ExponentType, class Allocator>
cpp_dec_float<Digits10, ExponentType, Allocator> cpp_dec_float<Digits10, ExponentType, Allocator>::pow2(const _Boost::long_long_type p)
{
   // Create a static const table of p^2 for -128 < p < +128.
   // Note: The size of this table must be odd-numbered and
   // symmetric about 0.
   init.do_nothing();
   static const _Boost::array<cpp_dec_float<Digits10, ExponentType, Allocator>, 255u> p2_data =
       {{cpp_dec_float("5.877471754111437539843682686111228389093327783860437607543758531392086297273635864257812500000000000e-39"),
         ...
         one(),
         two(),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(4)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(8)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(16)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(32)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(64)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(128)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(256)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(512)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(1024)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(2048)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(4096)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(8192)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(16384)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(32768)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(65536)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(131072)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(262144)),
         cpp_dec_float(static_cast<_Boost::ulong_long_type>(524288)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 20u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 21u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 22u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 23u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 24u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 25u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 26u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 27u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 28u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 29u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 30u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uL << 31u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 32u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 33u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 34u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 35u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 36u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 37u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 38u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 39u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 40u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 41u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 42u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 43u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 44u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 45u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 46u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 47u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 48u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 49u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 50u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 51u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 52u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 53u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 54u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 55u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 56u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 57u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 58u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 59u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 60u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 61u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 62u)),
         cpp_dec_float(static_cast<_Boost::uint64_t>(1uLL << 63u)),
   ...
   if ((p > static_cast<_Boost::long_long_type>(-128)) && (p < static_cast<_Boost::long_long_type>(+128)))
   {
   ...
   else
   {
      ...
      if (p < static_cast<_Boost::long_long_type>(0))
      {
         return pow2(static_cast<_Boost::long_long_type>(-p)).calculate_inv();
      }
      else
      {
         cpp_dec_float<Digits10, ExponentType, Allocator> t;
...
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_add(cpp_dec_float<Digits10, ExponentType, Allocator>& result, const _Boost::ulong_long_type& o)
{
   result.add_unsigned_long_long(o);
}
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_subtract(cpp_dec_float<Digits10, ExponentType, Allocator>& result, const _Boost::ulong_long_type& o)
{
   result.sub_unsigned_long_long(o);
}
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_multiply(cpp_dec_float<Digits10, ExponentType, Allocator>& result, const _Boost::ulong_long_type& o)
{
   result.mul_unsigned_long_long(o);
}
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_divide(cpp_dec_float<Digits10, ExponentType, Allocator>& result, const _Boost::ulong_long_type& o)
{
   result.div_unsigned_long_long(o);
}

template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_add(cpp_dec_float<Digits10, ExponentType, Allocator>& result, _Boost::long_long_type o)
{
   if (o < 0)
      result.sub_unsigned_long_long(_Boost::multiprecision::detail::unsigned_abs(o));
   else
      result.add_unsigned_long_long(o);
}
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_subtract(cpp_dec_float<Digits10, ExponentType, Allocator>& result, _Boost::long_long_type o)
{
   if (o < 0)
      result.add_unsigned_long_long(_Boost::multiprecision::detail::unsigned_abs(o));
   else
      result.sub_unsigned_long_long(o);
}
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_multiply(cpp_dec_float<Digits10, ExponentType, Allocator>& result, _Boost::long_long_type o)
{
   if (o < 0)
   {
      result.mul_unsigned_long_long(_Boost::multiprecision::detail::unsigned_abs(o));
      result.negate();
   }
   else
      result.mul_unsigned_long_long(o);
...
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_divide(cpp_dec_float<Digits10, ExponentType, Allocator>& result, _Boost::long_long_type o)
{
   if (o < 0)
   {
      result.div_unsigned_long_long(_Boost::multiprecision::detail::unsigned_abs(o));
      result.negate();
   }
   else
      result.div_unsigned_long_long(o);
...
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_convert_to(_Boost::ulong_long_type* result, const cpp_dec_float<Digits10, ExponentType, Allocator>& val)
{
   *result = val.extract_unsigned_long_long();
}
template <unsigned Digits10, class ExponentType, class Allocator>
inline void eval_convert_to(_Boost::long_long_type* result, const cpp_dec_float<Digits10, ExponentType, Allocator>& val)
{
...
{
   const _Boost::long_long_type the_exp = static_cast<_Boost::long_long_type>(e);
   ...
   if ((the_exp > static_cast<_Boost::long_long_type>(-std::numeric_limits<_Boost::long_long_type>::digits)) && (the_exp < static_cast<_Boost::long_long_type>(0)))
      result.div_unsigned_long_long(1ULL << static_cast<_Boost::long_long_type>(-the_exp));
   else if ((the_exp < static_cast<_Boost::long_long_type>(std::numeric_limits<_Boost::long_long_type>::digits)) && (the_exp > static_cast<_Boost::long_long_type>(0)))
      result.mul_unsigned_long_long(1ULL << the_exp);
   else if (the_exp != static_cast<_Boost::long_long_type>(0))
...
using _Boost::multiprecision::backends::cpp_dec_float;
...
}} // namespace _Boost::multiprecision

namespace std {
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >
{
 public:
   ...
   BOOST_STATIC_CONSTEXPR int  digits                              = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
   BOOST_STATIC_CONSTEXPR int  digits10                            = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
   BOOST_STATIC_CONSTEXPR int  max_digits10                        = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_total_digits10;
   BOOST_STATIC_CONSTEXPR ExponentType min_exponent                = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_min_exp;   // Type differs from int.
   BOOST_STATIC_CONSTEXPR ExponentType min_exponent10              = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_min_exp10; // Type differs from int.
   BOOST_STATIC_CONSTEXPR ExponentType max_exponent                = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_max_exp;   // Type differs from int.
   BOOST_STATIC_CONSTEXPR ExponentType max_exponent10              = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_max_exp10; // Type differs from int.
   BOOST_STATIC_CONSTEXPR int          radix                       = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_radix;
   ...
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates>(min)() { return (_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::min)(); }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates>(max)() { return (_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::max)(); }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> lowest() { return _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> epsilon() { return _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::eps(); }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> round_error() { return 0.5L; }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> infinity() { return _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::inf(); }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> quiet_NaN() { return _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::nan(); }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> signaling_NaN() { return _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
   BOOST_STATIC_CONSTEXPR _Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> denorm_min() { return _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
};

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::digits;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::radix;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::traps;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, class ExponentType, class Allocator, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::round_style;
...
template <unsigned Digits10, class ExponentType, class Allocator, class Policy, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct precision<_Boost::multiprecision::number<_Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates>, Policy>
{
   ...
   static const _Boost::int32_t cpp_dec_float_digits10 = _Boost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
...
}} // namespace _Boost::math::policies
