...
struct rational_adaptor
{
   ...
   typedef _Boost::rational<integer_type> rational_type;
   ...
   explicit rational_adaptor(const U& u,
                             typename enable_if_c<
                                 _Boost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_convertible<U, IntBackend>::value>::type* = 0)
       : m_value(IntBackend(u)) {}
   template <class U>
   typename enable_if_c<(_Boost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_arithmetic<U>::value), rational_adaptor&>::type operator=(const U& u)
   {
      m_value = IntBackend(u);
      return *this;
   }
   ...
   void serialize(Archive& ar, const mpl::true_&)
   {
      ...
      ar&          _Boost::make_nvp("numerator", n);
      ar&          _Boost::make_nvp("denominator", d);
   }
   template <class Archive>
...
inline std::size_t hash_value(const rational_adaptor<IntBackend>& val)
{
   ...
   _Boost::hash_combine(result, val.data().denominator());
   return result;
}
...
using _Boost::multiprecision::backends::rational_adaptor;
...
template <class IntBackend, _Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> > : public std::numeric_limits<_Boost::multiprecision::number<IntBackend, ExpressionTemplates> >
{
   typedef std::numeric_limits<_Boost::multiprecision::number<IntBackend> >                     base_type;
   typedef _Boost::multiprecision::number<_Boost::multiprecision::rational_adaptor<IntBackend> > number_type;
...
template <class IntBackend, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_integer;
template <class IntBackend, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_exact;
