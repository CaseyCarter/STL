...
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> >
    : public std::numeric_limits<_Boost::multiprecision::number<Backend, ExpressionTemplates> >
{
   ...
   typedef _Boost::multiprecision::number<_Boost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> number_type;
...
struct precision<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<Backend>, ExpressionTemplates>, Policy>
