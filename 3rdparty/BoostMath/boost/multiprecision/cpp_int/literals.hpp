...
struct pack_values
{
   ...
   typedef typename _Boost::mpl::if_c<shift == 0,
...
struct signed_cpp_int_literal_result_type
{
   ...
   typedef _Boost::multiprecision::backends::cpp_int_backend<bits, bits, signed_magnitude, unchecked, void> backend_type;
...
{
   static constexpr unsigned                                                                                 bits = Digits * 4;
   typedef _Boost::multiprecision::backends::cpp_int_backend<bits, bits, unsigned_magnitude, unchecked, void> backend_type;
   typedef number<backend_type, et_off>                                                                      number_type;
};
...
template <char... STR>
constexpr typename _Boost::multiprecision::literals::detail::signed_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::number_type operator"" _cppi()
{
   typedef typename _Boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;
   return _Boost::multiprecision::literals::detail::make_backend_from_pack<pt, typename _Boost::multiprecision::literals::detail::signed_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::backend_type>::value;
}

template <char... STR>
constexpr typename _Boost::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::number_type operator"" _cppui()
{
   typedef typename _Boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;
   return _Boost::multiprecision::literals::detail::make_backend_from_pack<pt, typename _Boost::multiprecision::literals::detail::unsigned_cpp_int_literal_result_type<(sizeof...(STR)) - 2>::backend_type>::value;
}

#define BOOST_MP_DEFINE_SIZED_CPP_INT_LITERAL(Bits)                                                                                                                                                                                \
   template <char... STR>                                                                                                                                                                                                          \
   constexpr _Boost::multiprecision::number<_Boost::multiprecision::backends::cpp_int_backend<Bits, Bits, _Boost::multiprecision::signed_magnitude, _Boost::multiprecision::unchecked, void> > operator"" BOOST_JOIN(_cppi, Bits)()    \
   {                                                                                                                                                                                                                               \
      typedef typename _Boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;                                                                                                                       \
      return _Boost::multiprecision::literals::detail::make_backend_from_pack<                                                                                                                                                      \
          pt,                                                                                                                                                                                                                      \
          _Boost::multiprecision::backends::cpp_int_backend<Bits, Bits, _Boost::multiprecision::signed_magnitude, _Boost::multiprecision::unchecked, void> >::value;                                                                  \
   }                                                                                                                                                                                                                               \
   template <char... STR>                                                                                                                                                                                                          \
   constexpr _Boost::multiprecision::number<_Boost::multiprecision::backends::cpp_int_backend<Bits, Bits, _Boost::multiprecision::unsigned_magnitude, _Boost::multiprecision::unchecked, void> > operator"" BOOST_JOIN(_cppui, Bits)() \
   {                                                                                                                                                                                                                               \
      typedef typename _Boost::multiprecision::literals::detail::make_packed_value_from_str<STR...>::type pt;                                                                                                                       \
      return _Boost::multiprecision::literals::detail::make_backend_from_pack<                                                                                                                                                      \
          pt,                                                                                                                                                                                                                      \
          _Boost::multiprecision::backends::cpp_int_backend<Bits, Bits, _Boost::multiprecision::unsigned_magnitude, _Boost::multiprecision::unchecked, void> >::value;                                                                \
   }
...
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(a.backend(), _Boost::multiprecision::literals::detail::make_negate_tag());
}
template <unsigned MinBits, cpp_int_check_type Checked>
constexpr number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>
operator-(number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&& a)
{
   return cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>(static_cast<const number<cpp_int_backend<MinBits, MinBits, signed_magnitude, Checked, void>, et_off>&>(a).backend(), _Boost::multiprecision::literals::detail::make_negate_tag());
}
