...
// [unsigned] _Boost::long_long_type, long, int, which has the specified number
// of bits.  Note that intN_t and _Boost::int_t<N> find the first
...
struct largest_signed_type
{
   typedef typename mpl::if_c<
       1 + std::numeric_limits<_Boost::long_long_type>::digits == N,
       ...
       typename mpl::if_c<
           ...
           typename mpl::if_c<
               ...
               int,
               typename _Boost::int_t<N>::exact>::type>::type>::type type;
};
...
{
   typedef typename mpl::if_c<
       std::numeric_limits<_Boost::ulong_long_type>::digits == N,
       ...
       typename mpl::if_c<
           ...
           typename mpl::if_c<
               ...
               unsigned int,
               typename _Boost::uint_t<N>::exact>::type>::type>::type type;
};
...
typedef _Boost::uint128_type                     double_limb_type;
typedef _Boost::int128_type                      signed_double_limb_type;
