...
namespace mp = _Boost::multiprecision;

namespace cpp_int_detail {

using namespace _Boost::multiprecision;
using namespace _Boost::multiprecision::backends;

template <class T>
struct is_binary_archive : public mpl::false_
{};
template <>
struct is_binary_archive<_Boost::archive::binary_oarchive> : public mpl::true_
{};
template <>
struct is_binary_archive<_Boost::archive::binary_iarchive> : public mpl::true_
{};
