...
struct logged_adaptor
{
 ...
 public:
   ...
   void serialize(Archive& ar, const unsigned int /*version*/)
   {
      ...
      ar& _Boost::make_nvp("value", m_value);
...
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> >
    : public std::numeric_limits<_Boost::multiprecision::number<Backend, ExpressionTemplates> >
{
   typedef std::numeric_limits<_Boost::multiprecision::number<Backend, ExpressionTemplates> >                            base_type;
   typedef _Boost::multiprecision::number<_Boost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> number_type;
...
template <class Backend, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
struct precision<_Boost::multiprecision::number<_Boost::multiprecision::logged_adaptor<Backend>, ExpressionTemplates>, Policy>
    : public precision<_Boost::multiprecision::number<Backend, ExpressionTemplates>, Policy>
{};
