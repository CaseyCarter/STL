...
struct mpfi_float_imp
{
   ...
   mpfi_float_imp& operator=(_Boost::ulong_long_type i)
   {
      if (m_data[0].left._mpfr_d == 0)
         mpfi_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
   ...
   mpfi_float_imp& operator=(_Boost::long_long_type i)
   {
      if (m_data[0].left._mpfr_d == 0)
         mpfi_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
   ...
   mpfi_float_imp& operator=(_Boost::ulong_long_type i)
   {
      if (m_data[0].left._mpfr_d == 0)
         mpfi_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
      _Boost::ulong_long_type mask  = ((((1uLL << (std::numeric_limits<unsigned long>::digits - 1)) - 1) << 1) | 1u);
      unsigned               shift = 0;
      mpfi_t                 t;
      mpfi_init2(t, (std::max)(static_cast<unsigned long>(std::numeric_limits<_Boost::ulong_long_type>::digits), static_cast<unsigned long>(multiprecision::detail::digits10_2_2(digits10))));
 ...
 protected:
   ...
   {
      static _Boost::multiprecision::detail::precision_type val(BOOST_MULTIPRECISION_MPFI_DEFAULT_PRECISION);
      return val;
   }
};
...
typename enable_if_c<_Boost::is_constructible<number<mpfr_float_backend<Digits10, allocate_dynamic>, et_on>, V>::value || _Boost::is_convertible<V, const char*>::value>::type
...
inline void eval_add(mpfi_float_backend<digits10>& result, long i)
{
   if (i > 0)
      ...
      mpfi_sub_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
template <unsigned digits10>
inline void eval_subtract(mpfi_float_backend<digits10>& result, long i)
{
   if (i > 0)
      ...
      mpfi_add_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
}
template <unsigned digits10>
inline void eval_multiply(mpfi_float_backend<digits10>& result, long i)
{
   mpfi_mul_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
...
{
   mpfi_div_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i));
   if (i < 0)
      mpfi_neg(result.data(), result.data());
}
//
...
{
   if (y < 0)
      mpfi_sub_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
   else
      mpfi_add_ui(a.data(), x.data(), y);
}
template <unsigned D1, unsigned D2>
...
inline void eval_add(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if (x < 0)
   {
      mpfi_ui_sub(a.data(), _Boost::multiprecision::detail::unsigned_abs(x), y.data());
...
{
   if (y < 0)
      mpfi_add_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
   else
      mpfi_sub_ui(a.data(), x.data(), y);
}
template <unsigned D1, unsigned D2>
...
inline void eval_subtract(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if (x < 0)
   {
      mpfi_add_ui(a.data(), y.data(), _Boost::multiprecision::detail::unsigned_abs(x));
      mpfi_neg(a.data(), a.data());
   }
   else
      mpfi_ui_sub(a.data(), x, y.data());
...
inline void eval_multiply(mpfi_float_backend<D1>& a, const mpfi_float_backend<D2>& x, long y)
{
   if (y < 0)
   {
      mpfi_mul_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
      a.negate();
   }
   else
      mpfi_mul_ui(a.data(), x.data(), y);
...
inline void eval_multiply(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if (x < 0)
   {
      mpfi_mul_ui(a.data(), y.data(), _Boost::multiprecision::detail::unsigned_abs(x));
      mpfi_neg(a.data(), a.data());
   }
   else
      mpfi_mul_ui(a.data(), y.data(), x);
...
inline void eval_divide(mpfi_float_backend<D1>& a, const mpfi_float_backend<D2>& x, long y)
{
   if (y < 0)
   {
      mpfi_div_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y));
      a.negate();
   }
   else
      mpfi_div_ui(a.data(), x.data(), y);
...
inline void eval_divide(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if (x < 0)
   {
      mpfi_ui_div(a.data(), _Boost::multiprecision::detail::unsigned_abs(x), y.data());
      mpfi_neg(a.data(), a.data());
   }
   else
      mpfi_ui_div(a.data(), x, y.data());
...
#ifdef _MPFR_H_HAVE_INTMAX_T
template <unsigned digits10>
inline void eval_convert_to(_Boost::ulong_long_type* result, const mpfi_float_backend<digits10>& val)
{
   mpfr_float_backend<digits10> t;
   mpfi_mid(t.data(), val.data());
   eval_convert_to(result, t);
...
template <unsigned digits10>
inline void eval_convert_to(_Boost::long_long_type* result, const mpfi_float_backend<digits10>& val)
{
   mpfr_float_backend<digits10> t;
   mpfi_mid(t.data(), val.data());
   eval_convert_to(result, t);
...
template <unsigned Digits10, class V>
inline typename enable_if_c<_Boost::is_constructible<number<mpfr_float_backend<Digits10, allocate_dynamic>, et_on>, V>::value || _Boost::is_convertible<V, const char*>::value>::type
assign_components(mpfi_float_backend<Digits10>& result, const V& a, const V& b)
{
...
{
   typedef typename _Boost::multiprecision::detail::canonical<unsigned, mpfi_float_backend<Digits10> >::type ui_type;
   ...
   if (s < 0)
   {
      ...
      typename _Boost::multiprecision::detail::canonical<_Boost::uintmax_t, mpfi_float_backend<Digits10> >::type an;
...
inline std::size_t hash_value(const mpfi_float_backend<Digits10>& val)
{
   ...
   for (std::size_t i = 0; i < len; ++i)
      _Boost::hash_combine(result, val.left_data()[0]._mpfr_d[i]);
   _Boost::hash_combine(result, val.left_data()[0]._mpfr_exp);
   _Boost::hash_combine(result, val.left_data()[0]._mpfr_sign);

   len = val.right_data()[0]._mpfr_prec / mp_bits_per_limb;
   if (val.right_data()[0]._mpfr_prec % mp_bits_per_limb)
      ++len;
   for (std::size_t i = 0; i < len; ++i)
      _Boost::hash_combine(result, val.right_data()[0]._mpfr_d[i]);
   _Boost::hash_combine(result, val.right_data()[0]._mpfr_exp);
   _Boost::hash_combine(result, val.right_data()[0]._mpfr_sign);
   return result;
}
...
{
   using _Boost::multiprecision::detail::generic_interconvert;
...
using _Boost::multiprecision::backends::mpfi_float_backend;
...
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfr_float_backend<Digits10>, ExpressionTemplates> > precision_guard(val);
...
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfi_float_backend<Digits10>, ExpressionTemplates> > precision_guard(a, b);
...
//
template <unsigned Digits10, expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> asinh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfi_float_backend<Digits10>, ExpressionTemplates> > precision_guard(arg);

   _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result;
   mpfi_asinh(result.backend().data(), arg.backend().data());
   return result;
}
template <unsigned Digits10, expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> acosh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfi_float_backend<Digits10>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> atanh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfi_float_backend<Digits10>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> cbrt BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfi_float_backend<Digits10>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> expm1 BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfi_float_backend<Digits10>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> log1p BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<mpfi_float_backend<Digits10>, ExpressionTemplates> > precision_guard(arg);
...
template <>
inline int digits<_Boost::multiprecision::mpfi_float>()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
   return multiprecision::detail::digits10_2_2(_Boost::multiprecision::mpfi_float::default_precision());
}
template <>
inline int digits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, _Boost::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
...
template <>
inline _Boost::multiprecision::mpfi_float
max_value<_Boost::multiprecision::mpfi_float>()
{
   _Boost::multiprecision::mpfi_float result(0.5);
...
template <>
inline _Boost::multiprecision::mpfi_float
min_value<_Boost::multiprecision::mpfi_float>()
{
   _Boost::multiprecision::mpfi_float result(0.5);
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, _Boost::multiprecision::et_off>
max_value<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, _Boost::multiprecision::et_off> >()
{
   _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, _Boost::multiprecision::et_off> result(0.5);
   mpfi_mul_2exp(result.backend().data(), result.backend().data(), mpfr_get_emax());
   //BOOST_ASSERT(mpfi_number_p(result.backend().data()));
   return result;
}
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, _Boost::multiprecision::et_off>
min_value<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, _Boost::multiprecision::et_off> >()
{
   _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, _Boost::multiprecision::et_off> result(0.5);
   mpfi_div_2exp(result.backend().data(), result.backend().data(), -mpfr_get_emin());
   //BOOST_ASSERT(mpfi_number_p(result.backend().data()));
...
typedef _Boost::multiprecision::number<_Boost::multiprecision::backends::logged_adaptor<_Boost::multiprecision::mpfi_float::backend_type>, _Boost::multiprecision::et_on>  logged_type1;
typedef _Boost::multiprecision::number<_Boost::multiprecision::backends::logged_adaptor<_Boost::multiprecision::mpfi_float::backend_type>, _Boost::multiprecision::et_off> logged_type2;
...
struct mpfi_initializer
{
   struct init
   {
      init()
      {
         _Boost::math::constants::pi<T>();
         _Boost::math::constants::ln_two<T>();
         _Boost::math::constants::euler<T>();
         _Boost::math::constants::catalan<T>();
      }
...
struct constant_pi<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template <int N>
   ...
   static inline result_type get(const _Boost::integral_constant<int, 0>&)
   {
      result_type result;
      mpfi_const_pi(result.backend().data());
      return result;
...
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_ln_two<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
...
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_euler<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template <int N>
   static inline result_type const& get(const _Boost::integral_constant<int, N>&)
   {
      mpfi_initializer<result_type>::force_instantiate();
      static result_type result;
      static bool        has_init = false;
...
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_catalan<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template <int N>
   static inline result_type const& get(const _Boost::integral_constant<int, N>&)
...
//
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> number_type;
 ...
 public:
   ...
   static number_type                        infinity()
   {
      ...
      if (!value.first)
      {
         _Boost::multiprecision::mpfr_float_backend<Digits10> t;
 ...
 private:
   struct data_initializer
   {
      data_initializer()
      {
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<digits10> > >::epsilon();
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<digits10> > >::round_error();
         (std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<digits10> > >::min)();
         (std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<digits10> > >::max)();
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<digits10> > >::infinity();
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<digits10> > >::quiet_NaN();
      }
...
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
const typename numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::data_initializer numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::initializer;

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::digits;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::radix;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::traps;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::round_style;

#endif

template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> number_type;
...
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::digits;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::max_digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_signed;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_integer;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_exact;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::radix;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::min_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::min_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::max_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::max_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_infinity;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_quiet_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_signaling_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_denorm;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_denorm_loss;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_iec559;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_bounded;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_modulo;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::traps;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::tinyness_before;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::round_style;
