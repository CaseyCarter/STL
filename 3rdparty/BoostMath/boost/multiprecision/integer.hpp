...
// be recognised by _Boost::int_t because they're larger than _Boost::long_long_type),
...
struct double_integer
{
   static const unsigned int_t_digits =
       2 * sizeof(I) <= sizeof(_Boost::long_long_type) ? std::numeric_limits<I>::digits * 2 : 1;

   typedef typename mpl::if_c<
       2 * sizeof(I) <= sizeof(_Boost::long_long_type),
       typename mpl::if_c<
           is_signed<I>::value,
           typename _Boost::int_t<int_t_digits>::least,
           typename _Boost::uint_t<int_t_digits>::least>::type,
       typename mpl::if_c<
