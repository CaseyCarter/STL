...
class number
{
 ...
 public:
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const V& v, typename _Boost::enable_if_c<
                                               (_Boost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value) && !is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value && !detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value
#ifdef BOOST_HAS_FLOAT128
                                               && !_Boost::is_same<V, __float128>::value
#endif
                                               >::type* = 0)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, typename _Boost::enable_if_c<
   ...
   {}
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, unsigned digits10, typename _Boost::enable_if_c<(_Boost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value) && !detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value && (_Boost::multiprecision::number_category<Backend>::value != _Boost::multiprecision::number_kind_complex) && (_Boost::multiprecision::number_category<Backend>::value != _Boost::multiprecision::number_kind_rational)
#ifdef BOOST_HAS_FLOAT128
                                                                                                          && !_Boost::is_same<V, __float128>::value
#endif
                                                                                                          >::type* = 0)
   ...
   template <class V>
   explicit BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const V& v, typename _Boost::enable_if_c<
                                                        (_Boost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value) && !detail::is_explicitly_convertible<typename detail::canonical<V, Backend>::type, Backend>::value && detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value>::type* = 0)
       BOOST_MP_NOEXCEPT_IF(noexcept(std::declval<Backend&>() = std::declval<typename detail::canonical<V, Backend>::type const&>()))
   {
      m_backend = canonical_value(v);
   }
   template <class V>
   explicit BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, typename _Boost::enable_if_c<
       ...
       : m_backend(canonical_value(v)) {}
   template <class V>
   explicit BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, unsigned digits10, typename _Boost::enable_if_c<(_Boost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value) && detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value && (_Boost::multiprecision::number_category<Backend>::value != _Boost::multiprecision::number_kind_complex) && (_Boost::multiprecision::number_category<Backend>::value != _Boost::multiprecision::number_kind_rational)>::type* = 0)
       : m_backend(canonical_value(v), digits10) {}
   ...
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const number<Other, ET>& val,
                               typename _Boost::enable_if_c<(_Boost::is_convertible<Other, Backend>::value && !detail::is_restricted_conversion<Other, Backend>::value)>::type* = 0)
       BOOST_MP_NOEXCEPT_IF(noexcept(Backend(std::declval<Other const&>())))
       : m_backend(val.backend()) {}

   template <class Other, expression_template_option ET>
   explicit BOOST_MP_CXX14_CONSTEXPR number(const number<Other, ET>& val, typename _Boost::enable_if_c<
   ...
   template <class Other, expression_template_option ET>
   explicit BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const number<Other, ET>& val, typename _Boost::enable_if_c<
                                                                          (detail::is_explicitly_convertible<Other, Backend>::value && (detail::is_restricted_conversion<Other, Backend>::value || !_Boost::is_convertible<Other, Backend>::value))>::type* = 0) BOOST_MP_NOEXCEPT_IF(noexcept(Backend(std::declval<Other const&>())))
       : m_backend(val.backend()) {}

   template <class V, class U>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const V& v1, const U& v2,
                               typename _Boost::enable_if_c<(is_convertible<V, value_type>::value && is_convertible<U, value_type>::value && !is_same<typename component_type<self_type>::type, self_type>::value)>::type* = 0)
   {
   ...
   BOOST_MP_FORCEINLINE explicit BOOST_MP_CXX14_CONSTEXPR number(const V& v1, const U& v2, unsigned digits10,
                                        typename _Boost::enable_if_c<((is_constructible<value_type, V>::value || is_convertible<V, std::string>::value) && (is_constructible<value_type, U>::value || is_convertible<U, std::string>::value) && !is_same<typename component_type<self_type>::type, self_type>::value) && !(is_convertible<V, value_type>::value && is_convertible<U, value_type>::value)>::type* = 0)
       : m_backend(canonical_value(detail::evaluate_if_expression(v1)), canonical_value(detail::evaluate_if_expression(v2)), digits10) {}

   template <class Other, expression_template_option ET>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR number(const number<Other, ET>& v1, const number<Other, ET>& v2, typename _Boost::enable_if_c<_Boost::is_convertible<Other, Backend>::value>::type* = 0)
   {
      using default_ops::assign_components;
      detail::scoped_default_precision<number<Backend, ExpressionTemplates> > precision_guard(v1, v2);
   ...
   BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value, number&>::type operator=(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e)
   {
      ...
      if (precision_guard.precision() != _Boost::multiprecision::detail::current_precision_of(*this))
      {
         number t(e);
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<is_convertible<V, self_type>::value, number<Backend, ExpressionTemplates>&>::type
   operator=(const V& v)
   ...
   template <class Other, expression_template_option ET>
   BOOST_MP_CXX14_CONSTEXPR typename _Boost::disable_if<_Boost::multiprecision::detail::is_explicitly_convertible<Other, Backend>, number<Backend, ExpressionTemplates>&>::type
   ...
   template <class tag, class Arg1, class Arg2, class Arg3, class Arg4>
   BOOST_MP_CXX14_CONSTEXPR number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e, typename _Boost::enable_if_c<is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = 0)
   {
      //
   ...
   explicit BOOST_MP_CXX14_CONSTEXPR number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e,
                   typename _Boost::enable_if_c<!is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value && _Boost::multiprecision::detail::is_explicitly_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = 0)
   {
      //
   ...
   template <class V>
   typename _Boost::enable_if_c<_Boost::is_convertible<V, self_type>::value, number<Backend, ExpressionTemplates>&>::type
   ...
   template <class V>
   BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<V, self_type>::value, number<Backend, ExpressionTemplates>&>::type
   operator-=(const V& v)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<is_integral<V>::value, number&>::type operator<<=(V val)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<_Boost::is_convertible<V, self_type>::value, number<Backend, ExpressionTemplates>&>::type
   operator/=(const V& v)
   {
   ...
   {
      ar& _Boost::make_nvp("backend", m_backend);
   }
 ...
 public:
   ...
   // an arithmetic type:
   //
   template <class T, typename _Boost::enable_if_c<is_same<T, bool>::value, int>::type = 0>
   explicit operator T() const
   {
      using default_ops::eval_is_zero;
      return !eval_is_zero(backend());
   }
   template <class T, typename _Boost::disable_if_c<is_same<T, bool>::value || is_void<T>::value, int>::type = 0>
   explicit operator T() const
   {
   ...
   template <class T>
#else
   template <class T, class = typename _Boost::disable_if_c<_Boost::is_constructible<T, self_type const&>::value || !_Boost::is_default_constructible<T>::value || (!_Boost::is_arithmetic<T>::value && !_Boost::is_complex<T>::value), T>::type>
#endif
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename _Boost::enable_if_c<is_arithmetic<V>::value && (number_category<Backend>::value != number_kind_complex), int>::type compare(const V& o) const
   {
      using default_ops::eval_get_sign;
      if (o == 0)
         return eval_get_sign(m_backend);
   ...
   template <class T>
   inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<_Boost::is_convertible<T, self_type>::value, self_type&>::type real(const T& val)
   {
   ...
   template <class T>
   inline BOOST_MP_CXX14_CONSTEXPR typename enable_if_c<_Boost::is_convertible<T, self_type>::value && number_category<self_type>::value == number_kind_complex, self_type&>::type imag(const T& val)
   {
 ...
 private:
   ...
   {
      using default_ops::eval_add;
      _Boost::multiprecision::detail::maybe_promote_precision(this);
   ...
   //
   template <class Exp>
   BOOST_MP_CXX14_CONSTEXPR typename _Boost::disable_if_c<_Boost::multiprecision::number_category<self_type>::value == _Boost::multiprecision::number_kind_integer || sizeof(Exp) == 1>::type
 ...
 public:
   ...
   template <class V>
   static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR typename _Boost::disable_if<is_same<typename detail::canonical<V, Backend>::type, V>, typename detail::canonical<V, Backend>::type>::type
   canonical_value(const V& v) BOOST_NOEXCEPT { return static_cast<typename detail::canonical<V, Backend>::type>(v); }
   template <class V>
   static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR typename _Boost::enable_if_c<is_same<typename detail::canonical<V, Backend>::type, V>::value, const V&>::type
...
inline std::istream& operator>>(std::istream& is, number<Backend, ExpressionTemplates>& r)
{
   ...
   std::string s;
   switch (_Boost::multiprecision::number_category<number<Backend, ExpressionTemplates> >::value)
   {
   case _Boost::multiprecision::number_kind_integer:
      if (oct_format)
      ...
      break;
   case _Boost::multiprecision::number_kind_floating_point:
...
inline BOOST_MP_CXX14_CONSTEXPR std::size_t hash_value(const rational<multiprecision::number<T, ExpressionTemplates> >& val)
{
   ...
   _Boost::hash_combine(result, hash_value(val.denominator()));
   return result;
}
...
template <class I>
struct component_type<_Boost::rational<I> >
{
   typedef I type;
};
...
template <class Backend, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct hash<_Boost::multiprecision::number<Backend, ExpressionTemplates> >
{
   BOOST_MP_CXX14_CONSTEXPR std::size_t operator()(const _Boost::multiprecision::number<Backend, ExpressionTemplates>& val) const { return hash_value(val); }
};
template <class Backend, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct hash<_Boost::rational<_Boost::multiprecision::number<Backend, ExpressionTemplates> > >
{
   BOOST_MP_CXX14_CONSTEXPR std::size_t operator()(const _Boost::rational<_Boost::multiprecision::number<Backend, ExpressionTemplates> >& val) const
   {
      std::size_t result = hash_value(val.numerator());
      _Boost::hash_combine(result, hash_value(val.denominator()));
      return result;
