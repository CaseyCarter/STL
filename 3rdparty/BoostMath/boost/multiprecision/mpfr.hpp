...
struct mpfr_float_imp<digits10, allocate_dynamic>
{
   ...
   typedef mpl::list<long, _Boost::long_long_type>           signed_types;
   typedef mpl::list<unsigned long, _Boost::ulong_long_type> unsigned_types;
#else
   ...
   mpfr_float_imp& operator=(_Boost::ulong_long_type i)
   {
      if (m_data[0]._mpfr_d == 0)
         mpfr_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
   ...
   mpfr_float_imp& operator=(_Boost::long_long_type i)
   {
      if (m_data[0]._mpfr_d == 0)
         mpfr_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
   ...
   mpfr_float_imp& operator=(_Boost::ulong_long_type i)
   {
      if (m_data[0]._mpfr_d == 0)
         mpfr_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
      _Boost::ulong_long_type mask  = ((((1uLL << (std::numeric_limits<unsigned long>::digits - 1)) - 1) << 1) | 1uLL);
      unsigned               shift = 0;
      mpfr_t                 t;
      mpfr_init2(t, (std::max)(static_cast<unsigned long>(std::numeric_limits<_Boost::ulong_long_type>::digits), mpfr_get_prec(m_data)));
   ...
   mpfr_float_imp& operator=(_Boost::long_long_type i)
   {
      if (m_data[0]._mpfr_d == 0)
         mpfr_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : (unsigned)get_default_precision()));
      bool neg = i < 0;
      *this    = _Boost::multiprecision::detail::unsigned_abs(i);
      if (neg)
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f) const
   {
      ...
      _Boost::multiprecision::detail::format_float_string(result, e, org_digits, f, 0 != mpfr_zero_p(m_data));
      return result;
   }
 ...
 protected:
   mpfr_t           m_data;
   static _Boost::multiprecision::detail::precision_type& get_default_precision() BOOST_NOEXCEPT
   {
      static _Boost::multiprecision::detail::precision_type val(BOOST_MULTIPRECISION_MPFR_DEFAULT_PRECISION);
      return val;
   }
};
...
struct mpfr_float_imp<digits10, allocate_stack>
{
   ...
   mpfr_float_imp& operator=(_Boost::ulong_long_type i)
   {
      _Boost::ulong_long_type mask  = ((((1uLL << (std::numeric_limits<unsigned long>::digits - 1)) - 1) << 1) | 1uL);
      unsigned               shift = 0;
      mpfr_t                 t;
...
inline void eval_add(mpfr_float_backend<digits10, AllocationType>& result, long i)
{
   if (i > 0)
      ...
      mpfr_sub_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
}
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_subtract(mpfr_float_backend<digits10, AllocationType>& result, long i)
{
   if (i > 0)
      ...
      mpfr_add_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
}
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_multiply(mpfr_float_backend<digits10, AllocationType>& result, long i)
{
   mpfr_mul_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
   if (i < 0)
...
{
   mpfr_div_ui(result.data(), result.data(), _Boost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
   if (i < 0)
      mpfr_neg(result.data(), result.data(), GMP_RNDN);
}
//
...
{
   if (y < 0)
      mpfr_sub_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
   else
      mpfr_add_ui(a.data(), x.data(), y, GMP_RNDN);
}
template <unsigned D1, unsigned D2, mpfr_allocation_type A1, mpfr_allocation_type A2>
...
inline void eval_add(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if (x < 0)
   {
      mpfr_ui_sub(a.data(), _Boost::multiprecision::detail::unsigned_abs(x), y.data(), GMP_RNDN);
...
{
   if (y < 0)
      mpfr_add_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
   else
      mpfr_sub_ui(a.data(), x.data(), y, GMP_RNDN);
}
template <unsigned D1, unsigned D2, mpfr_allocation_type A1, mpfr_allocation_type A2>
...
inline void eval_subtract(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if (x < 0)
   {
      mpfr_add_ui(a.data(), y.data(), _Boost::multiprecision::detail::unsigned_abs(x), GMP_RNDN);
      mpfr_neg(a.data(), a.data(), GMP_RNDN);
   }
   else
      mpfr_ui_sub(a.data(), x, y.data(), GMP_RNDN);
...
inline void eval_multiply(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y)
{
   if (y < 0)
   {
      mpfr_mul_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
      a.negate();
   }
   else
      mpfr_mul_ui(a.data(), x.data(), y, GMP_RNDN);
...
inline void eval_multiply(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if (x < 0)
   {
      mpfr_mul_ui(a.data(), y.data(), _Boost::multiprecision::detail::unsigned_abs(x), GMP_RNDN);
      mpfr_neg(a.data(), a.data(), GMP_RNDN);
   }
   else
      mpfr_mul_ui(a.data(), y.data(), x, GMP_RNDN);
...
inline void eval_divide(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y)
{
   if (y < 0)
   {
      mpfr_div_ui(a.data(), x.data(), _Boost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
      a.negate();
   }
   else
      mpfr_div_ui(a.data(), x.data(), y, GMP_RNDN);
...
inline void eval_divide(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if (x < 0)
   {
      mpfr_ui_div(a.data(), _Boost::multiprecision::detail::unsigned_abs(x), y.data(), GMP_RNDN);
      mpfr_neg(a.data(), a.data(), GMP_RNDN);
   }
   else
      mpfr_ui_div(a.data(), x, y.data(), GMP_RNDN);
...
#ifdef _MPFR_H_HAVE_INTMAX_T
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_convert_to(_Boost::ulong_long_type* result, const mpfr_float_backend<digits10, AllocationType>& val)
{
   if (mpfr_nan_p(val.data()))
   {
      BOOST_THROW_EXCEPTION(std::runtime_error("Could not convert NaN to integer."));
...
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_convert_to(_Boost::long_long_type* result, const mpfr_float_backend<digits10, AllocationType>& val)
{
   if (mpfr_nan_p(val.data()))
   {
      BOOST_THROW_EXCEPTION(std::runtime_error("Could not convert NaN to integer."));
...
inline std::size_t hash_value(const mpfr_float_backend<Digits10, AllocateType>& val)
{
   ...
   for (std::size_t i = 0; i < len; ++i)
      _Boost::hash_combine(result, val.data()[0]._mpfr_d[i]);
   _Boost::hash_combine(result, val.data()[0]._mpfr_exp);
   _Boost::hash_combine(result, val.data()[0]._mpfr_sign);
   return result;
}
...
using _Boost::multiprecision::backends::mpfr_float_backend;
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> copysign BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& a, const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& b)
{
   return (_Boost::multiprecision::signbit)(a) != (_Boost::multiprecision::signbit)(b) ? _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>(-a) : a;
}

template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> copysign BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates>& a, const _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates>& b)
{
   return (_Boost::multiprecision::signbit)(a) != (_Boost::multiprecision::signbit)(b) ? _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates>(-a) : a;
}
...
using _Boost::multiprecision::copysign;
using _Boost::multiprecision::signbit;

namespace tools {

template <>
inline int digits<_Boost::multiprecision::mpfr_float>()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
   return multiprecision::detail::digits10_2_2(_Boost::multiprecision::mpfr_float::default_precision());
}
template <>
inline int digits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, _Boost::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
...
template <>
inline _Boost::multiprecision::mpfr_float
max_value<_Boost::multiprecision::mpfr_float>()
{
   _Boost::multiprecision::mpfr_float result(0.5);
...
template <>
inline _Boost::multiprecision::mpfr_float
min_value<_Boost::multiprecision::mpfr_float>()
{
   _Boost::multiprecision::mpfr_float result(0.5);
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, _Boost::multiprecision::et_off>
max_value<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, _Boost::multiprecision::et_off> >()
{
   _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, _Boost::multiprecision::et_off> result(0.5);
   mpfr_mul_2exp(result.backend().data(), result.backend().data(), mpfr_get_emax(), GMP_RNDN);
   BOOST_ASSERT(mpfr_number_p(result.backend().data()));
   return result;
}
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, _Boost::multiprecision::et_off>
min_value<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, _Boost::multiprecision::et_off> >()
{
   _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, _Boost::multiprecision::et_off> result(0.5);
   mpfr_div_2exp(result.backend().data(), result.backend().data(), -mpfr_get_emin(), GMP_RNDN);
   BOOST_ASSERT(mpfr_number_p(result.backend().data()));
...
template <>
inline int digits<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float::backend_type> > >()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
   return multiprecision::detail::digits10_2_2(_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float::backend_type> >::default_precision());
}
template <>
inline int digits<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<0> >, _Boost::multiprecision::et_off> >()
#ifdef BOOST_MATH_NOEXCEPT
    BOOST_NOEXCEPT
#endif
{
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float::backend_type> >
max_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float::backend_type> > >()
{
   return max_value<_Boost::multiprecision::mpfr_float>().backend();
}

template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float::backend_type> >
min_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float::backend_type> > >()
{
   return min_value<_Boost::multiprecision::mpfr_float>().backend();
}

template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<0> >, _Boost::multiprecision::et_off>
max_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<0> >, _Boost::multiprecision::et_off> >()
{
   return max_value<_Boost::multiprecision::mpfr_float>().backend();
}
...
template <>
inline _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<0> >, _Boost::multiprecision::et_off>
min_value<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<0> >, _Boost::multiprecision::et_off> >()
{
   return min_value<_Boost::multiprecision::mpfr_float>().backend();
}
...
struct mpfr_constant_initializer
{
 ...
 private:
   struct initializer
   {
      initializer()
      {
         T::get(_Boost::integral_constant<int, N>());
      }
      void force_instantiate() const {}
   };
   static const initializer init;
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_pi<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_pi<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
   ...
   static inline const result_type get(const _Boost::integral_constant<int, 0>&)
   {
      result_type result;
      mpfr_const_pi(result.backend().data(), GMP_RNDN);
      return result;
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_ln_two<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_ln_two<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_euler<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_euler<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool        init = false;
      if (!init)
      {
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_catalan<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_catalan<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool        init = false;
      if (!init)
      {
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_pi<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_pi<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool        has_init = false;
      if (!has_init)
      {
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_ln_two<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_ln_two<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool        init = false;
      if (!init)
      {
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_euler<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_euler<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool        init = false;
      if (!init)
      {
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_catalan<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> result_type;
   template <int N>
   static inline const result_type& get(const _Boost::integral_constant<int, N>&)
   {
      detail::mpfr_constant_initializer<constant_catalan<_Boost::multiprecision::number<_Boost::multiprecision::debug_adaptor<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool        init = false;
      if (!init)
      {
...
//
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> asinh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);

   _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result;
   mpfr_asinh(result.backend().data(), arg.backend().data(), GMP_RNDN);
   return result;
}
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> acosh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> atanh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> cbrt BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> erf BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> erfc BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> expm1 BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> lgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> tgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> log1p BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   _Boost::multiprecision::detail::scoped_default_precision<number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
...
// Overloaded special functions which call native mpfr routines:
//
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> asinh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy&)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);

   _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result;
   mpfr_asinh(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("asinh<%1%>(%1%)", 0, Policy());
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> acosh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy&)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_acosh(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("acosh<%1%>(%1%)", 0, Policy());
   if (mpfr_nan_p(result.backend().data()))
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> atanh BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy& )
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_atanh(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("atanh<%1%>(%1%)", 0, Policy());
   if (mpfr_nan_p(result.backend().data()))
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> cbrt BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy&)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_cbrt(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("cbrt<%1%>(%1%)", 0, Policy());
   if (mpfr_nan_p(result.backend().data()))
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> erf BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy& pol)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_erf(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("erf<%1%>(%1%)", 0, pol);
   if (mpfr_nan_p(result.backend().data()))
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> erfc BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy& pol)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_erfc(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("erfc<%1%>(%1%)", 0, pol);
   if (mpfr_nan_p(result.backend().data()))
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> expm1 BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy& pol)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_expm1(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("expm1<%1%>(%1%)", 0, pol);
   if (mpfr_nan_p(result.backend().data()))
      return policies::raise_evaluation_error("expm1<%1%>(%1%)", "Unknown error, result is a NaN", result, pol);
   return result;
}
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> exm1 BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg)
{
   return expm1(arg, policies::policy<>());
}

template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> lgamma BOOST_PREVENT_MACRO_SUBSTITUTION(_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> arg, int* sign, const Policy& pol)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   {
      if (floor(arg) == arg)
         return policies::raise_pole_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >(
             "lgamma<%1%>", "Evaluation of lgamma at a negative integer %1%.", arg, pol);

      _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> t = detail::sinpx(arg);
      arg                                                                                                                     = -arg;
      if (t < 0)
      {
         t = -t;
      }
      result = _Boost::multiprecision::log(_Boost::math::constants::pi<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >()) - lgamma(arg, 0, pol) - _Boost::multiprecision::log(t);
      if (sign)
      {
         _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> phase = 1 - arg;
         phase                                                                                                                       = floor(phase) / 2;
   ...
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("lgamma<%1%>(%1%)", 0, pol);
   if (mpfr_nan_p(result.backend().data()))
      return policies::raise_evaluation_error("lgamma<%1%>(%1%)", "Unknown error, result is a NaN", result, pol);
   return result;
}
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> lgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, int* sign)
{
   return lgamma(arg, sign, policies::policy<>());
}
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> lgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy& pol)
{
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline typename _Boost::enable_if_c<_Boost::math::policies::is_policy<Policy>::value, _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::type tgamma BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy& pol)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_gamma(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("tgamma<%1%>(%1%)", 0, pol);
   if (mpfr_nan_p(result.backend().data()))
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
inline _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> log1p BOOST_PREVENT_MACRO_SUBSTITUTION(const _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>& arg, const Policy& pol)
{
   _Boost::multiprecision::detail::scoped_default_precision<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> > precision_guard(arg);
   ...
   mpfr_log1p(result.backend().data(), arg.backend().data(), GMP_RNDN);
   if (mpfr_inf_p(result.backend().data()))
      return policies::raise_overflow_error<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >("log1p<%1%>(%1%)", 0, pol);
   if (mpfr_nan_p(result.backend().data()))
...
//
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> number_type;
 ...
 private:
   struct data_initializer
   {
      data_initializer()
      {
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::epsilon();
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::round_error();
         (std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::min)();
         (std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::max)();
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::infinity();
         std::numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::quiet_NaN();
      }
...
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
const typename numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::data_initializer numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::initializer;

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::digits;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::radix;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::traps;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, _Boost::multiprecision::mpfr_allocation_type AllocateType, _Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::round_style;

#endif

template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >
{
   typedef _Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> number_type;
 ...
 public:
   ...
   {
      number_type value(1);
      mpfr_div_2exp(value.backend().data(), value.backend().data(), _Boost::multiprecision::detail::digits10_2_2(number_type::default_precision()) - 1, GMP_RNDN);
      return value;
   }
   static number_type round_error()
   {
...
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::digits;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_digits10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_signed;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_integer;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_exact;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::radix;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::min_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::min_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_exponent;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_exponent10;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_infinity;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_quiet_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_signaling_NaN;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_denorm;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_denorm_loss;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_iec559;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_bounded;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_modulo;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::traps;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::tinyness_before;
template <_Boost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<_Boost::multiprecision::number<_Boost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::round_style;
