...
struct alpha_holder
{
   typedef _Boost::intrusive::detail::h_alpha_t           h_alpha_t;
   typedef _Boost::intrusive::detail::alpha_by_max_size_t multiply_by_alpha_t;
...
struct alpha_holder<false, SizeType>
{
   ...
   typedef _Boost::intrusive::detail::h_alpha_sqrt2_t           h_alpha_t;
   typedef _Boost::intrusive::detail::alpha_0_75_by_max_size_t  multiply_by_alpha_t;
   ...
   /// @endcond
{
   ...
   //! @copydoc ::_Boost::intrusive::bstree::bstree()
   sgtree_impl()
      :  tree_type()
   {}

   //! @copydoc ::_Boost::intrusive::bstree::bstree(const key_compare &,const value_traits &)
   explicit sgtree_impl( const key_compare &cmp, const value_traits &v_traits = value_traits())
      :  tree_type(cmp, v_traits)
   {}

   //! @copydoc ::_Boost::intrusive::bstree::bstree(bool,Iterator,Iterator,const key_compare &,const value_traits &)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::bstree(bstree &&)
   sgtree_impl(BOOST_RV_REF(sgtree_impl) x)
      :  tree_type(BOOST_MOVE_BASE(tree_type, x)), alpha_traits(x.get_alpha_traits())
   {  ::_Boost::adl_move_swap(this->get_alpha_traits(), x.get_alpha_traits());   }

   //! @copydoc ::_Boost::intrusive::bstree::operator=(bstree &&)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::begin()
   iterator begin();

   //! @copydoc ::_Boost::intrusive::bstree::begin()const
   const_iterator begin() const;

   //! @copydoc ::_Boost::intrusive::bstree::cbegin()const
   const_iterator cbegin() const;

   //! @copydoc ::_Boost::intrusive::bstree::end()
   iterator end();

   //! @copydoc ::_Boost::intrusive::bstree::end()const
   const_iterator end() const;

   //! @copydoc ::_Boost::intrusive::bstree::cend()const
   const_iterator cend() const;

   //! @copydoc ::_Boost::intrusive::bstree::rbegin()
   reverse_iterator rbegin();

   //! @copydoc ::_Boost::intrusive::bstree::rbegin()const
   const_reverse_iterator rbegin() const;

   //! @copydoc ::_Boost::intrusive::bstree::crbegin()const
   const_reverse_iterator crbegin() const;

   //! @copydoc ::_Boost::intrusive::bstree::rend()
   reverse_iterator rend();

   //! @copydoc ::_Boost::intrusive::bstree::rend()const
   const_reverse_iterator rend() const;

   //! @copydoc ::_Boost::intrusive::bstree::crend()const
   const_reverse_iterator crend() const;

   //! @copydoc ::_Boost::intrusive::bstree::root()
   iterator root();

   //! @copydoc ::_Boost::intrusive::bstree::root()const
   const_iterator root() const;

   //! @copydoc ::_Boost::intrusive::bstree::croot()const
   const_iterator croot() const;

   //! @copydoc ::_Boost::intrusive::bstree::container_from_end_iterator(iterator)
   static sgtree_impl &container_from_end_iterator(iterator end_iterator);

   //! @copydoc ::_Boost::intrusive::bstree::container_from_end_iterator(const_iterator)
   static const sgtree_impl &container_from_end_iterator(const_iterator end_iterator);

   //! @copydoc ::_Boost::intrusive::bstree::container_from_iterator(iterator)
   static sgtree_impl &container_from_iterator(iterator it);

   //! @copydoc ::_Boost::intrusive::bstree::container_from_iterator(const_iterator)
   static const sgtree_impl &container_from_iterator(const_iterator it);

   //! @copydoc ::_Boost::intrusive::bstree::key_comp()const
   key_compare key_comp() const;

   //! @copydoc ::_Boost::intrusive::bstree::value_comp()const
   value_compare value_comp() const;

   //! @copydoc ::_Boost::intrusive::bstree::empty()const
   bool empty() const;

   //! @copydoc ::_Boost::intrusive::bstree::size()const
   size_type size() const;

   #endif   //#ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED

   //! @copydoc ::_Boost::intrusive::bstree::swap
   void swap(sgtree_impl& other)
   {
      //This can throw
      this->tree_type::swap(static_cast<tree_type&>(other));
      ::_Boost::adl_move_swap(this->get_alpha_traits(), other.get_alpha_traits());
   }

   //! @copydoc ::_Boost::intrusive::bstree::clone_from(const bstree&,Cloner,Disposer)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::clone_from(bstree&&,Cloner,Disposer)
   //! Additional notes: it also copies the alpha factor from the source container.
   template <class Cloner, class Disposer>
   void clone_from(BOOST_RV_REF(sgtree_impl) src, Cloner cloner, Disposer disposer)
   {
      tree_type::clone_from(BOOST_MOVE_BASE(tree_type, src), cloner, disposer);
      this->get_alpha_traits() = ::_Boost::move(src.get_alpha_traits());
   }

   //! @copydoc ::_Boost::intrusive::bstree::insert_equal(reference)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_equal(const_iterator,reference)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_equal(Iterator,Iterator)
   template<class Iterator>
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_unique(reference)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_unique(const_iterator,reference)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_unique_check(const KeyType&,KeyTypeKeyCompare,insert_commit_data&)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_unique_check(const_iterator,const KeyType&,KeyTypeKeyCompare,insert_commit_data&)
   template<class KeyType, class KeyTypeKeyCompare>
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_unique_check(const key_type&,insert_commit_data&)
   std::pair<iterator, bool> insert_unique_check
      (const key_type &key, insert_commit_data &commit_data)
   {  return this->insert_unique_check(key, this->key_comp(), commit_data);   }

   //! @copydoc ::_Boost::intrusive::bstree::insert_unique_check(const_iterator,const key_type&,insert_commit_data&)
   std::pair<iterator, bool> insert_unique_check
      (const_iterator hint, const key_type &key, insert_commit_data &commit_data)
   {  return this->insert_unique_check(hint, key, this->key_comp(), commit_data);   }

   //! @copydoc ::_Boost::intrusive::bstree::insert_unique_commit
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_unique(Iterator,Iterator)
   template<class Iterator>
   ...
   //! @copydoc ::_Boost::intrusive::bstree::insert_before
   ...
   //! @copydoc ::_Boost::intrusive::bstree::push_back
   ...
   //! @copydoc ::_Boost::intrusive::bstree::push_front
   ...
   //! @copydoc ::_Boost::intrusive::bstree::erase(const_iterator)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::erase(const_iterator,const_iterator)
   iterator erase(const_iterator b, const_iterator e)
   {  size_type n;   return private_erase(b, e, n);   }

   //! @copydoc ::_Boost::intrusive::bstree::erase(const key_type &)
   size_type erase(const key_type &key)
   {  return this->erase(key, this->key_comp());   }

   //! @copydoc ::_Boost::intrusive::bstree::erase(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   ...
   //! @copydoc ::_Boost::intrusive::bstree::erase_and_dispose(const_iterator,Disposer)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::erase_and_dispose(const_iterator,const_iterator,Disposer)
   template<class Disposer>
   iterator erase_and_dispose(const_iterator b, const_iterator e, Disposer disposer)
   {  size_type n;   return private_erase(b, e, n, disposer);   }

   //! @copydoc ::_Boost::intrusive::bstree::erase_and_dispose(const key_type &, Disposer)
   template<class Disposer>
   ...
   //! @copydoc ::_Boost::intrusive::bstree::erase_and_dispose(const KeyType&,KeyTypeKeyCompare,Disposer)
   ...
   //! @copydoc ::_Boost::intrusive::bstree::clear
   void clear()
   {
      tree_type::clear();
   ...
   //! @copydoc ::_Boost::intrusive::bstree::clear_and_dispose
   template<class Disposer>
   ...
   #if defined(BOOST_INTRUSIVE_DOXYGEN_INVOKED)
   //! @copydoc ::_Boost::intrusive::bstree::merge_unique
   ...
   #if defined(BOOST_INTRUSIVE_DOXYGEN_INVOKED)
   //! @copydoc ::_Boost::intrusive::bstree::merge_equal
   ...
   #ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
   //! @copydoc ::_Boost::intrusive::bstree::count(const key_type &)const
   size_type count(const key_type &key) const;

   //! @copydoc ::_Boost::intrusive::bstree::count(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   size_type count(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::_Boost::intrusive::bstree::lower_bound(const key_type &)
   iterator lower_bound(const key_type &key);

   //! @copydoc ::_Boost::intrusive::bstree::lower_bound(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   iterator lower_bound(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::_Boost::intrusive::bstree::lower_bound(const key_type &)const
   const_iterator lower_bound(const key_type &key) const;

   //! @copydoc ::_Boost::intrusive::bstree::lower_bound(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   const_iterator lower_bound(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::_Boost::intrusive::bstree::upper_bound(const key_type &)
   iterator upper_bound(const key_type &key);

   //! @copydoc ::_Boost::intrusive::bstree::upper_bound(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   iterator upper_bound(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::_Boost::intrusive::bstree::upper_bound(const key_type &)const
   const_iterator upper_bound(const key_type &key) const;

   //! @copydoc ::_Boost::intrusive::bstree::upper_bound(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   const_iterator upper_bound(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::_Boost::intrusive::bstree::find(const key_type &)
   iterator find(const key_type &key);

   //! @copydoc ::_Boost::intrusive::bstree::find(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   iterator find(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::_Boost::intrusive::bstree::find(const key_type &)const
   const_iterator find(const key_type &key) const;

   //! @copydoc ::_Boost::intrusive::bstree::find(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   const_iterator find(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::_Boost::intrusive::bstree::equal_range(const key_type &)
   std::pair<iterator,iterator> equal_range(const key_type &key);

   //! @copydoc ::_Boost::intrusive::bstree::equal_range(const KeyType&,KeyTypeKeyCompare)
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<iterator,iterator> equal_range(const KeyType& key, KeyTypeKeyCompare comp);

   //! @copydoc ::_Boost::intrusive::bstree::equal_range(const key_type &)const
   std::pair<const_iterator, const_iterator>
      equal_range(const key_type &key) const;

   //! @copydoc ::_Boost::intrusive::bstree::equal_range(const KeyType&,KeyTypeKeyCompare)const
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<const_iterator, const_iterator>
      equal_range(const KeyType& key, KeyTypeKeyCompare comp) const;

   //! @copydoc ::_Boost::intrusive::bstree::bounded_range(const key_type &,const key_type &,bool,bool)
   std::pair<iterator,iterator> bounded_range
      (const key_type &lower_key, const key_type &upper_key, bool left_closed, bool right_closed);

   //! @copydoc ::_Boost::intrusive::bstree::bounded_range(const KeyType&,const KeyType&,KeyTypeKeyCompare,bool,bool)
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<iterator,iterator> bounded_range
      (const KeyType& lower_key, const KeyType& upper_key, KeyTypeKeyCompare comp, bool left_closed, bool right_closed);

   //! @copydoc ::_Boost::intrusive::bstree::bounded_range(const key_type &,const key_type &,bool,bool)const
   std::pair<const_iterator, const_iterator>
      bounded_range(const key_type &lower_key, const key_type &upper_key, bool left_closed, bool right_closed) const;

   //! @copydoc ::_Boost::intrusive::bstree::bounded_range(const KeyType&,const KeyType&,KeyTypeKeyCompare,bool,bool)const
   template<class KeyType, class KeyTypeKeyCompare>
   std::pair<const_iterator, const_iterator> bounded_range
         (const KeyType& lower_key, const KeyType& upper_key, KeyTypeKeyCompare comp, bool left_closed, bool right_closed) const;

   //! @copydoc ::_Boost::intrusive::bstree::s_iterator_to(reference)
   static iterator s_iterator_to(reference value);

   //! @copydoc ::_Boost::intrusive::bstree::s_iterator_to(const_reference)
   static const_iterator s_iterator_to(const_reference value);

   //! @copydoc ::_Boost::intrusive::bstree::iterator_to(reference)
   iterator iterator_to(reference value);

   //! @copydoc ::_Boost::intrusive::bstree::iterator_to(const_reference)const
   const_iterator iterator_to(const_reference value) const;

   //! @copydoc ::_Boost::intrusive::bstree::init_node(reference)
   static void init_node(reference value);

   //! @copydoc ::_Boost::intrusive::bstree::unlink_leftmost_without_rebalance
   pointer unlink_leftmost_without_rebalance();

   //! @copydoc ::_Boost::intrusive::bstree::replace_node
   void replace_node(iterator replace_this, reference with_this);

   //! @copydoc ::_Boost::intrusive::bstree::remove_node
   void remove_node(reference value);

   //! @copydoc ::_Boost::intrusive::bstree::rebalance
   void rebalance();

   //! @copydoc ::_Boost::intrusive::bstree::rebalance_subtree
