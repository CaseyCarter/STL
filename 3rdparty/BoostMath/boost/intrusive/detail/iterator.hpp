...
using _Boost::movelib::iterator_traits;
...
template<class Category, class Traversal>
struct is_boost_iterator< _Boost::iterators::detail::iterator_category_with_traversal<Category, Traversal> >
{
...
struct iterator_enable_if_boost_iterator
   : ::_Boost::move_detail::enable_if_c
      < is_boost_iterator<typename _Boost::intrusive::iterator_traits<I>::iterator_category >::value
      , R>
{};
...
struct iterator_enable_if_tag
   : ::_Boost::move_detail::enable_if_c
      < ::_Boost::move_detail::is_same
         < typename _Boost::intrusive::iterator_traits<I>::iterator_category 
         , Tag
         >::value
         , R>
{};
...
struct iterator_enable_if_convertible_tag
   : ::_Boost::move_detail::enable_if_c
      < ::_Boost::move_detail::is_same_or_convertible
         < typename _Boost::intrusive::iterator_traits<I>::iterator_category 
         , Tag
         >::value &&
        !::_Boost::move_detail::is_same_or_convertible
...
struct iterator_enable_if_tag_difference_type
   : iterator_enable_if_tag<I, Tag, typename _Boost::intrusive::iterator_traits<I>::difference_type>
{};

template<class I, class Tag>
struct iterator_disable_if_tag_difference_type
   : iterator_disable_if_tag<I, Tag, typename _Boost::intrusive::iterator_traits<I>::difference_type>
{};
...
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag
   <InputIt, const _Boost::iterators::incrementable_traversal_tag&, const _Boost::iterators::single_pass_traversal_tag&>::type
   iterator_advance(InputIt& it, Distance n)
{
   while(n--)
      ++it;
...
template<class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag
   <InputIt, const _Boost::iterators::single_pass_traversal_tag &, const _Boost::iterators::forward_traversal_tag&>::type
   iterator_advance(InputIt& it, Distance n)
{
   while(n--)
      ++it;
...
template<class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag
   <InputIt, const _Boost::iterators::forward_traversal_tag&, const _Boost::iterators::bidirectional_traversal_tag&>::type
   iterator_advance(InputIt& it, Distance n)
{
   while(n--)
      ++it;
...
template<class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag
   <InputIt, const _Boost::iterators::bidirectional_traversal_tag&, const _Boost::iterators::random_access_traversal_tag&>::type
   iterator_advance(InputIt& it, Distance n)
{
   for (; 0 < n; --n)
      ++it;
...
template<class InputIt, class Distance>
BOOST_INTRUSIVE_FORCEINLINE typename iterator_enable_if_convertible_tag
   <InputIt, const _Boost::iterators::random_access_traversal_tag&, const fake&>::type
   iterator_advance(InputIt& it, Distance n)
{
   it += n;
}
