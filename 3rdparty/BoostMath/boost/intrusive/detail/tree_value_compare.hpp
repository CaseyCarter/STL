      ...
      || detail::is_same
            <From, typename pointer_traits
                     < typename pointer_rebind
                           < ValuePtr
                           , const typename _Boost::movelib::pointer_element<ValuePtr>::type>::type>
                  ::reference>::value
      >
{};
...
template< class ValuePtr, class KeyCompare, class KeyOfValue, class Ret = bool
        , bool = _Boost::intrusive::detail::is_same
   <typename _Boost::movelib::pointer_element<ValuePtr>::type, typename KeyOfValue::type>::value >
