...
struct mhtraits
{
   ...
   BOOST_INTRUSIVE_FORCEINLINE static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(_Boost::movelib::to_raw_pointer(n)), P));
   }
   ...
   BOOST_INTRUSIVE_FORCEINLINE static const_pointer to_value_ptr(const const_node_ptr & n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(_Boost::movelib::to_raw_pointer(n)), P));
   }
};
...
struct fhtraits
{
   ...
   {  return static_cast<node*>(_Boost::movelib::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(_Boost::movelib::to_raw_pointer(Functor::to_hook_ptr(value)));  }
