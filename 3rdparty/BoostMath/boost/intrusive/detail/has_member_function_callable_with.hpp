...
namespace _Boost_intrusive_hmfcw {
...
BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG
   ...
   {
      template<class U>
      static decltype(_Boost::move_detail::declval<U>().
         BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(::_Boost::move_detail::declval<Args>()...)
            , _Boost_intrusive_hmfcw::yes_type()) Test(U* f);
      template<class U>
      static _Boost_intrusive_hmfcw::no_type Test(...);
      static const bool value = sizeof(Test<Fun>((Fun*)0)) == sizeof(_Boost_intrusive_hmfcw::yes_type);
   };
   ...
   class BOOST_MOVE_CAT(has_member_function_named_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)
   {
      ...
      struct Base
         : public _Boost_intrusive_hmfcw::remove_cv<Type>::type, public BaseMixin
      ...
      template <typename U>
      static _Boost_intrusive_hmfcw::no_type  deduce
         (U*, Helper<void (BaseMixin::*)(), &U::BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME>* = 0);
      static _Boost_intrusive_hmfcw::yes_type deduce(...);

      public:
      static const bool value = sizeof(_Boost_intrusive_hmfcw::yes_type) == sizeof(deduce((Base*)0));
   };
      ...
      struct FunWrapTmpl : Fun
      {
         ...
         _Boost_intrusive_hmfcw::private_type BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(DontCares...) const;
      };
      ...
      {
         static bool const value = (sizeof(_Boost_intrusive_hmfcw::no_type) == sizeof(_Boost_intrusive_hmfcw::is_private_type
                                             ( (::_Boost::move_detail::declval
                                                   < FunWrapTmpl<Fun> >().
                                                   BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(::_Boost::move_detail::declval<Args>()...), 0) )
                                          )
                                    );
      };
         ...
         <Fun, false BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_COMMA_IF BOOST_MOVE_CAT(BOOST_MOVE_TARG,BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_MAX)>
      {
         ...
         //0 arg specialization when BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME is present
            ...
            {
               template<class U>
               static decltype(_Boost::move_detail::declval<U>().BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME()
                  , _Boost_intrusive_hmfcw::yes_type()) Test(U* f);
               ...
               template<class F, std::size_t N = sizeof(_Boost::move_detail::declval<F>().BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME(), 0)>
               struct BOOST_MOVE_CAT(zeroarg_checker_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)
               {  _Boost_intrusive_hmfcw::yes_type dummy[N ? 1 : 2];   };
               ...
               struct BOOST_MOVE_CAT(has_member_function_callable_with_impl_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)<Fun, true>
               {
                  ...
                  template<class U> static _Boost_intrusive_hmfcw::no_type Test(...);
                  static const bool value = sizeof(Test< Fun >(0)) == sizeof(_Boost_intrusive_hmfcw::yes_type);
               };
         ...
         //Declare some unneeded default constructor as some old compilers wrongly require it with is_convertible
            ...
            {\
               ...
               _Boost_intrusive_hmfcw::private_type BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME\
                  (BOOST_MOVE_REPEAT##N(_Boost_intrusive_hmfcw::dont_care)) const;\
            };\
            \
