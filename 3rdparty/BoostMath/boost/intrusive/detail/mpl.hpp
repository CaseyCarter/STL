...
using _Boost::move_detail::remove_cv;
using _Boost::move_detail::remove_reference;
using _Boost::move_detail::add_reference;
using _Boost::move_detail::remove_pointer;
using _Boost::move_detail::add_pointer;
using _Boost::move_detail::true_type;
using _Boost::move_detail::false_type;
using _Boost::move_detail::voider;
using _Boost::move_detail::enable_if_c;
using _Boost::move_detail::enable_if;
using _Boost::move_detail::disable_if_c;
using _Boost::move_detail::disable_if;
using _Boost::move_detail::is_convertible;
using _Boost::move_detail::if_c;
using _Boost::move_detail::if_;
using _Boost::move_detail::is_const;
using _Boost::move_detail::identity;
using _Boost::move_detail::alignment_of;
using _Boost::move_detail::is_empty;
using _Boost::move_detail::addressof;
using _Boost::move_detail::integral_constant;
using _Boost::move_detail::enable_if_convertible;
using _Boost::move_detail::disable_if_convertible;
using _Boost::move_detail::bool_;
using _Boost::move_detail::true_;
using _Boost::move_detail::false_;
using _Boost::move_detail::yes_type;
using _Boost::move_detail::no_type;
using _Boost::move_detail::apply;
using _Boost::move_detail::eval_if_c;
using _Boost::move_detail::eval_if;
using _Boost::move_detail::unvoid_ref;
using _Boost::move_detail::add_const_if_c;
...
#define BOOST_INTRUSIVE_INSTANTIATE_EVAL_DEFAULT_TYPE_TMPLT(TNAME)\
   ...
   {                                                              \
      ...
      static const bool value = (1 == sizeof(test<T>(0, 0)));     \
                                                                  \
      typedef typename                                            \
         ::_Boost::intrusive::detail::eval_if_c                    \
            < value                                               \
            , ::_Boost::intrusive::detail::identity<T>             \
            , ::_Boost::intrusive::detail::identity<DefaultWrap>   \
            >::type::TNAME type;                                  \
   };                                                             \
//
...
#define BOOST_INTRUSIVE_HAS_STATIC_MEMBER_FUNC_SIGNATURE(TRAITS_NAME, FUNC_NAME) \
  ...
  template<typename T> \
  static ::_Boost::intrusive::detail::yes_type test(helper<&T::FUNC_NAME>*); \
  template<typename T> static ::_Boost::intrusive::detail::no_type test(...); \
  public: \
  static const bool value = sizeof(test<U>(0)) == sizeof(::_Boost::intrusive::detail::yes_type); \
  }; \
//
...
{ \
   ...
   template <typename U> \
   static ::_Boost::intrusive::detail::no_type  test(U*, Helper<void (BaseMixin::*)(), &U::FUNC_NAME>* = 0); \
   static ::_Boost::intrusive::detail::yes_type test(...); \
   static const bool value = sizeof(::_Boost::intrusive::detail::yes_type) == sizeof(test((Base*)(0))); \
};\
//
