...
struct bstbase3
{
   ...
   typedef _Boost::intrusive::reverse_iterator<iterator>                                         reverse_iterator;
   typedef _Boost::intrusive::reverse_iterator<const_iterator>                                   const_reverse_iterator;
   ...
   typedef typename _Boost::intrusive::value_traits_pointers
...
{
   typedef ::_Boost::intrusive::detail::identity<T> type;
};
...
{
   typedef typename
      _Boost::movelib::pointer_element<ValuePtr>::type value_type;
   ...
   :  public bstbase<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp, ConstantTimeSize, SizeType, AlgoType, HeaderHolder>
{
   ...
   typedef BOOST_INTRUSIVE_IMPDEF(_Boost::intrusive::reverse_iterator<iterator>)                 reverse_iterator;
   typedef BOOST_INTRUSIVE_IMPDEF(_Boost::intrusive::reverse_iterator<const_iterator>)           const_reverse_iterator;
   ...
   bstree_impl(BOOST_RV_REF(bstree_impl) x)
      : data_type(::_Boost::move(x.comp()), ::_Boost::move(x.get_value_traits()))
   {
      this->swap(x);
   }
   ...
   {
      //This can throw
      ::_Boost::adl_move_swap(this->comp(), other.comp());
      //These can't throw
   ...
   friend bool operator==(const bstree_impl &x, const bstree_impl &y)
   {
      ...
      return _Boost::intrusive::algo_equal(x.cbegin(), x.cend(), y.cbegin(), y.cend());
   }
   ...
   friend bool operator<(const bstree_impl &x, const bstree_impl &y)
   {  return ::_Boost::intrusive::algo_lexicographical_compare(x.begin(), x.end(), y.begin(), y.end());  }
