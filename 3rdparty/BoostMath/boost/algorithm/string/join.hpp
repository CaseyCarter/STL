...
//  join --------------------------------------------------------------//
        ...
        */
            ...
            const Range1T& Separator)
        {
            ...
            // Parse input
            InputIteratorT itBegin=::_Boost::begin(Input);
            InputIteratorT itEnd=::_Boost::end(Input);
            ...
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::_Boost::end(Result), *itBegin);
                ++itBegin;
            }
            ...
            {
                // Add separator
                detail::insert(Result, ::_Boost::end(Result), ::_Boost::as_literal(Separator));
                // Add element
                detail::insert(Result, ::_Boost::end(Result), *itBegin);
            }
