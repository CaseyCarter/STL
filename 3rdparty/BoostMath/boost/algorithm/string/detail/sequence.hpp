...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::_Boost::algorithm::detail::insert( Input, At, ::_Boost::begin(Insert), ::_Boost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::_Boost::algorithm::detail::replace( Input, From, To, ::_Boost::begin(Insert), ::_Boost::end(Insert) );
                }
                else
                {
                    ::_Boost::algorithm::detail::insert( Input, From, ::_Boost::begin(Insert), ::_Boost::end(Insert) );
                }
            }
