...
//  iterate find ---------------------------------------------------//
        ...
        /*!
            ...
            \param Result A 'container container' to contain the result of search.
                ...
                Typical type of the result is 
                    \c std::vector<_Boost::iterator_range<iterator>>
        ...
        */
            ...
            FinderT Finder )
        {
            ...
            input_iterator_type InputEnd=::_Boost::end(lit_input);

            typedef transform_iterator<copy_range_type, find_iterator_type>
                transform_iter_type;
    
            transform_iter_type itBegin=
                ::_Boost::make_transform_iterator( 
                    find_iterator_type( ::_Boost::begin(lit_input), InputEnd, Finder ),
                    copy_range_type());
