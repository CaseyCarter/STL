...
//  replace_range --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::range_finder(SearchRange),
                ::_Boost::algorithm::const_formatter(Format));
        }
        ...
        */
            ...
            const Range3T& Format)
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::first_finder(Search),
                ::_Boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::first_finder(Search, is_iequal(Loc)),
                ::_Boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::last_finder(Search),
                ::_Boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::last_finder(Search, is_iequal(Loc)),
                ::_Boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::nth_finder(Search, Nth),
                ::_Boost::algorithm::const_formatter(Format) );
        }
       ...
       */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::nth_finder(Search, Nth, is_iequal(Loc) ),
                ::_Boost::algorithm::const_formatter(Format) );
        }
...
//  replace_all --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_copy(
            ...
            const Range3T& Format )
        {
            return ::_Boost::algorithm::find_format_all_copy(
                Output,
                Input,
                ::_Boost::algorithm::first_finder(Search),
                ::_Boost::algorithm::const_formatter(Format) );
        ...
        */
        ...
        inline void replace_all( 
            ...
            const Range2T& Format )
        {
            ::_Boost::algorithm::find_format_all( 
                Input, 
                ::_Boost::algorithm::first_finder(Search),
                ::_Boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::head_finder(N),
                ::_Boost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::_Boost::algorithm::find_format_copy(
                Output,
                Input,
                ::_Boost::algorithm::tail_finder(N),
                ::_Boost::algorithm::const_formatter(Format) );
        }
