        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::_Boost::as_literal(Col));
                m_Match=::_Boost::make_iterator_range(::_Boost::begin(lit_col), ::_Boost::begin(lit_col));
                m_End=::_Boost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::_Boost::as_literal(Col));
                m_Match=make_iterator_range(::_Boost::begin(lit_col), ::_Boost::begin(lit_col));
                m_Next=::_Boost::begin(lit_col);
                m_End=::_Boost::end(lit_col);
