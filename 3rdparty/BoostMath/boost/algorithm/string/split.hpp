...
/*! \file
    ...
    or \c std::list<_Boost::iterator_range<std::string::iterator>>
*/
...
//  find_all  ------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::_Boost::algorithm::iter_find(
                Result,
                Input,
...
//  tokenize  -------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::_Boost::algorithm::iter_split(
                Result,
                Input,
                ::_Boost::algorithm::token_finder( Pred, eCompress ) );         
        }
