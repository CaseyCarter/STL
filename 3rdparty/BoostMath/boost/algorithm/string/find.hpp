...
//  Generic find -----------------------------------------------//
        ...
        */
        ...
        {
            iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::_Boost::as_literal(Input));

            return Finder(::_Boost::begin(lit_input),::_Boost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::_Boost::algorithm::find(Input, ::_Boost::algorithm::token_finder(Pred, eCompress));
        }
