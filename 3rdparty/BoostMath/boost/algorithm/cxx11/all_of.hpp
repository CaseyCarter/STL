...
namespace _Boost { namespace algorithm {
...
{
    return _Boost::algorithm::all_of ( _Boost::begin (r), _Boost::end (r), p );
} 
...
{
    return _Boost::algorithm::all_of_equal ( _Boost::begin (r), _Boost::end (r), val );
} 

}} // namespace _Boost and algorithm
