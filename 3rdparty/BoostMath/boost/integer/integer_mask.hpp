...
#include <boost/integer.hpp>  // for _Boost::uint_t
...
#ifdef BOOST_MSVC
#pragma warning(push)
#pragma warning(disable:4245)  // 'initializing' : conversion from 'int' to 'const _Boost::low_bits_mask_t<8>::least', signed/unsigned mismatch
#endif
...
BOOST_LOW_BITS_MASK_SPECIALIZE( unsigned long );
    ...
    BOOST_LOW_BITS_MASK_SPECIALIZE( _Boost::ulong_long_type );
    #endif
