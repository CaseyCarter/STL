...
#pragma intrinsic(_BitScanForward64)
      ...
      template <>
      struct gcd_traits<_Boost::ulong_long_type> : public gcd_traits_defaults<_Boost::ulong_long_type>
      {
         BOOST_FORCEINLINE static BOOST_CXX14_CONSTEXPR unsigned find_lsb(_Boost::ulong_long_type mask)BOOST_NOEXCEPT
         {
            return __builtin_ctzll(mask);
         }
         BOOST_FORCEINLINE static BOOST_CXX14_CONSTEXPR unsigned make_odd(_Boost::ulong_long_type& val)BOOST_NOEXCEPT
         {
            unsigned result = find_lsb(val);
            val >>= result;
            return result;
      ...
      // are called, all values are > 0.
      //
      template <> struct gcd_traits<_Boost::long_long_type> : public gcd_traits_defaults<_Boost::long_long_type>
      {
         BOOST_FORCEINLINE static BOOST_CXX14_CONSTEXPR unsigned make_odd(_Boost::long_long_type& val)BOOST_NOEXCEPT { unsigned result = gcd_traits<_Boost::ulong_long_type>::find_lsb(val); val >>= result; return result; }
      };
      template <> struct gcd_traits<long> : public gcd_traits_defaults<long>
      {
   ...
   BOOST_CXX14_CONSTEXPR T mixed_binary_gcd(T u, T v) BOOST_GCD_NOEXCEPT(T)
   {
    ...
    {
       T temp = _Boost::integer::gcd_detail::optimal_gcd_select(a, b);
...
inline BOOST_CXX14_CONSTEXPR Integer gcd(Integer const &a, Integer const &b) BOOST_GCD_NOEXCEPT(Integer)
{
    if(a == (std::numeric_limits<Integer>::min)())
       return a == static_cast<Integer>(0) ? gcd_detail::gcd_traits<Integer>::abs(b) : _Boost::integer::gcd(static_cast<Integer>(a % b), b);
    else if (b == (std::numeric_limits<Integer>::min)())
       return b == static_cast<Integer>(0) ? gcd_detail::gcd_traits<Integer>::abs(a) : _Boost::integer::gcd(a, static_cast<Integer>(b % a));
...
//
template <typename Integer>
inline typename _Boost::enable_if_c<std::numeric_limits<Integer>::is_specialized, _Boost::rational<Integer> >::type gcd(_Boost::rational<Integer> const &a, _Boost::rational<Integer> const &b)
{
   return _Boost::rational<Integer>(static_cast<Integer>(gcd(a.numerator(), b.numerator())), static_cast<Integer>(lcm(a.denominator(), b.denominator())));
}

template <typename Integer>
inline typename _Boost::enable_if_c<std::numeric_limits<Integer>::is_specialized, _Boost::rational<Integer> >::type lcm(_Boost::rational<Integer> const &a, _Boost::rational<Integer> const &b)
{
   return _Boost::rational<Integer>(static_cast<Integer>(lcm(a.numerator(), b.numerator())), static_cast<Integer>(gcd(a.denominator(), b.denominator())));
}
/**
