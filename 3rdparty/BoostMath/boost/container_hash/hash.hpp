...
namespace _Boost
{
    namespace hash_detail
    {
        ...
        template <> struct basic_numbers<bool> :
            _Boost::hash_detail::enable_hash_value {};
        ...
        template <> struct long_numbers<_Boost::long_long_type> :
            _Boost::hash_detail::enable_hash_value {};
        template <> struct ulong_numbers<_Boost::ulong_long_type> :
            _Boost::hash_detail::enable_hash_value {};
#endif

#if defined(BOOST_HAS_INT128)
        template <> struct long_numbers2<_Boost::int128_type> :
            _Boost::hash_detail::enable_hash_value {};
        template <> struct ulong_numbers2<_Boost::uint128_type> :
            _Boost::hash_detail::enable_hash_value {};
#endif
    ...
    template <typename T>
    typename _Boost::hash_detail::basic_numbers<T>::type hash_value(T);
    template <typename T>
    typename _Boost::hash_detail::long_numbers<T>::type hash_value(T);
    template <typename T>
    typename _Boost::hash_detail::ulong_numbers<T>::type hash_value(T);

    template <typename T>
    typename _Boost::enable_if<_Boost::is_enum<T>, std::size_t>::type
        hash_value(T);
    ...
    template <typename T>
    typename _Boost::hash_detail::float_numbers<T>::type hash_value(T);
    ...
    namespace hash_detail
    {
        ...
        inline void hash_combine_impl(_Boost::uint32_t& h1,
                _Boost::uint32_t k1)
        {
...
// and also not for 32-bit gcc as it warns about the 64-bit constant.
        ...
        inline void hash_combine_impl(_Boost::uint64_t& h,
                _Boost::uint64_t k)
        {
            const _Boost::uint64_t m = UINT64_C(0xc6a4a7935bd1e995);
            const int r = 47;
    ...
    template <typename T>
    typename _Boost::hash_detail::basic_numbers<T>::type hash_value(T v)
    {
        return static_cast<std::size_t>(v);
    }

    template <typename T>
    typename _Boost::hash_detail::long_numbers<T>::type hash_value(T v)
    {
        return hash_detail::hash_value_signed(v);
    }

    template <typename T>
    typename _Boost::hash_detail::ulong_numbers<T>::type hash_value(T v)
    {
...
#pragma warning(disable:4267) // 'argument' : conversion from 'size_t' to
    ...
    {
        _Boost::hash<T> hasher;
        return _Boost::hash_detail::hash_combine_impl(seed, hasher(v));
    }
...
#pragma warning(pop)
    ...
    template <typename T>
    typename _Boost::hash_detail::float_numbers<T>::type hash_value(T v)
    {
        return _Boost::hash_detail::float_hash_value(v);
    }
    ...
    // _Boost::hash is defined later in extensions.hpp if
...
#define BOOST_HASH_SPECIALIZE(type) \
    template <> struct hash<type> \
         : public _Boost::hash_detail::hash_base<type> \
    { \
        std::size_t operator()(type v) const \
        { \
            return _Boost::hash_value(v); \
        } \
    };
...
#if !defined(BOOST_NO_LONG_LONG)
    BOOST_HASH_SPECIALIZE(_Boost::long_long_type)
    BOOST_HASH_SPECIALIZE(_Boost::ulong_long_type)
#endif

#if defined(BOOST_HAS_INT128)
    BOOST_HASH_SPECIALIZE(_Boost::int128_type)
    BOOST_HASH_SPECIALIZE(_Boost::uint128_type)
#endif
...
// Specializing _Boost::hash for pointers.

#if !defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)

    template <class T>
    struct hash<T*>
        : public _Boost::hash_detail::hash_base<T*>
    {
    ...
    // _Boost::hash for all remaining types. But hash_impl is only defined
    ...
    template <class T> struct hash
        : public _Boost::hash_detail::hash_impl<_Boost::is_pointer<T>::value>
