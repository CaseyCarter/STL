...
namespace _Boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME _Boost::enable_if_c<
        ...
        {
            _Boost::hash_detail::call_frexp<T> frexp;
            _Boost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        _Boost::static_log2<limits<T>::radix>::value
...
namespace _Boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return _Boost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
