...
namespace _Boost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(_Boost::long_long_type)(_Boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (_Boost::long_long_type)(_Boost::ulong_long_type)
