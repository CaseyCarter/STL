...
namespace _Boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename _Boost::mpl::if_<_Boost::is_const<M>,
    ...
    public:
        ...
        public:
            ...
            BOOST_STATIC_ASSERT ((_Boost::is_same<typename M::const_iterator1::iterator_category, typename M::const_iterator2::iterator_category>::value ));
     ...
     * - \c _Boost::numeric::ublas::indirect_array<A> where \c A can be \c int, \c size_t, \c long, etc...
     * - \c _Boost::numeric::ublas::matrix<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
