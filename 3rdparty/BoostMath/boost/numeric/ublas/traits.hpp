...
namespace {
  template<class T>
    typename _Boost::mpl::if_c<_Boost::is_integral<T>::value,
                              double,
                              T>::type
...
template<typename T>
inline typename _Boost::disable_if<
    _Boost::is_unsigned<T>, T >::type
...
template<typename T>
inline typename _Boost::enable_if<
    _Boost::is_unsigned<T>, T >::type
    boost_numeric_ublas_abs (const T &t ) {
        return t;
    }
...
namespace _Boost { namespace numeric { namespace ublas {
    ...
    template<>
    struct type_traits<_Boost::numeric::interval<float> > : scalar_traits<_Boost::numeric::interval<float> > {
        typedef type_traits<_Boost::numeric::interval<float> > self_type;
        typedef _Boost::numeric::interval<float> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef _Boost::numeric::interval<double> precision_type;

    };
    template<>
    struct type_traits<_Boost::numeric::interval<double> > : scalar_traits<_Boost::numeric::interval<double> > {
        typedef type_traits<_Boost::numeric::interval<double> > self_type;
        typedef _Boost::numeric::interval<double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef _Boost::numeric::interval<long double> precision_type;
    };
    template<>
    struct type_traits<_Boost::numeric::interval<long double> > : scalar_traits<_Boost::numeric::interval<long double> > {
        typedef type_traits<_Boost::numeric::interval<long double> > self_type;
        typedef _Boost::numeric::interval<long double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef value_type precision_type;
    ...
    namespace detail {
        ...
        template<typename T>
        struct has_trivial_constructor : public _Boost::has_trivial_constructor<T> {};

        template<typename T>
        struct has_trivial_destructor : public _Boost::has_trivial_destructor<T> {};
