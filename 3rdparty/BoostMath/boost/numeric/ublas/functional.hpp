...
#else
namespace _Boost { namespace numeric { namespace ublas { namespace raw {
}}}}
#endif
...
namespace _Boost { namespace numeric { namespace ublas {
    ...
    struct scalar_binary_assign_functor {
        ...
        typedef typename type_traits<typename _Boost::remove_reference<T1>::type>::reference argument1_type;
        typedef typename type_traits<T2>::const_reference argument2_type;
    };
    ...
    struct scalar_binary_swap_functor {
        typedef typename type_traits<typename _Boost::remove_reference<T1>::type>::reference argument1_type;
        typedef typename type_traits<typename _Boost::remove_reference<T2>::type>::reference argument2_type;
    };
    ...
    struct vector_inner_prod:
        ...
        result_type apply (const vector_container<C1> &c1,
            ...
            return _Boost::numeric::bindings::atlas::dot (c1 (), c2 ());
#else
    ...
    struct matrix_vector_prod1:
        ...
        result_type apply (const matrix_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return _Boost::numeric::bindings::atlas::dot (c1 ().row (i), c2 ());
#else
    ...
    struct matrix_vector_prod2:
        ...
        result_type apply (const vector_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return _Boost::numeric::bindings::atlas::dot (c1 (), c2 ().column (i));
#else
    ...
    struct matrix_matrix_prod:
        ...
        result_type apply (const matrix_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return _Boost::numeric::bindings::atlas::dot (c1 ().row (i), c2 ().column (j));
#else
            _Boost::ignore_unused(j);
    ...
    struct basic_column_major {
        ...
        size_type upper_element (size_type i, size_type size_i, size_type j, size_type size_j) {
            ...
            BOOST_UBLAS_CHECK (j < size_j, bad_index ());
            BOOST_UBLAS_CHECK (i <= j, bad_index ());
            _Boost::ignore_unused(size_i, size_j);
            // FIXME size_type overflow
            // sigma_j (j + 1) = (j + 1) * j / 2
