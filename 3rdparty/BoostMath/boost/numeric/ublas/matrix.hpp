...
namespace _Boost { namespace numeric { 
	 ...
	 * \code namespace ublas = _Boost::numeric::ublas; \endcode
	 *
	 * A common practice is to bring this namespace into the current scope with
	 * \code using namespace _Boost::numeric::ublas; \endcode.
	 *
	 ...
	 * The solution is simply to prefix each ublas vector like \c _Boost::numeric::ublas::vector<T>. If you think it's too long to 
	 * write, you can define a new namespace like \c namespace ublas = _Boost::numeric::ublas and then just declare your vectors
	 * with \c ublas::vector<T>. STL vectors will be declared as vector<T>. No need to prefix with \c std::
	 */
	namespace ublas {

    namespace detail {
        using namespace _Boost::numeric::ublas;
