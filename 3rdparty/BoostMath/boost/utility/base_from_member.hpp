...
struct remove_cv_ref
{
    typedef typename ::_Boost::remove_cv<typename
     ::_Boost::remove_reference<T>::type>::type  type;

};  // _Boost::detail::remove_cv_ref
...
struct is_related
    : public ::_Boost::is_same<
     typename ::_Boost::detail::remove_cv_ref<T>::type,
     typename ::_Boost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::_Boost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::_Boost::disable_if< ::_Boost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::_Boost::detail::enable_if_unrelated<base_from_member, T...>::type>
