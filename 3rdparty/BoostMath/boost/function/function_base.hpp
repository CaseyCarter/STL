...
#  define BOOST_FUNCTION_ENABLE_IF_NOT_INTEGRAL(Functor,Type)              \
      typename ::_Boost::enable_if_<          \
                           !(::_Boost::is_integral<Functor>::value), \
                           Type>::type
...
namespace _Boost {
  namespace detail {
    namespace function {
       ...
       * _Boost::function. It is a union containing function pointers,
      ...
      union function_buffer_members
      {
        ...
        struct type_t {
          ...
          const _Boost::typeindex::type_info* type;
      ...
      struct reference_manager
      {
               ...
               functor_manager_operation_type op)
        {
          ...
          case check_functor_type_tag:
            {
              ...
              if (*out_buffer.members.type.type == _Boost::typeindex::type_id<F>()
          ...
          case get_functor_type_tag:
            out_buffer.members.type.type = &_Boost::typeindex::type_id<F>().type_info();
      ...
      /**
       * Determine if _Boost::function can use the small-object
      ...
      struct functor_manager_common
      {
                ...
                functor_manager_operation_type op)
        {
          if (op == clone_functor_tag)
            ...
            if (*out_buffer.members.type.type == _Boost::typeindex::type_id<Functor>())
              out_buffer.members.obj_ptr = &in_buffer.members.func_ptr;
            else
              out_buffer.members.obj_ptr = 0;
          } else /* op == get_functor_type_tag */ {
            out_buffer.members.type.type = &_Boost::typeindex::type_id<Functor>().type_info();
      ...
      public:
               ...
               functor_manager_operation_type op)
        {
          ...
          if (op == get_functor_type_tag) {
            out_buffer.members.type.type = &_Boost::typeindex::type_id<functor_type>().type_info();
            out_buffer.members.type.const_qualified = false;
            out_buffer.members.type.volatile_qualified = false;
          } else {
...
public:
  ...
  /** Retrieve the type of the stored function object, or type_id<void>()
      if this is empty. */
  const _Boost::typeindex::type_info& target_type() const
  {
    if (!vtable) return _Boost::typeindex::type_id<void>().type_info();
  ...
  template<typename Functor>
    Functor* target()
    {
      ...
      type_result.members.type.type = &_Boost::typeindex::type_id<Functor>().type_info();
...
#endif
/**
 * The bad_function_call exception class is thrown when a _Boost::function
 * object is invoked
 */
class BOOST_SYMBOL_VISIBLE bad_function_call : public std::runtime_error
{
public:
  bad_function_call() : std::runtime_error("call to empty _Boost::function") {}
};
#if defined(BOOST_CLANG)
...
#ifdef BOOST_NO_SFINAE
// Comparisons between _Boost::function objects and arbitrary function objects
template<typename Functor>
...
#  if !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
// Comparisons between _Boost::function objects and arbitrary function
