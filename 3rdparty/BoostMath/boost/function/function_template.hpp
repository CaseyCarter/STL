...
#else
#  define BOOST_FUNCTION_VOID_RETURN_TYPE _Boost::detail::function::unusable
...
namespace _Boost {
    ...
    namespace function {
      ...
      struct BOOST_FUNCTION_MEMBER_INVOKER
      {
...

        {
          ...
          return _Boost::mem_fn(*f)(BOOST_FUNCTION_ARGS);
        }
      };
      ...
      struct BOOST_FUNCTION_VOID_MEMBER_INVOKER
      {
...

        {
          MemberPtr* f =
            reinterpret_cast<MemberPtr*>(function_obj_ptr.data);
          BOOST_FUNCTION_RETURN(_Boost::mem_fn(*f)(BOOST_FUNCTION_ARGS));
        }
      };
#endif
      ...
      /**
       * vtable for a specific _Boost::function instance. This
       * structure must be an aggregate so that we can use static
       * initialization in _Boost::function's assign_to and assign_to_a
      ...
      private:
        ...
        bool assign_to(MemberPtr f, function_buffer& functor, member_ptr_tag) const
        {
          ...
          if (f) {
            this->assign_to(_Boost::mem_fn(f), functor);
            return true;
          } else {
            return false;
          }
        ...
        bool assign_to_a(MemberPtr f, function_buffer& functor, Allocator a, member_ptr_tag) const
        {
          ...
          // right target_type() values.
          if (f) {
            this->assign_to_a(_Boost::mem_fn(f), functor, a);
            return true;
          } else {
            return false;
          }
        ...
        {
          if (!_Boost::detail::function::has_empty_target(_Boost::addressof(f))) {
  ...
  public:
    ...
    typedef R         result_type;
#else
    typedef  typename _Boost::detail::function::function_return_type<R>::type
      result_type;
#endif // BOOST_NO_VOID_RETURNS

  private:
    typedef _Boost::detail::function::BOOST_FUNCTION_VTABLE<
  ...
  public:
    ...
    // add signature for _Boost::lambda
    ...
    {
      if (this->empty())
        _Boost::throw_exception(bad_function_call());
...
#         endif
          std::memcpy(this->functor.data, f.functor.data, sizeof(_Boost::detail::function::function_buffer));
#         if defined(BOOST_GCC) && (BOOST_GCC >= 40700)
#           pragma GCC diagnostic pop
#         endif
        } else
          get_vtable()->base.manager(f.functor, this->functor,
                                     _Boost::detail::function::clone_functor_tag);
      }
    }
    ...
    {
      using _Boost::detail::function::vtable_base;

      typedef typename _Boost::detail::function::get_function_tag<Functor>::type tag;
      typedef _Boost::detail::function::BOOST_FUNCTION_GET_INVOKER<tag> get_invoker;
      ...
      if (stored_vtable.assign_to(f, functor)) {
        ...
        if (_Boost::has_trivial_copy_constructor<Functor>::value &&
            _Boost::has_trivial_destructor<Functor>::value &&
            _Boost::detail::function::function_allows_small_object_optimization<Functor>::value)
          value |= static_cast<std::size_t>(0x01);
        vtable = reinterpret_cast<_Boost::detail::function::vtable_base *>(value);
      } else
        vtable = 0;
    }
...
#           endif
            ...
            get_vtable()->base.manager(f.functor, this->functor,
                                     _Boost::detail::function::move_functor_tag);
          f.vtable = 0;
        } else {
          clear();
        }
...
// Poison comparisons between _Boost::function objects of the same type.
template<typename R BOOST_FUNCTION_COMMA BOOST_FUNCTION_TEMPLATE_PARMS>
