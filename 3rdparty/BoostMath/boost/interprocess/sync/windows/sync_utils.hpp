...
class sync_id
{
   ...
   {  return _Boost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef _Boost::unordered_map<sync_id, void*> umap_type;
   typedef _Boost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
