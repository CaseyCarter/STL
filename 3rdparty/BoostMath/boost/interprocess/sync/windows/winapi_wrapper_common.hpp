...
inline bool winapi_wrapper_timed_wait_for_single_object(void *handle, const _Boost::posix_time::ptime &abs_time);
 
inline void winapi_wrapper_wait_for_single_object(void *handle)
{
   winapi_wrapper_timed_wait_for_single_object(handle, _Boost::posix_time::pos_infin);
}

inline bool winapi_wrapper_try_wait_for_single_object(void *handle)
{
   return winapi_wrapper_timed_wait_for_single_object(handle, _Boost::posix_time::min_date_time);
}

inline bool winapi_wrapper_timed_wait_for_single_object(void *handle, const _Boost::posix_time::ptime &abs_time)
{
   const _Boost::posix_time::ptime cur_time = microsec_clock::universal_time();
   ...
   if (abs_time == _Boost::posix_time::pos_infin){
