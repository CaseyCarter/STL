...
bool try_based_timed_lock(MutexType &m, const _Boost::posix_time::ptime &abs_time)
{
   //Same as lock()
...
{
   const _Boost::posix_time::time_duration dur(0, 0, uCheckPeriodSec);
   _Boost::posix_time::ptime deadline(microsec_clock::universal_time()+dur);
...
template<class MutexType>
void timed_based_timed_lock(MutexType &m, const _Boost::posix_time::ptime &abs_time, unsigned const uCheckPeriodSec)
{
   const _Boost::posix_time::time_duration dur(0, 0, uCheckPeriodSec);
   _Boost::posix_time::ptime deadline(microsec_clock::universal_time()+dur);
