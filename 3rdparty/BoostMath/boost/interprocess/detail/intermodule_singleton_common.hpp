...
class intermodule_singleton_common
{
   ...
   static const ::_Boost::uint32_t Uninitialized       = 0u;
   static const ::_Boost::uint32_t Initializing        = 1u;
   static const ::_Boost::uint32_t Initialized         = 2u;
   static const ::_Boost::uint32_t Broken              = 3u;
   static const ::_Boost::uint32_t Destroyed           = 4u;
   ...
   static void initialize_singleton_logic
      (void *&ptr, volatile _Boost::uint32_t &this_module_singleton_initialized, singleton_constructor_t constructor, bool phoenix)
   {
      ...
      if(atomic_read32(&this_module_singleton_initialized) != Initialized){
         ...
         ::_Boost::uint32_t previous_module_singleton_initialized = atomic_cas32
         ...
         //trying to initialize the singleton.
            ...
            throw interprocess_exception("_Boost::interprocess::intermodule_singleton initialization failed");
         }
      }
      BOOST_ASSERT(ptr != 0);
   }

   static void finalize_singleton_logic(void *&ptr, volatile _Boost::uint32_t &this_module_singleton_initialized, singleton_destructor_t destructor)
   {
   ...
   static void initialize_global_map_handle()
   {
      ...
      while(1){
         ...
         ::_Boost::uint32_t tmp = atomic_cas32(&this_module_map_initialized, Initializing, Uninitialized);
   ...
   static volatile _Boost::uint32_t this_module_singleton_count;
   ...
   static volatile _Boost::uint32_t this_module_map_initialized;

   //Raw memory to construct the global map manager
   static union mem_holder_t
   {
      unsigned char map_mem [sizeof(ThreadSafeGlobalMap)];
      ::_Boost::container::dtl::max_align_t aligner;
   } mem_holder;
};

template<class ThreadSafeGlobalMap>
volatile _Boost::uint32_t intermodule_singleton_common<ThreadSafeGlobalMap>::this_module_singleton_count;

template<class ThreadSafeGlobalMap>
volatile _Boost::uint32_t intermodule_singleton_common<ThreadSafeGlobalMap>::this_module_map_initialized;
...
class intermodule_singleton_impl
{
   ...
   //singleton.
   static volatile _Boost::uint32_t   this_module_singleton_initialized;
...
template <typename C, bool L, bool P, class ThreadSafeGlobalMap>
volatile _Boost::uint32_t intermodule_singleton_impl<C, L, P, ThreadSafeGlobalMap>::this_module_singleton_initialized = 0;
