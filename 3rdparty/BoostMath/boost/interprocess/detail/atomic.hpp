...
//! Atomically increment an _Boost::uint32_t by 1
//! "mem": pointer to the object
//! Returns the old value pointed to by mem
inline _Boost::uint32_t atomic_inc32(volatile _Boost::uint32_t *mem);

//! Atomically read an _Boost::uint32_t from memory
inline _Boost::uint32_t atomic_read32(volatile _Boost::uint32_t *mem);

//! Atomically set an _Boost::uint32_t in memory
//! "mem": pointer to the object
//! "param": val value that the object will assume
inline void atomic_write32(volatile _Boost::uint32_t *mem, _Boost::uint32_t val);

//! Compare an _Boost::uint32_t's value with "cmp".
//! If they are the same swap the value with "with"
//! "mem": pointer to the value
//! "with": what to swap it with
//! "cmp": the value to compare it to
//! Returns the old value of *mem
inline _Boost::uint32_t atomic_cas32
   (volatile _Boost::uint32_t *mem, _Boost::uint32_t with, _Boost::uint32_t cmp);
...
//! Atomically decrement an _Boost::uint32_t by 1
//! "mem": pointer to the atomic value
//! Returns the old value pointed to by mem
inline _Boost::uint32_t atomic_dec32(volatile _Boost::uint32_t *mem)
...
//! Atomically add 'val' to an _Boost::uint32_t
//! "mem": pointer to the object
//! "val": amount to add
//! Returns the old value pointed to by mem
inline _Boost::uint32_t atomic_add32
   (volatile _Boost::uint32_t *mem, _Boost::uint32_t val)
{
   // int r = *pw;
   // *mem += val;
   // return r;
...
//! Returns the old value pointed to by mem
inline _Boost::uint32_t atomic_dec32(volatile _Boost::uint32_t *mem)
{  return atomic_add32(mem, (_Boost::uint32_t)-1);  }
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline _Boost::uint32_t atomic_add32(volatile _Boost::uint32_t *mem, _Boost::uint32_t val)
{
   _Boost::uint32_t prev, temp;
...
//! Returns the old value pointed to by mem
inline _Boost::uint32_t atomic_dec32(volatile _Boost::uint32_t *mem)
{  return atomic_add32(mem, _Boost::uint32_t(-1u));  }
...
//! Returns the old value pointed to by mem
inline _Boost::uint32_t atomic_dec32(volatile _Boost::uint32_t *mem)
{  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem), (_Boost::uint32_t)-1) + 1; }
...
inline _Boost::uint32_t atomic_dec32(volatile _Boost::uint32_t *mem)
{  _Boost::uint32_t old_val = __ATOMIC_DECREMENT_LONG(mem); __MB(); return old_val; }
...
inline _Boost::uint32_t atomic_read32(volatile _Boost::uint32_t *mem)
{  _Boost::uint32_t old_val = *mem; __MB(); return old_val;  }
...
//first define _Boost::uint32_t versions of __lwarx and __stwcx to avoid poluting
...
inline _Boost::uint32_t lwarxu(volatile _Boost::uint32_t *mem)
{
   return static_cast<_Boost::uint32_t>(__lwarx(reinterpret_cast<volatile int*>(mem)));
}
...
//!unsuccessful
inline bool stwcxu(volatile _Boost::uint32_t* mem, _Boost::uint32_t val)
{
...
inline _Boost::uint32_t atomic_add32
   (volatile _Boost::uint32_t *mem, _Boost::uint32_t val)
{  return __sync_fetch_and_add(const_cast<_Boost::uint32_t *>(mem), val);   }
...
//! Atomically read an _Boost::uint32_t from memory
inline _Boost::uint32_t atomic_read32(volatile _Boost::uint32_t *mem)
{  _Boost::uint32_t old_val = *mem; __sync_synchronize(); return old_val;  }
...
inline _Boost::uint32_t atomic_cas32
   (volatile _Boost::uint32_t *mem, _Boost::uint32_t with, _Boost::uint32_t cmp)
{  return __sync_val_compare_and_swap(const_cast<_Boost::uint32_t *>(mem), cmp, with);   }
...
#define vx_atomic_cast(_i)   (reinterpret_cast< ::atomic32_t *>( const_cast<_Boost::uint32_t *>(_i)))
...
inline bool atomic_add_unless32
   (volatile _Boost::uint32_t *mem, _Boost::uint32_t value, _Boost::uint32_t unless_this)
{
   _Boost::uint32_t old, c(atomic_read32(mem));
