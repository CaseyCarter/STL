...
class mapped_region
{
   ...
   {
      mapped_region tmp(_Boost::move(other));
      this->swap(tmp);
      return *this;
   }
   ...
   (offset_t mapping_size, offset_t offset, offset_t page_offset, std::size_t &size)
{
   ...
   if(mapping_size < offset ||
      _Boost::uintmax_t(mapping_size - (offset - page_offset)) >
         _Boost::uintmax_t(std::size_t(-1))){
...
{
   ::_Boost::adl_move_swap(this->m_base, other.m_base);
   ::_Boost::adl_move_swap(this->m_size, other.m_size);
   ::_Boost::adl_move_swap(this->m_page_offset, other.m_page_offset);
   ::_Boost::adl_move_swap(this->m_mode,  other.m_mode);
   #if defined (BOOST_INTERPROCESS_WINDOWS)
   ::_Boost::adl_move_swap(this->m_file_or_mapping_hnd, other.m_file_or_mapping_hnd);
   #else
   ::_Boost::adl_move_swap(this->m_is_xsi, other.m_is_xsi);
   #endif
}
