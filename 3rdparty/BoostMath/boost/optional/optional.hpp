...
namespace _Boost { namespace optional_detail {
...
template <typename T>
struct optional_value_type< ::_Boost::optional<T> >
{
  typedef T type;
};

}} // namespace _Boost::optional_detail
...
class optional_base : public optional_tag
{
  ...
  protected:
    ...
    BOOST_NOEXCEPT_IF(::_Boost::is_nothrow_move_constructible<T>::value)
      :
      m_initialized(false)
    {
      if ( rhs.is_initialized() )
        construct( _Boost::move(rhs.get_impl()) );
    }
#endif
    ...
    explicit optional_base ( Expr&& expr, PtrExpr const* tag )
      ...
      m_initialized(false)
    {
      construct(_Boost::forward<Expr>(expr),tag);
    }
    ...
    BOOST_NOEXCEPT_IF(::_Boost::is_nothrow_move_constructible<T>::value && ::_Boost::is_nothrow_move_assignable<T>::value)
    {
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value( _Boost::move(rhs.get_impl()) );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( _Boost::move(val) );
      else construct( _Boost::move(val) );
    }
#endif
    ...
    {
      if (is_initialized())
        assign_expr_to_initialized(_Boost::forward<Expr>(expr),tag);
      else construct(_Boost::forward<Expr>(expr),tag);
    }
#else
    template<class Expr>
  ...
  protected :
    ...
    void construct ( rval_reference_type val )
     {
       ::new (m_storage.address()) value_type( _Boost::move(val) ) ;
       m_initialized = true ;
     }
#endif
    ...
    {
      ::new (m_storage.address()) value_type( _Boost::forward<Args>(args)... ) ;
      m_initialized = true ;
    }
    ...
    {
      destroy();
      construct(in_place_init, _Boost::forward<Args>(args)...);
    }
    ...
    void construct ( in_place_init_t, Arg&& arg )
     {
       ::new (m_storage.address()) value_type( _Boost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       construct(in_place_init, _Boost::forward<Arg>(arg)) ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       _Boost_optional_detail::construct<value_type>(factory, m_storage.address());
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) value_type(_Boost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value( _Boost::forward<Expr>(expr) );
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
    ...
    void construct ( Expr&& expr, optional_tag const* )
     {
       if ( expr.is_initialized() )
       {
         ...
         new (m_storage.address()) value_type(_Boost::move(expr.get())) ;
         m_initialized = true ;
       }
     }
#else
...
struct is_optional_related
  : _Boost::conditional< _Boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME _Boost::decay<U>::type>::value
                     || _Boost::is_same<BOOST_DEDUCED_TYPENAME _Boost::decay<U>::type, none_t>::value
                     || _Boost::is_same<BOOST_DEDUCED_TYPENAME _Boost::decay<U>::type, in_place_init_t>::value
                     || _Boost::is_same<BOOST_DEDUCED_TYPENAME _Boost::decay<U>::type, in_place_init_if_t>::value,
    _Boost::true_type, _Boost::false_type>::type
{};
...
struct is_convertible_to_T_or_factory
  : _Boost::conditional< _Boost::is_base_of<_Boost::in_place_factory_base, BOOST_DEDUCED_TYPENAME _Boost::decay<U>::type>::value
                     || _Boost::is_base_of<_Boost::typed_in_place_factory_base, BOOST_DEDUCED_TYPENAME _Boost::decay<U>::type>::value
                     || (_Boost::is_constructible<T, U&&>::value && !_Boost::is_same<T, BOOST_DEDUCED_TYPENAME _Boost::decay<U>::type>::value)
                      , _Boost::true_type, _Boost::false_type>::type
{};

template <typename T, typename U>
struct is_optional_constructible : _Boost::is_constructible<T, U>
{};

#else

template <typename, typename>
struct is_convertible_to_T_or_factory : _Boost::true_type
{};

template <typename T, typename U>
struct is_optional_constructible : _Boost::true_type
{};
...
struct is_optional_val_init_candidate<T, U, false>
  : _Boost::conditional< is_convertible_to_T_or_factory<T, U>::value
                      , _Boost::true_type, _Boost::false_type>::type
{};
...
struct optional_uses_direct_storage_for
  : _Boost::conditional<(_Boost::is_scalar<T>::value && !_Boost::is_const<T>::value && !_Boost::is_volatile<T>::value)
                      , _Boost::true_type, _Boost::false_type>::type
{};
...
#  define BOOST_OPTIONAL_BASE_TYPE(T) _Boost::conditional< optional_config::optional_uses_direct_storage_for<T>::value, \
  ...
  : public BOOST_OPTIONAL_BASE_TYPE(T)
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base(optional_detail::init_value_tag(), _Boost::forward<T>(val))
      {}
#endif
    ...
    /// Creates an optional<T> initialized with 'val' IFF cond is true, otherwise creates an uninitialized optional.
    // Can throw if T::T(T &&) does
    optional ( bool cond, rval_reference_type val ) : base( cond, _Boost::forward<T>(val) )
      {}
#endif
    ...
    explicit optional ( optional<U> const& rhs
                        ...
                        ,BOOST_DEDUCED_TYPENAME _Boost::enable_if< optional_detail::is_optional_constructible<T, U const&>, bool>::type = true
#endif
                      )
      :
      base()
...
#ifndef BOOST_OPTIONAL_DETAIL_NO_SFINAE_FRIENDLY_CONSTRUCTORS
                        ,BOOST_DEDUCED_TYPENAME _Boost::enable_if< optional_detail::is_optional_constructible<T, U>, bool>::type = true
#endif
                      )
      :
      base()
    {
      if ( rhs.is_initialized() )
        this->construct( _Boost::move(rhs.get()) );
    }
#endif
  ...
  explicit optional ( Expr&& expr,
                      BOOST_DEDUCED_TYPENAME _Boost::enable_if< optional_detail::is_optional_val_init_candidate<T, Expr>, bool>::type = true
  )
    : base(_Boost::forward<Expr>(expr),_Boost::addressof(expr))
    {}

#else
    template<class Expr>
    explicit optional ( Expr const& expr ) : base(expr,_Boost::addressof(expr)) {}
    ...
    template<class Expr>
    BOOST_DEDUCED_TYPENAME _Boost::enable_if<optional_detail::is_optional_val_init_candidate<T, Expr>, optional&>::type
    operator= ( Expr&& expr )
      {
        this->assign_expr(_Boost::forward<Expr>(expr),_Boost::addressof(expr));
        return *this ;
      }
    ...
    optional& operator= ( Expr const& expr )
      {
        this->assign_expr(expr,_Boost::addressof(expr));
        return *this ;
      }
#endif // !defined  BOOST_OPTIONAL_DETAIL_NO_RVALUE_REFERENCES
    ...
    BOOST_DEDUCED_TYPENAME _Boost::enable_if<_Boost::is_same<T, BOOST_DEDUCED_TYPENAME _Boost::decay<T_>::type>, optional&>::type
    operator= ( T_&& val )
      {
        this->assign( _Boost::forward<T_>(val) ) ;
        return *this ;
      }
    ...
    {
      this->emplace_assign( _Boost::forward<Args>(args)... );
    }

    template<class... Args>
    explicit optional ( in_place_init_t, Args&&... args )
    : base( in_place_init, _Boost::forward<Args>(args)... )
    {}

    template<class... Args>
    explicit optional ( in_place_init_if_t, bool cond, Args&&... args )
    : base( in_place_init_if, cond, _Boost::forward<Args>(args)... )
    {}
    ...
    void emplace ( Arg&& arg )
     {
       this->emplace_assign( _Boost::forward<Arg>(arg) );
     }
    ...
    reference_type_of_temporary_wrapper operator *() && { return _Boost::move(this->get()) ; }
#else
    reference_const_type operator *() const { return this->get() ; }
    reference_type       operator *()       { return this->get() ; }
    ...
    template <typename F>
    optional<typename _Boost::result_of<F(reference_type)>::type> map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename _Boost::result_of<F(reference_const_type)>::type> map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename _Boost::result_of<F(reference_type_of_temporary_wrapper)>::type> map(F f) &&
      {
        if (this->has_value())
          return f(_Boost::move(this->get()));
        else
          return none;
      }

    template <typename F>
    optional<typename optional_detail::optional_value_type<typename _Boost::result_of<F(reference_type)>::type>::type> flat_map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename _Boost::result_of<F(reference_const_type)>::type>::type> flat_map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename _Boost::result_of<F(reference_type_of_temporary_wrapper)>::type>::type> flat_map(F f) &&
      {
        if (this->has_value())
          return f(_Boost::move(get()));
        else
          return none;
      }
...
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME _Boost::decay<T>::type> make_optional ( T && v  )
{
  return optional<BOOST_DEDUCED_TYPENAME _Boost::decay<T>::type>(_Boost::forward<T>(v));
}

// Returns optional<T>(cond,v)
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME _Boost::decay<T>::type> make_optional ( bool cond, T && v )
{
  return optional<BOOST_DEDUCED_TYPENAME _Boost::decay<T>::type>(cond,_Boost::forward<T>(v));
}
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output _Boost::optional, include header <boost/optional/optional_io.hpp>");
  return os;
}
