...
#else
  static rval_reference_type move(reference_type r) { return _Boost::move(r); }
#endif
#endif
...
void prevent_binding_rvalue_ref_to_optional_lvalue_ref()
{
  ...
  BOOST_STATIC_ASSERT_MSG(
    !_Boost::is_lvalue_reference<To>::value || !_Boost::is_rvalue_reference<From>::value, 
...
class optional_base : public optional_tag
{
...
#endif
    ::_Boost::detail::make_reference_content<T>::type internal_type ;
  ...
  protected:
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value(_Boost::move(rhs.get_impl()), is_reference_predicate() );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( _Boost::move(val), is_reference_predicate() );
  ...
  protected :
    ...
    void emplace_assign ( Args&&... args )
     {
       destroy();
       ::new (m_storage.address()) internal_type( _Boost::forward<Args>(args)... );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       ::new (m_storage.address()) internal_type( _Boost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) internal_type(_Boost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value(_Boost::forward<Expr>(expr), is_reference_predicate());
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
...
class optional : public optional_detail::optional_base<T>
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base( _Boost::forward<T>(val) ) 
  ...
  explicit optional ( Expr&& expr, 
                      BOOST_DEDUCED_TYPENAME _Boost::disable_if_c<
                        (_Boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME _Boost::decay<Expr>::type>::value) || 
                        _Boost::is_same<BOOST_DEDUCED_TYPENAME _Boost::decay<Expr>::type, none_t>::value, bool >::type = true 
  ) 
   ...
   // No-throw (assuming T::~T() doesn't)
    ...
    BOOST_DEDUCED_TYPENAME _Boost::disable_if_c<
      _Boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME _Boost::decay<Expr>::type>::value || 
        _Boost::is_same<BOOST_DEDUCED_TYPENAME _Boost::decay<Expr>::type, none_t>::value,
      optional&
    >::type 
    operator= ( Expr&& expr )
      {
