...
namespace regex_constants{
   ...
   enum flag_type_
   {
      ...
      no_except = ::_Boost::regbase::no_except,
      failbit = ::_Boost::regbase::failbit,
      literal = ::_Boost::regbase::literal,
      icase = ::_Boost::regbase::icase,
      nocollate = ::_Boost::regbase::nocollate,
      collate = ::_Boost::regbase::collate,
      nosubs = ::_Boost::regbase::nosubs,
      optimize = ::_Boost::regbase::optimize,
      bk_plus_qm = ::_Boost::regbase::bk_plus_qm,
      bk_vbar = ::_Boost::regbase::bk_vbar,
      no_intervals = ::_Boost::regbase::no_intervals,
      no_char_classes = ::_Boost::regbase::no_char_classes,
      no_escape_in_lists = ::_Boost::regbase::no_escape_in_lists,
      no_mod_m = ::_Boost::regbase::no_mod_m,
      mod_x = ::_Boost::regbase::mod_x,
      mod_s = ::_Boost::regbase::mod_s,
      no_mod_s = ::_Boost::regbase::no_mod_s,
      save_subexpression_location = ::_Boost::regbase::save_subexpression_location,
      no_empty_expressions = ::_Boost::regbase::no_empty_expressions,

      basic = ::_Boost::regbase::basic,
      extended = ::_Boost::regbase::extended,
      normal = ::_Boost::regbase::normal,
      emacs = ::_Boost::regbase::emacs,
      awk = ::_Boost::regbase::awk,
      grep = ::_Boost::regbase::grep,
      egrep = ::_Boost::regbase::egrep,
      sed = basic,
      perl = normal,
      ECMAScript = normal,
      JavaScript = normal,
   ...
   typedef ::_Boost::regbase::flag_type syntax_option_type;
