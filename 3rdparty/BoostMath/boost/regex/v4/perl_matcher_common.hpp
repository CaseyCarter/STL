...
void perl_matcher<BidiIterator, Allocator, traits>::estimate_max_state_count(std::random_access_iterator_tag*)
{
   ...
   std::ptrdiff_t dist = _Boost::BOOST_REGEX_DETAIL_NS::distance(base, last);
   if(dist == 0)
      dist = 1;
...
{
   ::_Boost::BOOST_REGEX_DETAIL_NS::concrete_protected_call
...
#pragma warning(disable:4127)
   ...
   {
      std::ptrdiff_t maxlen = ::_Boost::BOOST_REGEX_DETAIL_NS::distance(backstop, position);
