...
struct trivial_format_traits
{
   ...
   {
      return ::_Boost::BOOST_REGEX_DETAIL_NS::global_lower(c);
   }
   static charT toupper(charT c)
   {
      return ::_Boost::BOOST_REGEX_DETAIL_NS::global_upper(c);
   }
...
private:
   ...
   {
      typedef typename _Boost::is_convertible<ForwardIter, const char_type*>::type tag_type;
...
#endif
   inline int toi(ForwardIter& i, ForwardIter j, int base, const _Boost::mpl::false_&)
   {
      if(i != j)
      {
         std::vector<char_type> v(i, j);
...
#pragma warning(pop)
#endif
   inline int toi(ForwardIter& i, ForwardIter j, int base, const _Boost::mpl::true_&)
   {
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_all()
{
   ...
   while(m_position != m_end)
   {
      ...
      {
      case '&':
         if(m_flags & ::_Boost::regex_constants::format_sed)
         {
            ++m_position;
            put(m_results[0]);
            break;
      ...
      case '\\':
         ...
         break;
      case '(':
         if(m_flags & _Boost::regex_constants::format_all)
         {
            ++m_position;
      ...
      case ')':
         ...
         break;
      case ':':
         if((m_flags & _Boost::regex_constants::format_all) && m_have_conditional)
         {
            return;
         }
         put(*m_position);
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_perl()
{
   ...
   default:
      ...
      {
         std::ptrdiff_t len = ::_Boost::BOOST_REGEX_DETAIL_NS::distance(m_position, m_end);
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_escape()
{
   ...
   default:
      ...
      if((m_flags & _Boost::regex_constants::format_sed) == 0)
      {
         bool breakout = false;
         switch(*m_position)
         {
      ...
      int v = this->toi(m_position, m_position+len, 10);
      if((v > 0) || ((v == 0) && (m_flags & ::_Boost::regex_constants::format_sed)))
      {
         put(m_results[v]);
         break;
      }
      else if(v == 0)
      {
         ...
         --m_position;
         len = ::_Boost::BOOST_REGEX_DETAIL_NS::distance(m_position, m_end);
...
template<typename Formatter, bool IsFunction = _Boost::is_function<Formatter>::value>
...
private:
   ...
   //
   BOOST_STATIC_ASSERT((::_Boost::is_pointer<F>::value || ::_Boost::is_function<F>::value || ::_Boost::is_class<F>::value));
   static formatter_wrapper<typename unwrap_reference<F>::type> f;
   static M m;
   static O out;
   static _Boost::regex_constants::match_flag_type flags;
public:
...
public:
   ...
   //
   typedef typename _Boost::mpl::if_<
      _Boost::mpl::and_<_Boost::is_pointer<F>, _Boost::mpl::not_<_Boost::is_function<typename _Boost::remove_pointer<F>::type> > >,
      _Boost::mpl::int_<0>,
      typename _Boost::mpl::if_<
         has_const_iterator<F>,
         _Boost::mpl::int_<1>,
         _Boost::mpl::int_<format_traits_imp<F, M, O>::value>
      >::type
   >::type type;
   //
   ...
   //
   BOOST_STATIC_ASSERT( _Boost::is_class<F>::value && !has_const_iterator<F>::value ? (type::value > 1) : true);
};
...
struct format_functor3
{
   ...
   OutputIter operator()(const Match& m, OutputIter i, _Boost::regex_constants::match_flag_type f)
   {
      return _Boost::unwrap_ref(func)(m, i, f);
   }
   template <class OutputIter, class Traits>
   OutputIter operator()(const Match& m, OutputIter i, _Boost::regex_constants::match_flag_type f, const Traits&)
   {
      return (*this)(m, i, f);
   }
private:
...
struct format_functor2
{
   ...
   OutputIter operator()(const Match& m, OutputIter i, _Boost::regex_constants::match_flag_type /*f*/)
   {
      return _Boost::unwrap_ref(func)(m, i);
   }
   template <class OutputIter, class Traits>
   OutputIter operator()(const Match& m, OutputIter i, _Boost::regex_constants::match_flag_type f, const Traits&)
   {
...
struct format_functor1
{
   ...
   OutputIter operator()(const Match& m, OutputIter i, _Boost::regex_constants::match_flag_type /*f*/)
   {
      return do_format_string(_Boost::unwrap_ref(func)(m), i);
   }
   template <class OutputIter, class Traits>
   OutputIter operator()(const Match& m, OutputIter i, _Boost::regex_constants::match_flag_type f, const Traits&)
   {
...
struct format_functor_c_string
{
   ...
   template <class OutputIter>
   OutputIter operator()(const Match& m, OutputIter i, _Boost::regex_constants::match_flag_type f, const Traits& t = Traits())
   {
...
struct compute_functor_type
{
   ...
   typedef typename _Boost::remove_cv< typename _Boost::remove_pointer<Func>::type>::type maybe_char_type;

   typedef typename mpl::if_<
      ::_Boost::is_same<tag, mpl::int_<0> >, format_functor_c_string<maybe_char_type, Match, Traits>,
      typename mpl::if_<
         ::_Boost::is_same<tag, mpl::int_<1> >, format_functor_container<Func, Match, Traits>,
         typename mpl::if_<
            ::_Boost::is_same<tag, mpl::int_<2> >, format_functor1<Func, Match>,
            typename mpl::if_<
               ::_Boost::is_same<tag, mpl::int_<3> >, format_functor2<Func, Match>, 
