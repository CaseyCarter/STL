...
// because _Boost::call_once doesn't alow us to pass instance information
...
public:
   typedef scoped_static_mutex_lock scoped_lock;
   static void init();
   static _Boost::recursive_mutex* m_pmutex;
   static _Boost::once_flag m_once;
};
...
public:
   ...
   void unlock();
private:
   _Boost::unique_lock<_Boost::recursive_mutex>* m_plock;
   bool m_have_lock;
};
