...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace _Boost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER _Boost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace _Boost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER _Boost::type_of
