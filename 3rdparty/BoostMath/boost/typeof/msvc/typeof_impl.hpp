...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*_Boost::type_of::encode_index((_Boost::type_of::encode_counter<1005>*)0)))
...
# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
    struct name {\
        enum {_typeof_register_value=sizeof(_Boost::type_of::typeof_register_type<name>(expr))};\
