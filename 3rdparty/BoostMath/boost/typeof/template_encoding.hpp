...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename _Boost::type_of::push_back<V, _Boost::type_of::constant<std::size_t,ID> >::type V0;\
    ...
    {\
        typedef decode_type_impl<_Boost::type_of::constant<std::size_t,ID>, Iter> self_t;\
        typedef _Boost::type_of::constant<std::size_t,ID> self_id;\
        typedef Iter iter0;\
