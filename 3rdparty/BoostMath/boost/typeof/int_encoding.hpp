...
namespace _Boost { namespace type_of {
    ...
    struct encode_size_t : push_back<
        V,
        _Boost::type_of::constant<std::size_t,pack<n, false>::value>
    >
    {};
    ...
    struct encode_size_t<V, n, true> : push_back<typename push_back<
        V,
        _Boost::type_of::constant<std::size_t,pack<n % 0x3ffffffe, true>::value> >::type,
        _Boost::type_of::constant<std::size_t,n / 0x3ffffffe>
    >
    {};
