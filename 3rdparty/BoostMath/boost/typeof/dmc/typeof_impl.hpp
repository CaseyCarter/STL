...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*_Boost::type_of::encode_index((_Boost::type_of::encode_counter<1000>*)0)))
...
# define BOOST_TYPEOF(expr) \
    _Boost::type_of::msvc_typeid_wrapper<sizeof(*_Boost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
    struct name {\
        BOOST_STATIC_CONSTANT(int,_typeof_register_value=sizeof(_Boost::type_of::typeof_register_type<name>(expr)));\
        typedef typename _Boost::type_of::msvc_extract_type<name>::id2type id2type;\
        typedef typename id2type::type type;\
    };
...
# define BOOST_TYPEOF_NESTED_TYPEDEF(name,expr) \
    struct name {\
        BOOST_STATIC_CONSTANT(int,_typeof_register_value=sizeof(_Boost::type_of::typeof_register_type<name>(expr)));\
        typedef _Boost::type_of::msvc_extract_type<name>::id2type id2type;\
