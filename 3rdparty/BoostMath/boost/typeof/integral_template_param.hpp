...
#define BOOST_TYPEOF_INTEGRAL_PARAM_ENCODE(This, n)\
    typedef typename _Boost::type_of::encode_integral<\
        BOOST_PP_CAT(V, n),\
...
#define BOOST_TYPEOF_INTEGRAL_PARAM_DECODE(This, n)\
    typedef _Boost::type_of::decode_integral<BOOST_TYPEOF_INTEGRAL_PARAM_GETTYPE(This), BOOST_PP_CAT(iter, n)> BOOST_PP_CAT(d, n);\
