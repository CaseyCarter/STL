...
//! \tparam Options is an packed option type generated using using _Boost::container::tree_assoc_options.
   ...
   ///@endcond
{
   ...
   typedef typename _Boost::container::allocator_traits<allocator_type>::value_type        value_type;
   typedef typename _Boost::container::allocator_traits<allocator_type>::pointer           pointer;
   typedef typename _Boost::container::allocator_traits<allocator_type>::const_pointer     const_pointer;
   typedef typename _Boost::container::allocator_traits<allocator_type>::reference         reference;
   typedef typename _Boost::container::allocator_traits<allocator_type>::const_reference   const_reference;
   typedef typename _Boost::container::allocator_traits<allocator_type>::size_type         size_type;
   typedef typename _Boost::container::allocator_traits<allocator_type>::difference_type   difference_type;
   ...
   BOOST_CONTAINER_FORCEINLINE map(BOOST_RV_REF(map) x)
      BOOST_NOEXCEPT_IF(_Boost::container::dtl::is_nothrow_move_constructible<Compare>::value)
   ...
   BOOST_CONTAINER_FORCEINLINE map& operator=(BOOST_RV_REF(map) x)
      BOOST_NOEXCEPT_IF( (allocator_traits_type::propagate_on_container_move_assignment::value ||
                          allocator_traits_type::is_always_equal::value) &&
                           _Boost::container::dtl::is_nothrow_move_assignable<Compare>::value)
   ...
   //! <b>Effects</b>: If there is no key equivalent to x in the map, inserts
   //! value_type(_Boost::move(x), T()) into the map (the key is move-constructed)
   //!
   //! <b>Returns</b>: A reference to the mapped_type corresponding to x in *this.
   //!
   //! <b>Complexity</b>: Logarithmic.
   mapped_type& operator[](key_type &&k);
      ...
      BOOST_CONTAINER_FORCEINLINE mapped_type& operator[](BOOST_RV_REF(key_type) k)  {  return this->priv_subscript(::_Boost::move(k));  }
   #else
   ...
   {  return this->base_t::insert_or_assign(const_iterator(), k, ::_Boost::forward<M>(obj));  }
   ...
   {  return this->base_t::insert_or_assign(const_iterator(), ::_Boost::move(k), ::_Boost::forward<M>(obj));  }
   ...
   {  return this->base_t::insert_or_assign(hint, k, ::_Boost::forward<M>(obj)).first;  }
   ...
   {  return this->base_t::insert_or_assign(hint, ::_Boost::move(k), ::_Boost::forward<M>(obj)).first;  }
   ...
   { return this->try_emplace(_Boost::move(x.first), _Boost::move(x.second)); }
   ...
   { return this->base_t::insert_unique(_Boost::move(x)); }
   ...
   { return this->try_emplace(p, _Boost::move(x.first), _Boost::move(x.second)); }
   ...
   { return this->base_t::insert_unique(p, _Boost::move(x)); }
   ...
   {
      typename base_t::node_type  n(_Boost::move(nh));
      typename base_t::insert_return_type base_ret(this->base_t::insert_unique_node(_Boost::move(n)));
      return insert_return_type (base_ret.inserted, base_ret.position, _Boost::move(base_ret.node));
   }
   ...
   {
      typename base_t::node_type  n(_Boost::move(nh));
      typename base_t::insert_return_type base_ret(this->base_t::insert_unique_node(hint, _Boost::move(n)));
      return insert_return_type (base_ret.inserted, base_ret.position, _Boost::move(base_ret.node));
   }
   ...
   {  return this->base_t::emplace_unique(_Boost::forward<Args>(args)...); }
   ...
   {  return this->base_t::emplace_hint_unique(p, _Boost::forward<Args>(args)...); }
   ...
   {  return this->base_t::try_emplace(const_iterator(), k, _Boost::forward<Args>(args)...); }
   ...
   {  return this->base_t::try_emplace(hint, k, _Boost::forward<Args>(args)...).first; }
   ...
   {  return this->base_t::try_emplace(const_iterator(), _Boost::move(k), _Boost::forward<Args>(args)...); }
   ...
   {  return this->base_t::try_emplace(hint, _Boost::move(k), _Boost::forward<Args>(args)...).first; }
   ...
   {  return this->base_t::try_emplace(const_iterator(), _Boost::move(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N); }\
   \
   BOOST_MOVE_TMPL_LT##N BOOST_MOVE_CLASS##N BOOST_MOVE_GT##N \
   ...
   {  return this->base_t::try_emplace(hint, _Boost::move(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N).first; }\
   //
   ...
   node_type extract(const key_type& k)
   {
      ...
      node_type nh(_Boost::move(base_nh));
   ...
   //! @copydoc ::_Boost::container::map::merge(map<Key, T, C2, Allocator, Options>&)
   template<class C2>
   ...
   void swap(map& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && _Boost::container::dtl::is_nothrow_swappable<Compare>::value )
   ...
   {
      return this->try_emplace(_Boost::forward<KeyConvertible>(k)).first->second;
   }
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
};
...
template <class Key, class T, class Compare, class Allocator, class Options>
struct has_trivial_destructor_after_move<_Boost::container::map<Key, T, Compare, Allocator, Options> >
{
   typedef ::_Boost::container::dtl::tree<std::pair<const Key, T>, int, Compare, Allocator, Options> tree;
   static const bool value = ::_Boost::has_trivial_destructor_after_move<tree>::value;
};
   ...
   ///@endcond
{
   ...
   //! @copydoc ::_Boost::container::set::get_allocator()
   allocator_type get_allocator() const;

   //! @copydoc ::_Boost::container::set::get_stored_allocator()
   stored_allocator_type &get_stored_allocator();

   //! @copydoc ::_Boost::container::set::get_stored_allocator() const
   const stored_allocator_type &get_stored_allocator() const;

   //! @copydoc ::_Boost::container::set::begin()
   iterator begin();

   //! @copydoc ::_Boost::container::set::begin() const
   const_iterator begin() const;

   //! @copydoc ::_Boost::container::set::cbegin() const
   const_iterator cbegin() const;

   //! @copydoc ::_Boost::container::set::end()
   iterator end() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::end() const
   const_iterator end() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::cend() const
   const_iterator cend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::rbegin()
   reverse_iterator rbegin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::rbegin() const
   const_reverse_iterator rbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::crbegin() const
   const_reverse_iterator crbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::rend()
   reverse_iterator rend() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::rend() const
   const_reverse_iterator rend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::crend() const
   const_reverse_iterator crend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::empty() const
   bool empty() const;

   //! @copydoc ::_Boost::container::set::size() const
   size_type size() const;

   //! @copydoc ::_Boost::container::set::max_size() const
   ...
   {  return this->base_t::emplace_equal(_Boost::forward<Args>(args)...); }
   ...
   template <class... Args>
   BOOST_CONTAINER_FORCEINLINE iterator emplace_hint(const_iterator p, BOOST_FWD_REF(Args)... args)
   {  return this->base_t::emplace_hint_equal(p, _Boost::forward<Args>(args)...); }
   ...
   { return this->base_t::emplace_equal(_Boost::move(x)); }
   ...
   //!   is inserted right before p.
   BOOST_CONTAINER_FORCEINLINE iterator insert(const_iterator p, BOOST_RV_REF(nonconst_value_type) x)
   { return this->base_t::emplace_hint_equal(p, _Boost::move(x)); }
   ...
   {
      typename base_t::node_type n(_Boost::move(nh));
      return this->base_t::insert_equal_node(_Boost::move(n));
   }
   ...
   {
      typename base_t::node_type n(_Boost::move(nh));
      return this->base_t::insert_equal_node(hint, _Boost::move(n));
   }

   #if defined(BOOST_CONTAINER_DOXYGEN_INVOKED)

   //! @copydoc ::_Boost::container::set::erase(const_iterator)
   iterator erase(const_iterator p);

   //! @copydoc ::_Boost::container::set::erase(const key_type&)
   size_type erase(const key_type& x);

   //! @copydoc ::_Boost::container::set::erase(const_iterator,const_iterator)
   iterator erase(const_iterator first, const_iterator last);
   #endif

   //! @copydoc ::_Boost::container::map::extract(const key_type&)
   node_type extract(const key_type& k)
   {
      typename base_t::node_type base_nh(this->base_t::extract(k));
      return node_type(_Boost::move(base_nh));
   }

   //! @copydoc ::_Boost::container::map::extract(const_iterator)
   node_type extract(const_iterator position)
   {
      typename base_t::node_type base_nh(this->base_t::extract(position));
      return node_type (_Boost::move(base_nh));
   ...
   //! @copydoc ::_Boost::container::multimap::merge(multimap<Key, T, C2, Allocator, Options>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG multimap<Key, T, C2, Allocator, Options> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<multimap<Key, T, C2, Allocator, Options>&>(source)); }
   ...
   #if defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
   //! @copydoc ::_Boost::container::set::swap
   void swap(multiset& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && _Boost::container::dtl::is_nothrow_swappable<Compare>::value );

   //! @copydoc ::_Boost::container::set::clear
   void clear() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::_Boost::container::set::key_comp
   key_compare key_comp() const;

   //! @copydoc ::_Boost::container::set::value_comp
   value_compare value_comp() const;
...
//!specialization for optimizations
template <class Key, class T, class Compare, class Allocator, class Options>
struct has_trivial_destructor_after_move<_Boost::container::multimap<Key, T, Compare, Allocator, Options> >
{
   typedef ::_Boost::container::dtl::tree<std::pair<const Key, T>, int, Compare, Allocator, Options> tree;
   static const bool value = ::_Boost::has_trivial_destructor_after_move<tree>::value;
};
