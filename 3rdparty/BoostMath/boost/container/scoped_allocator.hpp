   ...
   : public OuterAlloc
{
   ...
   scoped_allocator_adaptor_base(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs &...args)
      : outer_allocator_type(::_Boost::forward<OuterA2>(outerAlloc))
      , m_inner(args...)
      {}
   ...
   scoped_allocator_adaptor_base(BOOST_RV_REF(scoped_allocator_adaptor_base) other)
      : outer_allocator_type(::_Boost::move(other.outer_allocator()))
      , m_inner(::_Boost::move(other.inner_allocator()))
      {}
   ...
   {
      outer_allocator_type::operator=(_Boost::move(other.outer_allocator()));
      m_inner = ::_Boost::move(other.inner_allocator());
      return *this;
   }
   ...
   {
      _Boost::adl_move_swap(this->outer_allocator(), r.outer_allocator());
      _Boost::adl_move_swap(this->m_inner, r.inner_allocator());
   }
         ...
         <OuterAlloc BOOST_CONTAINER_SCOPEDALLOC_DUMMYTRUE, BOOST_CONTAINER_SCOPEDALLOC_ALLINNER>
{
   ...
   scoped_allocator_adaptor(BOOST_RV_REF(scoped_allocator_adaptor) other)
      : base_type(::_Boost::move(other.base()))
      {}
   ...
   //!
   //! <b>Effects</b>: initializes the OuterAlloc base class with _Boost::forward<OuterA2>(outerAlloc) and inner
   ...
   scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc, const InnerAllocs & ...innerAllocs)
      : base_type(::_Boost::forward<OuterA2>(outerAlloc), innerAllocs...)
      {}
   #else // #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_CONTAINER_DOXYGEN_INVOKED)
   ...
   scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc BOOST_MOVE_I##N BOOST_MOVE_CREF##N)\
      : base_type(::_Boost::forward<OuterA2>(outerAlloc) BOOST_MOVE_I##N BOOST_MOVE_ARG##N)\
      {}\
   //
   ...
   {  return static_cast<scoped_allocator_adaptor&>(base_type::operator=(_Boost::move(other.base()))); }
   ...
   void construct(T* p, BOOST_FWD_REF(Args)...args)
   {
      dtl::dispatch_uses_allocator
         ...
         , this->inner_allocator(), p, ::_Boost::forward<Args>(args)...);
   }
   ...
   scoped_allocator_adaptor(internal_type_t, BOOST_FWD_REF(OuterA2) outer, const inner_allocator_type& inner)
      : base_type(internal_type_t(), ::_Boost::forward<OuterA2>(outer), inner)
   {}
                      ...
                      ,const scoped_allocator_adaptor<OuterA2, BOOST_CONTAINER_SCOPEDALLOC_ALLINNER>& b)
{
   ...
   #else
   const bool has_zero_inner = _Boost::container::dtl::is_same<P0, void>::value;
   #endif
