...
struct tree_opt
{
   static const _Boost::container::tree_type_enum tree_type = TreeType;
...
//! by \c _Boost::container::set, \c _Boost::container::multiset
//! \c _Boost::container::map and \c _Boost::container::multimap.
//! Supported options are: \c _Boost::container::optimize_size and \c _Boost::container::tree_type
...
{
   /// @cond
   typedef typename ::_Boost::intrusive::pack_options
      < tree_assoc_defaults,
...
template<class ...Options>
using tree_assoc_options_t = typename _Boost::container::tree_assoc_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c _Boost::container::hash_set, \c _Boost::container::hash_multiset
//! \c _Boost::container::hash_map and \c _Boost::container::hash_multimap.
//! Supported options are: \c _Boost::container::store_hash
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
template<class ...Options>
using hash_assoc_options_t = typename _Boost::container::hash_assoc_options<Options...>::type;
...
//!\c _Boost::container::growth_factor_50
//!\c _Boost::container::growth_factor_60
//!\c _Boost::container::growth_factor_100
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c _Boost::container::vector.
//! Supported options are: \c _Boost::container::growth_factor and \c _Boost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c _Boost::container::growth_factor and \c _Boost::container::stored_size
template<class ...Options>
using vector_options_t = typename _Boost::container::vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c _Boost::container::small_vector.
//! Supported options are: \c _Boost::container::growth_factor and \c _Boost::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c _Boost::container::growth_factor and \c _Boost::container::stored_size
template<class ...Options>
using small_vector_options_t = typename _Boost::container::small_vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c _Boost::container::static_vector.
//! Supported options are: \c _Boost::container::throw_on_overflow and \c _Boost::container::inplace_alignment
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c _Boost::container::growth_factor and \c _Boost::container::stored_size
template<class ...Options>
using static_vector_options_t = typename _Boost::container::static_vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c _Boost::container::deque.
//! Supported options are: \c _Boost::container::block_bytes
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c _Boost::container::block_bytes
template<class ...Options>
using deque_options_t = typename _Boost::container::deque_options<Options...>::type;
