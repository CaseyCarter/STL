...
template <
  ...
  class T6, class T7, class T8,
  class T9>
struct is_boost_tuple< _Boost::tuples::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
{
...
struct disable_if_boost_tuple
   : _Boost::container::dtl::disable_if< is_boost_tuple<Tuple> >
{};
...
template<>
struct is_tuple_null<_Boost::tuples::null_type>
{
   static const bool value = true;
};
...
struct piecewise_construct_use
{
   ...
   {  (void)&::_Boost::container::piecewise_construct;   }
};
...
#endif
{
   ...
   pair(BOOST_RV_REF(pair) p)
      : first(::_Boost::move(p.first)), second(::_Boost::move(p.second))
   {
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
   }
   ...
   pair(BOOST_FWD_REF(U) u, BOOST_FWD_REF(V) v)
      : first(::_Boost::forward<U>(u))
      , second(::_Boost::forward<V>(v))
   {
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
   }
   ...
   pair(try_emplace_t, BOOST_FWD_REF(KeyType) k, Args && ...args)
      : first(_Boost::forward<KeyType>(k)), second(::_Boost::forward<Args>(args)...)\
   {
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
   }
   #else

   //piecewise construction from _Boost::tuple
   ...
   pair( try_emplace_t, BOOST_FWD_REF(KeyType) k BOOST_MOVE_I##N BOOST_MOVE_UREF##N )\
      : first(_Boost::forward<KeyType>(k)), second(BOOST_MOVE_FWD##N)\
   {\
      BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));\
   }\
   //
   ...
   pair( piecewise_construct_t\
       , BoostTuple<BOOST_MOVE_TARG##N  BOOST_MOVE_I##N BOOST_MOVE_REPEAT(BOOST_MOVE_SUB(10,N),::_Boost::tuples::null_type)> p\
       , BoostTuple<BOOST_MOVE_TARGQ##M BOOST_MOVE_I##M BOOST_MOVE_REPEAT(BOOST_MOVE_SUB(10,M),::_Boost::tuples::null_type)> q\
       , typename dtl::enable_if_c\
         < pair_impl::is_boost_tuple< BoostTuple<BOOST_MOVE_TARG##N  BOOST_MOVE_I##N BOOST_MOVE_REPEAT(BOOST_MOVE_SUB(10,N),::_Boost::tuples::null_type)> >::value &&\
   ...
   #  if !defined(BOOST_CONTAINER_NO_CXX11_DELEGATING_CONSTRUCTORS)
      ...
      pair(Tuple<Args1...>& t1, Tuple<Args2...>& t2, index_tuple<Indexes1...>, index_tuple<Indexes2...>)
         : first (::_Boost::forward<Args1>(get<Indexes1>(t1))...)
         , second(::_Boost::forward<Args2>(get<Indexes2>(t2))...)
      {  (void) t1; (void)t2; }
   ...
   #  else
      ...
      {  return do_build_from_args<T>(::_Boost::move(t), typename build_number_seq<sizeof...(Args)>::type());   }
      ...
      {  (void)t; return T(::_Boost::forward<Args>(get<Indexes>(t))...);  }

      public:
      template< template<class ...> class Tuple, class... Args1, class... Args2
              , class = typename pair_impl::disable_if_boost_tuple< Tuple<Args1...> >::type>
      pair(piecewise_construct_t, Tuple<Args1...> t1, Tuple<Args2...> t2)
         : first  (build_from_args<first_type> (::_Boost::move(t1)))
         , second (build_from_args<second_type>(::_Boost::move(t2)))
      {
         BOOST_STATIC_ASSERT((sizeof(std::pair<T1, T2>) == sizeof(pair<T1, T2>)));
      }
   #  endif   //BOOST_NO_CXX11_VARIADIC_TEMPLATES
   ...
   {
      first  = ::_Boost::move(p.first);
      second = ::_Boost::move(p.second);
      return *this;
   }

   template <class D, class S>
   typename ::_Boost::container::dtl::disable_if_or
      < pair &
      , ::_Boost::container::dtl::is_same<T1, D>
      , ::_Boost::container::dtl::is_same<T2, S>
      >::type
...
//std::pair copy assignment
   ...
   void swap(pair& p)
   {
      ::_Boost::adl_move_swap(this->first, p.first);
      ::_Boost::adl_move_swap(this->second, p.second);
   }
};
...
template<class T1, class T2>
struct has_move_emulation_enabled< ::_Boost::container::dtl::pair<T1, T2> >
{
   static const bool value = true;
};
...
template <class T1, class T2>
struct is_class_or_union< ::_Boost::container::dtl::pair<T1, T2> >
...
template <class T1, class T2>
struct is_union< ::_Boost::container::dtl::pair<T1, T2> >
//This specialization is needed to avoid instantiation of pair in
//is_class, and allow recursive maps.
{
   static const bool value = false;
...
template <class T1, class T2>
struct is_class< ::_Boost::container::dtl::pair<T1, T2> >
//This specialization is needed to avoid instantiation of pair in
//is_class, and allow recursive maps.
{
   static const bool value = true;
...
struct is_trivially_copy_assignable
   <_Boost::container::dtl::pair<A,B> >
{
   static const bool value = _Boost::move_detail::is_trivially_copy_assignable<A>::value &&
                             _Boost::move_detail::is_trivially_copy_assignable<B>::value ;
};
...
struct is_trivially_move_assignable
   <_Boost::container::dtl::pair<A,B> >
{
   static const bool value = _Boost::move_detail::is_trivially_move_assignable<A>::value &&
                             _Boost::move_detail::is_trivially_move_assignable<B>::value ;
};
...
template<class A, class B>
struct is_trivially_copy_constructible<_Boost::container::dtl::pair<A,B> >
{
   static const bool value = _Boost::move_detail::is_trivially_copy_constructible<A>::value &&
                             _Boost::move_detail::is_trivially_copy_constructible<B>::value ;
};
...
template<class A, class B>
struct is_trivially_move_constructible<_Boost::container::dtl::pair<A,B> >
{
   static const bool value = _Boost::move_detail::is_trivially_move_constructible<A>::value &&
                             _Boost::move_detail::is_trivially_move_constructible<B>::value ;
};
...
template<class A, class B>
struct is_trivially_destructible<_Boost::container::dtl::pair<A,B> >
{
   static const bool value = _Boost::move_detail::is_trivially_destructible<A>::value &&
                             _Boost::move_detail::is_trivially_destructible<B>::value ;
};
