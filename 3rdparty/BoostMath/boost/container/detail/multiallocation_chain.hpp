...
class basic_multiallocation_chain
{
   ...
   typedef typename _Boost::intrusive::pointer_traits
   ...
   typedef bi::slist< node
                    , bi::linear<true>
                    , bi::cache_last<true>
                    , bi::size_type<typename _Boost::container::dtl::make_unsigned<difference_type>::type>
                    > slist_impl_t;
   ...
   {  return *static_cast<node*>(static_cast<void*>(_Boost::movelib::to_raw_pointer(p)));  }
   ...
   basic_multiallocation_chain(BOOST_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_(::_Boost::move(other.slist_impl_))
   {}
   ...
   {
      typedef typename _Boost::intrusive::pointer_traits<char_ptr> char_pointer_traits;
      ...
      if(num_units){
         ...
         for(size_type i = 0; i != num_units-1; ++i, elem += unit_bytes){
            ::new (_Boost::movelib::to_raw_pointer(prev_elem)) void_pointer(elem);
            prev_elem = elem;
         }
   ...
   : public MultiallocationChain
{
   ...
   transform_multiallocation_chain(BOOST_RV_REF(transform_multiallocation_chain) other)
      : MultiallocationChain(::_Boost::move(static_cast<MultiallocationChain&>(other)))
   {}
   ...
   transform_multiallocation_chain& operator=(BOOST_RV_REF(transform_multiallocation_chain) other)
   {
      return static_cast<MultiallocationChain&>
         (this->MultiallocationChain::operator=(::_Boost::move(static_cast<MultiallocationChain&>(other))));
   }
