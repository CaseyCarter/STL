...
namespace _Boost { namespace container { namespace dtl {
...
struct move_insert_range_proxy
{
   ...
   {
      this->first_ = ::_Boost::container::uninitialized_move_alloc_n_source
         (a, this->first_, n, p);
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n)
   {
      this->first_ = ::_Boost::container::move_n_source(this->first_, n, p);
   }
...
struct insert_range_proxy
{
   ...
   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n)
   {
      this->first_ = ::_Boost::container::uninitialized_copy_alloc_n_source(a, this->first_, n, p);
   }

   void copy_n_and_update(Allocator &, Iterator p, size_type n)
   {
      this->first_ = ::_Boost::container::copy_n_source(this->first_, n, p);
   }
...
struct insert_n_copies_proxy
{
   ...
   {  _Boost::container::uninitialized_fill_alloc_n(a, v_, n, p);  }
...
{
   typedef ::_Boost::container::allocator_traits<Allocator> alloc_traits;
   typedef typename allocator_traits<Allocator>::size_type size_type;
   typedef typename allocator_traits<Allocator>::value_type value_type;

   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) const
   {  _Boost::container::uninitialized_value_init_alloc_n(a, n, p);  }
...
struct insert_default_initialized_n_proxy
{
   ...
   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) const
   {  _Boost::container::uninitialized_default_init_alloc_n(a, n, p);  }
...
struct insert_copy_proxy
{
   ...
   void uninitialized_copy_n_and_update(Allocator &a, Iterator p, size_type n) const
   {
      ...
      alloc_traits::construct( a, _Boost::movelib::iterator_to_raw_pointer(p), v_);
   }
...
struct insert_move_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1);  (void)n;
      alloc_traits::construct( a, _Boost::movelib::iterator_to_raw_pointer(p), ::_Boost::move(v_) );
   }
...
insert_move_proxy<Allocator, It> get_insert_value_proxy(BOOST_RV_REF(typename _Boost::container::iterator_traits<It>::value_type) v)
{
   return insert_move_proxy<Allocator, It>(v);
}

template<class It, class Allocator>
insert_copy_proxy<Allocator, It> get_insert_value_proxy(const typename _Boost::container::iterator_traits<It>::value_type &v)
{
...
struct insert_nonmovable_emplace_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1); (void)n;
      alloc_traits::construct( a, _Boost::movelib::iterator_to_raw_pointer(p), ::_Boost::forward<Args>(get<IdxPack>(this->args_))... );
   }
   ...
   :  public insert_nonmovable_emplace_proxy<Allocator, Iterator, Args...>
{
   ...
   explicit insert_emplace_proxy(BOOST_FWD_REF(Args)... args)
      : base_t(::_Boost::forward<Args>(args)...)
   {}
   ...
   void priv_copy_some_and_update(Allocator &a, const index_tuple<IdxPack...>&, Iterator p, size_type n)
   {
      ...
      value_type *vp = reinterpret_cast<value_type *>(v.data);
      alloc_traits::construct(a, vp,
         ::_Boost::forward<Args>(get<IdxPack>(this->args_))...);
      BOOST_TRY{
         *p = ::_Boost::move(*vp);
      }
      BOOST_CATCH(...){
...
template<class Allocator, class Iterator>
struct insert_emplace_proxy<Allocator, Iterator, typename _Boost::container::allocator_traits<Allocator>::value_type>
   : public insert_move_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy(typename _Boost::container::allocator_traits<Allocator>::value_type &&v)
...
struct insert_emplace_proxy<Allocator, Iterator
   , typename _Boost::container::dtl::add_const<typename _Boost::container::allocator_traits<Allocator>::value_type>::type
   >
   : public insert_copy_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy(const typename _Boost::container::allocator_traits<Allocator>::value_type &v)
...
{\
   ...
   {\
      BOOST_ASSERT(n == 1); (void)n;\
      alloc_traits::construct(a, _Boost::movelib::iterator_to_raw_pointer(p) BOOST_MOVE_I##N BOOST_MOVE_MFWD##N);\
   }\
   \
...
//Specializations to avoid an unneeded temporary when emplacing from a single argument o type value_type
template<class Allocator, class Iterator>
struct insert_emplace_proxy_arg1<Allocator, Iterator, ::_Boost::rv<typename _Boost::container::allocator_traits<Allocator>::value_type> >
   : public insert_move_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy_arg1(typename _Boost::container::allocator_traits<Allocator>::value_type &v)
   : insert_move_proxy<Allocator, Iterator>(v)
   {}
};

template<class Allocator, class Iterator>
struct insert_emplace_proxy_arg1<Allocator, Iterator, typename _Boost::container::allocator_traits<Allocator>::value_type>
   : public insert_copy_proxy<Allocator, Iterator>
{
   explicit insert_emplace_proxy_arg1(const typename _Boost::container::allocator_traits<Allocator>::value_type &v)
   : insert_copy_proxy<Allocator, Iterator>(v)
   {}
};
