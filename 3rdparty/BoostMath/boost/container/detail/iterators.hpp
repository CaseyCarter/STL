...
class constant_iterator
  : public ::_Boost::container::iterator
      ...
      <std::random_access_iterator_tag, T, Difference, const T*, const T &>
{
   ...
   //constructed until ::_Boost::container::construct_in_place is called.
...
struct emplace_functor
{
   ...
   BOOST_CONTAINER_FORCEINLINE void inplace_impl(Allocator &a, T* ptr, const dtl::index_tuple<IdxPack...>&)
   {
      allocator_traits<Allocator>::construct
         (a, ptr, ::_Boost::forward<Args>(dtl::get<IdxPack>(args_))...);
   }
   ...
   {
      typedef typename _Boost::container::iterator_traits<DestIt>::value_type value_type;
      value_type && tmp= value_type(::_Boost::forward<Args>(dtl::get<IdxPack>(args_))...);
      *dest = ::_Boost::move(tmp);
   }
...
{\
   ...
   {\
      ...
      *dest = ::_Boost::move(const_cast<value_type &>(BOOST_MOVE_IF(N, tmp, tmp.get())));\
   }\
   \
   BOOST_MOVE_MREF##N\
};\
...
struct iiterator_types
{
   ...
   typedef typename _Boost::container::iterator_traits<IIterator>::pointer         it_pointer;
   typedef typename _Boost::container::iterator_traits<IIterator>::difference_type difference_type;
   typedef typename ::_Boost::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<value_type>::type                      pointer;
   typedef typename ::_Boost::intrusive::pointer_traits<it_pointer>::
      template rebind_pointer<const value_type>::type                const_pointer;
   typedef typename ::_Boost::intrusive::
...
{
   typedef typename ::_Boost::container::iterator
...
class iterator_from_iiterator
{
   ...
   {  return ::_Boost::intrusive::pointer_traits<pointer>::pointer_to(this->operator*());  }
...
using ::_Boost::intrusive::reverse_iterator;
