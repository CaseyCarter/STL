...
template<class Allocator, unsigned Version = _Boost::container::dtl::version<Allocator>::value>
struct allocator_version_traits
{
   typedef ::_Boost::container::dtl::integral_constant
      <unsigned, Version> alloc_version;

   typedef typename Allocator::multiallocation_chain multiallocation_chain;

   typedef typename _Boost::container::allocator_traits<Allocator>::pointer    pointer;
   typedef typename _Boost::container::allocator_traits<Allocator>::size_type  size_type;
...
struct allocator_version_traits<Allocator, 1>
{
   ...
   typedef typename _Boost::container::allocator_traits<Allocator>::pointer    pointer;
   typedef typename _Boost::container::allocator_traits<Allocator>::size_type  size_type;
   typedef typename _Boost::container::allocator_traits<Allocator>::value_type value_type;

   typedef typename _Boost::intrusive::pointer_traits<pointer>::
         template rebind_pointer<void>::type                void_ptr;
   typedef dtl::basic_multiallocation_chain
      <void_ptr>                                            multialloc_cached_counted;
   typedef _Boost::container::dtl::
   ...
   static void deallocate_individual(Allocator &a, multiallocation_chain &holder)
   {
      ...
      while(n){
         --n;
         pointer p = _Boost::intrusive::pointer_traits<pointer>::pointer_to(*it);
         ++it;
         a.deallocate(p, 1);
      }
   }
