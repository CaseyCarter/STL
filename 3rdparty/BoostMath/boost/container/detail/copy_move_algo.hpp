...
template<class It>
struct are_elements_contiguous< ::_Boost::move_iterator<It> >
...
template <class Pointer, bool IsConst>
struct are_elements_contiguous<_Boost::container::vec_iterator<Pointer, IsConst> >
{
   static const bool value = true;
};
...
template <class PointedType, class DifferenceType, class OffsetType, std::size_t OffsetAlignment>
struct are_elements_contiguous< ::_Boost::interprocess::offset_ptr<PointedType, DifferenceType, OffsetType, OffsetAlignment> >
{
   static const bool value = true;
};
...
struct are_contiguous_and_same
   : _Boost::move_detail::and_
      < are_elements_contiguous<I>
      , are_elements_contiguous<O>
      , is_same< typename remove_const< typename ::_Boost::container::iterator_traits<I>::value_type >::type
               , typename ::_Boost::container::iterator_traits<O>::value_type
               >
      >
{};
...
struct is_memtransfer_copy_assignable
   : _Boost::move_detail::and_
      ...
      , dtl::is_trivially_copy_assignable< typename ::_Boost::container::iterator_traits<I>::value_type >
      >
{};
...
struct is_memtransfer_copy_constructible
   : _Boost::move_detail::and_
      < are_contiguous_and_same<I, O>
      , dtl::is_trivially_copy_constructible< typename ::_Boost::container::iterator_traits<I>::value_type >
      >
{};
...
{
   typedef typename _Boost::container::iterator_traits<I>::value_type value_type;
   value_type *const dest_raw = _Boost::movelib::iterator_to_raw_pointer(r);
   const value_type *const beg_raw = _Boost::movelib::iterator_to_raw_pointer(f);
   const value_type *const end_raw = _Boost::movelib::iterator_to_raw_pointer(l);
   if(BOOST_LIKELY(beg_raw != end_raw && dest_raw && beg_raw)){
      const typename _Boost::container::iterator_traits<I>::difference_type n = end_raw - beg_raw;
      std::memmove(dest_raw, beg_raw, sizeof(value_type)*n);
      _Boost::container::iterator_advance(r, n);
   }
   return r;
}
...
F memmove_n(I f, U n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{
   typedef typename _Boost::container::iterator_traits<I>::value_type value_type;
   if(BOOST_LIKELY(n)){
      std::memmove(_Boost::movelib::iterator_to_raw_pointer(r), _Boost::movelib::iterator_to_raw_pointer(f), sizeof(value_type)*n);
      _Boost::container::iterator_advance(r, n);
   }
...
I memmove_n_source(I f, U n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{
   if(BOOST_LIKELY(n)){
      typedef typename _Boost::container::iterator_traits<I>::value_type value_type;
      std::memmove(_Boost::movelib::iterator_to_raw_pointer(r), _Boost::movelib::iterator_to_raw_pointer(f), sizeof(value_type)*n);
      _Boost::container::iterator_advance(f, n);
   }
   return f;
}
...
{
   typedef typename ::_Boost::container::iterator_traits<O>::value_type value_type;
...
struct enable_if_trivially_destructible
   : enable_if_c < dtl::is_trivially_destructible
                  <typename _Boost::container::iterator_traits<I>::value_type>::value
               , R>
{};
...
//!   \code
//!   for (; f != l; ++r, ++f)
//!      allocator_traits::construct(a, &*r, _Boost::move(*f));
//!   \endcode
//!
//! <b>Returns</b>: r
template
   ...
   uninitialized_move_alloc(Allocator &a, I f, I l, F r)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, _Boost::movelib::iterator_to_raw_pointer(r), _Boost::move(*f));
         ++f; ++r;
      }
   }
   BOOST_CATCH(...){
      for (; back != r; ++back){
         allocator_traits<Allocator>::destroy(a, _Boost::movelib::iterator_to_raw_pointer(back));
      }
      BOOST_RETHROW;
   }
   BOOST_CATCH_END
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename dtl::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &a, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename dtl::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_move_alloc_n(Allocator &, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
...
inline typename dtl::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &a, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
...
inline typename dtl::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_move_alloc_n_source(Allocator &, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
   ...
   uninitialized_copy_alloc(Allocator &a, I f, I l, F r)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, _Boost::movelib::iterator_to_raw_pointer(r), *f);
         ++f; ++r;
      }
   }
   BOOST_CATCH(...){
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename dtl::disable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &a, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename dtl::enable_if_memtransfer_copy_constructible<I, F, F>::type
   uninitialized_copy_alloc_n(Allocator &, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return dtl::memmove_n(f, n, r); }
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename dtl::disable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &a, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n) {
         _Boost::container::construct_in_place(a, _Boost::movelib::iterator_to_raw_pointer(r), f);
         ++f; ++r; --n;
      }
   }
   BOOST_CATCH(...){
...
template
   <typename Allocator,
    ...
    typename F> // F models ForwardIterator
inline typename dtl::enable_if_memtransfer_copy_constructible<I, F, I>::type
   uninitialized_copy_alloc_n_source(Allocator &, I f, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r) BOOST_NOEXCEPT_OR_NOTHROW
{  return dtl::memmove_n_source(f, n, r); }
...
inline typename dtl::disable_if_memzero_initializable<F, F>::type
   uninitialized_value_init_alloc_n(Allocator &a, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
         allocator_traits<Allocator>::construct(a, _Boost::movelib::iterator_to_raw_pointer(r));
         ++r;
      }
   }
   BOOST_CATCH(...){
...
inline typename dtl::enable_if_memzero_initializable<F, F>::type
   uninitialized_value_init_alloc_n(Allocator &, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   typedef typename _Boost::container::iterator_traits<F>::value_type value_type;
   std::memset((void*)_Boost::movelib::iterator_to_raw_pointer(r), 0, sizeof(value_type)*n);
   _Boost::container::iterator_advance(r, n);
   return r;
}
...
template
   <typename Allocator,
    typename F> // F models ForwardIterator
inline F uninitialized_default_init_alloc_n(Allocator &a, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
         allocator_traits<Allocator>::construct(a, _Boost::movelib::iterator_to_raw_pointer(r), default_init);
         ++r;
      }
   }
   BOOST_CATCH(...){
...
inline void uninitialized_fill_alloc(Allocator &a, F f, F l, const T &t)
{
   ...
   BOOST_TRY{
      while (f != l) {
         allocator_traits<Allocator>::construct(a, _Boost::movelib::iterator_to_raw_pointer(f), t);
         ++f;
      }
   }
   BOOST_CATCH(...){
...
template
   <typename Allocator,
    typename T,
    typename F> // F models ForwardIterator
inline F uninitialized_fill_alloc_n(Allocator &a, const T &v, typename _Boost::container::allocator_traits<Allocator>::size_type n, F r)
{
   F back = r;
   BOOST_TRY{
      while (n--) {
         allocator_traits<Allocator>::construct(a, _Boost::movelib::iterator_to_raw_pointer(r), v);
         ++r;
      }
   }
   BOOST_CATCH(...){
...
{
   while (n--) {
      _Boost::container::assign_in_place(r, f);
      ++f; ++r;
   }
   return f;
}
...
{
   typedef typename _Boost::container::iterator_traits<I>::value_type value_type;
   const typename _Boost::container::iterator_traits<I>::difference_type n = _Boost::container::iterator_distance(f, l);
   r -= n;
   std::memmove((_Boost::movelib::iterator_to_raw_pointer)(r), (_Boost::movelib::iterator_to_raw_pointer)(f), sizeof(value_type)*n);
   return r;
}
   ...
   destroy_alloc_n(Allocator &a, I f, U n)
{
   while(n){
      --n;
      allocator_traits<Allocator>::destroy(a, _Boost::movelib::iterator_to_raw_pointer(f));
      ++f;
   }
}
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   for (; n != n_i ; ++short_range_f, ++large_range_f, ++n){
      _Boost::adl_move_swap(*short_range_f, *large_range_f);
   }
   _Boost::container::uninitialized_move_alloc_n(a, large_range_f, n_j - n_i, short_range_f);  // may throw
   _Boost::container::destroy_alloc_n(a, large_range_f, n_j - n_i);
}
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   void *const large_ptr = static_cast<void*>(_Boost::movelib::iterator_to_raw_pointer(large_range_f));
   void *const short_ptr = static_cast<void*>(_Boost::movelib::iterator_to_raw_pointer(short_range_f));
   void *const stora_ptr = static_cast<void*>(_Boost::movelib::iterator_to_raw_pointer(storage.data));
   std::memcpy(stora_ptr, large_ptr, n_i_bytes);
   std::memcpy(large_ptr, short_ptr, n_i_bytes);
   std::memcpy(short_ptr, stora_ptr, n_i_bytes);
   _Boost::container::iterator_advance(large_range_f, n_i);
   _Boost::container::iterator_advance(short_range_f, n_i);
   _Boost::container::uninitialized_move_alloc_n(a, large_range_f, n_j - n_i, short_range_f);  // may throw
   _Boost::container::destroy_alloc_n(a, large_range_f, n_j - n_i);
}
                    ...
                    , G large_range_f, typename allocator_traits<Allocator>::size_type n_j)
{
   ...
   char *large_ptr = static_cast<char*>(static_cast<void*>(_Boost::movelib::iterator_to_raw_pointer(large_range_f)));
   char *short_ptr = static_cast<char*>(static_cast<void*>(_Boost::movelib::iterator_to_raw_pointer(short_range_f)));
...
{
   if (n_o < n_i){
      inp_start = _Boost::container::copy_n_source_dest(inp_start, n_o, out_start);     // may throw
      _Boost::container::uninitialized_copy_alloc_n(a, inp_start, n_i - n_o, out_start);// may throw
   }
   else{
      out_start = _Boost::container::copy_n(inp_start, n_i, out_start);  // may throw
      _Boost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
...
{
   if (n_o < n_i){
      inp_start = _Boost::container::move_n_source_dest(inp_start, n_o, out_start);  // may throw
      _Boost::container::uninitialized_move_alloc_n(a, inp_start, n_i - n_o, out_start);  // may throw
   }
   else{
      out_start = _Boost::container::move_n(inp_start, n_i, out_start);  // may throw
      _Boost::container::destroy_alloc_n(a, out_start, n_o - n_i);
   }
}
