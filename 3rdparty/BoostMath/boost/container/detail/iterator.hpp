...
using ::_Boost::intrusive::iterator_traits;
using ::_Boost::intrusive::iterator_distance;
using ::_Boost::intrusive::iterator_advance;
using ::_Boost::intrusive::iterator;
using ::_Boost::intrusive::iterator_enable_if_tag;
using ::_Boost::intrusive::iterator_disable_if_tag;
using ::_Boost::intrusive::iterator_arrow_result;
...
class back_emplacer
{
   ...
   {
      container.emplace_back(_Boost::forward<U>(value));
      return *this;
   }
