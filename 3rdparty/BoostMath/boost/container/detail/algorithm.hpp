...
using _Boost::intrusive::algo_equal;
using _Boost::intrusive::algo_lexicographical_compare;
...
{	return _Boost::container::binder1st<Func>(func, arg);  }
...
{
   return (_Boost::container::binder2nd<Func>(func, arg));
}
...
{
   return _Boost::container::unary_negate<Func>(func);
}
