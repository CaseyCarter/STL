...
{
   typedef _Boost::container::allocator_traits<Allocator> AllocTraits;
...
struct scoped_destroy_deallocator
{
   ...
   {
      if(m_ptr){
         AllocTraits::destroy(m_alloc, _Boost::movelib::to_raw_pointer(m_ptr));
...
struct scoped_destructor_n
{
   ...
   {
      if(!m_p) return;
      value_type *raw_ptr = _Boost::movelib::to_raw_pointer(m_p);
      while(m_n--){
...
class allocator_destroyer
{
   ...
   {
      AllocTraits::destroy(a_, _Boost::movelib::to_raw_pointer(p));
...
class allocator_destroyer_and_chain_builder
{
   ...
   {
      allocator_traits<Allocator>::destroy(a_, _Boost::movelib::to_raw_pointer(p));
      c_.push_back(p);
   }
};
