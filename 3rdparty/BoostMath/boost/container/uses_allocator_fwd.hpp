...
//! \file
//!   This header forward declares _Boost::container::constructible_with_allocator_prefix,
//!   _Boost::container::constructible_with_allocator_suffix and
//!   _Boost::container::uses_allocator. Also defines the following types:
