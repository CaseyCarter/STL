...
class vec_iterator
{
   ...
   typedef typename _Boost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   typedef typename _Boost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename dtl::if_c
      < IsConst
      , typename _Boost::intrusive::pointer_traits<Pointer>::template
                                 rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef typename _Boost::intrusive::pointer_traits<pointer>                       ptr_traits;
   ...
   : public Allocator
{
   ...
   typedef _Boost::container::allocator_traits<allocator_type>  allocator_traits_type;
   ...
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : allocator_type(_Boost::forward<AllocConvertible>(a)), m_start(), m_size(), m_capacity()
   {}

   //Constructor, does not throw
   template<class AllocConvertible>
   vector_alloc_holder(vector_uninitialized_size_t, BOOST_FWD_REF(AllocConvertible) a, size_type initial_size)
      : allocator_type(_Boost::forward<AllocConvertible>(a))
      , m_start()
   ...
   vector_alloc_holder(initial_capacity_t, pointer p, size_type n, BOOST_FWD_REF(AllocFwd) a)
      : allocator_type(::_Boost::forward<AllocFwd>(a))
      , m_start(p)
      , m_size()
      , m_capacity(n)
   {}
   ...
   BOOST_CONTAINER_FORCEINLINE pointer allocation_command(_Boost::container::allocation_type command,
   ...
   BOOST_CONTAINER_FORCEINLINE pointer allocate(size_type n)
   {
      ...
      if ( max < n )
         _Boost::container::throw_length_error("get_next_capacity, allocator's max size reached");
   ...
   {
      _Boost::adl_move_swap(this->m_start, x.m_start);
      _Boost::adl_move_swap(this->m_size, x.m_size);
      _Boost::adl_move_swap(this->m_capacity, x.m_capacity);
   }
   ...
   BOOST_CONTAINER_FORCEINLINE pointer priv_allocation_command(version_1, _Boost::container::allocation_type command,
   ...
   pointer priv_allocation_command(version_2, _Boost::container::allocation_type command,
                         size_type limit_size,
                         size_type &prefer_in_recvd_out_size,
                         pointer &reuse)
   {
   ...
   : public Allocator
{
   ...
   template<class AllocConvertible>
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : allocator_type(_Boost::forward<AllocConvertible>(a)), m_size()
   {}
   ...
   {
      ::_Boost::container::uninitialized_move_alloc_n
         (this->alloc(), _Boost::movelib::to_raw_pointer(holder.start()), m_size, _Boost::movelib::to_raw_pointer(this->start()));
   }
      ...
      , m_size(holder.m_size) //Initialize it to m_size as first_allocation can only succeed or abort
   {
      ...
      ::_Boost::container::uninitialized_move_alloc_n
         (this->alloc(), _Boost::movelib::to_raw_pointer(holder.start()), n, _Boost::movelib::to_raw_pointer(this->start()));
   }
   ...
   void priv_deep_swap(vector_alloc_holder<OtherAllocator, OtherStoredSizeType, OtherAllocatorVersion> &x)
   {
      ...
      value_type *const first_this = _Boost::movelib::to_raw_pointer(this->start());
      value_type *const first_x = _Boost::movelib::to_raw_pointer(x.start());

      if(this->m_size < x.m_size){
         _Boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x, x.m_size);
      }
      else{
         _Boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this, this->m_size);
      }
      _Boost::adl_move_swap(this->m_size, x.m_size);
   }
};
...
//! \tparam Options A type produced from \c _Boost::container::vector_options.
...
public:
   ...
   typedef ::_Boost::container::allocator_traits<allocator_type>            allocator_traits_t;
   ...
   typedef BOOST_CONTAINER_IMPDEF(_Boost::container::reverse_iterator<iterator>)        reverse_iterator;
   typedef BOOST_CONTAINER_IMPDEF(_Boost::container::reverse_iterator<const_iterator>)  const_reverse_iterator;

private:

   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   typedef typename _Boost::container::
   ...
   typedef typename dtl::version<allocator_type>::type alloc_version;
   typedef _Boost::container::vector_alloc_holder
   ...
   BOOST_CONTAINER_FORCEINLINE vector(initial_capacity_t, pointer initial_memory, size_type capacity, BOOST_FWD_REF(AllocFwd) a)
      : m_holder(initial_capacity_t(), initial_memory, capacity, ::_Boost::forward<AllocFwd>(a))
   {}
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      _Boost::container::uninitialized_value_init_alloc_n
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      _Boost::container::uninitialized_default_init_alloc_n
         (this->m_holder.alloc(), n, this->priv_raw_begin());
   }
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      _Boost::container::uninitialized_fill_alloc_n
...
//           ) -> vector<typename iterator_traits<InIt>::value_type, new_allocator<typename iterator_traits<InIt>::value_type>>;
                 ...
                 , x.size())
   {
      ...
      #endif
      ::_Boost::container::uninitialized_copy_alloc_n
   ...
   vector(BOOST_RV_REF(vector) x) BOOST_NOEXCEPT_OR_NOTHROW
      :  m_holder(_Boost::move(x.m_holder))
      ...
      :  m_holder(vector_uninitialized_size, a, x.size())
   {
      ...
      this->num_alloc += x.size() != 0;
      #endif
      ::_Boost::container::uninitialized_copy_alloc_n_source
         ( this->m_holder.alloc(), x.priv_raw_begin()
         , x.size(), this->priv_raw_begin());
   }
                 ...
                 )
   {
      if(is_propagable_from(x.get_stored_allocator(), x.m_holder.start(), a, true)){
         ...
         this->num_alloc += n != 0;
         #endif
         ::_Boost::container::uninitialized_move_alloc_n_source
            ( this->m_holder.alloc(), x.priv_raw_begin()
   ...
   {
      _Boost::container::destroy_alloc_n
   ...
   {
      if (BOOST_LIKELY(&x != this)){
         this->priv_move_assign(_Boost::move(x));
      }
      return *this;
   }
      ...
      )
   {
      ...
      if (first == last){
         ...
         const size_type n = static_cast<size_type>(end_pos - _Boost::movelib::iterator_to_raw_pointer(cur));
      ...
      )
   {
      ...
      const size_type input_sz = static_cast<size_type>(_Boost::container::iterator_distance(first, last));
      ...
      _Boost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), first, input_sz, this->priv_raw_begin(), this->size());
   ...
   BOOST_CONTAINER_FORCEINLINE reference emplace_back(BOOST_FWD_REF(Args)...args)
   {
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct(this->m_holder.alloc(), p, ::_Boost::forward<Args>(args)...);
         ...
         return *this->priv_forward_range_insert_no_capacity
            (this->back_ptr(), 1, type(::_Boost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   BOOST_CONTAINER_FORCEINLINE bool stable_emplace_back(BOOST_FWD_REF(Args)...args)
   {
      ...
      if (BOOST_LIKELY(is_room_enough)){
         //There is more memory, just construct a new object at the end
         allocator_traits_type::construct(this->m_holder.alloc(), this->priv_raw_end(), ::_Boost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
   ...
   //!
   //! <b>Complexity</b>: Linear to _Boost::container::iterator_distance [first, last).
   template <class InIt>
      ...
      )
   {
      ...
      return this->priv_forward_range_insert(vector_iterator_get_ptr(pos), _Boost::container::iterator_distance(first, last), proxy);
   }
   #endif

   //! <b>Requires</b>: p must be a valid iterator of *this. num, must
   //!   be equal to _Boost::container::iterator_distance(first, last)
   //!
   //! <b>Effects</b>: Insert a copy of the [first, last) range before pos.
   //!
   //! <b>Returns</b>: an iterator to the first inserted element or pos if first == last.
   ...
   //! <b>Complexity</b>: Linear to _Boost::container::iterator_distance [first, last).
   //!
   //! <b>Note</b>: This function avoids a linear operation to calculate _Boost::container::iterator_distance[first, last)
   ...
   iterator insert(const_iterator pos, size_type num, InIt first, InIt last)
   {
      ...
      BOOST_ASSERT(dtl::is_input_iterator<InIt>::value ||
                   num == static_cast<size_type>(_Boost::container::iterator_distance(first, last)));
      (void)last;
   ...
   iterator erase(const_iterator position)
   {
      ...
      T *const pos_ptr = _Boost::movelib::to_raw_pointer(p);
      T *const beg_ptr = this->priv_raw_begin();
      T *const new_end_ptr = ::_Boost::container::move(pos_ptr + 1, beg_ptr + this->m_holder.m_size, pos_ptr);
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      if (first != last){
         ...
         T* const first_ptr = _Boost::movelib::to_raw_pointer(vector_iterator_get_ptr(first));
         T* const last_ptr  = _Boost::movelib::to_raw_pointer(vector_iterator_get_ptr(last));
         T* const ptr = _Boost::movelib::to_raw_pointer(_Boost::container::move(last_ptr, old_end_ptr, first_ptr));
   ...
   {  return x.size() == y.size() && ::_Boost::container::algo_equal(x.begin(), x.end(), y.begin());  }
   ...
   BOOST_CONTAINER_FORCEINLINE void merge(InputIt first, InputIt last, Compare comp)
   {
      ...
      if(!dtl::is_input_iterator<InputIt>::value &&
         free_cap < (n = static_cast<size_type>(_Boost::container::iterator_distance(first, last)))){
         ...
         _Boost::movelib::adaptive_merge(raw_beg, raw_pos, raw_end, comp, raw_end, free_cap - n);
      }
   }
   ...
   BOOST_CONTAINER_FORCEINLINE void merge_unique(InputIt first, InputIt last, Compare comp)
   {
      ...
      _Boost::movelib::adaptive_merge(raw_beg, raw_pos, raw_end, comp, raw_end, this->capacity() - this->size());
   }
   ...
   void priv_merge_in_new_buffer(FwdIt first, size_type n, Compare comp, Version)
   {
      ...
      T* d_first = _Boost::movelib::to_raw_pointer(new_storage);
      size_type added = n;
      //Merge in new buffer loop
      while(1){
         if(!n) {
            ::_Boost::container::uninitialized_move_alloc(this->m_holder.alloc(), pbeg, pend, d_first);
            break;
         } 
         else if(pbeg == pend) {
            ::_Boost::container::uninitialized_move_alloc_n(this->m_holder.alloc(), first, n, d_first);
            break;
         }
         //maintain stability moving external values only if they are strictly less
            ...
            allocator_traits_type::construct( this->m_holder.alloc(), d_first, _Boost::move(*pbeg) );
            new_values_destroyer.increment_size(1u);
            ++pbeg;
            ++d_first;
         }
      ...
      _Boost::container::destroy_alloc_n(a, _Boost::movelib::to_raw_pointer(old_p), old_size);
      if (old_cap > 0) {
         ...
         < dtl::is_version<typename real_allocator<T, OtherA>::type, 0>::value >::type * = 0)
   {
      ...
      _Boost::container::move_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
         ...
         >::type * = 0)
   {
      ...
      //Else do a one by one move
         ...
         this->assign( _Boost::make_move_iterator(_Boost::movelib::iterator_to_raw_pointer(x.begin()))
                     , _Boost::make_move_iterator(_Boost::movelib::iterator_to_raw_pointer(x.end()  ))
                     );
      }
         ...
         < dtl::is_version<typename real_allocator<T, OtherA>::type, 0>::value >::type * = 0)
   {
      ...
      const size_type this_sz  = m_holder.m_size;
      const size_type other_sz = static_cast<size_type>(x.m_holder.m_size);
      _Boost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
      this->m_holder.m_size = other_sz;
   }
   ...
   void priv_swap(Vector &x, dtl::false_type)  //version_N
   {
      ...
      if(are_swap_propagable( this->get_stored_allocator(), this->m_holder.start()
         ...
         for(size_type i = 0; i != common_elements; ++i){
            _Boost::adl_move_swap(sml[i], big[i]);
         }
         //... and move-insert the remaining range
         sml.insert( sml.cend()
                   , _Boost::make_move_iterator(_Boost::movelib::iterator_to_raw_pointer(big.nth(common_elements)))
                   , _Boost::make_move_iterator(_Boost::movelib::iterator_to_raw_pointer(big.end()))
                   );
   ...
   dtl::insert_range_proxy<allocator_type, _Boost::move_iterator<T*>, T*> priv_dummy_empty_proxy()
   {
      return dtl::insert_range_proxy<allocator_type, _Boost::move_iterator<T*>, T*>
         (::_Boost::make_move_iterator((T *)0));
   }
   ...
   void priv_reserve_no_capacity(size_type new_cap, version_1)
   {
      ...
      this->priv_forward_range_insert_new_allocation
         ( _Boost::movelib::to_raw_pointer(p), new_cap, this->priv_raw_end(), 0, this->priv_dummy_empty_proxy());
   }
   ...
   void priv_reserve_no_capacity(size_type new_cap, version_2)
   {
      ...
      if(same_buffer_start){
         ...
         T * const new_mem = _Boost::movelib::to_raw_pointer(ret);
   ...
   void priv_destroy_last_n(const size_type n) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      if(!value_traits::trivial_dctr){
         ...
         _Boost::container::destroy_alloc_n(this->get_stored_allocator(), destroy_pos, n);
      }
   ...
   void priv_uninitialized_construct_at_end(InpIt first, InpIt last)
   {
      ...
      T* const new_end_pos = _Boost::container::uninitialized_copy_alloc(this->m_holder.alloc(), first, last, old_end_pos);
   ...
   iterator priv_insert(const const_iterator &p, BOOST_FWD_REF(U) x)
   {
      ...
      return this->priv_forward_range_insert
         ( vector_iterator_get_ptr(p), 1, dtl::get_insert_value_proxy<T*, allocator_type>(::_Boost::forward<U>(x)));
   }
   ...
   void priv_push_back(BOOST_FWD_REF(U) u)
   {
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct
            ( this->m_holder.alloc(), this->priv_raw_end(), ::_Boost::forward<U>(u) );
         ++this->m_holder.m_size;
      }
      else{
         this->priv_forward_range_insert_no_capacity
            ( this->back_ptr(), 1
            , this->priv_single_insert_proxy(::_Boost::forward<U>(u)), alloc_version());
      }
   }
   ...
   void priv_shrink_to_fit(version_1)
   {
      ...
      if(cp){
         ...
         if(!sz){
            ...
            #endif
            this->priv_forward_range_insert_new_allocation
               ( _Boost::movelib::to_raw_pointer(p), sz
      ...
      (const pointer &pos, const size_type n, const InsertionProxy insert_range_proxy, version_1)
   {
      ...
      T *const raw_pos = _Boost::movelib::to_raw_pointer(pos);

      const size_type new_cap = this->m_holder.template next_capacity<growth_factor_type>(n);
      //Pass the hint so that allocators can take advantage of this.
      T * const new_buf = _Boost::movelib::to_raw_pointer(this->m_holder.allocate(new_cap));
      #ifdef BOOST_CONTAINER_VECTOR_ALLOC_STATS
      ++this->num_alloc;
      #endif
      this->priv_forward_range_insert_new_allocation
      ...
      (const pointer &pos, const size_type n, const InsertionProxy insert_range_proxy, version_2)
   {
      ...
      if(reuse){
         ...
         //Backwards (and possibly forward) expansion
            ...
            #endif
            this->priv_forward_range_insert_expand_backwards
               (_Boost::movelib::to_raw_pointer(ret), real_cap, raw_pos, n, insert_range_proxy);
         }
      }
      //New buffer
      else{
      ...
      (size_type first_pos, size_type last_pos, size_type limit_pos, size_type shift_count)
   {
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         _Boost::container::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      else if((first_pos + shift_count) >= limit_pos){
         //All uninitialized_moved
         ::_Boost::container::uninitialized_move_alloc
      ...
      //Case C:
         ...
         ::_Boost::container::uninitialized_move_alloc(this->m_holder.alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         _Boost::container::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   {  return _Boost::movelib::to_raw_pointer(m_holder.start());  }
   ...
   void priv_forward_range_insert_expand_forward(T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if (!elems_after){
         ...
         _Boost::container::move_backward(pos, old_finish - n, old_finish);
         ...
         ::_Boost::container::uninitialized_move_alloc(this->m_holder.alloc(), pos, old_finish, pos + n);
         BOOST_TRY{
         ...
         BOOST_CATCH(...){
            _Boost::container::destroy_alloc_n(this->get_stored_allocator(), pos + n, elems_after);
            BOOST_RETHROW
         }
         BOOST_CATCH_END
      }
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(old_buffer){
         new_finish = ::_Boost::container::uninitialized_move_alloc
      ...
      if(old_buffer){
         ...
         if(!value_traits::trivial_dctr_after_move)
            _Boost::container::destroy_alloc_n(this->get_stored_allocator(), old_buffer, this->m_holder.m_size);
          ...
          T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(s_before >= before_plus_new){
         ...
         T *const new_elem_pos =
            ::_Boost::container::uninitialized_move_alloc(this->m_holder.alloc(), old_start, pos, new_start);
         ...
         //s_before is so big that divides old_end
            ...
            if(!value_traits::trivial_dctr){
               ...
               if(remaining_pos != old_start){  //Make sure data has to be moved
                  ::_Boost::container::move(remaining_pos, old_finish, old_start);
               }
         ...
         if (s_before <= elemsbefore) {
            ...
            T *const next = ::_Boost::container::move(old_start + s_before, pos, old_start);
            ...
            if(!do_after && (n != s_before)){
               ...
               ::_Boost::container::move(pos, old_finish, next + new_1st_range);
            }
         }
         else {
            ...
            T * const new_pos = ::_Boost::container::uninitialized_move_alloc
            ...
            if(do_after){
               ...
               T* const move_end = move_start != pos ? ::_Boost::container::move(pos, old_finish, move_start)
                                                     : old_finish;
               //Destroy remaining moved elements from old_end except if they
               //have trivial destructor after being moved
               size_type n_destroy = s_before - n;
               if(!value_traits::trivial_dctr_after_move)
                  _Boost::container::destroy_alloc_n(this->get_stored_allocator(), move_end, n_destroy);
         ...
         if(do_after){
            ...
            if (elemsafter >= n_after){
               ...
               _Boost::container::move_backward(pos, finish_n, old_finish);
...
struct has_trivial_destructor_after_move<_Boost::container::vector<T, Allocator, Options> >
{
   typedef typename _Boost::container::vector<T, Allocator, Options>::allocator_type allocator_type;
   typedef typename ::_Boost::container::allocator_traits<allocator_type>::pointer pointer;
   static const bool value = ::_Boost::has_trivial_destructor_after_move<allocator_type>::value &&
                             ::_Boost::has_trivial_destructor_after_move<pointer>::value;
};
