...
class basic_string_base
{
 ...
 public:
   ...
   typedef ::_Boost::intrusive::pointer_traits<pointer> pointer_traits;
      ...
      :  public allocator_type
   {
      ...
      explicit members_holder(BOOST_FWD_REF(AllocatorConvertible) a)
         :  allocator_type(_Boost::forward<AllocatorConvertible>(a))
      { this->init(); }
   ...
   typedef dtl::integral_constant<unsigned,
      _Boost::container::dtl::version<allocator_type>::value> alloc_version;
   ...
   void construct(pointer p, const value_type &value = value_type())
   {
      allocator_traits_type::construct
         ( this->alloc()
         , _Boost::movelib::to_raw_pointer(p)
         , value
         );
   }
   ...
   {
      value_type *raw_p = _Boost::movelib::to_raw_pointer(p);
      for(; n--; ++raw_p){
   ...
   void swap_data(basic_string_base& other)
   {
      if(this->is_short()){
         ...
         if(other.is_short()){
            ...
            _Boost::adl_move_swap(*this->members_.plong_repr(), *other.members_.plong_repr());
         }
      }
   }
};
   ...
   :  private dtl::basic_string_base<typename real_allocator<CharT, Allocator>::type>
{
   ...
   struct Not_within_traits
   {
      ...
      {
         return _Boost::container::find_if(m_first, m_last,
                        _Boost::container::bind1st(Eq_traits<Tr>(), x)) == m_last;
      }
   };
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   ...
   void shrink_to_fit()
   {
      ...
      if(this->priv_storage() > InternalBufferChars){
         ...
         if(this->priv_size() < InternalBufferChars){
            ...
            Traits::copy( _Boost::movelib::to_raw_pointer(this->priv_short_addr())
                        , _Boost::movelib::to_raw_pointer(long_addr)
                        , long_size+1);
            BOOST_ASSERT(!this->is_short());
            this->destroy_long();
   ...
   //! <b>Effects</b>: Equivalent to assign(basic_string(first, last)).
    ...
    basic_string& assign(const CharT* first, const CharT* last)
    {
       ...
       this->reserve(n);
       CharT* ptr = _Boost::movelib::to_raw_pointer(this->priv_addr());
      ...
      )
   {
      size_type cur = 0;
      const pointer addr = this->priv_addr();
      CharT *ptr = _Boost::movelib::to_raw_pointer(addr);
      const size_type old_size = this->priv_size();
   ...
   basic_string& insert(size_type pos1, const basic_string& s, size_type pos2, size_type n = npos)
   {
      ...
      if (sz > this->max_size() - len)
         throw_length_error("basic_string::insert max_size() exceeded");
      const CharT *beg_ptr = _Boost::movelib::to_raw_pointer(s.begin()) + pos2;
      ...
      )
   {
      const size_type n_pos = p - this->cbegin();
      if (first != last) {
         const size_type n = _Boost::container::iterator_distance(first, last);
         const size_type old_size = this->priv_size();
         ...
         if(enough_capacity){
            ...
            if (elems_after >= n) {
               ...
               Traits::move(const_cast<CharT*>(_Boost::movelib::to_raw_pointer(p + n)),
                           _Boost::movelib::to_raw_pointer(p),
                           (elems_after - n) + 1);
               this->priv_copy(first, last, const_cast<CharT*>(_Boost::movelib::to_raw_pointer(p)));
            }
            else {
               ForwardIter mid = first;
               _Boost::container::iterator_advance(mid, elems_after + 1);
               ...
               this->priv_copy(first, mid, const_cast<CharT*>(_Boost::movelib::to_raw_pointer(p)));
            }
         }
         else{
            ...
            if(!hint){
               ...
               //than with vector<T>
               value_type * const oldbuf     = _Boost::movelib::to_raw_pointer(old_start);
               value_type * const newbuf     = _Boost::movelib::to_raw_pointer(new_start);
               const value_type *const pos   = _Boost::movelib::to_raw_pointer(p);
   ...
   iterator erase(const_iterator p) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      CharT * const ptr = const_cast<CharT*>(_Boost::movelib::to_raw_pointer(p));
      const size_type old_size = this->priv_size();
      Traits::move(ptr,
                   _Boost::movelib::to_raw_pointer(p + 1),
   ...
   {
      CharT * f = const_cast<CharT*>(_Boost::movelib::to_raw_pointer(first));
      if (first != last) { // The move includes the terminating null.
         const size_type num_erased = last - first;
         const size_type old_size = this->priv_size();
         Traits::move(f,
                      _Boost::movelib::to_raw_pointer(last),
   ...
   basic_string& replace(const_iterator i1, const_iterator i2, size_type n, CharT c)
   {
      ...
      if (len >= n) {
         Traits::assign(const_cast<CharT*>(_Boost::movelib::to_raw_pointer(i1)), n, c);
         erase(i1 + n, i2);
      }
      else {
         Traits::assign(const_cast<CharT*>(_Boost::movelib::to_raw_pointer(i1)), len, c);
         insert(i2, n - len, c);
      }
      return *this;
   }
      ...
      )
   {
      for ( ; i1 != i2 && j1 != j2; ++i1, ++j1){
         Traits::assign(*const_cast<CharT*>(_Boost::movelib::to_raw_pointer(i1)), *j1);
      }
   ...
   {
      difference_type n = _Boost::container::iterator_distance(j1, j2);
      const difference_type len = i2 - i1;
      if (len >= n) {
         this->priv_copy(j1, j2, const_cast<CharT*>(_Boost::movelib::to_raw_pointer(i1)));
         this->erase(i1 + n, i2);
      }
      else {
         ForwardIter m = j1;
         _Boost::container::iterator_advance(m, len);
         this->priv_copy(j1, m, const_cast<CharT*>(_Boost::movelib::to_raw_pointer(i1)));
         this->insert(i2, m, j2);
      }
      return *this;
   }
   ...
   size_type copy(CharT* s, size_type n, size_type pos = 0) const
   {
      ...
      Traits::copy(s, _Boost::movelib::to_raw_pointer(this->priv_addr() + pos), len);
      return len;
   }
   ...
   {  return _Boost::movelib::to_raw_pointer(this->priv_addr()); }
   ...
   size_type find(const CharT* s, size_type pos, size_type n) const
   {
      if (pos + n > this->size())
         ...
         const const_iterator result =
            _Boost::container::search(_Boost::movelib::to_raw_pointer(addr + pos),
                   _Boost::movelib::to_raw_pointer(finish),
   ...
   size_type find(CharT c, size_type pos = 0) const
   {
      ...
      if (pos >= sz)
         ...
         const const_iterator result =
            _Boost::container::find_if(addr + pos, finish,
                  _Boost::container::bind2nd(Eq_traits<Traits>(), c));
         return result != finish ? result - begin() : npos;
      }
   }
   ...
   size_type rfind(CharT c, size_type pos = npos) const
   {
      ...
      if (len < 1)
         ...
         const_reverse_iterator rresult =
            _Boost::container::find_if(const_reverse_iterator(last), rend(),
                  _Boost::container::bind2nd(Eq_traits<Traits>(), c));
   ...
   size_type find_first_of(const CharT* s, size_type pos, size_type n) const
   {
      ...
      if (pos >= sz)
         ...
         const pointer addr    = this->priv_addr();
         pointer finish = addr + sz;
         const_iterator result = _Boost::container::find_first_of
   ...
   size_type find_last_of(const CharT* s, size_type pos, size_type n) const
   {
      ...
      if (len < 1)
         ...
         const const_reverse_iterator rresult =
            _Boost::container::find_first_of(const_reverse_iterator(last), rend(),
                               s, s + n, Eq_traits<Traits>());
   ...
   size_type find_first_not_of(const CharT* s, size_type pos, size_type n) const
   {
      if (pos > this->size())
         ...
         const const_iterator result = _Boost::container::find_if
   ...
   size_type find_first_not_of(CharT c, size_type pos = 0) const
   {
      if (pos > this->size())
         ...
         const const_iterator result
            = _Boost::container::find_if(addr + pos, finish,
                     _Boost::container::not1(_Boost::container::bind2nd(Eq_traits<Traits>(), c)));
         return result != finish ? result - begin() : npos;
      }
   }
   ...
   static int s_compare(It1 f1, It1 l1, It2 f2, It2 l2)
   {
      ...
      const int cmp = Traits::compare(_Boost::movelib::to_raw_pointer(f1),
                                      _Boost::movelib::to_raw_pointer(f2),
                                      dtl::min_value(n1, n2));
      ...
      , typename dtl::enable_if<dtl::is_same<AllocVersion, version_1> >::type* = 0)
   {
      ...
      BOOST_TRY{
         ...
         //Copy and update
         Traits::copy( _Boost::movelib::to_raw_pointer(ret)
                     , _Boost::movelib::to_raw_pointer(this->priv_long_addr())
                     , long_size+1);
   ...
   basic_string& priv_replace_dispatch(const_iterator first, const_iterator last,
                                       ...
                                       dtl::false_)
   {
      typedef typename _Boost::container::iterator_traits<InputIter>::iterator_category Category;
...
struct has_trivial_destructor_after_move<_Boost::container::basic_string<C, T, Allocator> >
{
   typedef typename _Boost::container::basic_string<C, T, Allocator>::allocator_type allocator_type;
   typedef typename ::_Boost::container::allocator_traits<allocator_type>::pointer pointer;
