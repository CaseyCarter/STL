...
#define BOOST_IOSTREAMS_FORWARD(class, impl, device, params, args) \
    ...
    { this->impl(::_Boost::iostreams::detail::wrap(t) args()); } \
    class(device& t params()) \
    { this->impl(::_Boost::iostreams::detail::wrap(t) args()); } \
    class(const ::_Boost::reference_wrapper<device>& ref params()) \
    { this->impl(ref args()); } \
    void open(const device& t params()) \
    { this->impl(::_Boost::iostreams::detail::wrap(t) args()); } \
    void open(device& t params()) \
    { this->impl(::_Boost::iostreams::detail::wrap(t) args()); } \
    void open(const ::_Boost::reference_wrapper<device>& ref params()) \
    { this->impl(ref args()); } \
...
# define BOOST_IOSTREAMS_DISABLE_IF_SAME(device, param) \
    , typename _Boost::disable_if< _Boost::is_same<device, param> >::type* = 0 \
    /**/
#else 
# define BOOST_IOSTREAMS_DISABLE_IF_SAME(device, param)
#endif
