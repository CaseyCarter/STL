...
struct resolve_traits {
    typedef typename 
            mpl::if_<
                _Boost::detail::is_incrementable<T>,
...
range_adapter< Mode, _Boost::iterator_range<Iter> >
resolve(const _Boost::iterator_range<Iter>& rng)
{ return range_adapter< Mode, _Boost::iterator_range<Iter> >(rng); }
