...
{ 
    try {
        _Boost::iostreams::close(t, BOOST_IOS::in);
    } catch (...) {
        try {
            _Boost::iostreams::close(t, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    _Boost::iostreams::close(t, BOOST_IOS::out);
...
{ 
    try {
        _Boost::iostreams::close(t, snk, BOOST_IOS::in);
    } catch (...) {
        try {
            _Boost::iostreams::close(t, snk, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    _Boost::iostreams::close(t, snk, BOOST_IOS::out);
