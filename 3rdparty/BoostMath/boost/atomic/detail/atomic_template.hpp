...
#pragma warning(push)
// '_Boost::atomics::atomic<T>' : multiple assignment operators specified
...
protected:
    ...
    union
    {
        ...
        typename _Boost::type_with_alignment< storage_alignment >::type m_aligner;
    };
#endif
...
public:
    ...
    BOOST_STATIC_ASSERT_MSG(sizeof(value_type) > 0u, "_Boost::atomic<T> requires T to be a complete type");
#if !defined(BOOST_ATOMIC_DETAIL_NO_CXX11_IS_TRIVIALLY_COPYABLE)
    BOOST_STATIC_ASSERT_MSG(atomics::detail::is_trivially_copyable< value_type >::value, "_Boost::atomic<T> requires T to be a trivially copyable type");
#endif
...
typedef atomic< _Boost::ulong_long_type > atomic_ullong;
typedef atomic< _Boost::long_long_type > atomic_llong;
#endif
...
typedef atomic< _Boost::intptr_t > atomic_intptr_t;
typedef atomic< _Boost::uintptr_t > atomic_uintptr_t;
#endif
