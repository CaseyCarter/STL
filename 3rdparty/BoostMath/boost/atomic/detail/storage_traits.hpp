...
struct BOOST_ATOMIC_DETAIL_MAY_ALIAS buffer_storage
{
    ...
    union
    {
        ...
        typename _Boost::type_with_alignment< Alignment >::type aligner;
    };
#endif
...
{
    typedef _Boost::uint8_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef _Boost::uint16_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< _Boost::uint16_t >::value;
...
{
    typedef _Boost::uint32_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< _Boost::uint32_t >::value;
...
{
    typedef _Boost::uint64_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< _Boost::uint64_t >::value;
...
{
    typedef _Boost::uint128_type BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< _Boost::uint128_type >::value;
    static BOOST_CONSTEXPR_OR_CONST std::size_t alignment = 16u;
};
