...
template< typename T >
using is_trivially_default_constructible = _Boost::has_trivial_constructor< T >;
#else
template< typename T >
struct is_trivially_default_constructible : public _Boost::has_trivial_constructor< T > {};
#endif
