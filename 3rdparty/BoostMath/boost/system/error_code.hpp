...
protected:
    ...
    explicit BOOST_SYSTEM_CONSTEXPR error_category( _Boost::ulong_long_type id ) BOOST_NOEXCEPT: id_( id )
    {
    }
...
public:
    ...
    BOOST_SYSTEM_CONSTEXPR generic_error_category() BOOST_NOEXCEPT:
        error_category( ( _Boost::ulong_long_type( 0xB2AB117A ) << 32 ) + 0x257EDF0D )
    {
    }
...
public:
    ...
    BOOST_SYSTEM_CONSTEXPR system_error_category() BOOST_NOEXCEPT:
        error_category( ( _Boost::ulong_long_type( 0x8FAFD21E ) << 32 ) + 0x25C5E09B )
    {
    }
...
inline std::size_t hash_value( error_code const & ec )
{
    ...
    _Boost::ulong_long_type id_ = cat.id_;

    if( id_ == 0 )
    {
        id_ = reinterpret_cast<_Boost::uintptr_t>( &cat );
    }

    _Boost::ulong_long_type hv = ( _Boost::ulong_long_type( 0xCBF29CE4 ) << 32 ) + 0x84222325;
    _Boost::ulong_long_type const prime = ( _Boost::ulong_long_type( 0x00000100 ) << 32 ) + 0x000001B3;
...
inline std::string _Boost::system::detail::generic_error_category::message( int ev ) const
{
    return generic_error_category_message( ev );
}

inline char const * _Boost::system::detail::generic_error_category::message( int ev, char * buffer, std::size_t len ) const BOOST_NOEXCEPT
{
...
inline _Boost::system::error_condition _Boost::system::detail::system_error_category::default_error_condition( int ev ) const BOOST_NOEXCEPT
{
    return system_category_default_error_condition_win32( ev );
}

inline std::string _Boost::system::detail::system_error_category::message( int ev ) const
{
    return system_category_message_win32( ev );
}

inline char const * _Boost::system::detail::system_error_category::message( int ev, char * buffer, std::size_t len ) const BOOST_NOEXCEPT
{
...
inline _Boost::system::error_category::operator std::error_category const & () const
{
    return _Boost::system::detail::to_std_category( *this );
}
