...
class ratio
{
    static const _Boost::intmax_t ABS_N = mpl::abs_c<_Boost::intmax_t, N>::value;
    static const _Boost::intmax_t ABS_D = mpl::abs_c<_Boost::intmax_t, D>::value;
    ...
    static const _Boost::intmax_t SIGN_N = mpl::sign_c<_Boost::intmax_t,N>::value
      * mpl::sign_c<_Boost::intmax_t,D>::value;
    static const _Boost::intmax_t GCD = mpl::gcd_c<_Boost::intmax_t, ABS_N, ABS_D>::value;
public:
    BOOST_STATIC_CONSTEXPR _Boost::intmax_t num = SIGN_N * ABS_N / GCD;
    BOOST_STATIC_CONSTEXPR _Boost::intmax_t den = ABS_D / GCD;

#ifdef BOOST_RATIO_EXTENSIONS
    typedef mpl::rational_c_tag tag;
    typedef _Boost::rational<_Boost::intmax_t> value_type;
    typedef _Boost::intmax_t num_type;
    typedef _Boost::intmax_t den_type;
    ratio()
    {}
    template <_Boost::intmax_t _N2, _Boost::intmax_t _D2>
...
template <_Boost::intmax_t N, _Boost::intmax_t D>
const    _Boost::intmax_t ratio<N, D>::num;
template <_Boost::intmax_t N, _Boost::intmax_t D>
const    _Boost::intmax_t ratio<N, D>::den;
#endif
...
struct ratio_add
: _Boost::ratio_detail::ratio_add<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_subtract
: _Boost::ratio_detail::ratio_subtract<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_multiply
: _Boost::ratio_detail::ratio_multiply<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_divide
: _Boost::ratio_detail::ratio_divide<R1, R2>::type
{
};
...
template <class R1, class R2>
struct ratio_equal
    : public _Boost::integral_constant<bool,
                               (R1::num == R2::num && R1::den == R2::den)>
{};

template <class R1, class R2>
struct ratio_not_equal
    : public _Boost::integral_constant<bool, !ratio_equal<R1, R2>::value>
{};
...
template <class R1, class R2>
struct ratio_less
    : _Boost::integral_constant<bool, _Boost::ratio_detail::ratio_less<R1, R2>::value>
{};

template <class R1, class R2>
struct ratio_less_equal
    : _Boost::integral_constant<bool, !ratio_less<R2, R1>::value>
{};
...
struct ratio_greater_equal
    : _Boost::integral_constant<bool, !ratio_less<R1, R2>::value>
{};

template <class R1, class R2>
struct ratio_gcd :
    ratio<mpl::gcd_c<_Boost::intmax_t, R1::num, R2::num>::value,
        mpl::lcm_c<_Boost::intmax_t, R1::den, R2::den>::value>::type
{
};
...
template <class R>
struct ratio_abs
    : ratio<mpl::abs_c<_Boost::intmax_t, R::num>::value, R::den>::type
{
};
template <class R>
struct ratio_sign
    : mpl::sign_c<_Boost::intmax_t, R::num>
{
};
...
template <class R1, class R2>
struct ratio_lcm :
    ratio<mpl::lcm_c<_Boost::intmax_t, R1::num, R2::num>::value,
        mpl::gcd_c<_Boost::intmax_t, R1::den, R2::den>::value>::type
{
};
