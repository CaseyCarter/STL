...
_Boost
    ...
    exception_ptr
        {
        typedef _Boost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    unknown_exception:
        ...
        explicit
        unknown_exception( _Boost::exception const & e ):
            _Boost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, _Boost::exception const & e2 ):
                T(e1),
                _Boost::exception(e2)
                {
                add_original_type(e1);
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<_Boost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( _Boost::exception const * e2 = get_boost_exception(&e1) )
                return _Boost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return _Boost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return _Boost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( _Boost::exception const & e )
            {
            return _Boost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( _Boost::exception const * be = get_boost_exception(&e) )
                    ...
                    ... )
                        ...
                        try
                            ...
                            exception_detail::clone_base const & base =
                                _Boost::enable_current_exception(std_exception_ptr_wrapper(std::current_exception()));
