...
_Boost
    ...
    error_info:
        ...
        error_info( T && v ) BOOST_NOEXCEPT_IF(_Boost::is_nothrow_move_constructible<T>::value):
            v_(std::move(v))
            {
            }
        error_info( error_info && x ) BOOST_NOEXCEPT_IF(_Boost::is_nothrow_move_constructible<T>::value):
            v_(std::move(x.v_))
            {
            }
#endif
