...
#define BOOST_EXCEPTION_STATIC_TYPEID(T) ::_Boost::exception_detail::type_info_(BOOST_CORE_TYPEID(T))

#ifndef BOOST_NO_RTTI
#define BOOST_EXCEPTION_DYNAMIC_TYPEID(x) ::_Boost::exception_detail::type_info_(typeid(x))
#endif
