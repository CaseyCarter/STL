...
#include  <memory>
namespace _Boost { namespace exception_detail { using std::shared_ptr; } }
#else
namespace _Boost { template <class T> class shared_ptr; }
namespace _Boost { namespace exception_detail { using _Boost::shared_ptr; } }
#endif
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing _Boost::exception.
