...
CreateSemaphoreA(
    ...
    _Boost::winapi::LONG_ lInitialCount,
    _Boost::winapi::LONG_ lMaximumCount,
    _Boost::winapi::LPCSTR_ lpName);
...
ReleaseSemaphore(
    _Boost::winapi::HANDLE_ hSemaphore,
    _Boost::winapi::LONG_ lReleaseCount,
    _Boost::winapi::LPLONG_ lpPreviousCount);
