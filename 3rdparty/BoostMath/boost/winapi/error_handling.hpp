...
FormatMessageA(
    ...
    _Boost::winapi::LPCVOID_ lpSource,
    _Boost::winapi::DWORD_ dwMessageId,
    _Boost::winapi::DWORD_ dwLanguageId,
    _Boost::winapi::LPSTR_ lpBuffer,
...
FormatMessageW(
    ...
    _Boost::winapi::DWORD_ dwMessageId,
    _Boost::winapi::DWORD_ dwLanguageId,
    _Boost::winapi::LPWSTR_ lpBuffer,
    _Boost::winapi::DWORD_ nSize,
    va_list *Arguments);

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_SYMBOL_IMPORT _Boost::winapi::UINT_ BOOST_WINAPI_WINAPI_CC
SetErrorMode(_Boost::winapi::UINT_ uMode);
#endif
} // extern "C"
#endif
