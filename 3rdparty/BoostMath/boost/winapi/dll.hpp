...
#endif // _WIN64
}} // namespace _Boost::winapi

#if !defined( BOOST_NO_ANSI_APIS )
BOOST_SYMBOL_IMPORT _Boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryA(_Boost::winapi::LPCSTR_ lpFileName);

BOOST_SYMBOL_IMPORT _Boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryExA(
    _Boost::winapi::LPCSTR_ lpFileName,
    _Boost::winapi::HANDLE_ hFile,
    _Boost::winapi::DWORD_ dwFlags
);

BOOST_SYMBOL_IMPORT _Boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleA(_Boost::winapi::LPCSTR_ lpFileName);

BOOST_SYMBOL_IMPORT _Boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameA(
    _Boost::winapi::HMODULE_ hModule,
    _Boost::winapi::LPSTR_ lpFilename,
    _Boost::winapi::DWORD_ nSize
);
#endif

BOOST_SYMBOL_IMPORT _Boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryW(_Boost::winapi::LPCWSTR_ lpFileName);

BOOST_SYMBOL_IMPORT _Boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryExW(
    _Boost::winapi::LPCWSTR_ lpFileName,
    _Boost::winapi::HANDLE_ hFile,
    _Boost::winapi::DWORD_ dwFlags
);

BOOST_SYMBOL_IMPORT _Boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleW(_Boost::winapi::LPCWSTR_ lpFileName);

BOOST_SYMBOL_IMPORT _Boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameW(
    _Boost::winapi::HMODULE_ hModule,
    _Boost::winapi::LPWSTR_ lpFilename,
    _Boost::winapi::DWORD_ nSize
);

#if !defined( UNDER_CE )
BOOST_SYMBOL_IMPORT _Boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddress(_Boost::winapi::HMODULE_ hModule, _Boost::winapi::LPCSTR_ lpProcName);
#else
...
BOOST_SYMBOL_IMPORT _Boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressA(_Boost::winapi::HMODULE_ hModule, _Boost::winapi::LPCSTR_ lpProcName);
BOOST_SYMBOL_IMPORT _Boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressW(_Boost::winapi::HMODULE_ hModule, _Boost::winapi::LPCWSTR_ lpProcName);
#endif

struct _MEMORY_BASIC_INFORMATION;

#if !defined( BOOST_WINAPI_IS_MINGW )
BOOST_SYMBOL_IMPORT _Boost::winapi::SIZE_T_ BOOST_WINAPI_WINAPI_CC
VirtualQuery(
    _Boost::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    _Boost::winapi::SIZE_T_ dwLength
);
...
FreeLibrary(_Boost::winapi::HMODULE_ hModule);
}
#endif
