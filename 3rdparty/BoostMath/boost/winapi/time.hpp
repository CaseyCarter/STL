...
BOOST_SYMBOL_IMPORT _Boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
...
BOOST_SYMBOL_IMPORT _Boost::winapi::ULONGLONG_ BOOST_WINAPI_WINAPI_CC
...
{
    _Boost::winapi::SYSTEMTIME_ st;
    _Boost::winapi::GetSystemTime(&st);
    _Boost::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
