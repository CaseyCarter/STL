...
typedef _Boost::winapi::VOID_ (BOOST_WINAPI_NTAPI_CC *WAITORTIMERCALLBACKFUNC)
    (_Boost::winapi::PVOID_, _Boost::winapi::BOOLEAN_);
typedef WAITORTIMERCALLBACKFUNC WAITORTIMERCALLBACK;

BOOST_SYMBOL_IMPORT _Boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
RegisterWaitForSingleObject(
    _Boost::winapi::PHANDLE_ phNewWaitObject,
    _Boost::winapi::HANDLE_ hObject,
    WAITORTIMERCALLBACK Callback,
    _Boost::winapi::PVOID_ Context,
    _Boost::winapi::ULONG_ dwMilliseconds,
    _Boost::winapi::ULONG_ dwFlags);
#endif
} // extern "C"
#endif
...
#if BOOST_WINAPI_PARTITION_DESKTOP
BOOST_SYMBOL_IMPORT _Boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWait(_Boost::winapi::HANDLE_ WaitHandle);
#endif

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_SYMBOL_IMPORT _Boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWaitEx(
    _Boost::winapi::HANDLE_ WaitHandle,
    _Boost::winapi::HANDLE_ CompletionEvent);
#endif
} // extern "C"
#endif
