...
BOOST_SYMBOL_IMPORT _Boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
SignalObjectAndWait(
    _Boost::winapi::HANDLE_ hObjectToSignal,
    _Boost::winapi::HANDLE_ hObjectToWaitOn,
    _Boost::winapi::DWORD_ dwMilliseconds,
    _Boost::winapi::BOOL_ bAlertable);
#endif
#endif
...
WaitForMultipleObjects(
    _Boost::winapi::DWORD_ nCount,
    _Boost::winapi::HANDLE_ const* lpHandles,
    _Boost::winapi::BOOL_ bWaitAll,
    _Boost::winapi::DWORD_ dwMilliseconds);
