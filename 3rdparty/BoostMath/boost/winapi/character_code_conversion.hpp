...
MultiByteToWideChar(
    _Boost::winapi::UINT_ CodePage,
    _Boost::winapi::DWORD_ dwFlags,
    _Boost::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
    _Boost::winapi::LPWSTR_ lpWideCharStr,
    int cchWideChar);
...
WideCharToMultiByte(
    _Boost::winapi::UINT_ CodePage,
    _Boost::winapi::DWORD_ dwFlags,
    _Boost::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    _Boost::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    _Boost::winapi::LPCSTR_ lpDefaultChar,
    _Boost::winapi::LPBOOL_ lpUsedDefaultChar);
