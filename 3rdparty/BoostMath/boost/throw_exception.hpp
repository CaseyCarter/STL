...
BOOST_NORETURN void throw_exception( std::exception const & e, _Boost::source_location const & loc ); // user defined
...
template<class E> BOOST_NORETURN void throw_exception( E const & e, _Boost::source_location const & )
{
    throw_exception_assert_compatibility( e );
    throw e;
}
...
template<class E> struct BOOST_SYMBOL_VISIBLE wrapexcept:
    public detail::wrapexcept_add_base<E, _Boost::exception_detail::clone_base>::type,
    public E,
    public detail::wrapexcept_add_base<E, _Boost::exception>::type
{
private:
...
private:
    ...
    void copy_from( _Boost::exception const* p )
    {
        static_cast<_Boost::exception&>( *this ) = *p;
    }
...
public:
    ...
    explicit wrapexcept( E const & e, _Boost::source_location const & loc ): E( e )
    {
        copy_from( &e );
    ...
    virtual _Boost::exception_detail::clone_base const * clone() const
    {
        wrapexcept * p = new wrapexcept( *this );
        deleter del = { p };

        _Boost::exception_detail::copy_boost_exception( p, this );
...
template<class E> BOOST_NORETURN void throw_exception( E const & e, _Boost::source_location const & loc )
{
    throw_exception_assert_compatibility( e );
...
#define BOOST_THROW_EXCEPTION(x) ::_Boost::throw_exception(x, BOOST_CURRENT_LOCATION)
