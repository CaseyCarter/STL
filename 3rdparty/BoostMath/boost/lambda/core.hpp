...
using ::_Boost::tuples::tuple;
using ::_Boost::tuples::null_type;
...
namespace {
  ...
  _Boost::lambda::placeholder1_type free1 = _Boost::lambda::placeholder1_type();
  _Boost::lambda::placeholder2_type free2 = _Boost::lambda::placeholder2_type();
  _Boost::lambda::placeholder3_type free3 = _Boost::lambda::placeholder3_type();

  _Boost::lambda::placeholder1_type& BOOST_ATTRIBUTE_UNUSED _1 = free1;
  _Boost::lambda::placeholder2_type& BOOST_ATTRIBUTE_UNUSED _2 = free2;
  _Boost::lambda::placeholder3_type& BOOST_ATTRIBUTE_UNUSED _3 = free3;
