...
template<> struct placeholder<FIRST> {
  ...
  RET call(CALL_FORMAL_ARGS) const { 
    BOOST_STATIC_ASSERT(_Boost::is_reference<RET>::value); 
...
template<class T>
struct result_of<_Boost::lambda::lambda_functor<T>()>
{
    typedef typename _Boost::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct result_of<const _Boost::lambda::lambda_functor<T>()>
{
    typedef typename _Boost::lambda::lambda_functor<T>::nullary_return_type type;
};
...
template<class T>
struct tr1_result_of<_Boost::lambda::lambda_functor<T>()>
{
    typedef typename _Boost::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct tr1_result_of<const _Boost::lambda::lambda_functor<T>()>
{
    typedef typename _Boost::lambda::lambda_functor<T>::nullary_return_type type;
};
