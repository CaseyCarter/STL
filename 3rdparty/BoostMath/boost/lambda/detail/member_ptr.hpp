...
struct member_pointer {
  typedef typename _Boost::add_reference<T>::type type;
...
struct member_pointer<const T U::*> {
  typedef typename _Boost::add_reference<const T>::type type;
  typedef U class_type;
...
struct member_pointer<volatile T U::*> {
  typedef typename _Boost::add_reference<volatile T>::type type;
  typedef U class_type;
...
struct member_pointer<const volatile T U::*> {
  typedef typename _Boost::add_reference<const volatile T>::type type;
  typedef U class_type;
...
public:
  ...
  private:
    ...
    typedef typename _Boost::remove_reference<type0>::type type1;
    ...
    typedef typename ::_Boost::remove_pointer<non_ref_A>::type non_pointer_A; 
  ...
  public:
    ...
    typedef typename detail::IF<
      ::_Boost::is_const<non_pointer_A>::value, 
      typename ::_Boost::add_const<type1>::type,
      type1
    >::RET type2;
    typedef typename detail::IF<
      ::_Boost::is_volatile<non_pointer_A>::value, 
      typename ::_Boost::add_volatile<type2>::type,
      type2
    >::RET type3;
    // add reference back
    typedef typename ::_Boost::add_reference<type3>::type type;
  };
};
...
struct member_pointer_action_helper<false, true> {
  ...
  template<class RET, class A, class B>
  static RET apply(A& a, B& b) { 
    typedef typename ::_Boost::remove_cv<B>::type plainB;
    typedef typename detail::member_pointer<plainB>::type ret_t; 
    typedef typename ::_Boost::remove_cv<A>::type plainA;
...
public:
  ...
  static RET apply(A& a, B& b) {
    typedef typename 
      ::_Boost::remove_cv<B>::type plainB;

    return detail::member_pointer_action_helper<
        _Boost::is_pointer<A>::value && 
...
struct return_type_N<other_action<member_pointer_action>, Args> {
  typedef typename _Boost::tuples::element<0, Args>::type A;
  typedef typename _Boost::tuples::element<1, Args>::type B;
  typedef typename 
    return_type_2<other_action<member_pointer_action>, 
                  typename _Boost::remove_reference<A>::type, 
                  typename _Boost::remove_reference<B>::type
                 >::type type;
};
