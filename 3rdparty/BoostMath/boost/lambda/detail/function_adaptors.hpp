...
struct remove_references_from_elements {
  typedef typename _Boost::tuples::cons<
    typename _Boost::remove_reference<typename Tuple::head_type>::type,
    typename remove_references_from_elements<typename Tuple::tail_type>::type
  > type;
};

template<>
struct remove_references_from_elements<_Boost::tuples::null_type> {
  typedef _Boost::tuples::null_type type;
};
...
template <class Func> struct function_adaptor {
  ...
  // Support functors that use the _Boost::result_of return type convention.
...
struct function_adaptor<T Object::*> {
  ...
  template<class Args> class sig { 
    typedef typename _Boost::tuples::element<1, Args>::type argument_type;
    typedef typename _Boost::remove_reference<
      argument_type
    >::type unref_type;

    typedef typename detail::IF<_Boost::is_const<unref_type>::value,
      typename _Boost::add_const<T>::type,
      T
    >::RET properly_consted_return_type;

    typedef typename detail::IF<_Boost::is_volatile<unref_type>::value,
      typename _Boost::add_volatile<properly_consted_return_type>::type,
      properly_consted_return_type
    >::RET properly_cvd_return_type;


  public:
    typedef typename detail::IF<_Boost::is_reference<argument_type>::value,
      typename _Boost::add_reference<properly_cvd_return_type>::type,
      typename _Boost::remove_cv<T>::type
    >::RET type;
  };
