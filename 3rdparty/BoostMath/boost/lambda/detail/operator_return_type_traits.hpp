...
struct return_type_1<other_action<addressof_action>, A> { 
  ...
  typedef typename detail::IF<
    _Boost::is_same<type1, detail::unspecified>::value, 
...
template <class A> struct contentsof_type {
  typedef typename _Boost::indirect_reference<A>::type type; 
};
...
struct pointer_arithmetic_traits<plus_action, A, B> { 
  ...
  typedef typename 
    array_to_pointer<typename _Boost::remove_reference<A>::type>::type AP;
  typedef typename 
    array_to_pointer<typename _Boost::remove_reference<B>::type>::type BP;

  static const bool is_pointer_A = _Boost::is_pointer<AP>::value;
  static const bool is_pointer_B = _Boost::is_pointer<BP>::value;  
...
struct pointer_arithmetic_traits<minus_action, A, B> { 
  ...
  static const bool same_pointer_type =
    is_pointer_A && is_pointer_B && 
    _Boost::is_same<
      typename _Boost::remove_const<
        typename _Boost::remove_pointer<
          typename _Boost::remove_const<AP>::type
        >::type
      >::type,
      typename _Boost::remove_const<
        typename _Boost::remove_pointer<
          typename _Boost::remove_const<BP>::type
        >::type
      >::type
    >::value;
...
struct return_type_2<bitwise_action<Act>, A, B>
{
  ...
  // the apply function
  BOOST_STATIC_ASSERT(!(_Boost::is_float<plain_A>::value && _Boost::is_float<plain_B>::value));
...
private:
  typedef typename _Boost::remove_reference<A>::type plainA;
public:
...
struct return_type_2<arithmetic_assignment_action<Act>, A, B> { 
  ...
  typedef typename 
    detail::IF<
      _Boost::is_same<type1, detail::unspecified>::value, 
      typename _Boost::add_reference<A>::type,
      type1
    >::RET type;
};
...
struct return_type_2<other_action<subscript_action>, A, B> {
  ...
  typedef typename _Boost::remove_reference<A>::type nonref_A;
  typedef typename _Boost::remove_reference<B>::type nonref_B;
