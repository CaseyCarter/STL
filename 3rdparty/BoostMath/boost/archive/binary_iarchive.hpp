...
class BOOST_SYMBOL_VISIBLE binary_iarchive :
    public binary_iarchive_impl<
        _Boost::archive::binary_iarchive,
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(_Boost::archive::binary_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(_Boost::archive::binary_iarchive)
