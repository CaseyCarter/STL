...
public:
    ...
    explicit library_version_type(const unsigned int & t_) : t(t_){
        BOOST_ASSERT(t_ <= _Boost::integer_traits<base_type>::const_max);
    }
...
#define BOOST_SERIALIZATION_NULL_POINTER_TAG _Boost::archive::class_id_type(-1)
...
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::library_version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::class_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::class_id_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::class_id_optional_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::class_name_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::object_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::object_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(_Boost::archive::tracking_type, primitive_type)
...
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::library_version_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::version_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::class_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::class_id_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::class_id_optional_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::class_name_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::object_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::object_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(_Boost::archive::tracking_type)
