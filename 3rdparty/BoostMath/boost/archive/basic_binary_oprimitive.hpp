...
public:
    ...
    _Boost::archive::codecvt_null<Elem> codecvt_null_facet;
...
public:
    ...
    struct use_array_optimization {
        template <class T>
            ...
            struct apply {
                typedef typename _Boost::serialization::is_bitwise_serializable< T >::type type;
            };
        #else
            struct apply : public _Boost::serialization::is_bitwise_serializable< T > {};
        #endif
    };

    // the optimized save_array dispatches to save_binary
    template <class ValueType>
    void save_array(_Boost::serialization::array_wrapper<ValueType> const& a, unsigned int)
    {
...
basic_binary_oprimitive<Archive, Elem, Tr>::save_binary(
    ...
    // BOOST_ASSERT(count <= std::size_t(_Boost::integer_traits<std::streamsize>::const_max));
