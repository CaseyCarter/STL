...
private:
    ...
    virtual void save(const _Boost::long_long_type t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const _Boost::ulong_long_type t){
        ArchiveImplementation::save(t);
    }
    #elif defined(BOOST_HAS_MS_INT64)
    virtual void save(const _Boost::int64_t t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const _Boost::uint64_t t){
        ArchiveImplementation::save(t);
    }
    #endif
