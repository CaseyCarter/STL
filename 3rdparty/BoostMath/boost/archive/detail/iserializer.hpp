...
private:
    virtual void destroy(/*const*/ void *address) const {
        _Boost::serialization::access::destroy(static_cast<T *>(address));
    }
public:
    explicit iserializer() :
        basic_iserializer(
            _Boost::serialization::singleton<
                typename
                _Boost::serialization::type_info_implementation< T >::type
            >::get_const_instance()
        )
    {}
    ...
    virtual bool class_info() const {
        return _Boost::serialization::implementation_level< T >::value
            >= _Boost::serialization::object_class_info;
    }
    virtual bool tracking(const unsigned int /* flags */) const {
        return _Boost::serialization::tracking_level< T >::value
                == _Boost::serialization::track_always
            || ( _Boost::serialization::tracking_level< T >::value
                == _Boost::serialization::track_selectively
                && serialized_as_pointer());
    }
    virtual version_type version() const {
        return version_type(::_Boost::serialization::version< T >::value);
    }
    virtual bool is_polymorphic() const {
        return _Boost::is_polymorphic< T >::value;
    }
    virtual ~iserializer(){};
};
...
BOOST_DLLEXPORT void iserializer<Archive, T>::load_object_data(
    ...
    if(file_version > static_cast<const unsigned int>(version()))
        _Boost::serialization::throw_exception(
            archive::archive_exception(
                _Boost::archive::archive_exception::unsupported_class_version,
                get_debug_info()
            )
        );
    #endif
    ...
    _Boost::serialization::serialize_adl(
        _Boost::serialization::smart_cast_reference<Archive &>(ar),
        * static_cast<T *>(x),
        file_version
    );
}
...
struct heap_allocation {
    // _Boost::has_new_operator< T > doesn't work on these compilers
    #if BOOST_SERIALIZATION_DONT_USE_HAS_NEW_OPERATOR
...
private:
    ...
    virtual const basic_iserializer & get_basic_serializer() const {
        return _Boost::serialization::singleton<
...
) const
{
    ...
    BOOST_TRY {
        ...
        _Boost::serialization::load_construct_data_adl<Archive, T>(
            ar_impl,
            static_cast<T *>(t),
            file_version
        );
    ...
    ar_impl >> _Boost::serialization::make_nvp(NULL, * static_cast<T *>(t));
}
...
struct load_non_pointer_type {
    ...
    struct load_only {
        ...
        static void invoke(Archive & ar, const T & t){
            ...
            _Boost::serialization::serialize_adl(
                ar,
                const_cast<T &>(t),
                _Boost::serialization::version< T >::value
            );
        }
    };
    ...
    struct load_standard {
        template<class T>
        static void invoke(Archive &ar, const T & t){
            void * x = _Boost::addressof(const_cast<T &>(t));
            ar.load_object(
                x,
                _Boost::serialization::singleton<
                    iserializer<Archive, T>
    ...
    static void invoke(Archive & ar, T &t){
        typedef typename mpl::eval_if<
                // if its primitive
                mpl::equal_to<
                    _Boost::serialization::implementation_level< T >,
                    mpl::int_<_Boost::serialization::primitive_type>
                >,
            ...
            mpl::greater_equal<
                        _Boost::serialization::implementation_level< T >,
                        mpl::int_<_Boost::serialization::object_class_info>
                    >,
            // do standard load
        ...
        typename mpl::eval_if<
            // no tracking
                    mpl::equal_to<
                        _Boost::serialization::tracking_level< T >,
                        mpl::int_<_Boost::serialization::track_never>
                >,
                // do a fast load
...
struct load_pointer_type {
    struct abstract
    {
        ...
        static const basic_pointer_iserializer * register_type(Archive & /* ar */){
            ...
            BOOST_STATIC_ASSERT(_Boost::is_polymorphic< T >::value);
    ...
    static const basic_pointer_iserializer * register_type(Archive &ar, const T* const /*t*/){
        ...
        typedef typename
            mpl::eval_if<
                _Boost::serialization::is_abstract<const T>,
                _Boost::mpl::identity<abstract>,
                _Boost::mpl::identity<non_abstract>
            >::type typex;
    ...
    static T * pointer_tweak(
        const _Boost::serialization::extended_type_info & eti,
        void const * const t,
        const T &
    ) {
        // tweak the pointer back to the base class
        void * upcast = const_cast<void *>(
            _Boost::serialization::void_upcast(
                eti,
                _Boost::serialization::singleton<
                    typename
                    _Boost::serialization::type_info_implementation< T >::type
    ...
    find(const _Boost::serialization::extended_type_info & type){
...
struct load_enum_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        int i;
        ar >> _Boost::serialization::make_nvp(NULL, i);
        t = static_cast< T >(i);
    }
};
...
struct load_array_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        _Boost::serialization::collection_size_type count;
        ar >> BOOST_SERIALIZATION_NVP(count);
        if(static_cast<std::size_t>(count) > current_count)
            _Boost::serialization::throw_exception(
                archive::archive_exception(
                    _Boost::archive::archive_exception::array_size_too_short
                )
            );
        // explict template arguments to pass intel C++ compiler
        ar >> serialization::make_array<
            value_type,
            _Boost::serialization::collection_size_type
        >(
