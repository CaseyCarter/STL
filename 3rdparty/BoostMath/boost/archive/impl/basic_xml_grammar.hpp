...
private:
    ...
    typedef typename _Boost::spirit::classic::chset<CharType> chset_t;
    typedef typename _Boost::spirit::classic::chlit<CharType> chlit_t;
    typedef typename _Boost::spirit::classic::scanner<
        typename  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef typename _Boost::spirit::classic::rule<scanner_t> rule_t;
