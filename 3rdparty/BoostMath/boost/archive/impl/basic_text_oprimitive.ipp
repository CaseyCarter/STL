...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        _Boost::archive::iterators::insert_linebreaks<
            _Boost::archive::iterators::base64_from_binary<
                _Boost::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    _Boost::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
...
BOOST_ARCHIVE_OR_WARCHIVE_DECL
basic_text_oprimitive<OStream>::~basic_text_oprimitive(){
    if(_Boost::core::uncaught_exceptions() > 0)
        return;
    os << std::endl;
}
