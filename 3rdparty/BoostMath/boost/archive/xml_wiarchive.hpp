...
protected:
    ...
    _Boost::scoped_ptr<xml_wgrammar> gimpl;
    std::wistream & get_is(){
        return is;
    }
    template<class T>
    ...
    void
    load(_Boost::serialization::item_version_type & t){
        unsigned int v;
        load(v);
        t = _Boost::serialization::item_version_type(v);
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(_Boost::archive::xml_wiarchive)
