...
public:
    ...
    virtual void save(const _Boost::long_long_type t) = 0;
    virtual void save(const _Boost::ulong_long_type t) = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(_Boost::archive::polymorphic_oarchive)
