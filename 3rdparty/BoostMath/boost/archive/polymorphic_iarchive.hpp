...
public:
    ...
    virtual void load(_Boost::long_long_type & t) = 0;
    virtual void load(_Boost::ulong_long_type & t) = 0;
    ...
    template<class T>
    void load_override(
        const _Boost::serialization::nvp< T > & t
    ){
        load_start(t.name());
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(_Boost::archive::polymorphic_iarchive)
