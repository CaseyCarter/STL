...
protected:
    ...
    #if 0
    void save_override(const _Boost::archive::version_type & t){
        ...
        if(_Boost::archive::library_version_type(6) < lvt){
            const _Boost::uint_least16_t x = t;
            * this->This() << x;
        }
        else{
    ...
    void save_override(const _Boost::serialization::item_version_type & t){
        library_version_type lvt = this->get_library_version();
        if(_Boost::archive::library_version_type(7) < lvt){
            this->detail_common_oarchive::save_override(t);
        }
    ...
    void save_override(class_id_type & t){
        ...
        if(_Boost::archive::library_version_type(6) < lvt){
            const _Boost::int_least16_t x = t;
            * this->This() << x;
        }
        else{
            const int x = t;
    ...
    void save_override(const serialization::collection_size_type & t){
        if (get_library_version() < _Boost::archive::library_version_type(6)){
            unsigned int x=0;
            * this->This() >> x;
