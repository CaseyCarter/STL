...
class escape :
    public _Boost::iterator_adaptor<
        Derived,
        Base,
        typename _Boost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        typename _Boost::iterator_value<Base>::type
    >
{
    typedef typename _Boost::iterator_value<Base>::type base_value_type;
    typedef typename _Boost::iterator_reference<Base>::type reference_type;
