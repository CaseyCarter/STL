    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace) BOOST_NOEXCEPT
        {
            ...
            if (lc_iequal(begin, lc_nan, lc_NAN, 3)) {
                ...
                else value = (_Boost::math::changesign) (std::numeric_limits<T>::quiet_NaN());
                return true;
            } else if (
                ( /* 'INF' or 'inf' */
             ...
             )
            {
                ...
                else value = (_Boost::math::changesign) (std::numeric_limits<T>::infinity());
                return true;
            }
                         ...
                         , const CharT* lc_infinity) BOOST_NOEXCEPT
        {
            using namespace std;
            const CharT minus = lcast_char_constants<CharT>::minus;
            if ((_Boost::math::isnan)(value)) {
                if ((_Boost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
                ...
                return true;
            } else if ((_Boost::math::isinf)(value)) {
                if ((_Boost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
