...
struct detect_precision_loss
{
    ...
    typedef _Boost::numeric::Trunc<Source> Rounder;
    typedef BOOST_DEDUCED_TYPENAME conditional<
        _Boost::is_arithmetic<Source>::value, Source, Source const&
    >::type argument_type ;
...
{
    inline bool operator() ( _Boost::numeric::range_check_result r ) const BOOST_NOEXCEPT {
        return (r == _Boost::numeric::cInRange);
    }
};

template <typename Target, typename Source>
inline bool noexcept_numeric_convert(const Source& arg, Target& result) BOOST_NOEXCEPT {
    typedef _Boost::numeric::converter<
            Target,
            Source,
            _Boost::numeric::conversion_traits<Target, Source >,
            nothrow_overflow_handler,
            detect_precision_loss<Source >
    > converter_orig_t;

    typedef BOOST_DEDUCED_TYPENAME _Boost::conditional<
        _Boost::is_base_of< detect_precision_loss<Source >, converter_orig_t >::value,
        converter_orig_t,
...
struct lexical_cast_dynamic_num_ignoring_minus
{
    static inline bool try_convert(const Source &arg, Target& result) BOOST_NOEXCEPT {
        typedef BOOST_DEDUCED_TYPENAME _Boost::conditional<
                _Boost::is_float<Source>::value,
                _Boost::type_identity<Source>,
                _Boost::make_unsigned<Source>
        >::type usource_lazy_t;
 ...
 *
 *
 * Rule 2) required because _Boost::lexical_cast has the behavior of
...
struct dynamic_num_converter_impl
{
    static inline bool try_convert(const Source &arg, Target& result) BOOST_NOEXCEPT {
        typedef BOOST_DEDUCED_TYPENAME _Boost::conditional<
            _Boost::is_unsigned<Target>::value &&
            (_Boost::is_signed<Source>::value || _Boost::is_float<Source>::value) &&
            !(_Boost::is_same<Source, bool>::value) &&
            !(_Boost::is_same<Target, bool>::value),
