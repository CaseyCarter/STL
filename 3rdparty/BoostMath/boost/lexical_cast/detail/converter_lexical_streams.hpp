...
#       error "_Boost::lexical_cast to use only 'C' locale during conversions."
#   endif
#endif
...
namespace _Boost {
    ...
    namespace detail // optimized stream wrappers
    {
        template< class CharT // a result of widest_char transformation
                ...
                >
        class lexical_istream_limited_src: _Boost::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch) {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "_Boost::lexical_cast does not support narrowing of char types."
                    "Use _Boost::locale instead" );
#ifndef BOOST_LEXICAL_CAST_ASSUME_C_LOCALE
                std::locale loc;
            ...
            bool shl_input_streamable(InputStreamable& input) {
                ...
                BOOST_STATIC_ASSERT((_Boost::is_same<char, CharT>::value));
#endif
            ...
            inline bool shl_signed(const T n) {
                CharT* tmp_finish = buffer + CharacterBufferSize;
                typedef BOOST_DEDUCED_TYPENAME _Boost::make_unsigned<T>::type utype;
            ...
            bool shl_real_type(float val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin, 
#endif
                    "%.*g", static_cast<int>(_Boost::detail::lcast_get_precision<float>()), val_as_double);
                return finish > start;
            }
            ...
            bool shl_real_type(double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin, 
#endif
                    "%.*g", static_cast<int>(_Boost::detail::lcast_get_precision<double>()), val);
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, char* begin) {
                ...
                finish = start +
                    ...
                    sprintf(begin, 
#endif
                    "%.*Lg", static_cast<int>(_Boost::detail::lcast_get_precision<long double>()), val );
                return finish > start;
            }
#endif
            ...
            bool shl_real_type(float val, wchar_t* begin) {
                ...
                finish = start + swprintf(begin, CharacterBufferSize,
                                       L"%.*g",
                                       static_cast<int>(_Boost::detail::lcast_get_precision<float >()),
                                       val_as_double );
                return finish > start;
            }
            ...
            bool shl_real_type(double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*g", static_cast<int>(_Boost::detail::lcast_get_precision<double >()), val );
                return finish > start;
            }
            ...
            bool shl_real_type(long double val, wchar_t* begin) {
                using namespace std;
                finish = start + swprintf(begin, CharacterBufferSize,
                                          L"%.*Lg", static_cast<int>(_Boost::detail::lcast_get_precision<long double >()), val );
                return finish > start;
            }
#endif
            template <class T>
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(_Boost::container::basic_string<CharT,Traits,Alloc> const& str) BOOST_NOEXCEPT {
                start = str.data();
                finish = start + str.length();
                return true;
            }
            ...
            template <class C>
            BOOST_DEDUCED_TYPENAME _Boost::disable_if<_Boost::is_const<C>, bool>::type 
            ...
            bool operator<<(_Boost::ulong_long_type n)   { return shl_unsigned(n); }
            bool operator<<(_Boost::long_long_type n)    { return shl_signed(n); }
            ...
            bool operator<<(const _Boost::uint128_type& n)   { return shl_unsigned(n); }
            bool operator<<(const _Boost::int128_type& n)    { return shl_signed(n); }
#endif
            ...
            BOOST_DEDUCED_TYPENAME _Boost::disable_if<_Boost::is_const<C>, bool>::type
            operator<<(_Boost::array<C, N> const& input) BOOST_NOEXCEPT { 
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(_Boost::array<const C, N>) == sizeof(_Boost::array<C, N>)),
                    "_Boost::array<C, N> and _Boost::array<const C, N> must have exactly the same layout."
                );
                return ((*this) << reinterpret_cast<_Boost::array<const C, N> const& >(input)); 
            }

            template <std::size_t N>
            bool operator<<(_Boost::array<const CharT, N> const& input) BOOST_NOEXCEPT { 
                return shl_char_array_limited(input.data(), N);
            }

            template <std::size_t N>
            bool operator<<(_Boost::array<const unsigned char, N> const& input) BOOST_NOEXCEPT { 
                return ((*this) << reinterpret_cast<_Boost::array<const char, N> const& >(input)); 
            }

            template <std::size_t N>
            bool operator<<(_Boost::array<const signed char, N> const& input) BOOST_NOEXCEPT { 
                return ((*this) << reinterpret_cast<_Boost::array<const char, N> const& >(input)); 
            }
            ...
            bool operator<<(std::array<C, N> const& input) BOOST_NOEXCEPT { 
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(std::array<C, N>) == sizeof(_Boost::array<C, N>)),
                    "std::array and _Boost::array must have exactly the same layout. "
                    "Bug in implementation of std::array or _Boost::array."
                );
                return ((*this) << reinterpret_cast<_Boost::array<C, N> const& >(input)); 
            }
#endif
        ...
        template <class CharT, class Traits>
        class lexical_ostream_limited_src: _Boost::noncopyable {
...
/************************************ HELPER FUNCTIONS FOR OPERATORS >> ( ... ) ********************************/
        private:
            ...
            {
                BOOST_STATIC_ASSERT_MSG(
                    (!_Boost::is_pointer<InputStreamable>::value),
                    "_Boost::lexical_cast can not convert to pointers"
                );

#if defined(BOOST_NO_STRINGSTREAM) || defined(BOOST_NO_STD_LOCALE)
                BOOST_STATIC_ASSERT_MSG((_Boost::is_same<char, CharT>::value),
                    "_Boost::lexical_cast can not convert, because your STL library does not "
            ...
            inline bool shr_xchar(T& output) BOOST_NOEXCEPT {
                BOOST_STATIC_ASSERT_MSG(( sizeof(CharT) == sizeof(T) ),
                    "_Boost::lexical_cast does not support narrowing of character types."
                    "Use _Boost::locale instead" );
...
/************************************ OPERATORS >> ( ... ) ********************************/
        public:
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>(_Boost::ulong_long_type& output)     { return shr_unsigned(output); }
            bool operator>>(_Boost::long_long_type& output)      { return shr_signed(output); }
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_INT128
            bool operator>>(_Boost::uint128_type& output)        { return shr_unsigned(output); }
            bool operator>>(_Boost::int128_type& output)         { return shr_signed(output); }
#endif
            ...
            template<class Alloc>
            bool operator>>(_Boost::container::basic_string<CharT,Traits,Alloc>& str) { 
                str.assign(start, finish); return true; 
            }

            template <std::size_t N>
            bool operator>>(_Boost::array<CharT, N>& output) BOOST_NOEXCEPT { 
                return shr_std_array<N>(output); 
            }

            template <std::size_t N>
            bool operator>>(_Boost::array<unsigned char, N>& output) BOOST_NOEXCEPT { 
                return ((*this) >> reinterpret_cast<_Boost::array<char, N>& >(output)); 
            }

            template <std::size_t N>
            bool operator>>(_Boost::array<signed char, N>& output) BOOST_NOEXCEPT { 
                return ((*this) >> reinterpret_cast<_Boost::array<char, N>& >(output)); 
            }
            ...
            bool operator>>(std::array<C, N>& output) BOOST_NOEXCEPT { 
                BOOST_STATIC_ASSERT_MSG(
                    (sizeof(std::array<C, N>) == sizeof(_Boost::array<C, N>)),
                    "std::array<C, N> and _Boost::array<C, N> must have exactly the same layout."
                );
                return ((*this) >> reinterpret_cast<_Boost::array<C, N>& >(output));
            }
#endif
