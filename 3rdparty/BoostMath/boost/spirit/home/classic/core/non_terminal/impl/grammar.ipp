...
struct grammar_definition
{
    ...
    struct grammar_helper : private grammar_helper_base<GrammarT>
    {
        ...
        typedef _Boost::shared_ptr<helper_t> helper_ptr_t;
        typedef _Boost::weak_ptr<helper_t>   helper_weak_ptr_t;
        ...
        define(grammar_t const* target_grammar)
        {
            ...
            _Boost::movelib::unique_ptr<definition_t>
                result(new definition_t(target_grammar->derived()));

#ifdef BOOST_SPIRIT_THREADSAFE
            _Boost::unique_lock<_Boost::mutex> lock(helpers.mutex());
#endif
...
# ifdef BOOST_SPIRIT_THREADSAFE
        _Boost::thread_specific_ptr<ptr_t> & tld_helper
            = static_<_Boost::thread_specific_ptr<ptr_t>,
