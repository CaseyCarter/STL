...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    namespace impl {
        ...
        private:
#ifdef BOOST_SPIRIT_THREADSAFE
            static _Boost::mutex &mutex_instance();
            static void mutex_init();
#endif

            _Boost::shared_ptr<object_with_id_base_supply<IdT> > id_supply;
        };
        ...
        {
            {
                ...
                static _Boost::once_flag been_here = BOOST_ONCE_INIT;
#else
                static _Boost::once_flag been_here;
#endif
                _Boost::call_once(been_here, mutex_init);
                _Boost::mutex &mutex = mutex_instance();
                _Boost::unique_lock<_Boost::mutex> lock(mutex);
#endif
                static _Boost::shared_ptr<object_with_id_base_supply<IdT> >
                    static_supply;
