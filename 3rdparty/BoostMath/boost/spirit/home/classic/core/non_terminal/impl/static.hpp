...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    //      T::T() MUST not throw!
    //          this is a requirement of _Boost::call_once.
    //
    ...
    public:
        ...
        typedef typename _Boost::call_traits<T>::reference reference;
        typedef typename _Boost::call_traits<T>::const_reference const_reference;

        static_(Tag = Tag())
        {
            _Boost::call_once(&default_ctor::construct, constructed_);
        }
    ...
    private:
        typedef typename _Boost::add_pointer<value_type>::type pointer;
        ...
        typedef _Boost::aligned_storage<sizeof(value_type),
            _Boost::alignment_of<value_type>::value> storage_type;
