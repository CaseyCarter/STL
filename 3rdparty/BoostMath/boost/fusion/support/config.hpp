...
//      }
namespace _Boost { namespace fusion { namespace detail
{
    namespace barrier { }
...
#   define BOOST_FUSION_DECLTYPE_N3031(parenthesized_expr) \
        _Boost::fusion::detail::type_alias_t<decltype parenthesized_expr>
# else
#   include <boost/mpl/identity.hpp>
#   define BOOST_FUSION_DECLTYPE_N3031(parenthesized_expr) \
        _Boost::mpl::identity<decltype parenthesized_expr>::type
# endif
#else
#   define BOOST_FUSION_DECLTYPE_N3031(parenthesized_expr) \
