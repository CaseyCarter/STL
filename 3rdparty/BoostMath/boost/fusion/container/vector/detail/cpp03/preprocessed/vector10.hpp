...
==============================================================================*/
namespace _Boost { namespace fusion
{
    struct vector_tag;
...
# endif
        ...
        vector_data1(U0 && arg0
          , typename _Boost::enable_if<is_convertible<U0, T0> >::type* = 0
        )
...
# endif
        ...
        vector1(
            Sequence const& seq
          , typename _Boost::enable_if<traits::is_sequence<Sequence> >::type* = 0
          , typename _Boost::disable_if<is_convertible<Sequence, T0> >::type* = 0
            )
...
# endif
        ...
        template <typename Sequence>
        BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        typename _Boost::disable_if<is_convertible<Sequence, T0>, this_type&>::type
