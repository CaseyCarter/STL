...
# endif
    ...
    explicit
    vector(U0 && arg0
        , typename _Boost::disable_if_c<_Boost::is_same<vector, typename _Boost::remove_cv_ref<U0>::type>::value, detail::enabler_>::type = detail::enabler
        )
...
# if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
        ...
        typename _Boost::disable_if_c<
            _Boost::is_same<vector, typename _Boost::remove_cv_ref<T>::type>::value
          , vector&
        >::type
        operator=(T&& rhs)
        {
