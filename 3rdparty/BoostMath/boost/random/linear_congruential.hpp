...
{
public:
    typedef _Boost::uint32_t result_type;
    ...
    /** Advances the state of the generator by @c z. */
    void discard(_Boost::uintmax_t z) { lcf.discard(z); }
...
private:
    ...
    static _Boost::uint64_t cnv(_Boost::uint32_t x)
