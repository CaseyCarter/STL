...
public:
  ...
  static IntType pow(IntType a, _Boost::uintmax_t exponent)
  {
      IntType result = 1;
      while(exponent != 0) {
          if(exponent % 2 == 1) {
...
private:
  ...
  static IntType mult_general(IntType a, IntType b)
  {
    ...
    if(::_Boost::uintmax_t(modulus) <=
        (::std::numeric_limits< ::_Boost::uintmax_t>::max)() / modulus)
    {
      return static_cast<IntType>(_Boost::uintmax_t(a) * b % modulus);
    } else {
