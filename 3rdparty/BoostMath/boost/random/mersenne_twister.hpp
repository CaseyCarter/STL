...
private:
     ...
     */
    void discard_many(_Boost::uintmax_t z)
    {
...
BOOST_RANDOM_PTR_HELPER_SPEC(_Boost::mt11213b)
BOOST_RANDOM_PTR_HELPER_SPEC(_Boost::mt19937)
BOOST_RANDOM_PTR_HELPER_SPEC(_Boost::mt19937_64)
