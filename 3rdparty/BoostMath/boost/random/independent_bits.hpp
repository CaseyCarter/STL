...
public:
    ...
    { return max_imp(_Boost::is_integral<UIntType>()); }
    ...
    {
        for(_Boost::uintmax_t i = 0; i < z; ++i) {
            (*this)();
        }
    }
...
private:
    ...
    /// \cond show_private
    typedef typename _Boost::random::traits::make_unsigned<base_result_type>::type base_unsigned;

    static UIntType max_imp(const _Boost::true_type&)
    {
       return _Boost::low_bits_mask_t<w>::sig_bits;
    }
    static UIntType max_imp(const _Boost::false_type&)
    {
