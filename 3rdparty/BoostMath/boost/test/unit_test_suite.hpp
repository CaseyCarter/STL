...
_Boost::unit_test::make_test_case( _Boost::function<void ()>(test_function), \
                                  test_name ,                              \
                                  __FILE__, __LINE__ )
...
_Boost::unit_test::make_test_case( (test_function),                         \
...
( new _Boost::unit_test::test_suite( testsuite_name, __FILE__, __LINE__ ) )
...
#define BOOST_AUTO_TEST_SUITE_NO_DECOR( suite_name )                    \
    BOOST_AUTO_TEST_SUITE_WITH_DECOR(                                   \
        suite_name,                                                     \
        _Boost::unit_test::decorator::collector_t::instance() )          \
/**/
...
BOOST_TEST_DECORATOR( * _Boost::unit_test::expected_failures( n ) )      \
/**/
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    _Boost::unit_test::make_test_case(                                   \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( _Boost::type<TestType>* = 0 )                       \
    {                                                                   \
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture ctor");  \
        ...
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture dtor");  \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    _Boost::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                      \
    _Boost::unit_test::ut_detail::template_test_case_gen<name,typelist>( \
...
template<typename type_name>                                            \
void BOOST_JOIN( name, _impl )( _Boost::type<type_name>* );              \
                                                                        \
struct name {                                                           \
    template<typename TestType>                                         \
    static void run( _Boost::type<TestType>* frwrd = 0 )                 \
    {                                                                   \
...
static _Boost::unit_test::ut_detail::global_configuration_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static _Boost::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static _Boost::unit_test::decorator::collector_t const&                  \
...
namespace _Boost { namespace unit_test { namespace ut_detail {
...
typedef ::_Boost::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static _Boost::unit_test::ut_detail::auto_test_unit_registrar       \
...
static const _Boost::unit_test::framework::impl::master_test_suite_name_setter mtsetter(BOOST_TEST_STRINGIZE( BOOST_TEST_MODULE ).trim( "\"" ));
#endif

#ifdef BOOST_TEST_ALTERNATIVE_INIT_API
bool init_unit_test()                   {
#else
::_Boost::unit_test::test_suite*
