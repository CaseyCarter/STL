...
class base;
typedef _Boost::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( _Boost::function<void()> const& setup, _Boost::function<void()> const& teardown = _Boost::function<void()>() )
{
...
public:
    typedef _Boost::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
