...
//
/// @file
/// Defines @ref _Boost::unit_test::test_unit "test_unit", @ref _Boost::unit_test::test_case "test_case",
/// @ref _Boost::unit_test::test_suite "test_suite" and @ref _Boost::unit_test::master_test_suite_t "master_test_suite_t"
// ***************************************************************************
...
public:
    ...
    typedef _Boost::function<test_tools::assertion_result (test_unit_id)>    precondition_t;
...
public:
    ...
    // Constructor
    test_case( const_string tc_name, _Boost::function<void ()> const& test_func );
    test_case( const_string tc_name, const_string tc_file, std::size_t tc_line, _Boost::function<void ()> const& test_func );

    // Public property
    typedef BOOST_READONLY_PROPERTY(_Boost::function<void ()>,(test_case))  test_func;
...
public:
    ...
    /// @overload
    void            add( _Boost::shared_ptr<test_unit_generator> gen_ptr, decorator::collector_t& decorators );
...
protected:
    ...
    std::vector< std::pair<_Boost::shared_ptr<test_unit_generator>, std::vector<decorator::base_ptr> > > m_generators; /// lazy evaluation
};
...
public:
    ...
    friend BOOST_TEST_DECL master_test_suite_t& _Boost::unit_test::framework::master_test_suite();
};
...
inline test_case*
make_test_case( _Boost::function<void ()> const& test_func, const_string tc_name, const_string tc_file, std::size_t tc_line )
{
...
make_test_case( void (UserTestCase::*           test_method )(),
                ...
                std::size_t                     tc_line,
                _Boost::shared_ptr<InstanceType> user_test_case )
{
