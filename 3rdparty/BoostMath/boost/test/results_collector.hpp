...
public:
    ...
    /// @returns
    ///   - @c _Boost::exit_success on success,
    ///   - @c _Boost::exit_exception_failure in case test unit
    ///     was aborted for any reason (incuding uncaught exception)
    ///   - and @c _Boost::exit_test_failure otherwise
...
/// of the test tree.
///
/// @see _Boost::unit_test::test_observer
