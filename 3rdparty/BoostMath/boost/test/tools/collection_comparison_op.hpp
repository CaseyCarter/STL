...
namespace _Boost { namespace test_tools { namespace assertion {  \
template<>                                                      \
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::EQ<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::EQ<L, R> >*, mpl::false_ )
{
    return lhs == rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::NE<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::NE<L, R> >*, mpl::false_ )
{
    return lhs != rhs;
}
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<OP>*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::LT<L, R> >*, mpl::false_ )
{
    return lhs < rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::LE<L, R> >*, mpl::false_ )
{
    return lhs <= rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::GT<L, R> >*, mpl::false_ )
{
    return lhs > rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, _Boost::type<op::GE<L, R> >*, mpl::false_ )
{
    return lhs >= rhs;
}
...
template<typename Lhs,typename Rhs>                                 \
struct name<Lhs,Rhs,typename _Boost::enable_if_c<                    \
