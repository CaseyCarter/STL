...
template<typename FPT>
struct fpt_limits : _Boost::conditional<std::numeric_limits<FPT>::is_specialized,
 ...
 * by the @ref _Boost::math::fpc::strength given at construction.
 *
 ...
 *
 * Serves the same purpose as _Boost::math::fpc::close_at_tolerance, but used when one
