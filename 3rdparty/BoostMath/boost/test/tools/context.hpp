...
struct BOOST_TEST_DECL context_frame {
    explicit    context_frame( ::_Boost::unit_test::lazy_ostream const& context_descr );
    ~context_frame();
...
#define BOOST_TEST_INFO( context_descr )                                                        \
    ::_Boost::unit_test::framework::add_context( BOOST_TEST_LAZY_MSG( context_descr ) , false )  \
/**/

#define BOOST_TEST_INFO_SCOPE( context_descr )                                                 \
    ::_Boost::test_tools::tt_detail::context_frame BOOST_JOIN( context_frame_, __LINE__ ) =      \
       ::_Boost::test_tools::tt_detail::context_frame(BOOST_TEST_LAZY_MSG( context_descr ) )     \
/**/
...
#define BOOST_CONTEXT_PARAM(r, ctx, i, context_descr)  \
  if( ::_Boost::test_tools::tt_detail::context_frame BOOST_PP_CAT(ctx, i) =                       \
        ::_Boost::test_tools::tt_detail::context_frame(BOOST_TEST_LAZY_MSG( context_descr ) ) )   \
/**/
