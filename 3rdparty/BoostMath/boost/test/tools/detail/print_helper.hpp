...
// ************************************************************************** //
    ...
    namespace impl {
        ...
        std::ostream& boost_test_print_type(std::ostream& ostr, T const& t) {
            BOOST_STATIC_ASSERT_MSG( (_Boost::has_left_shift<std::ostream,T>::value),
...
struct print_log_value {
    void    operator()( std::ostream& ostr, T const& t )
    {
        ...
        //ostr << t;
        using _Boost::test_tools::tt_detail::boost_test_print_type;
...
namespace _Boost{ namespace test_tools{ namespace tt_detail{ \
template<>                                                  \
