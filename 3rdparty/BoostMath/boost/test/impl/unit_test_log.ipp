...
typedef ::_Boost::io::ios_base_all_saver io_saver_type;
...
struct unit_test_log_data_helper_impl {
  typedef _Boost::shared_ptr<unit_test_log_formatter> formatter_ptr;
  typedef _Boost::shared_ptr<io_saver_type>           saver_ptr;
