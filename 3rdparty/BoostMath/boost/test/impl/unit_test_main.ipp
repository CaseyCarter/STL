...
unit_test_main( init_unit_test_func init_func, int argc, char* argv[] )
{
    ...
    _Boost::ignore_unused(shutdown_helper);
    ...
    BOOST_TEST_I_CATCH( framework::internal_error, ex ) {
        ...
        result_code = _Boost::exit_exception_failure;
    }
...
main( int argc, char* argv[] )
{
    ...
    _Boost::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::_Boost::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    _Boost::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::_Boost::unit_test::unit_test_main( init_func, argc, argv );
}
