...
template <typename T, bool is_cstring = is_cstring_impl<typename _Boost::decay<T>::type>::value >
...
struct deduce_cstring_transform_impl<T, true> {
    typedef typename _Boost::add_const<
        typename _Boost::remove_pointer<
            typename _Boost::decay<T>::type
        >::type
    >::type U;
    typedef _Boost::unit_test::basic_cstring<U> type;
};
...
struct deduce_cstring_transform_impl< T, false > {
    typedef typename
        _Boost::remove_const<
            typename _Boost::remove_reference<T>::type
        >::type type;
};

template <typename T>
struct deduce_cstring_transform_impl< std::basic_string<T, std::char_traits<T> >, false > {
    typedef _Boost::unit_test::basic_cstring<typename _Boost::add_const<T>::type> type;
};
...
public:
    using type = stringview_cstring_helper<typename _Boost::add_const<T>::type, sv_t>;
};
#endif
...
template<typename T, bool is_cstring = is_cstring<typename _Boost::decay<T>::type>::value >
...
template<typename T>
struct is_cstring_comparable< _Boost::unit_test::basic_cstring<T>, false > : public mpl::true_ {};
...
struct deduce_cstring_transform {
    typedef typename
        _Boost::remove_const<
            typename _Boost::remove_reference<T>::type
        >::type U;
    typedef typename ut_detail::deduce_cstring_transform_impl<typename _Boost::decay<U>::type>::type type;
};
