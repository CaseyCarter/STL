...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return _Boost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) _Boost::unit_test::readwrite_property<property_type >
...
: public _Boost::unit_test::readonly_property<property_type > {                      \
    typedef _Boost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return _Boost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return _Boost::addressof( base_prop::value ); }
