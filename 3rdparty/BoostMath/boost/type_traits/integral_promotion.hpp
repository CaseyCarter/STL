...
// 4.5/2
template <class T> struct need_promotion : public _Boost::is_enum<T> {};
...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(_Boost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(_Boost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, _Boost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, _Boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, _Boost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, _Boost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (_Boost::type_traits::detail::promoted_index<T>::value)
      , (_Boost::is_const<T>::value)
      , (_Boost::is_volatile<T>::value)
      >::type type;
};
...
{
private:
   typedef _Boost::type_traits::detail::need_promotion<typename remove_cv<T>::type> tag_type;
public:
   typedef typename _Boost::type_traits::detail::integral_promotion<T, tag_type::value>::type type;
};
