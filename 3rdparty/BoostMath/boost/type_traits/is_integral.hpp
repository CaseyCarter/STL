...
template<> struct is_integral< ::_Boost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::_Boost::long_long_type> : public true_type{};
...
template<> struct is_integral<_Boost::int128_type> : public true_type{};
template<> struct is_integral<_Boost::uint128_type> : public true_type{};
#endif
