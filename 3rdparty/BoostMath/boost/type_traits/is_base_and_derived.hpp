...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::_Boost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::_Boost::is_class<B>::value,
       ::_Boost::is_class<D>::value,
       ::_Boost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::_Boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::_Boost::detail::is_base_and_derived_impl<Base, Derived>::value)> {};
