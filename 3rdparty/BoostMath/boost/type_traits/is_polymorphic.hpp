...
{
   typedef is_polymorphic_selector< ::_Boost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::_Boost::detail::is_polymorphic_imp<T>::value> {};
