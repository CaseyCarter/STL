...
private:
    ...
    typedef typename _Boost::conditional<_Boost::is_const<U>::value, typename _Boost::add_const<T>::type, T>::type CT;

public:

    typedef typename _Boost::conditional<_Boost::is_volatile<U>::value, typename _Boost::add_volatile<CT>::type, CT>::type type;
};
