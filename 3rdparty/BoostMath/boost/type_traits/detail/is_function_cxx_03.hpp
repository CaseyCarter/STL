...
{
    template< typename T > struct result_
        : public ::_Boost::type_traits::is_function_ptr_helper<T*> {};
};

template <typename T>
struct is_function_impl
    : public is_function_chooser< ::_Boost::is_reference<T>::value >
...
#pragma warning(disable:6334)
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(::_Boost::type_traits::is_function_ptr_tester(t))
...
#else
template <class T> struct is_function : integral_constant<bool, ::_Boost::detail::is_function_impl<T>::value> {};
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
