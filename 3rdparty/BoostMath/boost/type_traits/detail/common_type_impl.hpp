...
{
    BOOST_STATIC_CONSTANT( bool, ct = _Boost::is_class<T>::value || _Boost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = _Boost::is_class<U>::value || _Boost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public _Boost::conditional<

    _Boost::is_convertible<T, U>::value && !_Boost::is_convertible<U, T>::value,
    _Boost::type_identity<U>,

    typename _Boost::conditional<

        _Boost::is_convertible<U, T>::value && !_Boost::is_convertible<T, U>::value,
        _Boost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public _Boost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public _Boost::conditional<
    _Boost::is_pointer<T>::value || _Boost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public _Boost::conditional<
    _Boost::is_member_pointer<T>::value || _Boost::is_member_pointer<U>::value,
