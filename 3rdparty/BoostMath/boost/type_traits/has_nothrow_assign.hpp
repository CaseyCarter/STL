...
namespace _Boost {
   ...
   namespace detail
   {
      ...
      template <class T>          struct has_nothrow_assign_imp<T, false, true>{ static const bool value = noexcept(_Boost::declval<typename add_reference<T>::type>() = _Boost::declval<typename add_reference<T const>::type>()); };
   ...
   struct has_nothrow_assign : public integral_constant < bool,
      ...
      >::value
#else
      ::_Boost::has_trivial_assign<T>::value
#endif
#else
