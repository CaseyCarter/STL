...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::_Boost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::_Boost::integral_constant<std::size_t, ::_Boost::detail::extent_imp<T,N>::value>
{
};
