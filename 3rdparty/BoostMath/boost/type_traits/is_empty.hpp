...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::_Boost::detail::empty_helper<cvt,::_Boost::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
              ::_Boost::detail::empty_helper<
                  cvt
                , ::_Boost::is_class<T>::value
                , ::_Boost::is_convertible< r_type,int>::value
...
template <class T> struct is_empty : integral_constant<bool, ::_Boost::detail::is_empty_impl<T>::value> {};
