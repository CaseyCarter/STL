...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename _Boost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::_Boost::is_pointer<T>::value>::type type;
   };
}

template <class T> struct remove_pointer{ typedef typename _Boost::detail::remove_pointer_imp2<T>::type type; };
