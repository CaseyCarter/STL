...
template<class T> struct common_type<T>: _Boost::decay<T>
{
   BOOST_STATIC_ASSERT_MSG(::_Boost::is_complete<T>::value || ::_Boost::is_void<T>::value || ::_Boost::is_array<T>::value, "Arguments to common_type must both be complete types");
};
...
template<class T1, class T2> using builtin_common_type = typename _Boost::decay<decltype( _Boost::declval<bool>()? _Boost::declval<T1>(): _Boost::declval<T2>() )>::type;
...
template<class T1, class T2> using builtin_common_type = decltype( _Boost::declval<bool>()? _Boost::declval<T1>(): _Boost::declval<T2>() );

template<class T1, class T2> struct common_type_impl_2: mp_defer<builtin_common_type, T1, T2>
{
};

template<class T1, class T2> using decay_common_type = typename _Boost::decay<typename common_type_impl_2<T1, T2>::type>::type;
...
template<class T1, class T2> struct common_type_impl: _Boost::decay<decltype( _Boost::declval<bool>()? _Boost::declval<T1>(): _Boost::declval<T2>() )>
{
};
...
template<class T1, class T2, class T1d = typename _Boost::decay<T1>::type, class T2d = typename _Boost::decay<T2>::type> struct common_type_decay_helper: _Boost::common_type<T1d, T2d>
{
};
...
{
   BOOST_STATIC_ASSERT_MSG(::_Boost::is_complete<T1>::value || ::_Boost::is_void<T1>::value || ::_Boost::is_array<T1>::value, "Arguments to common_type must both be complete types");
   BOOST_STATIC_ASSERT_MSG(::_Boost::is_complete<T2>::value || ::_Boost::is_void<T2>::value || ::_Boost::is_array<T2>::value, "Arguments to common_type must both be complete types");
};
