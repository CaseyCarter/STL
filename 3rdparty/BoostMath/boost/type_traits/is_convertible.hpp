...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<_Boost::is_void<From>, _Boost::is_function<To>, _Boost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(_Boost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::_Boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::_Boost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };

    static typename add_lvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( checker<To>::_m_check(_m_from) )
        == sizeof(::_Boost::type_traits::yes_type);
#pragma option pop
};
...
template <typename T> struct checker
{
    static _Boost::type_traits::no_type _m_check(any_conversion ...);
    static _Boost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( _Boost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::_Boost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( _Boost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::_Boost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::_Boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::_Boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::_Boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::_Boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::_Boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::_Boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::_Boost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::_Boost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::_Boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::_Boost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::_Boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::_Boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::_Boost::is_function<typename ::_Boost::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::_Boost::detail::is_convertible_basic_impl<From,To>::value && ! ::_Boost::is_array<To>::value && ! ::_Boost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   BOOST_STATIC_CONSTANT(bool, value = ( ::_Boost::detail::is_convertible_basic_impl<From, To>::value && !::_Boost::is_array<To>::value && !::_Boost::is_function<To>::value));
};
#endif
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::_Boost::is_arithmetic<From>::value, 
      ::_Boost::is_arithmetic<To>::value,
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::_Boost::detail::is_convertible_impl_dispatch<From, To>::value> 
{
   BOOST_STATIC_ASSERT_MSG(_Boost::is_complete<To>::value || _Boost::is_void<To>::value || _Boost::is_array<To>::value, "Destination argument type to is_convertible must be a complete type");
   BOOST_STATIC_ASSERT_MSG(_Boost::is_complete<From>::value || _Boost::is_void<From>::value || _Boost::is_array<From>::value, "From argument type to is_convertible must be a complete type");
};
...
struct is_convertible : public integral_constant<bool, BOOST_IS_CONVERTIBLE(From, To)> 
{
   ...
   BOOST_STATIC_ASSERT_MSG(_Boost::is_complete<From>::value || _Boost::is_void<From>::value || _Boost::is_array<From>::value || _Boost::is_reference<From>::value, "From argument type to is_convertible must be a complete type");
#endif
