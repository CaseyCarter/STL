...
struct has_nothrow_copy_constructor_imp : public _Boost::integral_constant<bool, false>{};
template <class T>
struct has_nothrow_copy_constructor_imp<T, true> : public _Boost::integral_constant<bool, noexcept(T(_Boost::declval<const T&>()))>{};

}

template <class T> struct has_nothrow_copy_constructor : public detail::has_nothrow_copy_constructor_imp<T, _Boost::is_copy_constructible<T>::value>{};
...
template <class T> struct has_nothrow_copy_constructor : public integral_constant<bool, ::_Boost::has_trivial_copy<T>::value>{};
