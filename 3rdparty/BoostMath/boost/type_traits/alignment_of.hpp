...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::_Boost::detail::alignment_logic<
            sizeof(::_Boost::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
template <class T> struct alignment_of : public integral_constant<std::size_t, ::_Boost::detail::alignment_of_impl<T>::value>{};
