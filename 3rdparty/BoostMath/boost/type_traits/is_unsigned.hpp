...
{
   BOOST_STATIC_CONSTANT(bool, value = (::_Boost::detail::is_unsigned_values<T>::minus_one > ::_Boost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::_Boost::detail::is_unsigned_select_helper< ::_Boost::is_integral<T>::value || ::_Boost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, _Boost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::_Boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::_Boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::_Boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::_Boost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::_Boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::_Boost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::_Boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::_Boost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
