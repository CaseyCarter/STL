...
namespace _Boost { namespace detail{
   ...
   template <class T, bool b> struct has_nothrow_constructor_imp : public _Boost::integral_constant<bool, false>{};
   template <class T> struct has_nothrow_constructor_imp<T, true> : public _Boost::integral_constant<bool, noexcept(T())>{};
...
template <class T> struct has_nothrow_constructor : public ::_Boost::has_trivial_constructor<T> {};
