...
#pragma GCC system_header
      ...
      template<class T, class U,
         typename _Boost::make_void<decltype((U*)(std::declval<T*>()))>::type* =
         nullptr>
   ...
   struct is_virtual_base_of : public
      _Boost::integral_constant<
      bool,
      _Boost::is_base_of<T, U>::value &&
   ...
   {
      typedef _Boost::integral_constant<bool, (_Boost::is_base_of<Base, Derived>::value && !_Boost::is_same<Base, Derived>::value)> tag_type;
...
template <class Base, class Derived> struct is_virtual_base_of : public integral_constant<bool, (::_Boost::detail::is_virtual_base_of_impl2<Base, Derived>::value)> {};
