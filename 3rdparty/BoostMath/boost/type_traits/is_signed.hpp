...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::_Boost::detail::is_signed_values<T>::minus_one  > _Boost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::_Boost::detail::is_signed_select_helper< ::_Boost::is_integral<T>::value || ::_Boost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, _Boost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::_Boost::long_long_type> : public true_type{};
template <> struct is_signed<const ::_Boost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::_Boost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::_Boost::long_long_type> : public true_type{};

template <> struct is_signed< ::_Boost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::_Boost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::_Boost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::_Boost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
