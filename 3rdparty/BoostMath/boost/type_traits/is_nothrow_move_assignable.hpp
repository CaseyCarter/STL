...
{
   BOOST_STATIC_ASSERT_MSG(_Boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};
...
struct false_or_cpp11_noexcept_move_assignable: public ::_Boost::false_type {};

template <class T>
struct false_or_cpp11_noexcept_move_assignable <
        T,
        typename ::_Boost::enable_if_<sizeof(T) && BOOST_NOEXCEPT_EXPR(::_Boost::declval<T&>() = ::_Boost::declval<T>())>::type
    > : public ::_Boost::integral_constant<bool, BOOST_NOEXCEPT_EXPR(::_Boost::declval<T&>() = ::_Boost::declval<T>())>
{};

}

template <class T>
struct is_nothrow_move_assignable : public integral_constant<bool, ::_Boost::detail::false_or_cpp11_noexcept_move_assignable<T>::value>
{
   BOOST_STATIC_ASSERT_MSG(_Boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};

template <class T> struct is_nothrow_move_assignable<T const> : public ::_Boost::false_type {};
template <class T> struct is_nothrow_move_assignable<T const volatile> : public ::_Boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T volatile> : public ::_Boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T&> : public ::_Boost::false_type{};
...
struct is_nothrow_move_assignable : public integral_constant<bool,
   (::_Boost::has_trivial_move_assign<T>::value || ::_Boost::has_nothrow_assign<T>::value) &&  ! ::_Boost::is_array<T>::value>
{
   BOOST_STATIC_ASSERT_MSG(_Boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};
