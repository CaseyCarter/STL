...
namespace _Boost {
  namespace unordered {
    template <class K, class T, class H = _Boost::hash<K>,
  ...
  using _Boost::unordered::unordered_map;
  using _Boost::unordered::unordered_multimap;
  using _Boost::unordered::swap;
  using _Boost::unordered::operator==;
  using _Boost::unordered::operator!=;
}
