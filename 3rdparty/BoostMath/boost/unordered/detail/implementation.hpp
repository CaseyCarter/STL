...
// 2 = _Boost::container::allocator_traits
...
namespace _Boost {
  namespace unordered {
    namespace detail {
      ...
      template <typename I>
      struct is_forward : _Boost::is_base_of<std::forward_iterator_tag,
      ...
      struct enable_if_forward
        : _Boost::enable_if_c<_Boost::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
      ...
      struct disable_if_forward
        : _Boost::disable_if_c<_Boost::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
    }
...
#undef BOOST_UNORDERED_PRIMES
      ...
      inline std::size_t insert_size(I i, I j,
        typename _Boost::unordered::detail::enable_if_forward<I, void*>::type =
          0)
      {
      ...
      inline std::size_t insert_size(I, I,
        typename _Boost::unordered::detail::disable_if_forward<I, void*>::type =
          0)
      {
        return 1;
      }
      ...
      inline std::size_t initial_size(I i, I j,
        std::size_t num_buckets =
          _Boost::unordered::detail::default_bucket_count)
      {
        return (std::max)(
          _Boost::unordered::detail::insert_size(i, j), num_buckets);
      }
      ...
      template <typename T, int Index> struct compressed_base : private T
      {
        ...
        compressed_base(T& x, move_tag) : T(_Boost::move(x)) {}
      ...
      template <typename T, int Index> struct uncompressed_base
      {
        ...
        uncompressed_base(T& x, move_tag) : value_(_Boost::move(x)) {}
      ...
      struct generate_base
        : _Boost::detail::if_true<
            _Boost::is_empty<T>::value>::BOOST_NESTED_TEMPLATE
            then<_Boost::unordered::detail::compressed_base<T, Index>,
              _Boost::unordered::detail::uncompressed_base<T, Index> >
      {
      };

      template <typename T1, typename T2>
      struct compressed
        : private _Boost::unordered::detail::generate_base<T1, 1>::type,
          private _Boost::unordered::detail::generate_base<T2, 2>::type
      {
        ...
        {
          first() = _Boost::move(x.first());
          second() = _Boost::move(x.second());
        }

        void swap(compressed& x)
        {
          _Boost::swap(first(), x.first());
          _Boost::swap(second(), x.second());
        }
...
// will be default-initialized.
      ...
      template <typename T>
      typename _Boost::add_lvalue_reference<T>::type make();
      struct choice9
      {
        typedef char (&type)[9];
      };
...
#define BOOST_UNORDERED_EMPLACE_FORWARD _Boost::forward<Args>(args)...
...
#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                                  \
  typedef typename _Boost::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type       \
    BOOST_PP_CAT(Arg, n);                                                      \
  BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a)                                  \
  _Boost::forward<BOOST_PP_CAT(A, i)>(BOOST_PP_CAT(a, i))
...
// Uses the standard versions if available.
      ...
      typedef _Boost::unordered::detail::integral_constant<bool, true> true_type;
      typedef _Boost::unordered::detail::integral_constant<bool, false>
        false_type;
...
#pragma warning(pop)
      ...
      template <typename ValueType> struct value_base
      {
        ...
        typename _Boost::aligned_storage<sizeof(value_type),
          _Boost::alignment_of<value_type>::value>::type data_;
      ...
      template <typename T> class optional
      {
        ...
        _Boost::unordered::detail::value_base<T> value_;
        bool has_value_;

        void destroy()
        {
          if (has_value_) {
            _Boost::unordered::detail::func::destroy(value_.value_ptr());
            has_value_ = false;
          }
        }
        ...
        void move(optional<T>& x)
        {
          ...
          new (value_.value_ptr()) T(_Boost::move(x.value_.value()));
          _Boost::unordered::detail::func::destroy(x.value_.value_ptr());
          has_value_ = true;
          x.has_value_ = false;
        }
      ...
      public:
        ...
        void swap(optional<T>& x)
        {
          if (has_value_ != x.has_value_) {
            ...
            _Boost::swap(value_.value(), x.value_.value());
          }
        }
...
#define BOOST_UNORDERED_CHECK_EXPRESSION(count, result, expression)            \
  template <typename U>                                                        \
  static                                                                       \
    typename _Boost::unordered::detail::expr_test<BOOST_PP_CAT(choice, result), \
...
#define BOOST_UNORDERED_HAS_FUNCTION(name, thing, args, _)                     \
  ...
  {                                                                            \
    ...
    BOOST_UNORDERED_CHECK_EXPRESSION(                                          \
      1, 1, _Boost::unordered::detail::make<thing>().name args);                \
...
#define BOOST_UNORDERED_CHECK_MEMBER(count, result, name, member)              \
                                                                               \
  typedef                                                                      \
    typename _Boost::unordered::detail::identity<member>::type BOOST_PP_CAT(    \
      check, count);                                                           \
                                                                               \
  ...
  {                                                                            \
    ...
    {                                                                          \
      value = (1 == sizeof(test<Tp>(choose())))                                \
                                                                               ...
                                                                               \
    typedef typename _Boost::detail::if_true<value>::BOOST_NESTED_TEMPLATE      \
...
#define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                              \
  ...
  {                                                                            \
                                                                               \
    template <typename X>                                                      \
    static typename _Boost::unordered::detail::sfinae<typename X::tname,        \
  ...
  namespace unordered {
    namespace detail {
      ...
      template <typename Alloc, typename T> struct rebind_wrap
      {
        ...
        typedef
          typename _Boost::detail::if_true<value>::BOOST_NESTED_TEMPLATE then<
  ...
  namespace unordered {
    namespace detail {
      ...
      BOOST_UNORDERED_HAS_FUNCTION(construct, U,
        (_Boost::unordered::detail::make<ValueType*>(),
          _Boost::unordered::detail::make<Args const>()...),
        2);
      ...
      BOOST_UNORDERED_HAS_FUNCTION(construct, U,
        (_Boost::unordered::detail::make<ValueType*>(),
          _Boost::unordered::detail::make<ValueType const>()),
        2);
      ...
      template <typename T, typename ValueType>
      BOOST_UNORDERED_HAS_FUNCTION(
        destroy, U, (_Boost::unordered::detail::make<ValueType*>()), 1);
      ...
      namespace func {
        ...
        inline Alloc call_select_on_container_copy_construction(
          ...
          typename _Boost::enable_if_c<
            _Boost::unordered::detail::has_select_on_container_copy_construction<
              Alloc>::value,
            void*>::type = 0)
        {
        ...
        inline SizeType call_max_size(const Alloc& a,
          typename _Boost::enable_if_c<
            _Boost::unordered::detail::has_max_size<Alloc>::value, void*>::type =
            0)
        {
          return a.max_size();
        }
  ...
  namespace unordered {
    namespace detail {
      template <typename Alloc> struct allocator_traits
      {
        ...
        template <typename T>
        struct pointer_to_other : _Boost::pointer_to_other<pointer, T>
        {
        };
        ...
        template <typename T>
        using rebind_traits =
          _Boost::unordered::detail::allocator_traits<rebind_alloc<T> >;
#endif
      ...
      public:
        ...
        static
          typename _Boost::enable_if_c<_Boost::unordered::detail::has_construct<
            Alloc, T, Args...>::value>::type
          construct(Alloc& a, T* p, BOOST_FWD_REF(Args)... x)
        {
          a.construct(p, _Boost::forward<Args>(x)...);
        }

        template <typename T, typename... Args>
        static
          typename _Boost::disable_if_c<_Boost::unordered::detail::has_construct<
            Alloc, T, Args...>::value>::type
          construct(Alloc&, T* p, BOOST_FWD_REF(Args)... x)
        {
          new (static_cast<void*>(p)) T(_Boost::forward<Args>(x)...);
        }

        template <typename T>
        static typename _Boost::enable_if_c<
          _Boost::unordered::detail::has_destroy<Alloc, T>::value>::type
        destroy(Alloc& a, T* p)
        {
          a.destroy(p);
        }
        ...
        template <typename T>
        static typename _Boost::disable_if_c<
          _Boost::unordered::detail::has_destroy<Alloc, T>::value>::type
        destroy(Alloc&, T* p)
        {
          _Boost::unordered::detail::func::destroy(p);
        }
        ...
        template <typename T>
        static typename _Boost::enable_if_c<
          _Boost::unordered::detail::has_construct<Alloc, T>::value>::type
        ...
        static void construct(Alloc& a, T* p, T const& x,
          typename _Boost::enable_if_c<
            _Boost::unordered::detail::has_construct<Alloc, T>::value &&
              _Boost::is_same<T, value_type>::value,
            void*>::type = 0)
        {
          a.construct(p, x);
        }
        ...
        static void destroy(Alloc& a, T* p,
          typename _Boost::enable_if_c<
            _Boost::unordered::detail::has_destroy<Alloc, T>::value &&
              _Boost::is_same<T, value_type>::value,
            void*>::type = 0)
        {
          a.destroy(p);
        ...
        {
          return _Boost::unordered::detail::func::call_max_size<size_type>(a);
        }
        ...
        {
          return _Boost::unordered::detail::func::
        ...
        typedef BOOST_UNORDERED_DEFAULT_TYPE(Alloc, is_always_equal,
          typename _Boost::is_empty<Alloc>::type) is_always_equal;
      };
    }
  }
}
...
////////////////////////////////////////////////////////////////////////////////
//
// _Boost::container::allocator_traits
...
namespace _Boost {
  namespace unordered {
    namespace detail {
      ...
      template <typename Alloc>
      struct allocator_traits : _Boost::container::allocator_traits<Alloc>
      {
      };

      template <typename Alloc, typename T>
      struct rebind_wrap : _Boost::container::allocator_traits<
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(_Boost::forward<Args>(args)...);
        }
      }
    }
  }
...
#define BOOST_UNORDERED_CALL_CONSTRUCT1(Traits, alloc, address, a0)            \
  _Boost::unordered::detail::func::construct_value(address, a0)
#define BOOST_UNORDERED_CALL_DESTROY(Traits, alloc, x)                         \
  _Boost::unordered::detail::func::destroy(x)
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(_Boost::forward<A0>(a0));
        }
      }
    }
  }
...
// construct_from_tuple for _Boost::tuple
...
namespace _Boost {
  namespace unordered {
    namespace detail {
      namespace func {
        template <typename Alloc, typename T>
        void construct_from_tuple(Alloc&, T* ptr, _Boost::tuple<>)
        {
          new ((void*)ptr) T();
        }

        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 1, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 2, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 3, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 4, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 5, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 6, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 7, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 8, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 9, _Boost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 10, _Boost)
      }
    }
  }
}
...
// construct_from_tuple for _Boost::tuple on old versions of sunpro.
//
// Old versions of Sun C++ had problems with template overloads of
// _Boost::tuple, so to fix it I added a distinct type for each length to
...
#define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(z, n, namespace_)                 \
  template <typename Alloc, typename T,                                        \
    BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
  void construct_from_tuple_impl(_Boost::unordered::detail::func::length<n>,    \
    Alloc&, T* ptr,                                                            \
    namespace_::tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)               \
  {                                                                            \
    new ((void*)ptr)                                                           \
    ...
    namespace detail {
      namespace func {
        ...
        void construct_from_tuple_impl(
          _Boost::unordered::detail::func::length<0>, Alloc&, T* ptr,
          _Boost::tuple<>)
        {
          new ((void*)ptr) T();
        }
        ...
        {
          construct_from_tuple_impl(_Boost::unordered::detail::func::length<
                                      _Boost::tuples::length<Tuple>::value>(),
            alloc, ptr, x);
        }
      }
    }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          static choice1::type test(
            choice1, _Boost::unordered::piecewise_construct_t);
          ...
          enum
          {
            value = sizeof(choice1::type) ==
                    sizeof(test(choose(), _Boost::unordered::detail::make<A0>()))
          };
        };
        ...
        {
          _Boost::unordered::detail::allocator_traits<Alloc>::construct(
            alloc, address, _Boost::forward<Args>(args)...);
        }

        // For backwards compatibility, implement a special case for
        // piecewise_construct with _Boost::tuple
        ...
        template <typename A0> struct detect_boost_tuple
        {
          ...
          static choice1::type test(choice1,
            _Boost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> const&);
        ...
        inline typename _Boost::enable_if_c<use_piecewise<A0>::value &&
        ...
        {
          _Boost::unordered::detail::func::construct_from_tuple(
            alloc, _Boost::addressof(address->first), _Boost::forward<A1>(a1));
          BOOST_TRY
          {
            _Boost::unordered::detail::func::construct_from_tuple(
              alloc, _Boost::addressof(address->second), _Boost::forward<A2>(a2));
          }
          BOOST_CATCH(...)
          {
            _Boost::unordered::detail::func::destroy(
              _Boost::addressof(address->first));
            BOOST_RETHROW
          }
          BOOST_CATCH_END
        }
        ...
        {
          new ((void*)address) T(_Boost::forward<A0>(args.a0));
        }
        ...
        {
          new ((void*)address)
            T(_Boost::forward<A0>(args.a0), _Boost::forward<A1>(args.a1));
        }
        ...
        {
          new ((void*)address) T(_Boost::forward<A0>(args.a0),
            _Boost::forward<A1>(args.a1), _Boost::forward<A2>(args.a2));
        }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                       \
  ...
  inline void construct_from_args(Alloc&, T* address,                          \
    _Boost::unordered::detail::BOOST_PP_CAT(emplace_args, num_params) <         \
...
#undef BOOST_UNORDERED_CONSTRUCT_IMPL
        ...
        inline void construct_from_args(Alloc& alloc, std::pair<A, B>* address,
          _Boost::unordered::detail::emplace_args3<A0, A1, A2> const& args,
          typename enable_if<use_piecewise<A0>, void*>::type = 0)
        {
          _Boost::unordered::detail::func::construct_from_tuple(
            alloc, _Boost::addressof(address->first), args.a1);
          BOOST_TRY
          {
            _Boost::unordered::detail::func::construct_from_tuple(
              alloc, _Boost::addressof(address->second), args.a2);
          }
          BOOST_CATCH(...)
          {
            _Boost::unordered::detail::func::destroy(
  ...
  namespace unordered {
    namespace detail {
      ...
      template <typename NodeAlloc> struct node_constructor
      {
        ...
        typedef _Boost::unordered::detail::allocator_traits<NodeAlloc>
      ...
      {
        if (node_) {
          _Boost::unordered::detail::func::destroy(_Boost::to_address(node_));
      ...
      template <typename Alloc> void node_constructor<Alloc>::create_node()
      {
        ...
        new ((void*)_Boost::to_address(node_)) node();
      }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        inline
          typename _Boost::unordered::detail::allocator_traits<Alloc>::pointer
          ...
          construct_node(Alloc& alloc, BOOST_FWD_REF(U) x)
        {
          ...
          BOOST_UNORDERED_CALL_CONSTRUCT1(
            _Boost::unordered::detail::allocator_traits<Alloc>, alloc,
            a.node_->value_ptr(), _Boost::forward<U>(x));
          return a.release();
        }
          ...
          construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          node_constructor<Alloc> a(alloc);
          a.create_node();
          _Boost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(_Boost::forward<Key>(k)),
            ...
            Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_FWD_REF(Mapped) m)
        {
          ...
          _Boost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(_Boost::forward<Key>(k)),
            std::forward_as_tuple(_Boost::forward<Mapped>(m)));
          return a.release();
        }
      ...
      defined(BOOST_LIBSTDCXX11))
          _Boost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(_Boost::forward<Key>(k)),
            std::forward_as_tuple(_Boost::forward<Args>(args)...));
#else
          ...
          _Boost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(_Boost::forward<Key>(k)),
            std::make_tuple(_Boost::forward<Args>(args)...));
#endif
          return a.release();
        }
          ...
          construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          node_constructor<Alloc> a(alloc);
          a.create_node();
          _Boost::unordered::detail::func::construct_value(
            _Boost::addressof(a.node_->value_ptr()->first),
            _Boost::forward<Key>(k));
          BOOST_TRY
          {
            _Boost::unordered::detail::func::construct_value(
              _Boost::addressof(a.node_->value_ptr()->second));
          }
          BOOST_CATCH(...)
          {
            _Boost::unordered::detail::func::destroy(
            ...
            Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          BOOST_TRY
          {
            _Boost::unordered::detail::func::construct_from_args(alloc,
              _Boost::addressof(a.node_->value_ptr()->second),
  ...
  namespace unordered {
    namespace iterator_detail {
      ...
      template <typename Node> struct l_iterator
      {
        ...
        friend struct _Boost::unordered::iterator_detail::cl_iterator;
      ...
      template <typename Node> struct cl_iterator
      {
        friend struct _Boost::unordered::iterator_detail::l_iterator<Node>;
      ...
      public:
        ...
        cl_iterator(
          _Boost::unordered::iterator_detail::l_iterator<Node> const& x)
...
#if !defined(BOOST_NO_MEMBER_TEMPLATE_FRIENDS)
        template <typename>
        friend struct _Boost::unordered::iterator_detail::c_iterator;
        template <typename> friend struct _Boost::unordered::detail::table;
      ...
      template <typename Node> struct c_iterator
      {
        friend struct _Boost::unordered::iterator_detail::iterator<Node>;
...
#endif
        typedef typename Node::node_pointer node_pointer;
        typedef _Boost::unordered::iterator_detail::iterator<Node> n_iterator;
        node_pointer node_;
    ...
    namespace detail {
      ...
      template <typename Alloc> node_holder<Alloc>::~node_holder()
      {
        while (nodes_) {
          ...
          _Boost::unordered::detail::func::destroy(_Boost::to_address(p));
      ...
      template <typename SizeT> struct prime_policy
      {
        ...
        {
          return _Boost::unordered::detail::next_prime(min);
        }

        static inline SizeT prev_bucket_count(SizeT max)
        {
          return _Boost::unordered::detail::prev_prime(max);
        }
      };
      ...
      template <> struct pick_policy2<_Boost::long_long_type>
      {
        typedef prime_policy<std::size_t> type;
      };

      template <> struct pick_policy2<_Boost::ulong_long_type>
      {
        typedef prime_policy<std::size_t> type;
      };
#endif
      ...
      template <typename T>
      struct pick_policy : pick_policy2<typename _Boost::remove_cv<T>::type>
      {
      };
      ...
      public:
        static const bool nothrow_move_assignable =
          _Boost::is_nothrow_move_assignable<H>::value &&
          _Boost::is_nothrow_move_assignable<P>::value;
        static const bool nothrow_move_constructible =
          _Boost::is_nothrow_move_constructible<H>::value &&
          _Boost::is_nothrow_move_constructible<P>::value;
        static const bool nothrow_swappable =
          _Boost::is_nothrow_swappable<H>::value &&
          _Boost::is_nothrow_swappable<P>::value;
      ...
      private:
        ...
        typedef typename _Boost::aligned_storage<sizeof(function_pair),
          _Boost::alignment_of<function_pair>::value>::type aligned_function;
      ...
      public:
        ...
        functions(functions& bf, _Boost::unordered::detail::move_tag)
            : current_(0)
        {
          construct_functions(current_, bf.current_functions(),
            _Boost::unordered::detail::integral_constant<bool,
      ...
      private:
        ...
        void construct_functions(unsigned char which, function_pair const& f,
          _Boost::unordered::detail::false_type =
            _Boost::unordered::detail::false_type())
        {
          BOOST_ASSERT(!(which & 2));
        ...
        void construct_functions(unsigned char which, function_pair& f,
          _Boost::unordered::detail::true_type)
        {
          BOOST_ASSERT(!(which & 2));
          new ((void*)&funcs_[which])
            function_pair(f, _Boost::unordered::detail::move_tag());
        }
...
#define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
      ...
      template <typename T>
      struct rv_ref
        : _Boost::detail::if_true<_Boost::is_class<T>::value>::
            BOOST_NESTED_TEMPLATE then<_Boost::unordered::detail::rv_ref_impl<T>,
              please_ignore_this_overload>::type
      {
      };

#define BOOST_UNORDERED_RV_REF(T)                                              \
  typename _Boost::unordered::detail::rv_ref<T>::type
#endif
...
#pragma warning(disable : 4127) // conditional expression is constant
      ...
      struct table : _Boost::unordered::detail::functions<typename Types::hasher,
      ...
      public:
        ...
        typedef _Boost::unordered::detail::functions<typename Types::hasher,
          typename Types::key_equal>
          functions;

        typedef typename Types::value_allocator value_allocator;
        typedef typename _Boost::unordered::detail::rebind_wrap<value_allocator,
          node>::type node_allocator;
        typedef typename _Boost::unordered::detail::rebind_wrap<value_allocator,
          bucket>::type bucket_allocator;
        typedef _Boost::unordered::detail::allocator_traits<node_allocator>
          node_allocator_traits;
        typedef _Boost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef _Boost::unordered::detail::node_constructor<node_allocator>
          node_constructor;
        typedef _Boost::unordered::detail::node_tmp<node_allocator> node_tmp;
        ...
        _Boost::unordered::detail::compressed<bucket_allocator, node_allocator>
          allocators_;
        std::size_t bucket_count_;
        std::size_t size_;
        float mlf_;
        ...
        void recalculate_max_load()
        {
          ...
          max_load_ = buckets_ ? _Boost::unordered::detail::double_to_size(
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
          ...
          return policy::new_bucket_count(
            _Boost::unordered::detail::double_to_size(
        ...
        table(table& x, _Boost::unordered::detail::move_tag m)
        ...
        table(table& x, node_allocator const& a,
          _Boost::unordered::detail::move_tag m)
        ...
        void create_buckets(std::size_t new_count)
        {
          ...
          for (bucket_pointer i = buckets_; i != end; ++i) {
            new ((void*)_Boost::to_address(i)) bucket();
          }
          new ((void*)_Boost::to_address(end)) bucket(dummy_node);
        }
        ...
        {
          _Boost::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x, false_type)
        {
          ...
          swap_allocators(
            x, _Boost::unordered::detail::integral_constant<bool,
                 allocator_traits<
                   node_allocator>::propagate_on_container_swap::value>());

          _Boost::swap(buckets_, x.buckets_);
          _Boost::swap(bucket_count_, x.bucket_count_);
          _Boost::swap(size_, x.size_);
        ...
        void swap(table& x)
        {
          ...
          swap(x, _Boost::unordered::detail::integral_constant<bool,
        ...
        void move_construct_buckets(table& src)
        {
          if (this->node_alloc() == src.node_alloc()) {
            ...
            for (node_pointer n = src.begin(); n; n = next_node(n)) {
              ...
              node_pointer n2 = _Boost::unordered::detail::func::construct_node(
                this->node_alloc(), _Boost::move(n->value()));
        ...
        void destroy_node(node_pointer n)
        {
          ...
          _Boost::unordered::detail::func::destroy(_Boost::to_address(n));
        ...
        void destroy_buckets()
        {
          ...
          for (bucket_pointer it = buckets_; it != end; ++it) {
            _Boost::unordered::detail::func::destroy(_Boost::to_address(it));
          }
          ...
          if (pos) {
            ...
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
                _Boost::unordered::detail::func::construct_node_from_args(
        ...
        {
          node_tmp b(_Boost::unordered::detail::func::construct_node_from_args(
                       this->node_alloc(), BOOST_UNORDERED_EMPLACE_FORWARD),
            this->node_alloc());
        ...
        emplace_return try_emplace_unique(BOOST_FWD_REF(Key) k)
        {
          ...
          if (pos) {
            ...
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
                _Boost::unordered::detail::func::construct_node_pair(
                  this->node_alloc(), _Boost::forward<Key>(k)),
                key_hash)),
              true);
          }
        }
          ...
          BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          if (pos) {
            ...
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
                _Boost::unordered::detail::func::construct_node_pair_from_args(
                  this->node_alloc(), _Boost::forward<Key>(k),
                  BOOST_UNORDERED_EMPLACE_FORWARD),
                key_hash)),
              true);
          ...
          BOOST_FWD_REF(Key) k, BOOST_FWD_REF(M) obj)
        {
          ...
          if (pos) {
            pos->value().second = _Boost::forward<M>(obj);
            return emplace_return(iterator(pos), false);
          } else {
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
        ...
        void merge_unique(_Boost::unordered::detail::table<Types2>& other)
        {
          typedef _Boost::unordered::detail::table<Types2> other_table;
          BOOST_STATIC_ASSERT(
            (_Boost::is_same<node, typename other_table::node>::value));
        ...
        void insert_range_unique2(const_key_type& k, InputIt i, InputIt j)
        {
          ...
          if (!pos) {
            node_tmp b(_Boost::unordered::detail::func::construct_node(
                         this->node_alloc(), *i),
              this->node_alloc());
            if (this->size_ + 1 > this->max_load_)
              this->reserve_for_insert(
                this->size_ + _Boost::unordered::detail::insert_size(i, j));
        ...
        void copy_buckets(table const& src, true_type)
        {
          ...
          for (node_pointer n = src.begin(); n; n = next_node(n)) {
            ...
            this->add_node_unique(
              _Boost::unordered::detail::func::construct_node(
            ...
            0)
        {
          ...
          if (distance == 1) {
            emplace_equiv(_Boost::unordered::detail::func::construct_node(
              this->node_alloc(), *i));
          } else {
        ...
        template <class I>
        void insert_range_equiv(I i, I j,
          typename _Boost::unordered::detail::disable_if_forward<I,
            void*>::type = 0)
        {
          for (; i != j; ++i) {
            emplace_equiv(_Boost::unordered::detail::func::construct_node(
...
#pragma warning(pop)
      ...
      template <typename Key, typename T> struct is_key
      {
        ...
        enum
        {
          value = sizeof(test(_Boost::unordered::detail::make<T>())) ==
                  sizeof(choice2::type)
        };
      ...
      {
        typedef ValueType value_type;
        typedef typename _Boost::remove_const<typename _Boost::unordered::detail::
        ...
        template <class Second>
        static key_type const& extract(
          _Boost::rv<std::pair<key_type, Second> > const& v)
        {
          return v.first;
        }
        ...
        template <class Second>
        static key_type const& extract(
          _Boost::rv<std::pair<key_type const, Second> > const& v)
        {
          return v.first;
        }
#endif
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  ...
  static no_key extract(_Boost::unordered::piecewise_construct_t,               \
  ...
  static typename is_key<key_type, T>::type extract(                           \
    _Boost::unordered::piecewise_construct_t, namespace_ tuple<T> const& k,     \
    T2 const&)                                                                 \
  {                                                                            \
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  static no_key extract(                                                       \
    _Boost::unordered::piecewise_construct_t, namespace_ tuple<> const&)        \
  {                                                                            \
    return no_key();                                                           \
  }                                                                            \
                                                                               \
  ...
  {                                                                            \
    return typename is_key<key_type, T>::type(namespace_ get<0>(k));           \
        ...
        BOOST_UNORDERED_KEY_FROM_TUPLE(_Boost::)
...
#undef BOOST_UNORDERED_KEY_FROM_TUPLE
      ...
      struct node : _Boost::unordered::detail::value_base<T>
      {
        typedef
          typename ::_Boost::unordered::detail::rebind_wrap<A, node<A, T> >::type
            allocator;
        typedef typename ::_Boost::unordered::detail::allocator_traits<
          allocator>::pointer node_pointer;
        typedef node_pointer link_pointer;
        typedef typename ::_Boost::unordered::detail::rebind_wrap<A,
      ...
      template <typename T>
      struct ptr_node : _Boost::unordered::detail::ptr_bucket
      {
        typedef T value_type;
        typedef _Boost::unordered::detail::ptr_bucket bucket_base;
        typedef ptr_node<T>* node_pointer;
        typedef ptr_bucket* link_pointer;
        typedef ptr_bucket* bucket_pointer;

        std::size_t bucket_info_;
        _Boost::unordered::detail::value_base<T> value_base_;
      ...
      struct pick_node2
      {
        typedef _Boost::unordered::detail::node<A, T> node;

        typedef typename _Boost::unordered::detail::allocator_traits<
          typename _Boost::unordered::detail::rebind_wrap<A,
            node>::type>::pointer node_pointer;

        typedef _Boost::unordered::detail::bucket<node_pointer> bucket;
        typedef node_pointer link_pointer;
      };

      template <typename A, typename T>
      struct pick_node2<A, T, _Boost::unordered::detail::ptr_node<T>*,
        _Boost::unordered::detail::ptr_bucket*>
      {
        typedef _Boost::unordered::detail::ptr_node<T> node;
        typedef _Boost::unordered::detail::ptr_bucket bucket;
        typedef bucket* link_pointer;
      };

      template <typename A, typename T> struct pick_node
      {
        typedef typename _Boost::remove_const<T>::type nonconst;

        typedef _Boost::unordered::detail::allocator_traits<
          typename _Boost::unordered::detail::rebind_wrap<A,
            _Boost::unordered::detail::ptr_node<nonconst> >::type>
          tentative_node_traits;

        typedef _Boost::unordered::detail::allocator_traits<
          typename _Boost::unordered::detail::rebind_wrap<A,
            _Boost::unordered::detail::ptr_bucket>::type>
