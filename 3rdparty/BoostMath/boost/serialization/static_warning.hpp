...
struct static_warning_test{
    typename _Boost::mpl::eval_if_c<
        B,
        _Boost::mpl::true_,
        typename _Boost::mpl::identity<
            _Boost::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef _Boost::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( _Boost::serialization::static_warning_test< B, L > ) \
