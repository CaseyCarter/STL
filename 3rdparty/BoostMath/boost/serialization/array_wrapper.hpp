...
namespace _Boost { namespace serialization {
...
private:
    ...
    friend const _Boost::serialization::array_wrapper<Tx> make_array(Tx * t, S s);
public:
...
public:
    ...
    void serialize_optimized(Archive &ar, const unsigned int, mpl::false_ ) const
    {
      ...
      T * t = address();
      while(0 < c--)
            ar & _Boost::serialization::make_nvp("item", *t++);
    }
    ...
    {
      _Boost::serialization::split_member(ar, *this, version);
    }
    ...
    {
      typedef typename
          _Boost::serialization::use_array_optimization<Archive>::template apply<
...
} } // end namespace _Boost::serialization
