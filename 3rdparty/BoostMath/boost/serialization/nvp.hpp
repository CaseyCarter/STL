...
#define BOOST_SERIALIZATION_NVP(name)                       \
    _Boost::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)           \
    _Boost::serialization::make_nvp(                         \
        BOOST_PP_STRINGIZE(name),                           \
        _Boost::serialization::base_object<name >(*this)     \
    )
/**/
