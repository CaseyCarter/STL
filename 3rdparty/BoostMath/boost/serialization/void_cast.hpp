    ...
    private _Boost::noncopyable
{
    ...
    friend
    BOOST_SERIALIZATION_DECL void const *
    _Boost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d =
            _Boost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b =
            _Boost::serialization::smart_cast<const Base *, const Derived *>(
...
private:
    static std::ptrdiff_t base_offset() {
        typename _Boost::aligned_storage<sizeof(Derived)>::type data;
...
{
    typedef
        typename mpl::eval_if<_Boost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
