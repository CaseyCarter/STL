...
// this is useful for compilers which don't support the _Boost::is_abstract
...
namespace serialization {
    template<class T>
    struct is_abstract : _Boost::is_abstract< T > {} ;
} // namespace serialization
} // namespace _Boost
...
namespace serialization {
    template<class T>
    struct is_abstract : _Boost::false_type {};
} // namespace serialization
} // namespace _Boost
...
namespace serialization {                             \
template<>                                            \
struct is_abstract< T > : _Boost::true_type {};        \
template<>                                            \
struct is_abstract< const T > : _Boost::true_type {};  \
}}                                                    \
/**/
