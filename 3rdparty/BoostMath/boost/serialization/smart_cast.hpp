...
T smart_cast(U u) {
    typedef
        typename mpl::eval_if<
            typename mpl::or_<
                _Boost::is_same<void *, U>,
                _Boost::is_same<void *, T>,
                _Boost::is_same<const void *, U>,
                _Boost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename mpl::eval_if<_Boost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename mpl::eval_if<_Boost::is_reference<U>,
