...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return _Boost::detail::addrof<T>::get(o, 0);
#else
    return _Boost::detail::addrof<T>::get(_Boost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename _Boost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return _Boost::detail::addressof(o);
}
#endif
