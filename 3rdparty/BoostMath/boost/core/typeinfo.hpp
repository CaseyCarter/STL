...
{
    static _Boost::core::typeinfo ti_;
...
template<class T> _Boost::core::typeinfo core_typeid_< T >::ti_( core_typeid_< T >::name(), &core_typeid_lib_id );
...
#define BOOST_CORE_TYPEID(T) (_Boost::detail::core_typeid_<T>::ti_)
