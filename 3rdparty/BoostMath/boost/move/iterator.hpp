...
class move_iterator
{
   ...
   typedef typename _Boost::movelib::iterator_traits<iterator_type>::value_type        value_type;
   #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_MOVE_DOXYGEN_INVOKED)
   typedef value_type &&                                                   reference;
   #else
   typedef typename ::_Boost::move_detail::if_
      < ::_Boost::has_move_emulation_enabled<value_type>
      , ::_Boost::rv<value_type>&
      , value_type & >::type                                               reference;
   #endif
   typedef It                                                              pointer;
   typedef typename _Boost::movelib::iterator_traits<iterator_type>::difference_type   difference_type;
   typedef typename _Boost::movelib::iterator_traits<iterator_type>::iterator_category iterator_category;
...
template <class I>
struct is_move_iterator< ::_Boost::move_iterator<I> >
{
...
class back_move_insert_iterator
{
   ...
   { container_m->push_back(_Boost::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(_Boost::move(x)); return *this; }
...
class move_insert_iterator
{
   ...
   {
      pos_ = container_m->insert(pos_, ::_Boost::move(x));
      ++pos_;
      return *this;
   }
