...
struct deleter_types
{
   ...
   typedef ::_Boost::rv<D> &                                       deleter_arg_type2;
   #endif
};
...
class is_rvalue_convertible
{
   ...
   #else
   typedef typename bmupmu::if_c
      < ::_Boost::has_move_emulation_enabled<T>::value && !bmupmu::is_reference<T>::value
      , ::_Boost::rv<T>&
...
class unique_ptr
{
      ...
      : m_data(p)
   {
      ...
      BOOST_STATIC_ASSERT(( !::_Boost::move_upmu::missing_virtual_destructor
   ...
   BOOST_MOVE_FORCEINLINE unique_ptr(BOOST_RV_REF(unique_ptr) u) BOOST_NOEXCEPT
      : m_data(u.release(), ::_Boost::move_if_not_lvalue_reference<D>(u.get_deleter()))
   {}
   ...
   BOOST_MOVE_FORCEINLINE unique_ptr( BOOST_RV_REF_BEG_IF_CXX11 unique_ptr<U, E> BOOST_RV_REF_END_IF_CXX11 u
      ...
      : m_data(u.release(), ::_Boost::move_if_not_lvalue_reference<E>(u.get_deleter()))
   {
   ...
   unique_ptr& operator=(BOOST_RV_REF(unique_ptr) u) BOOST_NOEXCEPT
   {
      ...
      m_data.deleter() = ::_Boost::move_if_not_lvalue_reference<D>(u.get_deleter());
      return *this;
   }
   ...
   {
      this->reset(u.release());
      m_data.deleter() = ::_Boost::move_if_not_lvalue_reference<E>(u.get_deleter());
      return *this;
   }
   ...
   {
      ::_Boost::adl_move_swap(m_data.m_p, u.m_data.m_p);
      ::_Boost::adl_move_swap(m_data.deleter(), u.m_data.deleter());
   }
};
