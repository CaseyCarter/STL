...
// @endcond
   ...
   class BOOST_RV_ATTRIBUTE_MAY_ALIAS rv
      : public ::_Boost::move_detail::if_c
         < ::_Boost::move_detail::is_class<T>::value
         , T
         , ::_Boost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::_Boost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::_Boost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::_Boost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::_Boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::_Boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::_Boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::_Boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   BOOST_MOVE_FORCEINLINE typename ::_Boost::move_detail::enable_if_c
      <  ::_Boost::move_detail::is_lvalue_reference<Ret>::value ||
        !::_Boost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::_Boost::move_detail::enable_if_c
      < !::_Boost::move_detail::is_lvalue_reference<Ret>::value &&
         ::_Boost::has_move_emulation_enabled<T>::value
      , ::_Boost::rv<T>&>::type
         move_return(::_Boost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      _Boost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::_Boost::move((BASE_TYPE&)(ARG))
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::_Boost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::_Boost::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::_Boost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::_Boost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< _Boost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::_Boost::move()` due to rvalue reference limitations.
   //!
