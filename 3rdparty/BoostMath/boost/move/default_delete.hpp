...
namespace bmupmu = ::_Boost::move_upmu;
...
namespace bmupd = _Boost::move_upd;
namespace bmupmu = ::_Boost::move_upmu;
...
struct default_delete
{
      ...
      ) BOOST_NOEXCEPT
   {
      ...
      BOOST_STATIC_ASSERT(( !::_Boost::move_upmu::missing_virtual_destructor<default_delete, U>::value ));
   }
