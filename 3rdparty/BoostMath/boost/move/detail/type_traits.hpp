...
// BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) should evaluate to true if T(_Boost::move(t)) <==> memcpy
...
// BOOST_MOVE_HAS_TRIVIAL_MOVE_ASSIGN(T) should evaluate to true if t = _Boost::move(u) <==> memcpy
...
#   define BOOST_MOVE_HAS_TRIVIAL_COPY(T)          (__has_trivial_copy(T)|| ::_Boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_TRIVIAL_ASSIGN(T)        (__has_trivial_assign(T) || ::_Boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)    (__has_trivial_destructor(T) || ::_Boost::move_detail::is_pod<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_CONSTRUCTOR(T)   (__has_nothrow_constructor(T) || ::_Boost::move_detail::is_trivially_default_constructible<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_COPY(T)          (__has_nothrow_copy(T) || ::_Boost::move_detail::is_trivially_copy_constructible<T>::value)
#   define BOOST_MOVE_HAS_NOTHROW_ASSIGN(T)        (__has_nothrow_assign(T) || ::_Boost::move_detail::is_trivially_copy_assignable<T>::value)

#   define BOOST_MOVE_IS_ENUM(T) __is_enum(T)
#   if defined(_MSC_VER) && (_MSC_VER >= 1700)
#       define BOOST_MOVE_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T)   (__has_trivial_move_constructor(T) || ::_Boost::move_detail::is_pod<T>::value)
#       define BOOST_MOVE_HAS_TRIVIAL_MOVE_ASSIGN(T)        (__has_trivial_move_assign(T) || ::_Boost::move_detail::is_pod<T>::value)
#   endif
#endif
...
#ifdef BOOST_INTEL
#  define BOOST_MOVE_INTEL_TT_OPTS || ::_Boost::move_detail::is_pod<T>::value
#else
...
//Fallback definitions
   ...
   #define BOOST_MOVE_IS_POD_IMPL(T) (::_Boost::move_detail::is_scalar<T>::value ||\
                                      ::_Boost::move_detail::is_void<T>::value   ||\
                                       BOOST_MOVE_IS_POD(T))
#else
   #define BOOST_MOVE_IS_POD_IMPL(T) \
      (::_Boost::move_detail::is_scalar<T>::value || ::_Boost::move_detail::is_void<T>::value)
#endif

#ifdef BOOST_MOVE_IS_EMPTY
   #define BOOST_MOVE_IS_EMPTY_IMPL(T) BOOST_MOVE_IS_EMPTY(T)
#else
   #define BOOST_MOVE_IS_EMPTY_IMPL(T)    ::_Boost::move_detail::is_empty_nonintrinsic<T>::value
#endif

#ifdef BOOST_MOVE_HAS_TRIVIAL_COPY
   #define BOOST_MOVE_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T)   ::_Boost::move_detail::is_pod<T>::value ||\
                                                          (::_Boost::move_detail::is_copy_constructible<T>::value &&\
...
#else
   #define BOOST_MOVE_IS_TRIVIALLY_DEFAULT_CONSTRUCTIBLE(T)  ::_Boost::move_detail::is_pod<T>::value
#endif
...
#else
   #define BOOST_MOVE_IS_TRIVIALLY_MOVE_CONSTRUCTIBLE(T)   ::_Boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_HAS_TRIVIAL_ASSIGN
   #define BOOST_MOVE_IS_TRIVIALLY_COPY_ASSIGNABLE(T) ::_Boost::move_detail::is_pod<T>::value ||\
                                                      ( ::_Boost::move_detail::is_copy_assignable<T>::value &&\
...
#else
   #define BOOST_MOVE_IS_TRIVIALLY_MOVE_ASSIGNABLE(T)  ::_Boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR
   #define BOOST_MOVE_IS_TRIVIALLY_DESTRUCTIBLE(T)   BOOST_MOVE_HAS_TRIVIAL_DESTRUCTOR(T)
#else
   #define BOOST_MOVE_IS_TRIVIALLY_DESTRUCTIBLE(T)   ::_Boost::move_detail::is_pod<T>::value
#endif
...
#else
   #define BOOST_MOVE_IS_NOTHROW_MOVE_ASSIGNABLE(T) ::_Boost::move_detail::is_pod<T>::value
#endif

#ifdef BOOST_MOVE_IS_ENUM
   #define BOOST_MOVE_IS_ENUM_IMPL(T)   BOOST_MOVE_IS_ENUM(T)
#else
   #define BOOST_MOVE_IS_ENUM_IMPL(T)   ::_Boost::move_detail::is_enum_nonintrinsic<T>::value
#endif
...
template <> struct make_unsigned_impl< ::_Boost::long_long_type >  {  typedef ::_Boost::ulong_long_type type; };
#endif
...
#ifdef BOOST_HAS_LONG_LONG
template<> struct is_integral_cv< ::_Boost:: long_long_type>{  static const bool value = true; };
template<> struct is_integral_cv< ::_Boost::ulong_long_type>{  static const bool value = true; };
#endif
...
struct is_copy_constructible
{
   ...
   // static yes_type test(U&, decltype(U(_Boost::declval<U&>()))* = 0);
   //                                                        ^ 
...
//
// error: function *function_name* cannot be referenced -- it is a deleted function
// static _Boost::type_traits::yes_type test(T1&, decltype(T1(_Boost::declval<T1&>()))* = 0);
//                                                        ^ 
//
// MSVC 12.0 (Visual 2013) has problems when the copy constructor has been deleted. See:
// https://connect.microsoft.com/VisualStudio/feedback/details/800328/std-is-copy-constructible-is-broken
...
union max_align
{
   ...
   long        long_;
   #ifdef BOOST_HAS_LONG_LONG
   ::_Boost::long_long_type   long_long_;
   #endif
   float       float_;
   double      double_;
   void *      void_ptr_;
...
#define BOOST_MOVE_ALIGNED_NEXT_STEP(TYPE, NEXT_TYPE)\
   ...
   #ifdef BOOST_HAS_LONG_LONG
      BOOST_MOVE_ALIGNED_NEXT_STEP(::_Boost::long_long_type, double)
      BOOST_MOVE_ALIGNED_NEXT_STEP(long, ::_Boost::long_long_type)
   #else
