...
{
   return ::_Boost::move_detail::addressof_impl<T>::f
      ( ::_Boost::move_detail::addr_impl_ref<T>( v ), 0 );
}
...
template<class T>
struct has_move_emulation_enabled_impl< ::_Boost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< _Boost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const _Boost::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::_Boost::rv<T>& type; };
} // namespace detail_add_rvalue_reference
