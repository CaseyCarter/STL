...
#define BOOST_MOVE_CATCH_CONST(U)  \
   typename ::_Boost::move_detail::if_< ::_Boost::move_detail::is_class<U>, BOOST_CATCH_CONST_RLVALUE(U), const U &>::type
#define BOOST_MOVE_CATCH_RVALUE(U)\
   typename ::_Boost::move_detail::if_< ::_Boost::move_detail::is_class<U>, BOOST_RV_REF(U), ::_Boost::move_detail::nat>::type
...
////////////////////////////////////////
   ...
   struct boost_move_conversion_aware_catch_1
      : public ::_Boost::move_detail::enable_if_and
                        < RETURN_VALUE
                        , ::_Boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>
                        , ::_Boost::move_detail::is_class<TYPE>
                        , ::_Boost::has_move_emulation_disabled<BOOST_MOVE_TEMPL_PARAM>
                        >
   {};

   template<class RETURN_VALUE, class BOOST_MOVE_TEMPL_PARAM, class TYPE>
   struct boost_move_conversion_aware_catch_2
      : public ::_Boost::move_detail::disable_if_or
                        < RETURN_VALUE
                        , ::_Boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM> 
                        , ::_Boost::move_detail::is_rv_impl<BOOST_MOVE_TEMPL_PARAM>
                        , ::_Boost::move_detail::and_
                                    < ::_Boost::move_detail::is_rv_impl<BOOST_MOVE_TEMPL_PARAM>
                                    , ::_Boost::move_detail::is_class<BOOST_MOVE_TEMPL_PARAM>
                                    >
                        >
   {};
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH_COMMON(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
      ...
      {  return FWD_FUNCTION(::_Boost::move(x));  }\
      \
   ...
   //
      ...
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
         ...
         BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u,\
            typename boost_move_conversion_aware_catch_1< ::_Boost::move_detail::nat, BOOST_MOVE_TEMPL_PARAM, TYPE>::type* = 0)\
         { return FWD_FUNCTION(u); }\
         \
         template<class BOOST_MOVE_TEMPL_PARAM>\
         BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u,\
            typename boost_move_conversion_aware_catch_2< ::_Boost::move_detail::nat, BOOST_MOVE_TEMPL_PARAM, TYPE>::type* = 0)\
         {\
            TYPE t((u));\
            return FWD_FUNCTION(::_Boost::move(t));\
         }\
      //
   #else
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
      ...
      \
      template<class BOOST_MOVE_TEMPL_PARAM>\
      BOOST_MOVE_FORCEINLINE typename ::_Boost::move_detail::enable_if_c\
                        < !::_Boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value\
                        , RETURN_VALUE >::type\
      PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u)\
      {\
         TYPE t((u));\
...
////////////////////////////////////////
   ...
   struct boost_move_conversion_aware_catch_1arg_1
      : public ::_Boost::move_detail::enable_if_and
                        < RETURN_VALUE
                        , ::_Boost::move_detail::not_< ::_Boost::move_detail::is_same_or_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO> >
                        , ::_Boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>
                        , ::_Boost::has_move_emulation_disabled<BOOST_MOVE_TEMPL_PARAM>
                        >
   {};
   ...
   struct boost_move_conversion_aware_catch_1arg_2
      : public ::_Boost::move_detail::disable_if_or
                        < RETURN_VALUE
                        , ::_Boost::move_detail::is_same_or_convertible< BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>
                        , ::_Boost::move_detail::is_rv_impl<BOOST_MOVE_TEMPL_PARAM>
                        , ::_Boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>
                        >
   {};
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG_COMMON(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
      ...
      {  return FWD_FUNCTION(arg1, ::_Boost::move(x));  }\
      \
   ...
   //
      ...
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
         ...
         {\
            TYPE t((u));\
            return FWD_FUNCTION(arg1, ::_Boost::move(t));\
         }\
      //
   #else
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
      ...
      \
      template<class BOOST_MOVE_TEMPL_PARAM>\
      BOOST_MOVE_FORCEINLINE typename ::_Boost::move_detail::disable_if_or\
                        < RETURN_VALUE \
                        , ::_Boost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM> \
                        , ::_Boost::move_detail::is_same_or_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO> \
                        >::type\
