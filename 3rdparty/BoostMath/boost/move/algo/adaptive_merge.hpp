                ...
                , typename iterator_traits<RandIt>::size_type uninitialized_len = 0)
{
   ...
   ::_Boost::movelib::adaptive_xbuf<value_type, value_type*, size_type> xbuf(uninitialized, size_type(uninitialized_len));
   ::_Boost::movelib::detail_adaptive::adaptive_merge_impl(first, size_type(middle - first), size_type(last - middle), comp, xbuf);
}
