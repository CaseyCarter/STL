...
public:
    ...
    index_type index()
    {
        return _Boost::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return _Boost::tuples::get<1>(*this);
    }
...
{
    typedef ::_Boost::range::index_value<
    ...
    >
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((
        _Boost::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(_Boost::begin(r), i),
                 iterator(_Boost::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(_Boost::begin(r), i),
                 iterator(_Boost::end(r), i + _Boost::size(r)))
    {
    }
};
...
{
    BOOST_RANGE_CONCEPT_ASSERT((
        _Boost::SinglePassRangeConcept<const SinglePassRange>
    ));
