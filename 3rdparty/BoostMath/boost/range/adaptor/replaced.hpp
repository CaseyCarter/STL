...
namespace _Boost
{
    namespace range_detail
    {
        ...
        private:
            ...
            _Boost::optional<data> m_impl;
        };

        template< class R >
        class replaced_range :
            public _Boost::iterator_range<
                _Boost::transform_iterator<
        ...
        public:
            ...
            replaced_range( R& r, value_type from, value_type to )
                : base_t( make_transform_iterator( _Boost::begin(r), Fn(from, to) ),
                          make_transform_iterator( _Boost::end(r), Fn(from, to) ) )
            { }
        };
