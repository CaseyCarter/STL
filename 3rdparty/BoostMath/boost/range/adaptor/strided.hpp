...
namespace _Boost
{
    namespace range_detail
    {
        ...
        public:
            ...
            typedef typename super_t::reference reference;
            typedef BaseIterator base_iterator;
            typedef typename _Boost::make_unsigned<difference_type>::type
                        size_type;
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(_Boost::begin(rng), _Boost::end(rng), stride);
        }
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(_Boost::end(rng), _Boost::end(rng), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            ...
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(_Boost::begin(rng), difference_type(), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(_Boost::end(rng), _Boost::size(rng), stride);
        }
            ...
            random_access_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                random_access_traversal_tag
            >(_Boost::begin(rng), _Boost::begin(rng), stride);
        }
