...
struct formatted_holder
{
    typedef typename _Boost::mpl::if_<
        _Boost::is_array<Sep>,
        const typename _Boost::remove_extent<Sep>::type*,
        Sep
    >::type separator_t;

    typedef typename _Boost::mpl::if_<
        _Boost::is_array<Prefix>,
        const typename _Boost::remove_extent<Prefix>::type*,
        Prefix
    >::type prefix_t;

    typedef typename _Boost::mpl::if_<
        _Boost::is_array<Postfix>,
        const typename _Boost::remove_extent<Postfix>::type*,
        Postfix
    >::type postfix_t;
...
)
{
    ...
    return range_detail::formatted_range<iterator, Sep, Prefix, Postfix>(
        _Boost::begin(rng), _Boost::end(rng), holder);
}
...
template<typename SinglePassRange, typename Sep, typename Prefix,
         typename Postfix>
inline _Boost::range_detail::formatted_range<
    typename _Boost::range_iterator<const SinglePassRange>::type,
    Sep, Prefix, Postfix
>
format(
    const SinglePassRange& rng,
...
{
    typedef typename _Boost::range_iterator<const SinglePassRange>::type
                iterator_t;

    typedef _Boost::range_detail::formatted_range<
                iterator_t, Sep, Prefix, Postfix>       result_t;

    typedef _Boost::range_detail::formatted_holder<Sep, Prefix, Postfix>
                holder_t;

    return result_t(_Boost::begin(rng), _Boost::end(rng),
...
format(const SinglePassRange& rng)
{
    ...
    namespace range
    {
        using _Boost::range_detail::formatted_range;
    } // namespace range
} // namespace _Boost
