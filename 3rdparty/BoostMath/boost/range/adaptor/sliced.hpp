...
namespace _Boost
{
    namespace adaptors
    {
        ...
        class sliced_range : public _Boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type >
        {
            typedef _Boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type > base_t;
        public:
            template<typename Rng, typename T, typename U>
            sliced_range(Rng& rng, T t, U u)
                : base_t(_Boost::next(_Boost::begin(rng), t),
                         _Boost::next(_Boost::begin(rng), u))
            {
            }
        };
        ...
        slice( RandomAccessRange& rng, std::size_t t, std::size_t u )
        {
            ...
            BOOST_ASSERT( static_cast<std::size_t>(_Boost::size(rng)) >= u &&
