...
namespace _Boost
{
    namespace range_detail
    {
        ...
        struct reversed_range : 
            public _Boost::iterator_range< 
                      _Boost::reverse_iterator<
                        BOOST_DEDUCED_TYPENAME range_iterator<R>::type 
                                              >
                                         >
        {
        private:
            typedef _Boost::iterator_range< 
                      _Boost::reverse_iterator<
                        BOOST_DEDUCED_TYPENAME range_iterator<R>::type 
                                              >
                                         >
        ...
        public:
            typedef _Boost::reverse_iterator<BOOST_DEDUCED_TYPENAME range_iterator<R>::type> iterator;

            explicit reversed_range( R& r ) 
                : base( iterator(_Boost::end(r)), iterator(_Boost::begin(r)) )
            { }
        };
