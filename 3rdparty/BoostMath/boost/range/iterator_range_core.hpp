...
namespace _Boost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( _Boost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( _Boost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( _Boost::begin(l),
                                                 _Boost::end(l),
                                                 _Boost::begin(r),
                                                 _Boost::end(r) );
        }
...
incrementable_t test_traversal_tag(_Boost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(_Boost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(_Boost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef _Boost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef _Boost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef _Boost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *_Boost::prior(this->m_End);
    }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                _Boost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        public:
            ...
            iterator_range(
                ...
                BOOST_DEDUCED_TYPENAME ::_Boost::enable_if<
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME _Boost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME _Boost::enable_if<
            mpl::not_<_Boost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, _Boost::next(first, n));
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = _Boost::begin( r ),
                    new_end   = _Boost::end( r );
        ...
        */
        ...
        {
            return SeqT( _Boost::begin( r ), _Boost::end( r ) );
        }
