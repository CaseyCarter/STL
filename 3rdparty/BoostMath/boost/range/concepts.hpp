...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the _Boost::adaptors::filtered
        // class with a _Boost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                _Boost::ignore_unused_variable_warning(i2);
                ...
                _Boost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                _Boost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = _Boost::begin(*m_range);
            iterator i2 = _Boost::end(*m_range);

            _Boost::ignore_unused_variable_warning(i1);
            _Boost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = _Boost::begin(const_range);
            const_iterator ci2 = _Boost::end(const_range);

            _Boost::ignore_unused_variable_warning(ci1);
            _Boost::ignore_unused_variable_warning(ci2);
        }
