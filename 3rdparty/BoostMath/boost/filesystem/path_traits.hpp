...
namespace _Boost { namespace filesystem {
...
namespace path_traits {
  ...
  template <class Container> inline
    ...
    typename _Boost::disable_if<_Boost::is_array<Container>, bool>::type
  ...
  template <class Container, class U> inline
    ...
    typename _Boost::disable_if<_Boost::is_array<Container>, void>::type
