...
struct space_info
{
  ...
  _Boost::uintmax_t capacity;
  _Boost::uintmax_t free;      // <= capacity
  _Boost::uintmax_t available; // <= free
};
...
BOOST_FILESYSTEM_DECL
_Boost::uintmax_t file_size(const path& p, system::error_code* ec=0);
BOOST_FILESYSTEM_DECL
_Boost::uintmax_t hard_link_count(const path& p, system::error_code* ec=0);
BOOST_FILESYSTEM_DECL
...
BOOST_FILESYSTEM_DECL
_Boost::uintmax_t remove_all(const path& p, system::error_code* ec=0);
BOOST_FILESYSTEM_DECL
...
inline
_Boost::uintmax_t file_size(const path& p) {return detail::file_size(p);}

inline
_Boost::uintmax_t file_size(const path& p, system::error_code& ec) BOOST_NOEXCEPT
                                     {return detail::file_size(p, &ec);}
inline
_Boost::uintmax_t hard_link_count(const path& p) {return detail::hard_link_count(p);}

inline
_Boost::uintmax_t hard_link_count(const path& p, system::error_code& ec) BOOST_NOEXCEPT
...
inline
_Boost::uintmax_t remove_all(const path& p) {return detail::remove_all(p);}

inline
_Boost::uintmax_t remove_all(const path& p, system::error_code& ec) BOOST_NOEXCEPT
