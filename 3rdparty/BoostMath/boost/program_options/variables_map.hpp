...
#   pragma warning (push)
#   pragma warning (disable:4251) // '_Boost::program_options::variable_value::v' : class '_Boost::any' needs to have dll-interface to be used by clients of class '_Boost::program_options::variable_value
#endif
...
namespace _Boost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const _Boost::any& xv, bool xdefaulted)
        : v(xv), m_defaulted(xdefaulted)
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws _Boost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return _Boost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return _Boost::any_cast<T&>(v);
       }
