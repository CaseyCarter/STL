...
namespace _Boost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        */
        virtual void parse(_Boost::any& value_store, 
        ...
        /** Called to assign default value to 'value_store'. Returns
            ...
            value exists. */
        virtual bool apply_default(_Boost::any& value_store) const = 0;
                                   
        /** Called when final value of an option is determined. 
        */
        virtual void notify(const _Boost::any& value_store) const = 0;
    ...
    */
    ...
    private: // base overrides
        void parse(_Boost::any& value_store, 
                   const std::vector<std::string>& new_tokens,
                   bool utf8) const;
    protected: // interface for derived classes.
        virtual void xparse(_Boost::any& value_store, 
                            const std::vector<std::string>& new_tokens) 
            const = 0;
    };
    ...
    */
    ...
    public:
        ...
        /** If 'value_store' is already initialized, or new_tokens
            ...
            any modifications.
         */
        void xparse(_Boost::any& value_store,
                    const std::vector<std::string>& new_tokens) const;

        /** Does nothing. */
        bool apply_default(_Boost::any&) const { return false; }

        /** Does nothing. */
        void notify(const _Boost::any&) const {}        
    private:
        bool m_zero_tokens;
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            m_default_value = _Boost::any(v);
            m_default_value_as_text = _Boost::lexical_cast<std::string>(v);
            return this;
        }
        ...
        */
        ...
        {
            m_implicit_value = _Boost::any(v);
            m_implicit_value_as_text =
                _Boost::lexical_cast<std::string>(v);
            return this;
        }
    ...
    public: // value semantic overrides
        ...
        */
        virtual bool apply_default(_Boost::any& value_store) const
        {
        ...
        /** If an address of variable to store value was specified
            ...
            does nothing. */
        void notify(const _Boost::any& value_store) const;
    ...
    private:
        ...
        // Default value is stored as _Boost::any and not
        // as _Boost::optional to avoid unnecessary instantiations.
        std::string m_value_name;
        _Boost::any m_default_value;
        std::string m_default_value_as_text;
        _Boost::any m_implicit_value;
        std::string m_implicit_value_as_text;
        bool m_composing, m_implicit, m_multitoken, m_zero_tokens, m_required;
        _Boost::function1<void, const T&> m_notifier;
    };
