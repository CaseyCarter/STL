...
#   pragma warning (push)
#   pragma warning (disable:4275) // non dll-interface class 'std::logic_error' used as base for dll-interface class '_Boost::program_options::error'
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class '_Boost::program_options::ambiguous_option'
#endif
...
namespace _Boost { namespace program_options {
    ...
    */
     ...
     *      Poor man's version of _Boost::format
     *  
