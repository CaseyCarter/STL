...
#   pragma warning (push)
#   pragma warning (disable:4251) // class '_Boost::shared_ptr<T>' needs to have dll-interface to be used by clients of class '_Boost::program_options::option_description'
#endif
