...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class '_Boost::program_options::positional_options_description'
#endif
...
namespace _Boost { namespace program_options { namespace detail {
    ...
    */
    ...
    public:
        ...
        typedef ::_Boost::program_options::command_line_style::style_t style_t;
