...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const _Boost::posix_time::ptime& t) {
    std::tm timetm = _Boost::gregorian::to_tm(t.date());
    _Boost::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const _Boost::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    _Boost::gregorian::date d = _Boost::gregorian::date_from_tm(timetm);
   ...
   *       _Boost::detail::winapi::FILETIME_ type.
   */
  template< typename TimeT, typename FileTimeT >
  inline
  TimeT from_ftime(const FileTimeT& ft)
  {
    return _Boost::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace _Boost::posix_time
