...
#define BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<_Boost::date_time::time_resolution_traits_adapted64_impl, _Boost::date_time::nano,
    1000000000, 9 > time_res_traits;
#else
  // set up conditional test compilations
#undef  BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    _Boost::date_time::time_resolution_traits_adapted64_impl, _Boost::date_time::micro,
  ...
  public:
   ...
   BOOST_CXX14_CONSTEXPR time_duration() :
    ...
    BOOST_CXX14_CONSTEXPR time_duration(_Boost::date_time::special_values sv) :
...
#else
    BOOST_STATIC_CONSTANT(_Boost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef _Boost::int64_t time_rep_type;
...
#if (defined(BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    BOOST_STATIC_CONSTANT(_Boost::int64_t, tick_per_second = 1000000);
#endif
  };
