...
namespace posix_time {
  ...
  ptime 
  operator+(const ptime& t, const _Boost::gregorian::months& m)
  {
  ...
  inline BOOST_CXX14_CONSTEXPR
  ptime 
  operator+=(ptime& t, const _Boost::gregorian::months& m)
  {
  ...
  inline BOOST_CXX14_CONSTEXPR
  ptime 
  operator+(const ptime& t, const _Boost::gregorian::years& y)
  {
  ...
  inline BOOST_CXX14_CONSTEXPR
  ptime 
  operator+=(ptime& t, const _Boost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
