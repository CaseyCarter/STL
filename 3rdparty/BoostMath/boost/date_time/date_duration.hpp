...
namespace date_time {
  ...
  class BOOST_SYMBOL_VISIBLE date_duration : private
              _Boost::less_than_comparable1< date_duration< duration_rep_traits >
            , _Boost::equality_comparable1< date_duration< duration_rep_traits >
            , _Boost::addable1< date_duration< duration_rep_traits >
            , _Boost::subtractable1< date_duration< duration_rep_traits >
            , _Boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef _Boost::date_time::int_adapter<long> impl_type;
