...
namespace date_time {
  ...
  struct time_resolution_traits_bi32_impl {
    typedef _Boost::int32_t int_type;
    typedef _Boost::int32_t impl_type;
  ...
  struct time_resolution_traits_adapted32_impl {
    typedef _Boost::int32_t int_type;
    typedef _Boost::date_time::int_adapter<_Boost::int32_t> impl_type;
  ...
  struct time_resolution_traits_bi64_impl {
    typedef _Boost::int64_t int_type;
    typedef _Boost::int64_t impl_type;
    static BOOST_CXX14_CONSTEXPR int_type as_number(impl_type i){ return i;}
    //! Used to determine if implemented type is int_adapter or int
    static BOOST_CXX14_CONSTEXPR bool is_adapted() { return false;}
  };
  ...
  struct time_resolution_traits_adapted64_impl {
    typedef _Boost::int64_t int_type;
    typedef _Boost::date_time::int_adapter<_Boost::int64_t> impl_type;
    static BOOST_CXX14_CONSTEXPR int_type as_number(impl_type i){ return i.as_number();}
    //! Used to determine if implemented type is int_adapter or int
    static BOOST_CXX14_CONSTEXPR bool is_adapted() { return true;}
  };
  ...
  //
  // In Boost 1.65.1 and earlier var_type was _Boost::int32_t which suffers
  ...
  //
  // In Boost 1.67.0 the var_type was changed to _Boost::int64_t, 
  ...
  template<typename frac_sec_type,
           ...
           _Boost::int64_t resolution_adjust,
#else
           typename frac_sec_type::int_type resolution_adjust,
#endif
           unsigned short frac_digits,
           typename var_type = _Boost::int64_t >     // see note above
...
#if (defined(BOOST_MSVC) && (_MSC_VER < 1300))
    BOOST_STATIC_CONSTANT(_Boost::int64_t, ticks_per_second = resolution_adjust);
#else
