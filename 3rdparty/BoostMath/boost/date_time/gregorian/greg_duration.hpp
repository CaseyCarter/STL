...
namespace gregorian {
  ...
  typedef _Boost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class BOOST_SYMBOL_VISIBLE date_duration :
    public _Boost::date_time::date_duration< date_duration_rep >
  {
    typedef _Boost::date_time::date_duration< date_duration_rep > base_type;
