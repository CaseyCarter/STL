/*!
@file
Forward declares `_Boost::hana::common` and `_Boost::hana::common_t`.
...
BOOST_HANA_NAMESPACE_BEGIN
    ...
    //! specialize `common` in the `_Boost::hana` namespace for pairs of custom
    ...
    //! `common` in the `_Boost::hana` namespace.
    //!
