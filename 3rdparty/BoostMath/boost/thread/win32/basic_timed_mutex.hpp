...
#pragma warning(pop)
            ...
            void lock()
            {
                ...
                if(old_count&lock_flag_value)
                {
                    ...
                    do
                    {
                        if(winapi::WaitForSingleObjectEx(sem,::_Boost::detail::win32::infinite,0)==0)
                        {
        ...
        public:
...
#if defined BOOST_THREAD_USES_DATETIME
            bool timed_lock(::_Boost::system_time const& wait_until)
            {
            ...
            bool timed_lock(_Boost::xtime const& timeout)
            {
                return timed_lock(_Boost::system_time(timeout));
            }
#endif
#ifdef BOOST_THREAD_USES_CHRONO
        ...
        private:
            ...
            void* get_event()
            {
                void* current_event=::_Boost::detail::interlocked_read_acquire(&event);
