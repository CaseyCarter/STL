...
namespace executors
{
  ...
  public:
    ...
    executor_adaptor(BOOST_THREAD_RV_REF(Args) ... args) : ex(_Boost::forward<Args>(args)...) {}
#else
    /**
     * executor_adaptor constructor
     */
    ...
    void submit(BOOST_THREAD_RV_REF(work) closure)  {
      return ex.submit(_Boost::move(closure));
    }
    ...
    {
      //submit(work(_Boost::forward<Closure>(closure)));
      work w((_Boost::forward<Closure>(closure)));
      submit(_Boost::move(w));
    }
