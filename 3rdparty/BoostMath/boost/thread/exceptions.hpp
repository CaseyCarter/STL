...
namespace _Boost
{
    ...
    public:
        lock_error()
        : base_type(0, "_Boost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "_Boost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::resource_unavailable_try_again), "_Boost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "_Boost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::invalid_argument), "_Boost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "_Boost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(static_cast<int>(system::errc::invalid_argument), "_Boost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "_Boost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::permission_denied), "_Boost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "_Boost::thread_permission_error")
          {
          }
