...
namespace _Boost
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(_Boost::forward<F>(f), _Boost::forward<As>(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(_Boost::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      invoker& operator=(BOOST_THREAD_RV_REF(invoker) f)
      {
        if (this != &f)
        {
          f_ = _Boost::move(BOOST_THREAD_RV(f).f_);
        }
        return *this;
      }
    ...
    private:
      ...
      {
        return detail::invoke(_Boost::move(csbl::get<0>(f_)), _Boost::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(_Boost::move(BOOST_THREAD_RV(f).f_))
      {}
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return detail::invoke<R>(_Boost::move(csbl::get<0>(f_)), _Boost::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , _Boost::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , _Boost::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(_Boost::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(_Boost::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(_Boost::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , _Boost::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) _Boost::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    class invoker<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8>
    {
      ...
      T7 v7_;
      T8 v8_;
      //::_Boost::tuple<Fp, T0, T1, T2, T3, T4, T5, T6, T7, T8> f_;
    ...
    public:
      ...
      : fp_(_Boost::move(BOOST_THREAD_RV(f).fp))
      , v0_(_Boost::move(BOOST_THREAD_RV(f).v0_))
      , v1_(_Boost::move(BOOST_THREAD_RV(f).v1_))
      , v2_(_Boost::move(BOOST_THREAD_RV(f).v2_))
      , v3_(_Boost::move(BOOST_THREAD_RV(f).v3_))
      , v4_(_Boost::move(BOOST_THREAD_RV(f).v4_))
      , v5_(_Boost::move(BOOST_THREAD_RV(f).v5_))
      , v6_(_Boost::move(BOOST_THREAD_RV(f).v6_))
      , v7_(_Boost::move(BOOST_THREAD_RV(f).v7_))
      , v8_(_Boost::move(BOOST_THREAD_RV(f).v8_))
      {}
