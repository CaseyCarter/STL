...
namespace _Boost
{
    ...
    public:
        ...
        mutex()
        {
            ...
            if(res)
            {
                _Boost::throw_exception(thread_resource_error(res, "_Boost:: mutex constructor failed in pthread_mutex_init"));
            }
        }
        ~mutex()
        {
        ...
        void lock() BOOST_THREAD_ACQUIRE()
        {
            ...
            if (res)
            {
                _Boost::throw_exception(lock_error(res,"boost: mutex lock failed in pthread_mutex_lock"));
            }
        }
...
#define BOOST_THREAD_DEFINES_MUTEX_NATIVE_HANDLE
    ...
    public:
        ...
        timed_mutex()
        {
            ...
            if(res)
            {
                _Boost::throw_exception(thread_resource_error(res, "_Boost:: timed_mutex constructor failed in pthread_mutex_init"));
            }
#ifndef BOOST_THREAD_USES_PTHREAD_TIMEDLOCK
            ...
            {
                BOOST_VERIFY(!posix::pthread_mutex_destroy(&m));
                _Boost::throw_exception(thread_resource_error(res2, "_Boost:: timed_mutex constructor failed in pthread_cond_init"));
            }
            is_locked=false;
#endif
        }
    ...
    public:
        ...
        void lock()
        {
            _Boost::pthread::pthread_mutex_scoped_lock const local_lock(&m);
            while(is_locked)
            {
