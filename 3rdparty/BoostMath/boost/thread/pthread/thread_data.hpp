...
#define BOOST_THREAD_DEFINES_THREAD_ATTRIBUTES_NATIVE_HANDLE
    ...
    namespace detail
    {
        ...
        typedef _Boost::shared_ptr<thread_data_base> thread_data_ptr;
            ...
            enable_shared_from_this<thread_data_base>
        {
            ...
            _Boost::mutex data_mutex;
            _Boost::condition_variable done_condition;
            bool done;
            bool join_started;
            bool joined;
            _Boost::detail::thread_exit_callback_node* thread_exit_callbacks;
            std::map<void const*,_Boost::detail::tss_data_node> tss_data;
