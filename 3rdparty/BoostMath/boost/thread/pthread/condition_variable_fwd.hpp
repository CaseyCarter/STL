...
//#endif
    ...
    public:
    //private: // used by _Boost::thread::try_join_until
...
//#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            ...
            if(res)
            {
                _Boost::throw_exception(thread_resource_error(res, "_Boost::condition_variable::condition_variable() constructor failed in pthread_mutex_init"));
            }
//#endif
...
//#endif
                _Boost::throw_exception(thread_resource_error(res, "_Boost::condition_variable::condition_variable() constructor failed in pthread_cond_init"));
            }
        }
        ~condition_variable()
        {
...
//#endif
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            _Boost::system_time const& abs_time)
        {
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            _Boost::system_time const& abs_time,predicate_type pred)
        {
#if defined BOOST_THREAD_WAIT_BUG
            const detail::real_platform_timepoint ts(abs_time + BOOST_THREAD_WAIT_BUG);
#else
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            ::_Boost::xtime const& abs_time,predicate_type pred)
        {
