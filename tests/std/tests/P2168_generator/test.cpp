...
static_assert(std::same_as<ranges::range_value_t<std::generator<const int&>>, int>);
static_assert(std::same_as<ranges::range_difference_t<std::generator<const int&>>, std::ptrdiff_t>);
static_assert(std::same_as<ranges::range_reference_t<std::generator<const int&>>, const int&>);
static_assert(std::same_as<ranges::range_rvalue_reference_t<std::generator<const int&>>, const int&&>);
