...
#include <libs/boost/libs/math/test/beta_small_data.ipp>
    ...
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_beta_spots, T, fptypes) {
        ...
        BOOST_CHECK_CLOSE_FRACTION(test_fn<T>(static_cast<T>(0.0125L), static_cast<T>(0.000023L)),
            static_cast<T>(43558.24045647538375006349016083320744662L), tolerance * 2);
        // End extract
    }
...
namespace cyl_bessel_i {
    ...
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_cyl_bessel_i, T, fptypes) {
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 10> i1_data      = {{
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 11> in_data      = {{
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 10> iv_data      = {{
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 5> iv_large_data = {{
...
namespace cyl_bessel_k {
    ...
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_cyl_bessel_k, T, fptypes) {
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 9> kn_data       = {{
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 11> kv_data      = {{
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 5> kv_large_data = {{
            // Bug report https://svn.boost.org/trac/boost/ticket/5560:
            {{SC_(-1.0),
...
namespace cyl_neumann {
    ...
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_cyl_neumann, T, fptypes) {
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 10> yn_data      = {{
        ...
        static constexpr _Boost::array<_Boost::array<typename table_type<T>::type, 3>, 7> yv_large_data = {{
            // Bug report https://svn.boost.org/trac/boost/ticket/5560:
            {{SC_(0.5),
...
#include <libs/boost/libs/math/test/ellint_f_data.ipp>
    ...
    BOOST_AUTO_TEST_CASE_TEMPLATE(test_ellint_1_boundaries, T, fptypes) {
        ...
        // domain is k^2 * sin^2 phi < 1
        BOOST_CHECK(std::isnan(test_fn<T>(static_cast<T>(2), static_cast<T>(0.523598775598299))));
        BOOST_CHECK(assert_domain_error());
        BOOST_CHECK(std::isnan(test_fn<T>(static_cast<T>(-2), static_cast<T>(-0.523598775598299))));
        BOOST_CHECK(assert_domain_error());
